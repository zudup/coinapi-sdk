...
module OpenapiClient
  class OrdersApi
    ...
    def v1_orders_history_time_start_time_end_get(time_start, time_end, opts = {})
      data, _status_code, _headers = v1_orders_history_time_start_time_end_get_with_http_info(time_start, time_end, opts)
      data
    end
    ...
    def v1_orders_history_time_start_time_end_get_with_http_info(time_start, time_end, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: OrdersApi.v1_orders_history_time_start_time_end_get ...'
      end
      # verify the required parameter 'time_start' is set
      if @api_client.config.client_side_validation && time_start.nil?
        fail ArgumentError, "Missing the required parameter 'time_start' when calling OrdersApi.v1_orders_history_time_start_time_end_get"
      end
      # verify the required parameter 'time_end' is set
      if @api_client.config.client_side_validation && time_end.nil?
        fail ArgumentError, "Missing the required parameter 'time_end' when calling OrdersApi.v1_orders_history_time_start_time_end_get"
      end
      # resource path
      local_var_path = '/v1/orders/history/{time_start}/{time_end}'.sub('{' + 'time_start' + '}', CGI.escape(time_start.to_s)).sub('{' + 'time_end' + '}', CGI.escape(time_end.to_s))
      ...
      new_options = opts.merge(
        :operation => :"OrdersApi.v1_orders_history_time_start_time_end_get",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: OrdersApi#v1_orders_history_time_start_time_end_get\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
