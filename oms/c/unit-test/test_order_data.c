...
order_data_t* instantiate_order_data(int include_optional) {
  ...
  if (include_optional) {
    order_data = order_data_create(
      ...
      0.22,
      0.0,
      oms___rest_api_____order_data__RECEIVED,
      list_create(),
      ...
      0.045,
      0.0783,
      oms___rest_api_____order_data_SIDE_"BUY",
      oms___rest_api_____order_data_ORDERTYPE_"LIMIT",
      oms___rest_api_____order_data__GOOD_TILL_CANCEL,
      null,
      list_create()
    );
  } else {
