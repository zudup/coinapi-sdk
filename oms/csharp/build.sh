...
${nuget_cmd} install src/CoinAPI.OMS.API.SDK234567/packages.config -o packages;
...
echo "[INFO] Run 'mcs' to build bin/CoinAPI.OMS.API.SDK234567.dll"
mcs -langversion:${langversion} -sdk:${sdk} -r:bin/Newtonsoft.Json.dll,bin/JsonSubTypes.dll,\
bin/RestSharp.dll,\
System.ComponentModel.DataAnnotations.dll,\
System.Runtime.Serialization.dll \
-target:library \
-out:bin/CoinAPI.OMS.API.SDK234567.dll \
-recurse:'src/CoinAPI.OMS.API.SDK234567/*.cs' \
-doc:bin/CoinAPI.OMS.API.SDK234567.xml \
-platform:anycpu
...
then
  ...
  echo "[INFO] bin/CoinAPI.OMS.API.SDK234567.dll was created successfully"
fi
