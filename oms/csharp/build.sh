...
${nuget_cmd} install src/CoinAPI.OMS.REST.V1/packages.config -o packages;
...
echo "[INFO] Run 'mcs' to build bin/CoinAPI.OMS.REST.V1.dll"
mcs -langversion:${langversion} -sdk:${sdk} -r:bin/Newtonsoft.Json.dll,bin/JsonSubTypes.dll,\
bin/RestSharp.dll,\
System.ComponentModel.DataAnnotations.dll,\
System.Runtime.Serialization.dll \
-target:library \
-out:bin/CoinAPI.OMS.REST.V1.dll \
-recurse:'src/CoinAPI.OMS.REST.V1/*.cs' \
-doc:bin/CoinAPI.OMS.REST.V1.xml \
-platform:anycpu
...
then
  ...
  echo "[INFO] bin/CoinAPI.OMS.REST.V1.dll was created successfully"
fi
