...
namespace CoinAPI.OMS.API.SDK234567.Api
{
    ...
    public partial class BalancesApi : IBalancesApi
    {
        ...
        /// <returns></returns>
        public BalancesApi(CoinAPI.OMS.API.SDK234567.Client.Configuration configuration = null)
        {
        ...
        /// <summary>
        /// Get balances Returns all of your balances, including available balance.
        /// </summary>
        /// <exception cref="CoinAPI.OMS.API.SDK234567.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="exchangeId">Exchange name (optional)</param>
        /// <returns>List&lt;Balance&gt;</returns>
        ...
        {
             ApiResponse<List<Balance>> localVarResponse = await V1BalancesGetAsyncWithHttpInfo(exchangeId);
             return localVarResponse.Data;
        ...
        /// <param name="exchangeId">Exchange name (optional)</param>
        /// <returns>Task of ApiResponse (List&lt;Balance&gt;)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<List<Balance>>> V1BalancesGetAsyncWithHttpInfo (string exchangeId = default(string))
        {
