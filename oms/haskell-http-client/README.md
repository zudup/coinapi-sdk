...
| baseModule                      | Set the base module namespace                                                                                                 |          | OMS-RESTAPI...@                      |
| cabalPackage                    | Set the cabal package name, which consists of one or more alphanumeric words separated by hyphens                             |          | oms---rest-api-...@                    |
...
| configType                      | Set the name of the type used for configuration                                                                               |          | @Config                      |
...
| requestType                     | Set the name of the type used to generate requests                                                                            |          | @Request                     |
...
| MODULE              | NOTES                                               |
| ------------------- | --------------------------------------------------- |
| OMS-RESTAPI...@.Client    | use the "dispatch" functions to send requests       |
| OMS-RESTAPI...@.Core      | core funcions, config and request types             |
| OMS-RESTAPI...@.API       | construct api requests                              |
| OMS-RESTAPI...@.Model     | describes api models                                |
| OMS-RESTAPI...@.MimeTypes | encoding/decoding MIME types (content-types/accept) |
| OMS-RESTAPI...@.ModelLens | lenses for model fields                             |
| OMS-RESTAPI...@.Logging   | logging functions and utils                         |
