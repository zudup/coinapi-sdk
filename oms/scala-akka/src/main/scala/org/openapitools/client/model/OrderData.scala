...
case class OrderData (
  ...
  /* Buy or Sell */
  side: Option[OrderDataEnums.Side] = None,
  /* The order type. */
  orderType: Option[OrderDataEnums.OrderType] = None,
  ...
  execInst: Option[OrderDataEnums.Seq[ExecInst]] = None
) extends ApiModel

object OrderDataEnums {
