...
void
OrderLive::fromJson(char* jsonStr)
{
...
void
OrderLive::setType(std::string  type)
{
	this->type = type;
}

std::string
OrderLive::getExchangeId()
{
	return exchange_id;
}

void
OrderLive::setExchangeId(std::string  exchange_id)
{
...
void
OrderLive::setId(std::string  id)
{
	this->id = id;
}

std::string
OrderLive::getClientOrderIdFormatExchange()
{
	return client_order_id_format_exchange;
}

void
OrderLive::setClientOrderIdFormatExchange(std::string  client_order_id_format_exchange)
{
	this->client_order_id_format_exchange = client_order_id_format_exchange;
}

std::string
OrderLive::getExchangeOrderId()
{
	return exchange_order_id;
}

void
OrderLive::setExchangeOrderId(std::string  exchange_order_id)
{
	this->exchange_order_id = exchange_order_id;
}

long long
OrderLive::getAmountOpen()
{
	return amount_open;
}

void
OrderLive::setAmountOpen(long long  amount_open)
{
	this->amount_open = amount_open;
}

long long
OrderLive::getAmountFilled()
{
	return amount_filled;
}

void
OrderLive::setAmountFilled(long long  amount_filled)
{
...
void
OrderLive::setStatus(OrderStatus  status)
{
	this->status = status;
}

std::list<std::list>
OrderLive::getTimeOrder()
{
	return time_order;
}

void
OrderLive::setTimeOrder(std::list <std::list> time_order)
{
	this->time_order = time_order;
}

std::string
OrderLive::getErrorMessage()
{
	return error_message;
}

void
OrderLive::setErrorMessage(std::string  error_message)
{
	this->error_message = error_message;
}

std::string
OrderLive::getClientOrderId()
{
	return client_order_id;
}

void
OrderLive::setClientOrderId(std::string  client_order_id)
{
	this->client_order_id = client_order_id;
}

std::string
OrderLive::getSymbolExchange()
{
	return symbol_exchange;
}

void
OrderLive::setSymbolExchange(std::string  symbol_exchange)
{
	this->symbol_exchange = symbol_exchange;
}

std::string
OrderLive::getSymbolCoinapi()
{
	return symbol_coinapi;
}

void
OrderLive::setSymbolCoinapi(std::string  symbol_coinapi)
{
	this->symbol_coinapi = symbol_coinapi;
}

long long
OrderLive::getAmountOrder()
{
	return amount_order;
}

void
OrderLive::setAmountOrder(long long  amount_order)
{
...
void
OrderLive::setPrice(long long  price)
{
	this->price = price;
}
...
void
OrderLive::setSide(std::string  side)
{
	this->side = side;
}

std::string
OrderLive::getOrderType()
{
	return order_type;
}

void
OrderLive::setOrderType(std::string  order_type)
{
	this->order_type = order_type;
}

TimeInForce
OrderLive::getTimeInForce()
{
	return time_in_force;
}

void
OrderLive::setTimeInForce(TimeInForce  time_in_force)
{
	this->time_in_force = time_in_force;
}

Date
OrderLive::getExpireTime()
{
	return expire_time;
}

void
OrderLive::setExpireTime(Date  expire_time)
{
	this->expire_time = expire_time;
}

std::list<std::string>
OrderLive::getExecInst()
{
	return exec_inst;
}

void
OrderLive::setExecInst(std::list <std::string> exec_inst)
{
