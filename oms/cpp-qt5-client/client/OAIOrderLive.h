...
#ifndef OAIOrderLive_H
#define OAIOrderLive_H
...
class OAIOrderLive : public OAIObject {
public:
    OAIOrderLive();
    OAIOrderLive(QString json);
    ~OAIOrderLive() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIOrderLive)

#endif // OAIOrderLive_H
