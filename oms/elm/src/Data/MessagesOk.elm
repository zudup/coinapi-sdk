...
module Data.MessagesOk exposing (MessagesOk, decoder, encode, encodeWithTag, toString)
...
decoder : Decoder MessagesOk
decoder =
    Decode.succeed MessagesOk
...
encode : MessagesOk -> Encode.Value
encode =
    Encode.object << encodePairs


encodeWithTag : ( String, String ) -> MessagesOk -> Encode.Value
encodeWithTag (tagField, tag) model =
    Encode.object <| encodePairs model ++ [ ( tagField, Encode.string tag ) ]


encodePairs : MessagesOk -> List (String, Encode.Value)
encodePairs model =
