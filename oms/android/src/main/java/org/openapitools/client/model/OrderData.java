...
public class OrderData {
  ...
  public boolean equals(Object o) {
    ...
    return (this.exchangeId == null ? orderData.exchangeId == null : this.exchangeId.equals(orderData.exchangeId)) &&
        (this.id == null ? orderData.id == null : this.id.equals(orderData.id)) &&
        (this.clientOrderIdFormatExchange == null ? orderData.clientOrderIdFormatExchange == null : this.clientOrderIdFormatExchange.equals(orderData.clientOrderIdFormatExchange)) &&
        (this.exchangeOrderId == null ? orderData.exchangeOrderId == null : this.exchangeOrderId.equals(orderData.exchangeOrderId)) &&
        (this.amountOpen == null ? orderData.amountOpen == null : this.amountOpen.equals(orderData.amountOpen)) &&
        (this.amountFilled == null ? orderData.amountFilled == null : this.amountFilled.equals(orderData.amountFilled)) &&
        (this.status == null ? orderData.status == null : this.status.equals(orderData.status)) &&
        (this.timeOrder == null ? orderData.timeOrder == null : this.timeOrder.equals(orderData.timeOrder)) &&
        (this.errorMessage == null ? orderData.errorMessage == null : this.errorMessage.equals(orderData.errorMessage)) &&
        (this.clientOrderId == null ? orderData.clientOrderId == null : this.clientOrderId.equals(orderData.clientOrderId)) &&
        (this.symbolExchange == null ? orderData.symbolExchange == null : this.symbolExchange.equals(orderData.symbolExchange)) &&
        (this.symbolCoinapi == null ? orderData.symbolCoinapi == null : this.symbolCoinapi.equals(orderData.symbolCoinapi)) &&
        (this.amountOrder == null ? orderData.amountOrder == null : this.amountOrder.equals(orderData.amountOrder)) &&
        (this.price == null ? orderData.price == null : this.price.equals(orderData.price)) &&
        (this.side == null ? orderData.side == null : this.side.equals(orderData.side)) &&
        (this.orderType == null ? orderData.orderType == null : this.orderType.equals(orderData.orderType)) &&
        (this.timeInForce == null ? orderData.timeInForce == null : this.timeInForce.equals(orderData.timeInForce)) &&
        (this.expireTime == null ? orderData.expireTime == null : this.expireTime.equals(orderData.expireTime)) &&
        (this.execInst == null ? orderData.execInst == null : this.execInst.equals(orderData.execInst));
  }
