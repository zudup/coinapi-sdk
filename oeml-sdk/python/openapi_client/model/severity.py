...
class Severity(ModelSimple):
    ...
    def __init__(self, *args, **kwargs):
        ...
        Args:
            args[0] (str): Severity of the message.., must be one of ["INFO", "WARNING", "ERROR", ]  # noqa: E501

        Keyword Args:
            value (str): Severity of the message.., must be one of ["INFO", "WARNING", "ERROR", ]  # noqa: E501
