...
class BalancesApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.v1_balances_get_endpoint = _Endpoint(
            settings={
                'response_type': (Balances,),
                'auth': [],
                'endpoint_path': '/v1/balances',
                'operation_id': 'v1_balances_get',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
    ...
    def v1_balances_get(
        ...
        **kwargs
        ...
        return self.v1_balances_get_endpoint.call_with_http_info(**kwargs)
