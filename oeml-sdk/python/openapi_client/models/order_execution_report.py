...
class OrderExecutionReport(object):
    ...
    @property
    def time_order(self):
        """Gets the time_order of this OrderExecutionReport.  # noqa: E501

        Timestamped history of order status changes.  # noqa: E501

        :return: The time_order of this OrderExecutionReport.  # noqa: E501
        :rtype: list[list[str]]
        """
    ...
    def time_order(self, time_order):
        """Sets the time_order of this OrderExecutionReport.

        Timestamped history of order status changes.  # noqa: E501

        :param time_order: The time_order of this OrderExecutionReport.  # noqa: E501
        :type: list[list[str]]
        """
