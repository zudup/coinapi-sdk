...
-- | 
data OMS-RESTConfig = OMS-RESTConfig
...
-- | display the config
instance P.Show OMS-RESTConfig where
  show c =
    T.printf
...
-- | constructs a default OMS-RESTConfig
--
-- configHost:
--
-- @http://localhost:3001@
...
addAuthMethod :: AuthMethod auth => OMS-RESTConfig -> auth -> OMS-RESTConfig
addAuthMethod config@OMS-RESTConfig {configAuthMethods = as} a =
  config { configAuthMethods = AnyAuthMethod a : as}

-- | updates the config to use stdout logging
withStdoutLogging :: OMS-RESTConfig -> IO OMS-RESTConfig
...
withStderrLogging :: OMS-RESTConfig -> IO OMS-RESTConfig
...
withNoLogging :: OMS-RESTConfig -> OMS-RESTConfig
...
data OMS-RESTRequest req contentType res accept = OMS-RESTRequest
  { rMethod  :: NH.Method   -- ^ Method of OMS-RESTRequest
  , rUrlPath :: [BCL.ByteString] -- ^ Endpoint of OMS-RESTRequest
  , rParams   :: Params -- ^ params of OMS-RESTRequest
  , rAuthTypes :: [P.TypeRep] -- ^ types of auth methods
  }
  deriving (P.Show)

-- | 'rMethod' Lens
rMethodL :: Lens_' (OMS-RESTRequest req contentType res accept) NH.Method
rMethodL f OMS-RESTRequest{..} = (\rMethod -> OMS-RESTRequest { rMethod, ..} ) <$> f rMethod
{-# INLINE rMethodL #-}

-- | 'rUrlPath' Lens
rUrlPathL :: Lens_' (OMS-RESTRequest req contentType res accept) [BCL.ByteString]
rUrlPathL f OMS-RESTRequest{..} = (\rUrlPath -> OMS-RESTRequest { rUrlPath, ..} ) <$> f rUrlPath
{-# INLINE rUrlPathL #-}

-- | 'rParams' Lens
rParamsL :: Lens_' (OMS-RESTRequest req contentType res accept) Params
rParamsL f OMS-RESTRequest{..} = (\rParams -> OMS-RESTRequest { rParams, ..} ) <$> f rParams
{-# INLINE rParamsL #-}

-- | 'rParams' Lens
rAuthTypesL :: Lens_' (OMS-RESTRequest req contentType res accept) [P.TypeRep]
rAuthTypesL f OMS-RESTRequest{..} = (\rAuthTypes -> OMS-RESTRequest { rAuthTypes, ..} ) <$> f rAuthTypes
{-# INLINE rAuthTypesL #-}
...
class HasBodyParam req param where
  setBodyParam :: forall contentType res accept. (Consumes req contentType, MimeRender contentType param) => OMS-RESTRequest req contentType res accept -> param -> OMS-RESTRequest req contentType res accept
  setBodyParam req xs =
...
class HasOptionalParam req param where
  ...
  applyOptionalParam :: OMS-RESTRequest req contentType res accept -> param -> OMS-RESTRequest req contentType res accept
  applyOptionalParam = (-&-)
  {-# INLINE applyOptionalParam #-}

  -- | infix operator \/ alias for 'addOptionalParam'
  (-&-) :: OMS-RESTRequest req contentType res accept -> param -> OMS-RESTRequest req contentType res accept
  (-&-) = applyOptionalParam
  {-# INLINE (-&-) #-}
...
-- ** OMS-RESTRequest Utils

_mkRequest :: NH.Method -- ^ Method 
          -> [BCL.ByteString] -- ^ Endpoint
          -> OMS-RESTRequest req contentType res accept -- ^ req: Request Type, res: Response Type
_mkRequest m u = OMS-RESTRequest m u _mkParams []

_mkParams :: Params
_mkParams = Params [] [] ParamBodyNone

setHeader :: OMS-RESTRequest req contentType res accept -> [NH.Header] -> OMS-RESTRequest req contentType res accept
setHeader req header =
  req `removeHeader` P.fmap P.fst header &
  L.over (rParamsL . paramsHeadersL) (header P.++)

removeHeader :: OMS-RESTRequest req contentType res accept -> [NH.HeaderName] -> OMS-RESTRequest req contentType res accept
...
_setContentTypeHeader :: forall req contentType res accept. MimeType contentType => OMS-RESTRequest req contentType res accept -> OMS-RESTRequest req contentType res accept
_setContentTypeHeader req =
    case mimeType (P.Proxy :: P.Proxy contentType) of 
        Just m -> req `setHeader` [("content-type", BC.pack $ P.show m)]
        Nothing -> req `removeHeader` ["content-type"]

_setAcceptHeader :: forall req contentType res accept. MimeType accept => OMS-RESTRequest req contentType res accept -> OMS-RESTRequest req contentType res accept
_setAcceptHeader req =
    case mimeType (P.Proxy :: P.Proxy accept) of 
        Just m -> req `setHeader` [("accept", BC.pack $ P.show m)]
        Nothing -> req `removeHeader` ["accept"]

setQuery :: OMS-RESTRequest req contentType res accept -> [NH.QueryItem] -> OMS-RESTRequest req contentType res accept
setQuery req query = 
  req &
  L.over
...
addForm :: OMS-RESTRequest req contentType res accept -> WH.Form -> OMS-RESTRequest req contentType res accept
addForm req newform = 
...
_addMultiFormPart :: OMS-RESTRequest req contentType res accept -> NH.Part -> OMS-RESTRequest req contentType res accept
...
_setBodyBS :: OMS-RESTRequest req contentType res accept -> B.ByteString -> OMS-RESTRequest req contentType res accept
_setBodyBS req body = 
    req & L.set (rParamsL . paramsBodyL) (ParamBodyB body)

_setBodyLBS :: OMS-RESTRequest req contentType res accept -> BL.ByteString -> OMS-RESTRequest req contentType res accept
_setBodyLBS req body = 
    req & L.set (rParamsL . paramsBodyL) (ParamBodyBL body)

_hasAuthType :: AuthMethod authMethod => OMS-RESTRequest req contentType res accept -> P.Proxy authMethod -> OMS-RESTRequest req contentType res accept
...
class P.Typeable a =>
  ...
  applyAuthMethod
    :: OMS-RESTConfig
    -> a
    -> OMS-RESTRequest req contentType res accept
    -> IO (OMS-RESTRequest req contentType res accept)
...
_applyAuthMethods
  ...
  -> OMS-RESTConfig
  -> IO (OMS-RESTRequest req contentType res accept)
_applyAuthMethods req config@(OMS-RESTConfig {configAuthMethods = as}) =
  foldlM go req as
  where
