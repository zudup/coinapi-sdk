...
-- | display the config
instance P.Show OEML-RESTConfig where
  show c =
    T.printf
...
-- | constructs a default OEML-RESTConfig
--
-- configHost:
--
...
addAuthMethod config@OEML-RESTConfig {configAuthMethods = as} a =
  config { configAuthMethods = AnyAuthMethod a : as}

-- | updates the config to use stdout logging
withStdoutLogging :: OEML-RESTConfig -> IO OEML-RESTConfig
...
withStderrLogging :: OEML-RESTConfig -> IO OEML-RESTConfig
...
data OEML-RESTRequest req contentType res accept = OEML-RESTRequest
  { rMethod  :: NH.Method   -- ^ Method of OEML-RESTRequest
  , rUrlPath :: [BCL.ByteString] -- ^ Endpoint of OEML-RESTRequest
  , rParams   :: Params -- ^ params of OEML-RESTRequest
  , rAuthTypes :: [P.TypeRep] -- ^ types of auth methods
  }
  deriving (P.Show)

-- | 'rMethod' Lens
rMethodL :: Lens_' (OEML-RESTRequest req contentType res accept) NH.Method
rMethodL f OEML-RESTRequest{..} = (\rMethod -> OEML-RESTRequest { rMethod, ..} ) <$> f rMethod
{-# INLINE rMethodL #-}

-- | 'rUrlPath' Lens
rUrlPathL :: Lens_' (OEML-RESTRequest req contentType res accept) [BCL.ByteString]
rUrlPathL f OEML-RESTRequest{..} = (\rUrlPath -> OEML-RESTRequest { rUrlPath, ..} ) <$> f rUrlPath
{-# INLINE rUrlPathL #-}

-- | 'rParams' Lens
rParamsL :: Lens_' (OEML-RESTRequest req contentType res accept) Params
rParamsL f OEML-RESTRequest{..} = (\rParams -> OEML-RESTRequest { rParams, ..} ) <$> f rParams
{-# INLINE rParamsL #-}

-- | 'rParams' Lens
rAuthTypesL :: Lens_' (OEML-RESTRequest req contentType res accept) [P.TypeRep]
rAuthTypesL f OEML-RESTRequest{..} = (\rAuthTypes -> OEML-RESTRequest { rAuthTypes, ..} ) <$> f rAuthTypes
{-# INLINE rAuthTypesL #-}
...
class HasBodyParam req param where
  setBodyParam :: forall contentType res accept. (Consumes req contentType, MimeRender contentType param) => OEML-RESTRequest req contentType res accept -> param -> OEML-RESTRequest req contentType res accept
  setBodyParam req xs =
...
class HasOptionalParam req param where
  ...
  applyOptionalParam :: OEML-RESTRequest req contentType res accept -> param -> OEML-RESTRequest req contentType res accept
  applyOptionalParam = (-&-)
  {-# INLINE applyOptionalParam #-}

  -- | infix operator \/ alias for 'addOptionalParam'
  (-&-) :: OEML-RESTRequest req contentType res accept -> param -> OEML-RESTRequest req contentType res accept
  (-&-) = applyOptionalParam
  {-# INLINE (-&-) #-}
...
setHeader :: OEML-RESTRequest req contentType res accept -> [NH.Header] -> OEML-RESTRequest req contentType res accept
setHeader req header =
  req `removeHeader` P.fmap P.fst header &
  L.over (rParamsL . paramsHeadersL) (header P.++)

removeHeader :: OEML-RESTRequest req contentType res accept -> [NH.HeaderName] -> OEML-RESTRequest req contentType res accept
...
setQuery :: OEML-RESTRequest req contentType res accept -> [NH.QueryItem] -> OEML-RESTRequest req contentType res accept
setQuery req query = 
  req &
  L.over
...
class P.Typeable a =>
  ...
  applyAuthMethod
    :: OEML-RESTConfig
    -> a
    -> OEML-RESTRequest req contentType res accept
    -> IO (OEML-RESTRequest req contentType res accept)
...
_applyAuthMethods
  ...
  -> OEML-RESTConfig
  -> IO (OEML-RESTRequest req contentType res accept)
_applyAuthMethods req config@(OEML-RESTConfig {configAuthMethods = as}) =
  foldlM go req as
  where
