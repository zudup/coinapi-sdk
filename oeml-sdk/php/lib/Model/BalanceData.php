...
class BalanceData implements ModelInterface, ArrayAccess
{
    ...
    {
        $this->container['asset_id_exchange'] = isset($data['asset_id_exchange']) ? $data['asset_id_exchange'] : null;
        $this->container['asset_id_coinapi'] = isset($data['asset_id_coinapi']) ? $data['asset_id_coinapi'] : null;
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['last_updated_by']) && !in_array($this->container['last_updated_by'], $allowedValues, true)) {
            $invalidProperties[] = sprintf(
                "invalid value for 'last_updated_by', must be one of '%s'",
