...
order_execution_report_t* instantiate_order_execution_report(int include_optional) {
  ...
  if (include_optional) {
    order_execution_report = order_execution_report_create(
      ...
      oeml___rest_api_order_execution_report__"LIMIT",
      oeml___rest_api_order_execution_report__"GOOD_TILL_CANCEL",
      ...
      0.22,
      0.0,
      oeml___rest_api_order_execution_report__RECEIVED,
      list_create(),
