...
typedef enum  { oeml___rest_api_order_execution_report_all_of__NULL = 0, oeml___rest_api_order_execution_report_all_of__RECEIVED, oeml___rest_api_order_execution_report_all_of__ROUTING, oeml___rest_api_order_execution_report_all_of__ROUTED, oeml___rest_api_order_execution_report_all_of___NEW, oeml___rest_api_order_execution_report_all_of__PENDING_CANCEL, oeml___rest_api_order_execution_report_all_of__PARTIALLY_FILLED, oeml___rest_api_order_execution_report_all_of__FILLED, oeml___rest_api_order_execution_report_all_of__CANCELED, oeml___rest_api_order_execution_report_all_of__REJECTED } oeml___rest_api_order_execution_report_all_of__e;
