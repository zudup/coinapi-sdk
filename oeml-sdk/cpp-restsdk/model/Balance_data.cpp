...
bool Balance_data::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    ...
    {
        utility::string_t refVal_asset_id_exchange;
        ok &= ModelBase::fromHttpContent(multipart->getContent(utility::conversions::to_string_t(U("asset_id_exchange"))), refVal_asset_id_exchange );
        setAssetIdExchange(refVal_asset_id_exchange);
    }
    if(multipart->hasContent(utility::conversions::to_string_t(U("asset_id_coinapi"))))
    {
        utility::string_t refVal_asset_id_coinapi;
        ok &= ModelBase::fromHttpContent(multipart->getContent(utility::conversions::to_string_t(U("asset_id_coinapi"))), refVal_asset_id_coinapi );
        setAssetIdCoinapi(refVal_asset_id_coinapi);
    }
    ...
    {
        double refVal_available;
        ok &= ModelBase::fromHttpContent(multipart->getContent(utility::conversions::to_string_t(U("available"))), refVal_available );
        setAvailable(refVal_available);
    }
    if(multipart->hasContent(utility::conversions::to_string_t(U("locked"))))
    {
        double refVal_locked;
        ok &= ModelBase::fromHttpContent(multipart->getContent(utility::conversions::to_string_t(U("locked"))), refVal_locked );
        setLocked(refVal_locked);
    }
    if(multipart->hasContent(utility::conversions::to_string_t(U("last_updated_by"))))
    {
        utility::string_t refVal_last_updated_by;
        ok &= ModelBase::fromHttpContent(multipart->getContent(utility::conversions::to_string_t(U("last_updated_by"))), refVal_last_updated_by );
        setLastUpdatedBy(refVal_last_updated_by);
    }
    if(multipart->hasContent(utility::conversions::to_string_t(U("rate_usd"))))
    {
        double refVal_rate_usd;
        ok &= ModelBase::fromHttpContent(multipart->getContent(utility::conversions::to_string_t(U("rate_usd"))), refVal_rate_usd );
        setRateUsd(refVal_rate_usd);
    }
    if(multipart->hasContent(utility::conversions::to_string_t(U("traded"))))
    {
        double refVal_traded;
        ok &= ModelBase::fromHttpContent(multipart->getContent(utility::conversions::to_string_t(U("traded"))), refVal_traded );
        setTraded(refVal_traded);
    }
    return ok;
}
