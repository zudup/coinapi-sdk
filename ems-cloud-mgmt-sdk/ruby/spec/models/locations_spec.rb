...
# Unit tests for OpenapiClient::Locations
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::Locations do
  let(:instance) { OpenapiClient::Locations.new }

  describe 'test an instance of Locations' do
    it 'should create an instance of Locations' do
      expect(instance).to be_instance_of(OpenapiClient::Locations)
    end
  end
