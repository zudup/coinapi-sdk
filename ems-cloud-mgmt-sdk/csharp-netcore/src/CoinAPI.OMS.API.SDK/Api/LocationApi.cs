...
namespace CoinAPI.OMS.API.SDK.Api
{
    ...
    public interface ILocationApiSync : IApiAccessor
    {
        ...
        /// </remarks>
        /// <exception cref="CoinAPI.OMS.API.SDK.Client.ApiException">Thrown when fails to make API call</exception>
        /// <returns>ApiResponse of List&lt;Locations&gt;</returns>
        ApiResponse<List<Locations>> LocationsWithHttpInfo();
    ...
    public interface ILocationApiAsync : IApiAccessor
    {
        ...
        System.Threading.Tasks.Task<List<Locations>> LocationsAsync(System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        ...
        /// <exception cref="CoinAPI.OMS.API.SDK.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (List&lt;Locations&gt;)</returns>
        System.Threading.Tasks.Task<ApiResponse<List<Locations>>> LocationsWithHttpInfoAsync(System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
    ...
    public partial class LocationApi : ILocationApi
    {
        ...
        /// <returns></returns>
        public LocationApi(CoinAPI.OMS.API.SDK.Client.Configuration configuration)
        {
        ...
        public LocationApi(CoinAPI.OMS.API.SDK.Client.ISynchronousClient client, CoinAPI.OMS.API.SDK.Client.IAsynchronousClient asyncClient, CoinAPI.OMS.API.SDK.Client.IReadableConfiguration configuration)
        {
        ...
        /// <summary>
        /// Get site locations This endpoint providing information about the server site locations supported in the EMS API.
        /// </summary>
        /// <exception cref="CoinAPI.OMS.API.SDK.Client.ApiException">Thrown when fails to make API call</exception>
        /// <returns>List&lt;Locations&gt;</returns>
        public List<Locations> Locations()
        {
            CoinAPI.OMS.API.SDK.Client.ApiResponse<List<Locations>> localVarResponse = LocationsWithHttpInfo();
        ...
        /// <exception cref="CoinAPI.OMS.API.SDK.Client.ApiException">Thrown when fails to make API call</exception>
        /// <returns>ApiResponse of List&lt;Locations&gt;</returns>
        public CoinAPI.OMS.API.SDK.Client.ApiResponse<List<Locations>> LocationsWithHttpInfo()
        {
            ...
            var localVarResponse = this.Client.Get<List<Locations>>("/v1/locations", localVarRequestOptions, this.Configuration);
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of List&lt;Locations&gt;</returns>
        public async System.Threading.Tasks.Task<List<Locations>> LocationsAsync(System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            CoinAPI.OMS.API.SDK.Client.ApiResponse<List<Locations>> localVarResponse = await LocationsWithHttpInfoAsync(cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (List&lt;Locations&gt;)</returns>
        public async System.Threading.Tasks.Task<CoinAPI.OMS.API.SDK.Client.ApiResponse<List<Locations>>> LocationsWithHttpInfoAsync(System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            ...
            // make the HTTP request
            var localVarResponse = await this.AsynchronousClient.GetAsync<List<Locations>>("/v1/locations", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
