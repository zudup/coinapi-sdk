...
feature {NONE} -- Initialization
	...
	make
		do
			...
			authentications.force (create {API_KEY_AUTH}.make ("header", "X-CoinAPI-Key"), "APIKeyHeader")
			is_api_key_configured := True 
			authentications.force (create {API_KEY_AUTH}.make ("query", "apikey"), "APIKeyQueryParam")
			is_api_key_configured := True 
		end

feature -- Access

	default_base_path: STRING = "https://ems-mgmt-sandbox.coinapi.io"
			-- default base path.
