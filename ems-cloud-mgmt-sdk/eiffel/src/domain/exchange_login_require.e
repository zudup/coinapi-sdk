...
feature --Access
    ...
    location_id: detachable STRING_32
      -- Location identifier
    required_parameters: detachable LIST [STRING_32]
...
feature -- Change Element
    ...
    set_required_parameters (a_name: like required_parameters)
        -- Set 'required_parameters' with 'a_name'.
      do
        required_parameters := a_name
      ensure
        required_parameters_set: required_parameters = a_name
      end
 ...
 feature -- Status Report
    ...
    output: STRING
      ...
      do
        ...
        Result.append("%Nclass EXCHANGE_LOGIN_REQUIRE%N")
        ...
        if attached required_parameters as l_required_parameters then
          across l_required_parameters as ic loop
            Result.append ("%N required_parameters:")
