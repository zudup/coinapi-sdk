...
module EMS-ManagedCloudREST.API.Certificate where
...
-- 
certificate
  :: EMS-ManagedCloudRESTRequest Certificate MimeNoContent Text MimePlainText
certificate =
  _mkRequest "GET" ["/v1/certificate/pem"]
    `_hasAuthType` (P.Proxy :: P.Proxy AuthApiKeyAPIKeyHeader)
    `_hasAuthType` (P.Proxy :: P.Proxy AuthApiKeyAPIKeyQueryParam)

data Certificate  
-- | @text/plain@
instance Produces Certificate MimePlainText
