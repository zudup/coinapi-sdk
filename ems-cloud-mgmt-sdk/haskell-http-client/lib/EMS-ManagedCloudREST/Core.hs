...
{-|
Module : EMS-ManagedCloudREST.Core
-}
...
module EMS-ManagedCloudREST.Core where
...
-- * EMS-ManagedCloudRESTConfig

-- |
data EMS-ManagedCloudRESTConfig = EMS-ManagedCloudRESTConfig
...
-- | display the config
instance P.Show EMS-ManagedCloudRESTConfig where
  show c =
    T.printf
...
-- | constructs a default EMS-ManagedCloudRESTConfig
--
-- configHost:
--
...
-- configUserAgent:
--
-- @"ems---managed-cloud-rest/0.1.0.0"@
--
newConfig :: IO EMS-ManagedCloudRESTConfig
newConfig = do
    logCxt <- initLogContext
    return $ EMS-ManagedCloudRESTConfig
        { configHost = "https://ems-mgmt-sandbox.coinapi.io"
        , configUserAgent = "ems---managed-cloud-rest/0.1.0.0"
...
addAuthMethod :: AuthMethod auth => EMS-ManagedCloudRESTConfig -> auth -> EMS-ManagedCloudRESTConfig
addAuthMethod config@EMS-ManagedCloudRESTConfig {configAuthMethods = as} a =
  config { configAuthMethods = AnyAuthMethod a : as}

-- | updates the config to use stdout logging
withStdoutLogging :: EMS-ManagedCloudRESTConfig -> IO EMS-ManagedCloudRESTConfig
...
withStderrLogging :: EMS-ManagedCloudRESTConfig -> IO EMS-ManagedCloudRESTConfig
...
withNoLogging :: EMS-ManagedCloudRESTConfig -> EMS-ManagedCloudRESTConfig
withNoLogging p = p { configLogExecWithContext =  runNullLogExec}

-- * EMS-ManagedCloudRESTRequest
...
data EMS-ManagedCloudRESTRequest req contentType res accept = EMS-ManagedCloudRESTRequest
  { rMethod  :: NH.Method   -- ^ Method of EMS-ManagedCloudRESTRequest
  , rUrlPath :: [BCL.ByteString] -- ^ Endpoint of EMS-ManagedCloudRESTRequest
  , rParams   :: Params -- ^ params of EMS-ManagedCloudRESTRequest
  , rAuthTypes :: [P.TypeRep] -- ^ types of auth methods
  }
  deriving (P.Show)

-- | 'rMethod' Lens
rMethodL :: Lens_' (EMS-ManagedCloudRESTRequest req contentType res accept) NH.Method
rMethodL f EMS-ManagedCloudRESTRequest{..} = (\rMethod -> EMS-ManagedCloudRESTRequest { rMethod, ..} ) <$> f rMethod
{-# INLINE rMethodL #-}

-- | 'rUrlPath' Lens
rUrlPathL :: Lens_' (EMS-ManagedCloudRESTRequest req contentType res accept) [BCL.ByteString]
rUrlPathL f EMS-ManagedCloudRESTRequest{..} = (\rUrlPath -> EMS-ManagedCloudRESTRequest { rUrlPath, ..} ) <$> f rUrlPath
{-# INLINE rUrlPathL #-}

-- | 'rParams' Lens
rParamsL :: Lens_' (EMS-ManagedCloudRESTRequest req contentType res accept) Params
rParamsL f EMS-ManagedCloudRESTRequest{..} = (\rParams -> EMS-ManagedCloudRESTRequest { rParams, ..} ) <$> f rParams
{-# INLINE rParamsL #-}

-- | 'rParams' Lens
rAuthTypesL :: Lens_' (EMS-ManagedCloudRESTRequest req contentType res accept) [P.TypeRep]
rAuthTypesL f EMS-ManagedCloudRESTRequest{..} = (\rAuthTypes -> EMS-ManagedCloudRESTRequest { rAuthTypes, ..} ) <$> f rAuthTypes
{-# INLINE rAuthTypesL #-}
...
class HasBodyParam req param where
  setBodyParam :: forall contentType res accept. (Consumes req contentType, MimeRender contentType param) => EMS-ManagedCloudRESTRequest req contentType res accept -> param -> EMS-ManagedCloudRESTRequest req contentType res accept
  setBodyParam req xs =
...
class HasOptionalParam req param where
  ...
  applyOptionalParam :: EMS-ManagedCloudRESTRequest req contentType res accept -> param -> EMS-ManagedCloudRESTRequest req contentType res accept
  applyOptionalParam = (-&-)
  {-# INLINE applyOptionalParam #-}

  -- | infix operator \/ alias for 'addOptionalParam'
  (-&-) :: EMS-ManagedCloudRESTRequest req contentType res accept -> param -> EMS-ManagedCloudRESTRequest req contentType res accept
  (-&-) = applyOptionalParam
  {-# INLINE (-&-) #-}
...
-- ** EMS-ManagedCloudRESTRequest Utils

_mkRequest :: NH.Method -- ^ Method
          -> [BCL.ByteString] -- ^ Endpoint
          -> EMS-ManagedCloudRESTRequest req contentType res accept -- ^ req: Request Type, res: Response Type
_mkRequest m u = EMS-ManagedCloudRESTRequest m u _mkParams []

_mkParams :: Params
_mkParams = Params [] [] ParamBodyNone

setHeader ::
     EMS-ManagedCloudRESTRequest req contentType res accept
  -> [NH.Header]
  -> EMS-ManagedCloudRESTRequest req contentType res accept
...
removeHeader :: EMS-ManagedCloudRESTRequest req contentType res accept -> [NH.HeaderName] -> EMS-ManagedCloudRESTRequest req contentType res accept
...
_setContentTypeHeader :: forall req contentType res accept. MimeType contentType => EMS-ManagedCloudRESTRequest req contentType res accept -> EMS-ManagedCloudRESTRequest req contentType res accept
_setContentTypeHeader req =
    case mimeType (P.Proxy :: P.Proxy contentType) of
        Just m -> req `setHeader` [("content-type", BC.pack $ P.show m)]
        Nothing -> req `removeHeader` ["content-type"]

_setAcceptHeader :: forall req contentType res accept. MimeType accept => EMS-ManagedCloudRESTRequest req contentType res accept -> EMS-ManagedCloudRESTRequest req contentType res accept
...
addForm :: EMS-ManagedCloudRESTRequest req contentType res accept -> WH.Form -> EMS-ManagedCloudRESTRequest req contentType res accept
addForm req newform =
...
_addMultiFormPart :: EMS-ManagedCloudRESTRequest req contentType res accept -> NH.Part -> EMS-ManagedCloudRESTRequest req contentType res accept
...
_setBodyBS :: EMS-ManagedCloudRESTRequest req contentType res accept -> B.ByteString -> EMS-ManagedCloudRESTRequest req contentType res accept
_setBodyBS req body =
    req & L.set (rParamsL . paramsBodyL) (ParamBodyB body)

_setBodyLBS :: EMS-ManagedCloudRESTRequest req contentType res accept -> BL.ByteString -> EMS-ManagedCloudRESTRequest req contentType res accept
_setBodyLBS req body =
    req & L.set (rParamsL . paramsBodyL) (ParamBodyBL body)

_hasAuthType :: AuthMethod authMethod => EMS-ManagedCloudRESTRequest req contentType res accept -> P.Proxy authMethod -> EMS-ManagedCloudRESTRequest req contentType res accept
...
class P.Typeable a =>
  ...
  applyAuthMethod
    ...
    -> a
    -> EMS-ManagedCloudRESTRequest req contentType res accept
    -> IO (EMS-ManagedCloudRESTRequest req contentType res accept)
...
_applyAuthMethods
  ...
  -> EMS-ManagedCloudRESTConfig
  -> IO (EMS-ManagedCloudRESTRequest req contentType res accept)
_applyAuthMethods req config@(EMS-ManagedCloudRESTConfig {configAuthMethods = as}) =
  foldlM go req as
  where
