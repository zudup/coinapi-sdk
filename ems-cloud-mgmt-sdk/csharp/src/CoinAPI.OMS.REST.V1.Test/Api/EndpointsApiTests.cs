...
namespace CoinAPI.OMS.REST.V1.Test
{
    ...
    public class EndpointsApiTests
    {
        ...
        {
            // TODO uncomment below to test 'IsInstanceOf' EndpointsApi
            //Assert.IsInstanceOf(typeof(EndpointsApi), instance);
        }
        ...
        public void EndpointsTest()
        {
            ...
            //var response = instance.Endpoints(filterExchangeId);
            //Assert.IsInstanceOf(typeof(List<AccountEndpoint>), response, "response is List<AccountEndpoint>");
        }
