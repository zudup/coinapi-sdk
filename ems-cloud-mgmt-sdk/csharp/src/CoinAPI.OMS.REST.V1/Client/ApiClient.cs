...
namespace CoinAPI.OMS.REST.V1.Client
{
    ...
    public partial class ApiClient
    {
        ...
        public ApiClient()
        {
            ...
            RestClient = new RestClient("https://ems-mgmt-sandbox.coinapi.io");
        }

        /// <summary>
        /// Initializes a new instance of the <see cref="ApiClient" /> class
        /// with default base path (https://ems-mgmt-sandbox.coinapi.io).
        /// </summary>
        ...
        public ApiClient(String basePath = "https://ems-mgmt-sandbox.coinapi.io")
        {
