(ns ems-managed-cloud-rest-api.core
...
(def auth-definitions
  {"APIKeyHeader" {:type :api-key :in :header :param-name "X-CoinAPI-Key"}
   "APIKeyQueryParam" {:type :api-key :in :query :param-name "apikey"}})

(def default-api-context
  "Default API context."
  {:base-url        "https://ems-mgmt-sandbox.coinapi.io"
   :date-format     "yyyy-MM-dd"
   :datetime-format "yyyy-MM-dd'T'HH:mm:ss.SSSXXX"
   :decode-models   false
   :debug           false
   :auths           {"APIKeyHeader" nil
                     "APIKeyQueryParam" nil}})
