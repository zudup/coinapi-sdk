(defproject ems-managed-cloud-rest-api "v1"
  :description "This section will provide necessary information about the `CoinAPI EMS Managed Cloud REST API` protocol. 
<br/><br/>
