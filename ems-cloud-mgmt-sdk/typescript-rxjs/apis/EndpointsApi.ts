...
export class EndpointsApi extends BaseAPI {
     ...
     * Get API endpoints
     */
    endpoints({ filterExchangeId }: EndpointsRequest): Observable<Array<AccountEndpoint>>
    endpoints({ filterExchangeId }: EndpointsRequest, opts?: OperationOpts): Observable<RawAjaxResponse<Array<AccountEndpoint>>>
    endpoints({ filterExchangeId }: EndpointsRequest, opts?: OperationOpts): Observable<Array<AccountEndpoint> | RawAjaxResponse<Array<AccountEndpoint>>> {
        ...
        return this.request<Array<AccountEndpoint>>({
            url: '/v1/endpoints',
            method: 'GET',
            headers,
            query,
