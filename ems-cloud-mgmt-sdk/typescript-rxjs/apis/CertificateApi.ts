...
export class CertificateApi extends BaseAPI {
     ...
     */
    certificate(): Observable<string>
    certificate(opts?: OperationOpts): Observable<RawAjaxResponse<string>>
    certificate(opts?: OperationOpts): Observable<string | RawAjaxResponse<string>> {
