...
export class ExchangeApi extends BaseAPI {
     ...
     */
    exchangeLoginRequire(): Observable<Array<ExchangeLoginRequire>>
    exchangeLoginRequire(opts?: OperationOpts): Observable<RawAjaxResponse<Array<ExchangeLoginRequire>>>
    exchangeLoginRequire(opts?: OperationOpts): Observable<Array<ExchangeLoginRequire> | RawAjaxResponse<Array<ExchangeLoginRequire>>> {
        const headers: HttpHeaders = {
            ...(this.configuration.apiKey && { 'X-CoinAPI-Key': this.configuration.apiKey('X-CoinAPI-Key') }), // APIKeyHeader authentication
        };

        return this.request<Array<ExchangeLoginRequire>>({
            url: '/v1/exchanges',
            method: 'GET',
            headers,
        }, opts?.responseOpts);
