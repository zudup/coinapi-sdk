...
export class LocationApi extends BaseAPI {
     ...
     * Get site locations
     */
    locations(): Observable<Array<Locations>>
    locations(opts?: OperationOpts): Observable<RawAjaxResponse<Array<Locations>>>
    locations(opts?: OperationOpts): Observable<Array<Locations> | RawAjaxResponse<Array<Locations>>> {
        const headers: HttpHeaders = {
            ...(this.configuration.apiKey && { 'X-CoinAPI-Key': this.configuration.apiKey('X-CoinAPI-Key') }), // APIKeyHeader authentication
        };

        return this.request<Array<Locations>>({
            url: '/v1/locations',
            method: 'GET',
            headers,
        }, opts?.responseOpts);
