...
AccountAPI_deleteAccount(apiClient_t *apiClient, list_t * exchange_id )
{
    ...
    // create the path
    long sizeOfPath = strlen("/v1/accounts")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/v1/accounts");
    ...
    if (exchange_id)
    {
        list_addElement(localVarQueryParameters,exchange_id);
    }
...
AccountAPI_deleteAccountAll(apiClient_t *apiClient)
{
    ...
    // create the path
    long sizeOfPath = strlen("/v1/accounts/all")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/v1/accounts/all");
...
AccountAPI_getAccount(apiClient_t *apiClient, list_t * filter_exchange_id )
{
    ...
    {
        list_addElement(localVarQueryParameters,filter_exchange_id);
    }
...
AccountAPI_persistAccount(apiClient_t *apiClient, account_data_t * body )
{
    ...
    {
        //string
        localVarSingleItemJSON_body = account_data_convertToJSON(body);
