...
class Locations implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * Sets location_id
     *
     * @param string|null $location_id CoinAPI location identifier
     *
     * @return self
     */
     ...
     * Sets region_name
     *
     * @param string|null $region_name Identifier of the region by the location provider
     *
     * @return self
     */
     ...
     * Sets provider_name
     *
     * @param string|null $provider_name Identifier of the location provider
     *
     * @return self
     */
