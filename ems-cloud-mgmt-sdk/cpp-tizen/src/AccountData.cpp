...
void
AccountData::fromJson(char* jsonStr)
{
...
AccountData::AccountData(char* json)
{
	this->fromJson(json);
}
...
std::string
AccountData::getExchangeId()
{
	return exchange_id;
}

void
AccountData::setExchangeId(std::string  exchange_id)
{
	this->exchange_id = exchange_id;
}

std::list<KeyValue>
AccountData::getParameters()
{
	return parameters;
}

void
AccountData::setParameters(std::list <KeyValue> parameters)
{
