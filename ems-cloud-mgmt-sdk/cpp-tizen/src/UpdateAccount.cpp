...
void
UpdateAccount::fromJson(char* jsonStr)
{
...
UpdateAccount::UpdateAccount(char* json)
{
	this->fromJson(json);
}
...
std::string
UpdateAccount::getExchangeId()
{
	return exchange_id;
}

void
UpdateAccount::setExchangeId(std::string  exchange_id)
{
	this->exchange_id = exchange_id;
}

std::list<KeyValue>
UpdateAccount::getParameters()
{
	return parameters;
}

void
UpdateAccount::setParameters(std::list <KeyValue> parameters)
{
