...
class OrdersApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.v1_orders_history_time_start_time_end_get_endpoint = _Endpoint(
            settings={
                'response_type': (OrderHistoryArray,),
                'auth': [],
                'endpoint_path': '/v1/orders/history/{time_start}/{time_end}',
                'operation_id': 'v1_orders_history_time_start_time_end_get',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
    ...
    def v1_orders_history_time_start_time_end_get(
        ...
        **kwargs
        ...
        Based on the date range, all changes registered in the orderbook.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.v1_orders_history_time_start_time_end_get(time_start, time_end, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['time_end'] = \
            time_end
        return self.v1_orders_history_time_start_time_end_get_endpoint.call_with_http_info(**kwargs)
