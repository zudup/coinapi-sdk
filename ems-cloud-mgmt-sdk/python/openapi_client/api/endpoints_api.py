...
class EndpointsApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.endpoints_endpoint = _Endpoint(
            settings={
                'response_type': ([AccountEndpoint],),
                'auth': [
                    'APIKeyHeader',
                    'APIKeyQueryParam'
                ],
    ...
    def endpoints(
        ...
        **kwargs
        ...
        Get all API endpoints that the EMS API expose for your subscription.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.endpoints(async_req=True)
        >>> result = thread.get()
        ...
        return self.endpoints_endpoint.call_with_http_info(**kwargs)
