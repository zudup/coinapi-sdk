...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EmsManagedCloudRestApi.AccountData();
  });
  ...
  describe('AccountData', function() {
    it('should create an instance of AccountData', function() {
      ...
      //var instance = new EmsManagedCloudRestApi.AccountData();
      //expect(instance).to.be.a(EmsManagedCloudRestApi.AccountData);
    });
