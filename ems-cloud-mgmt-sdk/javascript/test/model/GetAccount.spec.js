...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EmsManagedCloudRestApi.GetAccount();
  });
  ...
  describe('GetAccount', function() {
    it('should create an instance of GetAccount', function() {
      ...
      //var instance = new EmsManagedCloudRestApi.GetAccount();
      //expect(instance).to.be.a(EmsManagedCloudRestApi.GetAccount);
    });
