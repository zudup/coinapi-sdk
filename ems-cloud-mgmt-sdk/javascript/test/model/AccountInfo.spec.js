...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EmsManagedCloudRestApi.AccountInfo();
  });
  ...
  describe('AccountInfo', function() {
    it('should create an instance of AccountInfo', function() {
      ...
      //var instance = new EmsManagedCloudRestApi.AccountInfo();
      //expect(instance).to.be.a(EmsManagedCloudRestApi.AccountInfo);
    });
