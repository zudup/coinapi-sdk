...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EmsManagedCloudRestApi.Locations();
  });
  ...
  describe('Locations', function() {
    it('should create an instance of Locations', function() {
      ...
      //var instance = new EmsManagedCloudRestApi.Locations();
      //expect(instance).to.be.a(EmsManagedCloudRestApi.Locations);
    });
