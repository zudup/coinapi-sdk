...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EmsManagedCloudRestApi.AccountEndpoint();
  });
  ...
  describe('AccountEndpoint', function() {
    it('should create an instance of AccountEndpoint', function() {
      // uncomment below and update the code to test AccountEndpoint
      //var instance = new EmsManagedCloudRestApi.AccountEndpoint();
      //expect(instance).to.be.a(EmsManagedCloudRestApi.AccountEndpoint);
    });
    ...
    it('should have the property endpointHost (base name: "endpoint_host")', function() {
      // uncomment below and update the code to test the property endpointHost
      //var instance = new EmsManagedCloudRestApi.AccountEndpoint();
      //expect(instance).to.be();
    });
