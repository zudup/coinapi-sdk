 ...
 * 
 *
 * @param exchangeId Exchange identifier and optional tag identifying specific account configured when the software will be managing multiple accounts on the same exchange; for eg:  <code>BITSTAMP</code> <code>BITSTAMP/7c177641-74bd-4dbe-9b01-2497c12a5f70`</code> <code>BITSTAMP/2574</code> Allowed separators between the exchange identifier and the tag: <code>~/.,:;\\!@#$%^&*-_+=.</code> 
 * @param locationId Location identifier
 * @param endpointSchema Endpoint schema
 * @param endpointHost Endpoint host
 * @param endpointUrl Endpoint URL
 */

data class AccountEndpoint (
    ...
    /* Endpoint schema */
    @Json(name = "endpoint_schema")
    val endpointSchema: kotlin.String? = null,

    /* Endpoint host */
    @Json(name = "endpoint_host")
    val endpointHost: kotlin.String? = null,
