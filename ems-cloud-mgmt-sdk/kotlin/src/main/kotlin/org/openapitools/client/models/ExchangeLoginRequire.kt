 ...
 * @param requiredParameters Parameters required to log into the exchange
 */

data class ExchangeLoginRequire (
    ...
    @Json(name = "required_parameters")
    val requiredParameters: kotlin.collections.List<kotlin.String>? = null
