...
function Initialize-UpdateAccount {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => UpdateAccount' | Write-Debug
...
Convert from JSON to UpdateAccount<PSCustomObject>
...
UpdateAccount<PSCustomObject>
#>
function ConvertFrom-JsonToUpdateAccount {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => UpdateAccount' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in UpdateAccount
