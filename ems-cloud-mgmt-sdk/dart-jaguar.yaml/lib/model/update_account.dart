...

{
  ...
  @override
  String toString() {
    return 'UpdateAccount[exchangeId=$exchangeId, parameters=$parameters, ]';
  }
}

@GenSerializer(nullableFields: true)
class UpdateAccountSerializer extends Serializer<UpdateAccount> with _$UpdateAccountSerializer {
