goog.provide('API.Client.AccountData');

/**
 * @record
 */
API.Client.AccountData = function() {}
 ...
 * @export
 */
API.Client.AccountData.prototype.exchangeId;
 ...
 * @export
 */
API.Client.AccountData.prototype.parameters;
