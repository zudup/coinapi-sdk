...
public:
    ...
    void unsetRegion_name();

    void setRegionName(const utility::string_t& value);
...
protected:
    ...
    utility::string_t m_Region_name;
    bool m_Region_nameIsSet;
    utility::string_t m_Provider_name;
