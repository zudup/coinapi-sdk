...
utility::string_t AccountInfo::getExchangeId() const
{
    return m_Exchange_id;
}

void AccountInfo::setExchangeId(const utility::string_t& value)
{
    m_Exchange_id = value;
    m_Exchange_idIsSet = true;
}

bool AccountInfo::exchangeIdIsSet() const
{
    return m_Exchange_idIsSet;
}

void AccountInfo::unsetExchange_id()
{
    m_Exchange_idIsSet = false;
}
}
