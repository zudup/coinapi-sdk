...
#ifndef ORG_OPENAPITOOLS_CLIENT_MODEL_AccountEndpoint_H_
#define ORG_OPENAPITOOLS_CLIENT_MODEL_AccountEndpoint_H_
...
public:
    ...
    /// Endpoint schema
    /// </summary>
    utility::string_t getEndpointSchema() const;
    bool endpointSchemaIsSet() const;
    void unsetEndpoint_schema();

    void setEndpointSchema(const utility::string_t& value);

    /// <summary>
    /// Endpoint host
    /// </summary>
    utility::string_t getEndpointHost() const;
    bool endpointHostIsSet() const;
    void unsetEndpoint_host();

    void setEndpointHost(const utility::string_t& value);
...
protected:
    ...
    utility::string_t m_Endpoint_schema;
    bool m_Endpoint_schemaIsSet;
    utility::string_t m_Endpoint_host;
    bool m_Endpoint_hostIsSet;
...
#endif /* ORG_OPENAPITOOLS_CLIENT_MODEL_AccountEndpoint_H_ */
