...
void AccountData::validate()
{
    // TODO: implement validation
}

web::json::value AccountData::toJson() const
{
...
bool AccountData::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void AccountData::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool AccountData::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
utility::string_t AccountData::getExchangeId() const
{
    return m_Exchange_id;
}

void AccountData::setExchangeId(const utility::string_t& value)
{
    m_Exchange_id = value;
    m_Exchange_idIsSet = true;
}

bool AccountData::exchangeIdIsSet() const
{
    return m_Exchange_idIsSet;
}

void AccountData::unsetExchange_id()
{
    m_Exchange_idIsSet = false;
}
std::vector<std::shared_ptr<KeyValue>>& AccountData::getParameters()
{
    return m_Parameters;
}

void AccountData::setParameters(const std::vector<std::shared_ptr<KeyValue>>& value)
{
    m_Parameters = value;
    m_ParametersIsSet = true;
}

bool AccountData::parametersIsSet() const
{
    return m_ParametersIsSet;
}

void AccountData::unsetParameters()
{
    m_ParametersIsSet = false;
}
}
