...
#ifndef ORG_OPENAPITOOLS_CLIENT_MODEL_UpdateAccount_H_
#define ORG_OPENAPITOOLS_CLIENT_MODEL_UpdateAccount_H_
...
public:
    ...
    /// </summary>
    std::vector<std::shared_ptr<KeyValue>>& getParameters();
    bool parametersIsSet() const;
    void unsetParameters();

    void setParameters(const std::vector<std::shared_ptr<KeyValue>>& value);


protected:
    utility::string_t m_Exchange_id;
    bool m_Exchange_idIsSet;
    std::vector<std::shared_ptr<KeyValue>> m_Parameters;
...
#endif /* ORG_OPENAPITOOLS_CLIENT_MODEL_UpdateAccount_H_ */
