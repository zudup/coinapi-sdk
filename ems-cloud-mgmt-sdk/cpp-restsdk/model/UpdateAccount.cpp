...
void UpdateAccount::validate()
{
    // TODO: implement validation
}

web::json::value UpdateAccount::toJson() const
{
...
bool UpdateAccount::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void UpdateAccount::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool UpdateAccount::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
utility::string_t UpdateAccount::getExchangeId() const
{
    return m_Exchange_id;
}

void UpdateAccount::setExchangeId(const utility::string_t& value)
{
    m_Exchange_id = value;
    m_Exchange_idIsSet = true;
}

bool UpdateAccount::exchangeIdIsSet() const
{
    return m_Exchange_idIsSet;
}

void UpdateAccount::unsetExchange_id()
{
    m_Exchange_idIsSet = false;
}
std::vector<std::shared_ptr<KeyValue>>& UpdateAccount::getParameters()
{
    return m_Parameters;
}

void UpdateAccount::setParameters(const std::vector<std::shared_ptr<KeyValue>>& value)
{
    m_Parameters = value;
    m_ParametersIsSet = true;
}

bool UpdateAccount::parametersIsSet() const
{
    return m_ParametersIsSet;
}

void UpdateAccount::unsetParameters()
{
    m_ParametersIsSet = false;
}
}
