...
context("Test ExchangeLoginRequire")

model.instance <- ExchangeLoginRequire$new()
...
test_that("required_parameters", {
  # tests for the property `required_parameters` (array[character])
  # Parameters required to log into the exchange

  # uncomment below to test the property
  #expect_equal(model.instance$`required_parameters`, "EXPECTED_RESULT")
})
