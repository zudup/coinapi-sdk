...
case $state in
  ops)
    ...
    _values "Operations" \
            ...
            "dappsDexWithdrawRequestHistoricalGet[]"             "dappsSushiswapBundlesHistoricalGet[]" \
            ...
            "sushiswapGetTokensHistorical[Sushiswap.GetTokens (historical)]"             "dappsUniswapv2BundlesHistoricalGet[]" \
