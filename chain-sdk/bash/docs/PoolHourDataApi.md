...
```bash
 chainsChainIdDappsUniswapv2PoolHourDataHistoricalGet chain_id=value  startBlock=value  endBlock=value  startDate=value  endDate=value  poolId=value
```
...
```bash
 chainsChainIdDappsUniswapv3PoolHourDataHistoricalGet chain_id=value  startBlock=value  endBlock=value  startDate=value  endDate=value  poolId=value
```
