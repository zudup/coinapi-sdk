...
```bash
 chainsChainIdDappsUniswapv2PoolDayDataHistoricalGet chain_id=value  startBlock=value  endBlock=value  startDate=value  endDate=value  poolId=value
```
...
```bash
 chainsChainIdDappsUniswapv3PoolDayDataHistoricalGet chain_id=value  startBlock=value  endBlock=value  startDate=value  endDate=value  poolId=value
```
