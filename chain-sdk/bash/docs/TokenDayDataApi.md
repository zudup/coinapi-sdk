...
```bash
 chainsChainIdDappsSushiswapTokenDayDataHistoricalGet chain_id=value  startBlock=value  endBlock=value  startDate=value  endDate=value  tokenId=value
```
...
```bash
 chainsChainIdDappsUniswapv2TokenDayDataHistoricalGet chain_id=value  startBlock=value  endBlock=value  startDate=value  endDate=value  tokenId=value
```
...
```bash
 chainsChainIdDappsUniswapv3TokenDayDataHistoricalGet chain_id=value  startBlock=value  endBlock=value  startDate=value  endDate=value  tokenId=value
```
