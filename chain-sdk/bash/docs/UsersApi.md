...
```bash
 chainsChainIdDappsCowUsersHistoricalGet chain_id=value  startBlock=value  endBlock=value  startDate=value  endDate=value
```
...
```bash
 chainsChainIdDappsDexUsersHistoricalGet chain_id=value  startBlock=value  endBlock=value  startDate=value  endDate=value
```
...
```bash
 chainsChainIdDappsSushiswapUsersHistoricalGet chain_id=value  startBlock=value  endBlock=value  startDate=value  endDate=value
```
...
```bash
 chainsChainIdDappsUniswapv2UsersHistoricalGet chain_id=value  startBlock=value  endBlock=value  startDate=value  endDate=value
```
