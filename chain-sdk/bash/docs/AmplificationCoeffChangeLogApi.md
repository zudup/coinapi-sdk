...
```bash
 chainsChainIdDappsCurveAmplificationCoeffChangeLogHistoricalGet chain_id=value  startBlock=value  endBlock=value  startDate=value  endDate=value  poolId=value
```
