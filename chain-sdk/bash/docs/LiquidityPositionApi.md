...
```bash
 chainsChainIdDappsSushiswapLiquidityPositionHistoricalGet chain_id=value  startBlock=value  endBlock=value  startDate=value  endDate=value  poolId=value
```
...
```bash
 chainsChainIdDappsUniswapv2LiquidityPositionHistoricalGet chain_id=value  startBlock=value  endBlock=value  startDate=value  endDate=value  poolId=value
```
