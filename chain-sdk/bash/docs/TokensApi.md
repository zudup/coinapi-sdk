...
```bash
 chainsChainIdDappsCowTokensHistoricalGet chain_id=value  startBlock=value  endBlock=value  startDate=value  endDate=value  tokenId=value
```
...
```bash
 chainsChainIdDappsCurveTokensHistoricalGet chain_id=value  startBlock=value  endBlock=value  startDate=value  endDate=value  tokenId=value
```
...
```bash
 chainsChainIdDappsSushiswapTokensHistoricalGet chain_id=value  startBlock=value  endBlock=value  startDate=value  endDate=value  tokenId=value
```
...
```bash
 chainsChainIdDappsUniswapv2TokensHistoricalGet chain_id=value  startBlock=value  endBlock=value  startDate=value  endDate=value  tokenId=value
```
...
```bash
 chainsChainIdDappsUniswapv3TokensHistoricalGet chain_id=value  startBlock=value  endBlock=value  startDate=value  endDate=value  tokenId=value
```
