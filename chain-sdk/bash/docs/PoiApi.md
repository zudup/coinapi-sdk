...
```bash
 chainsChainIdDappsCurvePoiHistoricalGet chain_id=value  startBlock=value  endBlock=value  startDate=value  endDate=value
```
...
```bash
 chainsChainIdDappsSushiswapPoiHistoricalGet chain_id=value  startBlock=value  endBlock=value  startDate=value  endDate=value
```
...
```bash
 chainsChainIdDappsUniswapv2PoiHistoricalGet chain_id=value  startBlock=value  endBlock=value  startDate=value  endDate=value
```
...
```bash
 chainsChainIdDappsUniswapv3PoiHistoricalGet chain_id=value  startBlock=value  endBlock=value  startDate=value  endDate=value
```
