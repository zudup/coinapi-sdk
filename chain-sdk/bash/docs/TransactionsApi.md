...
```bash
 chainsChainIdDappsSushiswapTransactionsHistoricalGet chain_id=value  startBlock=value  endBlock=value  startDate=value  endDate=value
```
...
```bash
 chainsChainIdDappsUniswapv2TransactionsHistoricalGet chain_id=value  startBlock=value  endBlock=value  startDate=value  endDate=value
```
...
```bash
 chainsChainIdDappsUniswapv3TransactionsHistoricalGet chain_id=value  startBlock=value  endBlock=value  startDate=value  endDate=value
```
