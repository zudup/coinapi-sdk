...
```bash
 chainsChainIdDappsSushiswapFactoryHistoricalGet chain_id=value  startBlock=value  endBlock=value  startDate=value  endDate=value
```
...
```bash
 chainsChainIdDappsUniswapv2FactoryHistoricalGet chain_id=value  startBlock=value  endBlock=value  startDate=value  endDate=value
```
...
```bash
 chainsChainIdDappsUniswapv3FactoryHistoricalGet chain_id=value  startBlock=value  endBlock=value  startDate=value  endDate=value
```
