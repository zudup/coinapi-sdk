...
```bash
 chainsChainIdDappsCowTradesHistoricalGet chain_id=value  startBlock=value  endBlock=value  startDate=value  endDate=value
```
...
```bash
 chainsChainIdDappsDexTradesHistoricalGet chain_id=value  startBlock=value  endBlock=value  startDate=value  endDate=value
```
