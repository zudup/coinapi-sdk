...
```bash
 chainsChainIdDappsUniswapv2BurnsHistoricalGet chain_id=value  startBlock=value  endBlock=value  startDate=value  endDate=value  poolId=value
```
...
```bash
 chainsChainIdDappsUniswapv3BurnsHistoricalGet chain_id=value  startBlock=value  endBlock=value  startDate=value  endDate=value  poolId=value
```
