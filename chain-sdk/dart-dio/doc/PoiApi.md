...
try {
    api.chainsChainIdDappsCowPoiHistoricalGet(chainId, startBlock, endBlock, startDate, endDate);
} catch on DioError (e) {
...
try {
    api.chainsChainIdDappsCurvePoiHistoricalGet(chainId, startBlock, endBlock, startDate, endDate);
} catch on DioError (e) {
...
try {
    api.chainsChainIdDappsDexPoiHistoricalGet(chainId, startBlock, endBlock, startDate, endDate);
} catch on DioError (e) {
