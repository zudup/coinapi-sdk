# openapi.api.GaugeTypeWeightApi
...
final api = Openapi().getGaugeTypeWeightApi();
...
try {
    api.chainsChainIdDappsCurveGaugeTypeWeightHistoricalGet(chainId, startBlock, endBlock, startDate, endDate);
} catch on DioError (e) {
