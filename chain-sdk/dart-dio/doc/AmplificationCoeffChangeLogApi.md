...
final api = Openapi().getAmplificationCoeffChangeLogApi();
...
try {
    api.chainsChainIdDappsCurveAmplificationCoeffChangeLogHistoricalGet(chainId, startBlock, endBlock, startDate, endDate, poolId);
} catch on DioError (e) {
