# openapi.api.TransferOwnershipEventApi
...
final api = Openapi().getTransferOwnershipEventApi();
...
try {
    api.chainsChainIdDappsCurveTransferOwnershipEventHistoricalGet(chainId, startBlock, endBlock, startDate, endDate, poolId);
} catch on DioError (e) {
