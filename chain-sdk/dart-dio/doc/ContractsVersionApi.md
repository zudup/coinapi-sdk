# openapi.api.ContractsVersionApi
...
final api = Openapi().getContractsVersionApi();
...
try {
    api.chainsChainIdDappsCurveContractsVersionHistoricalGet(chainId, startBlock, endBlock, startDate, endDate, poolId);
} catch on DioError (e) {
