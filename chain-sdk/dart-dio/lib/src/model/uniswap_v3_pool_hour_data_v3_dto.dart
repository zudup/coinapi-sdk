...
part 'uniswap_v3_pool_hour_data_v3_dto.g.dart';
...
/// * [vid] - 
@BuiltValue()
abstract class UniswapV3PoolHourDataV3DTO implements Built<UniswapV3PoolHourDataV3DTO, UniswapV3PoolHourDataV3DTOBuilder> {
  ...
  UniswapV3PoolHourDataV3DTO._();

  factory UniswapV3PoolHourDataV3DTO([void updates(UniswapV3PoolHourDataV3DTOBuilder b)]) = _$UniswapV3PoolHourDataV3DTO;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(UniswapV3PoolHourDataV3DTOBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<UniswapV3PoolHourDataV3DTO> get serializer => _$UniswapV3PoolHourDataV3DTOSerializer();
}

class _$UniswapV3PoolHourDataV3DTOSerializer implements PrimitiveSerializer<UniswapV3PoolHourDataV3DTO> {
  @override
  final Iterable<Type> types = const [UniswapV3PoolHourDataV3DTO, _$UniswapV3PoolHourDataV3DTO];

  @override
  final String wireName = r'UniswapV3PoolHourDataV3DTO';

  Iterable<Object?> _serializeProperties(
    Serializers serializers,
    UniswapV3PoolHourDataV3DTO object, {
  ...
  void _deserializeProperties(
    ...
    required UniswapV3PoolHourDataV3DTOBuilder result,
  ...
  @override
  UniswapV3PoolHourDataV3DTO deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = UniswapV3PoolHourDataV3DTOBuilder();
