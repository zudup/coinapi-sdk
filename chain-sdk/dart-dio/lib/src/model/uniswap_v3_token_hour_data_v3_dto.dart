...
part 'uniswap_v3_token_hour_data_v3_dto.g.dart';
...
/// * [vid] - 
@BuiltValue()
abstract class UniswapV3TokenHourDataV3DTO implements Built<UniswapV3TokenHourDataV3DTO, UniswapV3TokenHourDataV3DTOBuilder> {
  ...
  UniswapV3TokenHourDataV3DTO._();

  factory UniswapV3TokenHourDataV3DTO([void updates(UniswapV3TokenHourDataV3DTOBuilder b)]) = _$UniswapV3TokenHourDataV3DTO;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(UniswapV3TokenHourDataV3DTOBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<UniswapV3TokenHourDataV3DTO> get serializer => _$UniswapV3TokenHourDataV3DTOSerializer();
}

class _$UniswapV3TokenHourDataV3DTOSerializer implements PrimitiveSerializer<UniswapV3TokenHourDataV3DTO> {
  @override
  final Iterable<Type> types = const [UniswapV3TokenHourDataV3DTO, _$UniswapV3TokenHourDataV3DTO];

  @override
  final String wireName = r'UniswapV3TokenHourDataV3DTO';

  Iterable<Object?> _serializeProperties(
    Serializers serializers,
    UniswapV3TokenHourDataV3DTO object, {
  ...
  void _deserializeProperties(
    ...
    required UniswapV3TokenHourDataV3DTOBuilder result,
  ...
  @override
  UniswapV3TokenHourDataV3DTO deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = UniswapV3TokenHourDataV3DTOBuilder();
