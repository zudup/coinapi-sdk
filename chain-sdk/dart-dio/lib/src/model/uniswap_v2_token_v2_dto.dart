...
part 'uniswap_v2_token_v2_dto.g.dart';
...
/// * [tokenSymbol] 
@BuiltValue()
abstract class UniswapV2TokenV2DTO implements Built<UniswapV2TokenV2DTO, UniswapV2TokenV2DTOBuilder> {
  ...
  UniswapV2TokenV2DTO._();

  factory UniswapV2TokenV2DTO([void updates(UniswapV2TokenV2DTOBuilder b)]) = _$UniswapV2TokenV2DTO;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(UniswapV2TokenV2DTOBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<UniswapV2TokenV2DTO> get serializer => _$UniswapV2TokenV2DTOSerializer();
}

class _$UniswapV2TokenV2DTOSerializer implements PrimitiveSerializer<UniswapV2TokenV2DTO> {
  @override
  final Iterable<Type> types = const [UniswapV2TokenV2DTO, _$UniswapV2TokenV2DTO];

  @override
  final String wireName = r'UniswapV2TokenV2DTO';

  Iterable<Object?> _serializeProperties(
    Serializers serializers,
    UniswapV2TokenV2DTO object, {
  ...
  void _deserializeProperties(
    ...
    required UniswapV2TokenV2DTOBuilder result,
  ...
  @override
  UniswapV2TokenV2DTO deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = UniswapV2TokenV2DTOBuilder();
