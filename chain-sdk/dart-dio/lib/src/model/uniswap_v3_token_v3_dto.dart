...
part 'uniswap_v3_token_v3_dto.g.dart';
...
/// * [tokenSymbol] 
@BuiltValue()
abstract class UniswapV3TokenV3DTO implements Built<UniswapV3TokenV3DTO, UniswapV3TokenV3DTOBuilder> {
  ...
  UniswapV3TokenV3DTO._();

  factory UniswapV3TokenV3DTO([void updates(UniswapV3TokenV3DTOBuilder b)]) = _$UniswapV3TokenV3DTO;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(UniswapV3TokenV3DTOBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<UniswapV3TokenV3DTO> get serializer => _$UniswapV3TokenV3DTOSerializer();
}

class _$UniswapV3TokenV3DTOSerializer implements PrimitiveSerializer<UniswapV3TokenV3DTO> {
  @override
  final Iterable<Type> types = const [UniswapV3TokenV3DTO, _$UniswapV3TokenV3DTO];

  @override
  final String wireName = r'UniswapV3TokenV3DTO';

  Iterable<Object?> _serializeProperties(
    Serializers serializers,
    UniswapV3TokenV3DTO object, {
  ...
  void _deserializeProperties(
    ...
    required UniswapV3TokenV3DTOBuilder result,
  ...
  @override
  UniswapV3TokenV3DTO deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = UniswapV3TokenV3DTOBuilder();
