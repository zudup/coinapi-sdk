...
part 'uniswap_v3_tick_v3_dto.g.dart';
...
@BuiltValue()
abstract class UniswapV3TickV3DTO implements Built<UniswapV3TickV3DTO, UniswapV3TickV3DTOBuilder> {
  ...
  UniswapV3TickV3DTO._();

  factory UniswapV3TickV3DTO([void updates(UniswapV3TickV3DTOBuilder b)]) = _$UniswapV3TickV3DTO;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(UniswapV3TickV3DTOBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<UniswapV3TickV3DTO> get serializer => _$UniswapV3TickV3DTOSerializer();
}

class _$UniswapV3TickV3DTOSerializer implements PrimitiveSerializer<UniswapV3TickV3DTO> {
  @override
  final Iterable<Type> types = const [UniswapV3TickV3DTO, _$UniswapV3TickV3DTO];

  @override
  final String wireName = r'UniswapV3TickV3DTO';

  Iterable<Object?> _serializeProperties(
    Serializers serializers,
    UniswapV3TickV3DTO object, {
  ...
  void _deserializeProperties(
    ...
    required UniswapV3TickV3DTOBuilder result,
  ...
  @override
  UniswapV3TickV3DTO deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = UniswapV3TickV3DTOBuilder();
