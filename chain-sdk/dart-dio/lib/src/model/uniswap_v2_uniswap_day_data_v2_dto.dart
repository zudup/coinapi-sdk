...
part 'uniswap_v2_uniswap_day_data_v2_dto.g.dart';
...
/// * [vid] - 
@BuiltValue()
abstract class UniswapV2UniswapDayDataV2DTO implements Built<UniswapV2UniswapDayDataV2DTO, UniswapV2UniswapDayDataV2DTOBuilder> {
  ...
  UniswapV2UniswapDayDataV2DTO._();

  factory UniswapV2UniswapDayDataV2DTO([void updates(UniswapV2UniswapDayDataV2DTOBuilder b)]) = _$UniswapV2UniswapDayDataV2DTO;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(UniswapV2UniswapDayDataV2DTOBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<UniswapV2UniswapDayDataV2DTO> get serializer => _$UniswapV2UniswapDayDataV2DTOSerializer();
}

class _$UniswapV2UniswapDayDataV2DTOSerializer implements PrimitiveSerializer<UniswapV2UniswapDayDataV2DTO> {
  @override
  final Iterable<Type> types = const [UniswapV2UniswapDayDataV2DTO, _$UniswapV2UniswapDayDataV2DTO];

  @override
  final String wireName = r'UniswapV2UniswapDayDataV2DTO';

  Iterable<Object?> _serializeProperties(
    Serializers serializers,
    UniswapV2UniswapDayDataV2DTO object, {
  ...
  void _deserializeProperties(
    ...
    required UniswapV2UniswapDayDataV2DTOBuilder result,
  ...
  @override
  UniswapV2UniswapDayDataV2DTO deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = UniswapV2UniswapDayDataV2DTOBuilder();
