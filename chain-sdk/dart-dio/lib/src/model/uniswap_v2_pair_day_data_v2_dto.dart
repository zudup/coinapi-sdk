...
part 'uniswap_v2_pair_day_data_v2_dto.g.dart';
...
/// * [vid] - 
@BuiltValue()
abstract class UniswapV2PairDayDataV2DTO implements Built<UniswapV2PairDayDataV2DTO, UniswapV2PairDayDataV2DTOBuilder> {
  ...
  UniswapV2PairDayDataV2DTO._();

  factory UniswapV2PairDayDataV2DTO([void updates(UniswapV2PairDayDataV2DTOBuilder b)]) = _$UniswapV2PairDayDataV2DTO;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(UniswapV2PairDayDataV2DTOBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<UniswapV2PairDayDataV2DTO> get serializer => _$UniswapV2PairDayDataV2DTOSerializer();
}

class _$UniswapV2PairDayDataV2DTOSerializer implements PrimitiveSerializer<UniswapV2PairDayDataV2DTO> {
  @override
  final Iterable<Type> types = const [UniswapV2PairDayDataV2DTO, _$UniswapV2PairDayDataV2DTO];

  @override
  final String wireName = r'UniswapV2PairDayDataV2DTO';

  Iterable<Object?> _serializeProperties(
    Serializers serializers,
    UniswapV2PairDayDataV2DTO object, {
  ...
  void _deserializeProperties(
    ...
    required UniswapV2PairDayDataV2DTOBuilder result,
  ...
  @override
  UniswapV2PairDayDataV2DTO deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = UniswapV2PairDayDataV2DTOBuilder();
