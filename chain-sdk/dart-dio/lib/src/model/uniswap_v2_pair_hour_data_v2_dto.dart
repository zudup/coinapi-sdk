...
part 'uniswap_v2_pair_hour_data_v2_dto.g.dart';
...
/// * [vid] - 
@BuiltValue()
abstract class UniswapV2PairHourDataV2DTO implements Built<UniswapV2PairHourDataV2DTO, UniswapV2PairHourDataV2DTOBuilder> {
  ...
  UniswapV2PairHourDataV2DTO._();

  factory UniswapV2PairHourDataV2DTO([void updates(UniswapV2PairHourDataV2DTOBuilder b)]) = _$UniswapV2PairHourDataV2DTO;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(UniswapV2PairHourDataV2DTOBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<UniswapV2PairHourDataV2DTO> get serializer => _$UniswapV2PairHourDataV2DTOSerializer();
}

class _$UniswapV2PairHourDataV2DTOSerializer implements PrimitiveSerializer<UniswapV2PairHourDataV2DTO> {
  @override
  final Iterable<Type> types = const [UniswapV2PairHourDataV2DTO, _$UniswapV2PairHourDataV2DTO];

  @override
  final String wireName = r'UniswapV2PairHourDataV2DTO';

  Iterable<Object?> _serializeProperties(
    Serializers serializers,
    UniswapV2PairHourDataV2DTO object, {
  ...
  void _deserializeProperties(
    ...
    required UniswapV2PairHourDataV2DTOBuilder result,
  ...
  @override
  UniswapV2PairHourDataV2DTO deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = UniswapV2PairHourDataV2DTOBuilder();
