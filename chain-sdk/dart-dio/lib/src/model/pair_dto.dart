...
/// * [evaluatedAsk] 
@BuiltValue()
abstract class PairDTO implements Built<PairDTO, PairDTOBuilder> {
  ...
  factory PairDTO([void updates(PairDTOBuilder b)]) = _$PairDTO;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(PairDTOBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<PairDTO> get serializer => _$PairDTOSerializer();
}

class _$PairDTOSerializer implements PrimitiveSerializer<PairDTO> {
  @override
  final Iterable<Type> types = const [PairDTO, _$PairDTO];

  @override
  final String wireName = r'PairDTO';
  ...
  void _deserializeProperties(
    ...
    required PairDTOBuilder result,
