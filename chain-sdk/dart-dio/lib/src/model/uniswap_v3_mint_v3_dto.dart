...
part 'uniswap_v3_mint_v3_dto.g.dart';
...
/// * [vid] - 
@BuiltValue()
abstract class UniswapV3MintV3DTO implements Built<UniswapV3MintV3DTO, UniswapV3MintV3DTOBuilder> {
  ...
  UniswapV3MintV3DTO._();

  factory UniswapV3MintV3DTO([void updates(UniswapV3MintV3DTOBuilder b)]) = _$UniswapV3MintV3DTO;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(UniswapV3MintV3DTOBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<UniswapV3MintV3DTO> get serializer => _$UniswapV3MintV3DTOSerializer();
}

class _$UniswapV3MintV3DTOSerializer implements PrimitiveSerializer<UniswapV3MintV3DTO> {
  @override
  final Iterable<Type> types = const [UniswapV3MintV3DTO, _$UniswapV3MintV3DTO];

  @override
  final String wireName = r'UniswapV3MintV3DTO';

  Iterable<Object?> _serializeProperties(
    Serializers serializers,
    UniswapV3MintV3DTO object, {
  ...
  void _deserializeProperties(
    ...
    required UniswapV3MintV3DTOBuilder result,
  ...
  @override
  UniswapV3MintV3DTO deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = UniswapV3MintV3DTOBuilder();
