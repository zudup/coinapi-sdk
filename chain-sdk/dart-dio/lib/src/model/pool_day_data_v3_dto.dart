...
abstract class PoolDayDataV3DTO implements Built<PoolDayDataV3DTO, PoolDayDataV3DTOBuilder> {
  ...
  factory PoolDayDataV3DTO([void updates(PoolDayDataV3DTOBuilder b)]) = _$PoolDayDataV3DTO;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(PoolDayDataV3DTOBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<PoolDayDataV3DTO> get serializer => _$PoolDayDataV3DTOSerializer();
}

class _$PoolDayDataV3DTOSerializer implements PrimitiveSerializer<PoolDayDataV3DTO> {
  @override
  final Iterable<Type> types = const [PoolDayDataV3DTO, _$PoolDayDataV3DTO];

  @override
  final String wireName = r'PoolDayDataV3DTO';

  Iterable<Object?> _serializeProperties(
    Serializers serializers,
    PoolDayDataV3DTO object, {
  ...
  void _deserializeProperties(
    ...
    required PoolDayDataV3DTOBuilder result,
  ...
  @override
  PoolDayDataV3DTO deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = PoolDayDataV3DTOBuilder();
