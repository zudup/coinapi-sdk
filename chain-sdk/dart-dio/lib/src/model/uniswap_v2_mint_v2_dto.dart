...
part 'uniswap_v2_mint_v2_dto.g.dart';
...
/// * [blockRange] - 
@BuiltValue()
abstract class UniswapV2MintV2DTO implements Built<UniswapV2MintV2DTO, UniswapV2MintV2DTOBuilder> {
  ...
  UniswapV2MintV2DTO._();

  factory UniswapV2MintV2DTO([void updates(UniswapV2MintV2DTOBuilder b)]) = _$UniswapV2MintV2DTO;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(UniswapV2MintV2DTOBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<UniswapV2MintV2DTO> get serializer => _$UniswapV2MintV2DTOSerializer();
}

class _$UniswapV2MintV2DTOSerializer implements PrimitiveSerializer<UniswapV2MintV2DTO> {
  @override
  final Iterable<Type> types = const [UniswapV2MintV2DTO, _$UniswapV2MintV2DTO];

  @override
  final String wireName = r'UniswapV2MintV2DTO';

  Iterable<Object?> _serializeProperties(
    Serializers serializers,
    UniswapV2MintV2DTO object, {
  ...
  void _deserializeProperties(
    ...
    required UniswapV2MintV2DTOBuilder result,
  ...
  @override
  UniswapV2MintV2DTO deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = UniswapV2MintV2DTOBuilder();
