...
part 'uniswap_v3_factory_v3_dto.g.dart';
...
/// * [vid] - 
@BuiltValue()
abstract class UniswapV3FactoryV3DTO implements Built<UniswapV3FactoryV3DTO, UniswapV3FactoryV3DTOBuilder> {
  ...
  UniswapV3FactoryV3DTO._();

  factory UniswapV3FactoryV3DTO([void updates(UniswapV3FactoryV3DTOBuilder b)]) = _$UniswapV3FactoryV3DTO;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(UniswapV3FactoryV3DTOBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<UniswapV3FactoryV3DTO> get serializer => _$UniswapV3FactoryV3DTOSerializer();
}

class _$UniswapV3FactoryV3DTOSerializer implements PrimitiveSerializer<UniswapV3FactoryV3DTO> {
  @override
  final Iterable<Type> types = const [UniswapV3FactoryV3DTO, _$UniswapV3FactoryV3DTO];

  @override
  final String wireName = r'UniswapV3FactoryV3DTO';

  Iterable<Object?> _serializeProperties(
    Serializers serializers,
    UniswapV3FactoryV3DTO object, {
  ...
  void _deserializeProperties(
    ...
    required UniswapV3FactoryV3DTOBuilder result,
  ...
  @override
  UniswapV3FactoryV3DTO deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = UniswapV3FactoryV3DTOBuilder();
