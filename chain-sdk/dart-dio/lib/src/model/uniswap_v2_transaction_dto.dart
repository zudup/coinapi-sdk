...
part 'uniswap_v2_transaction_dto.g.dart';
...
/// * [vid] - 
@BuiltValue()
abstract class UniswapV2TransactionDTO implements Built<UniswapV2TransactionDTO, UniswapV2TransactionDTOBuilder> {
  ...
  UniswapV2TransactionDTO._();

  factory UniswapV2TransactionDTO([void updates(UniswapV2TransactionDTOBuilder b)]) = _$UniswapV2TransactionDTO;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(UniswapV2TransactionDTOBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<UniswapV2TransactionDTO> get serializer => _$UniswapV2TransactionDTOSerializer();
}

class _$UniswapV2TransactionDTOSerializer implements PrimitiveSerializer<UniswapV2TransactionDTO> {
  @override
  final Iterable<Type> types = const [UniswapV2TransactionDTO, _$UniswapV2TransactionDTO];

  @override
  final String wireName = r'UniswapV2TransactionDTO';

  Iterable<Object?> _serializeProperties(
    Serializers serializers,
    UniswapV2TransactionDTO object, {
  ...
  void _deserializeProperties(
    ...
    required UniswapV2TransactionDTOBuilder result,
  ...
  @override
  UniswapV2TransactionDTO deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = UniswapV2TransactionDTOBuilder();
