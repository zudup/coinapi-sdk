...
part 'uniswap_v3_pool_day_data_v3_dto.g.dart';
...
/// * [vid] - 
@BuiltValue()
abstract class UniswapV3PoolDayDataV3DTO implements Built<UniswapV3PoolDayDataV3DTO, UniswapV3PoolDayDataV3DTOBuilder> {
  ...
  UniswapV3PoolDayDataV3DTO._();

  factory UniswapV3PoolDayDataV3DTO([void updates(UniswapV3PoolDayDataV3DTOBuilder b)]) = _$UniswapV3PoolDayDataV3DTO;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(UniswapV3PoolDayDataV3DTOBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<UniswapV3PoolDayDataV3DTO> get serializer => _$UniswapV3PoolDayDataV3DTOSerializer();
}

class _$UniswapV3PoolDayDataV3DTOSerializer implements PrimitiveSerializer<UniswapV3PoolDayDataV3DTO> {
  @override
  final Iterable<Type> types = const [UniswapV3PoolDayDataV3DTO, _$UniswapV3PoolDayDataV3DTO];

  @override
  final String wireName = r'UniswapV3PoolDayDataV3DTO';

  Iterable<Object?> _serializeProperties(
    Serializers serializers,
    UniswapV3PoolDayDataV3DTO object, {
  ...
  void _deserializeProperties(
    ...
    required UniswapV3PoolDayDataV3DTOBuilder result,
  ...
  @override
  UniswapV3PoolDayDataV3DTO deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = UniswapV3PoolDayDataV3DTOBuilder();
