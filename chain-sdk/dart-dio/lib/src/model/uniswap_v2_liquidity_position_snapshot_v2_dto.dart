...
part 'uniswap_v2_liquidity_position_snapshot_v2_dto.g.dart';
...
/// * [blockRange] - 
@BuiltValue()
abstract class UniswapV2LiquidityPositionSnapshotV2DTO implements Built<UniswapV2LiquidityPositionSnapshotV2DTO, UniswapV2LiquidityPositionSnapshotV2DTOBuilder> {
  ...
  UniswapV2LiquidityPositionSnapshotV2DTO._();

  factory UniswapV2LiquidityPositionSnapshotV2DTO([void updates(UniswapV2LiquidityPositionSnapshotV2DTOBuilder b)]) = _$UniswapV2LiquidityPositionSnapshotV2DTO;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(UniswapV2LiquidityPositionSnapshotV2DTOBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<UniswapV2LiquidityPositionSnapshotV2DTO> get serializer => _$UniswapV2LiquidityPositionSnapshotV2DTOSerializer();
}

class _$UniswapV2LiquidityPositionSnapshotV2DTOSerializer implements PrimitiveSerializer<UniswapV2LiquidityPositionSnapshotV2DTO> {
  @override
  final Iterable<Type> types = const [UniswapV2LiquidityPositionSnapshotV2DTO, _$UniswapV2LiquidityPositionSnapshotV2DTO];

  @override
  final String wireName = r'UniswapV2LiquidityPositionSnapshotV2DTO';

  Iterable<Object?> _serializeProperties(
    Serializers serializers,
    UniswapV2LiquidityPositionSnapshotV2DTO object, {
  ...
  void _deserializeProperties(
    ...
    required UniswapV2LiquidityPositionSnapshotV2DTOBuilder result,
  ...
  @override
  UniswapV2LiquidityPositionSnapshotV2DTO deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = UniswapV2LiquidityPositionSnapshotV2DTOBuilder();
