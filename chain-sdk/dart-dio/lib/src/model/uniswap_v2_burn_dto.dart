...
part 'uniswap_v2_burn_dto.g.dart';
...
/// * [vid] - 
@BuiltValue()
abstract class UniswapV2BurnDTO implements Built<UniswapV2BurnDTO, UniswapV2BurnDTOBuilder> {
  ...
  factory UniswapV2BurnDTO([void updates(UniswapV2BurnDTOBuilder b)]) = _$UniswapV2BurnDTO;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(UniswapV2BurnDTOBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<UniswapV2BurnDTO> get serializer => _$UniswapV2BurnDTOSerializer();
}

class _$UniswapV2BurnDTOSerializer implements PrimitiveSerializer<UniswapV2BurnDTO> {
  @override
  final Iterable<Type> types = const [UniswapV2BurnDTO, _$UniswapV2BurnDTO];

  @override
  final String wireName = r'UniswapV2BurnDTO';

  Iterable<Object?> _serializeProperties(
    Serializers serializers,
    UniswapV2BurnDTO object, {
  ...
  void _deserializeProperties(
    ...
    required UniswapV2BurnDTOBuilder result,
  ...
  @override
  UniswapV2BurnDTO deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = UniswapV2BurnDTOBuilder();
