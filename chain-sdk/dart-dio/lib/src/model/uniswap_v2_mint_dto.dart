...
part 'uniswap_v2_mint_dto.g.dart';
...
/// * [blockRange] - 
@BuiltValue()
abstract class UniswapV2MintDTO implements Built<UniswapV2MintDTO, UniswapV2MintDTOBuilder> {
  ...
  factory UniswapV2MintDTO([void updates(UniswapV2MintDTOBuilder b)]) = _$UniswapV2MintDTO;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(UniswapV2MintDTOBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<UniswapV2MintDTO> get serializer => _$UniswapV2MintDTOSerializer();
}

class _$UniswapV2MintDTOSerializer implements PrimitiveSerializer<UniswapV2MintDTO> {
  @override
  final Iterable<Type> types = const [UniswapV2MintDTO, _$UniswapV2MintDTO];

  @override
  final String wireName = r'UniswapV2MintDTO';

  Iterable<Object?> _serializeProperties(
    Serializers serializers,
    UniswapV2MintDTO object, {
  ...
  void _deserializeProperties(
    ...
    required UniswapV2MintDTOBuilder result,
  ...
  @override
  UniswapV2MintDTO deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = UniswapV2MintDTOBuilder();
