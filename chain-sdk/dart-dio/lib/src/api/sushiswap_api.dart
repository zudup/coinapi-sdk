...
class SushiswapApi {
  ...
  Future<Response<BuiltList<PairDTO>>> chainsChainIdDappsSushiswapPoolsCurrentGet({ 
    ...
    final _path = r'/chains/{chain_id}/dapps/sushiswap/pools/current'.replaceAll('{' r'chain_id' '}', chainId.toString());
  ...
  /// Throws [DioError] if API call or serialization fails
  Future<Response<BuiltList<SwapDTO>>> chainsChainIdDappsSushiswapSwapsCurrentGet({ 
    required String chainId,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ...
    final _path = r'/chains/{chain_id}/dapps/sushiswap/swaps/current'.replaceAll('{' r'chain_id' '}', chainId.toString());
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
  ...
  /// Throws [DioError] if API call or serialization fails
  Future<Response<BuiltList<TokenDTO>>> chainsChainIdDappsSushiswapTokensCurrentGet({ 
    required String chainId,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ...
    final _path = r'/chains/{chain_id}/dapps/sushiswap/tokens/current'.replaceAll('{' r'chain_id' '}', chainId.toString());
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
