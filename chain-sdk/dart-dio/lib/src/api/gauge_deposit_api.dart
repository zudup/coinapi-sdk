...
class GaugeDepositApi {
  ...
  const GaugeDepositApi(this._dio, this._serializers);
  ...
  Future<Response<void>> chainsChainIdDappsCurveGaugeDepositHistoricalGet({ 
    ...
    final _path = r'/chains/{chain_id}/dapps/curve/gaugeDeposit/historical'.replaceAll('{' r'chain_id' '}', chainId.toString());
