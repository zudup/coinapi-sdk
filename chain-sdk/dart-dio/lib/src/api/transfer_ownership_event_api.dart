...
class TransferOwnershipEventApi {
  ...
  const TransferOwnershipEventApi(this._dio, this._serializers);
  ...
  Future<Response<void>> chainsChainIdDappsCurveTransferOwnershipEventHistoricalGet({ 
    ...
    final _path = r'/chains/{chain_id}/dapps/curve/transferOwnershipEvent/historical'.replaceAll('{' r'chain_id' '}', chainId.toString());
