...
class RemoveLiquidityOneEventApi {
  ...
  const RemoveLiquidityOneEventApi(this._dio, this._serializers);
  ...
  Future<Response<void>> chainsChainIdDappsCurveRemoveLiquidityOneEventHistoricalGet({ 
    ...
    final _path = r'/chains/{chain_id}/dapps/curve/removeLiquidityOneEvent/historical'.replaceAll('{' r'chain_id' '}', chainId.toString());
