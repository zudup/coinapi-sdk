...
class UniswapV2Api {
  ...
  Future<Response<BuiltList<PairV2DTO>>> chainsChainIdDappsUniswapv2PoolsCurrentGet({ 
    ...
    final _path = r'/chains/{chain_id}/dapps/uniswapv2/pools/current'.replaceAll('{' r'chain_id' '}', chainId.toString());
  ...
  /// Throws [DioError] if API call or serialization fails
  Future<Response<BuiltList<SwapV2DTO>>> chainsChainIdDappsUniswapv2SwapsCurrentGet({ 
    required String chainId,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ...
    final _path = r'/chains/{chain_id}/dapps/uniswapv2/swaps/current'.replaceAll('{' r'chain_id' '}', chainId.toString());
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
  ...
  /// Throws [DioError] if API call or serialization fails
  Future<Response<BuiltList<TokenV2DTO>>> chainsChainIdDappsUniswapv2TokensCurrentGet({ 
    required String chainId,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ...
    final _path = r'/chains/{chain_id}/dapps/uniswapv2/tokens/current'.replaceAll('{' r'chain_id' '}', chainId.toString());
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
