...
class UniswapV2Api {
  ...
  Future<Response<void>> dappsUniswapv2BundlesHistoricalGet({ 
    int? startBlock,
    int? endBlock,
    DateTime? startDate,
    DateTime? endDate,
  ...
  /// Returns a [Future]
  /// Throws [DioError] if API call or serialization fails
  Future<Response<void>> dappsUniswapv2BurnsHistoricalGet({ 
    int? startBlock,
    int? endBlock,
    DateTime? startDate,
    DateTime? endDate,
  ...
  /// Returns a [Future]
  /// Throws [DioError] if API call or serialization fails
  Future<Response<void>> dappsUniswapv2DayDataHistoricalGet({ 
    int? startBlock,
    int? endBlock,
    DateTime? startDate,
    DateTime? endDate,
  ...
  /// Returns a [Future]
  /// Throws [DioError] if API call or serialization fails
  Future<Response<void>> dappsUniswapv2FactoryHistoricalGet({ 
    int? startBlock,
    int? endBlock,
    DateTime? startDate,
    DateTime? endDate,
  ...
  /// Returns a [Future]
  /// Throws [DioError] if API call or serialization fails
  Future<Response<void>> dappsUniswapv2LiquidityPositionHistoricalGet({ 
    int? startBlock,
    int? endBlock,
    DateTime? startDate,
    DateTime? endDate,
    ...
    final _path = r'/dapps/uniswapv2/liquidityPosition/historical';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
  ...
  /// Returns a [Future]
  /// Throws [DioError] if API call or serialization fails
  Future<Response<void>> dappsUniswapv2LiquidityPositionSnapshotsHistoricalGet({ 
    int? startBlock,
    int? endBlock,
    DateTime? startDate,
    DateTime? endDate,
  ...
  /// Returns a [Future]
  /// Throws [DioError] if API call or serialization fails
  Future<Response<void>> dappsUniswapv2MintsHistoricalGet({ 
    int? startBlock,
    int? endBlock,
    DateTime? startDate,
    DateTime? endDate,
  ...
  /// Returns a [Future]
  /// Throws [DioError] if API call or serialization fails
  Future<Response<void>> dappsUniswapv2PoiHistoricalGet({ 
    int? startBlock,
    int? endBlock,
    DateTime? startDate,
    DateTime? endDate,
    ...
    final _path = r'/dapps/uniswapv2/poi/historical';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
  ...
  /// Returns a [Future]
  /// Throws [DioError] if API call or serialization fails
  Future<Response<void>> dappsUniswapv2PoolDayDataHistoricalGet({ 
    int? startBlock,
    int? endBlock,
    DateTime? startDate,
    DateTime? endDate,
    ...
    final _path = r'/dapps/uniswapv2/poolDayData/historical';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
  ...
  /// Returns a [Future]
  /// Throws [DioError] if API call or serialization fails
  Future<Response<void>> dappsUniswapv2PoolHourDataHistoricalGet({ 
    int? startBlock,
    int? endBlock,
    DateTime? startDate,
    DateTime? endDate,
    ...
    final _path = r'/dapps/uniswapv2/poolHourData/historical';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
  ...
  /// Returns a [Future]
  /// Throws [DioError] if API call or serialization fails
  Future<Response<void>> dappsUniswapv2PoolsHistoricalGet({ 
    int? startBlock,
    int? endBlock,
    DateTime? startDate,
    DateTime? endDate,
  ...
  /// Returns a [Future]
  /// Throws [DioError] if API call or serialization fails
  Future<Response<void>> dappsUniswapv2SwapsHistoricalGet({ 
    int? startBlock,
    int? endBlock,
    DateTime? startDate,
    DateTime? endDate,
  ...
  /// Returns a [Future]
  /// Throws [DioError] if API call or serialization fails
  Future<Response<void>> dappsUniswapv2TokenDayDataHistoricalGet({ 
    int? startBlock,
    int? endBlock,
    DateTime? startDate,
    DateTime? endDate,
  ...
  /// Returns a [Future]
  /// Throws [DioError] if API call or serialization fails
  Future<Response<void>> dappsUniswapv2TokensHistoricalGet({ 
    int? startBlock,
    int? endBlock,
    DateTime? startDate,
    DateTime? endDate,
  ...
  /// Returns a [Future]
  /// Throws [DioError] if API call or serialization fails
  Future<Response<void>> dappsUniswapv2TransactionsHistoricalGet({ 
    int? startBlock,
    int? endBlock,
    DateTime? startDate,
    DateTime? endDate,
  ...
  /// Returns a [Future]
  /// Throws [DioError] if API call or serialization fails
  Future<Response<void>> dappsUniswapv2UsersHistoricalGet({ 
    int? startBlock,
    int? endBlock,
    DateTime? startDate,
    DateTime? endDate,
