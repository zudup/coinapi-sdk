...
class WeeklyVolumeApi {
  ...
  const WeeklyVolumeApi(this._dio, this._serializers);
  ...
  Future<Response<void>> chainsChainIdDappsCurveWeeklyVolumeHistoricalGet({ 
    ...
    final _path = r'/chains/{chain_id}/dapps/curve/weeklyVolume/historical'.replaceAll('{' r'chain_id' '}', chainId.toString());
