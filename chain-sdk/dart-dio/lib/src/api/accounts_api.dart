...
class AccountsApi {
  ...
  Future<Response<void>> chainsChainIdDappsCurveAccountsHistoricalGet({ 
    ...
    final _path = r'/chains/{chain_id}/dapps/curve/accounts/historical'.replaceAll('{' r'chain_id' '}', chainId.toString());
