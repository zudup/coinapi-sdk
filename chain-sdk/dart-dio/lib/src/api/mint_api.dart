...
class MintApi {
  ...
  Future<Response<void>> chainsChainIdDappsUniswapv2MintHistoricalGet({ 
    ...
    final _path = r'/chains/{chain_id}/dapps/uniswapv2/mint/historical'.replaceAll('{' r'chain_id' '}', chainId.toString());
