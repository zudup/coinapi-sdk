...
class BatchApi {
  ...
  Future<Response<void>> chainsChainIdDappsDexBatchHistoricalGet({ 
    ...
    final _path = r'/chains/{chain_id}/dapps/dex/batch/historical'.replaceAll('{' r'chain_id' '}', chainId.toString());
