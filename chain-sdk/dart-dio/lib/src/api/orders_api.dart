...
class OrdersApi {
  ...
  Future<Response<void>> chainsChainIdDappsCowOrdersHistoricalGet({ 
    ...
    final _path = r'/chains/{chain_id}/dapps/cow/orders/historical'.replaceAll('{' r'chain_id' '}', chainId.toString());
  ...
  /// Returns a [Future]
  /// Throws [DioError] if API call or serialization fails
  Future<Response<void>> chainsChainIdDappsDexOrdersHistoricalGet({ 
    required String chainId,
    int? startBlock,
    int? endBlock,
    DateTime? startDate,
    ...
    final _path = r'/chains/{chain_id}/dapps/dex/orders/historical'.replaceAll('{' r'chain_id' '}', chainId.toString());
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
