...
class GaugeLiquidityApi {
  ...
  const GaugeLiquidityApi(this._dio, this._serializers);
  ...
  Future<Response<void>> chainsChainIdDappsCurveGaugeLiquidityHistoricalGet({ 
    ...
    final _path = r'/chains/{chain_id}/dapps/curve/gaugeLiquidity/historical'.replaceAll('{' r'chain_id' '}', chainId.toString());
