...
class AmplificationCoeffChangeLogApi {
  ...
  const AmplificationCoeffChangeLogApi(this._dio, this._serializers);
  ...
  Future<Response<void>> chainsChainIdDappsCurveAmplificationCoeffChangeLogHistoricalGet({ 
    ...
    final _path = r'/chains/{chain_id}/dapps/curve/amplificationCoeffChangeLog/historical'.replaceAll('{' r'chain_id' '}', chainId.toString());
