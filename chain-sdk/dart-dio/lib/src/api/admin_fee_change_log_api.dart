...
class AdminFeeChangeLogApi {
  ...
  const AdminFeeChangeLogApi(this._dio, this._serializers);
  ...
  Future<Response<void>> chainsChainIdDappsCurveAdminFeeChangeLogHistoricalGet({ 
    ...
    final _path = r'/chains/{chain_id}/dapps/curve/adminFeeChangeLog/historical'.replaceAll('{' r'chain_id' '}', chainId.toString());
