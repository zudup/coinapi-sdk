...
class AddLiquidityEventApi {
  ...
  const AddLiquidityEventApi(this._dio, this._serializers);
  ...
  Future<Response<void>> chainsChainIdDappsCurveAddLiquidityEventHistoricalGet({ 
    ...
    final _path = r'/chains/{chain_id}/dapps/curve/addLiquidityEvent/historical'.replaceAll('{' r'chain_id' '}', chainId.toString());
