...
class HourDataApi {
  ...
  const HourDataApi(this._dio, this._serializers);
  ...
  Future<Response<void>> chainsChainIdDappsSushiswapHourDataHistoricalGet({ 
    ...
    final _path = r'/chains/{chain_id}/dapps/sushiswap/hourData/historical'.replaceAll('{' r'chain_id' '}', chainId.toString());
