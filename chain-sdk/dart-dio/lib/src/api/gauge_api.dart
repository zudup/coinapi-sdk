...
class GaugeApi {
  ...
  const GaugeApi(this._dio, this._serializers);
  ...
  Future<Response<void>> chainsChainIdDappsCurveGaugeHistoricalGet({ 
    ...
    final _path = r'/chains/{chain_id}/dapps/curve/gauge/historical'.replaceAll('{' r'chain_id' '}', chainId.toString());
