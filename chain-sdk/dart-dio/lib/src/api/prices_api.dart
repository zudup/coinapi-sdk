...
class PricesApi {
  ...
  Future<Response<void>> chainsChainIdDappsDexPricesHistoricalGet({ 
    ...
    final _path = r'/chains/{chain_id}/dapps/dex/prices/historical'.replaceAll('{' r'chain_id' '}', chainId.toString());
