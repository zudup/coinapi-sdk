...
class WithdrawApi {
  ...
  const WithdrawApi(this._dio, this._serializers);
  ...
  Future<Response<void>> chainsChainIdDappsDexWithdrawHistoricalGet({ 
    ...
    final _path = r'/chains/{chain_id}/dapps/dex/withdraw/historical'.replaceAll('{' r'chain_id' '}', chainId.toString());
