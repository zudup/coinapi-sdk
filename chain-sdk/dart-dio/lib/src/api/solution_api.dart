...
class SolutionApi {
  ...
  const SolutionApi(this._dio, this._serializers);
  ...
  Future<Response<void>> chainsChainIdDappsDexSolutionHistoricalGet({ 
    ...
    final _path = r'/chains/{chain_id}/dapps/dex/solution/historical'.replaceAll('{' r'chain_id' '}', chainId.toString());
