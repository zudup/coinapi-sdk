...
class PositionSnapshotApi {
  ...
  const PositionSnapshotApi(this._dio, this._serializers);
  ...
  Future<Response<void>> chainsChainIdDappsUniswapv3PositionSnapshotHistoricalGet({ 
    ...
    final _path = r'/chains/{chain_id}/dapps/uniswapv3/positionSnapshot/historical'.replaceAll('{' r'chain_id' '}', chainId.toString());
