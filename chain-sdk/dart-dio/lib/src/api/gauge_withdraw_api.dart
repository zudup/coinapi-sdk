...
class GaugeWithdrawApi {
  ...
  const GaugeWithdrawApi(this._dio, this._serializers);
  ...
  Future<Response<void>> chainsChainIdDappsCurveGaugeWithdrawHistoricalGet({ 
    ...
    final _path = r'/chains/{chain_id}/dapps/curve/gaugeWithdraw/historical'.replaceAll('{' r'chain_id' '}', chainId.toString());
