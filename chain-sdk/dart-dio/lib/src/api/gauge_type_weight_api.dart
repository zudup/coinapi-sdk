...
class GaugeTypeWeightApi {
  ...
  const GaugeTypeWeightApi(this._dio, this._serializers);
  ...
  Future<Response<void>> chainsChainIdDappsCurveGaugeTypeWeightHistoricalGet({ 
    ...
    final _path = r'/chains/{chain_id}/dapps/curve/gaugeTypeWeight/historical'.replaceAll('{' r'chain_id' '}', chainId.toString());
