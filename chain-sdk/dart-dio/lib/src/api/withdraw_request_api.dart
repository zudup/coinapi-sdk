...
class WithdrawRequestApi {
  ...
  const WithdrawRequestApi(this._dio, this._serializers);
  ...
  Future<Response<void>> chainsChainIdDappsDexWithdrawRequestHistoricalGet({ 
    ...
    final _path = r'/chains/{chain_id}/dapps/dex/withdrawRequest/historical'.replaceAll('{' r'chain_id' '}', chainId.toString());
