...
class SettlementApi {
  ...
  const SettlementApi(this._dio, this._serializers);
  ...
  Future<Response<void>> chainsChainIdDappsCowSettlementHistoricalGet({ 
    ...
    final _path = r'/chains/{chain_id}/dapps/cow/settlement/historical'.replaceAll('{' r'chain_id' '}', chainId.toString());
