...
class StatsApi {
  ...
  Future<Response<void>> chainsChainIdDappsDexStatsHistoricalGet({ 
    ...
    final _path = r'/chains/{chain_id}/dapps/dex/stats/historical'.replaceAll('{' r'chain_id' '}', chainId.toString());
