...
class TickDayDataApi {
  ...
  const TickDayDataApi(this._dio, this._serializers);
  ...
  Future<Response<void>> chainsChainIdDappsUniswapv3TickDayDataHistoricalGet({ 
    ...
    final _path = r'/chains/{chain_id}/dapps/uniswapv3/tickDayData/historical'.replaceAll('{' r'chain_id' '}', chainId.toString());
