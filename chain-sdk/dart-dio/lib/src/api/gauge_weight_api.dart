...
class GaugeWeightApi {
  ...
  const GaugeWeightApi(this._dio, this._serializers);
  ...
  Future<Response<void>> chainsChainIdDappsCurveGaugeWeightHistoricalGet({ 
    ...
    final _path = r'/chains/{chain_id}/dapps/curve/gaugeWeight/historical'.replaceAll('{' r'chain_id' '}', chainId.toString());
