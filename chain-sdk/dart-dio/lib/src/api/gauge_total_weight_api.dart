...
class GaugeTotalWeightApi {
  ...
  const GaugeTotalWeightApi(this._dio, this._serializers);
  ...
  Future<Response<void>> chainsChainIdDappsCurveGaugeTotalWeightHistoricalGet({ 
    ...
    final _path = r'/chains/{chain_id}/dapps/curve/gaugeTotalWeight/historical'.replaceAll('{' r'chain_id' '}', chainId.toString());
