...
class ContractsApi {
  ...
  Future<Response<void>> chainsChainIdDappsCurveContractsHistoricalGet({ 
    ...
    final _path = r'/chains/{chain_id}/dapps/curve/contracts/historical'.replaceAll('{' r'chain_id' '}', chainId.toString());
