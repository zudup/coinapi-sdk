...
class DayDataApi {
  ...
  const DayDataApi(this._dio, this._serializers);
  ...
  Future<Response<void>> chainsChainIdDappsSushiswapDayDataHistoricalGet({ 
    ...
    final _path = r'/chains/{chain_id}/dapps/sushiswap/dayData/historical'.replaceAll('{' r'chain_id' '}', chainId.toString());
