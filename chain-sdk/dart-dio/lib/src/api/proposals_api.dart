...
class ProposalsApi {
  ...
  Future<Response<void>> chainsChainIdDappsCurveProposalsHistoricalGet({ 
    ...
    final _path = r'/chains/{chain_id}/dapps/curve/proposals/historical'.replaceAll('{' r'chain_id' '}', chainId.toString());
