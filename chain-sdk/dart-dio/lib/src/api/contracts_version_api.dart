...
class ContractsVersionApi {
  ...
  const ContractsVersionApi(this._dio, this._serializers);
  ...
  Future<Response<void>> chainsChainIdDappsCurveContractsVersionHistoricalGet({ 
    ...
    final _path = r'/chains/{chain_id}/dapps/curve/contractsVersion/historical'.replaceAll('{' r'chain_id' '}', chainId.toString());
