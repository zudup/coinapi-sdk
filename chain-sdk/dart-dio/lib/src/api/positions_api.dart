...
class PositionsApi {
  ...
  Future<Response<void>> chainsChainIdDappsUniswapv3PositionsHistoricalGet({ 
    ...
    final _path = r'/chains/{chain_id}/dapps/uniswapv3/positions/historical'.replaceAll('{' r'chain_id' '}', chainId.toString());
