...
class DailyVolumeApi {
  ...
  const DailyVolumeApi(this._dio, this._serializers);
  ...
  Future<Response<void>> chainsChainIdDappsCurveDailyVolumeHistoricalGet({ 
    ...
    final _path = r'/chains/{chain_id}/dapps/curve/dailyVolume/historical'.replaceAll('{' r'chain_id' '}', chainId.toString());
