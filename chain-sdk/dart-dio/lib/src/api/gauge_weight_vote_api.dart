...
class GaugeWeightVoteApi {
  ...
  const GaugeWeightVoteApi(this._dio, this._serializers);
  ...
  Future<Response<void>> chainsChainIdDappsCurveGaugeWeightVoteHistoricalGet({ 
    ...
    final _path = r'/chains/{chain_id}/dapps/curve/gaugeWeightVote/historical'.replaceAll('{' r'chain_id' '}', chainId.toString());
