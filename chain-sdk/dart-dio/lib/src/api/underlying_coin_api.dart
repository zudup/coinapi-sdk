...
class UnderlyingCoinApi {
  ...
  const UnderlyingCoinApi(this._dio, this._serializers);
  ...
  Future<Response<void>> chainsChainIdDappsCurveUnderlyingCoinHistoricalGet({ 
    ...
    final _path = r'/chains/{chain_id}/dapps/curve/underlyingCoin/historical'.replaceAll('{' r'chain_id' '}', chainId.toString());
