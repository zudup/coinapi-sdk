...
class GaugeTypeApi {
  ...
  const GaugeTypeApi(this._dio, this._serializers);
  ...
  Future<Response<void>> chainsChainIdDappsCurveGaugeTypeHistoricalGet({ 
    ...
    final _path = r'/chains/{chain_id}/dapps/curve/gaugeType/historical'.replaceAll('{' r'chain_id' '}', chainId.toString());
