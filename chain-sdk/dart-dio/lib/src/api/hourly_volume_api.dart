...
class HourlyVolumeApi {
  ...
  const HourlyVolumeApi(this._dio, this._serializers);
  ...
  Future<Response<void>> chainsChainIdDappsCurveHourlyVolumeHistoricalGet({ 
    ...
    final _path = r'/chains/{chain_id}/dapps/curve/hourlyVolume/historical'.replaceAll('{' r'chain_id' '}', chainId.toString());
