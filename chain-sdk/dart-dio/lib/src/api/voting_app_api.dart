...
class VotingAppApi {
  ...
  const VotingAppApi(this._dio, this._serializers);
  ...
  Future<Response<void>> chainsChainIdDappsCurveVotingAppHistoricalGet({ 
    ...
    final _path = r'/chains/{chain_id}/dapps/curve/votingApp/historical'.replaceAll('{' r'chain_id' '}', chainId.toString());
