...
class CowApi {
  ...
  Future<Response<void>> dappsCowOrdersHistoricalGet({ 
    int? startBlock,
    int? endBlock,
    DateTime? startDate,
    DateTime? endDate,
  ...
  /// Returns a [Future]
  /// Throws [DioError] if API call or serialization fails
  Future<Response<void>> dappsCowSettlementHistoricalGet({ 
    int? startBlock,
    int? endBlock,
    DateTime? startDate,
    DateTime? endDate,
    ...
    final _path = r'/dapps/cow/settlement/historical';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
  ...
  /// Returns a [Future]
  /// Throws [DioError] if API call or serialization fails
  Future<Response<void>> dappsCowTokensHistoricalGet({ 
    int? startBlock,
    int? endBlock,
    DateTime? startDate,
    DateTime? endDate,
  ...
  /// Returns a [Future]
  /// Throws [DioError] if API call or serialization fails
  Future<Response<void>> dappsCowTradesHistoricalGet({ 
    int? startBlock,
    int? endBlock,
    DateTime? startDate,
    DateTime? endDate,
  ...
  /// Returns a [Future]
  /// Throws [DioError] if API call or serialization fails
  Future<Response<void>> dappsCowUsersHistoricalGet({ 
    int? startBlock,
    int? endBlock,
    DateTime? startDate,
    DateTime? endDate,
