...
class CowApi {
  ...
  Future<Response<BuiltList<CowOrderDTO>>> cowGetOrdersHistorical({ 
    ...
    final _path = r'/dapps/cow/orders/historical-manual';
  ...
  Future<Response<BuiltList<CowSettlementDTO>>> cowGetSettlementsHistorical({ 
    ...
    final _path = r'/dapps/cow/settlements/historical-manual';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
  ...
  Future<Response<BuiltList<CowTokenDTO>>> cowGetTokensHistorical({ 
    ...
    final _path = r'/dapps/cow/tokens/historical-manual';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
  ...
  Future<Response<BuiltList<CowTradeDTO>>> cowGetTradesHistorical({ 
    ...
    final _path = r'/dapps/cow/trades/historical-manual';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
  ...
  Future<Response<BuiltList<CowUserDTO>>> cowGetUsersHistorical({ 
    ...
    final _path = r'/dapps/cow/users/historical-manual';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
