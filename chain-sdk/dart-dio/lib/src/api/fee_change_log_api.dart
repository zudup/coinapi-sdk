...
class FeeChangeLogApi {
  ...
  const FeeChangeLogApi(this._dio, this._serializers);
  ...
  Future<Response<void>> chainsChainIdDappsCurveFeeChangeLogHistoricalGet({ 
    ...
    final _path = r'/chains/{chain_id}/dapps/curve/feeChangeLog/historical'.replaceAll('{' r'chain_id' '}', chainId.toString());
