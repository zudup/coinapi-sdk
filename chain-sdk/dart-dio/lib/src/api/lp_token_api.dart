...
class LpTokenApi {
  ...
  const LpTokenApi(this._dio, this._serializers);
  ...
  Future<Response<void>> chainsChainIdDappsCurveLpTokenHistoricalGet({ 
    ...
    final _path = r'/chains/{chain_id}/dapps/curve/lpToken/historical'.replaceAll('{' r'chain_id' '}', chainId.toString());
