...
class LiquidityPositionApi {
  ...
  const LiquidityPositionApi(this._dio, this._serializers);
  ...
  Future<Response<void>> chainsChainIdDappsSushiswapLiquidityPositionHistoricalGet({ 
    ...
    final _path = r'/chains/{chain_id}/dapps/sushiswap/liquidityPosition/historical'.replaceAll('{' r'chain_id' '}', chainId.toString());
  ...
  /// Returns a [Future]
  /// Throws [DioError] if API call or serialization fails
  Future<Response<void>> chainsChainIdDappsUniswapv2LiquidityPositionHistoricalGet({ 
    required String chainId,
    int? startBlock,
    int? endBlock,
    DateTime? startDate,
    ...
    final _path = r'/chains/{chain_id}/dapps/uniswapv2/liquidityPosition/historical'.replaceAll('{' r'chain_id' '}', chainId.toString());
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
