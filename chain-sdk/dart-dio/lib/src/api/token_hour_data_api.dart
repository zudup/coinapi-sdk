...
class TokenHourDataApi {
  ...
  const TokenHourDataApi(this._dio, this._serializers);
  ...
  Future<Response<void>> chainsChainIdDappsUniswapv3TokenHourDataHistoricalGet({ 
    ...
    final _path = r'/chains/{chain_id}/dapps/uniswapv3/tokenHourData/historical'.replaceAll('{' r'chain_id' '}', chainId.toString());
