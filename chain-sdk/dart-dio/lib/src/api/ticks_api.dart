...
class TicksApi {
  ...
  const TicksApi(this._dio, this._serializers);
  ...
  Future<Response<void>> chainsChainIdDappsUniswapv3TicksHistoricalGet({ 
    ...
    final _path = r'/chains/{chain_id}/dapps/uniswapv3/ticks/historical'.replaceAll('{' r'chain_id' '}', chainId.toString());
