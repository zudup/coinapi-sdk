...
class RemoveLiquidityEventApi {
  ...
  const RemoveLiquidityEventApi(this._dio, this._serializers);
  ...
  Future<Response<void>> chainsChainIdDappsCurveRemoveLiquidityEventHistoricalGet({ 
    ...
    final _path = r'/chains/{chain_id}/dapps/curve/removeLiquidityEvent/historical'.replaceAll('{' r'chain_id' '}', chainId.toString());
