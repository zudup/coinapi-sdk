...
class SystemStateApi {
  ...
  const SystemStateApi(this._dio, this._serializers);
  ...
  Future<Response<void>> chainsChainIdDappsCurveSystemStateHistoricalGet({ 
    ...
    final _path = r'/chains/{chain_id}/dapps/curve/systemState/historical'.replaceAll('{' r'chain_id' '}', chainId.toString());
