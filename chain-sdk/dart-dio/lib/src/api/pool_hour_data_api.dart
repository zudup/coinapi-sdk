...
class PoolHourDataApi {
  ...
  const PoolHourDataApi(this._dio, this._serializers);
  ...
  Future<Response<void>> chainsChainIdDappsSushiswapPoolHourDataHistoricalGet({ 
    ...
    final _path = r'/chains/{chain_id}/dapps/sushiswap/poolHourData/historical'.replaceAll('{' r'chain_id' '}', chainId.toString());
  ...
  /// Returns a [Future]
  /// Throws [DioError] if API call or serialization fails
  Future<Response<void>> chainsChainIdDappsUniswapv2PoolHourDataHistoricalGet({ 
    required String chainId,
    int? startBlock,
    int? endBlock,
    DateTime? startDate,
    ...
    final _path = r'/chains/{chain_id}/dapps/uniswapv2/poolHourData/historical'.replaceAll('{' r'chain_id' '}', chainId.toString());
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
  ...
  /// Returns a [Future]
  /// Throws [DioError] if API call or serialization fails
  Future<Response<void>> chainsChainIdDappsUniswapv3PoolHourDataHistoricalGet({ 
    required String chainId,
    int? startBlock,
    int? endBlock,
    DateTime? startDate,
    ...
    final _path = r'/chains/{chain_id}/dapps/uniswapv3/poolHourData/historical'.replaceAll('{' r'chain_id' '}', chainId.toString());
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
