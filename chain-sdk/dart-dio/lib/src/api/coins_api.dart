...
class CoinsApi {
  ...
  const CoinsApi(this._dio, this._serializers);
  ...
  Future<Response<void>> chainsChainIdDappsCurveCoinsHistoricalGet({ 
    ...
    final _path = r'/chains/{chain_id}/dapps/curve/coins/historical'.replaceAll('{' r'chain_id' '}', chainId.toString());
