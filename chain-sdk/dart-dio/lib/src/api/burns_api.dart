...
class BurnsApi {
  ...
  const BurnsApi(this._dio, this._serializers);
  ...
  Future<Response<void>> chainsChainIdDappsSushiswapBurnsHistoricalGet({ 
    ...
    final _path = r'/chains/{chain_id}/dapps/sushiswap/burns/historical'.replaceAll('{' r'chain_id' '}', chainId.toString());
  ...
  /// Returns a [Future]
  /// Throws [DioError] if API call or serialization fails
  Future<Response<void>> chainsChainIdDappsUniswapv2BurnsHistoricalGet({ 
    required String chainId,
    int? startBlock,
    int? endBlock,
    DateTime? startDate,
    ...
    final _path = r'/chains/{chain_id}/dapps/uniswapv2/burns/historical'.replaceAll('{' r'chain_id' '}', chainId.toString());
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
  ...
  /// Returns a [Future]
  /// Throws [DioError] if API call or serialization fails
  Future<Response<void>> chainsChainIdDappsUniswapv3BurnsHistoricalGet({ 
    required String chainId,
    int? startBlock,
    int? endBlock,
    DateTime? startDate,
    ...
    final _path = r'/chains/{chain_id}/dapps/uniswapv3/burns/historical'.replaceAll('{' r'chain_id' '}', chainId.toString());
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
