...
// tests for UniswapV2TransactionV2DTO
void main() {
  final instance = UniswapV2TransactionV2DTOBuilder();
  // TODO add properties to the builder and call build()

  group(UniswapV2TransactionV2DTO, () {
    // DateTime entryTime
