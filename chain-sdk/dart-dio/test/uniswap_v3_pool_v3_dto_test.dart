...
// tests for UniswapV3PoolV3DTO
void main() {
  final instance = UniswapV3PoolV3DTOBuilder();
  // TODO add properties to the builder and call build()

  group(UniswapV3PoolV3DTO, () {
    // DateTime entryTime
    ...
    test('to test the property `feeTier`', () async {
      // TODO
    });
    ...
    test('to test the property `observationIndex`', () async {
      // TODO
    });
