...
// tests for UniswapV2LiquidityPositionSnapshotV2DTO
void main() {
  final instance = UniswapV2LiquidityPositionSnapshotV2DTOBuilder();
  // TODO add properties to the builder and call build()

  group(UniswapV2LiquidityPositionSnapshotV2DTO, () {
    // DateTime entryTime
