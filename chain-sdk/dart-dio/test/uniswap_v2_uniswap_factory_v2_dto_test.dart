...
// tests for UniswapV2UniswapFactoryV2DTO
void main() {
  final instance = UniswapV2UniswapFactoryV2DTOBuilder();
  // TODO add properties to the builder and call build()

  group(UniswapV2UniswapFactoryV2DTO, () {
    // DateTime entryTime
    ...
    // int pairCount
    test('to test the property `pairCount`', () async {
      // TODO
    });
