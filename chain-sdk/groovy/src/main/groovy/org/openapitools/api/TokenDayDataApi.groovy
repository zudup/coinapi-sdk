...
class TokenDayDataApi {
    ...
    def chainsChainIdDappsSushiswapTokenDayDataHistoricalGet ( String chainId, Long startBlock, Long endBlock, Date startDate, Date endDate, String tokenId, Closure onSuccess, Closure onFailure)  {
        String resourcePath = "/chains/${chain_id}/dapps/sushiswap/tokenDayData/historical"
