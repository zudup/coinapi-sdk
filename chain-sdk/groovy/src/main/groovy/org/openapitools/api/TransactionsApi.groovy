...
class TransactionsApi {
    ...
    def chainsChainIdDappsSushiswapTransactionsHistoricalGet ( String chainId, Long startBlock, Long endBlock, Date startDate, Date endDate, Closure onSuccess, Closure onFailure)  {
        String resourcePath = "/chains/${chain_id}/dapps/sushiswap/transactions/historical"
