...
-export([cow_get_order_dtos_(historical)/1, cow_get_order_dtos_(historical)/2,
         cow_get_orders_(historical)/1, cow_get_orders_(historical)/2,
         cow_get_settlement_dtos_(historical)/1, cow_get_settlement_dtos_(historical)/2,
         cow_get_settlements_(historical)/1, cow_get_settlements_(historical)/2,
         cow_get_token_dtos_(historical)/1, cow_get_token_dtos_(historical)/2,
         cow_get_tokens_(historical)/1, cow_get_tokens_(historical)/2,
         cow_get_trade_dtos_(historical)/1, cow_get_trade_dtos_(historical)/2,
         cow_get_trades_(historical)/1, cow_get_trades_(historical)/2,
         cow_get_user_dtos_(historical)/1, cow_get_user_dtos_(historical)/2,
...
%% Gets OrderDTOs.
-spec cow_get_order_dtos_(historical)(ctx:ctx()) -> {ok, [openapi_cow_order_dto:openapi_cow_order_dto()], openapi_utils:response_info()} | {ok, hackney:client_ref()} | {error, term(), openapi_utils:response_info()}.
cow_get_order_dtos_(historical)(Ctx) ->
    cow_get_order_dtos_(historical)(Ctx, #{}).

-spec cow_get_order_dtos_(historical)(ctx:ctx(), maps:map()) -> {ok, [openapi_cow_order_dto:openapi_cow_order_dto()], openapi_utils:response_info()} | {ok, hackney:client_ref()} | {error, term(), openapi_utils:response_info()}.
cow_get_order_dtos_(historical)(Ctx, Optional) ->
...
%% @doc SettlementDTOs (historical) 🔥
%% Gets SettlementDTOs.
-spec cow_get_settlement_dtos_(historical)(ctx:ctx()) -> {ok, [openapi_cow_settlement_dto:openapi_cow_settlement_dto()], openapi_utils:response_info()} | {ok, hackney:client_ref()} | {error, term(), openapi_utils:response_info()}.
cow_get_settlement_dtos_(historical)(Ctx) ->
    cow_get_settlement_dtos_(historical)(Ctx, #{}).

-spec cow_get_settlement_dtos_(historical)(ctx:ctx(), maps:map()) -> {ok, [openapi_cow_settlement_dto:openapi_cow_settlement_dto()], openapi_utils:response_info()} | {ok, hackney:client_ref()} | {error, term(), openapi_utils:response_info()}.
cow_get_settlement_dtos_(historical)(Ctx, Optional) ->
    _OptionalParams = maps:get(params, Optional, #{}),
    Cfg = maps:get(cfg, Optional, application:get_env(kuberl, config, #{})),
...
%% Gets TokenDTOs.
-spec cow_get_token_dtos_(historical)(ctx:ctx()) -> {ok, [openapi_cow_token_dto:openapi_cow_token_dto()], openapi_utils:response_info()} | {ok, hackney:client_ref()} | {error, term(), openapi_utils:response_info()}.
cow_get_token_dtos_(historical)(Ctx) ->
    cow_get_token_dtos_(historical)(Ctx, #{}).

-spec cow_get_token_dtos_(historical)(ctx:ctx(), maps:map()) -> {ok, [openapi_cow_token_dto:openapi_cow_token_dto()], openapi_utils:response_info()} | {ok, hackney:client_ref()} | {error, term(), openapi_utils:response_info()}.
cow_get_token_dtos_(historical)(Ctx, Optional) ->
    _OptionalParams = maps:get(params, Optional, #{}),
    Cfg = maps:get(cfg, Optional, application:get_env(kuberl, config, #{})),
...
%% Gets TradeDTOs.
-spec cow_get_trade_dtos_(historical)(ctx:ctx()) -> {ok, [openapi_cow_trade_dto:openapi_cow_trade_dto()], openapi_utils:response_info()} | {ok, hackney:client_ref()} | {error, term(), openapi_utils:response_info()}.
cow_get_trade_dtos_(historical)(Ctx) ->
    cow_get_trade_dtos_(historical)(Ctx, #{}).

-spec cow_get_trade_dtos_(historical)(ctx:ctx(), maps:map()) -> {ok, [openapi_cow_trade_dto:openapi_cow_trade_dto()], openapi_utils:response_info()} | {ok, hackney:client_ref()} | {error, term(), openapi_utils:response_info()}.
cow_get_trade_dtos_(historical)(Ctx, Optional) ->
    _OptionalParams = maps:get(params, Optional, #{}),
    Cfg = maps:get(cfg, Optional, application:get_env(kuberl, config, #{})),
...
%% Gets UserDTOs.
-spec cow_get_user_dtos_(historical)(ctx:ctx()) -> {ok, [openapi_cow_user_dto:openapi_cow_user_dto()], openapi_utils:response_info()} | {ok, hackney:client_ref()} | {error, term(), openapi_utils:response_info()}.
cow_get_user_dtos_(historical)(Ctx) ->
    cow_get_user_dtos_(historical)(Ctx, #{}).

-spec cow_get_user_dtos_(historical)(ctx:ctx(), maps:map()) -> {ok, [openapi_cow_user_dto:openapi_cow_user_dto()], openapi_utils:response_info()} | {ok, hackney:client_ref()} | {error, term(), openapi_utils:response_info()}.
cow_get_user_dtos_(historical)(Ctx, Optional) ->
    _OptionalParams = maps:get(params, Optional, #{}),
    Cfg = maps:get(cfg, Optional, application:get_env(kuberl, config, #{})),
