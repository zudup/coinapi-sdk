...
-export([dapps_uniswapv2_bundles_historical_get/1, dapps_uniswapv2_bundles_historical_get/2,
         ...
         dapps_uniswapv2_poi_historical_get/1, dapps_uniswapv2_poi_historical_get/2,
...
%% @doc 
%% 
-spec dapps_uniswapv2_poi_historical_get(ctx:ctx()) -> {ok, [], openapi_utils:response_info()} | {ok, hackney:client_ref()} | {error, term(), openapi_utils:response_info()}.
dapps_uniswapv2_poi_historical_get(Ctx) ->
    dapps_uniswapv2_poi_historical_get(Ctx, #{}).

-spec dapps_uniswapv2_poi_historical_get(ctx:ctx(), maps:map()) -> {ok, [], openapi_utils:response_info()} | {ok, hackney:client_ref()} | {error, term(), openapi_utils:response_info()}.
dapps_uniswapv2_poi_historical_get(Ctx, Optional) ->
    _OptionalParams = maps:get(params, Optional, #{}),
    Cfg = maps:get(cfg, Optional, application:get_env(kuberl, config, #{})),
