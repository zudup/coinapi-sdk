...
-export([chains_chain_id_dapps_sushiswap_transactions_historical_get/2, chains_chain_id_dapps_sushiswap_transactions_historical_get/3,
         chains_chain_id_dapps_uniswapv2_transactions_historical_get/2, chains_chain_id_dapps_uniswapv2_transactions_historical_get/3,
...
%% @doc 
%% 
-spec chains_chain_id_dapps_sushiswap_transactions_historical_get(ctx:ctx(), binary()) -> {ok, [], openapi_utils:response_info()} | {ok, hackney:client_ref()} | {error, term(), openapi_utils:response_info()}.
chains_chain_id_dapps_sushiswap_transactions_historical_get(Ctx, ChainId) ->
    chains_chain_id_dapps_sushiswap_transactions_historical_get(Ctx, ChainId, #{}).

-spec chains_chain_id_dapps_sushiswap_transactions_historical_get(ctx:ctx(), binary(), maps:map()) -> {ok, [], openapi_utils:response_info()} | {ok, hackney:client_ref()} | {error, term(), openapi_utils:response_info()}.
chains_chain_id_dapps_sushiswap_transactions_historical_get(Ctx, ChainId, Optional) ->
    _OptionalParams = maps:get(params, Optional, #{}),
    Cfg = maps:get(cfg, Optional, application:get_env(kuberl, config, #{})),

    Method = get,
    Path = [<<"/chains/", ChainId, "/dapps/sushiswap/transactions/historical">>],
