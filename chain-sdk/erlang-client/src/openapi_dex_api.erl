...
dex_get_batches_(historical)(Ctx, Optional) ->
    ...
    Method = get,
    Path = [<<"/dapps/dex/batches/historical-manual">>],
...
dex_get_deposits_(historical)(Ctx, Optional) ->
    ...
    Method = get,
    Path = [<<"/dapps/dex/deposits/historical-manual">>],
...
dex_get_orders_(historical)(Ctx, Optional) ->
    ...
    Method = get,
    Path = [<<"/dapps/dex/orders/historical-manual">>],
    QS = lists:flatten([])++openapi_utils:optional_params(['startBlock', 'endBlock', 'startDate', 'endDate', 'tokenId'], _OptionalParams),
    Headers = [],
    Body1 = [],
    ContentTypeHeader = openapi_utils:select_header_content_type([]),
...
dex_get_prices_(historical)(Ctx, Optional) ->
    ...
    Method = get,
    Path = [<<"/dapps/dex/prices/historical-manual">>],
    QS = lists:flatten([])++openapi_utils:optional_params(['startBlock', 'endBlock', 'startDate', 'endDate', 'tokenId'], _OptionalParams),
    Headers = [],
    Body1 = [],
    ContentTypeHeader = openapi_utils:select_header_content_type([]),
...
dex_get_solutions_(historical)(Ctx, Optional) ->
    ...
    Method = get,
    Path = [<<"/dapps/dex/solutions/historical-manual">>],
    QS = lists:flatten([])++openapi_utils:optional_params(['startBlock', 'endBlock', 'startDate', 'endDate', 'tokenId'], _OptionalParams),
    Headers = [],
    Body1 = [],
    ContentTypeHeader = openapi_utils:select_header_content_type([]),
...
dex_get_stats_(historical)(Ctx, Optional) ->
    ...
    Method = get,
    Path = [<<"/dapps/dex/stats/historical-manual">>],
    QS = lists:flatten([])++openapi_utils:optional_params(['startBlock', 'endBlock', 'startDate', 'endDate'], _OptionalParams),
    Headers = [],
    Body1 = [],
    ContentTypeHeader = openapi_utils:select_header_content_type([]),
...
dex_get_tokens_(historical)(Ctx, Optional) ->
    ...
    Method = get,
    Path = [<<"/dapps/dex/tokens/historical-manual">>],
    QS = lists:flatten([])++openapi_utils:optional_params(['startBlock', 'endBlock', 'startDate', 'endDate', 'tokenId'], _OptionalParams),
    Headers = [],
    Body1 = [],
    ContentTypeHeader = openapi_utils:select_header_content_type([]),
...
dex_get_trades_(historical)(Ctx, Optional) ->
    ...
    Method = get,
    Path = [<<"/dapps/dex/trades/historical-manual">>],
    QS = lists:flatten([])++openapi_utils:optional_params(['startBlock', 'endBlock', 'startDate', 'endDate'], _OptionalParams),
    Headers = [],
    Body1 = [],
    ContentTypeHeader = openapi_utils:select_header_content_type([]),
...
dex_get_users_(historical)(Ctx, Optional) ->
    ...
    Method = get,
    Path = [<<"/dapps/dex/users/historical-manual">>],
    QS = lists:flatten([])++openapi_utils:optional_params(['startBlock', 'endBlock', 'startDate', 'endDate'], _OptionalParams),
    Headers = [],
    Body1 = [],
    ContentTypeHeader = openapi_utils:select_header_content_type([]),
...
dex_get_withdraws_(historical)(Ctx, Optional) ->
    ...
    Method = get,
    Path = [<<"/dapps/dex/withdraws/historical-manual">>],
    QS = lists:flatten([])++openapi_utils:optional_params(['startBlock', 'endBlock', 'startDate', 'endDate', 'tokenId'], _OptionalParams),
    Headers = [],
    Body1 = [],
    ContentTypeHeader = openapi_utils:select_header_content_type([]),
...
dex_get_withdraws_requests_(historical)(Ctx, Optional) ->
    ...
    Method = get,
    Path = [<<"/dapps/dex/withdrawsRequests/historical-manual">>],
    QS = lists:flatten([])++openapi_utils:optional_params(['startBlock', 'endBlock', 'startDate', 'endDate', 'tokenId'], _OptionalParams),
    Headers = [],
    Body1 = [],
    ContentTypeHeader = openapi_utils:select_header_content_type([]),
