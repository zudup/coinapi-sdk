...
namespace Example
{
    public class ChainsChainIdDappsDexTokensHistoricalGetExample
    {
        public static void Main()
        {
            ...
            {
                Debug.Print("Exception when calling TokensApi.ChainsChainIdDappsDexTokensHistoricalGet: " + e.Message);
                Debug.Print("Status Code: " + e.ErrorCode);
                Debug.Print(e.StackTrace);
            }
        }
...
{
    Debug.Print("Exception when calling TokensApi.ChainsChainIdDappsDexTokensHistoricalGetWithHttpInfo: " + e.Message);
    Debug.Print("Status Code: " + e.ErrorCode);
    Debug.Print(e.StackTrace);
}
```
