...
namespace CoinAPI.EMS.REST.V1.Test.Api
{
    ...
    public class BatchApiTests : IDisposable
    {
        ...
        /// <summary>
        /// Test ChainsChainIdDappsDexBatchHistoricalGet
        /// </summary>
        [Fact]
        public void ChainsChainIdDappsDexBatchHistoricalGetTest()
        {
            ...
            //instance.ChainsChainIdDappsDexBatchHistoricalGet(chainId, startBlock, endBlock, startDate, endDate);
        }
    }
}
