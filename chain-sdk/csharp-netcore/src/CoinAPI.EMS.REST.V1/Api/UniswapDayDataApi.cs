...
namespace CoinAPI.EMS.REST.V1.Api
{
    ...
    /// </summary>
    public interface IUniswapDayDataApiSync : IApiAccessor
    {
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public interface IUniswapDayDataApiAsync : IApiAccessor
    {
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public interface IUniswapDayDataApi : IUniswapDayDataApiSync, IUniswapDayDataApiAsync
    {
    ...
    public partial class UniswapDayDataApi : IUniswapDayDataApi
    {
        ...
        /// </summary>
        /// <returns></returns>
        public UniswapDayDataApi() : this((string)null)
        {
        }
        ...
        /// <returns></returns>
        public UniswapDayDataApi(CoinAPI.EMS.REST.V1.Client.Configuration configuration)
        {
        ...
        public UniswapDayDataApi(CoinAPI.EMS.REST.V1.Client.ISynchronousClient client, CoinAPI.EMS.REST.V1.Client.IAsynchronousClient asyncClient, CoinAPI.EMS.REST.V1.Client.IReadableConfiguration configuration)
        {
