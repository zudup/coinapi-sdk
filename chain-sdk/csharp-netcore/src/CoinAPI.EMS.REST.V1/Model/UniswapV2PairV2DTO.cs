...
namespace CoinAPI.EMS.REST.V1.Model
{
    ...
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="UniswapV2PairV2DTO" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as UniswapV2PairV2DTO);
        }

        /// <summary>
        /// Returns true if UniswapV2PairV2DTO instances are equal
        /// </summary>
        /// <param name="input">Instance of UniswapV2PairV2DTO to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(UniswapV2PairV2DTO input)
        {
            if (input == null)
            {
                return false;
