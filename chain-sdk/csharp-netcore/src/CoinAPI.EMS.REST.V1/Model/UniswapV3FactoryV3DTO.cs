...
namespace CoinAPI.EMS.REST.V1.Model
{
    ...
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="UniswapV3FactoryV3DTO" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as UniswapV3FactoryV3DTO);
        }

        /// <summary>
        /// Returns true if UniswapV3FactoryV3DTO instances are equal
        /// </summary>
        /// <param name="input">Instance of UniswapV3FactoryV3DTO to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(UniswapV3FactoryV3DTO input)
        {
            if (input == null)
            {
                return false;
