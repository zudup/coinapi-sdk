...
namespace CoinAPI.EMS.REST.V1.Model
{
    ...
    /// </summary>
    [DataContract(Name = "UniswapV2.LiquidityPositionV2DTO")]
    public partial class UniswapV2LiquidityPositionV2DTO : IEquatable<UniswapV2LiquidityPositionV2DTO>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="UniswapV2LiquidityPositionV2DTO" /> class.
        /// </summary>
        ...
        public UniswapV2LiquidityPositionV2DTO(DateTime entryTime = default(DateTime), DateTime recvTime = default(DateTime), long blockNumber = default(long), string id = default(string), string user = default(string), string pair = default(string), string liquidityTokenBalance = default(string), long vid = default(long))
        {
        ...
        {
            return this.Equals(input as UniswapV2LiquidityPositionV2DTO);
        }

        /// <summary>
        /// Returns true if UniswapV2LiquidityPositionV2DTO instances are equal
        /// </summary>
        /// <param name="input">Instance of UniswapV2LiquidityPositionV2DTO to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(UniswapV2LiquidityPositionV2DTO input)
        {
            if (input == null)
            {
                return false;
