...
namespace CoinAPI.EMS.REST.V1.Model
{
    ...
    /// </summary>
    [DataContract(Name = "UniswapV2.TransactionV2DTO")]
    public partial class UniswapV2TransactionV2DTO : IEquatable<UniswapV2TransactionV2DTO>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="UniswapV2TransactionV2DTO" /> class.
        /// </summary>
        ...
        public UniswapV2TransactionV2DTO(DateTime entryTime = default(DateTime), DateTime recvTime = default(DateTime), long blockNumber = default(long), string id = default(string), string timestamp = default(string), List<string> mints = default(List<string>), List<string> burns = default(List<string>), List<string> swaps = default(List<string>), long vid = default(long))
        {
        ...
        {
            return this.Equals(input as UniswapV2TransactionV2DTO);
        }

        /// <summary>
        /// Returns true if UniswapV2TransactionV2DTO instances are equal
        /// </summary>
        /// <param name="input">Instance of UniswapV2TransactionV2DTO to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(UniswapV2TransactionV2DTO input)
        {
            if (input == null)
            {
                return false;
