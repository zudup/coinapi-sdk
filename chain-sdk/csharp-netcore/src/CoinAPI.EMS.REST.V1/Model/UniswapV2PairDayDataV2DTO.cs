...
namespace CoinAPI.EMS.REST.V1.Model
{
    ...
    /// </summary>
    [DataContract(Name = "UniswapV2.PairDayDataV2DTO")]
    public partial class UniswapV2PairDayDataV2DTO : IEquatable<UniswapV2PairDayDataV2DTO>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="UniswapV2PairDayDataV2DTO" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as UniswapV2PairDayDataV2DTO);
        }

        /// <summary>
        /// Returns true if UniswapV2PairDayDataV2DTO instances are equal
        /// </summary>
        /// <param name="input">Instance of UniswapV2PairDayDataV2DTO to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(UniswapV2PairDayDataV2DTO input)
        {
            if (input == null)
            {
                return false;
