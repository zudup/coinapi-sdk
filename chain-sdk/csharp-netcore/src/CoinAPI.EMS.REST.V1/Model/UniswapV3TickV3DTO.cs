...
namespace CoinAPI.EMS.REST.V1.Model
{
    ...
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="UniswapV3TickV3DTO" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as UniswapV3TickV3DTO);
        }

        /// <summary>
        /// Returns true if UniswapV3TickV3DTO instances are equal
        /// </summary>
        /// <param name="input">Instance of UniswapV3TickV3DTO to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(UniswapV3TickV3DTO input)
        {
            if (input == null)
            {
                return false;
