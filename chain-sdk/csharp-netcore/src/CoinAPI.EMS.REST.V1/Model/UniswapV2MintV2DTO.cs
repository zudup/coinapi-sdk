...
namespace CoinAPI.EMS.REST.V1.Model
{
    ...
    /// </summary>
    [DataContract(Name = "UniswapV2.MintV2DTO")]
    public partial class UniswapV2MintV2DTO : IEquatable<UniswapV2MintV2DTO>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="UniswapV2MintV2DTO" /> class.
        /// </summary>
        ...
        public UniswapV2MintV2DTO(DateTime entryTime = default(DateTime), DateTime recvTime = default(DateTime), long blockNumber = default(long), string id = default(string), string transaction = default(string), string timestamp = default(string), string pair = default(string), string to = default(string), string liquidity = default(string), string sender = default(string), string amount0 = default(string), string amount1 = default(string), string logIndex = default(string), string amountUsd = default(string), string feeTo = default(string), string feeLiquidity = default(string), long vid = default(long), string blockRange = default(string))
        {
        ...
        {
            return this.Equals(input as UniswapV2MintV2DTO);
        }

        /// <summary>
        /// Returns true if UniswapV2MintV2DTO instances are equal
        /// </summary>
        /// <param name="input">Instance of UniswapV2MintV2DTO to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(UniswapV2MintV2DTO input)
        {
            if (input == null)
            {
                return false;
