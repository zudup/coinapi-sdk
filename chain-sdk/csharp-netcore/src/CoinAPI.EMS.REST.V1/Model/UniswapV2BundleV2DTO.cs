...
namespace CoinAPI.EMS.REST.V1.Model
{
    ...
    /// </summary>
    [DataContract(Name = "UniswapV2.BundleV2DTO")]
    public partial class UniswapV2BundleV2DTO : IEquatable<UniswapV2BundleV2DTO>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="UniswapV2BundleV2DTO" /> class.
        /// </summary>
        ...
        public UniswapV2BundleV2DTO(DateTime entryTime = default(DateTime), DateTime recvTime = default(DateTime), long blockNumber = default(long), string id = default(string), string ethPrice = default(string), long vid = default(long), string blockRange = default(string))
        {
        ...
        {
            return this.Equals(input as UniswapV2BundleV2DTO);
        }

        /// <summary>
        /// Returns true if UniswapV2BundleV2DTO instances are equal
        /// </summary>
        /// <param name="input">Instance of UniswapV2BundleV2DTO to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(UniswapV2BundleV2DTO input)
        {
            if (input == null)
            {
                return false;
