...
namespace CoinAPI.EMS.REST.V1.Model
{
    ...
    /// </summary>
    [DataContract(Name = "UniswapV2.TokenV2DTO")]
    public partial class UniswapV2TokenV2DTO : IEquatable<UniswapV2TokenV2DTO>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="UniswapV2TokenV2DTO" /> class.
        /// </summary>
        ...
        public UniswapV2TokenV2DTO(DateTime entryTime = default(DateTime), DateTime recvTime = default(DateTime), long blockNumber = default(long), long vid = default(long), string id = default(string), string symbol = default(string), string name = default(string), int decimals = default(int), NumericsBigInteger totalSupply = default(NumericsBigInteger), string tradeVolume = default(string), string tradeVolumeUsd = default(string), string untrackedVolumeUsd = default(string), NumericsBigInteger txCount = default(NumericsBigInteger), string totalLiquidity = default(string), string derivedEth = default(string))
        {
        ...
        {
            return this.Equals(input as UniswapV2TokenV2DTO);
        }

        /// <summary>
        /// Returns true if UniswapV2TokenV2DTO instances are equal
        /// </summary>
        /// <param name="input">Instance of UniswapV2TokenV2DTO to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(UniswapV2TokenV2DTO input)
        {
            if (input == null)
            {
                return false;
