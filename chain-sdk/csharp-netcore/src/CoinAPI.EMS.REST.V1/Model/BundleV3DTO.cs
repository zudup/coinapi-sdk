...
namespace CoinAPI.EMS.REST.V1.Model
{
    ...
    /// BundleV3DTO
    /// </summary>
    [DataContract(Name = "BundleV3DTO")]
    public partial class BundleV3DTO : IEquatable<BundleV3DTO>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="BundleV3DTO" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as BundleV3DTO);
        }

        /// <summary>
        /// Returns true if BundleV3DTO instances are equal
        /// </summary>
        /// <param name="input">Instance of BundleV3DTO to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(BundleV3DTO input)
        {
            if (input == null)
            {
                return false;
