...
namespace CoinAPI.EMS.REST.V1.Model
{
    ...
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="UniswapV3UniswapDayDataV3DTO" /> class.
        /// </summary>
        ...
        public UniswapV3UniswapDayDataV3DTO(DateTime entryTime = default(DateTime), DateTime recvTime = default(DateTime), long blockNumber = default(long), long vid = default(long), string id = default(string), int date = default(int), string volumeEth = default(string), string volumeUsd = default(string), string volumeUsdUntracked = default(string), string feesUsd = default(string), NumericsBigInteger txCount = default(NumericsBigInteger), string tvlUsd = default(string))
        {
        ...
        {
            return this.Equals(input as UniswapV3UniswapDayDataV3DTO);
        }

        /// <summary>
        /// Returns true if UniswapV3UniswapDayDataV3DTO instances are equal
        /// </summary>
        /// <param name="input">Instance of UniswapV3UniswapDayDataV3DTO to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(UniswapV3UniswapDayDataV3DTO input)
        {
            if (input == null)
            {
                return false;
