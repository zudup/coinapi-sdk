...
namespace CoinAPI.EMS.REST.V1.Model
{
    ...
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="UniswapV3BurnV3DTO" /> class.
        /// </summary>
        ...
        public UniswapV3BurnV3DTO(DateTime entryTime = default(DateTime), DateTime recvTime = default(DateTime), long blockNumber = default(long), string id = default(string), string transaction = default(string), string pool = default(string), string token0 = default(string), string token1 = default(string), string timestamp = default(string), string owner = default(string), string origin = default(string), string amount = default(string), string amount0 = default(string), string amount1 = default(string), string amountUsd = default(string), string tickLower = default(string), string tickUpper = default(string), string logIndex = default(string), long vid = default(long))
        {
        ...
        {
            return this.Equals(input as UniswapV3BurnV3DTO);
        }

        /// <summary>
        /// Returns true if UniswapV3BurnV3DTO instances are equal
        /// </summary>
        /// <param name="input">Instance of UniswapV3BurnV3DTO to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(UniswapV3BurnV3DTO input)
        {
            if (input == null)
            {
                return false;
