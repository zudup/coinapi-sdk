...
namespace CoinAPI.EMS.REST.V1.Model
{
    ...
    /// PoolDayDataV3DTO
    /// </summary>
    [DataContract(Name = "PoolDayDataV3DTO")]
    public partial class PoolDayDataV3DTO : IEquatable<PoolDayDataV3DTO>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PoolDayDataV3DTO" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as PoolDayDataV3DTO);
        }

        /// <summary>
        /// Returns true if PoolDayDataV3DTO instances are equal
        /// </summary>
        /// <param name="input">Instance of PoolDayDataV3DTO to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PoolDayDataV3DTO input)
        {
            if (input == null)
            {
                return false;
