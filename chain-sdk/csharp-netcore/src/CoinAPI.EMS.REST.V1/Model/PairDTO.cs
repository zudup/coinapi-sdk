...
namespace CoinAPI.EMS.REST.V1.Model
{
    ...
    /// </summary>
    [DataContract(Name = "PairDTO")]
    public partial class PairDTO : IEquatable<PairDTO>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PairDTO" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as PairDTO);
        }

        /// <summary>
        /// Returns true if PairDTO instances are equal
        /// </summary>
        /// <param name="input">Instance of PairDTO to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PairDTO input)
        {
            if (input == null)
            {
                return false;
