...
namespace CoinAPI.EMS.REST.V1.Model
{
    ...
    /// </summary>
    [DataContract(Name = "UniswapV3.TokenHourDataV3DTO")]
    public partial class UniswapV3TokenHourDataV3DTO : IEquatable<UniswapV3TokenHourDataV3DTO>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="UniswapV3TokenHourDataV3DTO" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as UniswapV3TokenHourDataV3DTO);
        }

        /// <summary>
        /// Returns true if UniswapV3TokenHourDataV3DTO instances are equal
        /// </summary>
        /// <param name="input">Instance of UniswapV3TokenHourDataV3DTO to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(UniswapV3TokenHourDataV3DTO input)
        {
            if (input == null)
            {
                return false;
