...
namespace CoinAPI.EMS.REST.V1.Model
{
    ...
    /// MintV3DTO
    /// </summary>
    [DataContract(Name = "MintV3DTO")]
    public partial class MintV3DTO : IEquatable<MintV3DTO>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MintV3DTO" /> class.
        /// </summary>
        ...
        public MintV3DTO(DateTime entryTime = default(DateTime), DateTime recvTime = default(DateTime), long blockNumber = default(long), string id = default(string), string transaction = default(string), string timestamp = default(string), string pool = default(string), string token0 = default(string), string token1 = default(string), string owner = default(string), string sender = default(string), string origin = default(string), string amount = default(string), string amount0 = default(string), string amount1 = default(string), string amountUsd = default(string), string tickLower = default(string), string tickUpper = default(string), string logIndex = default(string), long vid = default(long))
        {
        ...
        {
            return this.Equals(input as MintV3DTO);
        }

        /// <summary>
        /// Returns true if MintV3DTO instances are equal
        /// </summary>
        /// <param name="input">Instance of MintV3DTO to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MintV3DTO input)
        {
            if (input == null)
            {
                return false;
