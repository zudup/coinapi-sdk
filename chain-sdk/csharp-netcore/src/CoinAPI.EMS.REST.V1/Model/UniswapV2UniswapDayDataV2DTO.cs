...
namespace CoinAPI.EMS.REST.V1.Model
{
    ...
    /// </summary>
    [DataContract(Name = "UniswapV2.UniswapDayDataV2DTO")]
    public partial class UniswapV2UniswapDayDataV2DTO : IEquatable<UniswapV2UniswapDayDataV2DTO>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="UniswapV2UniswapDayDataV2DTO" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as UniswapV2UniswapDayDataV2DTO);
        }

        /// <summary>
        /// Returns true if UniswapV2UniswapDayDataV2DTO instances are equal
        /// </summary>
        /// <param name="input">Instance of UniswapV2UniswapDayDataV2DTO to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(UniswapV2UniswapDayDataV2DTO input)
        {
            if (input == null)
            {
                return false;
