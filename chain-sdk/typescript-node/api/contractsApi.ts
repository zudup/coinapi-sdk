...
export class ContractsApi {
     ...
     * @param poolId 
     */
    public async chainsChainIdDappsCurveContractsHistoricalGet (chainId: string, startBlock?: number, endBlock?: number, startDate?: Date, endDate?: Date, poolId?: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body?: any;  }> {
        const localVarPath = this.basePath + '/chains/{chain_id}/dapps/curve/contracts/historical'
