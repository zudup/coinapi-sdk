...
export class BatchApi {
     ...
     * @param endDate 
     */
    public async chainsChainIdDappsDexBatchHistoricalGet (chainId: string, startBlock?: number, endBlock?: number, startDate?: Date, endDate?: Date, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body?: any;  }> {
        const localVarPath = this.basePath + '/chains/{chain_id}/dapps/dex/batch/historical'
