...
export class PricesApi {
     ...
     * @param tokenId 
     */
    public async chainsChainIdDappsDexPricesHistoricalGet (chainId: string, startBlock?: number, endBlock?: number, startDate?: Date, endDate?: Date, tokenId?: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body?: any;  }> {
        const localVarPath = this.basePath + '/chains/{chain_id}/dapps/dex/prices/historical'
