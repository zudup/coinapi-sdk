...
export enum RemoveLiquidityEventApiApiKeys {
}

export class RemoveLiquidityEventApi {
    ...
    public setApiKey(key: RemoveLiquidityEventApiApiKeys, value: string) {
        (this.authentications as any)[RemoveLiquidityEventApiApiKeys[key]].apiKey = value;
    }
     ...
     * @param poolId 
     */
    public async chainsChainIdDappsCurveRemoveLiquidityEventHistoricalGet (chainId: string, startBlock?: number, endBlock?: number, startDate?: Date, endDate?: Date, poolId?: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body?: any;  }> {
        const localVarPath = this.basePath + '/chains/{chain_id}/dapps/curve/removeLiquidityEvent/historical'
