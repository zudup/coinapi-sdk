...
export enum UniswapDayDataApiApiKeys {
}

export class UniswapDayDataApi {
    ...
    public setApiKey(key: UniswapDayDataApiApiKeys, value: string) {
        (this.authentications as any)[UniswapDayDataApiApiKeys[key]].apiKey = value;
    }
