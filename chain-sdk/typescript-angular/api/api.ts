...
export const APIS = [BundlesService, BurnsService, FactoryService, MintsService, PoiService, PoolDayDataService, PoolHourDataService, PoolsService, PositionSnapshotService, SushiswapService, SwapsService, TokensService, TradesService, UniswapV2Service, UniswapV3Service];
