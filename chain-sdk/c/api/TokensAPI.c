...
TokensAPI_chainsChainIdDappsCowTokensHistoricalGet(apiClient_t *apiClient, char * chain_id , long startBlock , long endBlock , char startDate , char endDate , char * tokenId )
{
    ...
    // create the path
    long sizeOfPath = strlen("/chains/{chain_id}/dapps/cow/tokens/historical")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/chains/{chain_id}/dapps/cow/tokens/historical");
...
TokensAPI_chainsChainIdDappsCurveTokensHistoricalGet(apiClient_t *apiClient, char * chain_id , long startBlock , long endBlock , char startDate , char endDate , char * tokenId )
{
    ...
    // create the path
    long sizeOfPath = strlen("/chains/{chain_id}/dapps/curve/tokens/historical")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/chains/{chain_id}/dapps/curve/tokens/historical");
...
TokensAPI_chainsChainIdDappsDexTokensHistoricalGet(apiClient_t *apiClient, char * chain_id , long startBlock , long endBlock , char startDate , char endDate , char * tokenId )
{
    ...
    // create the path
    long sizeOfPath = strlen("/chains/{chain_id}/dapps/dex/tokens/historical")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/chains/{chain_id}/dapps/dex/tokens/historical");
...
TokensAPI_chainsChainIdDappsSushiswapTokensHistoricalGet(apiClient_t *apiClient, char * chain_id , long startBlock , long endBlock , char startDate , char endDate , char * tokenId )
{
    ...
    // create the path
    long sizeOfPath = strlen("/chains/{chain_id}/dapps/sushiswap/tokens/historical")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/chains/{chain_id}/dapps/sushiswap/tokens/historical");
...
TokensAPI_chainsChainIdDappsUniswapv2TokensHistoricalGet(apiClient_t *apiClient, char * chain_id , long startBlock , long endBlock , char startDate , char endDate , char * tokenId )
{
    ...
    // create the path
    long sizeOfPath = strlen("/chains/{chain_id}/dapps/uniswapv2/tokens/historical")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/chains/{chain_id}/dapps/uniswapv2/tokens/historical");
...
TokensAPI_chainsChainIdDappsUniswapv3TokensHistoricalGet(apiClient_t *apiClient, char * chain_id , long startBlock , long endBlock , char startDate , char endDate , char * tokenId )
{
    ...
    // create the path
    long sizeOfPath = strlen("/chains/{chain_id}/dapps/uniswapv3/tokens/historical")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/chains/{chain_id}/dapps/uniswapv3/tokens/historical");
