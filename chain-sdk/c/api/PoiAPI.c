...
void
PoiAPI_chainsChainIdDappsCowPoiHistoricalGet(apiClient_t *apiClient, char * chain_id , long startBlock , long endBlock , char startDate , char endDate )
{
    ...
    // create the path
    long sizeOfPath = strlen("/chains/{chain_id}/dapps/cow/poi/historical")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/chains/{chain_id}/dapps/cow/poi/historical");
...
void
PoiAPI_chainsChainIdDappsCurvePoiHistoricalGet(apiClient_t *apiClient, char * chain_id , long startBlock , long endBlock , char startDate , char endDate )
{
    list_t    *localVarQueryParameters = list_createList();
    list_t    *localVarHeaderParameters = NULL;
    list_t    *localVarFormParameters = NULL;
    ...
    // create the path
    long sizeOfPath = strlen("/chains/{chain_id}/dapps/curve/poi/historical")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/chains/{chain_id}/dapps/curve/poi/historical");
...
PoiAPI_chainsChainIdDappsDexPoiHistoricalGet(apiClient_t *apiClient, char * chain_id , long startBlock , long endBlock , char startDate , char endDate )
{
    ...
    // create the path
    long sizeOfPath = strlen("/chains/{chain_id}/dapps/dex/poi/historical")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/chains/{chain_id}/dapps/dex/poi/historical");
...
PoiAPI_chainsChainIdDappsSushiswapPoiHistoricalGet(apiClient_t *apiClient, char * chain_id , long startBlock , long endBlock , char startDate , char endDate )
{
    ...
    // create the path
    long sizeOfPath = strlen("/chains/{chain_id}/dapps/sushiswap/poi/historical")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/chains/{chain_id}/dapps/sushiswap/poi/historical");
