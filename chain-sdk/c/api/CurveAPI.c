...
CurveAPI_curveGetAccountDTOsHistorical(apiClient_t *apiClient, long startBlock , long endBlock , char startDate , char endDate , char * poolId )
{
    ...
    // create the path
    long sizeOfPath = strlen("/dapps/curve/AccountDTOs/historical")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/dapps/curve/AccountDTOs/historical");
...
CurveAPI_curveGetAddLiquidityEventDTOsHistorical(apiClient_t *apiClient, long startBlock , long endBlock , char startDate , char endDate , char * poolId )
{
    ...
    // create the path
    long sizeOfPath = strlen("/dapps/curve/AddLiquidityEventDTOs/historical")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/dapps/curve/AddLiquidityEventDTOs/historical");
...
CurveAPI_curveGetAdminFeeChangeLogDTOsHistorical(apiClient_t *apiClient, long startBlock , long endBlock , char startDate , char endDate , char * poolId )
{
    ...
    // create the path
    long sizeOfPath = strlen("/dapps/curve/AdminFeeChangeLogDTOs/historical")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/dapps/curve/AdminFeeChangeLogDTOs/historical");
...
CurveAPI_curveGetAmplificationCoeffChangeLogDTOsHistorical(apiClient_t *apiClient, long startBlock , long endBlock , char startDate , char endDate , char * poolId )
{
    ...
    // create the path
    long sizeOfPath = strlen("/dapps/curve/AmplificationCoeffChangeLogDTOs/historical")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/dapps/curve/AmplificationCoeffChangeLogDTOs/historical");
...
CurveAPI_curveGetCoinDTOsHistorical(apiClient_t *apiClient, long startBlock , long endBlock , char startDate , char endDate , char * poolId )
{
    ...
    // create the path
    long sizeOfPath = strlen("/dapps/curve/CoinDTOs/historical")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/dapps/curve/CoinDTOs/historical");
...
CurveAPI_curveGetContractDTOsHistorical(apiClient_t *apiClient, long startBlock , long endBlock , char startDate , char endDate , char * poolId )
{
    ...
    // create the path
    long sizeOfPath = strlen("/dapps/curve/ContractDTOs/historical")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/dapps/curve/ContractDTOs/historical");
...
CurveAPI_curveGetContractVersionDTOsHistorical(apiClient_t *apiClient, long startBlock , long endBlock , char startDate , char endDate , char * poolId )
{
    ...
    // create the path
    long sizeOfPath = strlen("/dapps/curve/ContractVersionDTOs/historical")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/dapps/curve/ContractVersionDTOs/historical");
...
CurveAPI_curveGetDailyVolumeDTOsHistorical(apiClient_t *apiClient, long startBlock , long endBlock , char startDate , char endDate , char * poolId )
{
    ...
    // create the path
    long sizeOfPath = strlen("/dapps/curve/DailyVolumeDTOs/historical")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/dapps/curve/DailyVolumeDTOs/historical");
...
CurveAPI_curveGetExchangeDTOsHistorical(apiClient_t *apiClient, long startBlock , long endBlock , char startDate , char endDate , char * poolId )
{
    ...
    // create the path
    long sizeOfPath = strlen("/dapps/curve/ExchangeDTOs/historical")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/dapps/curve/ExchangeDTOs/historical");
...
CurveAPI_curveGetFeeChangeLogDTOsHistorical(apiClient_t *apiClient, long startBlock , long endBlock , char startDate , char endDate , char * poolId )
{
    ...
    // create the path
    long sizeOfPath = strlen("/dapps/curve/FeeChangeLogDTOs/historical")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/dapps/curve/FeeChangeLogDTOs/historical");
...
CurveAPI_curveGetGaugeDTOsHistorical(apiClient_t *apiClient, long startBlock , long endBlock , char startDate , char endDate , char * poolId )
{
    ...
    // create the path
    long sizeOfPath = strlen("/dapps/curve/GaugeDTOs/historical")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/dapps/curve/GaugeDTOs/historical");
...
CurveAPI_curveGetGaugeDepositDTOsHistorical(apiClient_t *apiClient, long startBlock , long endBlock , char startDate , char endDate , char * poolId )
{
    ...
    // create the path
    long sizeOfPath = strlen("/dapps/curve/GaugeDepositDTOs/historical")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/dapps/curve/GaugeDepositDTOs/historical");
...
CurveAPI_curveGetGaugeLiquidityDTOsHistorical(apiClient_t *apiClient, long startBlock , long endBlock , char startDate , char endDate , char * poolId )
{
    ...
    // create the path
    long sizeOfPath = strlen("/dapps/curve/GaugeLiquidityDTOs/historical")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/dapps/curve/GaugeLiquidityDTOs/historical");
...
CurveAPI_curveGetGaugeTotalWeightDTOsHistorical(apiClient_t *apiClient, long startBlock , long endBlock , char startDate , char endDate , char * poolId )
{
    ...
    // create the path
    long sizeOfPath = strlen("/dapps/curve/GaugeTotalWeightDTOs/historical")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/dapps/curve/GaugeTotalWeightDTOs/historical");
...
CurveAPI_curveGetGaugeTypeDTOsHistorical(apiClient_t *apiClient, long startBlock , long endBlock , char startDate , char endDate , char * poolId )
{
    ...
    // create the path
    long sizeOfPath = strlen("/dapps/curve/GaugeTypeDTOs/historical")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/dapps/curve/GaugeTypeDTOs/historical");
...
CurveAPI_curveGetGaugeTypeWeightDTOsHistorical(apiClient_t *apiClient, long startBlock , long endBlock , char startDate , char endDate , char * poolId )
{
    ...
    // create the path
    long sizeOfPath = strlen("/dapps/curve/GaugeTypeWeightDTOs/historical")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/dapps/curve/GaugeTypeWeightDTOs/historical");
...
CurveAPI_curveGetGaugeWeightDTOsHistorical(apiClient_t *apiClient, long startBlock , long endBlock , char startDate , char endDate , char * poolId )
{
    ...
    // create the path
    long sizeOfPath = strlen("/dapps/curve/GaugeWeightDTOs/historical")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/dapps/curve/GaugeWeightDTOs/historical");
...
CurveAPI_curveGetGaugeWeightVoteDTOsHistorical(apiClient_t *apiClient, long startBlock , long endBlock , char startDate , char endDate , char * poolId )
{
    ...
    // create the path
    long sizeOfPath = strlen("/dapps/curve/GaugeWeightVoteDTOs/historical")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/dapps/curve/GaugeWeightVoteDTOs/historical");
...
CurveAPI_curveGetGaugeWithdrawDTOsHistorical(apiClient_t *apiClient, long startBlock , long endBlock , char startDate , char endDate , char * poolId )
{
    ...
    // create the path
    long sizeOfPath = strlen("/dapps/curve/GaugeWithdrawDTOs/historical")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/dapps/curve/GaugeWithdrawDTOs/historical");
...
CurveAPI_curveGetHourlyVolumeDTOsHistorical(apiClient_t *apiClient, long startBlock , long endBlock , char startDate , char endDate , char * poolId )
{
    ...
    // create the path
    long sizeOfPath = strlen("/dapps/curve/HourlyVolumeDTOs/historical")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/dapps/curve/HourlyVolumeDTOs/historical");
...
CurveAPI_curveGetLpTokenDTOsHistorical(apiClient_t *apiClient, long startBlock , long endBlock , char startDate , char endDate , char * poolId )
{
    ...
    // create the path
    long sizeOfPath = strlen("/dapps/curve/LpTokenDTOs/historical")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/dapps/curve/LpTokenDTOs/historical");
...
CurveAPI_curveGetPoolDTOsHistorical(apiClient_t *apiClient, long startBlock , long endBlock , char startDate , char endDate , char * poolId )
{
    ...
    // create the path
    long sizeOfPath = strlen("/dapps/curve/PoolDTOs/historical")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/dapps/curve/PoolDTOs/historical");
...
CurveAPI_curveGetProposalDTOsHistorical(apiClient_t *apiClient, long startBlock , long endBlock , char startDate , char endDate , char * poolId )
{
    ...
    // create the path
    long sizeOfPath = strlen("/dapps/curve/ProposalDTOs/historical")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/dapps/curve/ProposalDTOs/historical");
...
CurveAPI_curveGetProposalVoteDTOsHistorical(apiClient_t *apiClient, long startBlock , long endBlock , char startDate , char endDate , char * poolId )
{
    ...
    // create the path
    long sizeOfPath = strlen("/dapps/curve/ProposalVoteDTOs/historical")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/dapps/curve/ProposalVoteDTOs/historical");
...
CurveAPI_curveGetRemoveLiquidityEventDTOsHistorical(apiClient_t *apiClient, long startBlock , long endBlock , char startDate , char endDate , char * poolId )
{
    ...
    // create the path
    long sizeOfPath = strlen("/dapps/curve/RemoveLiquidityEventDTOs/historical")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/dapps/curve/RemoveLiquidityEventDTOs/historical");
...
CurveAPI_curveGetRemoveLiquidityOneEventDTOsHistorical(apiClient_t *apiClient, long startBlock , long endBlock , char startDate , char endDate , char * poolId )
{
    ...
    // create the path
    long sizeOfPath = strlen("/dapps/curve/RemoveLiquidityOneEventDTOs/historical")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/dapps/curve/RemoveLiquidityOneEventDTOs/historical");
...
CurveAPI_curveGetSystemStateDTOsHistorical(apiClient_t *apiClient, long startBlock , long endBlock , char startDate , char endDate , char * poolId )
{
    ...
    // create the path
    long sizeOfPath = strlen("/dapps/curve/SystemStateDTOs/historical")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/dapps/curve/SystemStateDTOs/historical");
...
CurveAPI_curveGetTokenDTOsHistorical(apiClient_t *apiClient, long startBlock , long endBlock , char startDate , char endDate , char * poolId )
{
    ...
    // create the path
    long sizeOfPath = strlen("/dapps/curve/TokenDTOs/historical")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/dapps/curve/TokenDTOs/historical");
...
CurveAPI_curveGetTransferOwnershipEventDTOsHistorical(apiClient_t *apiClient, long startBlock , long endBlock , char startDate , char endDate , char * poolId )
{
    ...
    // create the path
    long sizeOfPath = strlen("/dapps/curve/TransferOwnershipEventDTOs/historical")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/dapps/curve/TransferOwnershipEventDTOs/historical");
...
CurveAPI_curveGetUnderlyingCoinDTOsHistorical(apiClient_t *apiClient, long startBlock , long endBlock , char startDate , char endDate , char * poolId )
{
    ...
    // create the path
    long sizeOfPath = strlen("/dapps/curve/UnderlyingCoinDTOs/historical")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/dapps/curve/UnderlyingCoinDTOs/historical");
...
CurveAPI_curveGetVotingAppDTOsHistorical(apiClient_t *apiClient, long startBlock , long endBlock , char startDate , char endDate , char * poolId )
{
    ...
    // create the path
    long sizeOfPath = strlen("/dapps/curve/VotingAppDTOs/historical")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/dapps/curve/VotingAppDTOs/historical");
...
CurveAPI_curveGetWeeklyVolumeDTOsHistorical(apiClient_t *apiClient, long startBlock , long endBlock , char startDate , char endDate , char * poolId )
{
    ...
    // create the path
    long sizeOfPath = strlen("/dapps/curve/WeeklyVolumeDTOs/historical")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/dapps/curve/WeeklyVolumeDTOs/historical");
