...
#include <stdio.h>
#include <ctype.h>
#include "LiquidityPositionSnapshotsAPI.h"
...
LiquidityPositionSnapshotsAPI_chainsChainIdDappsSushiswapLiquidityPositionSnapshotsHistoricalGet(apiClient_t *apiClient, char * chain_id , long startBlock , long endBlock , char startDate , char endDate , char * poolId )
{
    ...
    // create the path
    long sizeOfPath = strlen("/chains/{chain_id}/dapps/sushiswap/liquidityPositionSnapshots/historical")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/chains/{chain_id}/dapps/sushiswap/liquidityPositionSnapshots/historical");
...
LiquidityPositionSnapshotsAPI_chainsChainIdDappsUniswapv2LiquidityPositionSnapshotsHistoricalGet(apiClient_t *apiClient, char * chain_id , long startBlock , long endBlock , char startDate , char endDate , char * poolId )
{
    ...
    // create the path
    long sizeOfPath = strlen("/chains/{chain_id}/dapps/uniswapv2/liquidityPositionSnapshots/historical")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/chains/{chain_id}/dapps/uniswapv2/liquidityPositionSnapshots/historical");
