...
void
DailyVolumeAPI_chainsChainIdDappsCurveDailyVolumeHistoricalGet(apiClient_t *apiClient, char * chain_id , long startBlock , long endBlock , char startDate , char endDate , char * poolId )
{
    ...
    // create the path
    long sizeOfPath = strlen("/chains/{chain_id}/dapps/curve/dailyVolume/historical")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/chains/{chain_id}/dapps/curve/dailyVolume/historical");
