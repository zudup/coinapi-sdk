...
void
PricesAPI_chainsChainIdDappsDexPricesHistoricalGet(apiClient_t *apiClient, char * chain_id , long startBlock , long endBlock , char startDate , char endDate , char * tokenId )
{
    ...
    // create the path
    long sizeOfPath = strlen("/chains/{chain_id}/dapps/dex/prices/historical")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/chains/{chain_id}/dapps/dex/prices/historical");
