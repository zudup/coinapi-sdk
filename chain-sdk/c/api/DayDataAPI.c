...
void
DayDataAPI_chainsChainIdDappsSushiswapDayDataHistoricalGet(apiClient_t *apiClient, char * chain_id , long startBlock , long endBlock , char startDate , char endDate )
{
    ...
    // create the path
    long sizeOfPath = strlen("/chains/{chain_id}/dapps/sushiswap/dayData/historical")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/chains/{chain_id}/dapps/sushiswap/dayData/historical");
