...
void
HourDataAPI_chainsChainIdDappsSushiswapHourDataHistoricalGet(apiClient_t *apiClient, char * chain_id , long startBlock , long endBlock , char startDate , char endDate )
{
    ...
    // create the path
    long sizeOfPath = strlen("/chains/{chain_id}/dapps/sushiswap/hourData/historical")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/chains/{chain_id}/dapps/sushiswap/hourData/historical");
