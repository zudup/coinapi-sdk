...
onchain_api_transactions_e_trade_aggressive_side__e transactions_e_trade_aggressive_side_transactions_e_trade_aggressive_side_parseFromJSON(cJSON *transactions_e_trade_aggressive_sideJSON) {
    onchain_api_transactions_e_trade_aggressive_side__e *transactions_e_trade_aggressive_side = NULL;
    onchain_api_transactions_e_trade_aggressive_side__e transactions_e_trade_aggressive_sideVariable;
