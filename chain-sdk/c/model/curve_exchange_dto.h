...
typedef enum  { onchain_api_curve_exchange_dto__NULL = 0, onchain_api_curve_exchange_dto__Buy, onchain_api_curve_exchange_dto__Sell, onchain_api_curve_exchange_dto__EstimatedBuy, onchain_api_curve_exchange_dto__EstimatedSell, onchain_api_curve_exchange_dto__Unknown } onchain_api_curve_exchange_dto__e;

char* curve_exchange_dto_evaluated_aggressor_ToString(onchain_api_curve_exchange_dto__e evaluated_aggressor);

onchain_api_curve_exchange_dto__e curve_exchange_dto_evaluated_aggressor_FromString(char* evaluated_aggressor);
