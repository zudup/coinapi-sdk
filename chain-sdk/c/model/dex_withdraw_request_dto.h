/*
 * dex_withdraw_request_dto.h
 *
 * Withdraw request of an user
 */

#ifndef _dex_withdraw_request_dto_H_
#define _dex_withdraw_request_dto_H_
...
typedef struct dex_withdraw_request_dto_t dex_withdraw_request_dto_t;




typedef struct dex_withdraw_request_dto_t {
    ...
    char *amount; // string
    char *withdrawable_from_batch_id; // string
...
#endif /* _dex_withdraw_request_dto_H_ */
