...
typedef enum  { onchain_api_uniswap_v2_swap_dto__NULL = 0, onchain_api_uniswap_v2_swap_dto__Buy, onchain_api_uniswap_v2_swap_dto__Sell, onchain_api_uniswap_v2_swap_dto__EstimatedBuy, onchain_api_uniswap_v2_swap_dto__EstimatedSell, onchain_api_uniswap_v2_swap_dto__Unknown } onchain_api_uniswap_v2_swap_dto__e;

char* uniswap_v2_swap_dto_evaluated_aggressor_ToString(onchain_api_uniswap_v2_swap_dto__e evaluated_aggressor);

onchain_api_uniswap_v2_swap_dto__e uniswap_v2_swap_dto_evaluated_aggressor_FromString(char* evaluated_aggressor);
