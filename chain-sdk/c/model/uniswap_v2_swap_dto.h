...
typedef enum  { on_chain___rest_api_uniswap_v2_swap_dto__NULL = 0, on_chain___rest_api_uniswap_v2_swap_dto__Buy, on_chain___rest_api_uniswap_v2_swap_dto__Sell, on_chain___rest_api_uniswap_v2_swap_dto__EstimatedBuy, on_chain___rest_api_uniswap_v2_swap_dto__EstimatedSell, on_chain___rest_api_uniswap_v2_swap_dto__Unknown } on_chain___rest_api_uniswap_v2_swap_dto__e;

char* uniswap_v2_swap_dto_evaluated_aggressor_ToString(on_chain___rest_api_uniswap_v2_swap_dto__e evaluated_aggressor);

on_chain___rest_api_uniswap_v2_swap_dto__e uniswap_v2_swap_dto_evaluated_aggressor_FromString(char* evaluated_aggressor);
