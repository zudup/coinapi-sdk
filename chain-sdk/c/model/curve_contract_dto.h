/*
 * curve_contract_dto.h
 *
 * 
 */

#ifndef _curve_contract_dto_H_
#define _curve_contract_dto_H_
...
typedef struct curve_contract_dto_t curve_contract_dto_t;




typedef struct curve_contract_dto_t {
    ...
    char *modified_at_block; // string
    char *modified_at_transaction; // string
    long vid; //numeric

} curve_contract_dto_t;
