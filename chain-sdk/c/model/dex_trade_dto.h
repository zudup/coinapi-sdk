...
typedef enum  { on_chain___rest_api_dex_trade_dto__NULL = 0, on_chain___rest_api_dex_trade_dto__Buy, on_chain___rest_api_dex_trade_dto__Sell, on_chain___rest_api_dex_trade_dto__EstimatedBuy, on_chain___rest_api_dex_trade_dto__EstimatedSell, on_chain___rest_api_dex_trade_dto__Unknown } on_chain___rest_api_dex_trade_dto__e;

char* dex_trade_dto_evaluated_aggressor_ToString(on_chain___rest_api_dex_trade_dto__e evaluated_aggressor);

on_chain___rest_api_dex_trade_dto__e dex_trade_dto_evaluated_aggressor_FromString(char* evaluated_aggressor);
