...
typedef enum  { onchain_api_dex_trade_dto__NULL = 0, onchain_api_dex_trade_dto__Buy, onchain_api_dex_trade_dto__Sell, onchain_api_dex_trade_dto__EstimatedBuy, onchain_api_dex_trade_dto__EstimatedSell, onchain_api_dex_trade_dto__Unknown } onchain_api_dex_trade_dto__e;

char* dex_trade_dto_evaluated_aggressor_ToString(onchain_api_dex_trade_dto__e evaluated_aggressor);

onchain_api_dex_trade_dto__e dex_trade_dto_evaluated_aggressor_FromString(char* evaluated_aggressor);
