...
function contracts_api:chains_chain_id_dapps_curve_contracts_historical_get(chain_id, start_block, end_block, start_date, end_date, pool_id)
	local req = http_request.new_from_uri({
		scheme = self.default_scheme;
		host = self.host;
		port = self.port;
		path = string.format("%s/chains/%s/dapps/curve/contracts/historical?startBlock=%s&endBlock=%s&startDate=%s&endDate=%s&poolId=%s",
