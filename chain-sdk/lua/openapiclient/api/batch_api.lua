...
function batch_api:chains_chain_id_dapps_dex_batch_historical_get(chain_id, start_block, end_block, start_date, end_date)
	local req = http_request.new_from_uri({
		scheme = self.default_scheme;
		host = self.host;
		port = self.port;
		path = string.format("%s/chains/%s/dapps/dex/batch/historical?startBlock=%s&endBlock=%s&startDate=%s&endDate=%s",
