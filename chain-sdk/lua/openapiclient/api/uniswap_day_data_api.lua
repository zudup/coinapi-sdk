...
local uniswap_day_data_api = {}
local uniswap_day_data_api_mt = {
	__name = "uniswap_day_data_api";
	__index = uniswap_day_data_api;
}

local function new_uniswap_day_data_api(authority, basePath, schemes)
	local schemes_map = {}
