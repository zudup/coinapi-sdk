...
function cow_api:cow_get_orders__historical(start_block, end_block, start_date, end_date)
	local req = http_request.new_from_uri({
		...
		host = self.host;
		port = self.port;
		path = string.format("%s/dapps/cow/orders/historical-manual?startBlock=%s&endBlock=%s&startDate=%s&endDate=%s",
...
function cow_api:cow_get_settlements__historical(start_block, end_block, start_date, end_date)
	local req = http_request.new_from_uri({
		...
		host = self.host;
		port = self.port;
		path = string.format("%s/dapps/cow/settlements/historical-manual?startBlock=%s&endBlock=%s&startDate=%s&endDate=%s",
			self.basePath, http_util.encodeURIComponent(start_block), http_util.encodeURIComponent(end_block), http_util.encodeURIComponent(start_date), http_util.encodeURIComponent(end_date));
	})
...
function cow_api:cow_get_tokens__historical(start_block, end_block, start_date, end_date, token_id)
	local req = http_request.new_from_uri({
		...
		host = self.host;
		port = self.port;
		path = string.format("%s/dapps/cow/tokens/historical-manual?startBlock=%s&endBlock=%s&startDate=%s&endDate=%s&tokenId=%s",
...
function cow_api:cow_get_trades__historical(start_block, end_block, start_date, end_date)
	local req = http_request.new_from_uri({
		...
		host = self.host;
		port = self.port;
		path = string.format("%s/dapps/cow/trades/historical-manual?startBlock=%s&endBlock=%s&startDate=%s&endDate=%s",
			self.basePath, http_util.encodeURIComponent(start_block), http_util.encodeURIComponent(end_block), http_util.encodeURIComponent(start_date), http_util.encodeURIComponent(end_date));
	})
...
function cow_api:cow_get_users__historical(start_block, end_block, start_date, end_date)
	local req = http_request.new_from_uri({
		...
		host = self.host;
		port = self.port;
		path = string.format("%s/dapps/cow/users/historical-manual?startBlock=%s&endBlock=%s&startDate=%s&endDate=%s",
			self.basePath, http_util.encodeURIComponent(start_block), http_util.encodeURIComponent(end_block), http_util.encodeURIComponent(start_date), http_util.encodeURIComponent(end_date));
	})
