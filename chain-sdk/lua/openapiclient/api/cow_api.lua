...
function cow_api:cow_get_order_dtos__historical(start_block, end_block, start_date, end_date, pool_id)
	local req = http_request.new_from_uri({
		scheme = self.default_scheme;
		host = self.host;
		port = self.port;
		path = string.format("%s/dapps/cow/OrderDTOs/historical?startBlock=%s&endBlock=%s&startDate=%s&endDate=%s&poolId=%s",
...
function cow_api:cow_get_orders__historical(start_block, end_block, start_date, end_date)
	local req = http_request.new_from_uri({
		...
		host = self.host;
		port = self.port;
		path = string.format("%s/dapps/cow/orders/historical?startBlock=%s&endBlock=%s&startDate=%s&endDate=%s",
...
function cow_api:cow_get_settlement_dtos__historical(start_block, end_block, start_date, end_date, pool_id)
	local req = http_request.new_from_uri({
		scheme = self.default_scheme;
		host = self.host;
		port = self.port;
		path = string.format("%s/dapps/cow/SettlementDTOs/historical?startBlock=%s&endBlock=%s&startDate=%s&endDate=%s&poolId=%s",
			self.basePath, http_util.encodeURIComponent(start_block), http_util.encodeURIComponent(end_block), http_util.encodeURIComponent(start_date), http_util.encodeURIComponent(end_date), http_util.encodeURIComponent(pool_id));
	})
...
function cow_api:cow_get_token_dtos__historical(start_block, end_block, start_date, end_date, pool_id)
	local req = http_request.new_from_uri({
		scheme = self.default_scheme;
		host = self.host;
		port = self.port;
		path = string.format("%s/dapps/cow/TokenDTOs/historical?startBlock=%s&endBlock=%s&startDate=%s&endDate=%s&poolId=%s",
			self.basePath, http_util.encodeURIComponent(start_block), http_util.encodeURIComponent(end_block), http_util.encodeURIComponent(start_date), http_util.encodeURIComponent(end_date), http_util.encodeURIComponent(pool_id));
	})
...
function cow_api:cow_get_tokens__historical(start_block, end_block, start_date, end_date, token_id)
	local req = http_request.new_from_uri({
		...
		host = self.host;
		port = self.port;
		path = string.format("%s/dapps/cow/tokens/historical?startBlock=%s&endBlock=%s&startDate=%s&endDate=%s&tokenId=%s",
...
function cow_api:cow_get_trade_dtos__historical(start_block, end_block, start_date, end_date, pool_id)
	local req = http_request.new_from_uri({
		scheme = self.default_scheme;
		host = self.host;
		port = self.port;
		path = string.format("%s/dapps/cow/TradeDTOs/historical?startBlock=%s&endBlock=%s&startDate=%s&endDate=%s&poolId=%s",
			self.basePath, http_util.encodeURIComponent(start_block), http_util.encodeURIComponent(end_block), http_util.encodeURIComponent(start_date), http_util.encodeURIComponent(end_date), http_util.encodeURIComponent(pool_id));
	})
...
function cow_api:cow_get_trades__historical(start_block, end_block, start_date, end_date)
	local req = http_request.new_from_uri({
		...
		host = self.host;
		port = self.port;
		path = string.format("%s/dapps/cow/trades/historical?startBlock=%s&endBlock=%s&startDate=%s&endDate=%s",
			self.basePath, http_util.encodeURIComponent(start_block), http_util.encodeURIComponent(end_block), http_util.encodeURIComponent(start_date), http_util.encodeURIComponent(end_date));
	})
...
function cow_api:cow_get_user_dtos__historical(start_block, end_block, start_date, end_date, pool_id)
	local req = http_request.new_from_uri({
		scheme = self.default_scheme;
		host = self.host;
		port = self.port;
		path = string.format("%s/dapps/cow/UserDTOs/historical?startBlock=%s&endBlock=%s&startDate=%s&endDate=%s&poolId=%s",
			self.basePath, http_util.encodeURIComponent(start_block), http_util.encodeURIComponent(end_block), http_util.encodeURIComponent(start_date), http_util.encodeURIComponent(end_date), http_util.encodeURIComponent(pool_id));
	})
...
function cow_api:cow_get_users__historical(start_block, end_block, start_date, end_date)
	local req = http_request.new_from_uri({
		...
		host = self.host;
		port = self.port;
		path = string.format("%s/dapps/cow/users/historical?startBlock=%s&endBlock=%s&startDate=%s&endDate=%s",
			self.basePath, http_util.encodeURIComponent(start_block), http_util.encodeURIComponent(end_block), http_util.encodeURIComponent(start_date), http_util.encodeURIComponent(end_date));
	})
