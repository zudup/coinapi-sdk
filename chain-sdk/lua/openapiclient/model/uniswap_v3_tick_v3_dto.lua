...
-- uniswap_v3_tick_v3_dto class
local uniswap_v3_tick_v3_dto = {}
local uniswap_v3_tick_v3_dto_mt = {
	__name = "uniswap_v3_tick_v3_dto";
	__index = uniswap_v3_tick_v3_dto;
}

local function cast_uniswap_v3_tick_v3_dto(t)
	return setmetatable(t, uniswap_v3_tick_v3_dto_mt)
end

local function new_uniswap_v3_tick_v3_dto(entry_time, recv_time, block_number, vid, id, pool_address, tick_idx, pool, liquidity_gross, liquidity_net, price_0, price_1, volume_token_0, volume_token_1, volume_usd, untracked_volume_usd, fees_usd, collected_fees_token_0, collected_fees_token_1, collected_fees_usd, created_at_timestamp, liquidity_provider_count, fee_growth_outside_0x128, fee_growth_outside_1x128)
	return cast_uniswap_v3_tick_v3_dto({
...
return {
	cast = cast_uniswap_v3_tick_v3_dto;
	new = new_uniswap_v3_tick_v3_dto;
}
