...
-- uniswap_v2_pair_dto class
local uniswap_v2_pair_dto = {}
local uniswap_v2_pair_dto_mt = {
	__name = "uniswap_v2_pair_dto";
	__index = uniswap_v2_pair_dto;
}

local function cast_uniswap_v2_pair_dto(t)
	return setmetatable(t, uniswap_v2_pair_dto_mt)
end

local function new_uniswap_v2_pair_dto(entry_time, recv_time, block_number, vid, id, token_0, token_1, reserve_0, reserve_1, total_supply, reserve_eth, reserve_usd, tracked_reserve_eth, token_0_price, token_1_price, volume_token_0, volume_token_1, volume_usd, untracked_volume_usd, tx_count, created_at_timestamp, liquidity_provider_count, evaluated_ask)
	return cast_uniswap_v2_pair_dto({
...
return {
	cast = cast_uniswap_v2_pair_dto;
	new = new_uniswap_v2_pair_dto;
}
