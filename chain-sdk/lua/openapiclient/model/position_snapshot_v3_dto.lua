...
-- position_snapshot_v3_dto class
local position_snapshot_v3_dto = {}
local position_snapshot_v3_dto_mt = {
	__name = "position_snapshot_v3_dto";
	__index = position_snapshot_v3_dto;
}

local function cast_position_snapshot_v3_dto(t)
	return setmetatable(t, position_snapshot_v3_dto_mt)
end

local function new_position_snapshot_v3_dto(entry_time, recv_time, block_number, id, owner, pool, position, timestamp, liquidity, deposited_token_0, deposited_token_1, withdrawn_token_0, withdrawn_token_1, collected_fees_token_0, collected_fees_token_1, transaction, fee_growth_inside_0_last_x128, fee_growth_inside_1_last_x128, vid)
	return cast_position_snapshot_v3_dto({
...
return {
	cast = cast_position_snapshot_v3_dto;
	new = new_position_snapshot_v3_dto;
}
