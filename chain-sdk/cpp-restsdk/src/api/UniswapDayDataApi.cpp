...
#include "CppRestOpenAPIClient/api/UniswapDayDataApi.h"
...
UniswapDayDataApi::UniswapDayDataApi( std::shared_ptr<const ApiClient> apiClient )
    : m_ApiClient(apiClient)
{
}

UniswapDayDataApi::~UniswapDayDataApi()
{
}
