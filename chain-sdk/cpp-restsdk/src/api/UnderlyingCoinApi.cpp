...
#include "CppRestOpenAPIClient/api/UnderlyingCoinApi.h"
...
UnderlyingCoinApi::UnderlyingCoinApi( std::shared_ptr<const ApiClient> apiClient )
    : m_ApiClient(apiClient)
{
}

UnderlyingCoinApi::~UnderlyingCoinApi()
{
}

pplx::task<void> UnderlyingCoinApi::chainsChainIdDappsCurveUnderlyingCoinHistoricalGet(utility::string_t chainId, boost::optional<int64_t> startBlock, boost::optional<int64_t> endBlock, boost::optional<utility::datetime> startDate, boost::optional<utility::datetime> endDate, boost::optional<utility::string_t> poolId) const
{


    std::shared_ptr<const ApiConfiguration> localVarApiConfiguration( m_ApiClient->getConfiguration() );
    utility::string_t localVarPath = utility::conversions::to_string_t("/chains/{chain_id}/dapps/curve/underlyingCoin/historical");
    ...
    {
        throw ApiException(400, utility::conversions::to_string_t("UnderlyingCoinApi->chainsChainIdDappsCurveUnderlyingCoinHistoricalGet does not produce any supported media type"));
    }
    ...
    {
        throw ApiException(415, utility::conversions::to_string_t("UnderlyingCoinApi->chainsChainIdDappsCurveUnderlyingCoinHistoricalGet does not consume any supported media type"));
    }
    ...
    .then([=](web::http::http_response localVarResponse)
    {
        ...
        if (localVarResponse.status_code() >= 400)
        {
            throw ApiException(localVarResponse.status_code()
                , utility::conversions::to_string_t("error calling chainsChainIdDappsCurveUnderlyingCoinHistoricalGet: ") + localVarResponse.reason_phrase()
        ...
        if(localVarResponse.headers().has(utility::conversions::to_string_t("Content-Type")))
        {
            ...
            if( localVarContentType.find(localVarResponseHttpContentType) == std::string::npos )
            {
                throw ApiException(500
                    , utility::conversions::to_string_t("error calling chainsChainIdDappsCurveUnderlyingCoinHistoricalGet: unexpected response type: ") + localVarContentType
                    , std::make_shared<std::stringstream>(localVarResponse.extract_utf8string(true).get()));
            }
        }
