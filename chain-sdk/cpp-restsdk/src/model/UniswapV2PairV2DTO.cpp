...
void UniswapV2PairV2DTO::validate()
{
    // TODO: implement validation
}

web::json::value UniswapV2PairV2DTO::toJson() const
{
...
bool UniswapV2PairV2DTO::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void UniswapV2PairV2DTO::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool UniswapV2PairV2DTO::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
utility::datetime UniswapV2PairV2DTO::getEntryTime() const
{
    return m_Entry_time;
}

void UniswapV2PairV2DTO::setEntryTime(const utility::datetime& value)
{
    m_Entry_time = value;
    m_Entry_timeIsSet = true;
}

bool UniswapV2PairV2DTO::entryTimeIsSet() const
{
    return m_Entry_timeIsSet;
}

void UniswapV2PairV2DTO::unsetEntry_time()
{
    m_Entry_timeIsSet = false;
}
utility::datetime UniswapV2PairV2DTO::getRecvTime() const
{
    return m_Recv_time;
}

void UniswapV2PairV2DTO::setRecvTime(const utility::datetime& value)
{
    m_Recv_time = value;
    m_Recv_timeIsSet = true;
}

bool UniswapV2PairV2DTO::recvTimeIsSet() const
{
    return m_Recv_timeIsSet;
}

void UniswapV2PairV2DTO::unsetRecv_time()
{
    m_Recv_timeIsSet = false;
}
int64_t UniswapV2PairV2DTO::getBlockNumber() const
{
    return m_Block_number;
}

void UniswapV2PairV2DTO::setBlockNumber(int64_t value)
{
    m_Block_number = value;
    m_Block_numberIsSet = true;
}

bool UniswapV2PairV2DTO::blockNumberIsSet() const
{
    return m_Block_numberIsSet;
}

void UniswapV2PairV2DTO::unsetBlock_number()
{
    m_Block_numberIsSet = false;
}
int64_t UniswapV2PairV2DTO::getVid() const
{
    return m_Vid;
}

void UniswapV2PairV2DTO::setVid(int64_t value)
{
    m_Vid = value;
    m_VidIsSet = true;
}

bool UniswapV2PairV2DTO::vidIsSet() const
{
    return m_VidIsSet;
}

void UniswapV2PairV2DTO::unsetVid()
{
    m_VidIsSet = false;
}
utility::string_t UniswapV2PairV2DTO::getId() const
{
    return m_Id;
}

void UniswapV2PairV2DTO::setId(const utility::string_t& value)
{
    m_Id = value;
    m_IdIsSet = true;
}

bool UniswapV2PairV2DTO::idIsSet() const
{
    return m_IdIsSet;
}

void UniswapV2PairV2DTO::unsetId()
{
    m_IdIsSet = false;
}
utility::string_t UniswapV2PairV2DTO::getToken0() const
{
    return m_Token_0;
}

void UniswapV2PairV2DTO::setToken0(const utility::string_t& value)
{
    m_Token_0 = value;
    m_Token_0IsSet = true;
}

bool UniswapV2PairV2DTO::token0IsSet() const
{
    return m_Token_0IsSet;
}

void UniswapV2PairV2DTO::unsetToken_0()
{
    m_Token_0IsSet = false;
}
utility::string_t UniswapV2PairV2DTO::getToken1() const
{
    return m_Token_1;
}

void UniswapV2PairV2DTO::setToken1(const utility::string_t& value)
{
    m_Token_1 = value;
    m_Token_1IsSet = true;
}

bool UniswapV2PairV2DTO::token1IsSet() const
{
    return m_Token_1IsSet;
}

void UniswapV2PairV2DTO::unsetToken_1()
{
    m_Token_1IsSet = false;
}
utility::string_t UniswapV2PairV2DTO::getReserve0() const
{
    return m_Reserve_0;
}

void UniswapV2PairV2DTO::setReserve0(const utility::string_t& value)
{
    m_Reserve_0 = value;
    m_Reserve_0IsSet = true;
}

bool UniswapV2PairV2DTO::reserve0IsSet() const
{
    return m_Reserve_0IsSet;
}

void UniswapV2PairV2DTO::unsetReserve_0()
{
    m_Reserve_0IsSet = false;
}
utility::string_t UniswapV2PairV2DTO::getReserve1() const
{
    return m_Reserve_1;
}

void UniswapV2PairV2DTO::setReserve1(const utility::string_t& value)
{
    m_Reserve_1 = value;
    m_Reserve_1IsSet = true;
}

bool UniswapV2PairV2DTO::reserve1IsSet() const
{
    return m_Reserve_1IsSet;
}

void UniswapV2PairV2DTO::unsetReserve_1()
{
    m_Reserve_1IsSet = false;
}
utility::string_t UniswapV2PairV2DTO::getTotalSupply() const
{
    return m_Total_supply;
}

void UniswapV2PairV2DTO::setTotalSupply(const utility::string_t& value)
{
    m_Total_supply = value;
    m_Total_supplyIsSet = true;
}

bool UniswapV2PairV2DTO::totalSupplyIsSet() const
{
    return m_Total_supplyIsSet;
}

void UniswapV2PairV2DTO::unsetTotal_supply()
{
    m_Total_supplyIsSet = false;
}
utility::string_t UniswapV2PairV2DTO::getReserveEth() const
{
    return m_Reserve_eth;
}

void UniswapV2PairV2DTO::setReserveEth(const utility::string_t& value)
{
    m_Reserve_eth = value;
    m_Reserve_ethIsSet = true;
}

bool UniswapV2PairV2DTO::reserveEthIsSet() const
{
    return m_Reserve_ethIsSet;
}

void UniswapV2PairV2DTO::unsetReserve_eth()
{
    m_Reserve_ethIsSet = false;
}
utility::string_t UniswapV2PairV2DTO::getReserveUsd() const
{
    return m_Reserve_usd;
}

void UniswapV2PairV2DTO::setReserveUsd(const utility::string_t& value)
{
    m_Reserve_usd = value;
    m_Reserve_usdIsSet = true;
}

bool UniswapV2PairV2DTO::reserveUsdIsSet() const
{
    return m_Reserve_usdIsSet;
}

void UniswapV2PairV2DTO::unsetReserve_usd()
{
    m_Reserve_usdIsSet = false;
}
utility::string_t UniswapV2PairV2DTO::getTrackedReserveEth() const
{
    return m_Tracked_reserve_eth;
}

void UniswapV2PairV2DTO::setTrackedReserveEth(const utility::string_t& value)
{
    m_Tracked_reserve_eth = value;
    m_Tracked_reserve_ethIsSet = true;
}

bool UniswapV2PairV2DTO::trackedReserveEthIsSet() const
{
    return m_Tracked_reserve_ethIsSet;
}

void UniswapV2PairV2DTO::unsetTracked_reserve_eth()
{
    m_Tracked_reserve_ethIsSet = false;
}
utility::string_t UniswapV2PairV2DTO::getToken0Price() const
{
    return m_Token_0_price;
}

void UniswapV2PairV2DTO::setToken0Price(const utility::string_t& value)
{
    m_Token_0_price = value;
    m_Token_0_priceIsSet = true;
}

bool UniswapV2PairV2DTO::token0PriceIsSet() const
{
    return m_Token_0_priceIsSet;
}

void UniswapV2PairV2DTO::unsetToken_0_price()
{
    m_Token_0_priceIsSet = false;
}
utility::string_t UniswapV2PairV2DTO::getToken1Price() const
{
    return m_Token_1_price;
}

void UniswapV2PairV2DTO::setToken1Price(const utility::string_t& value)
{
    m_Token_1_price = value;
    m_Token_1_priceIsSet = true;
}

bool UniswapV2PairV2DTO::token1PriceIsSet() const
{
    return m_Token_1_priceIsSet;
}

void UniswapV2PairV2DTO::unsetToken_1_price()
{
    m_Token_1_priceIsSet = false;
}
utility::string_t UniswapV2PairV2DTO::getVolumeToken0() const
{
    return m_Volume_token_0;
}

void UniswapV2PairV2DTO::setVolumeToken0(const utility::string_t& value)
{
    m_Volume_token_0 = value;
    m_Volume_token_0IsSet = true;
}

bool UniswapV2PairV2DTO::volumeToken0IsSet() const
{
    return m_Volume_token_0IsSet;
}

void UniswapV2PairV2DTO::unsetVolume_token_0()
{
    m_Volume_token_0IsSet = false;
}
utility::string_t UniswapV2PairV2DTO::getVolumeToken1() const
{
    return m_Volume_token_1;
}

void UniswapV2PairV2DTO::setVolumeToken1(const utility::string_t& value)
{
    m_Volume_token_1 = value;
    m_Volume_token_1IsSet = true;
}

bool UniswapV2PairV2DTO::volumeToken1IsSet() const
{
    return m_Volume_token_1IsSet;
}

void UniswapV2PairV2DTO::unsetVolume_token_1()
{
    m_Volume_token_1IsSet = false;
}
utility::string_t UniswapV2PairV2DTO::getVolumeUsd() const
{
    return m_Volume_usd;
}

void UniswapV2PairV2DTO::setVolumeUsd(const utility::string_t& value)
{
    m_Volume_usd = value;
    m_Volume_usdIsSet = true;
}

bool UniswapV2PairV2DTO::volumeUsdIsSet() const
{
    return m_Volume_usdIsSet;
}

void UniswapV2PairV2DTO::unsetVolume_usd()
{
    m_Volume_usdIsSet = false;
}
utility::string_t UniswapV2PairV2DTO::getUntrackedVolumeUsd() const
{
    return m_Untracked_volume_usd;
}

void UniswapV2PairV2DTO::setUntrackedVolumeUsd(const utility::string_t& value)
{
    m_Untracked_volume_usd = value;
    m_Untracked_volume_usdIsSet = true;
}

bool UniswapV2PairV2DTO::untrackedVolumeUsdIsSet() const
{
    return m_Untracked_volume_usdIsSet;
}

void UniswapV2PairV2DTO::unsetUntracked_volume_usd()
{
    m_Untracked_volume_usdIsSet = false;
}
std::shared_ptr<NumericsBigInteger> UniswapV2PairV2DTO::getTxCount() const
{
    return m_Tx_count;
}

void UniswapV2PairV2DTO::setTxCount(const std::shared_ptr<NumericsBigInteger>& value)
{
    m_Tx_count = value;
    m_Tx_countIsSet = true;
}

bool UniswapV2PairV2DTO::txCountIsSet() const
{
    return m_Tx_countIsSet;
}

void UniswapV2PairV2DTO::unsetTx_count()
{
    m_Tx_countIsSet = false;
}
utility::datetime UniswapV2PairV2DTO::getCreatedAtTimestamp() const
{
    return m_Created_at_timestamp;
}

void UniswapV2PairV2DTO::setCreatedAtTimestamp(const utility::datetime& value)
{
    m_Created_at_timestamp = value;
    m_Created_at_timestampIsSet = true;
}

bool UniswapV2PairV2DTO::createdAtTimestampIsSet() const
{
    return m_Created_at_timestampIsSet;
}

void UniswapV2PairV2DTO::unsetCreated_at_timestamp()
{
    m_Created_at_timestampIsSet = false;
}
utility::string_t UniswapV2PairV2DTO::getLiquidityProviderCount() const
{
    return m_Liquidity_provider_count;
}

void UniswapV2PairV2DTO::setLiquidityProviderCount(const utility::string_t& value)
{
    m_Liquidity_provider_count = value;
    m_Liquidity_provider_countIsSet = true;
}

bool UniswapV2PairV2DTO::liquidityProviderCountIsSet() const
{
    return m_Liquidity_provider_countIsSet;
}

void UniswapV2PairV2DTO::unsetLiquidity_provider_count()
{
    m_Liquidity_provider_countIsSet = false;
}
double UniswapV2PairV2DTO::getEvaluatedAsk() const
{
    return m_Evaluated_ask;
}

void UniswapV2PairV2DTO::setEvaluatedAsk(double value)
{
    m_Evaluated_ask = value;
    m_Evaluated_askIsSet = true;
}

bool UniswapV2PairV2DTO::evaluatedAskIsSet() const
{
    return m_Evaluated_askIsSet;
}

void UniswapV2PairV2DTO::unsetEvaluated_ask()
{
    m_Evaluated_askIsSet = false;
}
}
