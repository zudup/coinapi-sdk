...
void PoolV3DTO::validate()
{
    // TODO: implement validation
}

web::json::value PoolV3DTO::toJson() const
{
...
bool PoolV3DTO::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("fee_tier"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::shared_ptr<BigInteger> refVal_setFeeTier;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("liquidity"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::shared_ptr<BigInteger> refVal_setLiquidity;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("sqrt_price"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::shared_ptr<BigInteger> refVal_setSqrtPrice;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("fee_growth_global_0x128"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::shared_ptr<BigInteger> refVal_setFeeGrowthGlobal0x128;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("fee_growth_global_1x128"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::shared_ptr<BigInteger> refVal_setFeeGrowthGlobal1x128;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("observation_index"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::shared_ptr<BigInteger> refVal_setObservationIndex;
...
void PoolV3DTO::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool PoolV3DTO::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
utility::datetime PoolV3DTO::getEntryTime() const
{
    return m_Entry_time;
}

void PoolV3DTO::setEntryTime(const utility::datetime& value)
{
    m_Entry_time = value;
    m_Entry_timeIsSet = true;
}

bool PoolV3DTO::entryTimeIsSet() const
{
    return m_Entry_timeIsSet;
}

void PoolV3DTO::unsetEntry_time()
{
    m_Entry_timeIsSet = false;
}
utility::datetime PoolV3DTO::getRecvTime() const
{
    return m_Recv_time;
}

void PoolV3DTO::setRecvTime(const utility::datetime& value)
{
    m_Recv_time = value;
    m_Recv_timeIsSet = true;
}

bool PoolV3DTO::recvTimeIsSet() const
{
    return m_Recv_timeIsSet;
}

void PoolV3DTO::unsetRecv_time()
{
    m_Recv_timeIsSet = false;
}
int64_t PoolV3DTO::getBlockNumber() const
{
    return m_Block_number;
}

void PoolV3DTO::setBlockNumber(int64_t value)
{
    m_Block_number = value;
    m_Block_numberIsSet = true;
}

bool PoolV3DTO::blockNumberIsSet() const
{
    return m_Block_numberIsSet;
}

void PoolV3DTO::unsetBlock_number()
{
    m_Block_numberIsSet = false;
}
int64_t PoolV3DTO::getVid() const
{
    return m_Vid;
}

void PoolV3DTO::setVid(int64_t value)
{
    m_Vid = value;
    m_VidIsSet = true;
}

bool PoolV3DTO::vidIsSet() const
{
    return m_VidIsSet;
}

void PoolV3DTO::unsetVid()
{
    m_VidIsSet = false;
}
utility::string_t PoolV3DTO::getId() const
{
    return m_Id;
}

void PoolV3DTO::setId(const utility::string_t& value)
{
    m_Id = value;
    m_IdIsSet = true;
}

bool PoolV3DTO::idIsSet() const
{
    return m_IdIsSet;
}

void PoolV3DTO::unsetId()
{
    m_IdIsSet = false;
}
utility::datetime PoolV3DTO::getCreatedAtTimestamp() const
{
    return m_Created_at_timestamp;
}

void PoolV3DTO::setCreatedAtTimestamp(const utility::datetime& value)
{
    m_Created_at_timestamp = value;
    m_Created_at_timestampIsSet = true;
}

bool PoolV3DTO::createdAtTimestampIsSet() const
{
    return m_Created_at_timestampIsSet;
}

void PoolV3DTO::unsetCreated_at_timestamp()
{
    m_Created_at_timestampIsSet = false;
}
utility::string_t PoolV3DTO::getToken0() const
{
    return m_Token_0;
}

void PoolV3DTO::setToken0(const utility::string_t& value)
{
    m_Token_0 = value;
    m_Token_0IsSet = true;
}

bool PoolV3DTO::token0IsSet() const
{
    return m_Token_0IsSet;
}

void PoolV3DTO::unsetToken_0()
{
    m_Token_0IsSet = false;
}
utility::string_t PoolV3DTO::getToken1() const
{
    return m_Token_1;
}

void PoolV3DTO::setToken1(const utility::string_t& value)
{
    m_Token_1 = value;
    m_Token_1IsSet = true;
}

bool PoolV3DTO::token1IsSet() const
{
    return m_Token_1IsSet;
}

void PoolV3DTO::unsetToken_1()
{
    m_Token_1IsSet = false;
}
std::shared_ptr<BigInteger> PoolV3DTO::getFeeTier() const
{
    return m_Fee_tier;
}

void PoolV3DTO::setFeeTier(const std::shared_ptr<BigInteger>& value)
{
    m_Fee_tier = value;
    m_Fee_tierIsSet = true;
}

bool PoolV3DTO::feeTierIsSet() const
{
    return m_Fee_tierIsSet;
}

void PoolV3DTO::unsetFee_tier()
{
    m_Fee_tierIsSet = false;
}
std::shared_ptr<BigInteger> PoolV3DTO::getLiquidity() const
{
    return m_Liquidity;
}

void PoolV3DTO::setLiquidity(const std::shared_ptr<BigInteger>& value)
{
    m_Liquidity = value;
    m_LiquidityIsSet = true;
}

bool PoolV3DTO::liquidityIsSet() const
{
    return m_LiquidityIsSet;
}

void PoolV3DTO::unsetLiquidity()
{
    m_LiquidityIsSet = false;
}
std::shared_ptr<BigInteger> PoolV3DTO::getSqrtPrice() const
{
    return m_Sqrt_price;
}

void PoolV3DTO::setSqrtPrice(const std::shared_ptr<BigInteger>& value)
{
    m_Sqrt_price = value;
    m_Sqrt_priceIsSet = true;
}

bool PoolV3DTO::sqrtPriceIsSet() const
{
    return m_Sqrt_priceIsSet;
}

void PoolV3DTO::unsetSqrt_price()
{
    m_Sqrt_priceIsSet = false;
}
std::shared_ptr<BigInteger> PoolV3DTO::getFeeGrowthGlobal0x128() const
{
    return m_Fee_growth_global_0x128;
}

void PoolV3DTO::setFeeGrowthGlobal0x128(const std::shared_ptr<BigInteger>& value)
{
    m_Fee_growth_global_0x128 = value;
    m_Fee_growth_global_0x128IsSet = true;
}

bool PoolV3DTO::feeGrowthGlobal0x128IsSet() const
{
    return m_Fee_growth_global_0x128IsSet;
}

void PoolV3DTO::unsetFee_growth_global_0x128()
{
    m_Fee_growth_global_0x128IsSet = false;
}
std::shared_ptr<BigInteger> PoolV3DTO::getFeeGrowthGlobal1x128() const
{
    return m_Fee_growth_global_1x128;
}

void PoolV3DTO::setFeeGrowthGlobal1x128(const std::shared_ptr<BigInteger>& value)
{
    m_Fee_growth_global_1x128 = value;
    m_Fee_growth_global_1x128IsSet = true;
}

bool PoolV3DTO::feeGrowthGlobal1x128IsSet() const
{
    return m_Fee_growth_global_1x128IsSet;
}

void PoolV3DTO::unsetFee_growth_global_1x128()
{
    m_Fee_growth_global_1x128IsSet = false;
}
utility::string_t PoolV3DTO::getToken0Price() const
{
    return m_Token_0_price;
}

void PoolV3DTO::setToken0Price(const utility::string_t& value)
{
    m_Token_0_price = value;
    m_Token_0_priceIsSet = true;
}

bool PoolV3DTO::token0PriceIsSet() const
{
    return m_Token_0_priceIsSet;
}

void PoolV3DTO::unsetToken_0_price()
{
    m_Token_0_priceIsSet = false;
}
utility::string_t PoolV3DTO::getToken1Price() const
{
    return m_Token_1_price;
}

void PoolV3DTO::setToken1Price(const utility::string_t& value)
{
    m_Token_1_price = value;
    m_Token_1_priceIsSet = true;
}

bool PoolV3DTO::token1PriceIsSet() const
{
    return m_Token_1_priceIsSet;
}

void PoolV3DTO::unsetToken_1_price()
{
    m_Token_1_priceIsSet = false;
}
std::shared_ptr<BigInteger> PoolV3DTO::getTick() const
{
    return m_Tick;
}

void PoolV3DTO::setTick(const std::shared_ptr<BigInteger>& value)
{
    m_Tick = value;
    m_TickIsSet = true;
}

bool PoolV3DTO::tickIsSet() const
{
    return m_TickIsSet;
}

void PoolV3DTO::unsetTick()
{
    m_TickIsSet = false;
}
std::shared_ptr<BigInteger> PoolV3DTO::getObservationIndex() const
{
    return m_Observation_index;
}

void PoolV3DTO::setObservationIndex(const std::shared_ptr<BigInteger>& value)
{
    m_Observation_index = value;
    m_Observation_indexIsSet = true;
}

bool PoolV3DTO::observationIndexIsSet() const
{
    return m_Observation_indexIsSet;
}

void PoolV3DTO::unsetObservation_index()
{
    m_Observation_indexIsSet = false;
}
utility::string_t PoolV3DTO::getVolumeToken0() const
{
    return m_Volume_token_0;
}

void PoolV3DTO::setVolumeToken0(const utility::string_t& value)
{
    m_Volume_token_0 = value;
    m_Volume_token_0IsSet = true;
}

bool PoolV3DTO::volumeToken0IsSet() const
{
    return m_Volume_token_0IsSet;
}

void PoolV3DTO::unsetVolume_token_0()
{
    m_Volume_token_0IsSet = false;
}
utility::string_t PoolV3DTO::getVolumeToken1() const
{
    return m_Volume_token_1;
}

void PoolV3DTO::setVolumeToken1(const utility::string_t& value)
{
    m_Volume_token_1 = value;
    m_Volume_token_1IsSet = true;
}

bool PoolV3DTO::volumeToken1IsSet() const
{
    return m_Volume_token_1IsSet;
}

void PoolV3DTO::unsetVolume_token_1()
{
    m_Volume_token_1IsSet = false;
}
utility::string_t PoolV3DTO::getVolumeUsd() const
{
    return m_Volume_usd;
}

void PoolV3DTO::setVolumeUsd(const utility::string_t& value)
{
    m_Volume_usd = value;
    m_Volume_usdIsSet = true;
}

bool PoolV3DTO::volumeUsdIsSet() const
{
    return m_Volume_usdIsSet;
}

void PoolV3DTO::unsetVolume_usd()
{
    m_Volume_usdIsSet = false;
}
utility::string_t PoolV3DTO::getUntrackedVolumeUsd() const
{
    return m_Untracked_volume_usd;
}

void PoolV3DTO::setUntrackedVolumeUsd(const utility::string_t& value)
{
    m_Untracked_volume_usd = value;
    m_Untracked_volume_usdIsSet = true;
}

bool PoolV3DTO::untrackedVolumeUsdIsSet() const
{
    return m_Untracked_volume_usdIsSet;
}

void PoolV3DTO::unsetUntracked_volume_usd()
{
    m_Untracked_volume_usdIsSet = false;
}
utility::string_t PoolV3DTO::getFeesUsd() const
{
    return m_Fees_usd;
}

void PoolV3DTO::setFeesUsd(const utility::string_t& value)
{
    m_Fees_usd = value;
    m_Fees_usdIsSet = true;
}

bool PoolV3DTO::feesUsdIsSet() const
{
    return m_Fees_usdIsSet;
}

void PoolV3DTO::unsetFees_usd()
{
    m_Fees_usdIsSet = false;
}
std::shared_ptr<BigInteger> PoolV3DTO::getTxCount() const
{
    return m_Tx_count;
}

void PoolV3DTO::setTxCount(const std::shared_ptr<BigInteger>& value)
{
    m_Tx_count = value;
    m_Tx_countIsSet = true;
}

bool PoolV3DTO::txCountIsSet() const
{
    return m_Tx_countIsSet;
}

void PoolV3DTO::unsetTx_count()
{
    m_Tx_countIsSet = false;
}
utility::string_t PoolV3DTO::getCollectedFeesToken0() const
{
    return m_Collected_fees_token_0;
}

void PoolV3DTO::setCollectedFeesToken0(const utility::string_t& value)
{
    m_Collected_fees_token_0 = value;
    m_Collected_fees_token_0IsSet = true;
}

bool PoolV3DTO::collectedFeesToken0IsSet() const
{
    return m_Collected_fees_token_0IsSet;
}

void PoolV3DTO::unsetCollected_fees_token_0()
{
    m_Collected_fees_token_0IsSet = false;
}
utility::string_t PoolV3DTO::getCollectedFeesToken1() const
{
    return m_Collected_fees_token_1;
}

void PoolV3DTO::setCollectedFeesToken1(const utility::string_t& value)
{
    m_Collected_fees_token_1 = value;
    m_Collected_fees_token_1IsSet = true;
}

bool PoolV3DTO::collectedFeesToken1IsSet() const
{
    return m_Collected_fees_token_1IsSet;
}

void PoolV3DTO::unsetCollected_fees_token_1()
{
    m_Collected_fees_token_1IsSet = false;
}
utility::string_t PoolV3DTO::getCollectedFeesUsd() const
{
    return m_Collected_fees_usd;
}

void PoolV3DTO::setCollectedFeesUsd(const utility::string_t& value)
{
    m_Collected_fees_usd = value;
    m_Collected_fees_usdIsSet = true;
}

bool PoolV3DTO::collectedFeesUsdIsSet() const
{
    return m_Collected_fees_usdIsSet;
}

void PoolV3DTO::unsetCollected_fees_usd()
{
    m_Collected_fees_usdIsSet = false;
}
utility::string_t PoolV3DTO::getTotalValueLockedToken0() const
{
    return m_Total_value_locked_token_0;
}

void PoolV3DTO::setTotalValueLockedToken0(const utility::string_t& value)
{
    m_Total_value_locked_token_0 = value;
    m_Total_value_locked_token_0IsSet = true;
}

bool PoolV3DTO::totalValueLockedToken0IsSet() const
{
    return m_Total_value_locked_token_0IsSet;
}

void PoolV3DTO::unsetTotal_value_locked_token_0()
{
    m_Total_value_locked_token_0IsSet = false;
}
utility::string_t PoolV3DTO::getTotalValueLockedToken1() const
{
    return m_Total_value_locked_token_1;
}

void PoolV3DTO::setTotalValueLockedToken1(const utility::string_t& value)
{
    m_Total_value_locked_token_1 = value;
    m_Total_value_locked_token_1IsSet = true;
}

bool PoolV3DTO::totalValueLockedToken1IsSet() const
{
    return m_Total_value_locked_token_1IsSet;
}

void PoolV3DTO::unsetTotal_value_locked_token_1()
{
    m_Total_value_locked_token_1IsSet = false;
}
utility::string_t PoolV3DTO::getTotalValueLockedEth() const
{
    return m_Total_value_locked_eth;
}

void PoolV3DTO::setTotalValueLockedEth(const utility::string_t& value)
{
    m_Total_value_locked_eth = value;
    m_Total_value_locked_ethIsSet = true;
}

bool PoolV3DTO::totalValueLockedEthIsSet() const
{
    return m_Total_value_locked_ethIsSet;
}

void PoolV3DTO::unsetTotal_value_locked_eth()
{
    m_Total_value_locked_ethIsSet = false;
}
utility::string_t PoolV3DTO::getTotalValueLockedUsd() const
{
    return m_Total_value_locked_usd;
}

void PoolV3DTO::setTotalValueLockedUsd(const utility::string_t& value)
{
    m_Total_value_locked_usd = value;
    m_Total_value_locked_usdIsSet = true;
}

bool PoolV3DTO::totalValueLockedUsdIsSet() const
{
    return m_Total_value_locked_usdIsSet;
}

void PoolV3DTO::unsetTotal_value_locked_usd()
{
    m_Total_value_locked_usdIsSet = false;
}
utility::string_t PoolV3DTO::getTotalValueLockedUsdUntracked() const
{
    return m_Total_value_locked_usd_untracked;
}

void PoolV3DTO::setTotalValueLockedUsdUntracked(const utility::string_t& value)
{
    m_Total_value_locked_usd_untracked = value;
    m_Total_value_locked_usd_untrackedIsSet = true;
}

bool PoolV3DTO::totalValueLockedUsdUntrackedIsSet() const
{
    return m_Total_value_locked_usd_untrackedIsSet;
}

void PoolV3DTO::unsetTotal_value_locked_usd_untracked()
{
    m_Total_value_locked_usd_untrackedIsSet = false;
}
utility::string_t PoolV3DTO::getLiquidityProviderCount() const
{
    return m_Liquidity_provider_count;
}

void PoolV3DTO::setLiquidityProviderCount(const utility::string_t& value)
{
    m_Liquidity_provider_count = value;
    m_Liquidity_provider_countIsSet = true;
}

bool PoolV3DTO::liquidityProviderCountIsSet() const
{
    return m_Liquidity_provider_countIsSet;
}

void PoolV3DTO::unsetLiquidity_provider_count()
{
    m_Liquidity_provider_countIsSet = false;
}
double PoolV3DTO::getEvaluatedAsk() const
{
    return m_Evaluated_ask;
}

void PoolV3DTO::setEvaluatedAsk(double value)
{
    m_Evaluated_ask = value;
    m_Evaluated_askIsSet = true;
}

bool PoolV3DTO::evaluatedAskIsSet() const
{
    return m_Evaluated_askIsSet;
}

void PoolV3DTO::unsetEvaluated_ask()
{
    m_Evaluated_askIsSet = false;
}
}
