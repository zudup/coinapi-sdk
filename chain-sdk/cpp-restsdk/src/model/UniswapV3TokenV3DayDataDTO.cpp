...
void UniswapV3TokenV3DayDataDTO::validate()
{
    // TODO: implement validation
}

web::json::value UniswapV3TokenV3DayDataDTO::toJson() const
{
...
bool UniswapV3TokenV3DayDataDTO::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void UniswapV3TokenV3DayDataDTO::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool UniswapV3TokenV3DayDataDTO::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
utility::datetime UniswapV3TokenV3DayDataDTO::getEntryTime() const
{
    return m_Entry_time;
}

void UniswapV3TokenV3DayDataDTO::setEntryTime(const utility::datetime& value)
{
    m_Entry_time = value;
    m_Entry_timeIsSet = true;
}

bool UniswapV3TokenV3DayDataDTO::entryTimeIsSet() const
{
    return m_Entry_timeIsSet;
}

void UniswapV3TokenV3DayDataDTO::unsetEntry_time()
{
    m_Entry_timeIsSet = false;
}
utility::datetime UniswapV3TokenV3DayDataDTO::getRecvTime() const
{
    return m_Recv_time;
}

void UniswapV3TokenV3DayDataDTO::setRecvTime(const utility::datetime& value)
{
    m_Recv_time = value;
    m_Recv_timeIsSet = true;
}

bool UniswapV3TokenV3DayDataDTO::recvTimeIsSet() const
{
    return m_Recv_timeIsSet;
}

void UniswapV3TokenV3DayDataDTO::unsetRecv_time()
{
    m_Recv_timeIsSet = false;
}
int64_t UniswapV3TokenV3DayDataDTO::getBlockNumber() const
{
    return m_Block_number;
}

void UniswapV3TokenV3DayDataDTO::setBlockNumber(int64_t value)
{
    m_Block_number = value;
    m_Block_numberIsSet = true;
}

bool UniswapV3TokenV3DayDataDTO::blockNumberIsSet() const
{
    return m_Block_numberIsSet;
}

void UniswapV3TokenV3DayDataDTO::unsetBlock_number()
{
    m_Block_numberIsSet = false;
}
int64_t UniswapV3TokenV3DayDataDTO::getVid() const
{
    return m_Vid;
}

void UniswapV3TokenV3DayDataDTO::setVid(int64_t value)
{
    m_Vid = value;
    m_VidIsSet = true;
}

bool UniswapV3TokenV3DayDataDTO::vidIsSet() const
{
    return m_VidIsSet;
}

void UniswapV3TokenV3DayDataDTO::unsetVid()
{
    m_VidIsSet = false;
}
utility::string_t UniswapV3TokenV3DayDataDTO::getId() const
{
    return m_Id;
}

void UniswapV3TokenV3DayDataDTO::setId(const utility::string_t& value)
{
    m_Id = value;
    m_IdIsSet = true;
}

bool UniswapV3TokenV3DayDataDTO::idIsSet() const
{
    return m_IdIsSet;
}

void UniswapV3TokenV3DayDataDTO::unsetId()
{
    m_IdIsSet = false;
}
int32_t UniswapV3TokenV3DayDataDTO::getDate() const
{
    return m_date;
}

void UniswapV3TokenV3DayDataDTO::setDate(int32_t value)
{
    m_date = value;
    m_dateIsSet = true;
}

bool UniswapV3TokenV3DayDataDTO::dateIsSet() const
{
    return m_dateIsSet;
}

void UniswapV3TokenV3DayDataDTO::unsetdate()
{
    m_dateIsSet = false;
}
utility::string_t UniswapV3TokenV3DayDataDTO::getToken() const
{
    return m_Token;
}

void UniswapV3TokenV3DayDataDTO::setToken(const utility::string_t& value)
{
    m_Token = value;
    m_TokenIsSet = true;
}

bool UniswapV3TokenV3DayDataDTO::tokenIsSet() const
{
    return m_TokenIsSet;
}

void UniswapV3TokenV3DayDataDTO::unsetToken()
{
    m_TokenIsSet = false;
}
utility::string_t UniswapV3TokenV3DayDataDTO::getVolume() const
{
    return m_Volume;
}

void UniswapV3TokenV3DayDataDTO::setVolume(const utility::string_t& value)
{
    m_Volume = value;
    m_VolumeIsSet = true;
}

bool UniswapV3TokenV3DayDataDTO::volumeIsSet() const
{
    return m_VolumeIsSet;
}

void UniswapV3TokenV3DayDataDTO::unsetVolume()
{
    m_VolumeIsSet = false;
}
utility::string_t UniswapV3TokenV3DayDataDTO::getVolumeUsd() const
{
    return m_Volume_usd;
}

void UniswapV3TokenV3DayDataDTO::setVolumeUsd(const utility::string_t& value)
{
    m_Volume_usd = value;
    m_Volume_usdIsSet = true;
}

bool UniswapV3TokenV3DayDataDTO::volumeUsdIsSet() const
{
    return m_Volume_usdIsSet;
}

void UniswapV3TokenV3DayDataDTO::unsetVolume_usd()
{
    m_Volume_usdIsSet = false;
}
utility::string_t UniswapV3TokenV3DayDataDTO::getUntrackedVolumeUsd() const
{
    return m_Untracked_volume_usd;
}

void UniswapV3TokenV3DayDataDTO::setUntrackedVolumeUsd(const utility::string_t& value)
{
    m_Untracked_volume_usd = value;
    m_Untracked_volume_usdIsSet = true;
}

bool UniswapV3TokenV3DayDataDTO::untrackedVolumeUsdIsSet() const
{
    return m_Untracked_volume_usdIsSet;
}

void UniswapV3TokenV3DayDataDTO::unsetUntracked_volume_usd()
{
    m_Untracked_volume_usdIsSet = false;
}
utility::string_t UniswapV3TokenV3DayDataDTO::getTotalValueLocked() const
{
    return m_Total_value_locked;
}

void UniswapV3TokenV3DayDataDTO::setTotalValueLocked(const utility::string_t& value)
{
    m_Total_value_locked = value;
    m_Total_value_lockedIsSet = true;
}

bool UniswapV3TokenV3DayDataDTO::totalValueLockedIsSet() const
{
    return m_Total_value_lockedIsSet;
}

void UniswapV3TokenV3DayDataDTO::unsetTotal_value_locked()
{
    m_Total_value_lockedIsSet = false;
}
utility::string_t UniswapV3TokenV3DayDataDTO::getTotalValueLockedUsd() const
{
    return m_Total_value_locked_usd;
}

void UniswapV3TokenV3DayDataDTO::setTotalValueLockedUsd(const utility::string_t& value)
{
    m_Total_value_locked_usd = value;
    m_Total_value_locked_usdIsSet = true;
}

bool UniswapV3TokenV3DayDataDTO::totalValueLockedUsdIsSet() const
{
    return m_Total_value_locked_usdIsSet;
}

void UniswapV3TokenV3DayDataDTO::unsetTotal_value_locked_usd()
{
    m_Total_value_locked_usdIsSet = false;
}
utility::string_t UniswapV3TokenV3DayDataDTO::getPriceUsd() const
{
    return m_Price_usd;
}

void UniswapV3TokenV3DayDataDTO::setPriceUsd(const utility::string_t& value)
{
    m_Price_usd = value;
    m_Price_usdIsSet = true;
}

bool UniswapV3TokenV3DayDataDTO::priceUsdIsSet() const
{
    return m_Price_usdIsSet;
}

void UniswapV3TokenV3DayDataDTO::unsetPrice_usd()
{
    m_Price_usdIsSet = false;
}
utility::string_t UniswapV3TokenV3DayDataDTO::getFeesUsd() const
{
    return m_Fees_usd;
}

void UniswapV3TokenV3DayDataDTO::setFeesUsd(const utility::string_t& value)
{
    m_Fees_usd = value;
    m_Fees_usdIsSet = true;
}

bool UniswapV3TokenV3DayDataDTO::feesUsdIsSet() const
{
    return m_Fees_usdIsSet;
}

void UniswapV3TokenV3DayDataDTO::unsetFees_usd()
{
    m_Fees_usdIsSet = false;
}
utility::string_t UniswapV3TokenV3DayDataDTO::getOpen() const
{
    return m_Open;
}

void UniswapV3TokenV3DayDataDTO::setOpen(const utility::string_t& value)
{
    m_Open = value;
    m_OpenIsSet = true;
}

bool UniswapV3TokenV3DayDataDTO::openIsSet() const
{
    return m_OpenIsSet;
}

void UniswapV3TokenV3DayDataDTO::unsetOpen()
{
    m_OpenIsSet = false;
}
utility::string_t UniswapV3TokenV3DayDataDTO::getHigh() const
{
    return m_High;
}

void UniswapV3TokenV3DayDataDTO::setHigh(const utility::string_t& value)
{
    m_High = value;
    m_HighIsSet = true;
}

bool UniswapV3TokenV3DayDataDTO::highIsSet() const
{
    return m_HighIsSet;
}

void UniswapV3TokenV3DayDataDTO::unsetHigh()
{
    m_HighIsSet = false;
}
utility::string_t UniswapV3TokenV3DayDataDTO::getLow() const
{
    return m_Low;
}

void UniswapV3TokenV3DayDataDTO::setLow(const utility::string_t& value)
{
    m_Low = value;
    m_LowIsSet = true;
}

bool UniswapV3TokenV3DayDataDTO::lowIsSet() const
{
    return m_LowIsSet;
}

void UniswapV3TokenV3DayDataDTO::unsetLow()
{
    m_LowIsSet = false;
}
utility::string_t UniswapV3TokenV3DayDataDTO::getClose() const
{
    return m_Close;
}

void UniswapV3TokenV3DayDataDTO::setClose(const utility::string_t& value)
{
    m_Close = value;
    m_CloseIsSet = true;
}

bool UniswapV3TokenV3DayDataDTO::closeIsSet() const
{
    return m_CloseIsSet;
}

void UniswapV3TokenV3DayDataDTO::unsetClose()
{
    m_CloseIsSet = false;
}
}
