...
UniswapV3_UniswapDayDataV3DTO::UniswapV3_UniswapDayDataV3DTO()
{
...
void UniswapV3_UniswapDayDataV3DTO::validate()
{
    // TODO: implement validation
}

web::json::value UniswapV3_UniswapDayDataV3DTO::toJson() const
{
...
bool UniswapV3_UniswapDayDataV3DTO::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void UniswapV3_UniswapDayDataV3DTO::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool UniswapV3_UniswapDayDataV3DTO::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
utility::datetime UniswapV3_UniswapDayDataV3DTO::getEntryTime() const
{
    return m_Entry_time;
}

void UniswapV3_UniswapDayDataV3DTO::setEntryTime(const utility::datetime& value)
{
    m_Entry_time = value;
    m_Entry_timeIsSet = true;
}

bool UniswapV3_UniswapDayDataV3DTO::entryTimeIsSet() const
{
    return m_Entry_timeIsSet;
}

void UniswapV3_UniswapDayDataV3DTO::unsetEntry_time()
{
    m_Entry_timeIsSet = false;
}
utility::datetime UniswapV3_UniswapDayDataV3DTO::getRecvTime() const
{
    return m_Recv_time;
}

void UniswapV3_UniswapDayDataV3DTO::setRecvTime(const utility::datetime& value)
{
    m_Recv_time = value;
    m_Recv_timeIsSet = true;
}

bool UniswapV3_UniswapDayDataV3DTO::recvTimeIsSet() const
{
    return m_Recv_timeIsSet;
}

void UniswapV3_UniswapDayDataV3DTO::unsetRecv_time()
{
    m_Recv_timeIsSet = false;
}
int64_t UniswapV3_UniswapDayDataV3DTO::getBlockNumber() const
{
    return m_Block_number;
}

void UniswapV3_UniswapDayDataV3DTO::setBlockNumber(int64_t value)
{
    m_Block_number = value;
    m_Block_numberIsSet = true;
}

bool UniswapV3_UniswapDayDataV3DTO::blockNumberIsSet() const
{
    return m_Block_numberIsSet;
}

void UniswapV3_UniswapDayDataV3DTO::unsetBlock_number()
{
    m_Block_numberIsSet = false;
}
int64_t UniswapV3_UniswapDayDataV3DTO::getVid() const
{
    return m_Vid;
}

void UniswapV3_UniswapDayDataV3DTO::setVid(int64_t value)
{
    m_Vid = value;
    m_VidIsSet = true;
}

bool UniswapV3_UniswapDayDataV3DTO::vidIsSet() const
{
    return m_VidIsSet;
}

void UniswapV3_UniswapDayDataV3DTO::unsetVid()
{
    m_VidIsSet = false;
}
utility::string_t UniswapV3_UniswapDayDataV3DTO::getId() const
{
    return m_Id;
}

void UniswapV3_UniswapDayDataV3DTO::setId(const utility::string_t& value)
{
    m_Id = value;
    m_IdIsSet = true;
}

bool UniswapV3_UniswapDayDataV3DTO::idIsSet() const
{
    return m_IdIsSet;
}

void UniswapV3_UniswapDayDataV3DTO::unsetId()
{
    m_IdIsSet = false;
}
int32_t UniswapV3_UniswapDayDataV3DTO::getDate() const
{
    return m_date;
}

void UniswapV3_UniswapDayDataV3DTO::setDate(int32_t value)
{
    m_date = value;
    m_dateIsSet = true;
}

bool UniswapV3_UniswapDayDataV3DTO::dateIsSet() const
{
    return m_dateIsSet;
}

void UniswapV3_UniswapDayDataV3DTO::unsetdate()
{
    m_dateIsSet = false;
}
utility::string_t UniswapV3_UniswapDayDataV3DTO::getVolumeEth() const
{
    return m_Volume_eth;
}

void UniswapV3_UniswapDayDataV3DTO::setVolumeEth(const utility::string_t& value)
{
    m_Volume_eth = value;
    m_Volume_ethIsSet = true;
}

bool UniswapV3_UniswapDayDataV3DTO::volumeEthIsSet() const
{
    return m_Volume_ethIsSet;
}

void UniswapV3_UniswapDayDataV3DTO::unsetVolume_eth()
{
    m_Volume_ethIsSet = false;
}
utility::string_t UniswapV3_UniswapDayDataV3DTO::getVolumeUsd() const
{
    return m_Volume_usd;
}

void UniswapV3_UniswapDayDataV3DTO::setVolumeUsd(const utility::string_t& value)
{
    m_Volume_usd = value;
    m_Volume_usdIsSet = true;
}

bool UniswapV3_UniswapDayDataV3DTO::volumeUsdIsSet() const
{
    return m_Volume_usdIsSet;
}

void UniswapV3_UniswapDayDataV3DTO::unsetVolume_usd()
{
    m_Volume_usdIsSet = false;
}
utility::string_t UniswapV3_UniswapDayDataV3DTO::getVolumeUsdUntracked() const
{
    return m_Volume_usd_untracked;
}

void UniswapV3_UniswapDayDataV3DTO::setVolumeUsdUntracked(const utility::string_t& value)
{
    m_Volume_usd_untracked = value;
    m_Volume_usd_untrackedIsSet = true;
}

bool UniswapV3_UniswapDayDataV3DTO::volumeUsdUntrackedIsSet() const
{
    return m_Volume_usd_untrackedIsSet;
}

void UniswapV3_UniswapDayDataV3DTO::unsetVolume_usd_untracked()
{
    m_Volume_usd_untrackedIsSet = false;
}
utility::string_t UniswapV3_UniswapDayDataV3DTO::getFeesUsd() const
{
    return m_Fees_usd;
}

void UniswapV3_UniswapDayDataV3DTO::setFeesUsd(const utility::string_t& value)
{
    m_Fees_usd = value;
    m_Fees_usdIsSet = true;
}

bool UniswapV3_UniswapDayDataV3DTO::feesUsdIsSet() const
{
    return m_Fees_usdIsSet;
}

void UniswapV3_UniswapDayDataV3DTO::unsetFees_usd()
{
    m_Fees_usdIsSet = false;
}
std::shared_ptr<Numerics_BigInteger> UniswapV3_UniswapDayDataV3DTO::getTxCount() const
{
    return m_Tx_count;
}

void UniswapV3_UniswapDayDataV3DTO::setTxCount(const std::shared_ptr<Numerics_BigInteger>& value)
{
    m_Tx_count = value;
    m_Tx_countIsSet = true;
}

bool UniswapV3_UniswapDayDataV3DTO::txCountIsSet() const
{
    return m_Tx_countIsSet;
}

void UniswapV3_UniswapDayDataV3DTO::unsetTx_count()
{
    m_Tx_countIsSet = false;
}
utility::string_t UniswapV3_UniswapDayDataV3DTO::getTvlUsd() const
{
    return m_Tvl_usd;
}

void UniswapV3_UniswapDayDataV3DTO::setTvlUsd(const utility::string_t& value)
{
    m_Tvl_usd = value;
    m_Tvl_usdIsSet = true;
}

bool UniswapV3_UniswapDayDataV3DTO::tvlUsdIsSet() const
{
    return m_Tvl_usdIsSet;
}

void UniswapV3_UniswapDayDataV3DTO::unsetTvl_usd()
{
    m_Tvl_usdIsSet = false;
}
}
