...
void UniswapV3FactoryV3DTO::validate()
{
    // TODO: implement validation
}

web::json::value UniswapV3FactoryV3DTO::toJson() const
{
...
bool UniswapV3FactoryV3DTO::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void UniswapV3FactoryV3DTO::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool UniswapV3FactoryV3DTO::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
utility::datetime UniswapV3FactoryV3DTO::getEntryTime() const
{
    return m_Entry_time;
}

void UniswapV3FactoryV3DTO::setEntryTime(const utility::datetime& value)
{
    m_Entry_time = value;
    m_Entry_timeIsSet = true;
}

bool UniswapV3FactoryV3DTO::entryTimeIsSet() const
{
    return m_Entry_timeIsSet;
}

void UniswapV3FactoryV3DTO::unsetEntry_time()
{
    m_Entry_timeIsSet = false;
}
utility::datetime UniswapV3FactoryV3DTO::getRecvTime() const
{
    return m_Recv_time;
}

void UniswapV3FactoryV3DTO::setRecvTime(const utility::datetime& value)
{
    m_Recv_time = value;
    m_Recv_timeIsSet = true;
}

bool UniswapV3FactoryV3DTO::recvTimeIsSet() const
{
    return m_Recv_timeIsSet;
}

void UniswapV3FactoryV3DTO::unsetRecv_time()
{
    m_Recv_timeIsSet = false;
}
int64_t UniswapV3FactoryV3DTO::getBlockNumber() const
{
    return m_Block_number;
}

void UniswapV3FactoryV3DTO::setBlockNumber(int64_t value)
{
    m_Block_number = value;
    m_Block_numberIsSet = true;
}

bool UniswapV3FactoryV3DTO::blockNumberIsSet() const
{
    return m_Block_numberIsSet;
}

void UniswapV3FactoryV3DTO::unsetBlock_number()
{
    m_Block_numberIsSet = false;
}
utility::string_t UniswapV3FactoryV3DTO::getId() const
{
    return m_Id;
}

void UniswapV3FactoryV3DTO::setId(const utility::string_t& value)
{
    m_Id = value;
    m_IdIsSet = true;
}

bool UniswapV3FactoryV3DTO::idIsSet() const
{
    return m_IdIsSet;
}

void UniswapV3FactoryV3DTO::unsetId()
{
    m_IdIsSet = false;
}
utility::string_t UniswapV3FactoryV3DTO::getPoolCount() const
{
    return m_Pool_count;
}

void UniswapV3FactoryV3DTO::setPoolCount(const utility::string_t& value)
{
    m_Pool_count = value;
    m_Pool_countIsSet = true;
}

bool UniswapV3FactoryV3DTO::poolCountIsSet() const
{
    return m_Pool_countIsSet;
}

void UniswapV3FactoryV3DTO::unsetPool_count()
{
    m_Pool_countIsSet = false;
}
utility::string_t UniswapV3FactoryV3DTO::getTxCount() const
{
    return m_Tx_count;
}

void UniswapV3FactoryV3DTO::setTxCount(const utility::string_t& value)
{
    m_Tx_count = value;
    m_Tx_countIsSet = true;
}

bool UniswapV3FactoryV3DTO::txCountIsSet() const
{
    return m_Tx_countIsSet;
}

void UniswapV3FactoryV3DTO::unsetTx_count()
{
    m_Tx_countIsSet = false;
}
utility::string_t UniswapV3FactoryV3DTO::getTotalVolumeUsd() const
{
    return m_Total_volume_usd;
}

void UniswapV3FactoryV3DTO::setTotalVolumeUsd(const utility::string_t& value)
{
    m_Total_volume_usd = value;
    m_Total_volume_usdIsSet = true;
}

bool UniswapV3FactoryV3DTO::totalVolumeUsdIsSet() const
{
    return m_Total_volume_usdIsSet;
}

void UniswapV3FactoryV3DTO::unsetTotal_volume_usd()
{
    m_Total_volume_usdIsSet = false;
}
utility::string_t UniswapV3FactoryV3DTO::getTotalVolumeEth() const
{
    return m_Total_volume_eth;
}

void UniswapV3FactoryV3DTO::setTotalVolumeEth(const utility::string_t& value)
{
    m_Total_volume_eth = value;
    m_Total_volume_ethIsSet = true;
}

bool UniswapV3FactoryV3DTO::totalVolumeEthIsSet() const
{
    return m_Total_volume_ethIsSet;
}

void UniswapV3FactoryV3DTO::unsetTotal_volume_eth()
{
    m_Total_volume_ethIsSet = false;
}
utility::string_t UniswapV3FactoryV3DTO::getTotalFeesUsd() const
{
    return m_Total_fees_usd;
}

void UniswapV3FactoryV3DTO::setTotalFeesUsd(const utility::string_t& value)
{
    m_Total_fees_usd = value;
    m_Total_fees_usdIsSet = true;
}

bool UniswapV3FactoryV3DTO::totalFeesUsdIsSet() const
{
    return m_Total_fees_usdIsSet;
}

void UniswapV3FactoryV3DTO::unsetTotal_fees_usd()
{
    m_Total_fees_usdIsSet = false;
}
utility::string_t UniswapV3FactoryV3DTO::getTotalFeesEth() const
{
    return m_Total_fees_eth;
}

void UniswapV3FactoryV3DTO::setTotalFeesEth(const utility::string_t& value)
{
    m_Total_fees_eth = value;
    m_Total_fees_ethIsSet = true;
}

bool UniswapV3FactoryV3DTO::totalFeesEthIsSet() const
{
    return m_Total_fees_ethIsSet;
}

void UniswapV3FactoryV3DTO::unsetTotal_fees_eth()
{
    m_Total_fees_ethIsSet = false;
}
utility::string_t UniswapV3FactoryV3DTO::getUntrackedVolumeUsd() const
{
    return m_Untracked_volume_usd;
}

void UniswapV3FactoryV3DTO::setUntrackedVolumeUsd(const utility::string_t& value)
{
    m_Untracked_volume_usd = value;
    m_Untracked_volume_usdIsSet = true;
}

bool UniswapV3FactoryV3DTO::untrackedVolumeUsdIsSet() const
{
    return m_Untracked_volume_usdIsSet;
}

void UniswapV3FactoryV3DTO::unsetUntracked_volume_usd()
{
    m_Untracked_volume_usdIsSet = false;
}
utility::string_t UniswapV3FactoryV3DTO::getTotalValueLockedUsd() const
{
    return m_Total_value_locked_usd;
}

void UniswapV3FactoryV3DTO::setTotalValueLockedUsd(const utility::string_t& value)
{
    m_Total_value_locked_usd = value;
    m_Total_value_locked_usdIsSet = true;
}

bool UniswapV3FactoryV3DTO::totalValueLockedUsdIsSet() const
{
    return m_Total_value_locked_usdIsSet;
}

void UniswapV3FactoryV3DTO::unsetTotal_value_locked_usd()
{
    m_Total_value_locked_usdIsSet = false;
}
utility::string_t UniswapV3FactoryV3DTO::getTotalValueLockedEth() const
{
    return m_Total_value_locked_eth;
}

void UniswapV3FactoryV3DTO::setTotalValueLockedEth(const utility::string_t& value)
{
    m_Total_value_locked_eth = value;
    m_Total_value_locked_ethIsSet = true;
}

bool UniswapV3FactoryV3DTO::totalValueLockedEthIsSet() const
{
    return m_Total_value_locked_ethIsSet;
}

void UniswapV3FactoryV3DTO::unsetTotal_value_locked_eth()
{
    m_Total_value_locked_ethIsSet = false;
}
utility::string_t UniswapV3FactoryV3DTO::getTotalValueLockedUsdUntracked() const
{
    return m_Total_value_locked_usd_untracked;
}

void UniswapV3FactoryV3DTO::setTotalValueLockedUsdUntracked(const utility::string_t& value)
{
    m_Total_value_locked_usd_untracked = value;
    m_Total_value_locked_usd_untrackedIsSet = true;
}

bool UniswapV3FactoryV3DTO::totalValueLockedUsdUntrackedIsSet() const
{
    return m_Total_value_locked_usd_untrackedIsSet;
}

void UniswapV3FactoryV3DTO::unsetTotal_value_locked_usd_untracked()
{
    m_Total_value_locked_usd_untrackedIsSet = false;
}
utility::string_t UniswapV3FactoryV3DTO::getTotalValueLockedEthUntracked() const
{
    return m_Total_value_locked_eth_untracked;
}

void UniswapV3FactoryV3DTO::setTotalValueLockedEthUntracked(const utility::string_t& value)
{
    m_Total_value_locked_eth_untracked = value;
    m_Total_value_locked_eth_untrackedIsSet = true;
}

bool UniswapV3FactoryV3DTO::totalValueLockedEthUntrackedIsSet() const
{
    return m_Total_value_locked_eth_untrackedIsSet;
}

void UniswapV3FactoryV3DTO::unsetTotal_value_locked_eth_untracked()
{
    m_Total_value_locked_eth_untrackedIsSet = false;
}
utility::string_t UniswapV3FactoryV3DTO::getOwner() const
{
    return m_Owner;
}

void UniswapV3FactoryV3DTO::setOwner(const utility::string_t& value)
{
    m_Owner = value;
    m_OwnerIsSet = true;
}

bool UniswapV3FactoryV3DTO::ownerIsSet() const
{
    return m_OwnerIsSet;
}

void UniswapV3FactoryV3DTO::unsetOwner()
{
    m_OwnerIsSet = false;
}
int64_t UniswapV3FactoryV3DTO::getVid() const
{
    return m_Vid;
}

void UniswapV3FactoryV3DTO::setVid(int64_t value)
{
    m_Vid = value;
    m_VidIsSet = true;
}

bool UniswapV3FactoryV3DTO::vidIsSet() const
{
    return m_VidIsSet;
}

void UniswapV3FactoryV3DTO::unsetVid()
{
    m_VidIsSet = false;
}
}
