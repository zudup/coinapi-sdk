...
void TickDayDataV3DTO::validate()
{
    // TODO: implement validation
}

web::json::value TickDayDataV3DTO::toJson() const
{
...
bool TickDayDataV3DTO::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void TickDayDataV3DTO::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool TickDayDataV3DTO::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
utility::datetime TickDayDataV3DTO::getEntryTime() const
{
    return m_Entry_time;
}

void TickDayDataV3DTO::setEntryTime(const utility::datetime& value)
{
    m_Entry_time = value;
    m_Entry_timeIsSet = true;
}

bool TickDayDataV3DTO::entryTimeIsSet() const
{
    return m_Entry_timeIsSet;
}

void TickDayDataV3DTO::unsetEntry_time()
{
    m_Entry_timeIsSet = false;
}
utility::datetime TickDayDataV3DTO::getRecvTime() const
{
    return m_Recv_time;
}

void TickDayDataV3DTO::setRecvTime(const utility::datetime& value)
{
    m_Recv_time = value;
    m_Recv_timeIsSet = true;
}

bool TickDayDataV3DTO::recvTimeIsSet() const
{
    return m_Recv_timeIsSet;
}

void TickDayDataV3DTO::unsetRecv_time()
{
    m_Recv_timeIsSet = false;
}
int64_t TickDayDataV3DTO::getBlockNumber() const
{
    return m_Block_number;
}

void TickDayDataV3DTO::setBlockNumber(int64_t value)
{
    m_Block_number = value;
    m_Block_numberIsSet = true;
}

bool TickDayDataV3DTO::blockNumberIsSet() const
{
    return m_Block_numberIsSet;
}

void TickDayDataV3DTO::unsetBlock_number()
{
    m_Block_numberIsSet = false;
}
utility::string_t TickDayDataV3DTO::getId() const
{
    return m_Id;
}

void TickDayDataV3DTO::setId(const utility::string_t& value)
{
    m_Id = value;
    m_IdIsSet = true;
}

bool TickDayDataV3DTO::idIsSet() const
{
    return m_IdIsSet;
}

void TickDayDataV3DTO::unsetId()
{
    m_IdIsSet = false;
}
int32_t TickDayDataV3DTO::getDate() const
{
    return m_date;
}

void TickDayDataV3DTO::setDate(int32_t value)
{
    m_date = value;
    m_dateIsSet = true;
}

bool TickDayDataV3DTO::dateIsSet() const
{
    return m_dateIsSet;
}

void TickDayDataV3DTO::unsetdate()
{
    m_dateIsSet = false;
}
utility::string_t TickDayDataV3DTO::getPool() const
{
    return m_Pool;
}

void TickDayDataV3DTO::setPool(const utility::string_t& value)
{
    m_Pool = value;
    m_PoolIsSet = true;
}

bool TickDayDataV3DTO::poolIsSet() const
{
    return m_PoolIsSet;
}

void TickDayDataV3DTO::unsetPool()
{
    m_PoolIsSet = false;
}
utility::string_t TickDayDataV3DTO::getTick() const
{
    return m_Tick;
}

void TickDayDataV3DTO::setTick(const utility::string_t& value)
{
    m_Tick = value;
    m_TickIsSet = true;
}

bool TickDayDataV3DTO::tickIsSet() const
{
    return m_TickIsSet;
}

void TickDayDataV3DTO::unsetTick()
{
    m_TickIsSet = false;
}
utility::string_t TickDayDataV3DTO::getLiquidityGross() const
{
    return m_Liquidity_gross;
}

void TickDayDataV3DTO::setLiquidityGross(const utility::string_t& value)
{
    m_Liquidity_gross = value;
    m_Liquidity_grossIsSet = true;
}

bool TickDayDataV3DTO::liquidityGrossIsSet() const
{
    return m_Liquidity_grossIsSet;
}

void TickDayDataV3DTO::unsetLiquidity_gross()
{
    m_Liquidity_grossIsSet = false;
}
utility::string_t TickDayDataV3DTO::getLiquidityNet() const
{
    return m_Liquidity_net;
}

void TickDayDataV3DTO::setLiquidityNet(const utility::string_t& value)
{
    m_Liquidity_net = value;
    m_Liquidity_netIsSet = true;
}

bool TickDayDataV3DTO::liquidityNetIsSet() const
{
    return m_Liquidity_netIsSet;
}

void TickDayDataV3DTO::unsetLiquidity_net()
{
    m_Liquidity_netIsSet = false;
}
utility::string_t TickDayDataV3DTO::getVolumeToken0() const
{
    return m_Volume_token_0;
}

void TickDayDataV3DTO::setVolumeToken0(const utility::string_t& value)
{
    m_Volume_token_0 = value;
    m_Volume_token_0IsSet = true;
}

bool TickDayDataV3DTO::volumeToken0IsSet() const
{
    return m_Volume_token_0IsSet;
}

void TickDayDataV3DTO::unsetVolume_token_0()
{
    m_Volume_token_0IsSet = false;
}
utility::string_t TickDayDataV3DTO::getVolumeToken1() const
{
    return m_Volume_token_1;
}

void TickDayDataV3DTO::setVolumeToken1(const utility::string_t& value)
{
    m_Volume_token_1 = value;
    m_Volume_token_1IsSet = true;
}

bool TickDayDataV3DTO::volumeToken1IsSet() const
{
    return m_Volume_token_1IsSet;
}

void TickDayDataV3DTO::unsetVolume_token_1()
{
    m_Volume_token_1IsSet = false;
}
utility::string_t TickDayDataV3DTO::getVolumeUsd() const
{
    return m_Volume_usd;
}

void TickDayDataV3DTO::setVolumeUsd(const utility::string_t& value)
{
    m_Volume_usd = value;
    m_Volume_usdIsSet = true;
}

bool TickDayDataV3DTO::volumeUsdIsSet() const
{
    return m_Volume_usdIsSet;
}

void TickDayDataV3DTO::unsetVolume_usd()
{
    m_Volume_usdIsSet = false;
}
utility::string_t TickDayDataV3DTO::getFeesUsd() const
{
    return m_Fees_usd;
}

void TickDayDataV3DTO::setFeesUsd(const utility::string_t& value)
{
    m_Fees_usd = value;
    m_Fees_usdIsSet = true;
}

bool TickDayDataV3DTO::feesUsdIsSet() const
{
    return m_Fees_usdIsSet;
}

void TickDayDataV3DTO::unsetFees_usd()
{
    m_Fees_usdIsSet = false;
}
utility::string_t TickDayDataV3DTO::getFeeGrowthOutside0x128() const
{
    return m_Fee_growth_outside_0x128;
}

void TickDayDataV3DTO::setFeeGrowthOutside0x128(const utility::string_t& value)
{
    m_Fee_growth_outside_0x128 = value;
    m_Fee_growth_outside_0x128IsSet = true;
}

bool TickDayDataV3DTO::feeGrowthOutside0x128IsSet() const
{
    return m_Fee_growth_outside_0x128IsSet;
}

void TickDayDataV3DTO::unsetFee_growth_outside_0x128()
{
    m_Fee_growth_outside_0x128IsSet = false;
}
utility::string_t TickDayDataV3DTO::getFeeGrowthOutside1x128() const
{
    return m_Fee_growth_outside_1x128;
}

void TickDayDataV3DTO::setFeeGrowthOutside1x128(const utility::string_t& value)
{
    m_Fee_growth_outside_1x128 = value;
    m_Fee_growth_outside_1x128IsSet = true;
}

bool TickDayDataV3DTO::feeGrowthOutside1x128IsSet() const
{
    return m_Fee_growth_outside_1x128IsSet;
}

void TickDayDataV3DTO::unsetFee_growth_outside_1x128()
{
    m_Fee_growth_outside_1x128IsSet = false;
}
int64_t TickDayDataV3DTO::getVid() const
{
    return m_Vid;
}

void TickDayDataV3DTO::setVid(int64_t value)
{
    m_Vid = value;
    m_VidIsSet = true;
}

bool TickDayDataV3DTO::vidIsSet() const
{
    return m_VidIsSet;
}

void TickDayDataV3DTO::unsetVid()
{
    m_VidIsSet = false;
}
}
