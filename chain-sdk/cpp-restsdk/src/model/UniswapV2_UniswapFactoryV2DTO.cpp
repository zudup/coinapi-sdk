...
UniswapV2_UniswapFactoryV2DTO::UniswapV2_UniswapFactoryV2DTO()
{
...
void UniswapV2_UniswapFactoryV2DTO::validate()
{
    // TODO: implement validation
}

web::json::value UniswapV2_UniswapFactoryV2DTO::toJson() const
{
...
bool UniswapV2_UniswapFactoryV2DTO::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void UniswapV2_UniswapFactoryV2DTO::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool UniswapV2_UniswapFactoryV2DTO::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
utility::datetime UniswapV2_UniswapFactoryV2DTO::getEntryTime() const
{
    return m_Entry_time;
}

void UniswapV2_UniswapFactoryV2DTO::setEntryTime(const utility::datetime& value)
{
    m_Entry_time = value;
    m_Entry_timeIsSet = true;
}

bool UniswapV2_UniswapFactoryV2DTO::entryTimeIsSet() const
{
    return m_Entry_timeIsSet;
}

void UniswapV2_UniswapFactoryV2DTO::unsetEntry_time()
{
    m_Entry_timeIsSet = false;
}
utility::datetime UniswapV2_UniswapFactoryV2DTO::getRecvTime() const
{
    return m_Recv_time;
}

void UniswapV2_UniswapFactoryV2DTO::setRecvTime(const utility::datetime& value)
{
    m_Recv_time = value;
    m_Recv_timeIsSet = true;
}

bool UniswapV2_UniswapFactoryV2DTO::recvTimeIsSet() const
{
    return m_Recv_timeIsSet;
}

void UniswapV2_UniswapFactoryV2DTO::unsetRecv_time()
{
    m_Recv_timeIsSet = false;
}
int64_t UniswapV2_UniswapFactoryV2DTO::getBlockNumber() const
{
    return m_Block_number;
}

void UniswapV2_UniswapFactoryV2DTO::setBlockNumber(int64_t value)
{
    m_Block_number = value;
    m_Block_numberIsSet = true;
}

bool UniswapV2_UniswapFactoryV2DTO::blockNumberIsSet() const
{
    return m_Block_numberIsSet;
}

void UniswapV2_UniswapFactoryV2DTO::unsetBlock_number()
{
    m_Block_numberIsSet = false;
}
utility::string_t UniswapV2_UniswapFactoryV2DTO::getId() const
{
    return m_Id;
}

void UniswapV2_UniswapFactoryV2DTO::setId(const utility::string_t& value)
{
    m_Id = value;
    m_IdIsSet = true;
}

bool UniswapV2_UniswapFactoryV2DTO::idIsSet() const
{
    return m_IdIsSet;
}

void UniswapV2_UniswapFactoryV2DTO::unsetId()
{
    m_IdIsSet = false;
}
int32_t UniswapV2_UniswapFactoryV2DTO::getPairCount() const
{
    return m_Pair_count;
}

void UniswapV2_UniswapFactoryV2DTO::setPairCount(int32_t value)
{
    m_Pair_count = value;
    m_Pair_countIsSet = true;
}

bool UniswapV2_UniswapFactoryV2DTO::pairCountIsSet() const
{
    return m_Pair_countIsSet;
}

void UniswapV2_UniswapFactoryV2DTO::unsetPair_count()
{
    m_Pair_countIsSet = false;
}
utility::string_t UniswapV2_UniswapFactoryV2DTO::getTotalVolumeUsd() const
{
    return m_Total_volume_usd;
}

void UniswapV2_UniswapFactoryV2DTO::setTotalVolumeUsd(const utility::string_t& value)
{
    m_Total_volume_usd = value;
    m_Total_volume_usdIsSet = true;
}

bool UniswapV2_UniswapFactoryV2DTO::totalVolumeUsdIsSet() const
{
    return m_Total_volume_usdIsSet;
}

void UniswapV2_UniswapFactoryV2DTO::unsetTotal_volume_usd()
{
    m_Total_volume_usdIsSet = false;
}
utility::string_t UniswapV2_UniswapFactoryV2DTO::getTotalVolumeEth() const
{
    return m_Total_volume_eth;
}

void UniswapV2_UniswapFactoryV2DTO::setTotalVolumeEth(const utility::string_t& value)
{
    m_Total_volume_eth = value;
    m_Total_volume_ethIsSet = true;
}

bool UniswapV2_UniswapFactoryV2DTO::totalVolumeEthIsSet() const
{
    return m_Total_volume_ethIsSet;
}

void UniswapV2_UniswapFactoryV2DTO::unsetTotal_volume_eth()
{
    m_Total_volume_ethIsSet = false;
}
utility::string_t UniswapV2_UniswapFactoryV2DTO::getUntrackedVolumeUsd() const
{
    return m_Untracked_volume_usd;
}

void UniswapV2_UniswapFactoryV2DTO::setUntrackedVolumeUsd(const utility::string_t& value)
{
    m_Untracked_volume_usd = value;
    m_Untracked_volume_usdIsSet = true;
}

bool UniswapV2_UniswapFactoryV2DTO::untrackedVolumeUsdIsSet() const
{
    return m_Untracked_volume_usdIsSet;
}

void UniswapV2_UniswapFactoryV2DTO::unsetUntracked_volume_usd()
{
    m_Untracked_volume_usdIsSet = false;
}
utility::string_t UniswapV2_UniswapFactoryV2DTO::getTotalLiquidityUsd() const
{
    return m_Total_liquidity_usd;
}

void UniswapV2_UniswapFactoryV2DTO::setTotalLiquidityUsd(const utility::string_t& value)
{
    m_Total_liquidity_usd = value;
    m_Total_liquidity_usdIsSet = true;
}

bool UniswapV2_UniswapFactoryV2DTO::totalLiquidityUsdIsSet() const
{
    return m_Total_liquidity_usdIsSet;
}

void UniswapV2_UniswapFactoryV2DTO::unsetTotal_liquidity_usd()
{
    m_Total_liquidity_usdIsSet = false;
}
utility::string_t UniswapV2_UniswapFactoryV2DTO::getTotalLiquidityEth() const
{
    return m_Total_liquidity_eth;
}

void UniswapV2_UniswapFactoryV2DTO::setTotalLiquidityEth(const utility::string_t& value)
{
    m_Total_liquidity_eth = value;
    m_Total_liquidity_ethIsSet = true;
}

bool UniswapV2_UniswapFactoryV2DTO::totalLiquidityEthIsSet() const
{
    return m_Total_liquidity_ethIsSet;
}

void UniswapV2_UniswapFactoryV2DTO::unsetTotal_liquidity_eth()
{
    m_Total_liquidity_ethIsSet = false;
}
utility::string_t UniswapV2_UniswapFactoryV2DTO::getTxCount() const
{
    return m_Tx_count;
}

void UniswapV2_UniswapFactoryV2DTO::setTxCount(const utility::string_t& value)
{
    m_Tx_count = value;
    m_Tx_countIsSet = true;
}

bool UniswapV2_UniswapFactoryV2DTO::txCountIsSet() const
{
    return m_Tx_countIsSet;
}

void UniswapV2_UniswapFactoryV2DTO::unsetTx_count()
{
    m_Tx_countIsSet = false;
}
int64_t UniswapV2_UniswapFactoryV2DTO::getVid() const
{
    return m_Vid;
}

void UniswapV2_UniswapFactoryV2DTO::setVid(int64_t value)
{
    m_Vid = value;
    m_VidIsSet = true;
}

bool UniswapV2_UniswapFactoryV2DTO::vidIsSet() const
{
    return m_VidIsSet;
}

void UniswapV2_UniswapFactoryV2DTO::unsetVid()
{
    m_VidIsSet = false;
}
}
