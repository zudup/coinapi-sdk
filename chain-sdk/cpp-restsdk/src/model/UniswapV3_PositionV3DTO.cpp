...
UniswapV3_PositionV3DTO::UniswapV3_PositionV3DTO()
{
...
void UniswapV3_PositionV3DTO::validate()
{
    // TODO: implement validation
}

web::json::value UniswapV3_PositionV3DTO::toJson() const
{
...
bool UniswapV3_PositionV3DTO::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void UniswapV3_PositionV3DTO::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool UniswapV3_PositionV3DTO::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
utility::datetime UniswapV3_PositionV3DTO::getEntryTime() const
{
    return m_Entry_time;
}

void UniswapV3_PositionV3DTO::setEntryTime(const utility::datetime& value)
{
    m_Entry_time = value;
    m_Entry_timeIsSet = true;
}

bool UniswapV3_PositionV3DTO::entryTimeIsSet() const
{
    return m_Entry_timeIsSet;
}

void UniswapV3_PositionV3DTO::unsetEntry_time()
{
    m_Entry_timeIsSet = false;
}
utility::datetime UniswapV3_PositionV3DTO::getRecvTime() const
{
    return m_Recv_time;
}

void UniswapV3_PositionV3DTO::setRecvTime(const utility::datetime& value)
{
    m_Recv_time = value;
    m_Recv_timeIsSet = true;
}

bool UniswapV3_PositionV3DTO::recvTimeIsSet() const
{
    return m_Recv_timeIsSet;
}

void UniswapV3_PositionV3DTO::unsetRecv_time()
{
    m_Recv_timeIsSet = false;
}
int64_t UniswapV3_PositionV3DTO::getBlockNumber() const
{
    return m_Block_number;
}

void UniswapV3_PositionV3DTO::setBlockNumber(int64_t value)
{
    m_Block_number = value;
    m_Block_numberIsSet = true;
}

bool UniswapV3_PositionV3DTO::blockNumberIsSet() const
{
    return m_Block_numberIsSet;
}

void UniswapV3_PositionV3DTO::unsetBlock_number()
{
    m_Block_numberIsSet = false;
}
utility::string_t UniswapV3_PositionV3DTO::getId() const
{
    return m_Id;
}

void UniswapV3_PositionV3DTO::setId(const utility::string_t& value)
{
    m_Id = value;
    m_IdIsSet = true;
}

bool UniswapV3_PositionV3DTO::idIsSet() const
{
    return m_IdIsSet;
}

void UniswapV3_PositionV3DTO::unsetId()
{
    m_IdIsSet = false;
}
utility::string_t UniswapV3_PositionV3DTO::getOwner() const
{
    return m_Owner;
}

void UniswapV3_PositionV3DTO::setOwner(const utility::string_t& value)
{
    m_Owner = value;
    m_OwnerIsSet = true;
}

bool UniswapV3_PositionV3DTO::ownerIsSet() const
{
    return m_OwnerIsSet;
}

void UniswapV3_PositionV3DTO::unsetOwner()
{
    m_OwnerIsSet = false;
}
utility::string_t UniswapV3_PositionV3DTO::getPool() const
{
    return m_Pool;
}

void UniswapV3_PositionV3DTO::setPool(const utility::string_t& value)
{
    m_Pool = value;
    m_PoolIsSet = true;
}

bool UniswapV3_PositionV3DTO::poolIsSet() const
{
    return m_PoolIsSet;
}

void UniswapV3_PositionV3DTO::unsetPool()
{
    m_PoolIsSet = false;
}
utility::string_t UniswapV3_PositionV3DTO::getToken0() const
{
    return m_Token_0;
}

void UniswapV3_PositionV3DTO::setToken0(const utility::string_t& value)
{
    m_Token_0 = value;
    m_Token_0IsSet = true;
}

bool UniswapV3_PositionV3DTO::token0IsSet() const
{
    return m_Token_0IsSet;
}

void UniswapV3_PositionV3DTO::unsetToken_0()
{
    m_Token_0IsSet = false;
}
utility::string_t UniswapV3_PositionV3DTO::getToken1() const
{
    return m_Token_1;
}

void UniswapV3_PositionV3DTO::setToken1(const utility::string_t& value)
{
    m_Token_1 = value;
    m_Token_1IsSet = true;
}

bool UniswapV3_PositionV3DTO::token1IsSet() const
{
    return m_Token_1IsSet;
}

void UniswapV3_PositionV3DTO::unsetToken_1()
{
    m_Token_1IsSet = false;
}
utility::string_t UniswapV3_PositionV3DTO::getTickLower() const
{
    return m_Tick_lower;
}

void UniswapV3_PositionV3DTO::setTickLower(const utility::string_t& value)
{
    m_Tick_lower = value;
    m_Tick_lowerIsSet = true;
}

bool UniswapV3_PositionV3DTO::tickLowerIsSet() const
{
    return m_Tick_lowerIsSet;
}

void UniswapV3_PositionV3DTO::unsetTick_lower()
{
    m_Tick_lowerIsSet = false;
}
utility::string_t UniswapV3_PositionV3DTO::getTickUpper() const
{
    return m_Tick_upper;
}

void UniswapV3_PositionV3DTO::setTickUpper(const utility::string_t& value)
{
    m_Tick_upper = value;
    m_Tick_upperIsSet = true;
}

bool UniswapV3_PositionV3DTO::tickUpperIsSet() const
{
    return m_Tick_upperIsSet;
}

void UniswapV3_PositionV3DTO::unsetTick_upper()
{
    m_Tick_upperIsSet = false;
}
utility::string_t UniswapV3_PositionV3DTO::getLiquidity() const
{
    return m_Liquidity;
}

void UniswapV3_PositionV3DTO::setLiquidity(const utility::string_t& value)
{
    m_Liquidity = value;
    m_LiquidityIsSet = true;
}

bool UniswapV3_PositionV3DTO::liquidityIsSet() const
{
    return m_LiquidityIsSet;
}

void UniswapV3_PositionV3DTO::unsetLiquidity()
{
    m_LiquidityIsSet = false;
}
utility::string_t UniswapV3_PositionV3DTO::getDepositedToken0() const
{
    return m_Deposited_token_0;
}

void UniswapV3_PositionV3DTO::setDepositedToken0(const utility::string_t& value)
{
    m_Deposited_token_0 = value;
    m_Deposited_token_0IsSet = true;
}

bool UniswapV3_PositionV3DTO::depositedToken0IsSet() const
{
    return m_Deposited_token_0IsSet;
}

void UniswapV3_PositionV3DTO::unsetDeposited_token_0()
{
    m_Deposited_token_0IsSet = false;
}
utility::string_t UniswapV3_PositionV3DTO::getDepositedToken1() const
{
    return m_Deposited_token_1;
}

void UniswapV3_PositionV3DTO::setDepositedToken1(const utility::string_t& value)
{
    m_Deposited_token_1 = value;
    m_Deposited_token_1IsSet = true;
}

bool UniswapV3_PositionV3DTO::depositedToken1IsSet() const
{
    return m_Deposited_token_1IsSet;
}

void UniswapV3_PositionV3DTO::unsetDeposited_token_1()
{
    m_Deposited_token_1IsSet = false;
}
utility::string_t UniswapV3_PositionV3DTO::getWithdrawnToken0() const
{
    return m_Withdrawn_token_0;
}

void UniswapV3_PositionV3DTO::setWithdrawnToken0(const utility::string_t& value)
{
    m_Withdrawn_token_0 = value;
    m_Withdrawn_token_0IsSet = true;
}

bool UniswapV3_PositionV3DTO::withdrawnToken0IsSet() const
{
    return m_Withdrawn_token_0IsSet;
}

void UniswapV3_PositionV3DTO::unsetWithdrawn_token_0()
{
    m_Withdrawn_token_0IsSet = false;
}
utility::string_t UniswapV3_PositionV3DTO::getWithdrawnToken1() const
{
    return m_Withdrawn_token_1;
}

void UniswapV3_PositionV3DTO::setWithdrawnToken1(const utility::string_t& value)
{
    m_Withdrawn_token_1 = value;
    m_Withdrawn_token_1IsSet = true;
}

bool UniswapV3_PositionV3DTO::withdrawnToken1IsSet() const
{
    return m_Withdrawn_token_1IsSet;
}

void UniswapV3_PositionV3DTO::unsetWithdrawn_token_1()
{
    m_Withdrawn_token_1IsSet = false;
}
utility::string_t UniswapV3_PositionV3DTO::getCollectedFeesToken0() const
{
    return m_Collected_fees_token_0;
}

void UniswapV3_PositionV3DTO::setCollectedFeesToken0(const utility::string_t& value)
{
    m_Collected_fees_token_0 = value;
    m_Collected_fees_token_0IsSet = true;
}

bool UniswapV3_PositionV3DTO::collectedFeesToken0IsSet() const
{
    return m_Collected_fees_token_0IsSet;
}

void UniswapV3_PositionV3DTO::unsetCollected_fees_token_0()
{
    m_Collected_fees_token_0IsSet = false;
}
utility::string_t UniswapV3_PositionV3DTO::getCollectedFeesToken1() const
{
    return m_Collected_fees_token_1;
}

void UniswapV3_PositionV3DTO::setCollectedFeesToken1(const utility::string_t& value)
{
    m_Collected_fees_token_1 = value;
    m_Collected_fees_token_1IsSet = true;
}

bool UniswapV3_PositionV3DTO::collectedFeesToken1IsSet() const
{
    return m_Collected_fees_token_1IsSet;
}

void UniswapV3_PositionV3DTO::unsetCollected_fees_token_1()
{
    m_Collected_fees_token_1IsSet = false;
}
utility::string_t UniswapV3_PositionV3DTO::getTransaction() const
{
    return m_Transaction;
}

void UniswapV3_PositionV3DTO::setTransaction(const utility::string_t& value)
{
    m_Transaction = value;
    m_TransactionIsSet = true;
}

bool UniswapV3_PositionV3DTO::transactionIsSet() const
{
    return m_TransactionIsSet;
}

void UniswapV3_PositionV3DTO::unsetTransaction()
{
    m_TransactionIsSet = false;
}
utility::string_t UniswapV3_PositionV3DTO::getFeeGrowthInside0LastX128() const
{
    return m_Fee_growth_inside_0_last_x128;
}

void UniswapV3_PositionV3DTO::setFeeGrowthInside0LastX128(const utility::string_t& value)
{
    m_Fee_growth_inside_0_last_x128 = value;
    m_Fee_growth_inside_0_last_x128IsSet = true;
}

bool UniswapV3_PositionV3DTO::feeGrowthInside0LastX128IsSet() const
{
    return m_Fee_growth_inside_0_last_x128IsSet;
}

void UniswapV3_PositionV3DTO::unsetFee_growth_inside_0_last_x128()
{
    m_Fee_growth_inside_0_last_x128IsSet = false;
}
utility::string_t UniswapV3_PositionV3DTO::getFeeGrowthInside1LastX128() const
{
    return m_Fee_growth_inside_1_last_x128;
}

void UniswapV3_PositionV3DTO::setFeeGrowthInside1LastX128(const utility::string_t& value)
{
    m_Fee_growth_inside_1_last_x128 = value;
    m_Fee_growth_inside_1_last_x128IsSet = true;
}

bool UniswapV3_PositionV3DTO::feeGrowthInside1LastX128IsSet() const
{
    return m_Fee_growth_inside_1_last_x128IsSet;
}

void UniswapV3_PositionV3DTO::unsetFee_growth_inside_1_last_x128()
{
    m_Fee_growth_inside_1_last_x128IsSet = false;
}
int64_t UniswapV3_PositionV3DTO::getVid() const
{
    return m_Vid;
}

void UniswapV3_PositionV3DTO::setVid(int64_t value)
{
    m_Vid = value;
    m_VidIsSet = true;
}

bool UniswapV3_PositionV3DTO::vidIsSet() const
{
    return m_VidIsSet;
}

void UniswapV3_PositionV3DTO::unsetVid()
{
    m_VidIsSet = false;
}
}
