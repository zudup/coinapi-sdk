...
void TokenV3DTO::validate()
{
    // TODO: implement validation
}

web::json::value TokenV3DTO::toJson() const
{
...
bool TokenV3DTO::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("total_supply"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::shared_ptr<BigInteger> refVal_setTotalSupply;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("pool_count"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::shared_ptr<BigInteger> refVal_setPoolCount;
...
void TokenV3DTO::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool TokenV3DTO::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
utility::datetime TokenV3DTO::getEntryTime() const
{
    return m_Entry_time;
}

void TokenV3DTO::setEntryTime(const utility::datetime& value)
{
    m_Entry_time = value;
    m_Entry_timeIsSet = true;
}

bool TokenV3DTO::entryTimeIsSet() const
{
    return m_Entry_timeIsSet;
}

void TokenV3DTO::unsetEntry_time()
{
    m_Entry_timeIsSet = false;
}
utility::datetime TokenV3DTO::getRecvTime() const
{
    return m_Recv_time;
}

void TokenV3DTO::setRecvTime(const utility::datetime& value)
{
    m_Recv_time = value;
    m_Recv_timeIsSet = true;
}

bool TokenV3DTO::recvTimeIsSet() const
{
    return m_Recv_timeIsSet;
}

void TokenV3DTO::unsetRecv_time()
{
    m_Recv_timeIsSet = false;
}
int64_t TokenV3DTO::getBlockNumber() const
{
    return m_Block_number;
}

void TokenV3DTO::setBlockNumber(int64_t value)
{
    m_Block_number = value;
    m_Block_numberIsSet = true;
}

bool TokenV3DTO::blockNumberIsSet() const
{
    return m_Block_numberIsSet;
}

void TokenV3DTO::unsetBlock_number()
{
    m_Block_numberIsSet = false;
}
int64_t TokenV3DTO::getVid() const
{
    return m_Vid;
}

void TokenV3DTO::setVid(int64_t value)
{
    m_Vid = value;
    m_VidIsSet = true;
}

bool TokenV3DTO::vidIsSet() const
{
    return m_VidIsSet;
}

void TokenV3DTO::unsetVid()
{
    m_VidIsSet = false;
}
utility::string_t TokenV3DTO::getId() const
{
    return m_Id;
}

void TokenV3DTO::setId(const utility::string_t& value)
{
    m_Id = value;
    m_IdIsSet = true;
}

bool TokenV3DTO::idIsSet() const
{
    return m_IdIsSet;
}

void TokenV3DTO::unsetId()
{
    m_IdIsSet = false;
}
utility::string_t TokenV3DTO::getSymbol() const
{
    return m_Symbol;
}

void TokenV3DTO::setSymbol(const utility::string_t& value)
{
    m_Symbol = value;
    m_SymbolIsSet = true;
}

bool TokenV3DTO::symbolIsSet() const
{
    return m_SymbolIsSet;
}

void TokenV3DTO::unsetSymbol()
{
    m_SymbolIsSet = false;
}
utility::string_t TokenV3DTO::getName() const
{
    return m_Name;
}

void TokenV3DTO::setName(const utility::string_t& value)
{
    m_Name = value;
    m_NameIsSet = true;
}

bool TokenV3DTO::nameIsSet() const
{
    return m_NameIsSet;
}

void TokenV3DTO::unsetName()
{
    m_NameIsSet = false;
}
int32_t TokenV3DTO::getDecimals() const
{
    return m_Decimals;
}

void TokenV3DTO::setDecimals(int32_t value)
{
    m_Decimals = value;
    m_DecimalsIsSet = true;
}

bool TokenV3DTO::decimalsIsSet() const
{
    return m_DecimalsIsSet;
}

void TokenV3DTO::unsetDecimals()
{
    m_DecimalsIsSet = false;
}
std::shared_ptr<BigInteger> TokenV3DTO::getTotalSupply() const
{
    return m_Total_supply;
}

void TokenV3DTO::setTotalSupply(const std::shared_ptr<BigInteger>& value)
{
    m_Total_supply = value;
    m_Total_supplyIsSet = true;
}

bool TokenV3DTO::totalSupplyIsSet() const
{
    return m_Total_supplyIsSet;
}

void TokenV3DTO::unsetTotal_supply()
{
    m_Total_supplyIsSet = false;
}
utility::string_t TokenV3DTO::getVolume() const
{
    return m_Volume;
}

void TokenV3DTO::setVolume(const utility::string_t& value)
{
    m_Volume = value;
    m_VolumeIsSet = true;
}

bool TokenV3DTO::volumeIsSet() const
{
    return m_VolumeIsSet;
}

void TokenV3DTO::unsetVolume()
{
    m_VolumeIsSet = false;
}
utility::string_t TokenV3DTO::getVolumeUsd() const
{
    return m_Volume_usd;
}

void TokenV3DTO::setVolumeUsd(const utility::string_t& value)
{
    m_Volume_usd = value;
    m_Volume_usdIsSet = true;
}

bool TokenV3DTO::volumeUsdIsSet() const
{
    return m_Volume_usdIsSet;
}

void TokenV3DTO::unsetVolume_usd()
{
    m_Volume_usdIsSet = false;
}
utility::string_t TokenV3DTO::getUntrackedVolumeUsd() const
{
    return m_Untracked_volume_usd;
}

void TokenV3DTO::setUntrackedVolumeUsd(const utility::string_t& value)
{
    m_Untracked_volume_usd = value;
    m_Untracked_volume_usdIsSet = true;
}

bool TokenV3DTO::untrackedVolumeUsdIsSet() const
{
    return m_Untracked_volume_usdIsSet;
}

void TokenV3DTO::unsetUntracked_volume_usd()
{
    m_Untracked_volume_usdIsSet = false;
}
utility::string_t TokenV3DTO::getFeesUsd() const
{
    return m_Fees_usd;
}

void TokenV3DTO::setFeesUsd(const utility::string_t& value)
{
    m_Fees_usd = value;
    m_Fees_usdIsSet = true;
}

bool TokenV3DTO::feesUsdIsSet() const
{
    return m_Fees_usdIsSet;
}

void TokenV3DTO::unsetFees_usd()
{
    m_Fees_usdIsSet = false;
}
std::shared_ptr<BigInteger> TokenV3DTO::getTxCount() const
{
    return m_Tx_count;
}

void TokenV3DTO::setTxCount(const std::shared_ptr<BigInteger>& value)
{
    m_Tx_count = value;
    m_Tx_countIsSet = true;
}

bool TokenV3DTO::txCountIsSet() const
{
    return m_Tx_countIsSet;
}

void TokenV3DTO::unsetTx_count()
{
    m_Tx_countIsSet = false;
}
std::shared_ptr<BigInteger> TokenV3DTO::getPoolCount() const
{
    return m_Pool_count;
}

void TokenV3DTO::setPoolCount(const std::shared_ptr<BigInteger>& value)
{
    m_Pool_count = value;
    m_Pool_countIsSet = true;
}

bool TokenV3DTO::poolCountIsSet() const
{
    return m_Pool_countIsSet;
}

void TokenV3DTO::unsetPool_count()
{
    m_Pool_countIsSet = false;
}
utility::string_t TokenV3DTO::getTotalValueLocked() const
{
    return m_Total_value_locked;
}

void TokenV3DTO::setTotalValueLocked(const utility::string_t& value)
{
    m_Total_value_locked = value;
    m_Total_value_lockedIsSet = true;
}

bool TokenV3DTO::totalValueLockedIsSet() const
{
    return m_Total_value_lockedIsSet;
}

void TokenV3DTO::unsetTotal_value_locked()
{
    m_Total_value_lockedIsSet = false;
}
utility::string_t TokenV3DTO::getTotalValueLockedUsd() const
{
    return m_Total_value_locked_usd;
}

void TokenV3DTO::setTotalValueLockedUsd(const utility::string_t& value)
{
    m_Total_value_locked_usd = value;
    m_Total_value_locked_usdIsSet = true;
}

bool TokenV3DTO::totalValueLockedUsdIsSet() const
{
    return m_Total_value_locked_usdIsSet;
}

void TokenV3DTO::unsetTotal_value_locked_usd()
{
    m_Total_value_locked_usdIsSet = false;
}
utility::string_t TokenV3DTO::getTotalValueLockedUsdUntracked() const
{
    return m_Total_value_locked_usd_untracked;
}

void TokenV3DTO::setTotalValueLockedUsdUntracked(const utility::string_t& value)
{
    m_Total_value_locked_usd_untracked = value;
    m_Total_value_locked_usd_untrackedIsSet = true;
}

bool TokenV3DTO::totalValueLockedUsdUntrackedIsSet() const
{
    return m_Total_value_locked_usd_untrackedIsSet;
}

void TokenV3DTO::unsetTotal_value_locked_usd_untracked()
{
    m_Total_value_locked_usd_untrackedIsSet = false;
}
utility::string_t TokenV3DTO::getDerivedEth() const
{
    return m_Derived_eth;
}

void TokenV3DTO::setDerivedEth(const utility::string_t& value)
{
    m_Derived_eth = value;
    m_Derived_ethIsSet = true;
}

bool TokenV3DTO::derivedEthIsSet() const
{
    return m_Derived_ethIsSet;
}

void TokenV3DTO::unsetDerived_eth()
{
    m_Derived_ethIsSet = false;
}
std::vector<utility::string_t>& TokenV3DTO::getWhitelistPools()
{
    return m_Whitelist_pools;
}

void TokenV3DTO::setWhitelistPools(const std::vector<utility::string_t>& value)
{
    m_Whitelist_pools = value;
    m_Whitelist_poolsIsSet = true;
}

bool TokenV3DTO::whitelistPoolsIsSet() const
{
    return m_Whitelist_poolsIsSet;
}

void TokenV3DTO::unsetWhitelist_pools()
{
    m_Whitelist_poolsIsSet = false;
}
utility::string_t TokenV3DTO::getTokenSymbol() const
{
    return m_Token_symbol;
}

void TokenV3DTO::setTokenSymbol(const utility::string_t& value)
{
    m_Token_symbol = value;
    m_Token_symbolIsSet = true;
}

bool TokenV3DTO::tokenSymbolIsSet() const
{
    return m_Token_symbolIsSet;
}

void TokenV3DTO::unsetToken_symbol()
{
    m_Token_symbolIsSet = false;
}
}
