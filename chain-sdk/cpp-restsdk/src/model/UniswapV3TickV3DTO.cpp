...
void UniswapV3TickV3DTO::validate()
{
    // TODO: implement validation
}

web::json::value UniswapV3TickV3DTO::toJson() const
{
...
bool UniswapV3TickV3DTO::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("tick_idx"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::shared_ptr<NumericsBigInteger> refVal_setTickIdx;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("liquidity_gross"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::shared_ptr<NumericsBigInteger> refVal_setLiquidityGross;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("liquidity_net"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::shared_ptr<NumericsBigInteger> refVal_setLiquidityNet;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("liquidity_provider_count"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::shared_ptr<NumericsBigInteger> refVal_setLiquidityProviderCount;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("fee_growth_outside_0x128"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::shared_ptr<NumericsBigInteger> refVal_setFeeGrowthOutside0x128;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("fee_growth_outside_1x128"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::shared_ptr<NumericsBigInteger> refVal_setFeeGrowthOutside1x128;
...
void UniswapV3TickV3DTO::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool UniswapV3TickV3DTO::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
utility::datetime UniswapV3TickV3DTO::getEntryTime() const
{
    return m_Entry_time;
}

void UniswapV3TickV3DTO::setEntryTime(const utility::datetime& value)
{
    m_Entry_time = value;
    m_Entry_timeIsSet = true;
}

bool UniswapV3TickV3DTO::entryTimeIsSet() const
{
    return m_Entry_timeIsSet;
}

void UniswapV3TickV3DTO::unsetEntry_time()
{
    m_Entry_timeIsSet = false;
}
utility::datetime UniswapV3TickV3DTO::getRecvTime() const
{
    return m_Recv_time;
}

void UniswapV3TickV3DTO::setRecvTime(const utility::datetime& value)
{
    m_Recv_time = value;
    m_Recv_timeIsSet = true;
}

bool UniswapV3TickV3DTO::recvTimeIsSet() const
{
    return m_Recv_timeIsSet;
}

void UniswapV3TickV3DTO::unsetRecv_time()
{
    m_Recv_timeIsSet = false;
}
int64_t UniswapV3TickV3DTO::getBlockNumber() const
{
    return m_Block_number;
}

void UniswapV3TickV3DTO::setBlockNumber(int64_t value)
{
    m_Block_number = value;
    m_Block_numberIsSet = true;
}

bool UniswapV3TickV3DTO::blockNumberIsSet() const
{
    return m_Block_numberIsSet;
}

void UniswapV3TickV3DTO::unsetBlock_number()
{
    m_Block_numberIsSet = false;
}
int64_t UniswapV3TickV3DTO::getVid() const
{
    return m_Vid;
}

void UniswapV3TickV3DTO::setVid(int64_t value)
{
    m_Vid = value;
    m_VidIsSet = true;
}

bool UniswapV3TickV3DTO::vidIsSet() const
{
    return m_VidIsSet;
}

void UniswapV3TickV3DTO::unsetVid()
{
    m_VidIsSet = false;
}
utility::string_t UniswapV3TickV3DTO::getId() const
{
    return m_Id;
}

void UniswapV3TickV3DTO::setId(const utility::string_t& value)
{
    m_Id = value;
    m_IdIsSet = true;
}

bool UniswapV3TickV3DTO::idIsSet() const
{
    return m_IdIsSet;
}

void UniswapV3TickV3DTO::unsetId()
{
    m_IdIsSet = false;
}
utility::string_t UniswapV3TickV3DTO::getPoolAddress() const
{
    return m_Pool_address;
}

void UniswapV3TickV3DTO::setPoolAddress(const utility::string_t& value)
{
    m_Pool_address = value;
    m_Pool_addressIsSet = true;
}

bool UniswapV3TickV3DTO::poolAddressIsSet() const
{
    return m_Pool_addressIsSet;
}

void UniswapV3TickV3DTO::unsetPool_address()
{
    m_Pool_addressIsSet = false;
}
std::shared_ptr<NumericsBigInteger> UniswapV3TickV3DTO::getTickIdx() const
{
    return m_Tick_idx;
}

void UniswapV3TickV3DTO::setTickIdx(const std::shared_ptr<NumericsBigInteger>& value)
{
    m_Tick_idx = value;
    m_Tick_idxIsSet = true;
}

bool UniswapV3TickV3DTO::tickIdxIsSet() const
{
    return m_Tick_idxIsSet;
}

void UniswapV3TickV3DTO::unsetTick_idx()
{
    m_Tick_idxIsSet = false;
}
utility::string_t UniswapV3TickV3DTO::getPool() const
{
    return m_Pool;
}

void UniswapV3TickV3DTO::setPool(const utility::string_t& value)
{
    m_Pool = value;
    m_PoolIsSet = true;
}

bool UniswapV3TickV3DTO::poolIsSet() const
{
    return m_PoolIsSet;
}

void UniswapV3TickV3DTO::unsetPool()
{
    m_PoolIsSet = false;
}
std::shared_ptr<NumericsBigInteger> UniswapV3TickV3DTO::getLiquidityGross() const
{
    return m_Liquidity_gross;
}

void UniswapV3TickV3DTO::setLiquidityGross(const std::shared_ptr<NumericsBigInteger>& value)
{
    m_Liquidity_gross = value;
    m_Liquidity_grossIsSet = true;
}

bool UniswapV3TickV3DTO::liquidityGrossIsSet() const
{
    return m_Liquidity_grossIsSet;
}

void UniswapV3TickV3DTO::unsetLiquidity_gross()
{
    m_Liquidity_grossIsSet = false;
}
std::shared_ptr<NumericsBigInteger> UniswapV3TickV3DTO::getLiquidityNet() const
{
    return m_Liquidity_net;
}

void UniswapV3TickV3DTO::setLiquidityNet(const std::shared_ptr<NumericsBigInteger>& value)
{
    m_Liquidity_net = value;
    m_Liquidity_netIsSet = true;
}

bool UniswapV3TickV3DTO::liquidityNetIsSet() const
{
    return m_Liquidity_netIsSet;
}

void UniswapV3TickV3DTO::unsetLiquidity_net()
{
    m_Liquidity_netIsSet = false;
}
utility::string_t UniswapV3TickV3DTO::getPrice0() const
{
    return m_Price_0;
}

void UniswapV3TickV3DTO::setPrice0(const utility::string_t& value)
{
    m_Price_0 = value;
    m_Price_0IsSet = true;
}

bool UniswapV3TickV3DTO::price0IsSet() const
{
    return m_Price_0IsSet;
}

void UniswapV3TickV3DTO::unsetPrice_0()
{
    m_Price_0IsSet = false;
}
utility::string_t UniswapV3TickV3DTO::getPrice1() const
{
    return m_Price_1;
}

void UniswapV3TickV3DTO::setPrice1(const utility::string_t& value)
{
    m_Price_1 = value;
    m_Price_1IsSet = true;
}

bool UniswapV3TickV3DTO::price1IsSet() const
{
    return m_Price_1IsSet;
}

void UniswapV3TickV3DTO::unsetPrice_1()
{
    m_Price_1IsSet = false;
}
utility::string_t UniswapV3TickV3DTO::getVolumeToken0() const
{
    return m_Volume_token_0;
}

void UniswapV3TickV3DTO::setVolumeToken0(const utility::string_t& value)
{
    m_Volume_token_0 = value;
    m_Volume_token_0IsSet = true;
}

bool UniswapV3TickV3DTO::volumeToken0IsSet() const
{
    return m_Volume_token_0IsSet;
}

void UniswapV3TickV3DTO::unsetVolume_token_0()
{
    m_Volume_token_0IsSet = false;
}
utility::string_t UniswapV3TickV3DTO::getVolumeToken1() const
{
    return m_Volume_token_1;
}

void UniswapV3TickV3DTO::setVolumeToken1(const utility::string_t& value)
{
    m_Volume_token_1 = value;
    m_Volume_token_1IsSet = true;
}

bool UniswapV3TickV3DTO::volumeToken1IsSet() const
{
    return m_Volume_token_1IsSet;
}

void UniswapV3TickV3DTO::unsetVolume_token_1()
{
    m_Volume_token_1IsSet = false;
}
utility::string_t UniswapV3TickV3DTO::getVolumeUsd() const
{
    return m_Volume_usd;
}

void UniswapV3TickV3DTO::setVolumeUsd(const utility::string_t& value)
{
    m_Volume_usd = value;
    m_Volume_usdIsSet = true;
}

bool UniswapV3TickV3DTO::volumeUsdIsSet() const
{
    return m_Volume_usdIsSet;
}

void UniswapV3TickV3DTO::unsetVolume_usd()
{
    m_Volume_usdIsSet = false;
}
utility::string_t UniswapV3TickV3DTO::getUntrackedVolumeUsd() const
{
    return m_Untracked_volume_usd;
}

void UniswapV3TickV3DTO::setUntrackedVolumeUsd(const utility::string_t& value)
{
    m_Untracked_volume_usd = value;
    m_Untracked_volume_usdIsSet = true;
}

bool UniswapV3TickV3DTO::untrackedVolumeUsdIsSet() const
{
    return m_Untracked_volume_usdIsSet;
}

void UniswapV3TickV3DTO::unsetUntracked_volume_usd()
{
    m_Untracked_volume_usdIsSet = false;
}
utility::string_t UniswapV3TickV3DTO::getFeesUsd() const
{
    return m_Fees_usd;
}

void UniswapV3TickV3DTO::setFeesUsd(const utility::string_t& value)
{
    m_Fees_usd = value;
    m_Fees_usdIsSet = true;
}

bool UniswapV3TickV3DTO::feesUsdIsSet() const
{
    return m_Fees_usdIsSet;
}

void UniswapV3TickV3DTO::unsetFees_usd()
{
    m_Fees_usdIsSet = false;
}
utility::string_t UniswapV3TickV3DTO::getCollectedFeesToken0() const
{
    return m_Collected_fees_token_0;
}

void UniswapV3TickV3DTO::setCollectedFeesToken0(const utility::string_t& value)
{
    m_Collected_fees_token_0 = value;
    m_Collected_fees_token_0IsSet = true;
}

bool UniswapV3TickV3DTO::collectedFeesToken0IsSet() const
{
    return m_Collected_fees_token_0IsSet;
}

void UniswapV3TickV3DTO::unsetCollected_fees_token_0()
{
    m_Collected_fees_token_0IsSet = false;
}
utility::string_t UniswapV3TickV3DTO::getCollectedFeesToken1() const
{
    return m_Collected_fees_token_1;
}

void UniswapV3TickV3DTO::setCollectedFeesToken1(const utility::string_t& value)
{
    m_Collected_fees_token_1 = value;
    m_Collected_fees_token_1IsSet = true;
}

bool UniswapV3TickV3DTO::collectedFeesToken1IsSet() const
{
    return m_Collected_fees_token_1IsSet;
}

void UniswapV3TickV3DTO::unsetCollected_fees_token_1()
{
    m_Collected_fees_token_1IsSet = false;
}
utility::string_t UniswapV3TickV3DTO::getCollectedFeesUsd() const
{
    return m_Collected_fees_usd;
}

void UniswapV3TickV3DTO::setCollectedFeesUsd(const utility::string_t& value)
{
    m_Collected_fees_usd = value;
    m_Collected_fees_usdIsSet = true;
}

bool UniswapV3TickV3DTO::collectedFeesUsdIsSet() const
{
    return m_Collected_fees_usdIsSet;
}

void UniswapV3TickV3DTO::unsetCollected_fees_usd()
{
    m_Collected_fees_usdIsSet = false;
}
utility::datetime UniswapV3TickV3DTO::getCreatedAtTimestamp() const
{
    return m_Created_at_timestamp;
}

void UniswapV3TickV3DTO::setCreatedAtTimestamp(const utility::datetime& value)
{
    m_Created_at_timestamp = value;
    m_Created_at_timestampIsSet = true;
}

bool UniswapV3TickV3DTO::createdAtTimestampIsSet() const
{
    return m_Created_at_timestampIsSet;
}

void UniswapV3TickV3DTO::unsetCreated_at_timestamp()
{
    m_Created_at_timestampIsSet = false;
}
std::shared_ptr<NumericsBigInteger> UniswapV3TickV3DTO::getLiquidityProviderCount() const
{
    return m_Liquidity_provider_count;
}

void UniswapV3TickV3DTO::setLiquidityProviderCount(const std::shared_ptr<NumericsBigInteger>& value)
{
    m_Liquidity_provider_count = value;
    m_Liquidity_provider_countIsSet = true;
}

bool UniswapV3TickV3DTO::liquidityProviderCountIsSet() const
{
    return m_Liquidity_provider_countIsSet;
}

void UniswapV3TickV3DTO::unsetLiquidity_provider_count()
{
    m_Liquidity_provider_countIsSet = false;
}
std::shared_ptr<NumericsBigInteger> UniswapV3TickV3DTO::getFeeGrowthOutside0x128() const
{
    return m_Fee_growth_outside_0x128;
}

void UniswapV3TickV3DTO::setFeeGrowthOutside0x128(const std::shared_ptr<NumericsBigInteger>& value)
{
    m_Fee_growth_outside_0x128 = value;
    m_Fee_growth_outside_0x128IsSet = true;
}

bool UniswapV3TickV3DTO::feeGrowthOutside0x128IsSet() const
{
    return m_Fee_growth_outside_0x128IsSet;
}

void UniswapV3TickV3DTO::unsetFee_growth_outside_0x128()
{
    m_Fee_growth_outside_0x128IsSet = false;
}
std::shared_ptr<NumericsBigInteger> UniswapV3TickV3DTO::getFeeGrowthOutside1x128() const
{
    return m_Fee_growth_outside_1x128;
}

void UniswapV3TickV3DTO::setFeeGrowthOutside1x128(const std::shared_ptr<NumericsBigInteger>& value)
{
    m_Fee_growth_outside_1x128 = value;
    m_Fee_growth_outside_1x128IsSet = true;
}

bool UniswapV3TickV3DTO::feeGrowthOutside1x128IsSet() const
{
    return m_Fee_growth_outside_1x128IsSet;
}

void UniswapV3TickV3DTO::unsetFee_growth_outside_1x128()
{
    m_Fee_growth_outside_1x128IsSet = false;
}
}
