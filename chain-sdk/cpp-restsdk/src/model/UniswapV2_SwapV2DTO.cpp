...
UniswapV2_SwapV2DTO::UniswapV2_SwapV2DTO()
{
...
void UniswapV2_SwapV2DTO::validate()
{
    // TODO: implement validation
}

web::json::value UniswapV2_SwapV2DTO::toJson() const
{
...
bool UniswapV2_SwapV2DTO::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void UniswapV2_SwapV2DTO::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool UniswapV2_SwapV2DTO::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
utility::datetime UniswapV2_SwapV2DTO::getEntryTime() const
{
    return m_Entry_time;
}

void UniswapV2_SwapV2DTO::setEntryTime(const utility::datetime& value)
{
    m_Entry_time = value;
    m_Entry_timeIsSet = true;
}

bool UniswapV2_SwapV2DTO::entryTimeIsSet() const
{
    return m_Entry_timeIsSet;
}

void UniswapV2_SwapV2DTO::unsetEntry_time()
{
    m_Entry_timeIsSet = false;
}
utility::datetime UniswapV2_SwapV2DTO::getRecvTime() const
{
    return m_Recv_time;
}

void UniswapV2_SwapV2DTO::setRecvTime(const utility::datetime& value)
{
    m_Recv_time = value;
    m_Recv_timeIsSet = true;
}

bool UniswapV2_SwapV2DTO::recvTimeIsSet() const
{
    return m_Recv_timeIsSet;
}

void UniswapV2_SwapV2DTO::unsetRecv_time()
{
    m_Recv_timeIsSet = false;
}
int64_t UniswapV2_SwapV2DTO::getBlockNumber() const
{
    return m_Block_number;
}

void UniswapV2_SwapV2DTO::setBlockNumber(int64_t value)
{
    m_Block_number = value;
    m_Block_numberIsSet = true;
}

bool UniswapV2_SwapV2DTO::blockNumberIsSet() const
{
    return m_Block_numberIsSet;
}

void UniswapV2_SwapV2DTO::unsetBlock_number()
{
    m_Block_numberIsSet = false;
}
int64_t UniswapV2_SwapV2DTO::getVid() const
{
    return m_Vid;
}

void UniswapV2_SwapV2DTO::setVid(int64_t value)
{
    m_Vid = value;
    m_VidIsSet = true;
}

bool UniswapV2_SwapV2DTO::vidIsSet() const
{
    return m_VidIsSet;
}

void UniswapV2_SwapV2DTO::unsetVid()
{
    m_VidIsSet = false;
}
utility::string_t UniswapV2_SwapV2DTO::getId() const
{
    return m_Id;
}

void UniswapV2_SwapV2DTO::setId(const utility::string_t& value)
{
    m_Id = value;
    m_IdIsSet = true;
}

bool UniswapV2_SwapV2DTO::idIsSet() const
{
    return m_IdIsSet;
}

void UniswapV2_SwapV2DTO::unsetId()
{
    m_IdIsSet = false;
}
utility::string_t UniswapV2_SwapV2DTO::getTransaction() const
{
    return m_Transaction;
}

void UniswapV2_SwapV2DTO::setTransaction(const utility::string_t& value)
{
    m_Transaction = value;
    m_TransactionIsSet = true;
}

bool UniswapV2_SwapV2DTO::transactionIsSet() const
{
    return m_TransactionIsSet;
}

void UniswapV2_SwapV2DTO::unsetTransaction()
{
    m_TransactionIsSet = false;
}
utility::datetime UniswapV2_SwapV2DTO::getTimestamp() const
{
    return m_Timestamp;
}

void UniswapV2_SwapV2DTO::setTimestamp(const utility::datetime& value)
{
    m_Timestamp = value;
    m_TimestampIsSet = true;
}

bool UniswapV2_SwapV2DTO::timestampIsSet() const
{
    return m_TimestampIsSet;
}

void UniswapV2_SwapV2DTO::unsetTimestamp()
{
    m_TimestampIsSet = false;
}
utility::string_t UniswapV2_SwapV2DTO::getPair() const
{
    return m_Pair;
}

void UniswapV2_SwapV2DTO::setPair(const utility::string_t& value)
{
    m_Pair = value;
    m_PairIsSet = true;
}

bool UniswapV2_SwapV2DTO::pairIsSet() const
{
    return m_PairIsSet;
}

void UniswapV2_SwapV2DTO::unsetPair()
{
    m_PairIsSet = false;
}
utility::string_t UniswapV2_SwapV2DTO::getSender() const
{
    return m_Sender;
}

void UniswapV2_SwapV2DTO::setSender(const utility::string_t& value)
{
    m_Sender = value;
    m_SenderIsSet = true;
}

bool UniswapV2_SwapV2DTO::senderIsSet() const
{
    return m_SenderIsSet;
}

void UniswapV2_SwapV2DTO::unsetSender()
{
    m_SenderIsSet = false;
}
utility::string_t UniswapV2_SwapV2DTO::getFrom() const
{
    return m_From;
}

void UniswapV2_SwapV2DTO::setFrom(const utility::string_t& value)
{
    m_From = value;
    m_FromIsSet = true;
}

bool UniswapV2_SwapV2DTO::fromIsSet() const
{
    return m_FromIsSet;
}

void UniswapV2_SwapV2DTO::unsetFrom()
{
    m_FromIsSet = false;
}
utility::string_t UniswapV2_SwapV2DTO::getAmount0In() const
{
    return m_Amount_0_in;
}

void UniswapV2_SwapV2DTO::setAmount0In(const utility::string_t& value)
{
    m_Amount_0_in = value;
    m_Amount_0_inIsSet = true;
}

bool UniswapV2_SwapV2DTO::amount0InIsSet() const
{
    return m_Amount_0_inIsSet;
}

void UniswapV2_SwapV2DTO::unsetAmount_0_in()
{
    m_Amount_0_inIsSet = false;
}
utility::string_t UniswapV2_SwapV2DTO::getAmount1In() const
{
    return m_Amount_1_in;
}

void UniswapV2_SwapV2DTO::setAmount1In(const utility::string_t& value)
{
    m_Amount_1_in = value;
    m_Amount_1_inIsSet = true;
}

bool UniswapV2_SwapV2DTO::amount1InIsSet() const
{
    return m_Amount_1_inIsSet;
}

void UniswapV2_SwapV2DTO::unsetAmount_1_in()
{
    m_Amount_1_inIsSet = false;
}
utility::string_t UniswapV2_SwapV2DTO::getAmount0Out() const
{
    return m_Amount_0_out;
}

void UniswapV2_SwapV2DTO::setAmount0Out(const utility::string_t& value)
{
    m_Amount_0_out = value;
    m_Amount_0_outIsSet = true;
}

bool UniswapV2_SwapV2DTO::amount0OutIsSet() const
{
    return m_Amount_0_outIsSet;
}

void UniswapV2_SwapV2DTO::unsetAmount_0_out()
{
    m_Amount_0_outIsSet = false;
}
utility::string_t UniswapV2_SwapV2DTO::getAmount1Out() const
{
    return m_Amount_1_out;
}

void UniswapV2_SwapV2DTO::setAmount1Out(const utility::string_t& value)
{
    m_Amount_1_out = value;
    m_Amount_1_outIsSet = true;
}

bool UniswapV2_SwapV2DTO::amount1OutIsSet() const
{
    return m_Amount_1_outIsSet;
}

void UniswapV2_SwapV2DTO::unsetAmount_1_out()
{
    m_Amount_1_outIsSet = false;
}
utility::string_t UniswapV2_SwapV2DTO::getTo() const
{
    return m_To;
}

void UniswapV2_SwapV2DTO::setTo(const utility::string_t& value)
{
    m_To = value;
    m_ToIsSet = true;
}

bool UniswapV2_SwapV2DTO::toIsSet() const
{
    return m_ToIsSet;
}

void UniswapV2_SwapV2DTO::unsetTo()
{
    m_ToIsSet = false;
}
std::shared_ptr<Numerics_BigInteger> UniswapV2_SwapV2DTO::getLogIndex() const
{
    return m_Log_index;
}

void UniswapV2_SwapV2DTO::setLogIndex(const std::shared_ptr<Numerics_BigInteger>& value)
{
    m_Log_index = value;
    m_Log_indexIsSet = true;
}

bool UniswapV2_SwapV2DTO::logIndexIsSet() const
{
    return m_Log_indexIsSet;
}

void UniswapV2_SwapV2DTO::unsetLog_index()
{
    m_Log_indexIsSet = false;
}
utility::string_t UniswapV2_SwapV2DTO::getAmountUsd() const
{
    return m_Amount_usd;
}

void UniswapV2_SwapV2DTO::setAmountUsd(const utility::string_t& value)
{
    m_Amount_usd = value;
    m_Amount_usdIsSet = true;
}

bool UniswapV2_SwapV2DTO::amountUsdIsSet() const
{
    return m_Amount_usdIsSet;
}

void UniswapV2_SwapV2DTO::unsetAmount_usd()
{
    m_Amount_usdIsSet = false;
}
double UniswapV2_SwapV2DTO::getEvaluatedPrice() const
{
    return m_Evaluated_price;
}

void UniswapV2_SwapV2DTO::setEvaluatedPrice(double value)
{
    m_Evaluated_price = value;
    m_Evaluated_priceIsSet = true;
}

bool UniswapV2_SwapV2DTO::evaluatedPriceIsSet() const
{
    return m_Evaluated_priceIsSet;
}

void UniswapV2_SwapV2DTO::unsetEvaluated_price()
{
    m_Evaluated_priceIsSet = false;
}
double UniswapV2_SwapV2DTO::getEvaluatedAmount() const
{
    return m_Evaluated_amount;
}

void UniswapV2_SwapV2DTO::setEvaluatedAmount(double value)
{
    m_Evaluated_amount = value;
    m_Evaluated_amountIsSet = true;
}

bool UniswapV2_SwapV2DTO::evaluatedAmountIsSet() const
{
    return m_Evaluated_amountIsSet;
}

void UniswapV2_SwapV2DTO::unsetEvaluated_amount()
{
    m_Evaluated_amountIsSet = false;
}
std::shared_ptr<Transactions_ETradeAggressiveSide> UniswapV2_SwapV2DTO::getEvaluatedAggressor() const
{
    return m_Evaluated_aggressor;
}

void UniswapV2_SwapV2DTO::setEvaluatedAggressor(const std::shared_ptr<Transactions_ETradeAggressiveSide>& value)
{
    m_Evaluated_aggressor = value;
    m_Evaluated_aggressorIsSet = true;
}

bool UniswapV2_SwapV2DTO::evaluatedAggressorIsSet() const
{
    return m_Evaluated_aggressorIsSet;
}

void UniswapV2_SwapV2DTO::unsetEvaluated_aggressor()
{
    m_Evaluated_aggressorIsSet = false;
}
utility::string_t UniswapV2_SwapV2DTO::getPoolId() const
{
    return m_Pool_id;
}

void UniswapV2_SwapV2DTO::setPoolId(const utility::string_t& value)
{
    m_Pool_id = value;
    m_Pool_idIsSet = true;
}

bool UniswapV2_SwapV2DTO::poolIdIsSet() const
{
    return m_Pool_idIsSet;
}

void UniswapV2_SwapV2DTO::unsetPool_id()
{
    m_Pool_idIsSet = false;
}
utility::string_t UniswapV2_SwapV2DTO::getTransactionId() const
{
    return m_Transaction_id;
}

void UniswapV2_SwapV2DTO::setTransactionId(const utility::string_t& value)
{
    m_Transaction_id = value;
    m_Transaction_idIsSet = true;
}

bool UniswapV2_SwapV2DTO::transactionIdIsSet() const
{
    return m_Transaction_idIsSet;
}

void UniswapV2_SwapV2DTO::unsetTransaction_id()
{
    m_Transaction_idIsSet = false;
}
}
