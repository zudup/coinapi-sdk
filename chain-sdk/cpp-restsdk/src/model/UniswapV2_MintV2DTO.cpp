...
UniswapV2_MintV2DTO::UniswapV2_MintV2DTO()
{
...
void UniswapV2_MintV2DTO::validate()
{
    // TODO: implement validation
}

web::json::value UniswapV2_MintV2DTO::toJson() const
{
...
bool UniswapV2_MintV2DTO::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void UniswapV2_MintV2DTO::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool UniswapV2_MintV2DTO::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
utility::datetime UniswapV2_MintV2DTO::getEntryTime() const
{
    return m_Entry_time;
}

void UniswapV2_MintV2DTO::setEntryTime(const utility::datetime& value)
{
    m_Entry_time = value;
    m_Entry_timeIsSet = true;
}

bool UniswapV2_MintV2DTO::entryTimeIsSet() const
{
    return m_Entry_timeIsSet;
}

void UniswapV2_MintV2DTO::unsetEntry_time()
{
    m_Entry_timeIsSet = false;
}
utility::datetime UniswapV2_MintV2DTO::getRecvTime() const
{
    return m_Recv_time;
}

void UniswapV2_MintV2DTO::setRecvTime(const utility::datetime& value)
{
    m_Recv_time = value;
    m_Recv_timeIsSet = true;
}

bool UniswapV2_MintV2DTO::recvTimeIsSet() const
{
    return m_Recv_timeIsSet;
}

void UniswapV2_MintV2DTO::unsetRecv_time()
{
    m_Recv_timeIsSet = false;
}
int64_t UniswapV2_MintV2DTO::getBlockNumber() const
{
    return m_Block_number;
}

void UniswapV2_MintV2DTO::setBlockNumber(int64_t value)
{
    m_Block_number = value;
    m_Block_numberIsSet = true;
}

bool UniswapV2_MintV2DTO::blockNumberIsSet() const
{
    return m_Block_numberIsSet;
}

void UniswapV2_MintV2DTO::unsetBlock_number()
{
    m_Block_numberIsSet = false;
}
utility::string_t UniswapV2_MintV2DTO::getId() const
{
    return m_Id;
}

void UniswapV2_MintV2DTO::setId(const utility::string_t& value)
{
    m_Id = value;
    m_IdIsSet = true;
}

bool UniswapV2_MintV2DTO::idIsSet() const
{
    return m_IdIsSet;
}

void UniswapV2_MintV2DTO::unsetId()
{
    m_IdIsSet = false;
}
utility::string_t UniswapV2_MintV2DTO::getTransaction() const
{
    return m_Transaction;
}

void UniswapV2_MintV2DTO::setTransaction(const utility::string_t& value)
{
    m_Transaction = value;
    m_TransactionIsSet = true;
}

bool UniswapV2_MintV2DTO::transactionIsSet() const
{
    return m_TransactionIsSet;
}

void UniswapV2_MintV2DTO::unsetTransaction()
{
    m_TransactionIsSet = false;
}
utility::string_t UniswapV2_MintV2DTO::getTimestamp() const
{
    return m_Timestamp;
}

void UniswapV2_MintV2DTO::setTimestamp(const utility::string_t& value)
{
    m_Timestamp = value;
    m_TimestampIsSet = true;
}

bool UniswapV2_MintV2DTO::timestampIsSet() const
{
    return m_TimestampIsSet;
}

void UniswapV2_MintV2DTO::unsetTimestamp()
{
    m_TimestampIsSet = false;
}
utility::string_t UniswapV2_MintV2DTO::getPair() const
{
    return m_Pair;
}

void UniswapV2_MintV2DTO::setPair(const utility::string_t& value)
{
    m_Pair = value;
    m_PairIsSet = true;
}

bool UniswapV2_MintV2DTO::pairIsSet() const
{
    return m_PairIsSet;
}

void UniswapV2_MintV2DTO::unsetPair()
{
    m_PairIsSet = false;
}
utility::string_t UniswapV2_MintV2DTO::getTo() const
{
    return m_To;
}

void UniswapV2_MintV2DTO::setTo(const utility::string_t& value)
{
    m_To = value;
    m_ToIsSet = true;
}

bool UniswapV2_MintV2DTO::toIsSet() const
{
    return m_ToIsSet;
}

void UniswapV2_MintV2DTO::unsetTo()
{
    m_ToIsSet = false;
}
utility::string_t UniswapV2_MintV2DTO::getLiquidity() const
{
    return m_Liquidity;
}

void UniswapV2_MintV2DTO::setLiquidity(const utility::string_t& value)
{
    m_Liquidity = value;
    m_LiquidityIsSet = true;
}

bool UniswapV2_MintV2DTO::liquidityIsSet() const
{
    return m_LiquidityIsSet;
}

void UniswapV2_MintV2DTO::unsetLiquidity()
{
    m_LiquidityIsSet = false;
}
utility::string_t UniswapV2_MintV2DTO::getSender() const
{
    return m_Sender;
}

void UniswapV2_MintV2DTO::setSender(const utility::string_t& value)
{
    m_Sender = value;
    m_SenderIsSet = true;
}

bool UniswapV2_MintV2DTO::senderIsSet() const
{
    return m_SenderIsSet;
}

void UniswapV2_MintV2DTO::unsetSender()
{
    m_SenderIsSet = false;
}
utility::string_t UniswapV2_MintV2DTO::getAmount0() const
{
    return m_Amount_0;
}

void UniswapV2_MintV2DTO::setAmount0(const utility::string_t& value)
{
    m_Amount_0 = value;
    m_Amount_0IsSet = true;
}

bool UniswapV2_MintV2DTO::amount0IsSet() const
{
    return m_Amount_0IsSet;
}

void UniswapV2_MintV2DTO::unsetAmount_0()
{
    m_Amount_0IsSet = false;
}
utility::string_t UniswapV2_MintV2DTO::getAmount1() const
{
    return m_Amount_1;
}

void UniswapV2_MintV2DTO::setAmount1(const utility::string_t& value)
{
    m_Amount_1 = value;
    m_Amount_1IsSet = true;
}

bool UniswapV2_MintV2DTO::amount1IsSet() const
{
    return m_Amount_1IsSet;
}

void UniswapV2_MintV2DTO::unsetAmount_1()
{
    m_Amount_1IsSet = false;
}
utility::string_t UniswapV2_MintV2DTO::getLogIndex() const
{
    return m_Log_index;
}

void UniswapV2_MintV2DTO::setLogIndex(const utility::string_t& value)
{
    m_Log_index = value;
    m_Log_indexIsSet = true;
}

bool UniswapV2_MintV2DTO::logIndexIsSet() const
{
    return m_Log_indexIsSet;
}

void UniswapV2_MintV2DTO::unsetLog_index()
{
    m_Log_indexIsSet = false;
}
utility::string_t UniswapV2_MintV2DTO::getAmountUsd() const
{
    return m_Amount_usd;
}

void UniswapV2_MintV2DTO::setAmountUsd(const utility::string_t& value)
{
    m_Amount_usd = value;
    m_Amount_usdIsSet = true;
}

bool UniswapV2_MintV2DTO::amountUsdIsSet() const
{
    return m_Amount_usdIsSet;
}

void UniswapV2_MintV2DTO::unsetAmount_usd()
{
    m_Amount_usdIsSet = false;
}
utility::string_t UniswapV2_MintV2DTO::getFeeTo() const
{
    return m_Fee_to;
}

void UniswapV2_MintV2DTO::setFeeTo(const utility::string_t& value)
{
    m_Fee_to = value;
    m_Fee_toIsSet = true;
}

bool UniswapV2_MintV2DTO::feeToIsSet() const
{
    return m_Fee_toIsSet;
}

void UniswapV2_MintV2DTO::unsetFee_to()
{
    m_Fee_toIsSet = false;
}
utility::string_t UniswapV2_MintV2DTO::getFeeLiquidity() const
{
    return m_Fee_liquidity;
}

void UniswapV2_MintV2DTO::setFeeLiquidity(const utility::string_t& value)
{
    m_Fee_liquidity = value;
    m_Fee_liquidityIsSet = true;
}

bool UniswapV2_MintV2DTO::feeLiquidityIsSet() const
{
    return m_Fee_liquidityIsSet;
}

void UniswapV2_MintV2DTO::unsetFee_liquidity()
{
    m_Fee_liquidityIsSet = false;
}
int64_t UniswapV2_MintV2DTO::getVid() const
{
    return m_Vid;
}

void UniswapV2_MintV2DTO::setVid(int64_t value)
{
    m_Vid = value;
    m_VidIsSet = true;
}

bool UniswapV2_MintV2DTO::vidIsSet() const
{
    return m_VidIsSet;
}

void UniswapV2_MintV2DTO::unsetVid()
{
    m_VidIsSet = false;
}
utility::string_t UniswapV2_MintV2DTO::getBlockRange() const
{
    return m_Block_range;
}

void UniswapV2_MintV2DTO::setBlockRange(const utility::string_t& value)
{
    m_Block_range = value;
    m_Block_rangeIsSet = true;
}

bool UniswapV2_MintV2DTO::blockRangeIsSet() const
{
    return m_Block_rangeIsSet;
}

void UniswapV2_MintV2DTO::unsetBlock_range()
{
    m_Block_rangeIsSet = false;
}
}
