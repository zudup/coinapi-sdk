...
UniswapV2_LiquidityPositionSnapshotV2DTO::UniswapV2_LiquidityPositionSnapshotV2DTO()
{
...
void UniswapV2_LiquidityPositionSnapshotV2DTO::validate()
{
    // TODO: implement validation
}

web::json::value UniswapV2_LiquidityPositionSnapshotV2DTO::toJson() const
{
...
bool UniswapV2_LiquidityPositionSnapshotV2DTO::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void UniswapV2_LiquidityPositionSnapshotV2DTO::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool UniswapV2_LiquidityPositionSnapshotV2DTO::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
utility::datetime UniswapV2_LiquidityPositionSnapshotV2DTO::getEntryTime() const
{
    return m_Entry_time;
}

void UniswapV2_LiquidityPositionSnapshotV2DTO::setEntryTime(const utility::datetime& value)
{
    m_Entry_time = value;
    m_Entry_timeIsSet = true;
}

bool UniswapV2_LiquidityPositionSnapshotV2DTO::entryTimeIsSet() const
{
    return m_Entry_timeIsSet;
}

void UniswapV2_LiquidityPositionSnapshotV2DTO::unsetEntry_time()
{
    m_Entry_timeIsSet = false;
}
utility::datetime UniswapV2_LiquidityPositionSnapshotV2DTO::getRecvTime() const
{
    return m_Recv_time;
}

void UniswapV2_LiquidityPositionSnapshotV2DTO::setRecvTime(const utility::datetime& value)
{
    m_Recv_time = value;
    m_Recv_timeIsSet = true;
}

bool UniswapV2_LiquidityPositionSnapshotV2DTO::recvTimeIsSet() const
{
    return m_Recv_timeIsSet;
}

void UniswapV2_LiquidityPositionSnapshotV2DTO::unsetRecv_time()
{
    m_Recv_timeIsSet = false;
}
int64_t UniswapV2_LiquidityPositionSnapshotV2DTO::getBlockNumber() const
{
    return m_Block_number;
}

void UniswapV2_LiquidityPositionSnapshotV2DTO::setBlockNumber(int64_t value)
{
    m_Block_number = value;
    m_Block_numberIsSet = true;
}

bool UniswapV2_LiquidityPositionSnapshotV2DTO::blockNumberIsSet() const
{
    return m_Block_numberIsSet;
}

void UniswapV2_LiquidityPositionSnapshotV2DTO::unsetBlock_number()
{
    m_Block_numberIsSet = false;
}
utility::string_t UniswapV2_LiquidityPositionSnapshotV2DTO::getId() const
{
    return m_Id;
}

void UniswapV2_LiquidityPositionSnapshotV2DTO::setId(const utility::string_t& value)
{
    m_Id = value;
    m_IdIsSet = true;
}

bool UniswapV2_LiquidityPositionSnapshotV2DTO::idIsSet() const
{
    return m_IdIsSet;
}

void UniswapV2_LiquidityPositionSnapshotV2DTO::unsetId()
{
    m_IdIsSet = false;
}
utility::string_t UniswapV2_LiquidityPositionSnapshotV2DTO::getLiquidityPosition() const
{
    return m_Liquidity_position;
}

void UniswapV2_LiquidityPositionSnapshotV2DTO::setLiquidityPosition(const utility::string_t& value)
{
    m_Liquidity_position = value;
    m_Liquidity_positionIsSet = true;
}

bool UniswapV2_LiquidityPositionSnapshotV2DTO::liquidityPositionIsSet() const
{
    return m_Liquidity_positionIsSet;
}

void UniswapV2_LiquidityPositionSnapshotV2DTO::unsetLiquidity_position()
{
    m_Liquidity_positionIsSet = false;
}
int32_t UniswapV2_LiquidityPositionSnapshotV2DTO::getTimestamp() const
{
    return m_Timestamp;
}

void UniswapV2_LiquidityPositionSnapshotV2DTO::setTimestamp(int32_t value)
{
    m_Timestamp = value;
    m_TimestampIsSet = true;
}

bool UniswapV2_LiquidityPositionSnapshotV2DTO::timestampIsSet() const
{
    return m_TimestampIsSet;
}

void UniswapV2_LiquidityPositionSnapshotV2DTO::unsetTimestamp()
{
    m_TimestampIsSet = false;
}
int32_t UniswapV2_LiquidityPositionSnapshotV2DTO::getBlock() const
{
    return m_Block;
}

void UniswapV2_LiquidityPositionSnapshotV2DTO::setBlock(int32_t value)
{
    m_Block = value;
    m_BlockIsSet = true;
}

bool UniswapV2_LiquidityPositionSnapshotV2DTO::blockIsSet() const
{
    return m_BlockIsSet;
}

void UniswapV2_LiquidityPositionSnapshotV2DTO::unsetBlock()
{
    m_BlockIsSet = false;
}
utility::string_t UniswapV2_LiquidityPositionSnapshotV2DTO::getUser() const
{
    return m_User;
}

void UniswapV2_LiquidityPositionSnapshotV2DTO::setUser(const utility::string_t& value)
{
    m_User = value;
    m_UserIsSet = true;
}

bool UniswapV2_LiquidityPositionSnapshotV2DTO::userIsSet() const
{
    return m_UserIsSet;
}

void UniswapV2_LiquidityPositionSnapshotV2DTO::unsetUser()
{
    m_UserIsSet = false;
}
utility::string_t UniswapV2_LiquidityPositionSnapshotV2DTO::getPair() const
{
    return m_Pair;
}

void UniswapV2_LiquidityPositionSnapshotV2DTO::setPair(const utility::string_t& value)
{
    m_Pair = value;
    m_PairIsSet = true;
}

bool UniswapV2_LiquidityPositionSnapshotV2DTO::pairIsSet() const
{
    return m_PairIsSet;
}

void UniswapV2_LiquidityPositionSnapshotV2DTO::unsetPair()
{
    m_PairIsSet = false;
}
utility::string_t UniswapV2_LiquidityPositionSnapshotV2DTO::getToken0PriceUsd() const
{
    return m_Token_0_price_usd;
}

void UniswapV2_LiquidityPositionSnapshotV2DTO::setToken0PriceUsd(const utility::string_t& value)
{
    m_Token_0_price_usd = value;
    m_Token_0_price_usdIsSet = true;
}

bool UniswapV2_LiquidityPositionSnapshotV2DTO::token0PriceUsdIsSet() const
{
    return m_Token_0_price_usdIsSet;
}

void UniswapV2_LiquidityPositionSnapshotV2DTO::unsetToken_0_price_usd()
{
    m_Token_0_price_usdIsSet = false;
}
utility::string_t UniswapV2_LiquidityPositionSnapshotV2DTO::getToken1PriceUsd() const
{
    return m_Token_1_price_usd;
}

void UniswapV2_LiquidityPositionSnapshotV2DTO::setToken1PriceUsd(const utility::string_t& value)
{
    m_Token_1_price_usd = value;
    m_Token_1_price_usdIsSet = true;
}

bool UniswapV2_LiquidityPositionSnapshotV2DTO::token1PriceUsdIsSet() const
{
    return m_Token_1_price_usdIsSet;
}

void UniswapV2_LiquidityPositionSnapshotV2DTO::unsetToken_1_price_usd()
{
    m_Token_1_price_usdIsSet = false;
}
utility::string_t UniswapV2_LiquidityPositionSnapshotV2DTO::getReserve0() const
{
    return m_Reserve_0;
}

void UniswapV2_LiquidityPositionSnapshotV2DTO::setReserve0(const utility::string_t& value)
{
    m_Reserve_0 = value;
    m_Reserve_0IsSet = true;
}

bool UniswapV2_LiquidityPositionSnapshotV2DTO::reserve0IsSet() const
{
    return m_Reserve_0IsSet;
}

void UniswapV2_LiquidityPositionSnapshotV2DTO::unsetReserve_0()
{
    m_Reserve_0IsSet = false;
}
utility::string_t UniswapV2_LiquidityPositionSnapshotV2DTO::getReserve1() const
{
    return m_Reserve_1;
}

void UniswapV2_LiquidityPositionSnapshotV2DTO::setReserve1(const utility::string_t& value)
{
    m_Reserve_1 = value;
    m_Reserve_1IsSet = true;
}

bool UniswapV2_LiquidityPositionSnapshotV2DTO::reserve1IsSet() const
{
    return m_Reserve_1IsSet;
}

void UniswapV2_LiquidityPositionSnapshotV2DTO::unsetReserve_1()
{
    m_Reserve_1IsSet = false;
}
utility::string_t UniswapV2_LiquidityPositionSnapshotV2DTO::getReserveUsd() const
{
    return m_Reserve_usd;
}

void UniswapV2_LiquidityPositionSnapshotV2DTO::setReserveUsd(const utility::string_t& value)
{
    m_Reserve_usd = value;
    m_Reserve_usdIsSet = true;
}

bool UniswapV2_LiquidityPositionSnapshotV2DTO::reserveUsdIsSet() const
{
    return m_Reserve_usdIsSet;
}

void UniswapV2_LiquidityPositionSnapshotV2DTO::unsetReserve_usd()
{
    m_Reserve_usdIsSet = false;
}
utility::string_t UniswapV2_LiquidityPositionSnapshotV2DTO::getLiquidityTokenTotalSupply() const
{
    return m_Liquidity_token_total_supply;
}

void UniswapV2_LiquidityPositionSnapshotV2DTO::setLiquidityTokenTotalSupply(const utility::string_t& value)
{
    m_Liquidity_token_total_supply = value;
    m_Liquidity_token_total_supplyIsSet = true;
}

bool UniswapV2_LiquidityPositionSnapshotV2DTO::liquidityTokenTotalSupplyIsSet() const
{
    return m_Liquidity_token_total_supplyIsSet;
}

void UniswapV2_LiquidityPositionSnapshotV2DTO::unsetLiquidity_token_total_supply()
{
    m_Liquidity_token_total_supplyIsSet = false;
}
utility::string_t UniswapV2_LiquidityPositionSnapshotV2DTO::getLiquidityTokenBalance() const
{
    return m_Liquidity_token_balance;
}

void UniswapV2_LiquidityPositionSnapshotV2DTO::setLiquidityTokenBalance(const utility::string_t& value)
{
    m_Liquidity_token_balance = value;
    m_Liquidity_token_balanceIsSet = true;
}

bool UniswapV2_LiquidityPositionSnapshotV2DTO::liquidityTokenBalanceIsSet() const
{
    return m_Liquidity_token_balanceIsSet;
}

void UniswapV2_LiquidityPositionSnapshotV2DTO::unsetLiquidity_token_balance()
{
    m_Liquidity_token_balanceIsSet = false;
}
int64_t UniswapV2_LiquidityPositionSnapshotV2DTO::getVid() const
{
    return m_Vid;
}

void UniswapV2_LiquidityPositionSnapshotV2DTO::setVid(int64_t value)
{
    m_Vid = value;
    m_VidIsSet = true;
}

bool UniswapV2_LiquidityPositionSnapshotV2DTO::vidIsSet() const
{
    return m_VidIsSet;
}

void UniswapV2_LiquidityPositionSnapshotV2DTO::unsetVid()
{
    m_VidIsSet = false;
}
utility::string_t UniswapV2_LiquidityPositionSnapshotV2DTO::getBlockRange() const
{
    return m_Block_range;
}

void UniswapV2_LiquidityPositionSnapshotV2DTO::setBlockRange(const utility::string_t& value)
{
    m_Block_range = value;
    m_Block_rangeIsSet = true;
}

bool UniswapV2_LiquidityPositionSnapshotV2DTO::blockRangeIsSet() const
{
    return m_Block_rangeIsSet;
}

void UniswapV2_LiquidityPositionSnapshotV2DTO::unsetBlock_range()
{
    m_Block_rangeIsSet = false;
}
}
