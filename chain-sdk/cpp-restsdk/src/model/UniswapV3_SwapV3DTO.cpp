...
UniswapV3_SwapV3DTO::UniswapV3_SwapV3DTO()
{
...
void UniswapV3_SwapV3DTO::validate()
{
    // TODO: implement validation
}

web::json::value UniswapV3_SwapV3DTO::toJson() const
{
...
bool UniswapV3_SwapV3DTO::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void UniswapV3_SwapV3DTO::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool UniswapV3_SwapV3DTO::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
utility::datetime UniswapV3_SwapV3DTO::getEntryTime() const
{
    return m_Entry_time;
}

void UniswapV3_SwapV3DTO::setEntryTime(const utility::datetime& value)
{
    m_Entry_time = value;
    m_Entry_timeIsSet = true;
}

bool UniswapV3_SwapV3DTO::entryTimeIsSet() const
{
    return m_Entry_timeIsSet;
}

void UniswapV3_SwapV3DTO::unsetEntry_time()
{
    m_Entry_timeIsSet = false;
}
utility::datetime UniswapV3_SwapV3DTO::getRecvTime() const
{
    return m_Recv_time;
}

void UniswapV3_SwapV3DTO::setRecvTime(const utility::datetime& value)
{
    m_Recv_time = value;
    m_Recv_timeIsSet = true;
}

bool UniswapV3_SwapV3DTO::recvTimeIsSet() const
{
    return m_Recv_timeIsSet;
}

void UniswapV3_SwapV3DTO::unsetRecv_time()
{
    m_Recv_timeIsSet = false;
}
int64_t UniswapV3_SwapV3DTO::getBlockNumber() const
{
    return m_Block_number;
}

void UniswapV3_SwapV3DTO::setBlockNumber(int64_t value)
{
    m_Block_number = value;
    m_Block_numberIsSet = true;
}

bool UniswapV3_SwapV3DTO::blockNumberIsSet() const
{
    return m_Block_numberIsSet;
}

void UniswapV3_SwapV3DTO::unsetBlock_number()
{
    m_Block_numberIsSet = false;
}
int64_t UniswapV3_SwapV3DTO::getVid() const
{
    return m_Vid;
}

void UniswapV3_SwapV3DTO::setVid(int64_t value)
{
    m_Vid = value;
    m_VidIsSet = true;
}

bool UniswapV3_SwapV3DTO::vidIsSet() const
{
    return m_VidIsSet;
}

void UniswapV3_SwapV3DTO::unsetVid()
{
    m_VidIsSet = false;
}
utility::string_t UniswapV3_SwapV3DTO::getId() const
{
    return m_Id;
}

void UniswapV3_SwapV3DTO::setId(const utility::string_t& value)
{
    m_Id = value;
    m_IdIsSet = true;
}

bool UniswapV3_SwapV3DTO::idIsSet() const
{
    return m_IdIsSet;
}

void UniswapV3_SwapV3DTO::unsetId()
{
    m_IdIsSet = false;
}
utility::string_t UniswapV3_SwapV3DTO::getTransaction() const
{
    return m_Transaction;
}

void UniswapV3_SwapV3DTO::setTransaction(const utility::string_t& value)
{
    m_Transaction = value;
    m_TransactionIsSet = true;
}

bool UniswapV3_SwapV3DTO::transactionIsSet() const
{
    return m_TransactionIsSet;
}

void UniswapV3_SwapV3DTO::unsetTransaction()
{
    m_TransactionIsSet = false;
}
utility::datetime UniswapV3_SwapV3DTO::getTimestamp() const
{
    return m_Timestamp;
}

void UniswapV3_SwapV3DTO::setTimestamp(const utility::datetime& value)
{
    m_Timestamp = value;
    m_TimestampIsSet = true;
}

bool UniswapV3_SwapV3DTO::timestampIsSet() const
{
    return m_TimestampIsSet;
}

void UniswapV3_SwapV3DTO::unsetTimestamp()
{
    m_TimestampIsSet = false;
}
utility::string_t UniswapV3_SwapV3DTO::getPool() const
{
    return m_Pool;
}

void UniswapV3_SwapV3DTO::setPool(const utility::string_t& value)
{
    m_Pool = value;
    m_PoolIsSet = true;
}

bool UniswapV3_SwapV3DTO::poolIsSet() const
{
    return m_PoolIsSet;
}

void UniswapV3_SwapV3DTO::unsetPool()
{
    m_PoolIsSet = false;
}
utility::string_t UniswapV3_SwapV3DTO::getToken0() const
{
    return m_Token_0;
}

void UniswapV3_SwapV3DTO::setToken0(const utility::string_t& value)
{
    m_Token_0 = value;
    m_Token_0IsSet = true;
}

bool UniswapV3_SwapV3DTO::token0IsSet() const
{
    return m_Token_0IsSet;
}

void UniswapV3_SwapV3DTO::unsetToken_0()
{
    m_Token_0IsSet = false;
}
utility::string_t UniswapV3_SwapV3DTO::getToken1() const
{
    return m_Token_1;
}

void UniswapV3_SwapV3DTO::setToken1(const utility::string_t& value)
{
    m_Token_1 = value;
    m_Token_1IsSet = true;
}

bool UniswapV3_SwapV3DTO::token1IsSet() const
{
    return m_Token_1IsSet;
}

void UniswapV3_SwapV3DTO::unsetToken_1()
{
    m_Token_1IsSet = false;
}
utility::string_t UniswapV3_SwapV3DTO::getSender() const
{
    return m_Sender;
}

void UniswapV3_SwapV3DTO::setSender(const utility::string_t& value)
{
    m_Sender = value;
    m_SenderIsSet = true;
}

bool UniswapV3_SwapV3DTO::senderIsSet() const
{
    return m_SenderIsSet;
}

void UniswapV3_SwapV3DTO::unsetSender()
{
    m_SenderIsSet = false;
}
utility::string_t UniswapV3_SwapV3DTO::getRecipient() const
{
    return m_Recipient;
}

void UniswapV3_SwapV3DTO::setRecipient(const utility::string_t& value)
{
    m_Recipient = value;
    m_RecipientIsSet = true;
}

bool UniswapV3_SwapV3DTO::recipientIsSet() const
{
    return m_RecipientIsSet;
}

void UniswapV3_SwapV3DTO::unsetRecipient()
{
    m_RecipientIsSet = false;
}
utility::string_t UniswapV3_SwapV3DTO::getOrigin() const
{
    return m_Origin;
}

void UniswapV3_SwapV3DTO::setOrigin(const utility::string_t& value)
{
    m_Origin = value;
    m_OriginIsSet = true;
}

bool UniswapV3_SwapV3DTO::originIsSet() const
{
    return m_OriginIsSet;
}

void UniswapV3_SwapV3DTO::unsetOrigin()
{
    m_OriginIsSet = false;
}
utility::string_t UniswapV3_SwapV3DTO::getAmount0() const
{
    return m_Amount_0;
}

void UniswapV3_SwapV3DTO::setAmount0(const utility::string_t& value)
{
    m_Amount_0 = value;
    m_Amount_0IsSet = true;
}

bool UniswapV3_SwapV3DTO::amount0IsSet() const
{
    return m_Amount_0IsSet;
}

void UniswapV3_SwapV3DTO::unsetAmount_0()
{
    m_Amount_0IsSet = false;
}
utility::string_t UniswapV3_SwapV3DTO::getAmount1() const
{
    return m_Amount_1;
}

void UniswapV3_SwapV3DTO::setAmount1(const utility::string_t& value)
{
    m_Amount_1 = value;
    m_Amount_1IsSet = true;
}

bool UniswapV3_SwapV3DTO::amount1IsSet() const
{
    return m_Amount_1IsSet;
}

void UniswapV3_SwapV3DTO::unsetAmount_1()
{
    m_Amount_1IsSet = false;
}
utility::string_t UniswapV3_SwapV3DTO::getAmountUsd() const
{
    return m_Amount_usd;
}

void UniswapV3_SwapV3DTO::setAmountUsd(const utility::string_t& value)
{
    m_Amount_usd = value;
    m_Amount_usdIsSet = true;
}

bool UniswapV3_SwapV3DTO::amountUsdIsSet() const
{
    return m_Amount_usdIsSet;
}

void UniswapV3_SwapV3DTO::unsetAmount_usd()
{
    m_Amount_usdIsSet = false;
}
std::shared_ptr<Numerics_BigInteger> UniswapV3_SwapV3DTO::getSqrtPriceX96() const
{
    return m_Sqrt_price_x96;
}

void UniswapV3_SwapV3DTO::setSqrtPriceX96(const std::shared_ptr<Numerics_BigInteger>& value)
{
    m_Sqrt_price_x96 = value;
    m_Sqrt_price_x96IsSet = true;
}

bool UniswapV3_SwapV3DTO::sqrtPriceX96IsSet() const
{
    return m_Sqrt_price_x96IsSet;
}

void UniswapV3_SwapV3DTO::unsetSqrt_price_x96()
{
    m_Sqrt_price_x96IsSet = false;
}
std::shared_ptr<Numerics_BigInteger> UniswapV3_SwapV3DTO::getTick() const
{
    return m_Tick;
}

void UniswapV3_SwapV3DTO::setTick(const std::shared_ptr<Numerics_BigInteger>& value)
{
    m_Tick = value;
    m_TickIsSet = true;
}

bool UniswapV3_SwapV3DTO::tickIsSet() const
{
    return m_TickIsSet;
}

void UniswapV3_SwapV3DTO::unsetTick()
{
    m_TickIsSet = false;
}
std::shared_ptr<Numerics_BigInteger> UniswapV3_SwapV3DTO::getLogIndex() const
{
    return m_Log_index;
}

void UniswapV3_SwapV3DTO::setLogIndex(const std::shared_ptr<Numerics_BigInteger>& value)
{
    m_Log_index = value;
    m_Log_indexIsSet = true;
}

bool UniswapV3_SwapV3DTO::logIndexIsSet() const
{
    return m_Log_indexIsSet;
}

void UniswapV3_SwapV3DTO::unsetLog_index()
{
    m_Log_indexIsSet = false;
}
double UniswapV3_SwapV3DTO::getEvaluatedPrice() const
{
    return m_Evaluated_price;
}

void UniswapV3_SwapV3DTO::setEvaluatedPrice(double value)
{
    m_Evaluated_price = value;
    m_Evaluated_priceIsSet = true;
}

bool UniswapV3_SwapV3DTO::evaluatedPriceIsSet() const
{
    return m_Evaluated_priceIsSet;
}

void UniswapV3_SwapV3DTO::unsetEvaluated_price()
{
    m_Evaluated_priceIsSet = false;
}
double UniswapV3_SwapV3DTO::getEvaluatedAmount() const
{
    return m_Evaluated_amount;
}

void UniswapV3_SwapV3DTO::setEvaluatedAmount(double value)
{
    m_Evaluated_amount = value;
    m_Evaluated_amountIsSet = true;
}

bool UniswapV3_SwapV3DTO::evaluatedAmountIsSet() const
{
    return m_Evaluated_amountIsSet;
}

void UniswapV3_SwapV3DTO::unsetEvaluated_amount()
{
    m_Evaluated_amountIsSet = false;
}
std::shared_ptr<Transactions_ETradeAggressiveSide> UniswapV3_SwapV3DTO::getEvaluatedAggressor() const
{
    return m_Evaluated_aggressor;
}

void UniswapV3_SwapV3DTO::setEvaluatedAggressor(const std::shared_ptr<Transactions_ETradeAggressiveSide>& value)
{
    m_Evaluated_aggressor = value;
    m_Evaluated_aggressorIsSet = true;
}

bool UniswapV3_SwapV3DTO::evaluatedAggressorIsSet() const
{
    return m_Evaluated_aggressorIsSet;
}

void UniswapV3_SwapV3DTO::unsetEvaluated_aggressor()
{
    m_Evaluated_aggressorIsSet = false;
}
utility::string_t UniswapV3_SwapV3DTO::getPoolId() const
{
    return m_Pool_id;
}

void UniswapV3_SwapV3DTO::setPoolId(const utility::string_t& value)
{
    m_Pool_id = value;
    m_Pool_idIsSet = true;
}

bool UniswapV3_SwapV3DTO::poolIdIsSet() const
{
    return m_Pool_idIsSet;
}

void UniswapV3_SwapV3DTO::unsetPool_id()
{
    m_Pool_idIsSet = false;
}
utility::string_t UniswapV3_SwapV3DTO::getTransactionId() const
{
    return m_Transaction_id;
}

void UniswapV3_SwapV3DTO::setTransactionId(const utility::string_t& value)
{
    m_Transaction_id = value;
    m_Transaction_idIsSet = true;
}

bool UniswapV3_SwapV3DTO::transactionIdIsSet() const
{
    return m_Transaction_idIsSet;
}

void UniswapV3_SwapV3DTO::unsetTransaction_id()
{
    m_Transaction_idIsSet = false;
}
}
