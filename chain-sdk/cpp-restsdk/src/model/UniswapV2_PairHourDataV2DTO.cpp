...
UniswapV2_PairHourDataV2DTO::UniswapV2_PairHourDataV2DTO()
{
...
void UniswapV2_PairHourDataV2DTO::validate()
{
    // TODO: implement validation
}

web::json::value UniswapV2_PairHourDataV2DTO::toJson() const
{
...
bool UniswapV2_PairHourDataV2DTO::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void UniswapV2_PairHourDataV2DTO::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool UniswapV2_PairHourDataV2DTO::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
utility::datetime UniswapV2_PairHourDataV2DTO::getEntryTime() const
{
    return m_Entry_time;
}

void UniswapV2_PairHourDataV2DTO::setEntryTime(const utility::datetime& value)
{
    m_Entry_time = value;
    m_Entry_timeIsSet = true;
}

bool UniswapV2_PairHourDataV2DTO::entryTimeIsSet() const
{
    return m_Entry_timeIsSet;
}

void UniswapV2_PairHourDataV2DTO::unsetEntry_time()
{
    m_Entry_timeIsSet = false;
}
utility::datetime UniswapV2_PairHourDataV2DTO::getRecvTime() const
{
    return m_Recv_time;
}

void UniswapV2_PairHourDataV2DTO::setRecvTime(const utility::datetime& value)
{
    m_Recv_time = value;
    m_Recv_timeIsSet = true;
}

bool UniswapV2_PairHourDataV2DTO::recvTimeIsSet() const
{
    return m_Recv_timeIsSet;
}

void UniswapV2_PairHourDataV2DTO::unsetRecv_time()
{
    m_Recv_timeIsSet = false;
}
int64_t UniswapV2_PairHourDataV2DTO::getBlockNumber() const
{
    return m_Block_number;
}

void UniswapV2_PairHourDataV2DTO::setBlockNumber(int64_t value)
{
    m_Block_number = value;
    m_Block_numberIsSet = true;
}

bool UniswapV2_PairHourDataV2DTO::blockNumberIsSet() const
{
    return m_Block_numberIsSet;
}

void UniswapV2_PairHourDataV2DTO::unsetBlock_number()
{
    m_Block_numberIsSet = false;
}
utility::string_t UniswapV2_PairHourDataV2DTO::getId() const
{
    return m_Id;
}

void UniswapV2_PairHourDataV2DTO::setId(const utility::string_t& value)
{
    m_Id = value;
    m_IdIsSet = true;
}

bool UniswapV2_PairHourDataV2DTO::idIsSet() const
{
    return m_IdIsSet;
}

void UniswapV2_PairHourDataV2DTO::unsetId()
{
    m_IdIsSet = false;
}
int32_t UniswapV2_PairHourDataV2DTO::getHourStartUnix() const
{
    return m_Hour_start_unix;
}

void UniswapV2_PairHourDataV2DTO::setHourStartUnix(int32_t value)
{
    m_Hour_start_unix = value;
    m_Hour_start_unixIsSet = true;
}

bool UniswapV2_PairHourDataV2DTO::hourStartUnixIsSet() const
{
    return m_Hour_start_unixIsSet;
}

void UniswapV2_PairHourDataV2DTO::unsetHour_start_unix()
{
    m_Hour_start_unixIsSet = false;
}
utility::string_t UniswapV2_PairHourDataV2DTO::getPair() const
{
    return m_Pair;
}

void UniswapV2_PairHourDataV2DTO::setPair(const utility::string_t& value)
{
    m_Pair = value;
    m_PairIsSet = true;
}

bool UniswapV2_PairHourDataV2DTO::pairIsSet() const
{
    return m_PairIsSet;
}

void UniswapV2_PairHourDataV2DTO::unsetPair()
{
    m_PairIsSet = false;
}
utility::string_t UniswapV2_PairHourDataV2DTO::getReserve0() const
{
    return m_Reserve_0;
}

void UniswapV2_PairHourDataV2DTO::setReserve0(const utility::string_t& value)
{
    m_Reserve_0 = value;
    m_Reserve_0IsSet = true;
}

bool UniswapV2_PairHourDataV2DTO::reserve0IsSet() const
{
    return m_Reserve_0IsSet;
}

void UniswapV2_PairHourDataV2DTO::unsetReserve_0()
{
    m_Reserve_0IsSet = false;
}
utility::string_t UniswapV2_PairHourDataV2DTO::getReserve1() const
{
    return m_Reserve_1;
}

void UniswapV2_PairHourDataV2DTO::setReserve1(const utility::string_t& value)
{
    m_Reserve_1 = value;
    m_Reserve_1IsSet = true;
}

bool UniswapV2_PairHourDataV2DTO::reserve1IsSet() const
{
    return m_Reserve_1IsSet;
}

void UniswapV2_PairHourDataV2DTO::unsetReserve_1()
{
    m_Reserve_1IsSet = false;
}
utility::string_t UniswapV2_PairHourDataV2DTO::getTotalSupply() const
{
    return m_Total_supply;
}

void UniswapV2_PairHourDataV2DTO::setTotalSupply(const utility::string_t& value)
{
    m_Total_supply = value;
    m_Total_supplyIsSet = true;
}

bool UniswapV2_PairHourDataV2DTO::totalSupplyIsSet() const
{
    return m_Total_supplyIsSet;
}

void UniswapV2_PairHourDataV2DTO::unsetTotal_supply()
{
    m_Total_supplyIsSet = false;
}
utility::string_t UniswapV2_PairHourDataV2DTO::getReserveUsd() const
{
    return m_Reserve_usd;
}

void UniswapV2_PairHourDataV2DTO::setReserveUsd(const utility::string_t& value)
{
    m_Reserve_usd = value;
    m_Reserve_usdIsSet = true;
}

bool UniswapV2_PairHourDataV2DTO::reserveUsdIsSet() const
{
    return m_Reserve_usdIsSet;
}

void UniswapV2_PairHourDataV2DTO::unsetReserve_usd()
{
    m_Reserve_usdIsSet = false;
}
utility::string_t UniswapV2_PairHourDataV2DTO::getHourlyVolumeToken0() const
{
    return m_Hourly_volume_token_0;
}

void UniswapV2_PairHourDataV2DTO::setHourlyVolumeToken0(const utility::string_t& value)
{
    m_Hourly_volume_token_0 = value;
    m_Hourly_volume_token_0IsSet = true;
}

bool UniswapV2_PairHourDataV2DTO::hourlyVolumeToken0IsSet() const
{
    return m_Hourly_volume_token_0IsSet;
}

void UniswapV2_PairHourDataV2DTO::unsetHourly_volume_token_0()
{
    m_Hourly_volume_token_0IsSet = false;
}
utility::string_t UniswapV2_PairHourDataV2DTO::getHourlyVolumeToken1() const
{
    return m_Hourly_volume_token_1;
}

void UniswapV2_PairHourDataV2DTO::setHourlyVolumeToken1(const utility::string_t& value)
{
    m_Hourly_volume_token_1 = value;
    m_Hourly_volume_token_1IsSet = true;
}

bool UniswapV2_PairHourDataV2DTO::hourlyVolumeToken1IsSet() const
{
    return m_Hourly_volume_token_1IsSet;
}

void UniswapV2_PairHourDataV2DTO::unsetHourly_volume_token_1()
{
    m_Hourly_volume_token_1IsSet = false;
}
utility::string_t UniswapV2_PairHourDataV2DTO::getHourlyVolumeUsd() const
{
    return m_Hourly_volume_usd;
}

void UniswapV2_PairHourDataV2DTO::setHourlyVolumeUsd(const utility::string_t& value)
{
    m_Hourly_volume_usd = value;
    m_Hourly_volume_usdIsSet = true;
}

bool UniswapV2_PairHourDataV2DTO::hourlyVolumeUsdIsSet() const
{
    return m_Hourly_volume_usdIsSet;
}

void UniswapV2_PairHourDataV2DTO::unsetHourly_volume_usd()
{
    m_Hourly_volume_usdIsSet = false;
}
utility::string_t UniswapV2_PairHourDataV2DTO::getHourlyTxns() const
{
    return m_Hourly_txns;
}

void UniswapV2_PairHourDataV2DTO::setHourlyTxns(const utility::string_t& value)
{
    m_Hourly_txns = value;
    m_Hourly_txnsIsSet = true;
}

bool UniswapV2_PairHourDataV2DTO::hourlyTxnsIsSet() const
{
    return m_Hourly_txnsIsSet;
}

void UniswapV2_PairHourDataV2DTO::unsetHourly_txns()
{
    m_Hourly_txnsIsSet = false;
}
int64_t UniswapV2_PairHourDataV2DTO::getVid() const
{
    return m_Vid;
}

void UniswapV2_PairHourDataV2DTO::setVid(int64_t value)
{
    m_Vid = value;
    m_VidIsSet = true;
}

bool UniswapV2_PairHourDataV2DTO::vidIsSet() const
{
    return m_VidIsSet;
}

void UniswapV2_PairHourDataV2DTO::unsetVid()
{
    m_VidIsSet = false;
}
}
