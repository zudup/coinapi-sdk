...
#ifndef ORG_OPENAPITOOLS_CLIENT_MODEL_UniswapV3TickV3DTO_H_
#define ORG_OPENAPITOOLS_CLIENT_MODEL_UniswapV3TickV3DTO_H_
...
public:
    ...
    /// 
    /// </summary>
    std::shared_ptr<NumericsBigInteger> getTickIdx() const;
    bool tickIdxIsSet() const;
    void unsetTick_idx();

    void setTickIdx(const std::shared_ptr<NumericsBigInteger>& value);
    ...
    /// 
    /// </summary>
    std::shared_ptr<NumericsBigInteger> getLiquidityGross() const;
    bool liquidityGrossIsSet() const;
    void unsetLiquidity_gross();

    void setLiquidityGross(const std::shared_ptr<NumericsBigInteger>& value);

    /// <summary>
    /// 
    /// </summary>
    std::shared_ptr<NumericsBigInteger> getLiquidityNet() const;
    bool liquidityNetIsSet() const;
    void unsetLiquidity_net();

    void setLiquidityNet(const std::shared_ptr<NumericsBigInteger>& value);
    ...
    /// 
    /// </summary>
    std::shared_ptr<NumericsBigInteger> getLiquidityProviderCount() const;
    bool liquidityProviderCountIsSet() const;
    void unsetLiquidity_provider_count();

    void setLiquidityProviderCount(const std::shared_ptr<NumericsBigInteger>& value);

    /// <summary>
    /// 
    /// </summary>
    std::shared_ptr<NumericsBigInteger> getFeeGrowthOutside0x128() const;
    bool feeGrowthOutside0x128IsSet() const;
    void unsetFee_growth_outside_0x128();

    void setFeeGrowthOutside0x128(const std::shared_ptr<NumericsBigInteger>& value);

    /// <summary>
    /// 
    /// </summary>
    std::shared_ptr<NumericsBigInteger> getFeeGrowthOutside1x128() const;
    bool feeGrowthOutside1x128IsSet() const;
    void unsetFee_growth_outside_1x128();

    void setFeeGrowthOutside1x128(const std::shared_ptr<NumericsBigInteger>& value);
...
protected:
    ...
    std::shared_ptr<NumericsBigInteger> m_Tick_idx;
    bool m_Tick_idxIsSet;
    utility::string_t m_Pool;
    bool m_PoolIsSet;
    std::shared_ptr<NumericsBigInteger> m_Liquidity_gross;
    bool m_Liquidity_grossIsSet;
    std::shared_ptr<NumericsBigInteger> m_Liquidity_net;
    ...
    std::shared_ptr<NumericsBigInteger> m_Liquidity_provider_count;
    bool m_Liquidity_provider_countIsSet;
    std::shared_ptr<NumericsBigInteger> m_Fee_growth_outside_0x128;
    bool m_Fee_growth_outside_0x128IsSet;
    std::shared_ptr<NumericsBigInteger> m_Fee_growth_outside_1x128;
...
#endif /* ORG_OPENAPITOOLS_CLIENT_MODEL_UniswapV3TickV3DTO_H_ */
