...
#ifndef ORG_OPENAPITOOLS_CLIENT_MODEL_UniswapV2_MintV2DTO_H_
#define ORG_OPENAPITOOLS_CLIENT_MODEL_UniswapV2_MintV2DTO_H_
...
/// Mint entities are created for every emitted Mint event on the Uniswap core contracts. The Mint entity stores key data about the event like token amounts, who sent the transaction, who received the liquidity, and more. This entity can be used to track liquidity provisions on pairs.
/// </summary>
class  UniswapV2_MintV2DTO
    : public ModelBase
{
public:
    UniswapV2_MintV2DTO();
    virtual ~UniswapV2_MintV2DTO();
...
#endif /* ORG_OPENAPITOOLS_CLIENT_MODEL_UniswapV2_MintV2DTO_H_ */
