...
#ifndef ORG_OPENAPITOOLS_CLIENT_MODEL_SwapV3DTO_H_
#define ORG_OPENAPITOOLS_CLIENT_MODEL_SwapV3DTO_H_
...
public:
    ...
    /// 
    /// </summary>
    std::shared_ptr<BigInteger> getSqrtPriceX96() const;
    bool sqrtPriceX96IsSet() const;
    void unsetSqrt_price_x96();

    void setSqrtPriceX96(const std::shared_ptr<BigInteger>& value);
    ...
    /// 
    /// </summary>
    std::shared_ptr<BigInteger> getLogIndex() const;
    ...
    /// 
    /// </summary>
    std::shared_ptr<ETradeAggressiveSide> getEvaluatedAggressor() const;
    bool evaluatedAggressorIsSet() const;
    void unsetEvaluated_aggressor();

    void setEvaluatedAggressor(const std::shared_ptr<ETradeAggressiveSide>& value);
...
protected:
    ...
    std::shared_ptr<BigInteger> m_Sqrt_price_x96;
    bool m_Sqrt_price_x96IsSet;
    std::shared_ptr<BigInteger> m_Tick;
    bool m_TickIsSet;
    std::shared_ptr<BigInteger> m_Log_index;
    ...
    std::shared_ptr<ETradeAggressiveSide> m_Evaluated_aggressor;
...
#endif /* ORG_OPENAPITOOLS_CLIENT_MODEL_SwapV3DTO_H_ */
