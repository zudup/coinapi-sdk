...
#ifndef ORG_OPENAPITOOLS_CLIENT_MODEL_UniswapV3SwapV3DTO_H_
#define ORG_OPENAPITOOLS_CLIENT_MODEL_UniswapV3SwapV3DTO_H_
...
public:
    ...
    /// 
    /// </summary>
    std::shared_ptr<NumericsBigInteger> getSqrtPriceX96() const;
    bool sqrtPriceX96IsSet() const;
    void unsetSqrt_price_x96();

    void setSqrtPriceX96(const std::shared_ptr<NumericsBigInteger>& value);
    ...
    /// 
    /// </summary>
    std::shared_ptr<NumericsBigInteger> getLogIndex() const;
    bool logIndexIsSet() const;
    void unsetLog_index();

    void setLogIndex(const std::shared_ptr<NumericsBigInteger>& value);
    ...
    /// 
    /// </summary>
    std::shared_ptr<TransactionsETradeAggressiveSide> getEvaluatedAggressor() const;
    bool evaluatedAggressorIsSet() const;
    void unsetEvaluated_aggressor();

    void setEvaluatedAggressor(const std::shared_ptr<TransactionsETradeAggressiveSide>& value);
...
protected:
    ...
    std::shared_ptr<NumericsBigInteger> m_Sqrt_price_x96;
    bool m_Sqrt_price_x96IsSet;
    std::shared_ptr<NumericsBigInteger> m_Tick;
    bool m_TickIsSet;
    std::shared_ptr<NumericsBigInteger> m_Log_index;
    ...
    std::shared_ptr<TransactionsETradeAggressiveSide> m_Evaluated_aggressor;
...
#endif /* ORG_OPENAPITOOLS_CLIENT_MODEL_UniswapV3SwapV3DTO_H_ */
