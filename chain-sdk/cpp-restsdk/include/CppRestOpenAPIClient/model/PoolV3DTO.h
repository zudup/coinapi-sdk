...
#ifndef ORG_OPENAPITOOLS_CLIENT_MODEL_PoolV3DTO_H_
#define ORG_OPENAPITOOLS_CLIENT_MODEL_PoolV3DTO_H_
...
public:
    ...
    /// 
    /// </summary>
    std::shared_ptr<BigInteger> getFeeTier() const;
    bool feeTierIsSet() const;
    void unsetFee_tier();

    void setFeeTier(const std::shared_ptr<BigInteger>& value);

    /// <summary>
    /// 
    /// </summary>
    std::shared_ptr<BigInteger> getLiquidity() const;
    bool liquidityIsSet() const;
    void unsetLiquidity();

    void setLiquidity(const std::shared_ptr<BigInteger>& value);

    /// <summary>
    /// 
    /// </summary>
    std::shared_ptr<BigInteger> getSqrtPrice() const;
    bool sqrtPriceIsSet() const;
    void unsetSqrt_price();

    void setSqrtPrice(const std::shared_ptr<BigInteger>& value);

    /// <summary>
    /// 
    /// </summary>
    std::shared_ptr<BigInteger> getFeeGrowthGlobal0x128() const;
    bool feeGrowthGlobal0x128IsSet() const;
    void unsetFee_growth_global_0x128();

    void setFeeGrowthGlobal0x128(const std::shared_ptr<BigInteger>& value);

    /// <summary>
    /// 
    /// </summary>
    std::shared_ptr<BigInteger> getFeeGrowthGlobal1x128() const;
    bool feeGrowthGlobal1x128IsSet() const;
    void unsetFee_growth_global_1x128();

    void setFeeGrowthGlobal1x128(const std::shared_ptr<BigInteger>& value);
    ...
    /// 
    /// </summary>
    std::shared_ptr<BigInteger> getTick() const;
    bool tickIsSet() const;
    void unsetTick();

    void setTick(const std::shared_ptr<BigInteger>& value);

    /// <summary>
    /// 
    /// </summary>
    std::shared_ptr<BigInteger> getObservationIndex() const;
    bool observationIndexIsSet() const;
    void unsetObservation_index();

    void setObservationIndex(const std::shared_ptr<BigInteger>& value);
...
protected:
    ...
    bool m_Token_1IsSet;
    std::shared_ptr<BigInteger> m_Fee_tier;
    bool m_Fee_tierIsSet;
    std::shared_ptr<BigInteger> m_Liquidity;
    bool m_LiquidityIsSet;
    std::shared_ptr<BigInteger> m_Sqrt_price;
    bool m_Sqrt_priceIsSet;
    std::shared_ptr<BigInteger> m_Fee_growth_global_0x128;
    bool m_Fee_growth_global_0x128IsSet;
    std::shared_ptr<BigInteger> m_Fee_growth_global_1x128;
    ...
    std::shared_ptr<BigInteger> m_Tick;
    bool m_TickIsSet;
    std::shared_ptr<BigInteger> m_Observation_index;
...
#endif /* ORG_OPENAPITOOLS_CLIENT_MODEL_PoolV3DTO_H_ */
