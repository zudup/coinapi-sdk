...
#ifndef ORG_OPENAPITOOLS_CLIENT_MODEL_UniswapV3PoolV3DTO_H_
#define ORG_OPENAPITOOLS_CLIENT_MODEL_UniswapV3PoolV3DTO_H_
...
public:
    ...
    /// 
    /// </summary>
    std::shared_ptr<NumericsBigInteger> getFeeTier() const;
    bool feeTierIsSet() const;
    void unsetFee_tier();

    void setFeeTier(const std::shared_ptr<NumericsBigInteger>& value);

    /// <summary>
    /// 
    /// </summary>
    std::shared_ptr<NumericsBigInteger> getLiquidity() const;
    bool liquidityIsSet() const;
    void unsetLiquidity();

    void setLiquidity(const std::shared_ptr<NumericsBigInteger>& value);

    /// <summary>
    /// 
    /// </summary>
    std::shared_ptr<NumericsBigInteger> getSqrtPrice() const;
    bool sqrtPriceIsSet() const;
    void unsetSqrt_price();

    void setSqrtPrice(const std::shared_ptr<NumericsBigInteger>& value);

    /// <summary>
    /// 
    /// </summary>
    std::shared_ptr<NumericsBigInteger> getFeeGrowthGlobal0x128() const;
    bool feeGrowthGlobal0x128IsSet() const;
    void unsetFee_growth_global_0x128();

    void setFeeGrowthGlobal0x128(const std::shared_ptr<NumericsBigInteger>& value);

    /// <summary>
    /// 
    /// </summary>
    std::shared_ptr<NumericsBigInteger> getFeeGrowthGlobal1x128() const;
    bool feeGrowthGlobal1x128IsSet() const;
    void unsetFee_growth_global_1x128();

    void setFeeGrowthGlobal1x128(const std::shared_ptr<NumericsBigInteger>& value);
    ...
    /// 
    /// </summary>
    std::shared_ptr<NumericsBigInteger> getTick() const;
    bool tickIsSet() const;
    void unsetTick();

    void setTick(const std::shared_ptr<NumericsBigInteger>& value);

    /// <summary>
    /// 
    /// </summary>
    std::shared_ptr<NumericsBigInteger> getObservationIndex() const;
    bool observationIndexIsSet() const;
    void unsetObservation_index();

    void setObservationIndex(const std::shared_ptr<NumericsBigInteger>& value);
    ...
    /// 
    /// </summary>
    std::shared_ptr<NumericsBigInteger> getTxCount() const;
    bool txCountIsSet() const;
    void unsetTx_count();

    void setTxCount(const std::shared_ptr<NumericsBigInteger>& value);
...
protected:
    ...
    bool m_Token_1IsSet;
    std::shared_ptr<NumericsBigInteger> m_Fee_tier;
    bool m_Fee_tierIsSet;
    std::shared_ptr<NumericsBigInteger> m_Liquidity;
    bool m_LiquidityIsSet;
    std::shared_ptr<NumericsBigInteger> m_Sqrt_price;
    bool m_Sqrt_priceIsSet;
    std::shared_ptr<NumericsBigInteger> m_Fee_growth_global_0x128;
    bool m_Fee_growth_global_0x128IsSet;
    std::shared_ptr<NumericsBigInteger> m_Fee_growth_global_1x128;
    ...
    std::shared_ptr<NumericsBigInteger> m_Tick;
    bool m_TickIsSet;
    std::shared_ptr<NumericsBigInteger> m_Observation_index;
    ...
    std::shared_ptr<NumericsBigInteger> m_Tx_count;
...
#endif /* ORG_OPENAPITOOLS_CLIENT_MODEL_UniswapV3PoolV3DTO_H_ */
