...
#ifndef ORG_OPENAPITOOLS_CLIENT_MODEL_UniswapV3TokenV3DTO_H_
#define ORG_OPENAPITOOLS_CLIENT_MODEL_UniswapV3TokenV3DTO_H_
...
public:
    ...
    /// 
    /// </summary>
    std::shared_ptr<NumericsBigInteger> getTotalSupply() const;
    bool totalSupplyIsSet() const;
    void unsetTotal_supply();

    void setTotalSupply(const std::shared_ptr<NumericsBigInteger>& value);
    ...
    /// 
    /// </summary>
    std::shared_ptr<NumericsBigInteger> getPoolCount() const;
    bool poolCountIsSet() const;
    void unsetPool_count();

    void setPoolCount(const std::shared_ptr<NumericsBigInteger>& value);
...
protected:
    ...
    std::shared_ptr<NumericsBigInteger> m_Total_supply;
    ...
    std::shared_ptr<NumericsBigInteger> m_Pool_count;
...
#endif /* ORG_OPENAPITOOLS_CLIENT_MODEL_UniswapV3TokenV3DTO_H_ */
