...
/*
 * UniswapV2_BurnV2DTO.h
 *
 * Burn entities are created for every emitted Burn event on the Uniswap core contracts. The Burn entity stores key data about the event like token amounts, who burned LP tokens, who received tokens, and more. This entity can be used to track liquidity removals on pairs.
 */

#ifndef ORG_OPENAPITOOLS_CLIENT_MODEL_UniswapV2_BurnV2DTO_H_
#define ORG_OPENAPITOOLS_CLIENT_MODEL_UniswapV2_BurnV2DTO_H_
...
/// Burn entities are created for every emitted Burn event on the Uniswap core contracts. The Burn entity stores key data about the event like token amounts, who burned LP tokens, who received tokens, and more. This entity can be used to track liquidity removals on pairs.
/// </summary>
class  UniswapV2_BurnV2DTO
    : public ModelBase
{
public:
    UniswapV2_BurnV2DTO();
    virtual ~UniswapV2_BurnV2DTO();
...
#endif /* ORG_OPENAPITOOLS_CLIENT_MODEL_UniswapV2_BurnV2DTO_H_ */
