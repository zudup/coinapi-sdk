...
#ifndef ORG_OPENAPITOOLS_CLIENT_API_TokenHourDataApi_H_
#define ORG_OPENAPITOOLS_CLIENT_API_TokenHourDataApi_H_
...
public:
    ...
    explicit TokenHourDataApi( std::shared_ptr<const ApiClient> apiClient );

    virtual ~TokenHourDataApi();
    ...
    pplx::task<void> chainsChainIdDappsUniswapv3TokenHourDataHistoricalGet(
...
#endif /* ORG_OPENAPITOOLS_CLIENT_API_TokenHourDataApi_H_ */
