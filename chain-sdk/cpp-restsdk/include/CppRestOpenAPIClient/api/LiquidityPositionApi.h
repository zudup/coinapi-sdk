...
/*
 * LiquidityPositionApi.h
 *
 * 
 */

#ifndef ORG_OPENAPITOOLS_CLIENT_API_LiquidityPositionApi_H_
#define ORG_OPENAPITOOLS_CLIENT_API_LiquidityPositionApi_H_
...
public:
    ...
    explicit LiquidityPositionApi( std::shared_ptr<const ApiClient> apiClient );

    virtual ~LiquidityPositionApi();
    ...
    pplx::task<void> chainsChainIdDappsSushiswapLiquidityPositionHistoricalGet(
    ...
    /// <param name="endDate"> (optional, default to utility::datetime())</param>
    /// <param name="poolId"> (optional, default to utility::conversions::to_string_t(&quot;&quot;))</param>
    pplx::task<void> chainsChainIdDappsUniswapv2LiquidityPositionHistoricalGet(
        utility::string_t chainId,
        boost::optional<int64_t> startBlock,
        boost::optional<int64_t> endBlock,
        boost::optional<utility::datetime> startDate,
...
#endif /* ORG_OPENAPITOOLS_CLIENT_API_LiquidityPositionApi_H_ */
