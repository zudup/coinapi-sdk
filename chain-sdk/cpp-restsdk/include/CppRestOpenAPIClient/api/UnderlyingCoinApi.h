...
#ifndef ORG_OPENAPITOOLS_CLIENT_API_UnderlyingCoinApi_H_
#define ORG_OPENAPITOOLS_CLIENT_API_UnderlyingCoinApi_H_
...
public:
    ...
    explicit UnderlyingCoinApi( std::shared_ptr<const ApiClient> apiClient );

    virtual ~UnderlyingCoinApi();
    ...
    pplx::task<void> chainsChainIdDappsCurveUnderlyingCoinHistoricalGet(
...
#endif /* ORG_OPENAPITOOLS_CLIENT_API_UnderlyingCoinApi_H_ */
