...
#ifndef ORG_OPENAPITOOLS_CLIENT_API_UniswapDayDataApi_H_
#define ORG_OPENAPITOOLS_CLIENT_API_UniswapDayDataApi_H_
...
public:
    ...
    explicit UniswapDayDataApi( std::shared_ptr<const ApiClient> apiClient );

    virtual ~UniswapDayDataApi();
...
#endif /* ORG_OPENAPITOOLS_CLIENT_API_UniswapDayDataApi_H_ */
