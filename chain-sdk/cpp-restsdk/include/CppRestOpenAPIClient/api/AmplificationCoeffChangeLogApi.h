...
/*
 * AmplificationCoeffChangeLogApi.h
 *
 * 
 */

#ifndef ORG_OPENAPITOOLS_CLIENT_API_AmplificationCoeffChangeLogApi_H_
#define ORG_OPENAPITOOLS_CLIENT_API_AmplificationCoeffChangeLogApi_H_
...
public:
    ...
    explicit AmplificationCoeffChangeLogApi( std::shared_ptr<const ApiClient> apiClient );

    virtual ~AmplificationCoeffChangeLogApi();
    ...
    pplx::task<void> chainsChainIdDappsCurveAmplificationCoeffChangeLogHistoricalGet(
...
#endif /* ORG_OPENAPITOOLS_CLIENT_API_AmplificationCoeffChangeLogApi_H_ */
