...
/*
 * ContractsVersionApi.h
 *
 * 
 */

#ifndef ORG_OPENAPITOOLS_CLIENT_API_ContractsVersionApi_H_
#define ORG_OPENAPITOOLS_CLIENT_API_ContractsVersionApi_H_
...
public:
    ...
    explicit ContractsVersionApi( std::shared_ptr<const ApiClient> apiClient );

    virtual ~ContractsVersionApi();
    ...
    pplx::task<void> chainsChainIdDappsCurveContractsVersionHistoricalGet(
...
#endif /* ORG_OPENAPITOOLS_CLIENT_API_ContractsVersionApi_H_ */
