...
#ifndef ORG_OPENAPITOOLS_CLIENT_API_DepositApi_H_
#define ORG_OPENAPITOOLS_CLIENT_API_DepositApi_H_
...
public:
    ...
    explicit DepositApi( std::shared_ptr<const ApiClient> apiClient );
...
#endif /* ORG_OPENAPITOOLS_CLIENT_API_DepositApi_H_ */
