...
/*
 * AdminFeeChangeLogApi.h
 *
 * 
 */

#ifndef ORG_OPENAPITOOLS_CLIENT_API_AdminFeeChangeLogApi_H_
#define ORG_OPENAPITOOLS_CLIENT_API_AdminFeeChangeLogApi_H_
...
public:
    ...
    explicit AdminFeeChangeLogApi( std::shared_ptr<const ApiClient> apiClient );

    virtual ~AdminFeeChangeLogApi();
    ...
    pplx::task<void> chainsChainIdDappsCurveAdminFeeChangeLogHistoricalGet(
...
#endif /* ORG_OPENAPITOOLS_CLIENT_API_AdminFeeChangeLogApi_H_ */
