...
/*
 * GaugeTypeWeightApi.h
 *
 * 
 */

#ifndef ORG_OPENAPITOOLS_CLIENT_API_GaugeTypeWeightApi_H_
#define ORG_OPENAPITOOLS_CLIENT_API_GaugeTypeWeightApi_H_
...
public:
    ...
    explicit GaugeTypeWeightApi( std::shared_ptr<const ApiClient> apiClient );

    virtual ~GaugeTypeWeightApi();
    ...
    pplx::task<void> chainsChainIdDappsCurveGaugeTypeWeightHistoricalGet(
...
#endif /* ORG_OPENAPITOOLS_CLIENT_API_GaugeTypeWeightApi_H_ */
