...
/*
 * PositionSnapshotApi.h
 *
 * 
 */

#ifndef ORG_OPENAPITOOLS_CLIENT_API_PositionSnapshotApi_H_
#define ORG_OPENAPITOOLS_CLIENT_API_PositionSnapshotApi_H_
...
public:
    ...
    explicit PositionSnapshotApi( std::shared_ptr<const ApiClient> apiClient );

    virtual ~PositionSnapshotApi();
    ...
    pplx::task<void> chainsChainIdDappsUniswapv3PositionSnapshotHistoricalGet(
...
#endif /* ORG_OPENAPITOOLS_CLIENT_API_PositionSnapshotApi_H_ */
