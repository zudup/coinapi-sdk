...
#ifndef ORG_OPENAPITOOLS_CLIENT_API_GaugeWeightApi_H_
#define ORG_OPENAPITOOLS_CLIENT_API_GaugeWeightApi_H_
...
public:
    ...
    explicit GaugeWeightApi( std::shared_ptr<const ApiClient> apiClient );

    virtual ~GaugeWeightApi();
    ...
    pplx::task<void> chainsChainIdDappsCurveGaugeWeightHistoricalGet(
...
#endif /* ORG_OPENAPITOOLS_CLIENT_API_GaugeWeightApi_H_ */
