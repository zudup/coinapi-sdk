...
/*
 * WithdrawRequestApi.h
 *
 * 
 */

#ifndef ORG_OPENAPITOOLS_CLIENT_API_WithdrawRequestApi_H_
#define ORG_OPENAPITOOLS_CLIENT_API_WithdrawRequestApi_H_
...
public:
    ...
    explicit WithdrawRequestApi( std::shared_ptr<const ApiClient> apiClient );

    virtual ~WithdrawRequestApi();
    ...
    pplx::task<void> chainsChainIdDappsDexWithdrawRequestHistoricalGet(
...
#endif /* ORG_OPENAPITOOLS_CLIENT_API_WithdrawRequestApi_H_ */
