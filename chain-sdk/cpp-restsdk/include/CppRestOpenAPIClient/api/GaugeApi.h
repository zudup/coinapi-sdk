...
#ifndef ORG_OPENAPITOOLS_CLIENT_API_GaugeApi_H_
#define ORG_OPENAPITOOLS_CLIENT_API_GaugeApi_H_
...
public:
    ...
    explicit GaugeApi( std::shared_ptr<const ApiClient> apiClient );
    ...
    pplx::task<void> chainsChainIdDappsCurveGaugeHistoricalGet(
...
#endif /* ORG_OPENAPITOOLS_CLIENT_API_GaugeApi_H_ */
