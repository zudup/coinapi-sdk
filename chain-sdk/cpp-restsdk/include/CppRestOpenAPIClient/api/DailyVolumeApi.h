...
#ifndef ORG_OPENAPITOOLS_CLIENT_API_DailyVolumeApi_H_
#define ORG_OPENAPITOOLS_CLIENT_API_DailyVolumeApi_H_
...
public:
    ...
    explicit DailyVolumeApi( std::shared_ptr<const ApiClient> apiClient );

    virtual ~DailyVolumeApi();
    ...
    pplx::task<void> chainsChainIdDappsCurveDailyVolumeHistoricalGet(
...
#endif /* ORG_OPENAPITOOLS_CLIENT_API_DailyVolumeApi_H_ */
