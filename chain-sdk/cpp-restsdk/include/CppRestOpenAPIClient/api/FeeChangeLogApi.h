...
#ifndef ORG_OPENAPITOOLS_CLIENT_API_FeeChangeLogApi_H_
#define ORG_OPENAPITOOLS_CLIENT_API_FeeChangeLogApi_H_
...
public:
    ...
    explicit FeeChangeLogApi( std::shared_ptr<const ApiClient> apiClient );

    virtual ~FeeChangeLogApi();
    ...
    pplx::task<void> chainsChainIdDappsCurveFeeChangeLogHistoricalGet(
...
#endif /* ORG_OPENAPITOOLS_CLIENT_API_FeeChangeLogApi_H_ */
