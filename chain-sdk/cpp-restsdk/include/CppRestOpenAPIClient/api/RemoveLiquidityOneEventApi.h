...
/*
 * RemoveLiquidityOneEventApi.h
 *
 * 
 */

#ifndef ORG_OPENAPITOOLS_CLIENT_API_RemoveLiquidityOneEventApi_H_
#define ORG_OPENAPITOOLS_CLIENT_API_RemoveLiquidityOneEventApi_H_
...
public:
    ...
    explicit RemoveLiquidityOneEventApi( std::shared_ptr<const ApiClient> apiClient );

    virtual ~RemoveLiquidityOneEventApi();
    ...
    pplx::task<void> chainsChainIdDappsCurveRemoveLiquidityOneEventHistoricalGet(
...
#endif /* ORG_OPENAPITOOLS_CLIENT_API_RemoveLiquidityOneEventApi_H_ */
