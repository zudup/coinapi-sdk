...
#ifndef ORG_OPENAPITOOLS_CLIENT_API_DayDataApi_H_
#define ORG_OPENAPITOOLS_CLIENT_API_DayDataApi_H_
...
public:
    ...
    explicit DayDataApi( std::shared_ptr<const ApiClient> apiClient );
    ...
    pplx::task<void> chainsChainIdDappsSushiswapDayDataHistoricalGet(
...
#endif /* ORG_OPENAPITOOLS_CLIENT_API_DayDataApi_H_ */
