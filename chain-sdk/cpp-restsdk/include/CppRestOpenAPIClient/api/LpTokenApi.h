...
#ifndef ORG_OPENAPITOOLS_CLIENT_API_LpTokenApi_H_
#define ORG_OPENAPITOOLS_CLIENT_API_LpTokenApi_H_
...
public:
    ...
    explicit LpTokenApi( std::shared_ptr<const ApiClient> apiClient );
    ...
    pplx::task<void> chainsChainIdDappsCurveLpTokenHistoricalGet(
...
#endif /* ORG_OPENAPITOOLS_CLIENT_API_LpTokenApi_H_ */
