...
#ifndef ORG_OPENAPITOOLS_CLIENT_API_PoolDayDataApi_H_
#define ORG_OPENAPITOOLS_CLIENT_API_PoolDayDataApi_H_
...
public:
    ...
    explicit PoolDayDataApi( std::shared_ptr<const ApiClient> apiClient );

    virtual ~PoolDayDataApi();
    ...
    pplx::task<void> chainsChainIdDappsSushiswapPoolDayDataHistoricalGet(
    ...
    /// <param name="endDate"> (optional, default to utility::datetime())</param>
    /// <param name="poolId"> (optional, default to utility::conversions::to_string_t(&quot;&quot;))</param>
    pplx::task<void> chainsChainIdDappsUniswapv2PoolDayDataHistoricalGet(
        utility::string_t chainId,
        boost::optional<int64_t> startBlock,
        boost::optional<int64_t> endBlock,
        boost::optional<utility::datetime> startDate,
    ...
    /// <param name="endDate"> (optional, default to utility::datetime())</param>
    /// <param name="poolId"> (optional, default to utility::conversions::to_string_t(&quot;&quot;))</param>
    pplx::task<void> chainsChainIdDappsUniswapv3PoolDayDataHistoricalGet(
        utility::string_t chainId,
        boost::optional<int64_t> startBlock,
        boost::optional<int64_t> endBlock,
        boost::optional<utility::datetime> startDate,
...
#endif /* ORG_OPENAPITOOLS_CLIENT_API_PoolDayDataApi_H_ */
