...
#ifndef ORG_OPENAPITOOLS_CLIENT_API_HourDataApi_H_
#define ORG_OPENAPITOOLS_CLIENT_API_HourDataApi_H_
...
public:
    ...
    explicit HourDataApi( std::shared_ptr<const ApiClient> apiClient );
    ...
    pplx::task<void> chainsChainIdDappsSushiswapHourDataHistoricalGet(
...
#endif /* ORG_OPENAPITOOLS_CLIENT_API_HourDataApi_H_ */
