...
#ifndef ORG_OPENAPITOOLS_CLIENT_API_SettlementApi_H_
#define ORG_OPENAPITOOLS_CLIENT_API_SettlementApi_H_
...
public:
    ...
    explicit SettlementApi( std::shared_ptr<const ApiClient> apiClient );
    ...
    pplx::task<void> chainsChainIdDappsCowSettlementHistoricalGet(
...
#endif /* ORG_OPENAPITOOLS_CLIENT_API_SettlementApi_H_ */
