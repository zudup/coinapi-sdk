...
#ifndef ORG_OPENAPITOOLS_CLIENT_API_HourlyVolumeApi_H_
#define ORG_OPENAPITOOLS_CLIENT_API_HourlyVolumeApi_H_
...
public:
    ...
    explicit HourlyVolumeApi( std::shared_ptr<const ApiClient> apiClient );

    virtual ~HourlyVolumeApi();
    ...
    pplx::task<void> chainsChainIdDappsCurveHourlyVolumeHistoricalGet(
...
#endif /* ORG_OPENAPITOOLS_CLIENT_API_HourlyVolumeApi_H_ */
