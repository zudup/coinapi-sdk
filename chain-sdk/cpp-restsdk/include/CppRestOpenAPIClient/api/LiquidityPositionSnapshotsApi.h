...
/*
 * LiquidityPositionSnapshotsApi.h
 *
 * 
 */

#ifndef ORG_OPENAPITOOLS_CLIENT_API_LiquidityPositionSnapshotsApi_H_
#define ORG_OPENAPITOOLS_CLIENT_API_LiquidityPositionSnapshotsApi_H_
...
public:
    ...
    explicit LiquidityPositionSnapshotsApi( std::shared_ptr<const ApiClient> apiClient );

    virtual ~LiquidityPositionSnapshotsApi();
    ...
    pplx::task<void> chainsChainIdDappsSushiswapLiquidityPositionSnapshotsHistoricalGet(
    ...
    /// <param name="endDate"> (optional, default to utility::datetime())</param>
    /// <param name="poolId"> (optional, default to utility::conversions::to_string_t(&quot;&quot;))</param>
    pplx::task<void> chainsChainIdDappsUniswapv2LiquidityPositionSnapshotsHistoricalGet(
        utility::string_t chainId,
        boost::optional<int64_t> startBlock,
        boost::optional<int64_t> endBlock,
        boost::optional<utility::datetime> startDate,
...
#endif /* ORG_OPENAPITOOLS_CLIENT_API_LiquidityPositionSnapshotsApi_H_ */
