...
#ifndef ORG_OPENAPITOOLS_CLIENT_API_MintApi_H_
#define ORG_OPENAPITOOLS_CLIENT_API_MintApi_H_
...
public:
    ...
    pplx::task<void> chainsChainIdDappsUniswapv2MintHistoricalGet(
...
#endif /* ORG_OPENAPITOOLS_CLIENT_API_MintApi_H_ */
