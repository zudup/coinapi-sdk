...
/*
 * RemoveLiquidityEventApi.h
 *
 * 
 */

#ifndef ORG_OPENAPITOOLS_CLIENT_API_RemoveLiquidityEventApi_H_
#define ORG_OPENAPITOOLS_CLIENT_API_RemoveLiquidityEventApi_H_
...
public:
    ...
    explicit RemoveLiquidityEventApi( std::shared_ptr<const ApiClient> apiClient );

    virtual ~RemoveLiquidityEventApi();
    ...
    pplx::task<void> chainsChainIdDappsCurveRemoveLiquidityEventHistoricalGet(
...
#endif /* ORG_OPENAPITOOLS_CLIENT_API_RemoveLiquidityEventApi_H_ */
