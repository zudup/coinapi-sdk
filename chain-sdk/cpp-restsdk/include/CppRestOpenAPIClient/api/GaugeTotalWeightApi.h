...
/*
 * GaugeTotalWeightApi.h
 *
 * 
 */

#ifndef ORG_OPENAPITOOLS_CLIENT_API_GaugeTotalWeightApi_H_
#define ORG_OPENAPITOOLS_CLIENT_API_GaugeTotalWeightApi_H_
...
public:
    ...
    explicit GaugeTotalWeightApi( std::shared_ptr<const ApiClient> apiClient );

    virtual ~GaugeTotalWeightApi();
    ...
    pplx::task<void> chainsChainIdDappsCurveGaugeTotalWeightHistoricalGet(
...
#endif /* ORG_OPENAPITOOLS_CLIENT_API_GaugeTotalWeightApi_H_ */
