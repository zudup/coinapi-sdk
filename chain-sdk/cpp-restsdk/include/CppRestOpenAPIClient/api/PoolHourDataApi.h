...
#ifndef ORG_OPENAPITOOLS_CLIENT_API_PoolHourDataApi_H_
#define ORG_OPENAPITOOLS_CLIENT_API_PoolHourDataApi_H_
...
public:
    ...
    explicit PoolHourDataApi( std::shared_ptr<const ApiClient> apiClient );

    virtual ~PoolHourDataApi();
    ...
    pplx::task<void> chainsChainIdDappsSushiswapPoolHourDataHistoricalGet(
    ...
    /// <param name="endDate"> (optional, default to utility::datetime())</param>
    /// <param name="poolId"> (optional, default to utility::conversions::to_string_t(&quot;&quot;))</param>
    pplx::task<void> chainsChainIdDappsUniswapv2PoolHourDataHistoricalGet(
        utility::string_t chainId,
        boost::optional<int64_t> startBlock,
        boost::optional<int64_t> endBlock,
        boost::optional<utility::datetime> startDate,
    ...
    /// <param name="endDate"> (optional, default to utility::datetime())</param>
    /// <param name="poolId"> (optional, default to utility::conversions::to_string_t(&quot;&quot;))</param>
    pplx::task<void> chainsChainIdDappsUniswapv3PoolHourDataHistoricalGet(
        utility::string_t chainId,
        boost::optional<int64_t> startBlock,
        boost::optional<int64_t> endBlock,
        boost::optional<utility::datetime> startDate,
...
#endif /* ORG_OPENAPITOOLS_CLIENT_API_PoolHourDataApi_H_ */
