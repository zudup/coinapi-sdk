...
#ifndef ORG_OPENAPITOOLS_CLIENT_API_GaugeWithdrawApi_H_
#define ORG_OPENAPITOOLS_CLIENT_API_GaugeWithdrawApi_H_
...
public:
    ...
    explicit GaugeWithdrawApi( std::shared_ptr<const ApiClient> apiClient );

    virtual ~GaugeWithdrawApi();
    ...
    pplx::task<void> chainsChainIdDappsCurveGaugeWithdrawHistoricalGet(
...
#endif /* ORG_OPENAPITOOLS_CLIENT_API_GaugeWithdrawApi_H_ */
