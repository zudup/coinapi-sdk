...
#ifndef ORG_OPENAPITOOLS_CLIENT_API_WeeklyVolumeApi_H_
#define ORG_OPENAPITOOLS_CLIENT_API_WeeklyVolumeApi_H_
...
public:
    ...
    explicit WeeklyVolumeApi( std::shared_ptr<const ApiClient> apiClient );

    virtual ~WeeklyVolumeApi();
    ...
    pplx::task<void> chainsChainIdDappsCurveWeeklyVolumeHistoricalGet(
...
#endif /* ORG_OPENAPITOOLS_CLIENT_API_WeeklyVolumeApi_H_ */
