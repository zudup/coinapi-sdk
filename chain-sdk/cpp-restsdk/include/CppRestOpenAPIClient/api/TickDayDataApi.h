...
#ifndef ORG_OPENAPITOOLS_CLIENT_API_TickDayDataApi_H_
#define ORG_OPENAPITOOLS_CLIENT_API_TickDayDataApi_H_
...
public:
    ...
    explicit TickDayDataApi( std::shared_ptr<const ApiClient> apiClient );

    virtual ~TickDayDataApi();
    ...
    pplx::task<void> chainsChainIdDappsUniswapv3TickDayDataHistoricalGet(
...
#endif /* ORG_OPENAPITOOLS_CLIENT_API_TickDayDataApi_H_ */
