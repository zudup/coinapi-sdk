...
#ifndef ORG_OPENAPITOOLS_CLIENT_API_GaugeLiquidityApi_H_
#define ORG_OPENAPITOOLS_CLIENT_API_GaugeLiquidityApi_H_
...
public:
    ...
    explicit GaugeLiquidityApi( std::shared_ptr<const ApiClient> apiClient );

    virtual ~GaugeLiquidityApi();
    ...
    pplx::task<void> chainsChainIdDappsCurveGaugeLiquidityHistoricalGet(
...
#endif /* ORG_OPENAPITOOLS_CLIENT_API_GaugeLiquidityApi_H_ */
