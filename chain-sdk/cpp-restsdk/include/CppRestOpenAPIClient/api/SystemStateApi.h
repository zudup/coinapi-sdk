...
#ifndef ORG_OPENAPITOOLS_CLIENT_API_SystemStateApi_H_
#define ORG_OPENAPITOOLS_CLIENT_API_SystemStateApi_H_
...
public:
    ...
    explicit SystemStateApi( std::shared_ptr<const ApiClient> apiClient );

    virtual ~SystemStateApi();
    ...
    pplx::task<void> chainsChainIdDappsCurveSystemStateHistoricalGet(
...
#endif /* ORG_OPENAPITOOLS_CLIENT_API_SystemStateApi_H_ */
