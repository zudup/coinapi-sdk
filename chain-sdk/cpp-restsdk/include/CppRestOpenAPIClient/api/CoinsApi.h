...
#ifndef ORG_OPENAPITOOLS_CLIENT_API_CoinsApi_H_
#define ORG_OPENAPITOOLS_CLIENT_API_CoinsApi_H_
...
public:
    ...
    explicit CoinsApi( std::shared_ptr<const ApiClient> apiClient );
    ...
    pplx::task<void> chainsChainIdDappsCurveCoinsHistoricalGet(
...
#endif /* ORG_OPENAPITOOLS_CLIENT_API_CoinsApi_H_ */
