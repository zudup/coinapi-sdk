...
#ifndef ORG_OPENAPITOOLS_CLIENT_API_MintsApi_H_
#define ORG_OPENAPITOOLS_CLIENT_API_MintsApi_H_
...
public:
    ...
    explicit MintsApi( std::shared_ptr<const ApiClient> apiClient );
    ...
    pplx::task<void> chainsChainIdDappsSushiswapMintsHistoricalGet(
    ...
    /// <param name="endDate"> (optional, default to utility::datetime())</param>
    /// <param name="poolId"> (optional, default to utility::conversions::to_string_t(&quot;&quot;))</param>
    pplx::task<void> chainsChainIdDappsUniswapv2MintsHistoricalGet(
        utility::string_t chainId,
        boost::optional<int64_t> startBlock,
        boost::optional<int64_t> endBlock,
        boost::optional<utility::datetime> startDate,
    ...
    /// <param name="endDate"> (optional, default to utility::datetime())</param>
    /// <param name="poolId"> (optional, default to utility::conversions::to_string_t(&quot;&quot;))</param>
    pplx::task<void> chainsChainIdDappsUniswapv3MintsHistoricalGet(
        utility::string_t chainId,
        boost::optional<int64_t> startBlock,
        boost::optional<int64_t> endBlock,
        boost::optional<utility::datetime> startDate,
...
#endif /* ORG_OPENAPITOOLS_CLIENT_API_MintsApi_H_ */
