...
#ifndef ORG_OPENAPITOOLS_CLIENT_API_TicksApi_H_
#define ORG_OPENAPITOOLS_CLIENT_API_TicksApi_H_
...
public:
    ...
    explicit TicksApi( std::shared_ptr<const ApiClient> apiClient );
    ...
    pplx::task<void> chainsChainIdDappsUniswapv3TicksHistoricalGet(
...
#endif /* ORG_OPENAPITOOLS_CLIENT_API_TicksApi_H_ */
