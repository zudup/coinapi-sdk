...
#ifndef ORG_OPENAPITOOLS_CLIENT_API_WithdrawApi_H_
#define ORG_OPENAPITOOLS_CLIENT_API_WithdrawApi_H_
...
public:
    ...
    explicit WithdrawApi( std::shared_ptr<const ApiClient> apiClient );
    ...
    pplx::task<void> chainsChainIdDappsDexWithdrawHistoricalGet(
...
#endif /* ORG_OPENAPITOOLS_CLIENT_API_WithdrawApi_H_ */
