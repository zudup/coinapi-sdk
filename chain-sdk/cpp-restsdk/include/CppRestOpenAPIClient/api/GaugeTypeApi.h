...
#ifndef ORG_OPENAPITOOLS_CLIENT_API_GaugeTypeApi_H_
#define ORG_OPENAPITOOLS_CLIENT_API_GaugeTypeApi_H_
...
public:
    ...
    explicit GaugeTypeApi( std::shared_ptr<const ApiClient> apiClient );

    virtual ~GaugeTypeApi();
    ...
    pplx::task<void> chainsChainIdDappsCurveGaugeTypeHistoricalGet(
...
#endif /* ORG_OPENAPITOOLS_CLIENT_API_GaugeTypeApi_H_ */
