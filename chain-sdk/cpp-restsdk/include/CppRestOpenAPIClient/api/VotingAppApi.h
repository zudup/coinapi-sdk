...
#ifndef ORG_OPENAPITOOLS_CLIENT_API_VotingAppApi_H_
#define ORG_OPENAPITOOLS_CLIENT_API_VotingAppApi_H_
...
public:
    ...
    explicit VotingAppApi( std::shared_ptr<const ApiClient> apiClient );

    virtual ~VotingAppApi();
    ...
    pplx::task<void> chainsChainIdDappsCurveVotingAppHistoricalGet(
...
#endif /* ORG_OPENAPITOOLS_CLIENT_API_VotingAppApi_H_ */
