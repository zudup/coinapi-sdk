...
/*
 * TransferOwnershipEventApi.h
 *
 * 
 */

#ifndef ORG_OPENAPITOOLS_CLIENT_API_TransferOwnershipEventApi_H_
#define ORG_OPENAPITOOLS_CLIENT_API_TransferOwnershipEventApi_H_
...
public:
    ...
    explicit TransferOwnershipEventApi( std::shared_ptr<const ApiClient> apiClient );

    virtual ~TransferOwnershipEventApi();
    ...
    pplx::task<void> chainsChainIdDappsCurveTransferOwnershipEventHistoricalGet(
...
#endif /* ORG_OPENAPITOOLS_CLIENT_API_TransferOwnershipEventApi_H_ */
