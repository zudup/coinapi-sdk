...
#ifndef ORG_OPENAPITOOLS_CLIENT_API_GaugeDepositApi_H_
#define ORG_OPENAPITOOLS_CLIENT_API_GaugeDepositApi_H_
...
public:
    ...
    explicit GaugeDepositApi( std::shared_ptr<const ApiClient> apiClient );

    virtual ~GaugeDepositApi();
    ...
    pplx::task<void> chainsChainIdDappsCurveGaugeDepositHistoricalGet(
...
#endif /* ORG_OPENAPITOOLS_CLIENT_API_GaugeDepositApi_H_ */
