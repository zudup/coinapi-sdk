...
/*
 * GaugeWeightVoteApi.h
 *
 * 
 */

#ifndef ORG_OPENAPITOOLS_CLIENT_API_GaugeWeightVoteApi_H_
#define ORG_OPENAPITOOLS_CLIENT_API_GaugeWeightVoteApi_H_
...
public:
    ...
    explicit GaugeWeightVoteApi( std::shared_ptr<const ApiClient> apiClient );

    virtual ~GaugeWeightVoteApi();
    ...
    pplx::task<void> chainsChainIdDappsCurveGaugeWeightVoteHistoricalGet(
...
#endif /* ORG_OPENAPITOOLS_CLIENT_API_GaugeWeightVoteApi_H_ */
