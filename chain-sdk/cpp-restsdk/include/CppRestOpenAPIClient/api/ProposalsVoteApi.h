...
#ifndef ORG_OPENAPITOOLS_CLIENT_API_ProposalsVoteApi_H_
#define ORG_OPENAPITOOLS_CLIENT_API_ProposalsVoteApi_H_
...
public:
    ...
    explicit ProposalsVoteApi( std::shared_ptr<const ApiClient> apiClient );

    virtual ~ProposalsVoteApi();
    ...
    pplx::task<void> chainsChainIdDappsCurveProposalsVoteHistoricalGet(
...
#endif /* ORG_OPENAPITOOLS_CLIENT_API_ProposalsVoteApi_H_ */
