...
#ifndef ORG_OPENAPITOOLS_CLIENT_API_ProposalsApi_H_
#define ORG_OPENAPITOOLS_CLIENT_API_ProposalsApi_H_
...
public:
    ...
    explicit ProposalsApi( std::shared_ptr<const ApiClient> apiClient );

    virtual ~ProposalsApi();
    ...
    pplx::task<void> chainsChainIdDappsCurveProposalsHistoricalGet(
...
#endif /* ORG_OPENAPITOOLS_CLIENT_API_ProposalsApi_H_ */
