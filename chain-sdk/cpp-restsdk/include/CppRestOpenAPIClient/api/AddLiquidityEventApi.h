...
/*
 * AddLiquidityEventApi.h
 *
 * 
 */

#ifndef ORG_OPENAPITOOLS_CLIENT_API_AddLiquidityEventApi_H_
#define ORG_OPENAPITOOLS_CLIENT_API_AddLiquidityEventApi_H_
...
public:
    ...
    explicit AddLiquidityEventApi( std::shared_ptr<const ApiClient> apiClient );

    virtual ~AddLiquidityEventApi();
    ...
    pplx::task<void> chainsChainIdDappsCurveAddLiquidityEventHistoricalGet(
...
#endif /* ORG_OPENAPITOOLS_CLIENT_API_AddLiquidityEventApi_H_ */
