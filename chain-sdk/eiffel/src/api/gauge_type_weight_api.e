...
feature -- API Access
	...
	chains_chain_id_dapps_curve_gauge_type_weight_historical_get (chain_id: STRING_32; start_block: INTEGER_64; end_block: INTEGER_64; start_date: DATE_TIME; end_date: DATE_TIME)
			-- 
			-- 
			-- 
		...
		do
			...
			l_path := "/chains/{chain_id}/dapps/curve/gaugeTypeWeight/historical"
