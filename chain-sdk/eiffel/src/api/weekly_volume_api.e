...
feature -- API Access
	...
	chains_chain_id_dapps_curve_weekly_volume_historical_get (chain_id: STRING_32; start_block: INTEGER_64; end_block: INTEGER_64; start_date: DATE_TIME; end_date: DATE_TIME; pool_id: STRING_32)
			-- 
			-- 
			-- 
		...
		do
			...
			l_path := "/chains/{chain_id}/dapps/curve/weeklyVolume/historical"
