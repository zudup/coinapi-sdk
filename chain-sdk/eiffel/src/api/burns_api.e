...
feature -- API Access
	...
	chains_chain_id_dapps_sushiswap_burns_historical_get (chain_id: STRING_32; start_block: INTEGER_64; end_block: INTEGER_64; start_date: DATE_TIME; end_date: DATE_TIME; pool_id: STRING_32)
			-- 
			-- 
			-- 
		...
		do
			...
			l_path := "/chains/{chain_id}/dapps/sushiswap/burns/historical"
	...
	chains_chain_id_dapps_uniswapv2_burns_historical_get (chain_id: STRING_32; start_block: INTEGER_64; end_block: INTEGER_64; start_date: DATE_TIME; end_date: DATE_TIME; pool_id: STRING_32)
			-- 
			-- 
			-- 
			-- argument: chain_id  (required)
		...
		do
			...
			l_path := "/chains/{chain_id}/dapps/uniswapv2/burns/historical"
			l_path.replace_substring_all ("{"+"chain_id"+"}", api_client.url_encode (chain_id.out))
			l_request.fill_query_params(api_client.parameter_to_tuple("", "startBlock", start_block));
			l_request.fill_query_params(api_client.parameter_to_tuple("", "endBlock", end_block));
			l_request.fill_query_params(api_client.parameter_to_tuple("", "startDate", start_date));
	...
	chains_chain_id_dapps_uniswapv3_burns_historical_get (chain_id: STRING_32; start_block: INTEGER_64; end_block: INTEGER_64; start_date: DATE_TIME; end_date: DATE_TIME; pool_id: STRING_32)
			-- 
			-- 
			-- 
			-- argument: chain_id  (required)
		...
		do
			...
			l_path := "/chains/{chain_id}/dapps/uniswapv3/burns/historical"
			l_path.replace_substring_all ("{"+"chain_id"+"}", api_client.url_encode (chain_id.out))
			l_request.fill_query_params(api_client.parameter_to_tuple("", "startBlock", start_block));
			l_request.fill_query_params(api_client.parameter_to_tuple("", "endBlock", end_block));
			l_request.fill_query_params(api_client.parameter_to_tuple("", "startDate", start_date));
