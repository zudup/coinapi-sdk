...
feature -- Change Element
    ...
    set_needs_complete (a_name: like needs_complete)
        -- Set 'needs_complete' with 'a_name'.
      do
        needs_complete := a_name
      ensure
        needs_complete_set: needs_complete = a_name
      end
 ...
 feature -- Status Report
    ...
    output: STRING
      ...
      do
        ...
        Result.append("%Nclass UNISWAP_V2_BURN_V2_DTO%N")
        ...
        if attached needs_complete as l_needs_complete then
          Result.append ("%Nneeds_complete:")
          Result.append (l_needs_complete.out)
          Result.append ("%N")
        end
