...
class UNISWAP_V3_UNISWAP_DAY_DATA_V3_DTO
...
feature -- Change Element
    ...
    set_volume_usd_untracked (a_name: like volume_usd_untracked)
        -- Set 'volume_usd_untracked' with 'a_name'.
      do
        volume_usd_untracked := a_name
      ensure
        volume_usd_untracked_set: volume_usd_untracked = a_name
      end
 ...
 feature -- Status Report
    ...
    output: STRING
      ...
      do
        ...
        Result.append("%Nclass UNISWAP_V3_UNISWAP_DAY_DATA_V3_DTO%N")
        ...
        if attached volume_usd_untracked as l_volume_usd_untracked then
          Result.append ("%Nvolume_usd_untracked:")
          Result.append (l_volume_usd_untracked.out)
          Result.append ("%N")
        end
