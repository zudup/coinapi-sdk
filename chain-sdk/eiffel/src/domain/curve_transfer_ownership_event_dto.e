...
class CURVE_TRANSFER_OWNERSHIP_EVENT_DTO
...
feature --Access
    ...
    pool: detachable STRING_32
      -- 
    new_admin: detachable STRING_32
      -- 
...
feature -- Change Element
    ...
    set_new_admin (a_name: like new_admin)
        -- Set 'new_admin' with 'a_name'.
      do
        new_admin := a_name
      ensure
        new_admin_set: new_admin = a_name
      end
 ...
 feature -- Status Report
    ...
    output: STRING
      ...
      do
        ...
        Result.append("%Nclass CURVE_TRANSFER_OWNERSHIP_EVENT_DTO%N")
        ...
        if attached new_admin as l_new_admin then
          Result.append ("%Nnew_admin:")
          Result.append (l_new_admin.out)
          Result.append ("%N")
        end
