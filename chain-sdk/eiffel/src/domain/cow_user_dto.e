...
feature -- Change Element
    ...
    set_is_solver (a_name: like is_solver)
        -- Set 'is_solver' with 'a_name'.
      do
        is_solver := a_name
      ensure
        is_solver_set: is_solver = a_name
      end
 ...
 feature -- Status Report
    ...
    output: STRING
      ...
      do
        ...
        Result.append("%Nclass COW_USER_DTO%N")
        ...
        if attached is_solver as l_is_solver then
          Result.append ("%Nis_solver:")
          Result.append (l_is_solver.out)
          Result.append ("%N")
        end
