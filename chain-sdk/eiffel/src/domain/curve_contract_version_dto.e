...
class CURVE_CONTRACT_VERSION_DTO
...
feature -- Change Element
    ...
    set_contract (a_name: like contract)
        -- Set 'contract' with 'a_name'.
      do
        contract := a_name
      ensure
        contract_set: contract = a_name
      end
 ...
 feature -- Status Report
    ...
    output: STRING
      ...
      do
        ...
        Result.append("%Nclass CURVE_CONTRACT_VERSION_DTO%N")
        ...
        if attached contract as l_contract then
          Result.append ("%Ncontract:")
          Result.append (l_contract.out)
          Result.append ("%N")
        end
