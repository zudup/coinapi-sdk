...
feature -- Test routines
    ...
    test_chains_chain_id_dapps_sushiswap_token_day_data_historical_get
            -- 
            --
            -- 
        local
        ...
        do
            ...
            -- api.chains_chain_id_dapps_sushiswap_token_day_data_historical_get(l_chain_id, l_start_block, l_end_block, l_start_date, l_end_date, l_token_id)
            assert ("not_implemented", False)
        end

    test_chains_chain_id_dapps_uniswapv2_token_day_data_historical_get
            -- 
            --
            -- 
        local
        ...
        do
            ...
            -- api.chains_chain_id_dapps_uniswapv2_token_day_data_historical_get(l_chain_id, l_start_block, l_end_block, l_start_date, l_end_date, l_token_id)
            assert ("not_implemented", False)
        end
