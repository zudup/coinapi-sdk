...
type UniswapV3FactoryV3DTO struct {
...
func (o *UniswapV3FactoryV3DTO) SetIdNil() {
	o.Id.Set(nil)
}
...
func (o *UniswapV3FactoryV3DTO) SetPoolCountNil() {
	o.PoolCount.Set(nil)
}
...
func (o *UniswapV3FactoryV3DTO) SetTxCountNil() {
	o.TxCount.Set(nil)
}
...
func (o *UniswapV3FactoryV3DTO) SetTotalVolumeUsdNil() {
...
func (o *UniswapV3FactoryV3DTO) SetTotalVolumeEthNil() {
...
func (o *UniswapV3FactoryV3DTO) SetTotalFeesUsdNil() {
...
func (o *UniswapV3FactoryV3DTO) SetTotalFeesEthNil() {
...
func (o *UniswapV3FactoryV3DTO) SetUntrackedVolumeUsdNil() {
...
func (o *UniswapV3FactoryV3DTO) SetTotalValueLockedUsdNil() {
...
func (o *UniswapV3FactoryV3DTO) SetTotalValueLockedEthNil() {
...
func (o *UniswapV3FactoryV3DTO) SetTotalValueLockedUsdUntrackedNil() {
...
func (o *UniswapV3FactoryV3DTO) SetTotalValueLockedEthUntrackedNil() {
...
func (o *UniswapV3FactoryV3DTO) SetOwnerNil() {
	o.Owner.Set(nil)
}
...
func (o UniswapV3FactoryV3DTO) MarshalJSON() ([]byte, error) {
...
type NullableUniswapV3FactoryV3DTO struct {
	value *UniswapV3FactoryV3DTO
	isSet bool
}

func (v NullableUniswapV3FactoryV3DTO) Get() *UniswapV3FactoryV3DTO {
	return v.value
}

func (v *NullableUniswapV3FactoryV3DTO) Set(val *UniswapV3FactoryV3DTO) {
	v.value = val
	v.isSet = true
}

func (v NullableUniswapV3FactoryV3DTO) IsSet() bool {
	return v.isSet
}

func (v *NullableUniswapV3FactoryV3DTO) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableUniswapV3FactoryV3DTO(val *UniswapV3FactoryV3DTO) *NullableUniswapV3FactoryV3DTO {
	return &NullableUniswapV3FactoryV3DTO{value: val, isSet: true}
}

func (v NullableUniswapV3FactoryV3DTO) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableUniswapV3FactoryV3DTO) UnmarshalJSON(src []byte) error {
	v.isSet = true
