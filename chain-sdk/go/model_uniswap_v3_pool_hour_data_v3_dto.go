...
type UniswapV3PoolHourDataV3DTO struct {
...
func NewUniswapV3PoolHourDataV3DTO() *UniswapV3PoolHourDataV3DTO {
	this := UniswapV3PoolHourDataV3DTO{}
	return &this
}
...
func (o *UniswapV3PoolHourDataV3DTO) SetIdNil() {
	o.Id.Set(nil)
}
...
func (o *UniswapV3PoolHourDataV3DTO) SetPoolNil() {
	o.Pool.Set(nil)
}
...
func (o *UniswapV3PoolHourDataV3DTO) SetLiquidityNil() {
	o.Liquidity.Set(nil)
}
...
func (o *UniswapV3PoolHourDataV3DTO) SetSqrtPriceNil() {
	o.SqrtPrice.Set(nil)
}
...
func (o *UniswapV3PoolHourDataV3DTO) SetToken0PriceNil() {
...
func (o *UniswapV3PoolHourDataV3DTO) SetToken1PriceNil() {
...
func (o *UniswapV3PoolHourDataV3DTO) SetTickNil() {
	o.Tick.Set(nil)
}
...
func (o *UniswapV3PoolHourDataV3DTO) SetFeeGrowthGlobal0x128Nil() {
...
func (o *UniswapV3PoolHourDataV3DTO) SetFeeGrowthGlobal1x128Nil() {
...
func (o *UniswapV3PoolHourDataV3DTO) SetTvlUsdNil() {
	o.TvlUsd.Set(nil)
}
...
func (o *UniswapV3PoolHourDataV3DTO) SetVolumeToken0Nil() {
...
func (o *UniswapV3PoolHourDataV3DTO) SetVolumeToken1Nil() {
...
func (o *UniswapV3PoolHourDataV3DTO) SetVolumeUsdNil() {
	o.VolumeUsd.Set(nil)
}
...
func (o *UniswapV3PoolHourDataV3DTO) SetFeesUsdNil() {
	o.FeesUsd.Set(nil)
}
...
func (o *UniswapV3PoolHourDataV3DTO) SetTxCountNil() {
	o.TxCount.Set(nil)
}
...
func (o *UniswapV3PoolHourDataV3DTO) SetOpenNil() {
	o.Open.Set(nil)
}
...
func (o *UniswapV3PoolHourDataV3DTO) SetHighNil() {
	o.High.Set(nil)
}
...
func (o *UniswapV3PoolHourDataV3DTO) SetLowNil() {
	o.Low.Set(nil)
}
...
func (o *UniswapV3PoolHourDataV3DTO) SetCloseNil() {
	o.Close.Set(nil)
}
...
func (o UniswapV3PoolHourDataV3DTO) MarshalJSON() ([]byte, error) {
...
type NullableUniswapV3PoolHourDataV3DTO struct {
	value *UniswapV3PoolHourDataV3DTO
	isSet bool
}

func (v NullableUniswapV3PoolHourDataV3DTO) Get() *UniswapV3PoolHourDataV3DTO {
	return v.value
}

func (v *NullableUniswapV3PoolHourDataV3DTO) Set(val *UniswapV3PoolHourDataV3DTO) {
	v.value = val
	v.isSet = true
}

func (v NullableUniswapV3PoolHourDataV3DTO) IsSet() bool {
	return v.isSet
}

func (v *NullableUniswapV3PoolHourDataV3DTO) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableUniswapV3PoolHourDataV3DTO(val *UniswapV3PoolHourDataV3DTO) *NullableUniswapV3PoolHourDataV3DTO {
	return &NullableUniswapV3PoolHourDataV3DTO{value: val, isSet: true}
}

func (v NullableUniswapV3PoolHourDataV3DTO) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableUniswapV3PoolHourDataV3DTO) UnmarshalJSON(src []byte) error {
	v.isSet = true
