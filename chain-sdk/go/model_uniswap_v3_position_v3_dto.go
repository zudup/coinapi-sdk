...
type UniswapV3PositionV3DTO struct {
...
func (o *UniswapV3PositionV3DTO) SetIdNil() {
	o.Id.Set(nil)
}
...
func (o *UniswapV3PositionV3DTO) SetOwnerNil() {
	o.Owner.Set(nil)
}
...
func (o *UniswapV3PositionV3DTO) SetPoolNil() {
	o.Pool.Set(nil)
}
...
func (o *UniswapV3PositionV3DTO) SetToken0Nil() {
	o.Token0.Set(nil)
}
...
func (o *UniswapV3PositionV3DTO) SetToken1Nil() {
	o.Token1.Set(nil)
}
...
func (o *UniswapV3PositionV3DTO) SetTickLowerNil() {
	o.TickLower.Set(nil)
}
...
func (o *UniswapV3PositionV3DTO) SetTickUpperNil() {
	o.TickUpper.Set(nil)
}
...
func (o *UniswapV3PositionV3DTO) SetLiquidityNil() {
	o.Liquidity.Set(nil)
}
...
func (o *UniswapV3PositionV3DTO) SetDepositedToken0Nil() {
...
func (o *UniswapV3PositionV3DTO) SetDepositedToken1Nil() {
...
func (o *UniswapV3PositionV3DTO) SetWithdrawnToken0Nil() {
...
func (o *UniswapV3PositionV3DTO) SetWithdrawnToken1Nil() {
...
func (o *UniswapV3PositionV3DTO) SetCollectedFeesToken0Nil() {
...
func (o *UniswapV3PositionV3DTO) SetCollectedFeesToken1Nil() {
...
func (o *UniswapV3PositionV3DTO) SetTransactionNil() {
...
func (o *UniswapV3PositionV3DTO) SetFeeGrowthInside0LastX128Nil() {
...
func (o *UniswapV3PositionV3DTO) SetFeeGrowthInside1LastX128Nil() {
...
func (o UniswapV3PositionV3DTO) MarshalJSON() ([]byte, error) {
...
type NullableUniswapV3PositionV3DTO struct {
	value *UniswapV3PositionV3DTO
	isSet bool
}

func (v NullableUniswapV3PositionV3DTO) Get() *UniswapV3PositionV3DTO {
	return v.value
}

func (v *NullableUniswapV3PositionV3DTO) Set(val *UniswapV3PositionV3DTO) {
	v.value = val
	v.isSet = true
}

func (v NullableUniswapV3PositionV3DTO) IsSet() bool {
	return v.isSet
}

func (v *NullableUniswapV3PositionV3DTO) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableUniswapV3PositionV3DTO(val *UniswapV3PositionV3DTO) *NullableUniswapV3PositionV3DTO {
	return &NullableUniswapV3PositionV3DTO{value: val, isSet: true}
}

func (v NullableUniswapV3PositionV3DTO) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableUniswapV3PositionV3DTO) UnmarshalJSON(src []byte) error {
	v.isSet = true
