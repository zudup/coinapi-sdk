...
// UniswapV2BurnV2DTO Burn entities are created for every emitted Burn event on the Uniswap core contracts. The Burn entity stores key data about the event like token amounts, who burned LP tokens, who received tokens, and more. This entity can be used to track liquidity removals on pairs.
type UniswapV2BurnV2DTO struct {
...
func (o *UniswapV2BurnV2DTO) SetIdNil() {
	o.Id.Set(nil)
}
...
func (o *UniswapV2BurnV2DTO) SetTransactionNil() {
...
func (o *UniswapV2BurnV2DTO) SetTimestampNil() {
	o.Timestamp.Set(nil)
}
...
func (o *UniswapV2BurnV2DTO) SetPairNil() {
	o.Pair.Set(nil)
}
...
func (o *UniswapV2BurnV2DTO) SetLiquidityNil() {
	o.Liquidity.Set(nil)
}
...
func (o *UniswapV2BurnV2DTO) SetSenderNil() {
	o.Sender.Set(nil)
}
...
func (o *UniswapV2BurnV2DTO) SetAmount0Nil() {
	o.Amount0.Set(nil)
}
...
func (o *UniswapV2BurnV2DTO) SetAmount1Nil() {
	o.Amount1.Set(nil)
}
...
func (o *UniswapV2BurnV2DTO) SetToNil() {
	o.To.Set(nil)
}
...
func (o *UniswapV2BurnV2DTO) SetLogIndexNil() {
	o.LogIndex.Set(nil)
}
...
func (o *UniswapV2BurnV2DTO) SetAmountUsdNil() {
	o.AmountUsd.Set(nil)
}
...
func (o *UniswapV2BurnV2DTO) SetFeeToNil() {
	o.FeeTo.Set(nil)
}
...
func (o *UniswapV2BurnV2DTO) SetFeeLiquidityNil() {
...
func (o UniswapV2BurnV2DTO) MarshalJSON() ([]byte, error) {
...
type NullableUniswapV2BurnV2DTO struct {
	value *UniswapV2BurnV2DTO
	isSet bool
}

func (v NullableUniswapV2BurnV2DTO) Get() *UniswapV2BurnV2DTO {
	return v.value
}

func (v *NullableUniswapV2BurnV2DTO) Set(val *UniswapV2BurnV2DTO) {
	v.value = val
	v.isSet = true
}

func (v NullableUniswapV2BurnV2DTO) IsSet() bool {
	return v.isSet
}

func (v *NullableUniswapV2BurnV2DTO) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableUniswapV2BurnV2DTO(val *UniswapV2BurnV2DTO) *NullableUniswapV2BurnV2DTO {
	return &NullableUniswapV2BurnV2DTO{value: val, isSet: true}
}

func (v NullableUniswapV2BurnV2DTO) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableUniswapV2BurnV2DTO) UnmarshalJSON(src []byte) error {
	v.isSet = true
