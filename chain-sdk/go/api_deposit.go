...
*/
func (a *DepositApiService) ChainsChainIdDappsDexTokensHistoricalGet(ctx context.Context, chainId string) ApiChainsChainIdDappsDexTokensHistoricalGetRequest {
	return ApiChainsChainIdDappsDexTokensHistoricalGetRequest{
		ApiService: a,
		ctx: ctx,
		chainId: chainId,
...
func (a *DepositApiService) ChainsChainIdDappsDexTokensHistoricalGetExecute(r ApiChainsChainIdDappsDexTokensHistoricalGetRequest) (*http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "DepositApiService.ChainsChainIdDappsDexTokensHistoricalGet")
	if err != nil {
