...
type UniswapV3BurnV3DTO struct {
...
func (o *UniswapV3BurnV3DTO) SetIdNil() {
	o.Id.Set(nil)
}
...
func (o *UniswapV3BurnV3DTO) SetTransactionNil() {
...
func (o *UniswapV3BurnV3DTO) SetPoolNil() {
	o.Pool.Set(nil)
}
...
func (o *UniswapV3BurnV3DTO) SetToken0Nil() {
	o.Token0.Set(nil)
}
...
func (o *UniswapV3BurnV3DTO) SetToken1Nil() {
	o.Token1.Set(nil)
}
...
func (o *UniswapV3BurnV3DTO) SetTimestampNil() {
	o.Timestamp.Set(nil)
}
...
func (o *UniswapV3BurnV3DTO) SetOwnerNil() {
	o.Owner.Set(nil)
}
...
func (o *UniswapV3BurnV3DTO) SetOriginNil() {
	o.Origin.Set(nil)
}
...
func (o *UniswapV3BurnV3DTO) SetAmountNil() {
	o.Amount.Set(nil)
}
...
func (o *UniswapV3BurnV3DTO) SetAmount0Nil() {
	o.Amount0.Set(nil)
}
...
func (o *UniswapV3BurnV3DTO) SetAmount1Nil() {
	o.Amount1.Set(nil)
}
...
func (o *UniswapV3BurnV3DTO) SetAmountUsdNil() {
	o.AmountUsd.Set(nil)
}
...
func (o *UniswapV3BurnV3DTO) SetTickLowerNil() {
	o.TickLower.Set(nil)
}
...
func (o *UniswapV3BurnV3DTO) SetTickUpperNil() {
	o.TickUpper.Set(nil)
}
...
func (o *UniswapV3BurnV3DTO) SetLogIndexNil() {
	o.LogIndex.Set(nil)
}
...
func (o UniswapV3BurnV3DTO) MarshalJSON() ([]byte, error) {
...
type NullableUniswapV3BurnV3DTO struct {
	value *UniswapV3BurnV3DTO
	isSet bool
}

func (v NullableUniswapV3BurnV3DTO) Get() *UniswapV3BurnV3DTO {
	return v.value
}

func (v *NullableUniswapV3BurnV3DTO) Set(val *UniswapV3BurnV3DTO) {
	v.value = val
	v.isSet = true
}

func (v NullableUniswapV3BurnV3DTO) IsSet() bool {
	return v.isSet
}

func (v *NullableUniswapV3BurnV3DTO) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableUniswapV3BurnV3DTO(val *UniswapV3BurnV3DTO) *NullableUniswapV3BurnV3DTO {
	return &NullableUniswapV3BurnV3DTO{value: val, isSet: true}
}

func (v NullableUniswapV3BurnV3DTO) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableUniswapV3BurnV3DTO) UnmarshalJSON(src []byte) error {
	v.isSet = true
