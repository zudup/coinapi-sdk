...
// UniswapV2UniswapDayDataV2DTO Tracks data across all pairs aggregated into a daily bucket.
type UniswapV2UniswapDayDataV2DTO struct {
...
func NewUniswapV2UniswapDayDataV2DTO() *UniswapV2UniswapDayDataV2DTO {
	this := UniswapV2UniswapDayDataV2DTO{}
	return &this
}
...
func (o *UniswapV2UniswapDayDataV2DTO) SetIdNil() {
	o.Id.Set(nil)
}
...
func (o *UniswapV2UniswapDayDataV2DTO) SetDailyVolumeEthNil() {
...
func (o *UniswapV2UniswapDayDataV2DTO) SetDailyVolumeUsdNil() {
...
func (o *UniswapV2UniswapDayDataV2DTO) SetDailyVolumeUntrackedNil() {
...
func (o *UniswapV2UniswapDayDataV2DTO) SetTotalVolumeEthNil() {
...
func (o *UniswapV2UniswapDayDataV2DTO) SetTotalLiquidityEthNil() {
...
func (o *UniswapV2UniswapDayDataV2DTO) SetTotalVolumeUsdNil() {
...
func (o *UniswapV2UniswapDayDataV2DTO) SetTotalLiquidityUsdNil() {
...
func (o *UniswapV2UniswapDayDataV2DTO) SetTxCountNil() {
	o.TxCount.Set(nil)
}
...
func (o UniswapV2UniswapDayDataV2DTO) MarshalJSON() ([]byte, error) {
...
type NullableUniswapV2UniswapDayDataV2DTO struct {
	value *UniswapV2UniswapDayDataV2DTO
	isSet bool
}

func (v NullableUniswapV2UniswapDayDataV2DTO) Get() *UniswapV2UniswapDayDataV2DTO {
	return v.value
}

func (v *NullableUniswapV2UniswapDayDataV2DTO) Set(val *UniswapV2UniswapDayDataV2DTO) {
	v.value = val
	v.isSet = true
}

func (v NullableUniswapV2UniswapDayDataV2DTO) IsSet() bool {
	return v.isSet
}

func (v *NullableUniswapV2UniswapDayDataV2DTO) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableUniswapV2UniswapDayDataV2DTO(val *UniswapV2UniswapDayDataV2DTO) *NullableUniswapV2UniswapDayDataV2DTO {
	return &NullableUniswapV2UniswapDayDataV2DTO{value: val, isSet: true}
}

func (v NullableUniswapV2UniswapDayDataV2DTO) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableUniswapV2UniswapDayDataV2DTO) UnmarshalJSON(src []byte) error {
	v.isSet = true
