...
// UniswapV3TransactionV3DTO struct for UniswapV3TransactionV3DTO
type UniswapV3TransactionV3DTO struct {
...
func NewUniswapV3TransactionV3DTO() *UniswapV3TransactionV3DTO {
	this := UniswapV3TransactionV3DTO{}
	return &this
}
...
func (o *UniswapV3TransactionV3DTO) SetIdNil() {
	o.Id.Set(nil)
}
...
func (o *UniswapV3TransactionV3DTO) SetTimestampNil() {
	o.Timestamp.Set(nil)
}
...
func (o *UniswapV3TransactionV3DTO) SetGasUsedNil() {
	o.GasUsed.Set(nil)
}
...
func (o *UniswapV3TransactionV3DTO) SetGasPriceNil() {
	o.GasPrice.Set(nil)
}
...
func (o UniswapV3TransactionV3DTO) MarshalJSON() ([]byte, error) {
...
type NullableUniswapV3TransactionV3DTO struct {
	value *UniswapV3TransactionV3DTO
	isSet bool
}

func (v NullableUniswapV3TransactionV3DTO) Get() *UniswapV3TransactionV3DTO {
	return v.value
}

func (v *NullableUniswapV3TransactionV3DTO) Set(val *UniswapV3TransactionV3DTO) {
	v.value = val
	v.isSet = true
}

func (v NullableUniswapV3TransactionV3DTO) IsSet() bool {
	return v.isSet
}

func (v *NullableUniswapV3TransactionV3DTO) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableUniswapV3TransactionV3DTO(val *UniswapV3TransactionV3DTO) *NullableUniswapV3TransactionV3DTO {
	return &NullableUniswapV3TransactionV3DTO{value: val, isSet: true}
}

func (v NullableUniswapV3TransactionV3DTO) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableUniswapV3TransactionV3DTO) UnmarshalJSON(src []byte) error {
	v.isSet = true
