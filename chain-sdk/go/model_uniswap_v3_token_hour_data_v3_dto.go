...
type UniswapV3TokenHourDataV3DTO struct {
...
func NewUniswapV3TokenHourDataV3DTO() *UniswapV3TokenHourDataV3DTO {
	this := UniswapV3TokenHourDataV3DTO{}
	return &this
}
...
func (o *UniswapV3TokenHourDataV3DTO) SetIdNil() {
	o.Id.Set(nil)
}
...
func (o *UniswapV3TokenHourDataV3DTO) SetTokenNil() {
	o.Token.Set(nil)
}
...
func (o *UniswapV3TokenHourDataV3DTO) SetVolumeNil() {
	o.Volume.Set(nil)
}
...
func (o *UniswapV3TokenHourDataV3DTO) SetVolumeUsdNil() {
	o.VolumeUsd.Set(nil)
}
...
func (o *UniswapV3TokenHourDataV3DTO) SetUntrackedVolumeUsdNil() {
...
func (o *UniswapV3TokenHourDataV3DTO) SetTotalValueLockedNil() {
...
func (o *UniswapV3TokenHourDataV3DTO) SetTotalValueLockedUsdNil() {
...
func (o *UniswapV3TokenHourDataV3DTO) SetPriceUsdNil() {
	o.PriceUsd.Set(nil)
}
...
func (o *UniswapV3TokenHourDataV3DTO) SetFeesUsdNil() {
	o.FeesUsd.Set(nil)
}
...
func (o *UniswapV3TokenHourDataV3DTO) SetOpenNil() {
	o.Open.Set(nil)
}
...
func (o *UniswapV3TokenHourDataV3DTO) SetHighNil() {
	o.High.Set(nil)
}
...
func (o *UniswapV3TokenHourDataV3DTO) SetLowNil() {
	o.Low.Set(nil)
}
...
func (o *UniswapV3TokenHourDataV3DTO) SetCloseNil() {
	o.Close.Set(nil)
}
...
func (o UniswapV3TokenHourDataV3DTO) MarshalJSON() ([]byte, error) {
...
type NullableUniswapV3TokenHourDataV3DTO struct {
	value *UniswapV3TokenHourDataV3DTO
	isSet bool
}

func (v NullableUniswapV3TokenHourDataV3DTO) Get() *UniswapV3TokenHourDataV3DTO {
	return v.value
}

func (v *NullableUniswapV3TokenHourDataV3DTO) Set(val *UniswapV3TokenHourDataV3DTO) {
	v.value = val
	v.isSet = true
}

func (v NullableUniswapV3TokenHourDataV3DTO) IsSet() bool {
	return v.isSet
}

func (v *NullableUniswapV3TokenHourDataV3DTO) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableUniswapV3TokenHourDataV3DTO(val *UniswapV3TokenHourDataV3DTO) *NullableUniswapV3TokenHourDataV3DTO {
	return &NullableUniswapV3TokenHourDataV3DTO{value: val, isSet: true}
}

func (v NullableUniswapV3TokenHourDataV3DTO) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableUniswapV3TokenHourDataV3DTO) UnmarshalJSON(src []byte) error {
	v.isSet = true
