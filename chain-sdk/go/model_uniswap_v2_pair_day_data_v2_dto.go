...
// UniswapV2PairDayDataV2DTO Tracks pair data across each day.
type UniswapV2PairDayDataV2DTO struct {
...
func NewUniswapV2PairDayDataV2DTO() *UniswapV2PairDayDataV2DTO {
	this := UniswapV2PairDayDataV2DTO{}
	return &this
}
...
func (o *UniswapV2PairDayDataV2DTO) SetIdNil() {
	o.Id.Set(nil)
}
...
func (o *UniswapV2PairDayDataV2DTO) SetPairAddressNil() {
...
func (o *UniswapV2PairDayDataV2DTO) SetToken0Nil() {
	o.Token0.Set(nil)
}
...
func (o *UniswapV2PairDayDataV2DTO) SetToken1Nil() {
	o.Token1.Set(nil)
}
...
func (o *UniswapV2PairDayDataV2DTO) SetReserve0Nil() {
	o.Reserve0.Set(nil)
}
...
func (o *UniswapV2PairDayDataV2DTO) SetReserve1Nil() {
	o.Reserve1.Set(nil)
}
...
func (o *UniswapV2PairDayDataV2DTO) SetTotalSupplyNil() {
...
func (o *UniswapV2PairDayDataV2DTO) SetReserveUsdNil() {
...
func (o *UniswapV2PairDayDataV2DTO) SetDailyVolumeToken0Nil() {
...
func (o *UniswapV2PairDayDataV2DTO) SetDailyVolumeToken1Nil() {
...
func (o *UniswapV2PairDayDataV2DTO) SetDailyVolumeUsdNil() {
...
func (o *UniswapV2PairDayDataV2DTO) SetDailyTxnsNil() {
	o.DailyTxns.Set(nil)
}
...
func (o UniswapV2PairDayDataV2DTO) MarshalJSON() ([]byte, error) {
...
type NullableUniswapV2PairDayDataV2DTO struct {
	value *UniswapV2PairDayDataV2DTO
	isSet bool
}

func (v NullableUniswapV2PairDayDataV2DTO) Get() *UniswapV2PairDayDataV2DTO {
	return v.value
}

func (v *NullableUniswapV2PairDayDataV2DTO) Set(val *UniswapV2PairDayDataV2DTO) {
	v.value = val
	v.isSet = true
}

func (v NullableUniswapV2PairDayDataV2DTO) IsSet() bool {
	return v.isSet
}

func (v *NullableUniswapV2PairDayDataV2DTO) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableUniswapV2PairDayDataV2DTO(val *UniswapV2PairDayDataV2DTO) *NullableUniswapV2PairDayDataV2DTO {
	return &NullableUniswapV2PairDayDataV2DTO{value: val, isSet: true}
}

func (v NullableUniswapV2PairDayDataV2DTO) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableUniswapV2PairDayDataV2DTO) UnmarshalJSON(src []byte) error {
	v.isSet = true
