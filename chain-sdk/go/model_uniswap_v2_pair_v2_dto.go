...
type UniswapV2PairV2DTO struct {
...
func (o *UniswapV2PairV2DTO) SetIdNil() {
	o.Id.Set(nil)
}
...
func (o *UniswapV2PairV2DTO) SetToken0Nil() {
	o.Token0.Set(nil)
}
...
func (o *UniswapV2PairV2DTO) SetToken1Nil() {
	o.Token1.Set(nil)
}
...
func (o *UniswapV2PairV2DTO) SetReserve0Nil() {
	o.Reserve0.Set(nil)
}
...
func (o *UniswapV2PairV2DTO) SetReserve1Nil() {
	o.Reserve1.Set(nil)
}
...
func (o *UniswapV2PairV2DTO) SetTotalSupplyNil() {
...
func (o *UniswapV2PairV2DTO) SetReserveEthNil() {
...
func (o *UniswapV2PairV2DTO) SetReserveUsdNil() {
...
func (o *UniswapV2PairV2DTO) SetTrackedReserveEthNil() {
...
func (o *UniswapV2PairV2DTO) SetToken0PriceNil() {
...
func (o *UniswapV2PairV2DTO) SetToken1PriceNil() {
...
func (o *UniswapV2PairV2DTO) SetVolumeToken0Nil() {
...
func (o *UniswapV2PairV2DTO) SetVolumeToken1Nil() {
...
func (o *UniswapV2PairV2DTO) SetVolumeUsdNil() {
	o.VolumeUsd.Set(nil)
}
...
func (o *UniswapV2PairV2DTO) SetUntrackedVolumeUsdNil() {
...
func (o *UniswapV2PairV2DTO) SetLiquidityProviderCountNil() {
...
func (o UniswapV2PairV2DTO) MarshalJSON() ([]byte, error) {
...
type NullableUniswapV2PairV2DTO struct {
	value *UniswapV2PairV2DTO
	isSet bool
}

func (v NullableUniswapV2PairV2DTO) Get() *UniswapV2PairV2DTO {
	return v.value
}

func (v *NullableUniswapV2PairV2DTO) Set(val *UniswapV2PairV2DTO) {
	v.value = val
	v.isSet = true
}

func (v NullableUniswapV2PairV2DTO) IsSet() bool {
	return v.isSet
}

func (v *NullableUniswapV2PairV2DTO) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableUniswapV2PairV2DTO(val *UniswapV2PairV2DTO) *NullableUniswapV2PairV2DTO {
	return &NullableUniswapV2PairV2DTO{value: val, isSet: true}
}

func (v NullableUniswapV2PairV2DTO) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableUniswapV2PairV2DTO) UnmarshalJSON(src []byte) error {
	v.isSet = true
