...
// PoolV3DTO struct for PoolV3DTO
...
// SetFeeTier gets a reference to the given BigInteger and assigns it to the FeeTier field.
...
// SetLiquidity gets a reference to the given BigInteger and assigns it to the Liquidity field.
...
// SetSqrtPrice gets a reference to the given BigInteger and assigns it to the SqrtPrice field.
...
func (o *PoolV3DTO) GetFeeGrowthGlobal0x128() BigInteger {
	if o == nil || o.FeeGrowthGlobal0x128 == nil {
		var ret BigInteger
		return ret
	}
...
// SetFeeGrowthGlobal0x128 gets a reference to the given BigInteger and assigns it to the FeeGrowthGlobal0x128 field.
...
func (o *PoolV3DTO) GetFeeGrowthGlobal1x128() BigInteger {
	if o == nil || o.FeeGrowthGlobal1x128 == nil {
		var ret BigInteger
		return ret
	}
...
// SetFeeGrowthGlobal1x128 gets a reference to the given BigInteger and assigns it to the FeeGrowthGlobal1x128 field.
...
func (o *PoolV3DTO) SetToken0PriceNil() {
...
func (o *PoolV3DTO) SetToken1PriceNil() {
...
func (o *PoolV3DTO) GetObservationIndex() BigInteger {
	if o == nil || o.ObservationIndex == nil {
		var ret BigInteger
		return ret
	}
...
// SetObservationIndex gets a reference to the given BigInteger and assigns it to the ObservationIndex field.
...
func (o *PoolV3DTO) SetVolumeToken0Nil() {
...
func (o *PoolV3DTO) SetVolumeToken1Nil() {
...
func (o *PoolV3DTO) SetVolumeUsdNil() {
	o.VolumeUsd.Set(nil)
}
...
func (o *PoolV3DTO) SetUntrackedVolumeUsdNil() {
...
func (o *PoolV3DTO) SetFeesUsdNil() {
	o.FeesUsd.Set(nil)
}
...
func (o *PoolV3DTO) SetCollectedFeesToken0Nil() {
...
func (o *PoolV3DTO) SetCollectedFeesToken1Nil() {
...
func (o *PoolV3DTO) SetCollectedFeesUsdNil() {
...
func (o *PoolV3DTO) GetTotalValueLockedToken0() string {
	if o == nil || o.TotalValueLockedToken0.Get() == nil {
		var ret string
		return ret
	}
...
func (o *PoolV3DTO) SetTotalValueLockedToken0Nil() {
...
func (o *PoolV3DTO) GetTotalValueLockedToken1() string {
	if o == nil || o.TotalValueLockedToken1.Get() == nil {
		var ret string
		return ret
	}
...
func (o *PoolV3DTO) SetTotalValueLockedToken1Nil() {
...
func (o *PoolV3DTO) SetTotalValueLockedEthNil() {
...
func (o *PoolV3DTO) SetTotalValueLockedUsdNil() {
...
func (o *PoolV3DTO) SetTotalValueLockedUsdUntrackedNil() {
...
func (o *PoolV3DTO) SetLiquidityProviderCountNil() {
...
func (o PoolV3DTO) MarshalJSON() ([]byte, error) {
	...
	if o.FeeGrowthGlobal0x128 != nil {
		toSerialize["fee_growth_global_0x128"] = o.FeeGrowthGlobal0x128
	}
	if o.FeeGrowthGlobal1x128 != nil {
...
type NullablePoolV3DTO struct {
	value *PoolV3DTO
	isSet bool
}

func (v NullablePoolV3DTO) Get() *PoolV3DTO {
	return v.value
}

func (v *NullablePoolV3DTO) Set(val *PoolV3DTO) {
	v.value = val
	v.isSet = true
}

func (v NullablePoolV3DTO) IsSet() bool {
	return v.isSet
}

func (v *NullablePoolV3DTO) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePoolV3DTO(val *PoolV3DTO) *NullablePoolV3DTO {
	return &NullablePoolV3DTO{value: val, isSet: true}
}

func (v NullablePoolV3DTO) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePoolV3DTO) UnmarshalJSON(src []byte) error {
	v.isSet = true
