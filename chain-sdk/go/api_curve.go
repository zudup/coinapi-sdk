...
type ApiDappsCurvePoiHistoricalGetRequest struct {
	ctx context.Context
	ApiService *CurveApiService
	startBlock *int64
	endBlock *int64
...
func (r ApiDappsCurvePoiHistoricalGetRequest) StartBlock(startBlock int64) ApiDappsCurvePoiHistoricalGetRequest {
	r.startBlock = &startBlock
	return r
}

func (r ApiDappsCurvePoiHistoricalGetRequest) EndBlock(endBlock int64) ApiDappsCurvePoiHistoricalGetRequest {
	r.endBlock = &endBlock
	return r
}

func (r ApiDappsCurvePoiHistoricalGetRequest) StartDate(startDate time.Time) ApiDappsCurvePoiHistoricalGetRequest {
	r.startDate = &startDate
	return r
}

func (r ApiDappsCurvePoiHistoricalGetRequest) EndDate(endDate time.Time) ApiDappsCurvePoiHistoricalGetRequest {
	r.endDate = &endDate
	return r
}

func (r ApiDappsCurvePoiHistoricalGetRequest) Execute() (*http.Response, error) {
	return r.ApiService.DappsCurvePoiHistoricalGetExecute(r)
}

/*
DappsCurvePoiHistoricalGet Method for DappsCurvePoiHistoricalGet

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @return ApiDappsCurvePoiHistoricalGetRequest
*/
func (a *CurveApiService) DappsCurvePoiHistoricalGet(ctx context.Context) ApiDappsCurvePoiHistoricalGetRequest {
	return ApiDappsCurvePoiHistoricalGetRequest{
		ApiService: a,
		ctx: ctx,
	}
...
// Execute executes the request
func (a *CurveApiService) DappsCurvePoiHistoricalGetExecute(r ApiDappsCurvePoiHistoricalGetRequest) (*http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "CurveApiService.DappsCurvePoiHistoricalGet")
	if err != nil {
		return nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/dapps/curve/poi/historical"
