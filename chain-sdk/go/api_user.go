...
*/
func (a *UserApiService) ChainsChainIdDappsUniswapv2UsersHistoricalGet(ctx context.Context, chainId string) ApiChainsChainIdDappsUniswapv2UsersHistoricalGetRequest {
	return ApiChainsChainIdDappsUniswapv2UsersHistoricalGetRequest{
		ApiService: a,
		ctx: ctx,
		chainId: chainId,
...
func (a *UserApiService) ChainsChainIdDappsUniswapv2UsersHistoricalGetExecute(r ApiChainsChainIdDappsUniswapv2UsersHistoricalGetRequest) (*http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "UserApiService.ChainsChainIdDappsUniswapv2UsersHistoricalGet")
	if err != nil {
