...
type UniswapV3TickV3DTO struct {
...
func (o *UniswapV3TickV3DTO) SetIdNil() {
	o.Id.Set(nil)
}
...
func (o *UniswapV3TickV3DTO) SetPoolAddressNil() {
...
func (o *UniswapV3TickV3DTO) SetPoolNil() {
	o.Pool.Set(nil)
}
...
func (o *UniswapV3TickV3DTO) SetPrice0Nil() {
	o.Price0.Set(nil)
}
...
func (o *UniswapV3TickV3DTO) SetPrice1Nil() {
	o.Price1.Set(nil)
}
...
func (o *UniswapV3TickV3DTO) SetVolumeToken0Nil() {
...
func (o *UniswapV3TickV3DTO) SetVolumeToken1Nil() {
...
func (o *UniswapV3TickV3DTO) SetVolumeUsdNil() {
	o.VolumeUsd.Set(nil)
}
...
func (o *UniswapV3TickV3DTO) SetUntrackedVolumeUsdNil() {
...
func (o *UniswapV3TickV3DTO) SetFeesUsdNil() {
	o.FeesUsd.Set(nil)
}
...
func (o *UniswapV3TickV3DTO) SetCollectedFeesToken0Nil() {
...
func (o *UniswapV3TickV3DTO) SetCollectedFeesToken1Nil() {
...
func (o *UniswapV3TickV3DTO) SetCollectedFeesUsdNil() {
...
func (o UniswapV3TickV3DTO) MarshalJSON() ([]byte, error) {
...
type NullableUniswapV3TickV3DTO struct {
	value *UniswapV3TickV3DTO
	isSet bool
}

func (v NullableUniswapV3TickV3DTO) Get() *UniswapV3TickV3DTO {
	return v.value
}

func (v *NullableUniswapV3TickV3DTO) Set(val *UniswapV3TickV3DTO) {
	v.value = val
	v.isSet = true
}

func (v NullableUniswapV3TickV3DTO) IsSet() bool {
	return v.isSet
}

func (v *NullableUniswapV3TickV3DTO) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableUniswapV3TickV3DTO(val *UniswapV3TickV3DTO) *NullableUniswapV3TickV3DTO {
	return &NullableUniswapV3TickV3DTO{value: val, isSet: true}
}

func (v NullableUniswapV3TickV3DTO) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableUniswapV3TickV3DTO) UnmarshalJSON(src []byte) error {
	v.isSet = true
