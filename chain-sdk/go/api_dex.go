...
type ApiDappsDexPoiHistoricalGetRequest struct {
	ctx context.Context
	ApiService *DexApiService
	startBlock *int64
	endBlock *int64
...
func (r ApiDappsDexPoiHistoricalGetRequest) StartBlock(startBlock int64) ApiDappsDexPoiHistoricalGetRequest {
	r.startBlock = &startBlock
	return r
}

func (r ApiDappsDexPoiHistoricalGetRequest) EndBlock(endBlock int64) ApiDappsDexPoiHistoricalGetRequest {
	r.endBlock = &endBlock
	return r
}

func (r ApiDappsDexPoiHistoricalGetRequest) StartDate(startDate time.Time) ApiDappsDexPoiHistoricalGetRequest {
	r.startDate = &startDate
	return r
}

func (r ApiDappsDexPoiHistoricalGetRequest) EndDate(endDate time.Time) ApiDappsDexPoiHistoricalGetRequest {
	r.endDate = &endDate
	return r
}

func (r ApiDappsDexPoiHistoricalGetRequest) Execute() (*http.Response, error) {
	return r.ApiService.DappsDexPoiHistoricalGetExecute(r)
}

/*
DappsDexPoiHistoricalGet Method for DappsDexPoiHistoricalGet

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @return ApiDappsDexPoiHistoricalGetRequest
*/
func (a *DexApiService) DappsDexPoiHistoricalGet(ctx context.Context) ApiDappsDexPoiHistoricalGetRequest {
	return ApiDappsDexPoiHistoricalGetRequest{
		ApiService: a,
		ctx: ctx,
	}
...
// Execute executes the request
func (a *DexApiService) DappsDexPoiHistoricalGetExecute(r ApiDappsDexPoiHistoricalGetRequest) (*http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "DexApiService.DappsDexPoiHistoricalGet")
	if err != nil {
		return nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/dapps/dex/poi/historical"
