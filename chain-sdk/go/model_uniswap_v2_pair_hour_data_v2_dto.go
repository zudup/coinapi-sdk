...
// UniswapV2PairHourDataV2DTO Tracks pair data across each hour.
type UniswapV2PairHourDataV2DTO struct {
...
func NewUniswapV2PairHourDataV2DTO() *UniswapV2PairHourDataV2DTO {
	this := UniswapV2PairHourDataV2DTO{}
	return &this
}
...
func (o *UniswapV2PairHourDataV2DTO) SetIdNil() {
	o.Id.Set(nil)
}
...
func (o *UniswapV2PairHourDataV2DTO) SetPairNil() {
	o.Pair.Set(nil)
}
...
func (o *UniswapV2PairHourDataV2DTO) SetReserve0Nil() {
	o.Reserve0.Set(nil)
}
...
func (o *UniswapV2PairHourDataV2DTO) SetReserve1Nil() {
	o.Reserve1.Set(nil)
}
...
func (o *UniswapV2PairHourDataV2DTO) SetTotalSupplyNil() {
...
func (o *UniswapV2PairHourDataV2DTO) SetReserveUsdNil() {
...
func (o *UniswapV2PairHourDataV2DTO) SetHourlyVolumeToken0Nil() {
...
func (o *UniswapV2PairHourDataV2DTO) SetHourlyVolumeToken1Nil() {
...
func (o *UniswapV2PairHourDataV2DTO) SetHourlyVolumeUsdNil() {
...
func (o *UniswapV2PairHourDataV2DTO) SetHourlyTxnsNil() {
...
func (o UniswapV2PairHourDataV2DTO) MarshalJSON() ([]byte, error) {
...
type NullableUniswapV2PairHourDataV2DTO struct {
	value *UniswapV2PairHourDataV2DTO
	isSet bool
}

func (v NullableUniswapV2PairHourDataV2DTO) Get() *UniswapV2PairHourDataV2DTO {
	return v.value
}

func (v *NullableUniswapV2PairHourDataV2DTO) Set(val *UniswapV2PairHourDataV2DTO) {
	v.value = val
	v.isSet = true
}

func (v NullableUniswapV2PairHourDataV2DTO) IsSet() bool {
	return v.isSet
}

func (v *NullableUniswapV2PairHourDataV2DTO) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableUniswapV2PairHourDataV2DTO(val *UniswapV2PairHourDataV2DTO) *NullableUniswapV2PairHourDataV2DTO {
	return &NullableUniswapV2PairHourDataV2DTO{value: val, isSet: true}
}

func (v NullableUniswapV2PairHourDataV2DTO) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableUniswapV2PairHourDataV2DTO) UnmarshalJSON(src []byte) error {
	v.isSet = true
