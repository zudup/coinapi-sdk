...
// UniswapV2TransactionV2DTO Transaction entities are created for each Ethereum transaction that contains an interaction within Uniswap contracts. Each transaction contains 3 arrays, and at least one of these arrays has a length of 1.
type UniswapV2TransactionV2DTO struct {
...
func NewUniswapV2TransactionV2DTO() *UniswapV2TransactionV2DTO {
	this := UniswapV2TransactionV2DTO{}
	return &this
}
...
func (o *UniswapV2TransactionV2DTO) SetIdNil() {
	o.Id.Set(nil)
}
...
func (o *UniswapV2TransactionV2DTO) SetTimestampNil() {
	o.Timestamp.Set(nil)
}
...
func (o UniswapV2TransactionV2DTO) MarshalJSON() ([]byte, error) {
...
type NullableUniswapV2TransactionV2DTO struct {
	value *UniswapV2TransactionV2DTO
	isSet bool
}

func (v NullableUniswapV2TransactionV2DTO) Get() *UniswapV2TransactionV2DTO {
	return v.value
}

func (v *NullableUniswapV2TransactionV2DTO) Set(val *UniswapV2TransactionV2DTO) {
	v.value = val
	v.isSet = true
}

func (v NullableUniswapV2TransactionV2DTO) IsSet() bool {
	return v.isSet
}

func (v *NullableUniswapV2TransactionV2DTO) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableUniswapV2TransactionV2DTO(val *UniswapV2TransactionV2DTO) *NullableUniswapV2TransactionV2DTO {
	return &NullableUniswapV2TransactionV2DTO{value: val, isSet: true}
}

func (v NullableUniswapV2TransactionV2DTO) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableUniswapV2TransactionV2DTO) UnmarshalJSON(src []byte) error {
	v.isSet = true
