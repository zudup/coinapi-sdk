...
type UniswapV2TokenV2DTO struct {
...
func (o *UniswapV2TokenV2DTO) SetIdNil() {
	o.Id.Set(nil)
}
...
func (o *UniswapV2TokenV2DTO) SetSymbolNil() {
	o.Symbol.Set(nil)
}
...
func (o *UniswapV2TokenV2DTO) SetNameNil() {
	o.Name.Set(nil)
}
...
func (o *UniswapV2TokenV2DTO) SetTradeVolumeNil() {
...
func (o *UniswapV2TokenV2DTO) SetTradeVolumeUsdNil() {
...
func (o *UniswapV2TokenV2DTO) SetUntrackedVolumeUsdNil() {
...
func (o *UniswapV2TokenV2DTO) SetTotalLiquidityNil() {
...
func (o *UniswapV2TokenV2DTO) SetDerivedEthNil() {
...
func (o *UniswapV2TokenV2DTO) SetTokenSymbolNil() {
...
func (o UniswapV2TokenV2DTO) MarshalJSON() ([]byte, error) {
...
type NullableUniswapV2TokenV2DTO struct {
	value *UniswapV2TokenV2DTO
	isSet bool
}

func (v NullableUniswapV2TokenV2DTO) Get() *UniswapV2TokenV2DTO {
	return v.value
}

func (v *NullableUniswapV2TokenV2DTO) Set(val *UniswapV2TokenV2DTO) {
	v.value = val
	v.isSet = true
}

func (v NullableUniswapV2TokenV2DTO) IsSet() bool {
	return v.isSet
}

func (v *NullableUniswapV2TokenV2DTO) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableUniswapV2TokenV2DTO(val *UniswapV2TokenV2DTO) *NullableUniswapV2TokenV2DTO {
	return &NullableUniswapV2TokenV2DTO{value: val, isSet: true}
}

func (v NullableUniswapV2TokenV2DTO) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableUniswapV2TokenV2DTO) UnmarshalJSON(src []byte) error {
	v.isSet = true
