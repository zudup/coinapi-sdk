...
type UniswapV3BundleV3DTO struct {
...
func (o *UniswapV3BundleV3DTO) SetIdNil() {
	o.Id.Set(nil)
}
...
func (o *UniswapV3BundleV3DTO) SetEthPriceUsdNil() {
...
func (o UniswapV3BundleV3DTO) MarshalJSON() ([]byte, error) {
...
type NullableUniswapV3BundleV3DTO struct {
	value *UniswapV3BundleV3DTO
	isSet bool
}

func (v NullableUniswapV3BundleV3DTO) Get() *UniswapV3BundleV3DTO {
	return v.value
}

func (v *NullableUniswapV3BundleV3DTO) Set(val *UniswapV3BundleV3DTO) {
	v.value = val
	v.isSet = true
}

func (v NullableUniswapV3BundleV3DTO) IsSet() bool {
	return v.isSet
}

func (v *NullableUniswapV3BundleV3DTO) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableUniswapV3BundleV3DTO(val *UniswapV3BundleV3DTO) *NullableUniswapV3BundleV3DTO {
	return &NullableUniswapV3BundleV3DTO{value: val, isSet: true}
}

func (v NullableUniswapV3BundleV3DTO) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableUniswapV3BundleV3DTO) UnmarshalJSON(src []byte) error {
	v.isSet = true
