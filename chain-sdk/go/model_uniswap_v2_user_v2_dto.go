...
// UniswapV2UserV2DTO A user entity is created for any address that provides liquidity to a pool on Uniswap. This entity can be used to track open positions for users.
type UniswapV2UserV2DTO struct {
...
func (o *UniswapV2UserV2DTO) SetIdNil() {
	o.Id.Set(nil)
}
...
func (o *UniswapV2UserV2DTO) SetUsdSwappedNil() {
...
func (o UniswapV2UserV2DTO) MarshalJSON() ([]byte, error) {
...
type NullableUniswapV2UserV2DTO struct {
	value *UniswapV2UserV2DTO
	isSet bool
}

func (v NullableUniswapV2UserV2DTO) Get() *UniswapV2UserV2DTO {
	return v.value
}

func (v *NullableUniswapV2UserV2DTO) Set(val *UniswapV2UserV2DTO) {
	v.value = val
	v.isSet = true
}

func (v NullableUniswapV2UserV2DTO) IsSet() bool {
	return v.isSet
}

func (v *NullableUniswapV2UserV2DTO) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableUniswapV2UserV2DTO(val *UniswapV2UserV2DTO) *NullableUniswapV2UserV2DTO {
	return &NullableUniswapV2UserV2DTO{value: val, isSet: true}
}

func (v NullableUniswapV2UserV2DTO) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableUniswapV2UserV2DTO) UnmarshalJSON(src []byte) error {
	v.isSet = true
