...
func (o *BurnV3DTO) SetTransactionNil() {
...
func (o *BurnV3DTO) SetTimestampNil() {
	o.Timestamp.Set(nil)
}
...
func (o *BurnV3DTO) SetAmount0Nil() {
	o.Amount0.Set(nil)
}
...
func (o *BurnV3DTO) SetAmount1Nil() {
	o.Amount1.Set(nil)
}
...
func (o *BurnV3DTO) SetAmountUsdNil() {
	o.AmountUsd.Set(nil)
}
...
func (o *BurnV3DTO) SetTickLowerNil() {
	o.TickLower.Set(nil)
}
...
func (o *BurnV3DTO) SetTickUpperNil() {
	o.TickUpper.Set(nil)
}
...
func (o *BurnV3DTO) SetLogIndexNil() {
	o.LogIndex.Set(nil)
}
...
type NullableBurnV3DTO struct {
	value *BurnV3DTO
	isSet bool
}

func (v NullableBurnV3DTO) Get() *BurnV3DTO {
	return v.value
}

func (v *NullableBurnV3DTO) Set(val *BurnV3DTO) {
	v.value = val
	v.isSet = true
}

func (v NullableBurnV3DTO) IsSet() bool {
	return v.isSet
}

func (v *NullableBurnV3DTO) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableBurnV3DTO(val *BurnV3DTO) *NullableBurnV3DTO {
	return &NullableBurnV3DTO{value: val, isSet: true}
}

func (v NullableBurnV3DTO) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableBurnV3DTO) UnmarshalJSON(src []byte) error {
	v.isSet = true
