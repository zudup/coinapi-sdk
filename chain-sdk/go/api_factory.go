...
type ApiChainsChainIdDappsSushiswapFactoryHistoricalGetRequest struct {
	ctx context.Context
...
func (r ApiChainsChainIdDappsSushiswapFactoryHistoricalGetRequest) StartBlock(startBlock int64) ApiChainsChainIdDappsSushiswapFactoryHistoricalGetRequest {
	r.startBlock = &startBlock
	return r
}

func (r ApiChainsChainIdDappsSushiswapFactoryHistoricalGetRequest) EndBlock(endBlock int64) ApiChainsChainIdDappsSushiswapFactoryHistoricalGetRequest {
	r.endBlock = &endBlock
	return r
}

func (r ApiChainsChainIdDappsSushiswapFactoryHistoricalGetRequest) StartDate(startDate time.Time) ApiChainsChainIdDappsSushiswapFactoryHistoricalGetRequest {
	r.startDate = &startDate
	return r
}

func (r ApiChainsChainIdDappsSushiswapFactoryHistoricalGetRequest) EndDate(endDate time.Time) ApiChainsChainIdDappsSushiswapFactoryHistoricalGetRequest {
	r.endDate = &endDate
	return r
}

func (r ApiChainsChainIdDappsSushiswapFactoryHistoricalGetRequest) Execute() (*http.Response, error) {
	return r.ApiService.ChainsChainIdDappsSushiswapFactoryHistoricalGetExecute(r)
}

/*
ChainsChainIdDappsSushiswapFactoryHistoricalGet Method for ChainsChainIdDappsSushiswapFactoryHistoricalGet

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @param chainId
 @return ApiChainsChainIdDappsSushiswapFactoryHistoricalGetRequest
*/
func (a *FactoryApiService) ChainsChainIdDappsSushiswapFactoryHistoricalGet(ctx context.Context, chainId string) ApiChainsChainIdDappsSushiswapFactoryHistoricalGetRequest {
	return ApiChainsChainIdDappsSushiswapFactoryHistoricalGetRequest{
		ApiService: a,
		ctx: ctx,
		chainId: chainId,
...
func (a *FactoryApiService) ChainsChainIdDappsSushiswapFactoryHistoricalGetExecute(r ApiChainsChainIdDappsSushiswapFactoryHistoricalGetRequest) (*http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "FactoryApiService.ChainsChainIdDappsSushiswapFactoryHistoricalGet")
	if err != nil {
		return nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/chains/{chain_id}/dapps/sushiswap/factory/historical"
