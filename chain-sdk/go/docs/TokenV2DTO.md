...
**TradeVolume** | Pointer to **NullableString** |  | [optional] 
**TradeVolumeUsd** | Pointer to **NullableString** |  | [optional] 
**UntrackedVolumeUsd** | Pointer to **NullableString** |  | [optional] 
**TxCount** | Pointer to [**BigInteger**](BigInteger.md) |  | [optional] 
**TotalLiquidity** | Pointer to **NullableString** |  | [optional] 
**DerivedEth** | Pointer to **NullableString** |  | [optional] 
