...
**PoolCount** | Pointer to **NullableString** |  | [optional] 
**TxCount** | Pointer to **NullableString** |  | [optional] 
**TotalVolumeUsd** | Pointer to **NullableString** |  | [optional] 
**TotalVolumeEth** | Pointer to **NullableString** |  | [optional] 
**TotalFeesUsd** | Pointer to **NullableString** |  | [optional] 
**TotalFeesEth** | Pointer to **NullableString** |  | [optional] 
**UntrackedVolumeUsd** | Pointer to **NullableString** |  | [optional] 
**TotalValueLockedUsd** | Pointer to **NullableString** |  | [optional] 
**TotalValueLockedEth** | Pointer to **NullableString** |  | [optional] 
**TotalValueLockedUsdUntracked** | Pointer to **NullableString** |  | [optional] 
**TotalValueLockedEthUntracked** | Pointer to **NullableString** |  | [optional] 
