...
func (o *UniswapV2BundleV2DTO) SetIdNil() {
	o.Id.Set(nil)
}
...
func (o *UniswapV2BundleV2DTO) SetEthPriceNil() {
	o.EthPrice.Set(nil)
}
...
func (o *UniswapV2BundleV2DTO) SetBlockRangeNil() {
...
func (o UniswapV2BundleV2DTO) MarshalJSON() ([]byte, error) {
...
type NullableUniswapV2BundleV2DTO struct {
	value *UniswapV2BundleV2DTO
	isSet bool
}

func (v NullableUniswapV2BundleV2DTO) Get() *UniswapV2BundleV2DTO {
	return v.value
}

func (v *NullableUniswapV2BundleV2DTO) Set(val *UniswapV2BundleV2DTO) {
	v.value = val
	v.isSet = true
}

func (v NullableUniswapV2BundleV2DTO) IsSet() bool {
	return v.isSet
}

func (v *NullableUniswapV2BundleV2DTO) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableUniswapV2BundleV2DTO(val *UniswapV2BundleV2DTO) *NullableUniswapV2BundleV2DTO {
	return &NullableUniswapV2BundleV2DTO{value: val, isSet: true}
}

func (v NullableUniswapV2BundleV2DTO) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableUniswapV2BundleV2DTO) UnmarshalJSON(src []byte) error {
	v.isSet = true
