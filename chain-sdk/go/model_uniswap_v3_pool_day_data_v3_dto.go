...
type UniswapV3PoolDayDataV3DTO struct {
...
func NewUniswapV3PoolDayDataV3DTO() *UniswapV3PoolDayDataV3DTO {
	this := UniswapV3PoolDayDataV3DTO{}
	return &this
}
...
func (o *UniswapV3PoolDayDataV3DTO) SetIdNil() {
	o.Id.Set(nil)
}
...
func (o *UniswapV3PoolDayDataV3DTO) SetPoolNil() {
	o.Pool.Set(nil)
}
...
func (o *UniswapV3PoolDayDataV3DTO) SetLiquidityNil() {
	o.Liquidity.Set(nil)
}
...
func (o *UniswapV3PoolDayDataV3DTO) SetSqrtPriceNil() {
	o.SqrtPrice.Set(nil)
}
...
func (o *UniswapV3PoolDayDataV3DTO) SetToken0PriceNil() {
...
func (o *UniswapV3PoolDayDataV3DTO) SetToken1PriceNil() {
...
func (o *UniswapV3PoolDayDataV3DTO) SetTickNil() {
	o.Tick.Set(nil)
}
...
func (o *UniswapV3PoolDayDataV3DTO) SetFeeGrowthGlobal0x128Nil() {
...
func (o *UniswapV3PoolDayDataV3DTO) SetFeeGrowthGlobal1x128Nil() {
...
func (o *UniswapV3PoolDayDataV3DTO) SetTvlUsdNil() {
	o.TvlUsd.Set(nil)
}
...
func (o *UniswapV3PoolDayDataV3DTO) SetVolumeToken0Nil() {
...
func (o *UniswapV3PoolDayDataV3DTO) SetVolumeToken1Nil() {
...
func (o *UniswapV3PoolDayDataV3DTO) SetVolumeUsdNil() {
	o.VolumeUsd.Set(nil)
}
...
func (o *UniswapV3PoolDayDataV3DTO) SetFeesUsdNil() {
	o.FeesUsd.Set(nil)
}
...
func (o *UniswapV3PoolDayDataV3DTO) SetTxCountNil() {
	o.TxCount.Set(nil)
}
...
func (o *UniswapV3PoolDayDataV3DTO) SetOpenNil() {
	o.Open.Set(nil)
}
...
func (o *UniswapV3PoolDayDataV3DTO) SetHighNil() {
	o.High.Set(nil)
}
...
func (o *UniswapV3PoolDayDataV3DTO) SetLowNil() {
	o.Low.Set(nil)
}
...
func (o *UniswapV3PoolDayDataV3DTO) SetCloseNil() {
	o.Close.Set(nil)
}
...
func (o UniswapV3PoolDayDataV3DTO) MarshalJSON() ([]byte, error) {
...
type NullableUniswapV3PoolDayDataV3DTO struct {
	value *UniswapV3PoolDayDataV3DTO
	isSet bool
}

func (v NullableUniswapV3PoolDayDataV3DTO) Get() *UniswapV3PoolDayDataV3DTO {
	return v.value
}

func (v *NullableUniswapV3PoolDayDataV3DTO) Set(val *UniswapV3PoolDayDataV3DTO) {
	v.value = val
	v.isSet = true
}

func (v NullableUniswapV3PoolDayDataV3DTO) IsSet() bool {
	return v.isSet
}

func (v *NullableUniswapV3PoolDayDataV3DTO) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableUniswapV3PoolDayDataV3DTO(val *UniswapV3PoolDayDataV3DTO) *NullableUniswapV3PoolDayDataV3DTO {
	return &NullableUniswapV3PoolDayDataV3DTO{value: val, isSet: true}
}

func (v NullableUniswapV3PoolDayDataV3DTO) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableUniswapV3PoolDayDataV3DTO) UnmarshalJSON(src []byte) error {
	v.isSet = true
