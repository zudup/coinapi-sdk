...
type UniswapV3MintV3DTO struct {
...
func (o *UniswapV3MintV3DTO) SetIdNil() {
	o.Id.Set(nil)
}
...
func (o *UniswapV3MintV3DTO) SetTransactionNil() {
...
func (o *UniswapV3MintV3DTO) SetTimestampNil() {
	o.Timestamp.Set(nil)
}
...
func (o *UniswapV3MintV3DTO) SetPoolNil() {
	o.Pool.Set(nil)
}
...
func (o *UniswapV3MintV3DTO) SetToken0Nil() {
	o.Token0.Set(nil)
}
...
func (o *UniswapV3MintV3DTO) SetToken1Nil() {
	o.Token1.Set(nil)
}
...
func (o *UniswapV3MintV3DTO) SetOwnerNil() {
	o.Owner.Set(nil)
}
...
func (o *UniswapV3MintV3DTO) SetSenderNil() {
	o.Sender.Set(nil)
}
...
func (o *UniswapV3MintV3DTO) SetOriginNil() {
	o.Origin.Set(nil)
}
...
func (o *UniswapV3MintV3DTO) SetAmountNil() {
	o.Amount.Set(nil)
}
...
func (o *UniswapV3MintV3DTO) SetAmount0Nil() {
	o.Amount0.Set(nil)
}
...
func (o *UniswapV3MintV3DTO) SetAmount1Nil() {
	o.Amount1.Set(nil)
}
...
func (o *UniswapV3MintV3DTO) SetAmountUsdNil() {
	o.AmountUsd.Set(nil)
}
...
func (o *UniswapV3MintV3DTO) SetTickLowerNil() {
	o.TickLower.Set(nil)
}
...
func (o *UniswapV3MintV3DTO) SetTickUpperNil() {
	o.TickUpper.Set(nil)
}
...
func (o *UniswapV3MintV3DTO) SetLogIndexNil() {
	o.LogIndex.Set(nil)
}
...
func (o UniswapV3MintV3DTO) MarshalJSON() ([]byte, error) {
...
type NullableUniswapV3MintV3DTO struct {
	value *UniswapV3MintV3DTO
	isSet bool
}

func (v NullableUniswapV3MintV3DTO) Get() *UniswapV3MintV3DTO {
	return v.value
}

func (v *NullableUniswapV3MintV3DTO) Set(val *UniswapV3MintV3DTO) {
	v.value = val
	v.isSet = true
}

func (v NullableUniswapV3MintV3DTO) IsSet() bool {
	return v.isSet
}

func (v *NullableUniswapV3MintV3DTO) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableUniswapV3MintV3DTO(val *UniswapV3MintV3DTO) *NullableUniswapV3MintV3DTO {
	return &NullableUniswapV3MintV3DTO{value: val, isSet: true}
}

func (v NullableUniswapV3MintV3DTO) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableUniswapV3MintV3DTO) UnmarshalJSON(src []byte) error {
	v.isSet = true
