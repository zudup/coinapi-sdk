...
// tests for SushiswapTokenDTO
void main() {
  // final instance = SushiswapTokenDTO();

  group('test SushiswapTokenDTO', () {
    // DateTime entryTime
    ...
    // List<String> whitelistPairs (default value: const [])
    test('to test the property `whitelistPairs`', () async {
      // TODO
    });
