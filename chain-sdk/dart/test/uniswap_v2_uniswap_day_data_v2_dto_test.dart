...
// tests for UniswapV2UniswapDayDataV2DTO
void main() {
  // final instance = UniswapV2UniswapDayDataV2DTO();

  group('test UniswapV2UniswapDayDataV2DTO', () {
    // DateTime entryTime
    ...
    test('to test the property `dailyVolumeUntracked`', () async {
      // TODO
    });
