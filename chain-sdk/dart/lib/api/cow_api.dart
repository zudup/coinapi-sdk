...
class CowApi {
  ...
  /// Performs an HTTP 'GET /dapps/cow/poi/historical' operation and returns the [Response].
  /// Parameters:
  ///
  /// * [int] startBlock:
  ///
  ...
  ///
  /// * [DateTime] endDate:
  Future<Response> dappsCowPoiHistoricalGetWithHttpInfo({ int? startBlock, int? endBlock, DateTime? startDate, DateTime? endDate, }) async {
    // ignore: prefer_const_declarations
    final path = r'/dapps/cow/poi/historical';
  ...
  ///
  /// * [DateTime] endDate:
  Future<void> dappsCowPoiHistoricalGet({ int? startBlock, int? endBlock, DateTime? startDate, DateTime? endDate, }) async {
    final response = await dappsCowPoiHistoricalGetWithHttpInfo( startBlock: startBlock, endBlock: endBlock, startDate: startDate, endDate: endDate, );
    if (response.statusCode >= HttpStatus.badRequest) {
      throw ApiException(response.statusCode, await _decodeBodyBytes(response));
    }
  }
