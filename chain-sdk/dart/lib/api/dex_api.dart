...
class DexApi {
  ...
  /// Performs an HTTP 'GET /dapps/dex/poi/historical' operation and returns the [Response].
  /// Parameters:
  ///
  /// * [int] startBlock:
  ///
  ...
  ///
  /// * [DateTime] endDate:
  Future<Response> dappsDexPoiHistoricalGetWithHttpInfo({ int? startBlock, int? endBlock, DateTime? startDate, DateTime? endDate, }) async {
    // ignore: prefer_const_declarations
    final path = r'/dapps/dex/poi/historical';
  ...
  ///
  /// * [DateTime] endDate:
  Future<void> dappsDexPoiHistoricalGet({ int? startBlock, int? endBlock, DateTime? startDate, DateTime? endDate, }) async {
    final response = await dappsDexPoiHistoricalGetWithHttpInfo( startBlock: startBlock, endBlock: endBlock, startDate: startDate, endDate: endDate, );
    if (response.statusCode >= HttpStatus.badRequest) {
      throw ApiException(response.statusCode, await _decodeBodyBytes(response));
    }
  }
