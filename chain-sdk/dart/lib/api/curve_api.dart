...
class CurveApi {
  ...
  /// Performs an HTTP 'GET /dapps/curve/poi/historical' operation and returns the [Response].
  /// Parameters:
  ///
  /// * [int] startBlock:
  ///
  ...
  ///
  /// * [DateTime] endDate:
  Future<Response> dappsCurvePoiHistoricalGetWithHttpInfo({ int? startBlock, int? endBlock, DateTime? startDate, DateTime? endDate, }) async {
    // ignore: prefer_const_declarations
    final path = r'/dapps/curve/poi/historical';
  ...
  ///
  /// * [DateTime] endDate:
  Future<void> dappsCurvePoiHistoricalGet({ int? startBlock, int? endBlock, DateTime? startDate, DateTime? endDate, }) async {
    final response = await dappsCurvePoiHistoricalGetWithHttpInfo( startBlock: startBlock, endBlock: endBlock, startDate: startDate, endDate: endDate, );
    if (response.statusCode >= HttpStatus.badRequest) {
      throw ApiException(response.statusCode, await _decodeBodyBytes(response));
    }
  }
