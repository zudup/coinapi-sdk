...
class PoolV3DTO {
  /// Returns a new [PoolV3DTO] instance.
  PoolV3DTO({
    this.entryTime,
    this.recvTime,
    this.blockNumber,
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is PoolV3DTO &&
  ...
  /// Returns a new [PoolV3DTO] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static PoolV3DTO? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "PoolV3DTO[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "PoolV3DTO[$key]" has a null value in JSON.');
        });
        return true;
      }());
      ...
      return PoolV3DTO(
        ...
        feeTier: BigInteger.fromJson(json[r'fee_tier']),
        liquidity: BigInteger.fromJson(json[r'liquidity']),
        sqrtPrice: BigInteger.fromJson(json[r'sqrt_price']),
        feeGrowthGlobal0x128: BigInteger.fromJson(json[r'fee_growth_global_0x128']),
        feeGrowthGlobal1x128: BigInteger.fromJson(json[r'fee_growth_global_1x128']),
        ...
        observationIndex: BigInteger.fromJson(json[r'observation_index']),
  ...
  static List<PoolV3DTO>? listFromJson(dynamic json, {bool growable = false,}) {
    final result = <PoolV3DTO>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = PoolV3DTO.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, PoolV3DTO> mapFromJson(dynamic json) {
    final map = <String, PoolV3DTO>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = PoolV3DTO.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of PoolV3DTO-objects as value to a dart map
  static Map<String, List<PoolV3DTO>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<PoolV3DTO>>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = PoolV3DTO.listFromJson(entry.value, growable: growable,);
        if (value != null) {
          map[entry.key] = value;
        }
      }
