...
class TokenV3DTO {
  /// Returns a new [TokenV3DTO] instance.
  TokenV3DTO({
    this.entryTime,
    this.recvTime,
    this.blockNumber,
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is TokenV3DTO &&
  ...
  /// Returns a new [TokenV3DTO] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static TokenV3DTO? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "TokenV3DTO[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "TokenV3DTO[$key]" has a null value in JSON.');
        });
        return true;
      }());
      ...
      return TokenV3DTO(
        ...
        poolCount: BigInteger.fromJson(json[r'pool_count']),
  ...
  static List<TokenV3DTO>? listFromJson(dynamic json, {bool growable = false,}) {
    final result = <TokenV3DTO>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = TokenV3DTO.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, TokenV3DTO> mapFromJson(dynamic json) {
    final map = <String, TokenV3DTO>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = TokenV3DTO.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of TokenV3DTO-objects as value to a dart map
  static Map<String, List<TokenV3DTO>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<TokenV3DTO>>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = TokenV3DTO.listFromJson(entry.value, growable: growable,);
        if (value != null) {
          map[entry.key] = value;
        }
      }
