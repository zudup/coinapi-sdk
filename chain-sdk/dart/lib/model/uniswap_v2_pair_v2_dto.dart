...
class UniswapV2PairV2DTO {
  /// Returns a new [UniswapV2PairV2DTO] instance.
  UniswapV2PairV2DTO({
    this.entryTime,
    this.recvTime,
    this.blockNumber,
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is UniswapV2PairV2DTO &&
  ...
  /// Returns a new [UniswapV2PairV2DTO] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static UniswapV2PairV2DTO? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "UniswapV2PairV2DTO[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "UniswapV2PairV2DTO[$key]" has a null value in JSON.');
        });
        return true;
      }());
  ...
  static List<UniswapV2PairV2DTO>? listFromJson(dynamic json, {bool growable = false,}) {
    final result = <UniswapV2PairV2DTO>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = UniswapV2PairV2DTO.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, UniswapV2PairV2DTO> mapFromJson(dynamic json) {
    final map = <String, UniswapV2PairV2DTO>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = UniswapV2PairV2DTO.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of UniswapV2PairV2DTO-objects as value to a dart map
  static Map<String, List<UniswapV2PairV2DTO>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<UniswapV2PairV2DTO>>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = UniswapV2PairV2DTO.listFromJson(entry.value, growable: growable,);
        if (value != null) {
          map[entry.key] = value;
        }
      }
