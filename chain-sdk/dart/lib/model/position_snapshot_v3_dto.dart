...
class PositionSnapshotV3DTO {
  /// Returns a new [PositionSnapshotV3DTO] instance.
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is PositionSnapshotV3DTO &&
  ...
  /// Returns a new [PositionSnapshotV3DTO] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static PositionSnapshotV3DTO? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "PositionSnapshotV3DTO[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "PositionSnapshotV3DTO[$key]" has a null value in JSON.');
        });
        return true;
      }());
  ...
  static List<PositionSnapshotV3DTO>? listFromJson(dynamic json, {bool growable = false,}) {
    final result = <PositionSnapshotV3DTO>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = PositionSnapshotV3DTO.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, PositionSnapshotV3DTO> mapFromJson(dynamic json) {
    final map = <String, PositionSnapshotV3DTO>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = PositionSnapshotV3DTO.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of PositionSnapshotV3DTO-objects as value to a dart map
  static Map<String, List<PositionSnapshotV3DTO>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<PositionSnapshotV3DTO>>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = PositionSnapshotV3DTO.listFromJson(entry.value, growable: growable,);
        if (value != null) {
          map[entry.key] = value;
        }
      }
