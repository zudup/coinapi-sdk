...
class SwapDTO {
  /// Returns a new [SwapDTO] instance.
  SwapDTO({
    this.entryTime,
    this.recvTime,
    this.blockNumber,
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is SwapDTO &&
  ...
  /// Returns a new [SwapDTO] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static SwapDTO? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "SwapDTO[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "SwapDTO[$key]" has a null value in JSON.');
        });
        return true;
      }());
  ...
  static List<SwapDTO>? listFromJson(dynamic json, {bool growable = false,}) {
    final result = <SwapDTO>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = SwapDTO.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, SwapDTO> mapFromJson(dynamic json) {
    final map = <String, SwapDTO>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = SwapDTO.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of SwapDTO-objects as value to a dart map
  static Map<String, List<SwapDTO>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<SwapDTO>>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = SwapDTO.listFromJson(entry.value, growable: growable,);
        if (value != null) {
          map[entry.key] = value;
        }
      }
