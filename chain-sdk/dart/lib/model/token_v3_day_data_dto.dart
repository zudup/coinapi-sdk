...
class TokenV3DayDataDTO {
  /// Returns a new [TokenV3DayDataDTO] instance.
  TokenV3DayDataDTO({
    this.entryTime,
    this.recvTime,
    this.blockNumber,
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is TokenV3DayDataDTO &&
  ...
  /// Returns a new [TokenV3DayDataDTO] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static TokenV3DayDataDTO? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "TokenV3DayDataDTO[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "TokenV3DayDataDTO[$key]" has a null value in JSON.');
        });
        return true;
      }());
  ...
  static List<TokenV3DayDataDTO>? listFromJson(dynamic json, {bool growable = false,}) {
    final result = <TokenV3DayDataDTO>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = TokenV3DayDataDTO.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, TokenV3DayDataDTO> mapFromJson(dynamic json) {
    final map = <String, TokenV3DayDataDTO>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = TokenV3DayDataDTO.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of TokenV3DayDataDTO-objects as value to a dart map
  static Map<String, List<TokenV3DayDataDTO>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<TokenV3DayDataDTO>>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = TokenV3DayDataDTO.listFromJson(entry.value, growable: growable,);
        if (value != null) {
          map[entry.key] = value;
        }
      }
