...
class UniswapV3TokenV3DTO {
  /// Returns a new [UniswapV3TokenV3DTO] instance.
  UniswapV3TokenV3DTO({
    this.entryTime,
    this.recvTime,
    this.blockNumber,
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is UniswapV3TokenV3DTO &&
  ...
  /// Returns a new [UniswapV3TokenV3DTO] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static UniswapV3TokenV3DTO? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "UniswapV3TokenV3DTO[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "UniswapV3TokenV3DTO[$key]" has a null value in JSON.');
        });
        return true;
      }());
  ...
  static List<UniswapV3TokenV3DTO>? listFromJson(dynamic json, {bool growable = false,}) {
    final result = <UniswapV3TokenV3DTO>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = UniswapV3TokenV3DTO.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, UniswapV3TokenV3DTO> mapFromJson(dynamic json) {
    final map = <String, UniswapV3TokenV3DTO>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = UniswapV3TokenV3DTO.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of UniswapV3TokenV3DTO-objects as value to a dart map
  static Map<String, List<UniswapV3TokenV3DTO>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<UniswapV3TokenV3DTO>>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = UniswapV3TokenV3DTO.listFromJson(entry.value, growable: growable,);
        if (value != null) {
          map[entry.key] = value;
        }
      }
