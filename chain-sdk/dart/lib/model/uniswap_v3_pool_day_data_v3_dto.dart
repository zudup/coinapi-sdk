...
class UniswapV3PoolDayDataV3DTO {
  /// Returns a new [UniswapV3PoolDayDataV3DTO] instance.
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is UniswapV3PoolDayDataV3DTO &&
  ...
  @override
  String toString() => 'UniswapV3PoolDayDataV3DTO[entryTime=$entryTime, recvTime=$recvTime, blockNumber=$blockNumber, id=$id, date=$date, pool=$pool, liquidity=$liquidity, sqrtPrice=$sqrtPrice, token0Price=$token0Price, token1Price=$token1Price, tick=$tick, feeGrowthGlobal0x128=$feeGrowthGlobal0x128, feeGrowthGlobal1x128=$feeGrowthGlobal1x128, tvlUsd=$tvlUsd, volumeToken0=$volumeToken0, volumeToken1=$volumeToken1, volumeUsd=$volumeUsd, feesUsd=$feesUsd, txCount=$txCount, open=$open, high=$high, low=$low, close=$close, vid=$vid]';
  ...
  /// Returns a new [UniswapV3PoolDayDataV3DTO] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static UniswapV3PoolDayDataV3DTO? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "UniswapV3PoolDayDataV3DTO[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "UniswapV3PoolDayDataV3DTO[$key]" has a null value in JSON.');
        });
        return true;
      }());
  ...
  static List<UniswapV3PoolDayDataV3DTO>? listFromJson(dynamic json, {bool growable = false,}) {
    final result = <UniswapV3PoolDayDataV3DTO>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = UniswapV3PoolDayDataV3DTO.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, UniswapV3PoolDayDataV3DTO> mapFromJson(dynamic json) {
    final map = <String, UniswapV3PoolDayDataV3DTO>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = UniswapV3PoolDayDataV3DTO.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of UniswapV3PoolDayDataV3DTO-objects as value to a dart map
  static Map<String, List<UniswapV3PoolDayDataV3DTO>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<UniswapV3PoolDayDataV3DTO>>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = UniswapV3PoolDayDataV3DTO.listFromJson(entry.value, growable: growable,);
        if (value != null) {
          map[entry.key] = value;
        }
      }
