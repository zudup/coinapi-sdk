...
final api_instance = GaugeWithdrawApi();
...
try {
    api_instance.chainsChainIdDappsCurveGaugeWithdrawHistoricalGet(chainId, startBlock, endBlock, startDate, endDate);
} catch (e) {
