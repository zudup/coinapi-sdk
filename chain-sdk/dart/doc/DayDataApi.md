...
try {
    api_instance.chainsChainIdDappsSushiswapDayDataHistoricalGet(chainId, startBlock, endBlock, startDate, endDate);
} catch (e) {
    print('Exception when calling DayDataApi->chainsChainIdDappsSushiswapDayDataHistoricalGet: $e\n');
}
```
