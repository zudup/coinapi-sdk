...
final api_instance = PositionSnapshotApi();
...
try {
    api_instance.chainsChainIdDappsUniswapv3PositionSnapshotHistoricalGet(chainId, startBlock, endBlock, startDate, endDate, poolId);
} catch (e) {
