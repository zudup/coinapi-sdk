...
final api_instance = DailyVolumeApi();
...
try {
    api_instance.chainsChainIdDappsCurveDailyVolumeHistoricalGet(chainId, startBlock, endBlock, startDate, endDate, poolId);
} catch (e) {
    print('Exception when calling DailyVolumeApi->chainsChainIdDappsCurveDailyVolumeHistoricalGet: $e\n');
}
```
