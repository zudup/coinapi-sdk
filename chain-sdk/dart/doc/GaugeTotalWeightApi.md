# openapi.api.GaugeTotalWeightApi
...
final api_instance = GaugeTotalWeightApi();
...
try {
    api_instance.chainsChainIdDappsCurveGaugeTotalWeightHistoricalGet(chainId, startBlock, endBlock, startDate, endDate);
} catch (e) {
    print('Exception when calling GaugeTotalWeightApi->chainsChainIdDappsCurveGaugeTotalWeightHistoricalGet: $e\n');
}
```
