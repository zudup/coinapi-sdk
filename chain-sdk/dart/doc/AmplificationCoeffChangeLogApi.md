# openapi.api.AmplificationCoeffChangeLogApi
...
final api_instance = AmplificationCoeffChangeLogApi();
...
try {
    api_instance.chainsChainIdDappsCurveAmplificationCoeffChangeLogHistoricalGet(chainId, startBlock, endBlock, startDate, endDate, poolId);
} catch (e) {
    print('Exception when calling AmplificationCoeffChangeLogApi->chainsChainIdDappsCurveAmplificationCoeffChangeLogHistoricalGet: $e\n');
}
```
