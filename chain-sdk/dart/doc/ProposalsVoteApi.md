...
final api_instance = ProposalsVoteApi();
...
try {
    api_instance.chainsChainIdDappsCurveProposalsVoteHistoricalGet(chainId, startBlock, endBlock, startDate, endDate);
} catch (e) {
    print('Exception when calling ProposalsVoteApi->chainsChainIdDappsCurveProposalsVoteHistoricalGet: $e\n');
}
```
