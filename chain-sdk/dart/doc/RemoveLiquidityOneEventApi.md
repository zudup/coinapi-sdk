# openapi.api.RemoveLiquidityOneEventApi
...
final api_instance = RemoveLiquidityOneEventApi();
...
try {
    api_instance.chainsChainIdDappsCurveRemoveLiquidityOneEventHistoricalGet(chainId, startBlock, endBlock, startDate, endDate, poolId);
} catch (e) {
