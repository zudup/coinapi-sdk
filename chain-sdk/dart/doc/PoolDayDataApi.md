...
final api_instance = PoolDayDataApi();
...
try {
    api_instance.chainsChainIdDappsSushiswapPoolDayDataHistoricalGet(chainId, startBlock, endBlock, startDate, endDate, poolId);
} catch (e) {
    print('Exception when calling PoolDayDataApi->chainsChainIdDappsSushiswapPoolDayDataHistoricalGet: $e\n');
}
```
...
try {
    api_instance.chainsChainIdDappsUniswapv2PoolDayDataHistoricalGet(chainId, startBlock, endBlock, startDate, endDate, poolId);
} catch (e) {
...
try {
    api_instance.chainsChainIdDappsUniswapv3PoolDayDataHistoricalGet(chainId, startBlock, endBlock, startDate, endDate, poolId);
} catch (e) {
