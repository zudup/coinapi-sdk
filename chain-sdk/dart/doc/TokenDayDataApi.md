...
try {
    api_instance.chainsChainIdDappsSushiswapTokenDayDataHistoricalGet(chainId, startBlock, endBlock, startDate, endDate, tokenId);
} catch (e) {
    print('Exception when calling TokenDayDataApi->chainsChainIdDappsSushiswapTokenDayDataHistoricalGet: $e\n');
}
```
