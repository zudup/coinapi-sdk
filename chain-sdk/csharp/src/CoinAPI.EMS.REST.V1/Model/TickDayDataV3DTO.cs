...
namespace CoinAPI.EMS.REST.V1.Model
{
    ...
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TickDayDataV3DTO" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as TickDayDataV3DTO);
        }

        /// <summary>
        /// Returns true if TickDayDataV3DTO instances are equal
        /// </summary>
        /// <param name="input">Instance of TickDayDataV3DTO to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TickDayDataV3DTO input)
        {
            if (input == null)
                return false;
