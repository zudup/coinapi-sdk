...
namespace CoinAPI.EMS.REST.V1.Model
{
    ...
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="UniswapV3MintV3DTO" /> class.
        /// </summary>
        ...
        public UniswapV3MintV3DTO(DateTime entryTime = default(DateTime), DateTime recvTime = default(DateTime), long blockNumber = default(long), string id = default(string), string transaction = default(string), string timestamp = default(string), string pool = default(string), string token0 = default(string), string token1 = default(string), string owner = default(string), string sender = default(string), string origin = default(string), string amount = default(string), string amount0 = default(string), string amount1 = default(string), string amountUsd = default(string), string tickLower = default(string), string tickUpper = default(string), string logIndex = default(string), long vid = default(long))
        {
            this.Id = id;
        ...
        {
            return this.Equals(input as UniswapV3MintV3DTO);
        }

        /// <summary>
        /// Returns true if UniswapV3MintV3DTO instances are equal
        /// </summary>
        /// <param name="input">Instance of UniswapV3MintV3DTO to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(UniswapV3MintV3DTO input)
        {
            if (input == null)
                return false;
