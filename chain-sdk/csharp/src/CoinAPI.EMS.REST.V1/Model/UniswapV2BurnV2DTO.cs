...
namespace CoinAPI.EMS.REST.V1.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class UniswapV2BurnV2DTO :  IEquatable<UniswapV2BurnV2DTO>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="UniswapV2BurnV2DTO" /> class.
        /// </summary>
        ...
        public UniswapV2BurnV2DTO(DateTime entryTime = default(DateTime), DateTime recvTime = default(DateTime), long blockNumber = default(long), string id = default(string), string transaction = default(string), string timestamp = default(string), string pair = default(string), string liquidity = default(string), string sender = default(string), string amount0 = default(string), string amount1 = default(string), string to = default(string), string logIndex = default(string), string amountUsd = default(string), bool needsComplete = default(bool), string feeTo = default(string), string feeLiquidity = default(string), long vid = default(long))
        {
            this.Id = id;
        ...
        /// </summary>
        [DataMember(Name="needs_complete", EmitDefaultValue=false)]
        ...
        {
            return this.Equals(input as UniswapV2BurnV2DTO);
        }

        /// <summary>
        /// Returns true if UniswapV2BurnV2DTO instances are equal
        /// </summary>
        /// <param name="input">Instance of UniswapV2BurnV2DTO to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(UniswapV2BurnV2DTO input)
        {
            if (input == null)
                return false;
