...
namespace CoinAPI.EMS.REST.V1.Model
{
    ...
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="UniswapV3TokenV3DTO" /> class.
        /// </summary>
        ...
        public UniswapV3TokenV3DTO(DateTime entryTime = default(DateTime), DateTime recvTime = default(DateTime), long blockNumber = default(long), long vid = default(long), string id = default(string), string symbol = default(string), string name = default(string), int decimals = default(int), NumericsBigInteger totalSupply = default(NumericsBigInteger), string volume = default(string), string volumeUsd = default(string), string untrackedVolumeUsd = default(string), string feesUsd = default(string), NumericsBigInteger txCount = default(NumericsBigInteger), NumericsBigInteger poolCount = default(NumericsBigInteger), string totalValueLocked = default(string), string totalValueLockedUsd = default(string), string totalValueLockedUsdUntracked = default(string), string derivedEth = default(string), List<string> whitelistPools = default(List<string>))
        {
            this.Id = id;
            this.Symbol = symbol;
            this.Name = name;
        ...
        {
            return this.Equals(input as UniswapV3TokenV3DTO);
        }

        /// <summary>
        /// Returns true if UniswapV3TokenV3DTO instances are equal
        /// </summary>
        /// <param name="input">Instance of UniswapV3TokenV3DTO to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(UniswapV3TokenV3DTO input)
        {
            if (input == null)
                return false;
