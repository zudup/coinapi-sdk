...
[**chainsChainIdDappsDexUsersHistoricalGetWithHttpInfo**](UsersApi.md#chainsChainIdDappsDexUsersHistoricalGetWithHttpInfo) | **GET** /chains/{chain_id}/dapps/dex/users/historical | 
...
> chainsChainIdDappsDexUsersHistoricalGet(chainsChainIdDappsDexUsersHistoricalGetRequest): ApiRequest[Unit]
...
object Example extends App {
    ...
    val request = apiInstance.chainsChainIdDappsDexUsersHistoricalGet(chainId, startBlock, endBlock, startDate, endDate)
    val response = apiInvoker.execute(request)
