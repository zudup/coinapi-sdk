...
[**chainsChainIdDappsCurveRemoveLiquidityOneEventHistoricalGetWithHttpInfo**](RemoveLiquidityOneEventApi.md#chainsChainIdDappsCurveRemoveLiquidityOneEventHistoricalGetWithHttpInfo) | **GET** /chains/{chain_id}/dapps/curve/removeLiquidityOneEvent/historical | 



## chainsChainIdDappsCurveRemoveLiquidityOneEventHistoricalGet

> chainsChainIdDappsCurveRemoveLiquidityOneEventHistoricalGet(chainsChainIdDappsCurveRemoveLiquidityOneEventHistoricalGetRequest): ApiRequest[Unit]
...
object Example extends App {
    ...
    val apiInstance = RemoveLiquidityOneEventApi("https://onchain.coinapi.io")
    ...
    val request = apiInstance.chainsChainIdDappsCurveRemoveLiquidityOneEventHistoricalGet(chainId, startBlock, endBlock, startDate, endDate, poolId)
