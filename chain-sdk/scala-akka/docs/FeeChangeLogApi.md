...
[**chainsChainIdDappsCurveFeeChangeLogHistoricalGetWithHttpInfo**](FeeChangeLogApi.md#chainsChainIdDappsCurveFeeChangeLogHistoricalGetWithHttpInfo) | **GET** /chains/{chain_id}/dapps/curve/feeChangeLog/historical | 



## chainsChainIdDappsCurveFeeChangeLogHistoricalGet

> chainsChainIdDappsCurveFeeChangeLogHistoricalGet(chainsChainIdDappsCurveFeeChangeLogHistoricalGetRequest): ApiRequest[Unit]
...
object Example extends App {
    ...
    val apiInstance = FeeChangeLogApi("https://onchain.coinapi.io")
    ...
    val request = apiInstance.chainsChainIdDappsCurveFeeChangeLogHistoricalGet(chainId, startBlock, endBlock, startDate, endDate, poolId)
