...
[**chainsChainIdDappsDexWithdrawHistoricalGetWithHttpInfo**](WithdrawApi.md#chainsChainIdDappsDexWithdrawHistoricalGetWithHttpInfo) | **GET** /chains/{chain_id}/dapps/dex/withdraw/historical | 



## chainsChainIdDappsDexWithdrawHistoricalGet

> chainsChainIdDappsDexWithdrawHistoricalGet(chainsChainIdDappsDexWithdrawHistoricalGetRequest): ApiRequest[Unit]
...
object Example extends App {
    ...
    val apiInstance = WithdrawApi("https://onchain.coinapi.io")
    ...
    val request = apiInstance.chainsChainIdDappsDexWithdrawHistoricalGet(chainId, startBlock, endBlock, startDate, endDate, tokenId)
