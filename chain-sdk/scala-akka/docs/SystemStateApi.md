...
[**chainsChainIdDappsCurveSystemStateHistoricalGetWithHttpInfo**](SystemStateApi.md#chainsChainIdDappsCurveSystemStateHistoricalGetWithHttpInfo) | **GET** /chains/{chain_id}/dapps/curve/systemState/historical | 



## chainsChainIdDappsCurveSystemStateHistoricalGet

> chainsChainIdDappsCurveSystemStateHistoricalGet(chainsChainIdDappsCurveSystemStateHistoricalGetRequest): ApiRequest[Unit]
...
object Example extends App {
    ...
    val apiInstance = SystemStateApi("https://onchain.coinapi.io")
    ...
    val request = apiInstance.chainsChainIdDappsCurveSystemStateHistoricalGet(chainId, startBlock, endBlock, startDate, endDate)
