...
[**chainsChainIdDappsCurveDailyVolumeHistoricalGetWithHttpInfo**](DailyVolumeApi.md#chainsChainIdDappsCurveDailyVolumeHistoricalGetWithHttpInfo) | **GET** /chains/{chain_id}/dapps/curve/dailyVolume/historical | 



## chainsChainIdDappsCurveDailyVolumeHistoricalGet

> chainsChainIdDappsCurveDailyVolumeHistoricalGet(chainsChainIdDappsCurveDailyVolumeHistoricalGetRequest): ApiRequest[Unit]
...
object Example extends App {
    ...
    val apiInstance = DailyVolumeApi("https://onchain.coinapi.io")
    ...
    val request = apiInstance.chainsChainIdDappsCurveDailyVolumeHistoricalGet(chainId, startBlock, endBlock, startDate, endDate, poolId)
