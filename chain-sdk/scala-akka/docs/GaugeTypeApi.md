...
[**chainsChainIdDappsCurveGaugeTypeHistoricalGetWithHttpInfo**](GaugeTypeApi.md#chainsChainIdDappsCurveGaugeTypeHistoricalGetWithHttpInfo) | **GET** /chains/{chain_id}/dapps/curve/gaugeType/historical | 



## chainsChainIdDappsCurveGaugeTypeHistoricalGet

> chainsChainIdDappsCurveGaugeTypeHistoricalGet(chainsChainIdDappsCurveGaugeTypeHistoricalGetRequest): ApiRequest[Unit]
...
object Example extends App {
    ...
    val apiInstance = GaugeTypeApi("https://onchain.coinapi.io")
    ...
    val request = apiInstance.chainsChainIdDappsCurveGaugeTypeHistoricalGet(chainId, startBlock, endBlock, startDate, endDate)
