...
[**chainsChainIdDappsUniswapv3TicksHistoricalGetWithHttpInfo**](TicksApi.md#chainsChainIdDappsUniswapv3TicksHistoricalGetWithHttpInfo) | **GET** /chains/{chain_id}/dapps/uniswapv3/ticks/historical | 



## chainsChainIdDappsUniswapv3TicksHistoricalGet

> chainsChainIdDappsUniswapv3TicksHistoricalGet(chainsChainIdDappsUniswapv3TicksHistoricalGetRequest): ApiRequest[Unit]
...
object Example extends App {
    ...
    val apiInstance = TicksApi("https://onchain.coinapi.io")
    ...
    val request = apiInstance.chainsChainIdDappsUniswapv3TicksHistoricalGet(chainId, startBlock, endBlock, startDate, endDate, poolId)
