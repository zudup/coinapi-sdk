...
[**chainsChainIdDappsCurveContractsHistoricalGetWithHttpInfo**](ContractsApi.md#chainsChainIdDappsCurveContractsHistoricalGetWithHttpInfo) | **GET** /chains/{chain_id}/dapps/curve/contracts/historical | 



## chainsChainIdDappsCurveContractsHistoricalGet

> chainsChainIdDappsCurveContractsHistoricalGet(chainsChainIdDappsCurveContractsHistoricalGetRequest): ApiRequest[Unit]
...
object Example extends App {
    ...
    val apiInstance = ContractsApi("https://onchain.coinapi.io")
    ...
    val request = apiInstance.chainsChainIdDappsCurveContractsHistoricalGet(chainId, startBlock, endBlock, startDate, endDate, poolId)
