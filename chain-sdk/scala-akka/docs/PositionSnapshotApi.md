...
[**chainsChainIdDappsUniswapv3PositionSnapshotHistoricalGetWithHttpInfo**](PositionSnapshotApi.md#chainsChainIdDappsUniswapv3PositionSnapshotHistoricalGetWithHttpInfo) | **GET** /chains/{chain_id}/dapps/uniswapv3/positionSnapshot/historical | 



## chainsChainIdDappsUniswapv3PositionSnapshotHistoricalGet

> chainsChainIdDappsUniswapv3PositionSnapshotHistoricalGet(chainsChainIdDappsUniswapv3PositionSnapshotHistoricalGetRequest): ApiRequest[Unit]
...
object Example extends App {
    ...
    val apiInstance = PositionSnapshotApi("https://onchain.coinapi.io")
    ...
    val request = apiInstance.chainsChainIdDappsUniswapv3PositionSnapshotHistoricalGet(chainId, startBlock, endBlock, startDate, endDate, poolId)
