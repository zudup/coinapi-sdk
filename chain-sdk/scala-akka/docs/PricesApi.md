...
[**chainsChainIdDappsDexPricesHistoricalGetWithHttpInfo**](PricesApi.md#chainsChainIdDappsDexPricesHistoricalGetWithHttpInfo) | **GET** /chains/{chain_id}/dapps/dex/prices/historical | 



## chainsChainIdDappsDexPricesHistoricalGet

> chainsChainIdDappsDexPricesHistoricalGet(chainsChainIdDappsDexPricesHistoricalGetRequest): ApiRequest[Unit]
...
object Example extends App {
    ...
    val apiInstance = PricesApi("https://onchain.coinapi.io")
    ...
    val request = apiInstance.chainsChainIdDappsDexPricesHistoricalGet(chainId, startBlock, endBlock, startDate, endDate, tokenId)
