...
[**chainsChainIdDappsCurveAccountsHistoricalGetWithHttpInfo**](AccountsApi.md#chainsChainIdDappsCurveAccountsHistoricalGetWithHttpInfo) | **GET** /chains/{chain_id}/dapps/curve/accounts/historical | 



## chainsChainIdDappsCurveAccountsHistoricalGet

> chainsChainIdDappsCurveAccountsHistoricalGet(chainsChainIdDappsCurveAccountsHistoricalGetRequest): ApiRequest[Unit]
...
object Example extends App {
    ...
    val apiInstance = AccountsApi("https://onchain.coinapi.io")
    ...
    val request = apiInstance.chainsChainIdDappsCurveAccountsHistoricalGet(chainId, startBlock, endBlock, startDate, endDate)
