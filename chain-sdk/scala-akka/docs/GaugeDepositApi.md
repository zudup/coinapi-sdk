...
[**chainsChainIdDappsCurveGaugeDepositHistoricalGetWithHttpInfo**](GaugeDepositApi.md#chainsChainIdDappsCurveGaugeDepositHistoricalGetWithHttpInfo) | **GET** /chains/{chain_id}/dapps/curve/gaugeDeposit/historical | 



## chainsChainIdDappsCurveGaugeDepositHistoricalGet

> chainsChainIdDappsCurveGaugeDepositHistoricalGet(chainsChainIdDappsCurveGaugeDepositHistoricalGetRequest): ApiRequest[Unit]
...
object Example extends App {
    ...
    val apiInstance = GaugeDepositApi("https://onchain.coinapi.io")
    ...
    val request = apiInstance.chainsChainIdDappsCurveGaugeDepositHistoricalGet(chainId, startBlock, endBlock, startDate, endDate)
