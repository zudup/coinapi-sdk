...
[**chainsChainIdDappsCowOrdersHistoricalGetWithHttpInfo**](OrdersApi.md#chainsChainIdDappsCowOrdersHistoricalGetWithHttpInfo) | **GET** /chains/{chain_id}/dapps/cow/orders/historical | 
...
[**chainsChainIdDappsDexOrdersHistoricalGetWithHttpInfo**](OrdersApi.md#chainsChainIdDappsDexOrdersHistoricalGetWithHttpInfo) | **GET** /chains/{chain_id}/dapps/dex/orders/historical | 



## chainsChainIdDappsCowOrdersHistoricalGet

> chainsChainIdDappsCowOrdersHistoricalGet(chainsChainIdDappsCowOrdersHistoricalGetRequest): ApiRequest[Unit]
...
object Example extends App {
    ...
    val apiInstance = OrdersApi("https://onchain.coinapi.io")
    ...
    val request = apiInstance.chainsChainIdDappsCowOrdersHistoricalGet(chainId, startBlock, endBlock, startDate, endDate)
...
> chainsChainIdDappsDexOrdersHistoricalGet(chainsChainIdDappsDexOrdersHistoricalGetRequest): ApiRequest[Unit]
...
object Example extends App {
    ...
    val request = apiInstance.chainsChainIdDappsDexOrdersHistoricalGet(chainId, startBlock, endBlock, startDate, endDate, tokenId)
    val response = apiInvoker.execute(request)
