...
[**chainsChainIdDappsDexSolutionHistoricalGetWithHttpInfo**](SolutionApi.md#chainsChainIdDappsDexSolutionHistoricalGetWithHttpInfo) | **GET** /chains/{chain_id}/dapps/dex/solution/historical | 



## chainsChainIdDappsDexSolutionHistoricalGet

> chainsChainIdDappsDexSolutionHistoricalGet(chainsChainIdDappsDexSolutionHistoricalGetRequest): ApiRequest[Unit]
...
object Example extends App {
    ...
    val apiInstance = SolutionApi("https://onchain.coinapi.io")
    ...
    val request = apiInstance.chainsChainIdDappsDexSolutionHistoricalGet(chainId, startBlock, endBlock, startDate, endDate, tokenId)
