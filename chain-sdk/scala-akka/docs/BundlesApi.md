...
[**chainsChainIdDappsSushiswapBundlesHistoricalGetWithHttpInfo**](BundlesApi.md#chainsChainIdDappsSushiswapBundlesHistoricalGetWithHttpInfo) | **GET** /chains/{chain_id}/dapps/sushiswap/bundles/historical | 
...
[**chainsChainIdDappsUniswapv2BundlesHistoricalGetWithHttpInfo**](BundlesApi.md#chainsChainIdDappsUniswapv2BundlesHistoricalGetWithHttpInfo) | **GET** /chains/{chain_id}/dapps/uniswapv2/bundles/historical | 
...
> chainsChainIdDappsSushiswapBundlesHistoricalGet(chainsChainIdDappsSushiswapBundlesHistoricalGetRequest): ApiRequest[Unit]
...
object Example extends App {
    ...
    val request = apiInstance.chainsChainIdDappsSushiswapBundlesHistoricalGet(chainId, startBlock, endBlock, startDate, endDate)
...
> chainsChainIdDappsUniswapv2BundlesHistoricalGet(chainsChainIdDappsUniswapv2BundlesHistoricalGetRequest): ApiRequest[Unit]
...
object Example extends App {
    ...
    val request = apiInstance.chainsChainIdDappsUniswapv2BundlesHistoricalGet(chainId, startBlock, endBlock, startDate, endDate)
    val response = apiInvoker.execute(request)
