...
[**chainsChainIdDappsCurveProposalsHistoricalGetWithHttpInfo**](ProposalsApi.md#chainsChainIdDappsCurveProposalsHistoricalGetWithHttpInfo) | **GET** /chains/{chain_id}/dapps/curve/proposals/historical | 



## chainsChainIdDappsCurveProposalsHistoricalGet

> chainsChainIdDappsCurveProposalsHistoricalGet(chainsChainIdDappsCurveProposalsHistoricalGetRequest): ApiRequest[Unit]
...
object Example extends App {
    ...
    val apiInstance = ProposalsApi("https://onchain.coinapi.io")
    ...
    val request = apiInstance.chainsChainIdDappsCurveProposalsHistoricalGet(chainId, startBlock, endBlock, startDate, endDate)
