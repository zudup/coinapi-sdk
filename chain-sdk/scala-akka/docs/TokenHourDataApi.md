...
[**chainsChainIdDappsUniswapv3TokenHourDataHistoricalGetWithHttpInfo**](TokenHourDataApi.md#chainsChainIdDappsUniswapv3TokenHourDataHistoricalGetWithHttpInfo) | **GET** /chains/{chain_id}/dapps/uniswapv3/tokenHourData/historical | 



## chainsChainIdDappsUniswapv3TokenHourDataHistoricalGet

> chainsChainIdDappsUniswapv3TokenHourDataHistoricalGet(chainsChainIdDappsUniswapv3TokenHourDataHistoricalGetRequest): ApiRequest[Unit]
...
object Example extends App {
    ...
    val apiInstance = TokenHourDataApi("https://onchain.coinapi.io")
    ...
    val request = apiInstance.chainsChainIdDappsUniswapv3TokenHourDataHistoricalGet(chainId, startBlock, endBlock, startDate, endDate, tokenId)
