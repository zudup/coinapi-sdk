...
[**chainsChainIdDappsDexStatsHistoricalGetWithHttpInfo**](StatsApi.md#chainsChainIdDappsDexStatsHistoricalGetWithHttpInfo) | **GET** /chains/{chain_id}/dapps/dex/stats/historical | 



## chainsChainIdDappsDexStatsHistoricalGet

> chainsChainIdDappsDexStatsHistoricalGet(chainsChainIdDappsDexStatsHistoricalGetRequest): ApiRequest[Unit]
...
object Example extends App {
    ...
    val apiInstance = StatsApi("https://onchain.coinapi.io")
    ...
    val request = apiInstance.chainsChainIdDappsDexStatsHistoricalGet(chainId, startBlock, endBlock, startDate, endDate)
