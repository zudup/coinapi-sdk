...
[**chainsChainIdDappsCowSettlementHistoricalGetWithHttpInfo**](SettlementApi.md#chainsChainIdDappsCowSettlementHistoricalGetWithHttpInfo) | **GET** /chains/{chain_id}/dapps/cow/settlement/historical | 



## chainsChainIdDappsCowSettlementHistoricalGet

> chainsChainIdDappsCowSettlementHistoricalGet(chainsChainIdDappsCowSettlementHistoricalGetRequest): ApiRequest[Unit]
...
object Example extends App {
    ...
    val apiInstance = SettlementApi("https://onchain.coinapi.io")
    ...
    val request = apiInstance.chainsChainIdDappsCowSettlementHistoricalGet(chainId, startBlock, endBlock, startDate, endDate)
