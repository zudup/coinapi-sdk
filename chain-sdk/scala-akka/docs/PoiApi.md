...
[**chainsChainIdDappsCowPoiHistoricalGetWithHttpInfo**](PoiApi.md#chainsChainIdDappsCowPoiHistoricalGetWithHttpInfo) | **GET** /chains/{chain_id}/dapps/cow/poi/historical | 
...
[**chainsChainIdDappsCurvePoiHistoricalGetWithHttpInfo**](PoiApi.md#chainsChainIdDappsCurvePoiHistoricalGetWithHttpInfo) | **GET** /chains/{chain_id}/dapps/curve/poi/historical | 
...
[**chainsChainIdDappsDexPoiHistoricalGetWithHttpInfo**](PoiApi.md#chainsChainIdDappsDexPoiHistoricalGetWithHttpInfo) | **GET** /chains/{chain_id}/dapps/dex/poi/historical | 
...
> chainsChainIdDappsCowPoiHistoricalGet(chainsChainIdDappsCowPoiHistoricalGetRequest): ApiRequest[Unit]
...
object Example extends App {
    ...
    val request = apiInstance.chainsChainIdDappsCowPoiHistoricalGet(chainId, startBlock, endBlock, startDate, endDate)
...
> chainsChainIdDappsCurvePoiHistoricalGet(chainsChainIdDappsCurvePoiHistoricalGetRequest): ApiRequest[Unit]
...
object Example extends App {
    ...
    val request = apiInstance.chainsChainIdDappsCurvePoiHistoricalGet(chainId, startBlock, endBlock, startDate, endDate)
    val response = apiInvoker.execute(request)
...
> chainsChainIdDappsDexPoiHistoricalGet(chainsChainIdDappsDexPoiHistoricalGetRequest): ApiRequest[Unit]
...
object Example extends App {
    ...
    val request = apiInstance.chainsChainIdDappsDexPoiHistoricalGet(chainId, startBlock, endBlock, startDate, endDate)
    val response = apiInvoker.execute(request)
