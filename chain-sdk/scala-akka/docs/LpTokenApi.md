...
[**chainsChainIdDappsCurveLpTokenHistoricalGetWithHttpInfo**](LpTokenApi.md#chainsChainIdDappsCurveLpTokenHistoricalGetWithHttpInfo) | **GET** /chains/{chain_id}/dapps/curve/lpToken/historical | 



## chainsChainIdDappsCurveLpTokenHistoricalGet

> chainsChainIdDappsCurveLpTokenHistoricalGet(chainsChainIdDappsCurveLpTokenHistoricalGetRequest): ApiRequest[Unit]
...
object Example extends App {
    ...
    val apiInstance = LpTokenApi("https://onchain.coinapi.io")
    ...
    val request = apiInstance.chainsChainIdDappsCurveLpTokenHistoricalGet(chainId, startBlock, endBlock, startDate, endDate, poolId)
