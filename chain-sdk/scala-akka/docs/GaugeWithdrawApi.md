...
[**chainsChainIdDappsCurveGaugeWithdrawHistoricalGetWithHttpInfo**](GaugeWithdrawApi.md#chainsChainIdDappsCurveGaugeWithdrawHistoricalGetWithHttpInfo) | **GET** /chains/{chain_id}/dapps/curve/gaugeWithdraw/historical | 



## chainsChainIdDappsCurveGaugeWithdrawHistoricalGet

> chainsChainIdDappsCurveGaugeWithdrawHistoricalGet(chainsChainIdDappsCurveGaugeWithdrawHistoricalGetRequest): ApiRequest[Unit]
...
object Example extends App {
    ...
    val apiInstance = GaugeWithdrawApi("https://onchain.coinapi.io")
    ...
    val request = apiInstance.chainsChainIdDappsCurveGaugeWithdrawHistoricalGet(chainId, startBlock, endBlock, startDate, endDate)
