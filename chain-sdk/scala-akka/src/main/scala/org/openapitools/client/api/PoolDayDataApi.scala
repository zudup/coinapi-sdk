...
object PoolDayDataApi {

  def apply(baseUrl: String = "https://onchain.coinapi.io") = new PoolDayDataApi(baseUrl)
}

class PoolDayDataApi(baseUrl: String) {
   ...
   * @param poolId 
   */
  def chainsChainIdDappsSushiswapPoolDayDataHistoricalGet(chainId: String, startBlock: Option[Long] = None, endBlock: Option[Long] = None, startDate: Option[OffsetDateTime] = None, endDate: Option[OffsetDateTime] = None, poolId: Option[String] = None): ApiRequest[Unit] =
    ApiRequest[Unit](ApiMethods.GET, baseUrl, "/chains/{chain_id}/dapps/sushiswap/poolDayData/historical", "application/json")
