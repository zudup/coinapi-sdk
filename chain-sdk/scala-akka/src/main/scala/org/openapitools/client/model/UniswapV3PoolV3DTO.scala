...
case class UniswapV3PoolV3DTO (
  ...
  feeTier: Option[NumericsBigInteger] = None,
  liquidity: Option[NumericsBigInteger] = None,
  sqrtPrice: Option[NumericsBigInteger] = None,
  feeGrowthGlobal0x128: Option[NumericsBigInteger] = None,
  feeGrowthGlobal1x128: Option[NumericsBigInteger] = None,
  /* Token0 per token1. */
  token0Price: Option[String] = None,
  /* Token1 per token0. */
  token1Price: Option[String] = None,
  tick: Option[NumericsBigInteger] = None,
  observationIndex: Option[NumericsBigInteger] = None,
