...
# Unit tests for OpenapiClient::WithdrawApi
...
describe 'WithdrawApi' do
  ...
  describe 'test an instance of WithdrawApi' do
    it 'should create an instance of WithdrawApi' do
      expect(@api_instance).to be_instance_of(OpenapiClient::WithdrawApi)
    end
  end
  ...
  # @return [nil]
  describe 'chains_chain_id_dapps_dex_withdraw_historical_get test' do
    it 'should work' do
