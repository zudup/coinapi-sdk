...
# Unit tests for OpenapiClient::UniswapDayDataApi
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'UniswapDayDataApi' do
  before do
  ...
  describe 'test an instance of UniswapDayDataApi' do
    it 'should create an instance of UniswapDayDataApi' do
      expect(@api_instance).to be_instance_of(OpenapiClient::UniswapDayDataApi)
    end
  end
