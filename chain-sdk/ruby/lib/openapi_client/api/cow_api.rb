...
module OpenapiClient
  class CowApi
    ...
    # @option opts [Time] :end_date 
    # @return [nil]
    def dapps_cow_poi_historical_get(opts = {})
      dapps_cow_poi_historical_get_with_http_info(opts)
      nil
    end
    ...
    # @option opts [Time] :end_date 
    # @return [Array<(nil, Integer, Hash)>] nil, response status code and response headers
    def dapps_cow_poi_historical_get_with_http_info(opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: CowApi.dapps_cow_poi_historical_get ...'
      end
      # resource path
      local_var_path = '/dapps/cow/poi/historical'
      ...
      new_options = opts.merge(
        :operation => :"CowApi.dapps_cow_poi_historical_get",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: CowApi#dapps_cow_poi_historical_get\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
