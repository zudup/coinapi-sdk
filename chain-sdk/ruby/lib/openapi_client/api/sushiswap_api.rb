...
module OpenapiClient
  class SushiswapApi
    ...
    # @option opts [Time] :end_date 
    # @return [nil]
    def dapps_sushiswap_poi_historical_get(opts = {})
      dapps_sushiswap_poi_historical_get_with_http_info(opts)
      nil
    end
    ...
    # @option opts [Time] :end_date 
    # @return [Array<(nil, Integer, Hash)>] nil, response status code and response headers
    def dapps_sushiswap_poi_historical_get_with_http_info(opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: SushiswapApi.dapps_sushiswap_poi_historical_get ...'
      end
      # resource path
      local_var_path = '/dapps/sushiswap/poi/historical'
      ...
      new_options = opts.merge(
        :operation => :"SushiswapApi.dapps_sushiswap_poi_historical_get",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: SushiswapApi#dapps_sushiswap_poi_historical_get\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def dapps_sushiswap_pools_historical_get(opts = {})
      dapps_sushiswap_pools_historical_get_with_http_info(opts)
      nil
    end
    ...
    def dapps_sushiswap_swaps_historical_get(opts = {})
      dapps_sushiswap_swaps_historical_get_with_http_info(opts)
      nil
    end
    ...
    def dapps_sushiswap_tokens_historical_get(opts = {})
      dapps_sushiswap_tokens_historical_get_with_http_info(opts)
      nil
    end
