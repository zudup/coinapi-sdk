...
require 'openapi_client/api/add_liquidity_event_api'
require 'openapi_client/api/admin_fee_change_log_api'
require 'openapi_client/api/amplification_coeff_change_log_api'
require 'openapi_client/api/batch_api'
require 'openapi_client/api/bundles_api'
require 'openapi_client/api/burns_api'
require 'openapi_client/api/coins_api'
require 'openapi_client/api/contracts_api'
require 'openapi_client/api/contracts_version_api'
require 'openapi_client/api/daily_volume_api'
require 'openapi_client/api/day_data_api'
require 'openapi_client/api/deposit_api'
require 'openapi_client/api/factory_api'
require 'openapi_client/api/fee_change_log_api'
require 'openapi_client/api/gauge_api'
require 'openapi_client/api/gauge_deposit_api'
require 'openapi_client/api/gauge_liquidity_api'
require 'openapi_client/api/gauge_total_weight_api'
require 'openapi_client/api/gauge_type_api'
require 'openapi_client/api/gauge_type_weight_api'
require 'openapi_client/api/gauge_weight_api'
require 'openapi_client/api/gauge_weight_vote_api'
require 'openapi_client/api/gauge_withdraw_api'
require 'openapi_client/api/hour_data_api'
require 'openapi_client/api/hourly_volume_api'
require 'openapi_client/api/liquidity_position_api'
require 'openapi_client/api/liquidity_position_snapshots_api'
require 'openapi_client/api/lp_token_api'
...
require 'openapi_client/api/proposals_api'
require 'openapi_client/api/proposals_vote_api'
require 'openapi_client/api/remove_liquidity_event_api'
require 'openapi_client/api/remove_liquidity_one_event_api'
require 'openapi_client/api/settlement_api'
require 'openapi_client/api/solution_api'
require 'openapi_client/api/stats_api'
require 'openapi_client/api/sushiswap_api'
require 'openapi_client/api/swaps_api'
require 'openapi_client/api/system_state_api'
...
require 'openapi_client/api/transfer_ownership_event_api'
require 'openapi_client/api/underlying_coin_api'
...
require 'openapi_client/api/voting_app_api'
require 'openapi_client/api/weekly_volume_api'
require 'openapi_client/api/withdraw_api'
require 'openapi_client/api/withdraw_request_api'
