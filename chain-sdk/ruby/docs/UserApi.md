...
| ------ | ------------ | ----------- |
| [**chains_chain_id_dapps_uniswapv2_users_historical_get**](UserApi.md#chains_chain_id_dapps_uniswapv2_users_historical_get) | **GET** /chains/{chain_id}/dapps/uniswapv2/users/historical |  |
...
begin
  ...
  puts "Error when calling UserApi->chains_chain_id_dapps_uniswapv2_users_historical_get: #{e}"
end
```
...
begin
  ...
  puts "Error when calling UserApi->chains_chain_id_dapps_uniswapv2_users_historical_get_with_http_info: #{e}"
end
```
