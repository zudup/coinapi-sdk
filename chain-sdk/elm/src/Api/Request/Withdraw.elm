...
module Api.Request.Withdraw exposing
...
chainsChainIdDappsDexWithdrawHistoricalGet : String -> Maybe Int -> Maybe Int -> Maybe Posix -> Maybe Posix -> Maybe String -> Api.Request ()
chainsChainIdDappsDexWithdrawHistoricalGet chainId_path startBlock_query endBlock_query startDate_query endDate_query tokenId_query =
    Api.request
        "GET"
        "/chains/{chain_id}/dapps/dex/withdraw/historical"
