...
chainsChainIdDappsCowOrdersHistoricalGet : String -> Maybe Int -> Maybe Int -> Maybe Posix -> Maybe Posix -> Api.Request ()
chainsChainIdDappsCowOrdersHistoricalGet chainId_path startBlock_query endBlock_query startDate_query endDate_query =
    Api.request
        "GET"
