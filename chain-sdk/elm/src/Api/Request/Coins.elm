...
module Api.Request.Coins exposing
...
chainsChainIdDappsCurveCoinsHistoricalGet : String -> Maybe Int -> Maybe Int -> Maybe Posix -> Maybe Posix -> Maybe String -> Api.Request ()
chainsChainIdDappsCurveCoinsHistoricalGet chainId_path startBlock_query endBlock_query startDate_query endDate_query poolId_query =
    Api.request
        "GET"
        "/chains/{chain_id}/dapps/curve/coins/historical"
