...
module Api.Request.LpToken exposing
...
chainsChainIdDappsCurveLpTokenHistoricalGet : String -> Maybe Int -> Maybe Int -> Maybe Posix -> Maybe Posix -> Maybe String -> Api.Request ()
chainsChainIdDappsCurveLpTokenHistoricalGet chainId_path startBlock_query endBlock_query startDate_query endDate_query poolId_query =
    Api.request
        "GET"
        "/chains/{chain_id}/dapps/curve/lpToken/historical"
