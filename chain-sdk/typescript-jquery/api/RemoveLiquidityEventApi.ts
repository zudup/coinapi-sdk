...
export class RemoveLiquidityEventApi {
     ...
     * @param poolId 
     */
    public chainsChainIdDappsCurveRemoveLiquidityEventHistoricalGet(chainId: string, startBlock?: number, endBlock?: number, startDate?: string, endDate?: string, poolId?: string, extraJQueryAjaxSettings?: JQueryAjaxSettings): JQuery.Promise<
    { response: JQueryXHR; body?: any;  },
    { response: JQueryXHR; errorThrown: string }
    > {
        let localVarPath = this.basePath + '/chains/{chain_id}/dapps/curve/removeLiquidityEvent/historical'.replace('{' + 'chain_id' + '}', encodeURIComponent(String(chainId)));
