...
```php
chainsChainIdDappsCowUsersHistoricalGet($chain_id, $start_block, $end_block, $start_date, $end_date)
```
...
try {
    $apiInstance->chainsChainIdDappsCowUsersHistoricalGet($chain_id, $start_block, $end_block, $start_date, $end_date);
} catch (Exception $e) {
    echo 'Exception when calling UsersApi->chainsChainIdDappsCowUsersHistoricalGet: ', $e->getMessage(), PHP_EOL;
}
```
...
```php
chainsChainIdDappsDexUsersHistoricalGet($chain_id, $start_block, $end_block, $start_date, $end_date)
```
...
try {
    $apiInstance->chainsChainIdDappsDexUsersHistoricalGet($chain_id, $start_block, $end_block, $start_date, $end_date);
} catch (Exception $e) {
    echo 'Exception when calling UsersApi->chainsChainIdDappsDexUsersHistoricalGet: ', $e->getMessage(), PHP_EOL;
}
```
