...
$apiInstance = new OpenAPI\Client\Api\DepositApi(
...
try {
    ...
    echo 'Exception when calling DepositApi->chainsChainIdDappsDexTokensHistoricalGet: ', $e->getMessage(), PHP_EOL;
}
```
