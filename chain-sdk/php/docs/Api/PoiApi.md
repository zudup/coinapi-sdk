...
```php
chainsChainIdDappsCurvePoiHistoricalGet($chain_id, $start_block, $end_block, $start_date, $end_date)
```
...
try {
    $apiInstance->chainsChainIdDappsCurvePoiHistoricalGet($chain_id, $start_block, $end_block, $start_date, $end_date);
} catch (Exception $e) {
    echo 'Exception when calling PoiApi->chainsChainIdDappsCurvePoiHistoricalGet: ', $e->getMessage(), PHP_EOL;
}
```
...
```php
chainsChainIdDappsDexPoiHistoricalGet($chain_id, $start_block, $end_block, $start_date, $end_date)
```
...
try {
    $apiInstance->chainsChainIdDappsDexPoiHistoricalGet($chain_id, $start_block, $end_block, $start_date, $end_date);
} catch (Exception $e) {
    echo 'Exception when calling PoiApi->chainsChainIdDappsDexPoiHistoricalGet: ', $e->getMessage(), PHP_EOL;
}
```
