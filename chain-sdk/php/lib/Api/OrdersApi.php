...
class OrdersApi
{
     ...
     */
    public function v1OrdersHistoryGet($time_start, $time_end)
    {
        list($response) = $this->v1OrdersHistoryGetWithHttpInfo($time_start, $time_end);
        return $response;
    }
     ...
     */
    public function v1OrdersHistoryGetWithHttpInfo($time_start, $time_end)
    {
        $request = $this->v1OrdersHistoryGetRequest($time_start, $time_end);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function v1OrdersHistoryGetAsync($time_start, $time_end)
    {
        return $this->v1OrdersHistoryGetAsyncWithHttpInfo($time_start, $time_end)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function v1OrdersHistoryGetAsyncWithHttpInfo($time_start, $time_end)
    {
        $returnType = '\OpenAPI\Client\Model\OrderHistory[]';
        $request = $this->v1OrdersHistoryGetRequest($time_start, $time_end);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function v1OrdersHistoryGetRequest($time_start, $time_end)
    {
