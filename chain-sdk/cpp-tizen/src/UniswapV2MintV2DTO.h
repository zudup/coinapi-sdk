...
#ifndef _UniswapV2.MintV2DTO_H_
#define _UniswapV2.MintV2DTO_H_
...
/*! \brief Mint entities are created for every emitted Mint event on the Uniswap core contracts. The Mint entity stores key data about the event like token amounts, who sent the transaction, who received the liquidity, and more. This entity can be used to track liquidity provisions on pairs.
 *
 *  \ingroup Models
 *
 */

class UniswapV2.MintV2DTO : public Object {
public:
	/*! \brief Constructor.
	 */
	UniswapV2.MintV2DTO();
	UniswapV2.MintV2DTO(char* str);

	/*! \brief Destructor.
	 */
	virtual ~UniswapV2.MintV2DTO();
	...
	/*! \brief Get Transaction hash plus index in the transaction mint array.
	 */
	std::string getId();

	/*! \brief Set Transaction hash plus index in the transaction mint array.
	 */
