...
void
MintV3DTO::fromJson(char* jsonStr)
{
...
std::string
MintV3DTO::getEntryTime()
{
	return entry_time;
}

void
MintV3DTO::setEntryTime(std::string  entry_time)
{
	this->entry_time = entry_time;
}

std::string
MintV3DTO::getRecvTime()
{
	return recv_time;
}

void
MintV3DTO::setRecvTime(std::string  recv_time)
{
	this->recv_time = recv_time;
}

long long
MintV3DTO::getBlockNumber()
{
	return block_number;
}

void
MintV3DTO::setBlockNumber(long long  block_number)
{
...
void
MintV3DTO::setId(std::string  id)
{
	this->id = id;
}

std::string
MintV3DTO::getTransaction()
{
	return transaction;
}

void
MintV3DTO::setTransaction(std::string  transaction)
{
	this->transaction = transaction;
}

std::string
MintV3DTO::getTimestamp()
{
	return timestamp;
}

void
MintV3DTO::setTimestamp(std::string  timestamp)
{
...
void
MintV3DTO::setPool(std::string  pool)
{
	this->pool = pool;
}
...
void
MintV3DTO::setToken0(std::string  token_0)
{
...
void
MintV3DTO::setToken1(std::string  token_1)
{
...
void
MintV3DTO::setOwner(std::string  owner)
{
	this->owner = owner;
}
...
void
MintV3DTO::setSender(std::string  sender)
{
	this->sender = sender;
}
...
void
MintV3DTO::setOrigin(std::string  origin)
{
	this->origin = origin;
}
...
void
MintV3DTO::setAmount(std::string  amount)
{
	this->amount = amount;
}

std::string
MintV3DTO::getAmount0()
{
	return amount_0;
}

void
MintV3DTO::setAmount0(std::string  amount_0)
{
	this->amount_0 = amount_0;
}

std::string
MintV3DTO::getAmount1()
{
	return amount_1;
}

void
MintV3DTO::setAmount1(std::string  amount_1)
{
	this->amount_1 = amount_1;
}

std::string
MintV3DTO::getAmountUsd()
{
	return amount_usd;
}

void
MintV3DTO::setAmountUsd(std::string  amount_usd)
{
	this->amount_usd = amount_usd;
}

std::string
MintV3DTO::getTickLower()
{
	return tick_lower;
}

void
MintV3DTO::setTickLower(std::string  tick_lower)
{
	this->tick_lower = tick_lower;
}

std::string
MintV3DTO::getTickUpper()
{
	return tick_upper;
}

void
MintV3DTO::setTickUpper(std::string  tick_upper)
{
	this->tick_upper = tick_upper;
}

std::string
MintV3DTO::getLogIndex()
{
	return log_index;
}

void
MintV3DTO::setLogIndex(std::string  log_index)
{
...
void
MintV3DTO::setVid(long long  vid)
{
	this->vid = vid;
}
