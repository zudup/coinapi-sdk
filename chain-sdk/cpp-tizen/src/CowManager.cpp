...
static bool cowGetOrderDTOs (historical)Processor(MemoryStruct_s p_chunk, long code, char* errormsg, void* userData,
	void(* voidHandler)())
{
...
static bool cowGetOrderDTOs (historical)Helper(char * accessToken,
	...
	, void* userData, bool isAsync)
{
	...
	string url("/dapps/cow/OrderDTOs/historical");
	int pos;
	...
	if(!isAsync){
		...
		bool retval = cowGetOrderDTOs (historical)Processor(*p_chunk, code, errormsg, userData,reinterpret_cast<void(*)()>(handler));
		...
		requestInfo = new(nothrow) RequestInfo (CowManager::getBasePath(), url, myhttpmethod, queryParams,
			mBody, headerList, p_chunk, &code, errormsg, userData, reinterpret_cast<void(*)()>(handler), cowGetOrderDTOs (historical)Processor);;
		if(requestInfo == NULL)
			return false;
...
bool CowManager::cowGetOrderDTOs (historical)Async(char * accessToken,
	long long startBlock, long long endBlock, std::string startDate, std::string endDate, std::string poolId, 
	void(* handler)(std::list<Cow.OrderDTO>, Error, void* )
	, void* userData)
{
	return cowGetOrderDTOs (historical)Helper(accessToken,
	startBlock, endBlock, startDate, endDate, poolId, 
	handler, userData, true);
}

bool CowManager::cowGetOrderDTOs (historical)Sync(char * accessToken,
	long long startBlock, long long endBlock, std::string startDate, std::string endDate, std::string poolId, 
	void(* handler)(std::list<Cow.OrderDTO>, Error, void* )
	, void* userData)
{
...
static bool cowGetSettlementDTOs (historical)Processor(MemoryStruct_s p_chunk, long code, char* errormsg, void* userData,
	void(* voidHandler)())
{
...
static bool cowGetSettlementDTOs (historical)Helper(char * accessToken,
	long long startBlock, long long endBlock, std::string startDate, std::string endDate, std::string poolId, 
	void(* handler)(std::list<Cow.SettlementDTO>, Error, void* )
	, void* userData, bool isAsync)
{
	...
	string url("/dapps/cow/SettlementDTOs/historical");
	int pos;
	...
	if(!isAsync){
		NetClient::easycurl(CowManager::getBasePath(), url, myhttpmethod, queryParams,
			mBody, headerList, p_chunk, &code, errormsg);
		bool retval = cowGetSettlementDTOs (historical)Processor(*p_chunk, code, errormsg, userData,reinterpret_cast<void(*)()>(handler));
		...
		requestInfo = new(nothrow) RequestInfo (CowManager::getBasePath(), url, myhttpmethod, queryParams,
			mBody, headerList, p_chunk, &code, errormsg, userData, reinterpret_cast<void(*)()>(handler), cowGetSettlementDTOs (historical)Processor);;
		if(requestInfo == NULL)
			return false;
...
bool CowManager::cowGetSettlementDTOs (historical)Async(char * accessToken,
	long long startBlock, long long endBlock, std::string startDate, std::string endDate, std::string poolId, 
	void(* handler)(std::list<Cow.SettlementDTO>, Error, void* )
	, void* userData)
{
	return cowGetSettlementDTOs (historical)Helper(accessToken,
	startBlock, endBlock, startDate, endDate, poolId, 
	handler, userData, true);
}

bool CowManager::cowGetSettlementDTOs (historical)Sync(char * accessToken,
	long long startBlock, long long endBlock, std::string startDate, std::string endDate, std::string poolId, 
	void(* handler)(std::list<Cow.SettlementDTO>, Error, void* )
	, void* userData)
{
...
static bool cowGetTokenDTOs (historical)Processor(MemoryStruct_s p_chunk, long code, char* errormsg, void* userData,
	void(* voidHandler)())
{
...
static bool cowGetTokenDTOs (historical)Helper(char * accessToken,
	long long startBlock, long long endBlock, std::string startDate, std::string endDate, std::string poolId, 
	void(* handler)(std::list<Cow.TokenDTO>, Error, void* )
	, void* userData, bool isAsync)
{
	...
	string url("/dapps/cow/TokenDTOs/historical");
	int pos;
	...
	if(!isAsync){
		NetClient::easycurl(CowManager::getBasePath(), url, myhttpmethod, queryParams,
			mBody, headerList, p_chunk, &code, errormsg);
		bool retval = cowGetTokenDTOs (historical)Processor(*p_chunk, code, errormsg, userData,reinterpret_cast<void(*)()>(handler));
		...
		requestInfo = new(nothrow) RequestInfo (CowManager::getBasePath(), url, myhttpmethod, queryParams,
			mBody, headerList, p_chunk, &code, errormsg, userData, reinterpret_cast<void(*)()>(handler), cowGetTokenDTOs (historical)Processor);;
		if(requestInfo == NULL)
			return false;
...
bool CowManager::cowGetTokenDTOs (historical)Async(char * accessToken,
	long long startBlock, long long endBlock, std::string startDate, std::string endDate, std::string poolId, 
	void(* handler)(std::list<Cow.TokenDTO>, Error, void* )
	, void* userData)
{
	return cowGetTokenDTOs (historical)Helper(accessToken,
	startBlock, endBlock, startDate, endDate, poolId, 
	handler, userData, true);
}

bool CowManager::cowGetTokenDTOs (historical)Sync(char * accessToken,
	long long startBlock, long long endBlock, std::string startDate, std::string endDate, std::string poolId, 
	void(* handler)(std::list<Cow.TokenDTO>, Error, void* )
	, void* userData)
{
...
static bool cowGetTradeDTOs (historical)Processor(MemoryStruct_s p_chunk, long code, char* errormsg, void* userData,
	void(* voidHandler)())
{
...
static bool cowGetTradeDTOs (historical)Helper(char * accessToken,
	long long startBlock, long long endBlock, std::string startDate, std::string endDate, std::string poolId, 
	void(* handler)(std::list<Cow.TradeDTO>, Error, void* )
	, void* userData, bool isAsync)
{
	...
	string url("/dapps/cow/TradeDTOs/historical");
	int pos;
	...
	if(!isAsync){
		NetClient::easycurl(CowManager::getBasePath(), url, myhttpmethod, queryParams,
			mBody, headerList, p_chunk, &code, errormsg);
		bool retval = cowGetTradeDTOs (historical)Processor(*p_chunk, code, errormsg, userData,reinterpret_cast<void(*)()>(handler));
		...
		requestInfo = new(nothrow) RequestInfo (CowManager::getBasePath(), url, myhttpmethod, queryParams,
			mBody, headerList, p_chunk, &code, errormsg, userData, reinterpret_cast<void(*)()>(handler), cowGetTradeDTOs (historical)Processor);;
		if(requestInfo == NULL)
			return false;
...
bool CowManager::cowGetTradeDTOs (historical)Async(char * accessToken,
	long long startBlock, long long endBlock, std::string startDate, std::string endDate, std::string poolId, 
	void(* handler)(std::list<Cow.TradeDTO>, Error, void* )
	, void* userData)
{
	return cowGetTradeDTOs (historical)Helper(accessToken,
	startBlock, endBlock, startDate, endDate, poolId, 
	handler, userData, true);
}

bool CowManager::cowGetTradeDTOs (historical)Sync(char * accessToken,
	long long startBlock, long long endBlock, std::string startDate, std::string endDate, std::string poolId, 
	void(* handler)(std::list<Cow.TradeDTO>, Error, void* )
	, void* userData)
{
...
static bool cowGetUserDTOs (historical)Processor(MemoryStruct_s p_chunk, long code, char* errormsg, void* userData,
	void(* voidHandler)())
{
...
static bool cowGetUserDTOs (historical)Helper(char * accessToken,
	long long startBlock, long long endBlock, std::string startDate, std::string endDate, std::string poolId, 
	void(* handler)(std::list<Cow.UserDTO>, Error, void* )
	, void* userData, bool isAsync)
{
	...
	string url("/dapps/cow/UserDTOs/historical");
	int pos;
	...
	if(!isAsync){
		NetClient::easycurl(CowManager::getBasePath(), url, myhttpmethod, queryParams,
			mBody, headerList, p_chunk, &code, errormsg);
		bool retval = cowGetUserDTOs (historical)Processor(*p_chunk, code, errormsg, userData,reinterpret_cast<void(*)()>(handler));
		...
		requestInfo = new(nothrow) RequestInfo (CowManager::getBasePath(), url, myhttpmethod, queryParams,
			mBody, headerList, p_chunk, &code, errormsg, userData, reinterpret_cast<void(*)()>(handler), cowGetUserDTOs (historical)Processor);;
		if(requestInfo == NULL)
			return false;
...
bool CowManager::cowGetUserDTOs (historical)Async(char * accessToken,
	long long startBlock, long long endBlock, std::string startDate, std::string endDate, std::string poolId, 
	void(* handler)(std::list<Cow.UserDTO>, Error, void* )
	, void* userData)
{
	return cowGetUserDTOs (historical)Helper(accessToken,
	startBlock, endBlock, startDate, endDate, poolId, 
	handler, userData, true);
}

bool CowManager::cowGetUserDTOs (historical)Sync(char * accessToken,
	long long startBlock, long long endBlock, std::string startDate, std::string endDate, std::string poolId, 
	void(* handler)(std::list<Cow.UserDTO>, Error, void* )
	, void* userData)
{
