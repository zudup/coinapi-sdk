...
void
FactoryV3DTO::fromJson(char* jsonStr)
{
...
FactoryV3DTO::FactoryV3DTO(char* json)
{
	this->fromJson(json);
}
...
std::string
FactoryV3DTO::getEntryTime()
{
	return entry_time;
}

void
FactoryV3DTO::setEntryTime(std::string  entry_time)
{
	this->entry_time = entry_time;
}

std::string
FactoryV3DTO::getRecvTime()
{
	return recv_time;
}

void
FactoryV3DTO::setRecvTime(std::string  recv_time)
{
	this->recv_time = recv_time;
}

long long
FactoryV3DTO::getBlockNumber()
{
	return block_number;
}

void
FactoryV3DTO::setBlockNumber(long long  block_number)
{
...
void
FactoryV3DTO::setId(std::string  id)
{
	this->id = id;
}

std::string
FactoryV3DTO::getPoolCount()
{
	return pool_count;
}

void
FactoryV3DTO::setPoolCount(std::string  pool_count)
{
	this->pool_count = pool_count;
}

std::string
FactoryV3DTO::getTxCount()
{
	return tx_count;
}

void
FactoryV3DTO::setTxCount(std::string  tx_count)
{
	this->tx_count = tx_count;
}

std::string
FactoryV3DTO::getTotalVolumeUsd()
{
	return total_volume_usd;
}

void
FactoryV3DTO::setTotalVolumeUsd(std::string  total_volume_usd)
{
	this->total_volume_usd = total_volume_usd;
}

std::string
FactoryV3DTO::getTotalVolumeEth()
{
	return total_volume_eth;
}

void
FactoryV3DTO::setTotalVolumeEth(std::string  total_volume_eth)
{
	this->total_volume_eth = total_volume_eth;
}

std::string
FactoryV3DTO::getTotalFeesUsd()
{
	return total_fees_usd;
}

void
FactoryV3DTO::setTotalFeesUsd(std::string  total_fees_usd)
{
	this->total_fees_usd = total_fees_usd;
}

std::string
FactoryV3DTO::getTotalFeesEth()
{
	return total_fees_eth;
}

void
FactoryV3DTO::setTotalFeesEth(std::string  total_fees_eth)
{
	this->total_fees_eth = total_fees_eth;
}

std::string
FactoryV3DTO::getUntrackedVolumeUsd()
{
	return untracked_volume_usd;
}

void
FactoryV3DTO::setUntrackedVolumeUsd(std::string  untracked_volume_usd)
{
	this->untracked_volume_usd = untracked_volume_usd;
}

std::string
FactoryV3DTO::getTotalValueLockedUsd()
{
	return total_value_locked_usd;
}

void
FactoryV3DTO::setTotalValueLockedUsd(std::string  total_value_locked_usd)
{
	this->total_value_locked_usd = total_value_locked_usd;
}

std::string
FactoryV3DTO::getTotalValueLockedEth()
{
	return total_value_locked_eth;
}

void
FactoryV3DTO::setTotalValueLockedEth(std::string  total_value_locked_eth)
{
	this->total_value_locked_eth = total_value_locked_eth;
}

std::string
FactoryV3DTO::getTotalValueLockedUsdUntracked()
{
	return total_value_locked_usd_untracked;
}

void
FactoryV3DTO::setTotalValueLockedUsdUntracked(std::string  total_value_locked_usd_untracked)
{
	this->total_value_locked_usd_untracked = total_value_locked_usd_untracked;
}

std::string
FactoryV3DTO::getTotalValueLockedEthUntracked()
{
	return total_value_locked_eth_untracked;
}

void
FactoryV3DTO::setTotalValueLockedEthUntracked(std::string  total_value_locked_eth_untracked)
{
	this->total_value_locked_eth_untracked = total_value_locked_eth_untracked;
}

std::string
FactoryV3DTO::getOwner()
{
	return owner;
}

void
FactoryV3DTO::setOwner(std::string  owner)
{
	this->owner = owner;
}
...
void
FactoryV3DTO::setVid(long long  vid)
{
	this->vid = vid;
}
