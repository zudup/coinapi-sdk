...
static bool chainsChainIdDappsSushiswapLiquidityPositionSnapshotsHistoricalGetProcessor(MemoryStruct_s p_chunk, long code, char* errormsg, void* userData,
	void(* voidHandler)())
{
...
static bool chainsChainIdDappsSushiswapLiquidityPositionSnapshotsHistoricalGetHelper(char * accessToken,
	...
	void(* handler)(Error, void* ) , void* userData, bool isAsync)
{
	...
	string url("/chains/{chain_id}/dapps/sushiswap/liquidityPositionSnapshots/historical");
	int pos;
	...
	if(!isAsync){
		...
		bool retval = chainsChainIdDappsSushiswapLiquidityPositionSnapshotsHistoricalGetProcessor(*p_chunk, code, errormsg, userData,reinterpret_cast<void(*)()>(handler));
		...
		requestInfo = new(nothrow) RequestInfo (LiquidityPositionSnapshotsManager::getBasePath(), url, myhttpmethod, queryParams,
			mBody, headerList, p_chunk, &code, errormsg, userData, reinterpret_cast<void(*)()>(handler), chainsChainIdDappsSushiswapLiquidityPositionSnapshotsHistoricalGetProcessor);;
		if(requestInfo == NULL)
			return false;
...
bool LiquidityPositionSnapshotsManager::chainsChainIdDappsSushiswapLiquidityPositionSnapshotsHistoricalGetAsync(char * accessToken,
	std::string chainId, long long startBlock, long long endBlock, std::string startDate, std::string endDate, std::string poolId, 
	
	void(* handler)(Error, void* ) , void* userData)
{
	return chainsChainIdDappsSushiswapLiquidityPositionSnapshotsHistoricalGetHelper(accessToken,
	chainId, startBlock, endBlock, startDate, endDate, poolId, 
	handler, userData, true);
}

bool LiquidityPositionSnapshotsManager::chainsChainIdDappsSushiswapLiquidityPositionSnapshotsHistoricalGetSync(char * accessToken,
	std::string chainId, long long startBlock, long long endBlock, std::string startDate, std::string endDate, std::string poolId, 
