...
#ifndef _UniswapV2.MintDTO_H_
#define _UniswapV2.MintDTO_H_
...
class UniswapV2.MintDTO : public Object {
public:
	/*! \brief Constructor.
	 */
	UniswapV2.MintDTO();
	UniswapV2.MintDTO(char* str);

	/*! \brief Destructor.
	 */
	virtual ~UniswapV2.MintDTO();
