...
static bool chainsChainIdDappsDexBatchHistoricalGetProcessor(MemoryStruct_s p_chunk, long code, char* errormsg, void* userData,
	void(* voidHandler)())
{
...
static bool chainsChainIdDappsDexBatchHistoricalGetHelper(char * accessToken,
	...
	void(* handler)(Error, void* ) , void* userData, bool isAsync)
{
	...
	string url("/chains/{chain_id}/dapps/dex/batch/historical");
	int pos;
	...
	if(!isAsync){
		...
		bool retval = chainsChainIdDappsDexBatchHistoricalGetProcessor(*p_chunk, code, errormsg, userData,reinterpret_cast<void(*)()>(handler));
		...
		requestInfo = new(nothrow) RequestInfo (BatchManager::getBasePath(), url, myhttpmethod, queryParams,
			mBody, headerList, p_chunk, &code, errormsg, userData, reinterpret_cast<void(*)()>(handler), chainsChainIdDappsDexBatchHistoricalGetProcessor);;
		if(requestInfo == NULL)
			return false;
...
bool BatchManager::chainsChainIdDappsDexBatchHistoricalGetAsync(char * accessToken,
	std::string chainId, long long startBlock, long long endBlock, std::string startDate, std::string endDate, 
	
	void(* handler)(Error, void* ) , void* userData)
{
	return chainsChainIdDappsDexBatchHistoricalGetHelper(accessToken,
	chainId, startBlock, endBlock, startDate, endDate, 
	handler, userData, true);
}

bool BatchManager::chainsChainIdDappsDexBatchHistoricalGetSync(char * accessToken,
	std::string chainId, long long startBlock, long long endBlock, std::string startDate, std::string endDate, 
