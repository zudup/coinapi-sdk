...
void
PairV2DTO::fromJson(char* jsonStr)
{
...
std::string
PairV2DTO::getEntryTime()
{
	return entry_time;
}

void
PairV2DTO::setEntryTime(std::string  entry_time)
{
	this->entry_time = entry_time;
}

std::string
PairV2DTO::getRecvTime()
{
	return recv_time;
}

void
PairV2DTO::setRecvTime(std::string  recv_time)
{
	this->recv_time = recv_time;
}

long long
PairV2DTO::getBlockNumber()
{
	return block_number;
}

void
PairV2DTO::setBlockNumber(long long  block_number)
{
...
void
PairV2DTO::setVid(long long  vid)
{
	this->vid = vid;
}
...
void
PairV2DTO::setToken0(std::string  token_0)
{
...
void
PairV2DTO::setToken1(std::string  token_1)
{
	this->token_1 = token_1;
}

std::string
PairV2DTO::getReserve0()
{
	return reserve_0;
}

void
PairV2DTO::setReserve0(std::string  reserve_0)
{
	this->reserve_0 = reserve_0;
}

std::string
PairV2DTO::getReserve1()
{
	return reserve_1;
}

void
PairV2DTO::setReserve1(std::string  reserve_1)
{
	this->reserve_1 = reserve_1;
}

std::string
PairV2DTO::getTotalSupply()
{
	return total_supply;
}

void
PairV2DTO::setTotalSupply(std::string  total_supply)
{
	this->total_supply = total_supply;
}

std::string
PairV2DTO::getReserveEth()
{
	return reserve_eth;
}

void
PairV2DTO::setReserveEth(std::string  reserve_eth)
{
	this->reserve_eth = reserve_eth;
}

std::string
PairV2DTO::getReserveUsd()
{
	return reserve_usd;
}

void
PairV2DTO::setReserveUsd(std::string  reserve_usd)
{
	this->reserve_usd = reserve_usd;
}

std::string
PairV2DTO::getTrackedReserveEth()
{
	return tracked_reserve_eth;
}

void
PairV2DTO::setTrackedReserveEth(std::string  tracked_reserve_eth)
{
	this->tracked_reserve_eth = tracked_reserve_eth;
}

std::string
PairV2DTO::getToken0Price()
{
	return token_0_price;
}

void
PairV2DTO::setToken0Price(std::string  token_0_price)
{
	this->token_0_price = token_0_price;
}

std::string
PairV2DTO::getToken1Price()
{
	return token_1_price;
}

void
PairV2DTO::setToken1Price(std::string  token_1_price)
{
	this->token_1_price = token_1_price;
}

std::string
PairV2DTO::getVolumeToken0()
{
	return volume_token_0;
}

void
PairV2DTO::setVolumeToken0(std::string  volume_token_0)
{
	this->volume_token_0 = volume_token_0;
}

std::string
PairV2DTO::getVolumeToken1()
{
	return volume_token_1;
}

void
PairV2DTO::setVolumeToken1(std::string  volume_token_1)
{
	this->volume_token_1 = volume_token_1;
}

std::string
PairV2DTO::getVolumeUsd()
{
	return volume_usd;
}

void
PairV2DTO::setVolumeUsd(std::string  volume_usd)
{
	this->volume_usd = volume_usd;
}

std::string
PairV2DTO::getUntrackedVolumeUsd()
{
	return untracked_volume_usd;
}

void
PairV2DTO::setUntrackedVolumeUsd(std::string  untracked_volume_usd)
{
	this->untracked_volume_usd = untracked_volume_usd;
}

BigInteger
PairV2DTO::getTxCount()
{
	return tx_count;
}

void
PairV2DTO::setTxCount(BigInteger  tx_count)
{
	this->tx_count = tx_count;
}

std::string
PairV2DTO::getCreatedAtTimestamp()
{
	return created_at_timestamp;
}

void
PairV2DTO::setCreatedAtTimestamp(std::string  created_at_timestamp)
{
	this->created_at_timestamp = created_at_timestamp;
}

std::string
PairV2DTO::getLiquidityProviderCount()
{
	return liquidity_provider_count;
}

void
PairV2DTO::setLiquidityProviderCount(std::string  liquidity_provider_count)
{
	this->liquidity_provider_count = liquidity_provider_count;
}

double
PairV2DTO::getEvaluatedAsk()
{
	return evaluated_ask;
}

void
PairV2DTO::setEvaluatedAsk(double  evaluated_ask)
{
