...
#ifndef _UniswapV2.TransactionDTO_H_
#define _UniswapV2.TransactionDTO_H_
...
class UniswapV2.TransactionDTO : public Object {
public:
	/*! \brief Constructor.
	 */
	UniswapV2.TransactionDTO();
	UniswapV2.TransactionDTO(char* str);

	/*! \brief Destructor.
	 */
	virtual ~UniswapV2.TransactionDTO();
...
#endif /* _UniswapV2.TransactionDTO_H_ */
