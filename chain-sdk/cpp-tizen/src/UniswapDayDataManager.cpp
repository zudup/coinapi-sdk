...
#include "UniswapDayDataManager.h"
#include "NetClient.h"
#include "Helpers.h"
#include "Error.h"
...
UniswapDayDataManager::UniswapDayDataManager()
{
...
static gboolean __UniswapDayDataManagerresponseHandler(gpointer data)
{
...
static gpointer __UniswapDayDataManagerthreadFunc(gpointer data)
{
	RequestInfo *request = static_cast<RequestInfo*>(data);
	...
	g_idle_add(__UniswapDayDataManagerresponseHandler, static_cast<gpointer>(request));
	...
	void(* handler)(Error, void* ) , void* userData, bool isAsync)
{
	...
	if(!isAsync){
		...
		thread = g_thread_new(NULL, __UniswapDayDataManagerthreadFunc, static_cast<gpointer>(requestInfo));
		return true;
	}
}
