...
static bool chainsChainIdDappsDexSolutionHistoricalGetProcessor(MemoryStruct_s p_chunk, long code, char* errormsg, void* userData,
	void(* voidHandler)())
{
...
static bool chainsChainIdDappsDexSolutionHistoricalGetHelper(char * accessToken,
	...
	void(* handler)(Error, void* ) , void* userData, bool isAsync)
{
	...
	string url("/chains/{chain_id}/dapps/dex/solution/historical");
	int pos;
	...
	if(!isAsync){
		...
		bool retval = chainsChainIdDappsDexSolutionHistoricalGetProcessor(*p_chunk, code, errormsg, userData,reinterpret_cast<void(*)()>(handler));
		...
		requestInfo = new(nothrow) RequestInfo (SolutionManager::getBasePath(), url, myhttpmethod, queryParams,
			mBody, headerList, p_chunk, &code, errormsg, userData, reinterpret_cast<void(*)()>(handler), chainsChainIdDappsDexSolutionHistoricalGetProcessor);;
		if(requestInfo == NULL)
			return false;
...
bool SolutionManager::chainsChainIdDappsDexSolutionHistoricalGetAsync(char * accessToken,
	std::string chainId, long long startBlock, long long endBlock, std::string startDate, std::string endDate, std::string tokenId, 
	
	void(* handler)(Error, void* ) , void* userData)
{
	return chainsChainIdDappsDexSolutionHistoricalGetHelper(accessToken,
	chainId, startBlock, endBlock, startDate, endDate, tokenId, 
	handler, userData, true);
}

bool SolutionManager::chainsChainIdDappsDexSolutionHistoricalGetSync(char * accessToken,
	std::string chainId, long long startBlock, long long endBlock, std::string startDate, std::string endDate, std::string tokenId, 
