...
UniswapV2.PairDTO::UniswapV2.PairDTO()
{
	//__init();
}
...
void
UniswapV2.PairDTO::fromJson(char* jsonStr)
{
...
UniswapV2.PairDTO::UniswapV2.PairDTO(char* json)
{
	this->fromJson(json);
}

char*
UniswapV2.PairDTO::toJson()
{
...
std::string
UniswapV2.PairDTO::getEntryTime()
{
	return entry_time;
}

void
UniswapV2.PairDTO::setEntryTime(std::string  entry_time)
{
	this->entry_time = entry_time;
}

std::string
UniswapV2.PairDTO::getRecvTime()
{
	return recv_time;
}

void
UniswapV2.PairDTO::setRecvTime(std::string  recv_time)
{
	this->recv_time = recv_time;
}

long long
UniswapV2.PairDTO::getBlockNumber()
{
	return block_number;
}

void
UniswapV2.PairDTO::setBlockNumber(long long  block_number)
{
	this->block_number = block_number;
}

long long
UniswapV2.PairDTO::getVid()
{
	return vid;
}

void
UniswapV2.PairDTO::setVid(long long  vid)
{
	this->vid = vid;
}

std::string
UniswapV2.PairDTO::getId()
{
	return id;
}

void
UniswapV2.PairDTO::setId(std::string  id)
{
	this->id = id;
}

std::string
UniswapV2.PairDTO::getToken0()
{
	return token_0;
}

void
UniswapV2.PairDTO::setToken0(std::string  token_0)
{
	this->token_0 = token_0;
}

std::string
UniswapV2.PairDTO::getToken1()
{
	return token_1;
}

void
UniswapV2.PairDTO::setToken1(std::string  token_1)
{
	this->token_1 = token_1;
}

std::string
UniswapV2.PairDTO::getReserve0()
{
	return reserve_0;
}

void
UniswapV2.PairDTO::setReserve0(std::string  reserve_0)
{
	this->reserve_0 = reserve_0;
}

std::string
UniswapV2.PairDTO::getReserve1()
{
	return reserve_1;
}

void
UniswapV2.PairDTO::setReserve1(std::string  reserve_1)
{
	this->reserve_1 = reserve_1;
}

std::string
UniswapV2.PairDTO::getTotalSupply()
{
	return total_supply;
}

void
UniswapV2.PairDTO::setTotalSupply(std::string  total_supply)
{
	this->total_supply = total_supply;
}

std::string
UniswapV2.PairDTO::getReserveEth()
{
	return reserve_eth;
}

void
UniswapV2.PairDTO::setReserveEth(std::string  reserve_eth)
{
	this->reserve_eth = reserve_eth;
}

std::string
UniswapV2.PairDTO::getReserveUsd()
{
	return reserve_usd;
}

void
UniswapV2.PairDTO::setReserveUsd(std::string  reserve_usd)
{
	this->reserve_usd = reserve_usd;
}

std::string
UniswapV2.PairDTO::getTrackedReserveEth()
{
	return tracked_reserve_eth;
}

void
UniswapV2.PairDTO::setTrackedReserveEth(std::string  tracked_reserve_eth)
{
	this->tracked_reserve_eth = tracked_reserve_eth;
}

std::string
UniswapV2.PairDTO::getToken0Price()
{
	return token_0_price;
}

void
UniswapV2.PairDTO::setToken0Price(std::string  token_0_price)
{
	this->token_0_price = token_0_price;
}

std::string
UniswapV2.PairDTO::getToken1Price()
{
	return token_1_price;
}

void
UniswapV2.PairDTO::setToken1Price(std::string  token_1_price)
{
	this->token_1_price = token_1_price;
}

std::string
UniswapV2.PairDTO::getVolumeToken0()
{
	return volume_token_0;
}

void
UniswapV2.PairDTO::setVolumeToken0(std::string  volume_token_0)
{
	this->volume_token_0 = volume_token_0;
}

std::string
UniswapV2.PairDTO::getVolumeToken1()
{
	return volume_token_1;
}

void
UniswapV2.PairDTO::setVolumeToken1(std::string  volume_token_1)
{
	this->volume_token_1 = volume_token_1;
}

std::string
UniswapV2.PairDTO::getVolumeUsd()
{
	return volume_usd;
}

void
UniswapV2.PairDTO::setVolumeUsd(std::string  volume_usd)
{
	this->volume_usd = volume_usd;
}

std::string
UniswapV2.PairDTO::getUntrackedVolumeUsd()
{
	return untracked_volume_usd;
}

void
UniswapV2.PairDTO::setUntrackedVolumeUsd(std::string  untracked_volume_usd)
{
	this->untracked_volume_usd = untracked_volume_usd;
}

Numerics.BigInteger
UniswapV2.PairDTO::getTxCount()
{
	return tx_count;
}

void
UniswapV2.PairDTO::setTxCount(Numerics.BigInteger  tx_count)
{
	this->tx_count = tx_count;
}

std::string
UniswapV2.PairDTO::getCreatedAtTimestamp()
{
	return created_at_timestamp;
}

void
UniswapV2.PairDTO::setCreatedAtTimestamp(std::string  created_at_timestamp)
{
	this->created_at_timestamp = created_at_timestamp;
}

std::string
UniswapV2.PairDTO::getLiquidityProviderCount()
{
	return liquidity_provider_count;
}

void
UniswapV2.PairDTO::setLiquidityProviderCount(std::string  liquidity_provider_count)
{
	this->liquidity_provider_count = liquidity_provider_count;
}

double
UniswapV2.PairDTO::getEvaluatedAsk()
{
	return evaluated_ask;
}

void
UniswapV2.PairDTO::setEvaluatedAsk(double  evaluated_ask)
{
