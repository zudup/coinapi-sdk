...
void
PositionSnapshotV3DTO::__cleanup()
{
	//if(entry_time != NULL) {
	//
	//delete entry_time;
...
void
PositionSnapshotV3DTO::fromJson(char* jsonStr)
{
...
PositionSnapshotV3DTO::PositionSnapshotV3DTO(char* json)
{
	this->fromJson(json);
}

char*
PositionSnapshotV3DTO::toJson()
{
...
std::string
PositionSnapshotV3DTO::getEntryTime()
{
	return entry_time;
}

void
PositionSnapshotV3DTO::setEntryTime(std::string  entry_time)
{
	this->entry_time = entry_time;
}

std::string
PositionSnapshotV3DTO::getRecvTime()
{
	return recv_time;
}

void
PositionSnapshotV3DTO::setRecvTime(std::string  recv_time)
{
	this->recv_time = recv_time;
}

long long
PositionSnapshotV3DTO::getBlockNumber()
{
	return block_number;
}

void
PositionSnapshotV3DTO::setBlockNumber(long long  block_number)
{
	this->block_number = block_number;
}

std::string
PositionSnapshotV3DTO::getId()
{
	return id;
}

void
PositionSnapshotV3DTO::setId(std::string  id)
{
	this->id = id;
}

std::string
PositionSnapshotV3DTO::getOwner()
{
	return owner;
}

void
PositionSnapshotV3DTO::setOwner(std::string  owner)
{
	this->owner = owner;
}

std::string
PositionSnapshotV3DTO::getPool()
{
	return pool;
}

void
PositionSnapshotV3DTO::setPool(std::string  pool)
{
	this->pool = pool;
}

std::string
PositionSnapshotV3DTO::getPosition()
{
	return position;
}

void
PositionSnapshotV3DTO::setPosition(std::string  position)
{
	this->position = position;
}

std::string
PositionSnapshotV3DTO::getTimestamp()
{
	return timestamp;
}

void
PositionSnapshotV3DTO::setTimestamp(std::string  timestamp)
{
	this->timestamp = timestamp;
}

std::string
PositionSnapshotV3DTO::getLiquidity()
{
	return liquidity;
}

void
PositionSnapshotV3DTO::setLiquidity(std::string  liquidity)
{
	this->liquidity = liquidity;
}

std::string
PositionSnapshotV3DTO::getDepositedToken0()
{
	return deposited_token_0;
}

void
PositionSnapshotV3DTO::setDepositedToken0(std::string  deposited_token_0)
{
	this->deposited_token_0 = deposited_token_0;
}

std::string
PositionSnapshotV3DTO::getDepositedToken1()
{
	return deposited_token_1;
}

void
PositionSnapshotV3DTO::setDepositedToken1(std::string  deposited_token_1)
{
	this->deposited_token_1 = deposited_token_1;
}

std::string
PositionSnapshotV3DTO::getWithdrawnToken0()
{
	return withdrawn_token_0;
}

void
PositionSnapshotV3DTO::setWithdrawnToken0(std::string  withdrawn_token_0)
{
	this->withdrawn_token_0 = withdrawn_token_0;
}

std::string
PositionSnapshotV3DTO::getWithdrawnToken1()
{
	return withdrawn_token_1;
}

void
PositionSnapshotV3DTO::setWithdrawnToken1(std::string  withdrawn_token_1)
{
	this->withdrawn_token_1 = withdrawn_token_1;
}

std::string
PositionSnapshotV3DTO::getCollectedFeesToken0()
{
	return collected_fees_token_0;
}

void
PositionSnapshotV3DTO::setCollectedFeesToken0(std::string  collected_fees_token_0)
{
	this->collected_fees_token_0 = collected_fees_token_0;
}

std::string
PositionSnapshotV3DTO::getCollectedFeesToken1()
{
	return collected_fees_token_1;
}

void
PositionSnapshotV3DTO::setCollectedFeesToken1(std::string  collected_fees_token_1)
{
	this->collected_fees_token_1 = collected_fees_token_1;
}

std::string
PositionSnapshotV3DTO::getTransaction()
{
	return transaction;
}

void
PositionSnapshotV3DTO::setTransaction(std::string  transaction)
{
	this->transaction = transaction;
}

std::string
PositionSnapshotV3DTO::getFeeGrowthInside0LastX128()
{
	return fee_growth_inside_0_last_x128;
}

void
PositionSnapshotV3DTO::setFeeGrowthInside0LastX128(std::string  fee_growth_inside_0_last_x128)
{
	this->fee_growth_inside_0_last_x128 = fee_growth_inside_0_last_x128;
}

std::string
PositionSnapshotV3DTO::getFeeGrowthInside1LastX128()
{
	return fee_growth_inside_1_last_x128;
}

void
PositionSnapshotV3DTO::setFeeGrowthInside1LastX128(std::string  fee_growth_inside_1_last_x128)
{
	this->fee_growth_inside_1_last_x128 = fee_growth_inside_1_last_x128;
}

long long
PositionSnapshotV3DTO::getVid()
{
	return vid;
}

void
PositionSnapshotV3DTO::setVid(long long  vid)
{
	this->vid = vid;
}
