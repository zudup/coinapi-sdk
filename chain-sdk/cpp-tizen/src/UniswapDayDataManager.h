#ifndef _UniswapDayDataManager_H_
#define _UniswapDayDataManager_H_
...
/** \addtogroup UniswapDayData UniswapDayData
 * \ingroup Operations
 *  @{
 */
class UniswapDayDataManager {
public:
	UniswapDayDataManager();
	virtual ~UniswapDayDataManager();
...
#endif /* UniswapDayDataManager_H_ */
