...
Sushiswap.HourDataDTO::Sushiswap.HourDataDTO()
{
	//__init();
}
...
void
Sushiswap.HourDataDTO::__cleanup()
{
	//if(entry_time != NULL) {
	//
	//delete entry_time;
...
void
Sushiswap.HourDataDTO::fromJson(char* jsonStr)
{
...
Sushiswap.HourDataDTO::Sushiswap.HourDataDTO(char* json)
{
	this->fromJson(json);
}

char*
Sushiswap.HourDataDTO::toJson()
{
...
std::string
Sushiswap.HourDataDTO::getEntryTime()
{
	return entry_time;
}

void
Sushiswap.HourDataDTO::setEntryTime(std::string  entry_time)
{
	this->entry_time = entry_time;
}

std::string
Sushiswap.HourDataDTO::getRecvTime()
{
	return recv_time;
}

void
Sushiswap.HourDataDTO::setRecvTime(std::string  recv_time)
{
	this->recv_time = recv_time;
}

long long
Sushiswap.HourDataDTO::getBlockNumber()
{
	return block_number;
}

void
Sushiswap.HourDataDTO::setBlockNumber(long long  block_number)
{
	this->block_number = block_number;
}

std::string
Sushiswap.HourDataDTO::getId()
{
	return id;
}

void
Sushiswap.HourDataDTO::setId(std::string  id)
{
	this->id = id;
}

int
Sushiswap.HourDataDTO::getDate()
{
	return date;
}

void
Sushiswap.HourDataDTO::setDate(int  date)
{
	this->date = date;
}

std::string
Sushiswap.HourDataDTO::getFactory()
{
	return factory;
}

void
Sushiswap.HourDataDTO::setFactory(std::string  factory)
{
	this->factory = factory;
}

std::string
Sushiswap.HourDataDTO::getVolumeEth()
{
	return volume_eth;
}

void
Sushiswap.HourDataDTO::setVolumeEth(std::string  volume_eth)
{
	this->volume_eth = volume_eth;
}

std::string
Sushiswap.HourDataDTO::getVolumeUsd()
{
	return volume_usd;
}

void
Sushiswap.HourDataDTO::setVolumeUsd(std::string  volume_usd)
{
	this->volume_usd = volume_usd;
}

std::string
Sushiswap.HourDataDTO::getUntrackedVolume()
{
	return untracked_volume;
}

void
Sushiswap.HourDataDTO::setUntrackedVolume(std::string  untracked_volume)
{
	this->untracked_volume = untracked_volume;
}

std::string
Sushiswap.HourDataDTO::getLiquidityEth()
{
	return liquidity_eth;
}

void
Sushiswap.HourDataDTO::setLiquidityEth(std::string  liquidity_eth)
{
	this->liquidity_eth = liquidity_eth;
}

std::string
Sushiswap.HourDataDTO::getLiquidityUsd()
{
	return liquidity_usd;
}

void
Sushiswap.HourDataDTO::setLiquidityUsd(std::string  liquidity_usd)
{
	this->liquidity_usd = liquidity_usd;
}

std::string
Sushiswap.HourDataDTO::getTxCount()
{
	return tx_count;
}

void
Sushiswap.HourDataDTO::setTxCount(std::string  tx_count)
{
	this->tx_count = tx_count;
}

long long
Sushiswap.HourDataDTO::getVid()
{
	return vid;
}

void
Sushiswap.HourDataDTO::setVid(long long  vid)
{
	this->vid = vid;
}
