 ...
 */
bool chainsChainIdDappsCowOrdersHistoricalGetSync(char * accessToken,
 ...
 * \param userData The user data to be passed to the callback function.
 */
bool chainsChainIdDappsCowOrdersHistoricalGetAsync(char * accessToken,
	std::string chainId, long long startBlock, long long endBlock, std::string startDate, std::string endDate, 
 ...
 * \param userData The user data to be passed to the callback function.
 */
bool chainsChainIdDappsDexOrdersHistoricalGetSync(char * accessToken,
 ...
 * \param userData The user data to be passed to the callback function.
 */
bool chainsChainIdDappsDexOrdersHistoricalGetAsync(char * accessToken,
	std::string chainId, long long startBlock, long long endBlock, std::string startDate, std::string endDate, std::string tokenId, 
