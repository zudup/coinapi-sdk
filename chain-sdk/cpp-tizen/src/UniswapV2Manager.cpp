...
static bool dappsUniswapv2PoiHistoricalGetProcessor(MemoryStruct_s p_chunk, long code, char* errormsg, void* userData,
	void(* voidHandler)())
{
...
static bool dappsUniswapv2PoiHistoricalGetHelper(char * accessToken,
	long long startBlock, long long endBlock, std::string startDate, std::string endDate, 
	...
	void(* handler)(Error, void* ) , void* userData, bool isAsync)
{
	...
	string url("/dapps/uniswapv2/poi/historical");
	int pos;
	...
	if(!isAsync){
		NetClient::easycurl(UniswapV2Manager::getBasePath(), url, myhttpmethod, queryParams,
			mBody, headerList, p_chunk, &code, errormsg);
		bool retval = dappsUniswapv2PoiHistoricalGetProcessor(*p_chunk, code, errormsg, userData,reinterpret_cast<void(*)()>(handler));
		...
		requestInfo = new(nothrow) RequestInfo (UniswapV2Manager::getBasePath(), url, myhttpmethod, queryParams,
			mBody, headerList, p_chunk, &code, errormsg, userData, reinterpret_cast<void(*)()>(handler), dappsUniswapv2PoiHistoricalGetProcessor);;
		if(requestInfo == NULL)
			return false;
...
bool UniswapV2Manager::dappsUniswapv2PoiHistoricalGetAsync(char * accessToken,
	long long startBlock, long long endBlock, std::string startDate, std::string endDate, 
	
	void(* handler)(Error, void* ) , void* userData)
{
	return dappsUniswapv2PoiHistoricalGetHelper(accessToken,
	startBlock, endBlock, startDate, endDate, 
	handler, userData, true);
}

bool UniswapV2Manager::dappsUniswapv2PoiHistoricalGetSync(char * accessToken,
	long long startBlock, long long endBlock, std::string startDate, std::string endDate, 
