...
static bool chainsChainIdDappsUniswapv3PositionsHistoricalGetProcessor(MemoryStruct_s p_chunk, long code, char* errormsg, void* userData,
	void(* voidHandler)())
{
...
static bool chainsChainIdDappsUniswapv3PositionsHistoricalGetHelper(char * accessToken,
	...
	void(* handler)(Error, void* ) , void* userData, bool isAsync)
{
	...
	string url("/chains/{chain_id}/dapps/uniswapv3/positions/historical");
	int pos;
	...
	if(!isAsync){
		...
		bool retval = chainsChainIdDappsUniswapv3PositionsHistoricalGetProcessor(*p_chunk, code, errormsg, userData,reinterpret_cast<void(*)()>(handler));
		...
		requestInfo = new(nothrow) RequestInfo (PositionsManager::getBasePath(), url, myhttpmethod, queryParams,
			mBody, headerList, p_chunk, &code, errormsg, userData, reinterpret_cast<void(*)()>(handler), chainsChainIdDappsUniswapv3PositionsHistoricalGetProcessor);;
		if(requestInfo == NULL)
			return false;
...
bool PositionsManager::chainsChainIdDappsUniswapv3PositionsHistoricalGetAsync(char * accessToken,
	std::string chainId, long long startBlock, long long endBlock, std::string startDate, std::string endDate, std::string poolId, 
	
	void(* handler)(Error, void* ) , void* userData)
{
	return chainsChainIdDappsUniswapv3PositionsHistoricalGetHelper(accessToken,
	chainId, startBlock, endBlock, startDate, endDate, poolId, 
	handler, userData, true);
}

bool PositionsManager::chainsChainIdDappsUniswapv3PositionsHistoricalGetSync(char * accessToken,
	std::string chainId, long long startBlock, long long endBlock, std::string startDate, std::string endDate, std::string poolId, 
