...
#ifndef _UniswapV2.TransactionV2DTO_H_
#define _UniswapV2.TransactionV2DTO_H_
...
/*! \brief Transaction entities are created for each Ethereum transaction that contains an interaction within Uniswap contracts. Each transaction contains 3 arrays, and at least one of these arrays has a length of 1.
 *
 *  \ingroup Models
 *
 */

class UniswapV2.TransactionV2DTO : public Object {
public:
	/*! \brief Constructor.
	 */
	UniswapV2.TransactionV2DTO();
	UniswapV2.TransactionV2DTO(char* str);

	/*! \brief Destructor.
	 */
	virtual ~UniswapV2.TransactionV2DTO();
...
#endif /* _UniswapV2.TransactionV2DTO_H_ */
