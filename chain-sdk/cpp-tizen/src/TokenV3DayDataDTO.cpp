...
void
TokenV3DayDataDTO::fromJson(char* jsonStr)
{
...
TokenV3DayDataDTO::TokenV3DayDataDTO(char* json)
{
	this->fromJson(json);
}

char*
TokenV3DayDataDTO::toJson()
{
...
std::string
TokenV3DayDataDTO::getEntryTime()
{
	return entry_time;
}

void
TokenV3DayDataDTO::setEntryTime(std::string  entry_time)
{
	this->entry_time = entry_time;
}

std::string
TokenV3DayDataDTO::getRecvTime()
{
	return recv_time;
}

void
TokenV3DayDataDTO::setRecvTime(std::string  recv_time)
{
	this->recv_time = recv_time;
}

long long
TokenV3DayDataDTO::getBlockNumber()
{
	return block_number;
}

void
TokenV3DayDataDTO::setBlockNumber(long long  block_number)
{
	this->block_number = block_number;
}

long long
TokenV3DayDataDTO::getVid()
{
	return vid;
}

void
TokenV3DayDataDTO::setVid(long long  vid)
{
	this->vid = vid;
}

std::string
TokenV3DayDataDTO::getId()
{
	return id;
}

void
TokenV3DayDataDTO::setId(std::string  id)
{
	this->id = id;
}

int
TokenV3DayDataDTO::getDate()
{
	return date;
}

void
TokenV3DayDataDTO::setDate(int  date)
{
	this->date = date;
}

std::string
TokenV3DayDataDTO::getToken()
{
	return token;
}

void
TokenV3DayDataDTO::setToken(std::string  token)
{
	this->token = token;
}

std::string
TokenV3DayDataDTO::getVolume()
{
	return volume;
}

void
TokenV3DayDataDTO::setVolume(std::string  volume)
{
	this->volume = volume;
}

std::string
TokenV3DayDataDTO::getVolumeUsd()
{
	return volume_usd;
}

void
TokenV3DayDataDTO::setVolumeUsd(std::string  volume_usd)
{
	this->volume_usd = volume_usd;
}

std::string
TokenV3DayDataDTO::getUntrackedVolumeUsd()
{
	return untracked_volume_usd;
}

void
TokenV3DayDataDTO::setUntrackedVolumeUsd(std::string  untracked_volume_usd)
{
	this->untracked_volume_usd = untracked_volume_usd;
}

std::string
TokenV3DayDataDTO::getTotalValueLocked()
{
	return total_value_locked;
}

void
TokenV3DayDataDTO::setTotalValueLocked(std::string  total_value_locked)
{
	this->total_value_locked = total_value_locked;
}

std::string
TokenV3DayDataDTO::getTotalValueLockedUsd()
{
	return total_value_locked_usd;
}

void
TokenV3DayDataDTO::setTotalValueLockedUsd(std::string  total_value_locked_usd)
{
	this->total_value_locked_usd = total_value_locked_usd;
}

std::string
TokenV3DayDataDTO::getPriceUsd()
{
	return price_usd;
}

void
TokenV3DayDataDTO::setPriceUsd(std::string  price_usd)
{
	this->price_usd = price_usd;
}

std::string
TokenV3DayDataDTO::getFeesUsd()
{
	return fees_usd;
}

void
TokenV3DayDataDTO::setFeesUsd(std::string  fees_usd)
{
	this->fees_usd = fees_usd;
}

std::string
TokenV3DayDataDTO::getOpen()
{
	return open;
}

void
TokenV3DayDataDTO::setOpen(std::string  open)
{
	this->open = open;
}

std::string
TokenV3DayDataDTO::getHigh()
{
	return high;
}

void
TokenV3DayDataDTO::setHigh(std::string  high)
{
	this->high = high;
}

std::string
TokenV3DayDataDTO::getLow()
{
	return low;
}

void
TokenV3DayDataDTO::setLow(std::string  low)
{
	this->low = low;
}

std::string
TokenV3DayDataDTO::getClose()
{
	return close;
}

void
TokenV3DayDataDTO::setClose(std::string  close)
{
	this->close = close;
}
