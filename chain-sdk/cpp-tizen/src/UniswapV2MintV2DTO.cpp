...
UniswapV2.MintV2DTO::UniswapV2.MintV2DTO()
{
	//__init();
}
...
void
UniswapV2.MintV2DTO::fromJson(char* jsonStr)
{
...
UniswapV2.MintV2DTO::UniswapV2.MintV2DTO(char* json)
{
	this->fromJson(json);
}

char*
UniswapV2.MintV2DTO::toJson()
{
...
std::string
UniswapV2.MintV2DTO::getEntryTime()
{
	return entry_time;
}

void
UniswapV2.MintV2DTO::setEntryTime(std::string  entry_time)
{
	this->entry_time = entry_time;
}

std::string
UniswapV2.MintV2DTO::getRecvTime()
{
	return recv_time;
}

void
UniswapV2.MintV2DTO::setRecvTime(std::string  recv_time)
{
	this->recv_time = recv_time;
}

long long
UniswapV2.MintV2DTO::getBlockNumber()
{
	return block_number;
}

void
UniswapV2.MintV2DTO::setBlockNumber(long long  block_number)
{
	this->block_number = block_number;
}

std::string
UniswapV2.MintV2DTO::getId()
{
	return id;
}

void
UniswapV2.MintV2DTO::setId(std::string  id)
{
	this->id = id;
}

std::string
UniswapV2.MintV2DTO::getTransaction()
{
	return transaction;
}

void
UniswapV2.MintV2DTO::setTransaction(std::string  transaction)
{
	this->transaction = transaction;
}

std::string
UniswapV2.MintV2DTO::getTimestamp()
{
	return timestamp;
}

void
UniswapV2.MintV2DTO::setTimestamp(std::string  timestamp)
{
	this->timestamp = timestamp;
}

std::string
UniswapV2.MintV2DTO::getPair()
{
	return pair;
}

void
UniswapV2.MintV2DTO::setPair(std::string  pair)
{
	this->pair = pair;
}

std::string
UniswapV2.MintV2DTO::getTo()
{
	return to;
}

void
UniswapV2.MintV2DTO::setTo(std::string  to)
{
	this->to = to;
}

std::string
UniswapV2.MintV2DTO::getLiquidity()
{
	return liquidity;
}

void
UniswapV2.MintV2DTO::setLiquidity(std::string  liquidity)
{
	this->liquidity = liquidity;
}

std::string
UniswapV2.MintV2DTO::getSender()
{
	return sender;
}

void
UniswapV2.MintV2DTO::setSender(std::string  sender)
{
	this->sender = sender;
}

std::string
UniswapV2.MintV2DTO::getAmount0()
{
	return amount_0;
}

void
UniswapV2.MintV2DTO::setAmount0(std::string  amount_0)
{
	this->amount_0 = amount_0;
}

std::string
UniswapV2.MintV2DTO::getAmount1()
{
	return amount_1;
}

void
UniswapV2.MintV2DTO::setAmount1(std::string  amount_1)
{
	this->amount_1 = amount_1;
}

std::string
UniswapV2.MintV2DTO::getLogIndex()
{
	return log_index;
}

void
UniswapV2.MintV2DTO::setLogIndex(std::string  log_index)
{
	this->log_index = log_index;
}

std::string
UniswapV2.MintV2DTO::getAmountUsd()
{
	return amount_usd;
}

void
UniswapV2.MintV2DTO::setAmountUsd(std::string  amount_usd)
{
	this->amount_usd = amount_usd;
}

std::string
UniswapV2.MintV2DTO::getFeeTo()
{
	return fee_to;
}

void
UniswapV2.MintV2DTO::setFeeTo(std::string  fee_to)
{
	this->fee_to = fee_to;
}

std::string
UniswapV2.MintV2DTO::getFeeLiquidity()
{
	return fee_liquidity;
}

void
UniswapV2.MintV2DTO::setFeeLiquidity(std::string  fee_liquidity)
{
	this->fee_liquidity = fee_liquidity;
}

long long
UniswapV2.MintV2DTO::getVid()
{
	return vid;
}

void
UniswapV2.MintV2DTO::setVid(long long  vid)
{
	this->vid = vid;
}

std::string
UniswapV2.MintV2DTO::getBlockRange()
{
	return block_range;
}

void
UniswapV2.MintV2DTO::setBlockRange(std::string  block_range)
{
