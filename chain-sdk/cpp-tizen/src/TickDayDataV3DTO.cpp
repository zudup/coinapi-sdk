...
void
TickDayDataV3DTO::fromJson(char* jsonStr)
{
...
TickDayDataV3DTO::TickDayDataV3DTO(char* json)
{
	this->fromJson(json);
}

char*
TickDayDataV3DTO::toJson()
{
...
std::string
TickDayDataV3DTO::getEntryTime()
{
	return entry_time;
}

void
TickDayDataV3DTO::setEntryTime(std::string  entry_time)
{
	this->entry_time = entry_time;
}

std::string
TickDayDataV3DTO::getRecvTime()
{
	return recv_time;
}

void
TickDayDataV3DTO::setRecvTime(std::string  recv_time)
{
	this->recv_time = recv_time;
}

long long
TickDayDataV3DTO::getBlockNumber()
{
	return block_number;
}

void
TickDayDataV3DTO::setBlockNumber(long long  block_number)
{
	this->block_number = block_number;
}

std::string
TickDayDataV3DTO::getId()
{
	return id;
}

void
TickDayDataV3DTO::setId(std::string  id)
{
	this->id = id;
}

int
TickDayDataV3DTO::getDate()
{
	return date;
}

void
TickDayDataV3DTO::setDate(int  date)
{
	this->date = date;
}

std::string
TickDayDataV3DTO::getPool()
{
	return pool;
}

void
TickDayDataV3DTO::setPool(std::string  pool)
{
	this->pool = pool;
}

std::string
TickDayDataV3DTO::getTick()
{
	return tick;
}

void
TickDayDataV3DTO::setTick(std::string  tick)
{
	this->tick = tick;
}

std::string
TickDayDataV3DTO::getLiquidityGross()
{
	return liquidity_gross;
}

void
TickDayDataV3DTO::setLiquidityGross(std::string  liquidity_gross)
{
	this->liquidity_gross = liquidity_gross;
}

std::string
TickDayDataV3DTO::getLiquidityNet()
{
	return liquidity_net;
}

void
TickDayDataV3DTO::setLiquidityNet(std::string  liquidity_net)
{
	this->liquidity_net = liquidity_net;
}

std::string
TickDayDataV3DTO::getVolumeToken0()
{
	return volume_token_0;
}

void
TickDayDataV3DTO::setVolumeToken0(std::string  volume_token_0)
{
	this->volume_token_0 = volume_token_0;
}

std::string
TickDayDataV3DTO::getVolumeToken1()
{
	return volume_token_1;
}

void
TickDayDataV3DTO::setVolumeToken1(std::string  volume_token_1)
{
	this->volume_token_1 = volume_token_1;
}

std::string
TickDayDataV3DTO::getVolumeUsd()
{
	return volume_usd;
}

void
TickDayDataV3DTO::setVolumeUsd(std::string  volume_usd)
{
	this->volume_usd = volume_usd;
}

std::string
TickDayDataV3DTO::getFeesUsd()
{
	return fees_usd;
}

void
TickDayDataV3DTO::setFeesUsd(std::string  fees_usd)
{
	this->fees_usd = fees_usd;
}

std::string
TickDayDataV3DTO::getFeeGrowthOutside0x128()
{
	return fee_growth_outside_0x128;
}

void
TickDayDataV3DTO::setFeeGrowthOutside0x128(std::string  fee_growth_outside_0x128)
{
	this->fee_growth_outside_0x128 = fee_growth_outside_0x128;
}

std::string
TickDayDataV3DTO::getFeeGrowthOutside1x128()
{
	return fee_growth_outside_1x128;
}

void
TickDayDataV3DTO::setFeeGrowthOutside1x128(std::string  fee_growth_outside_1x128)
{
	this->fee_growth_outside_1x128 = fee_growth_outside_1x128;
}

long long
TickDayDataV3DTO::getVid()
{
	return vid;
}

void
TickDayDataV3DTO::setVid(long long  vid)
{
	this->vid = vid;
}
