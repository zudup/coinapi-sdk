/*
 * Curve.RemoveLiquidityEventDTO.h
 *
 * 
 */

#ifndef _Curve.RemoveLiquidityEventDTO_H_
#define _Curve.RemoveLiquidityEventDTO_H_
...
class Curve.RemoveLiquidityEventDTO : public Object {
public:
	/*! \brief Constructor.
	 */
	Curve.RemoveLiquidityEventDTO();
	Curve.RemoveLiquidityEventDTO(char* str);

	/*! \brief Destructor.
	 */
	virtual ~Curve.RemoveLiquidityEventDTO();
...
#endif /* _Curve.RemoveLiquidityEventDTO_H_ */
