...
#ifndef _UniswapV2.BurnDTO_H_
#define _UniswapV2.BurnDTO_H_
...
class UniswapV2.BurnDTO : public Object {
public:
	/*! \brief Constructor.
	 */
	UniswapV2.BurnDTO();
	UniswapV2.BurnDTO(char* str);

	/*! \brief Destructor.
	 */
	virtual ~UniswapV2.BurnDTO();
