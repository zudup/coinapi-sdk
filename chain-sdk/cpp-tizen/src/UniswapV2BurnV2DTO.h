/*
 * UniswapV2.BurnV2DTO.h
 *
 * Burn entities are created for every emitted Burn event on the Uniswap core contracts. The Burn entity stores key data about the event like token amounts, who burned LP tokens, who received tokens, and more. This entity can be used to track liquidity removals on pairs.
 */

#ifndef _UniswapV2.BurnV2DTO_H_
#define _UniswapV2.BurnV2DTO_H_
...
class UniswapV2.BurnV2DTO : public Object {
public:
	/*! \brief Constructor.
	 */
	UniswapV2.BurnV2DTO();
	UniswapV2.BurnV2DTO(char* str);

	/*! \brief Destructor.
	 */
	virtual ~UniswapV2.BurnV2DTO();
	...
	/*! \brief Get Transaction hash plus index in the transaction burn array
	 */
	std::string getId();

	/*! \brief Set Transaction hash plus index in the transaction burn array
	 */
	...
	/*! \brief Get 
	 */
	bool getNeedsComplete();

	/*! \brief Set 
	 */
	void setNeedsComplete(bool  needs_complete);
