...
UniswapV3.MintDTO::UniswapV3.MintDTO()
{
	//__init();
}
...
void
UniswapV3.MintDTO::fromJson(char* jsonStr)
{
...
UniswapV3.MintDTO::UniswapV3.MintDTO(char* json)
{
	this->fromJson(json);
}

char*
UniswapV3.MintDTO::toJson()
{
...
std::string
UniswapV3.MintDTO::getEntryTime()
{
	return entry_time;
}

void
UniswapV3.MintDTO::setEntryTime(std::string  entry_time)
{
	this->entry_time = entry_time;
}

std::string
UniswapV3.MintDTO::getRecvTime()
{
	return recv_time;
}

void
UniswapV3.MintDTO::setRecvTime(std::string  recv_time)
{
	this->recv_time = recv_time;
}

long long
UniswapV3.MintDTO::getBlockNumber()
{
	return block_number;
}

void
UniswapV3.MintDTO::setBlockNumber(long long  block_number)
{
	this->block_number = block_number;
}

std::string
UniswapV3.MintDTO::getId()
{
	return id;
}

void
UniswapV3.MintDTO::setId(std::string  id)
{
	this->id = id;
}

std::string
UniswapV3.MintDTO::getTransaction()
{
	return transaction;
}

void
UniswapV3.MintDTO::setTransaction(std::string  transaction)
{
	this->transaction = transaction;
}

std::string
UniswapV3.MintDTO::getTimestamp()
{
	return timestamp;
}

void
UniswapV3.MintDTO::setTimestamp(std::string  timestamp)
{
	this->timestamp = timestamp;
}

std::string
UniswapV3.MintDTO::getPool()
{
	return pool;
}

void
UniswapV3.MintDTO::setPool(std::string  pool)
{
	this->pool = pool;
}

std::string
UniswapV3.MintDTO::getToken0()
{
	return token_0;
}

void
UniswapV3.MintDTO::setToken0(std::string  token_0)
{
	this->token_0 = token_0;
}

std::string
UniswapV3.MintDTO::getToken1()
{
	return token_1;
}

void
UniswapV3.MintDTO::setToken1(std::string  token_1)
{
	this->token_1 = token_1;
}

std::string
UniswapV3.MintDTO::getOwner()
{
	return owner;
}

void
UniswapV3.MintDTO::setOwner(std::string  owner)
{
	this->owner = owner;
}

std::string
UniswapV3.MintDTO::getSender()
{
	return sender;
}

void
UniswapV3.MintDTO::setSender(std::string  sender)
{
	this->sender = sender;
}

std::string
UniswapV3.MintDTO::getOrigin()
{
	return origin;
}

void
UniswapV3.MintDTO::setOrigin(std::string  origin)
{
	this->origin = origin;
}

std::string
UniswapV3.MintDTO::getAmount()
{
	return amount;
}

void
UniswapV3.MintDTO::setAmount(std::string  amount)
{
	this->amount = amount;
}

std::string
UniswapV3.MintDTO::getAmount0()
{
	return amount_0;
}

void
UniswapV3.MintDTO::setAmount0(std::string  amount_0)
{
	this->amount_0 = amount_0;
}

std::string
UniswapV3.MintDTO::getAmount1()
{
	return amount_1;
}

void
UniswapV3.MintDTO::setAmount1(std::string  amount_1)
{
	this->amount_1 = amount_1;
}

std::string
UniswapV3.MintDTO::getAmountUsd()
{
	return amount_usd;
}

void
UniswapV3.MintDTO::setAmountUsd(std::string  amount_usd)
{
	this->amount_usd = amount_usd;
}

std::string
UniswapV3.MintDTO::getTickLower()
{
	return tick_lower;
}

void
UniswapV3.MintDTO::setTickLower(std::string  tick_lower)
{
	this->tick_lower = tick_lower;
}

std::string
UniswapV3.MintDTO::getTickUpper()
{
	return tick_upper;
}

void
UniswapV3.MintDTO::setTickUpper(std::string  tick_upper)
{
	this->tick_upper = tick_upper;
}

std::string
UniswapV3.MintDTO::getLogIndex()
{
	return log_index;
}

void
UniswapV3.MintDTO::setLogIndex(std::string  log_index)
{
	this->log_index = log_index;
}

long long
UniswapV3.MintDTO::getVid()
{
	return vid;
}

void
UniswapV3.MintDTO::setVid(long long  vid)
{
	this->vid = vid;
}
