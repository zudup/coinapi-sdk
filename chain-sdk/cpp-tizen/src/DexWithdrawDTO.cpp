...
Dex.WithdrawDTO::Dex.WithdrawDTO()
{
	//__init();
}
...
void
Dex.WithdrawDTO::fromJson(char* jsonStr)
{
...
Dex.WithdrawDTO::Dex.WithdrawDTO(char* json)
{
	this->fromJson(json);
}

char*
Dex.WithdrawDTO::toJson()
{
...
std::string
Dex.WithdrawDTO::getEntryTime()
{
	return entry_time;
}

void
Dex.WithdrawDTO::setEntryTime(std::string  entry_time)
{
	this->entry_time = entry_time;
}

std::string
Dex.WithdrawDTO::getRecvTime()
{
	return recv_time;
}

void
Dex.WithdrawDTO::setRecvTime(std::string  recv_time)
{
	this->recv_time = recv_time;
}

long long
Dex.WithdrawDTO::getBlockNumber()
{
	return block_number;
}

void
Dex.WithdrawDTO::setBlockNumber(long long  block_number)
{
	this->block_number = block_number;
}

std::string
Dex.WithdrawDTO::getId()
{
	return id;
}

void
Dex.WithdrawDTO::setId(std::string  id)
{
	this->id = id;
}

std::string
Dex.WithdrawDTO::getUser()
{
	return user;
}

void
Dex.WithdrawDTO::setUser(std::string  user)
{
	this->user = user;
}

std::string
Dex.WithdrawDTO::getTokenAddress()
{
	return token_address;
}

void
Dex.WithdrawDTO::setTokenAddress(std::string  token_address)
{
	this->token_address = token_address;
}

std::string
Dex.WithdrawDTO::getAmount()
{
	return amount;
}

void
Dex.WithdrawDTO::setAmount(std::string  amount)
{
	this->amount = amount;
}

std::string
Dex.WithdrawDTO::getCreateEpoch()
{
	return create_epoch;
}

void
Dex.WithdrawDTO::setCreateEpoch(std::string  create_epoch)
{
	this->create_epoch = create_epoch;
}

std::string
Dex.WithdrawDTO::getCreateBatchId()
{
	return create_batch_id;
}

void
Dex.WithdrawDTO::setCreateBatchId(std::string  create_batch_id)
{
	this->create_batch_id = create_batch_id;
}

std::string
Dex.WithdrawDTO::getTxHash()
{
	return tx_hash;
}

void
Dex.WithdrawDTO::setTxHash(std::string  tx_hash)
{
	this->tx_hash = tx_hash;
}

long long
Dex.WithdrawDTO::getVid()
{
	return vid;
}

void
Dex.WithdrawDTO::setVid(long long  vid)
{
	this->vid = vid;
}
