...
static bool chainsChainIdDappsSushiswapPoolDayDataHistoricalGetProcessor(MemoryStruct_s p_chunk, long code, char* errormsg, void* userData,
	void(* voidHandler)())
{
...
static bool chainsChainIdDappsSushiswapPoolDayDataHistoricalGetHelper(char * accessToken,
	...
	void(* handler)(Error, void* ) , void* userData, bool isAsync)
{
	...
	string url("/chains/{chain_id}/dapps/sushiswap/poolDayData/historical");
	int pos;
	...
	if(!isAsync){
		...
		bool retval = chainsChainIdDappsSushiswapPoolDayDataHistoricalGetProcessor(*p_chunk, code, errormsg, userData,reinterpret_cast<void(*)()>(handler));
		...
		requestInfo = new(nothrow) RequestInfo (PoolDayDataManager::getBasePath(), url, myhttpmethod, queryParams,
			mBody, headerList, p_chunk, &code, errormsg, userData, reinterpret_cast<void(*)()>(handler), chainsChainIdDappsSushiswapPoolDayDataHistoricalGetProcessor);;
		if(requestInfo == NULL)
			return false;
...
bool PoolDayDataManager::chainsChainIdDappsSushiswapPoolDayDataHistoricalGetAsync(char * accessToken,
	std::string chainId, long long startBlock, long long endBlock, std::string startDate, std::string endDate, std::string poolId, 
	
	void(* handler)(Error, void* ) , void* userData)
{
	return chainsChainIdDappsSushiswapPoolDayDataHistoricalGetHelper(accessToken,
	chainId, startBlock, endBlock, startDate, endDate, poolId, 
	handler, userData, true);
}

bool PoolDayDataManager::chainsChainIdDappsSushiswapPoolDayDataHistoricalGetSync(char * accessToken,
	std::string chainId, long long startBlock, long long endBlock, std::string startDate, std::string endDate, std::string poolId, 
