...
void
PoolHourDataV3DTO::fromJson(char* jsonStr)
{
...
PoolHourDataV3DTO::PoolHourDataV3DTO(char* json)
{
	this->fromJson(json);
}

char*
PoolHourDataV3DTO::toJson()
{
...
std::string
PoolHourDataV3DTO::getEntryTime()
{
	return entry_time;
}

void
PoolHourDataV3DTO::setEntryTime(std::string  entry_time)
{
	this->entry_time = entry_time;
}

std::string
PoolHourDataV3DTO::getRecvTime()
{
	return recv_time;
}

void
PoolHourDataV3DTO::setRecvTime(std::string  recv_time)
{
	this->recv_time = recv_time;
}

long long
PoolHourDataV3DTO::getBlockNumber()
{
	return block_number;
}

void
PoolHourDataV3DTO::setBlockNumber(long long  block_number)
{
	this->block_number = block_number;
}

std::string
PoolHourDataV3DTO::getId()
{
	return id;
}

void
PoolHourDataV3DTO::setId(std::string  id)
{
	this->id = id;
}

int
PoolHourDataV3DTO::getPeriodStartUnix()
{
	return period_start_unix;
}

void
PoolHourDataV3DTO::setPeriodStartUnix(int  period_start_unix)
{
	this->period_start_unix = period_start_unix;
}

std::string
PoolHourDataV3DTO::getPool()
{
	return pool;
}

void
PoolHourDataV3DTO::setPool(std::string  pool)
{
	this->pool = pool;
}

std::string
PoolHourDataV3DTO::getLiquidity()
{
	return liquidity;
}

void
PoolHourDataV3DTO::setLiquidity(std::string  liquidity)
{
	this->liquidity = liquidity;
}

std::string
PoolHourDataV3DTO::getSqrtPrice()
{
	return sqrt_price;
}

void
PoolHourDataV3DTO::setSqrtPrice(std::string  sqrt_price)
{
	this->sqrt_price = sqrt_price;
}

std::string
PoolHourDataV3DTO::getToken0Price()
{
	return token_0_price;
}

void
PoolHourDataV3DTO::setToken0Price(std::string  token_0_price)
{
	this->token_0_price = token_0_price;
}

std::string
PoolHourDataV3DTO::getToken1Price()
{
	return token_1_price;
}

void
PoolHourDataV3DTO::setToken1Price(std::string  token_1_price)
{
	this->token_1_price = token_1_price;
}

std::string
PoolHourDataV3DTO::getTick()
{
	return tick;
}

void
PoolHourDataV3DTO::setTick(std::string  tick)
{
	this->tick = tick;
}

std::string
PoolHourDataV3DTO::getFeeGrowthGlobal0x128()
{
	return fee_growth_global_0x128;
}

void
PoolHourDataV3DTO::setFeeGrowthGlobal0x128(std::string  fee_growth_global_0x128)
{
	this->fee_growth_global_0x128 = fee_growth_global_0x128;
}

std::string
PoolHourDataV3DTO::getFeeGrowthGlobal1x128()
{
	return fee_growth_global_1x128;
}

void
PoolHourDataV3DTO::setFeeGrowthGlobal1x128(std::string  fee_growth_global_1x128)
{
	this->fee_growth_global_1x128 = fee_growth_global_1x128;
}

std::string
PoolHourDataV3DTO::getTvlUsd()
{
	return tvl_usd;
}

void
PoolHourDataV3DTO::setTvlUsd(std::string  tvl_usd)
{
	this->tvl_usd = tvl_usd;
}

std::string
PoolHourDataV3DTO::getVolumeToken0()
{
	return volume_token_0;
}

void
PoolHourDataV3DTO::setVolumeToken0(std::string  volume_token_0)
{
	this->volume_token_0 = volume_token_0;
}

std::string
PoolHourDataV3DTO::getVolumeToken1()
{
	return volume_token_1;
}

void
PoolHourDataV3DTO::setVolumeToken1(std::string  volume_token_1)
{
	this->volume_token_1 = volume_token_1;
}

std::string
PoolHourDataV3DTO::getVolumeUsd()
{
	return volume_usd;
}

void
PoolHourDataV3DTO::setVolumeUsd(std::string  volume_usd)
{
	this->volume_usd = volume_usd;
}

std::string
PoolHourDataV3DTO::getFeesUsd()
{
	return fees_usd;
}

void
PoolHourDataV3DTO::setFeesUsd(std::string  fees_usd)
{
	this->fees_usd = fees_usd;
}

std::string
PoolHourDataV3DTO::getTxCount()
{
	return tx_count;
}

void
PoolHourDataV3DTO::setTxCount(std::string  tx_count)
{
	this->tx_count = tx_count;
}

std::string
PoolHourDataV3DTO::getOpen()
{
	return open;
}

void
PoolHourDataV3DTO::setOpen(std::string  open)
{
	this->open = open;
}

std::string
PoolHourDataV3DTO::getHigh()
{
	return high;
}

void
PoolHourDataV3DTO::setHigh(std::string  high)
{
	this->high = high;
}

std::string
PoolHourDataV3DTO::getLow()
{
	return low;
}

void
PoolHourDataV3DTO::setLow(std::string  low)
{
	this->low = low;
}

std::string
PoolHourDataV3DTO::getClose()
{
	return close;
}

void
PoolHourDataV3DTO::setClose(std::string  close)
{
	this->close = close;
}

long long
PoolHourDataV3DTO::getVid()
{
	return vid;
}

void
PoolHourDataV3DTO::setVid(long long  vid)
{
	this->vid = vid;
}
