(ns on-chain-api.specs.pool-hour-data-v3-dto
...
(def pool-hour-data-v3-dto-data
  {
...
(def pool-hour-data-v3-dto-spec
  (ds/spec
    {:name ::pool-hour-data-v3-dto
     :spec pool-hour-data-v3-dto-data}))
