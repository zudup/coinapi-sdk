(ns on-chain-api.specs.uniswap-v3-position-v3-dto
...
(def uniswap-v3-position-v3-dto-data
  {
...
(def uniswap-v3-position-v3-dto-spec
  (ds/spec
    {:name ::uniswap-v3-position-v3-dto
     :spec uniswap-v3-position-v3-dto-data}))
