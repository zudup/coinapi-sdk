...
(defn-spec chains-chain-id-dapps-cow-orders-historical-get-with-http-info any?
  ""
  ([chain_id string?, ] (chains-chain-id-dapps-cow-orders-historical-get-with-http-info chain_id nil))
  ([chain_id string?, {:keys [startBlock endBlock startDate endDate]} (s/map-of keyword? any?)]
   (check-required-params chain_id)
   (call-api "/chains/{chain_id}/dapps/cow/orders/historical" :get
...
(defn-spec chains-chain-id-dapps-cow-orders-historical-get any?
  ""
  ([chain_id string?, ] (chains-chain-id-dapps-cow-orders-historical-get chain_id nil))
  ([chain_id string?, optional-params any?]
   (let [res (:data (chains-chain-id-dapps-cow-orders-historical-get-with-http-info chain_id optional-params))]
     (if (:decode-models *api-context*)
        (st/decode any? res st/string-transformer)
        res))))


(defn-spec chains-chain-id-dapps-dex-orders-historical-get-with-http-info any?
  ""
  ([chain_id string?, ] (chains-chain-id-dapps-dex-orders-historical-get-with-http-info chain_id nil))
  ([chain_id string?, {:keys [startBlock endBlock startDate endDate tokenId]} (s/map-of keyword? any?)]
   (check-required-params chain_id)
   (call-api "/chains/{chain_id}/dapps/dex/orders/historical" :get
             {:path-params   {"chain_id" chain_id }
              :header-params {}
...
(defn-spec chains-chain-id-dapps-dex-orders-historical-get any?
  ""
  ([chain_id string?, ] (chains-chain-id-dapps-dex-orders-historical-get chain_id nil))
  ([chain_id string?, optional-params any?]
   (let [res (:data (chains-chain-id-dapps-dex-orders-historical-get-with-http-info chain_id optional-params))]
     (if (:decode-models *api-context*)
        (st/decode any? res st/string-transformer)
        res))))
