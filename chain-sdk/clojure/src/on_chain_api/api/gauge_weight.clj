(ns on-chain-api.api.gauge-weight
...
(defn-spec chains-chain-id-dapps-curve-gauge-weight-historical-get-with-http-info any?
  ""
  ([chain_id string?, ] (chains-chain-id-dapps-curve-gauge-weight-historical-get-with-http-info chain_id nil))
  ([chain_id string?, {:keys [startBlock endBlock startDate endDate]} (s/map-of keyword? any?)]
   (check-required-params chain_id)
   (call-api "/chains/{chain_id}/dapps/curve/gaugeWeight/historical" :get
...
(defn-spec chains-chain-id-dapps-curve-gauge-weight-historical-get any?
  ""
  ([chain_id string?, ] (chains-chain-id-dapps-curve-gauge-weight-historical-get chain_id nil))
  ([chain_id string?, optional-params any?]
   (let [res (:data (chains-chain-id-dapps-curve-gauge-weight-historical-get-with-http-info chain_id optional-params))]
