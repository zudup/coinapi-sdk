(ns on-chain-api.api.fee-change-log
...
(defn-spec chains-chain-id-dapps-curve-fee-change-log-historical-get-with-http-info any?
  ""
  ([chain_id string?, ] (chains-chain-id-dapps-curve-fee-change-log-historical-get-with-http-info chain_id nil))
  ([chain_id string?, {:keys [startBlock endBlock startDate endDate poolId]} (s/map-of keyword? any?)]
   (check-required-params chain_id)
   (call-api "/chains/{chain_id}/dapps/curve/feeChangeLog/historical" :get
...
(defn-spec chains-chain-id-dapps-curve-fee-change-log-historical-get any?
  ""
  ([chain_id string?, ] (chains-chain-id-dapps-curve-fee-change-log-historical-get chain_id nil))
  ([chain_id string?, optional-params any?]
   (let [res (:data (chains-chain-id-dapps-curve-fee-change-log-historical-get-with-http-info chain_id optional-params))]
