(ns on-chain-dapps-rest-api.specs.uniswap-v3/burn-dto
...
(def uniswap-v3/burn-dto-spec
  (ds/spec
    {:name ::uniswap-v3/burn-dto
     :spec uniswap-v3/burn-dto-data}))
