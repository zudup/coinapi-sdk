(ns on-chain-dapps-rest-api.specs.uniswap-v3/position-snapshot-dto
...
(def uniswap-v3/position-snapshot-dto-data
  {
...
(def uniswap-v3/position-snapshot-dto-spec
  (ds/spec
    {:name ::uniswap-v3/position-snapshot-dto
     :spec uniswap-v3/position-snapshot-dto-data}))
