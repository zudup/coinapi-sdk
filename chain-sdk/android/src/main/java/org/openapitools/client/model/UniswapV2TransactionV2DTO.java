...
public class UniswapV2TransactionV2DTO {
  ...
  public boolean equals(Object o) {
    ...
    return (this.entryTime == null ? uniswapV2TransactionV2DTO.entryTime == null : this.entryTime.equals(uniswapV2TransactionV2DTO.entryTime)) &&
        (this.recvTime == null ? uniswapV2TransactionV2DTO.recvTime == null : this.recvTime.equals(uniswapV2TransactionV2DTO.recvTime)) &&
        (this.blockNumber == null ? uniswapV2TransactionV2DTO.blockNumber == null : this.blockNumber.equals(uniswapV2TransactionV2DTO.blockNumber)) &&
        (this.id == null ? uniswapV2TransactionV2DTO.id == null : this.id.equals(uniswapV2TransactionV2DTO.id)) &&
        (this.timestamp == null ? uniswapV2TransactionV2DTO.timestamp == null : this.timestamp.equals(uniswapV2TransactionV2DTO.timestamp)) &&
        (this.mints == null ? uniswapV2TransactionV2DTO.mints == null : this.mints.equals(uniswapV2TransactionV2DTO.mints)) &&
        (this.burns == null ? uniswapV2TransactionV2DTO.burns == null : this.burns.equals(uniswapV2TransactionV2DTO.burns)) &&
        (this.swaps == null ? uniswapV2TransactionV2DTO.swaps == null : this.swaps.equals(uniswapV2TransactionV2DTO.swaps)) &&
        (this.vid == null ? uniswapV2TransactionV2DTO.vid == null : this.vid.equals(uniswapV2TransactionV2DTO.vid));
  }
