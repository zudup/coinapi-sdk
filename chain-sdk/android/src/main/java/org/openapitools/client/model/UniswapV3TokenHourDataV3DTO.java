...
public class UniswapV3TokenHourDataV3DTO {
  ...
  public boolean equals(Object o) {
    ...
    return (this.entryTime == null ? uniswapV3TokenHourDataV3DTO.entryTime == null : this.entryTime.equals(uniswapV3TokenHourDataV3DTO.entryTime)) &&
        (this.recvTime == null ? uniswapV3TokenHourDataV3DTO.recvTime == null : this.recvTime.equals(uniswapV3TokenHourDataV3DTO.recvTime)) &&
        (this.blockNumber == null ? uniswapV3TokenHourDataV3DTO.blockNumber == null : this.blockNumber.equals(uniswapV3TokenHourDataV3DTO.blockNumber)) &&
        (this.id == null ? uniswapV3TokenHourDataV3DTO.id == null : this.id.equals(uniswapV3TokenHourDataV3DTO.id)) &&
        (this.periodStartUnix == null ? uniswapV3TokenHourDataV3DTO.periodStartUnix == null : this.periodStartUnix.equals(uniswapV3TokenHourDataV3DTO.periodStartUnix)) &&
        (this.token == null ? uniswapV3TokenHourDataV3DTO.token == null : this.token.equals(uniswapV3TokenHourDataV3DTO.token)) &&
        (this.volume == null ? uniswapV3TokenHourDataV3DTO.volume == null : this.volume.equals(uniswapV3TokenHourDataV3DTO.volume)) &&
        (this.volumeUsd == null ? uniswapV3TokenHourDataV3DTO.volumeUsd == null : this.volumeUsd.equals(uniswapV3TokenHourDataV3DTO.volumeUsd)) &&
        (this.untrackedVolumeUsd == null ? uniswapV3TokenHourDataV3DTO.untrackedVolumeUsd == null : this.untrackedVolumeUsd.equals(uniswapV3TokenHourDataV3DTO.untrackedVolumeUsd)) &&
        (this.totalValueLocked == null ? uniswapV3TokenHourDataV3DTO.totalValueLocked == null : this.totalValueLocked.equals(uniswapV3TokenHourDataV3DTO.totalValueLocked)) &&
        (this.totalValueLockedUsd == null ? uniswapV3TokenHourDataV3DTO.totalValueLockedUsd == null : this.totalValueLockedUsd.equals(uniswapV3TokenHourDataV3DTO.totalValueLockedUsd)) &&
        (this.priceUsd == null ? uniswapV3TokenHourDataV3DTO.priceUsd == null : this.priceUsd.equals(uniswapV3TokenHourDataV3DTO.priceUsd)) &&
        (this.feesUsd == null ? uniswapV3TokenHourDataV3DTO.feesUsd == null : this.feesUsd.equals(uniswapV3TokenHourDataV3DTO.feesUsd)) &&
        (this.open == null ? uniswapV3TokenHourDataV3DTO.open == null : this.open.equals(uniswapV3TokenHourDataV3DTO.open)) &&
        (this.high == null ? uniswapV3TokenHourDataV3DTO.high == null : this.high.equals(uniswapV3TokenHourDataV3DTO.high)) &&
        (this.low == null ? uniswapV3TokenHourDataV3DTO.low == null : this.low.equals(uniswapV3TokenHourDataV3DTO.low)) &&
        (this.close == null ? uniswapV3TokenHourDataV3DTO.close == null : this.close.equals(uniswapV3TokenHourDataV3DTO.close)) &&
        (this.vid == null ? uniswapV3TokenHourDataV3DTO.vid == null : this.vid.equals(uniswapV3TokenHourDataV3DTO.vid));
  }
