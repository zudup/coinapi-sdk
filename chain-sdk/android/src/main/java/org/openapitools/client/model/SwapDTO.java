...
public class SwapDTO {
  ...
  public boolean equals(Object o) {
    ...
    return (this.entryTime == null ? swapDTO.entryTime == null : this.entryTime.equals(swapDTO.entryTime)) &&
        (this.recvTime == null ? swapDTO.recvTime == null : this.recvTime.equals(swapDTO.recvTime)) &&
        (this.blockNumber == null ? swapDTO.blockNumber == null : this.blockNumber.equals(swapDTO.blockNumber)) &&
        (this.id == null ? swapDTO.id == null : this.id.equals(swapDTO.id)) &&
        (this.transaction == null ? swapDTO.transaction == null : this.transaction.equals(swapDTO.transaction)) &&
        (this.timestamp == null ? swapDTO.timestamp == null : this.timestamp.equals(swapDTO.timestamp)) &&
        (this.pair == null ? swapDTO.pair == null : this.pair.equals(swapDTO.pair)) &&
        (this.sender == null ? swapDTO.sender == null : this.sender.equals(swapDTO.sender)) &&
        (this.amount0In == null ? swapDTO.amount0In == null : this.amount0In.equals(swapDTO.amount0In)) &&
        (this.amount1In == null ? swapDTO.amount1In == null : this.amount1In.equals(swapDTO.amount1In)) &&
        (this.amount0Out == null ? swapDTO.amount0Out == null : this.amount0Out.equals(swapDTO.amount0Out)) &&
        (this.amount1Out == null ? swapDTO.amount1Out == null : this.amount1Out.equals(swapDTO.amount1Out)) &&
        (this.to == null ? swapDTO.to == null : this.to.equals(swapDTO.to)) &&
        (this.logIndex == null ? swapDTO.logIndex == null : this.logIndex.equals(swapDTO.logIndex)) &&
        (this.amountUsd == null ? swapDTO.amountUsd == null : this.amountUsd.equals(swapDTO.amountUsd)) &&
        (this.vid == null ? swapDTO.vid == null : this.vid.equals(swapDTO.vid)) &&
        (this.poolId == null ? swapDTO.poolId == null : this.poolId.equals(swapDTO.poolId)) &&
        (this.transactionId == null ? swapDTO.transactionId == null : this.transactionId.equals(swapDTO.transactionId)) &&
        (this.evaluatedPrice == null ? swapDTO.evaluatedPrice == null : this.evaluatedPrice.equals(swapDTO.evaluatedPrice)) &&
        (this.evaluatedAmount == null ? swapDTO.evaluatedAmount == null : this.evaluatedAmount.equals(swapDTO.evaluatedAmount)) &&
        (this.evaluatedAggressor == null ? swapDTO.evaluatedAggressor == null : this.evaluatedAggressor.equals(swapDTO.evaluatedAggressor));
  }
