...
public class UniswapV3PoolDayDataV3DTO {
  ...
  public boolean equals(Object o) {
    ...
    return (this.entryTime == null ? uniswapV3PoolDayDataV3DTO.entryTime == null : this.entryTime.equals(uniswapV3PoolDayDataV3DTO.entryTime)) &&
        (this.recvTime == null ? uniswapV3PoolDayDataV3DTO.recvTime == null : this.recvTime.equals(uniswapV3PoolDayDataV3DTO.recvTime)) &&
        (this.blockNumber == null ? uniswapV3PoolDayDataV3DTO.blockNumber == null : this.blockNumber.equals(uniswapV3PoolDayDataV3DTO.blockNumber)) &&
        (this.id == null ? uniswapV3PoolDayDataV3DTO.id == null : this.id.equals(uniswapV3PoolDayDataV3DTO.id)) &&
        (this.date == null ? uniswapV3PoolDayDataV3DTO.date == null : this.date.equals(uniswapV3PoolDayDataV3DTO.date)) &&
        (this.pool == null ? uniswapV3PoolDayDataV3DTO.pool == null : this.pool.equals(uniswapV3PoolDayDataV3DTO.pool)) &&
        (this.liquidity == null ? uniswapV3PoolDayDataV3DTO.liquidity == null : this.liquidity.equals(uniswapV3PoolDayDataV3DTO.liquidity)) &&
        (this.sqrtPrice == null ? uniswapV3PoolDayDataV3DTO.sqrtPrice == null : this.sqrtPrice.equals(uniswapV3PoolDayDataV3DTO.sqrtPrice)) &&
        (this.token0Price == null ? uniswapV3PoolDayDataV3DTO.token0Price == null : this.token0Price.equals(uniswapV3PoolDayDataV3DTO.token0Price)) &&
        (this.token1Price == null ? uniswapV3PoolDayDataV3DTO.token1Price == null : this.token1Price.equals(uniswapV3PoolDayDataV3DTO.token1Price)) &&
        (this.tick == null ? uniswapV3PoolDayDataV3DTO.tick == null : this.tick.equals(uniswapV3PoolDayDataV3DTO.tick)) &&
        (this.feeGrowthGlobal0x128 == null ? uniswapV3PoolDayDataV3DTO.feeGrowthGlobal0x128 == null : this.feeGrowthGlobal0x128.equals(uniswapV3PoolDayDataV3DTO.feeGrowthGlobal0x128)) &&
        (this.feeGrowthGlobal1x128 == null ? uniswapV3PoolDayDataV3DTO.feeGrowthGlobal1x128 == null : this.feeGrowthGlobal1x128.equals(uniswapV3PoolDayDataV3DTO.feeGrowthGlobal1x128)) &&
        (this.tvlUsd == null ? uniswapV3PoolDayDataV3DTO.tvlUsd == null : this.tvlUsd.equals(uniswapV3PoolDayDataV3DTO.tvlUsd)) &&
        (this.volumeToken0 == null ? uniswapV3PoolDayDataV3DTO.volumeToken0 == null : this.volumeToken0.equals(uniswapV3PoolDayDataV3DTO.volumeToken0)) &&
        (this.volumeToken1 == null ? uniswapV3PoolDayDataV3DTO.volumeToken1 == null : this.volumeToken1.equals(uniswapV3PoolDayDataV3DTO.volumeToken1)) &&
        (this.volumeUsd == null ? uniswapV3PoolDayDataV3DTO.volumeUsd == null : this.volumeUsd.equals(uniswapV3PoolDayDataV3DTO.volumeUsd)) &&
        (this.feesUsd == null ? uniswapV3PoolDayDataV3DTO.feesUsd == null : this.feesUsd.equals(uniswapV3PoolDayDataV3DTO.feesUsd)) &&
        (this.txCount == null ? uniswapV3PoolDayDataV3DTO.txCount == null : this.txCount.equals(uniswapV3PoolDayDataV3DTO.txCount)) &&
        (this.open == null ? uniswapV3PoolDayDataV3DTO.open == null : this.open.equals(uniswapV3PoolDayDataV3DTO.open)) &&
        (this.high == null ? uniswapV3PoolDayDataV3DTO.high == null : this.high.equals(uniswapV3PoolDayDataV3DTO.high)) &&
        (this.low == null ? uniswapV3PoolDayDataV3DTO.low == null : this.low.equals(uniswapV3PoolDayDataV3DTO.low)) &&
        (this.close == null ? uniswapV3PoolDayDataV3DTO.close == null : this.close.equals(uniswapV3PoolDayDataV3DTO.close)) &&
        (this.vid == null ? uniswapV3PoolDayDataV3DTO.vid == null : this.vid.equals(uniswapV3PoolDayDataV3DTO.vid));
  }
