...
public class UniswapV2TokenV2DTO {
  ...
  public boolean equals(Object o) {
    ...
    return (this.entryTime == null ? uniswapV2TokenV2DTO.entryTime == null : this.entryTime.equals(uniswapV2TokenV2DTO.entryTime)) &&
        (this.recvTime == null ? uniswapV2TokenV2DTO.recvTime == null : this.recvTime.equals(uniswapV2TokenV2DTO.recvTime)) &&
        (this.blockNumber == null ? uniswapV2TokenV2DTO.blockNumber == null : this.blockNumber.equals(uniswapV2TokenV2DTO.blockNumber)) &&
        (this.vid == null ? uniswapV2TokenV2DTO.vid == null : this.vid.equals(uniswapV2TokenV2DTO.vid)) &&
        (this.id == null ? uniswapV2TokenV2DTO.id == null : this.id.equals(uniswapV2TokenV2DTO.id)) &&
        (this.symbol == null ? uniswapV2TokenV2DTO.symbol == null : this.symbol.equals(uniswapV2TokenV2DTO.symbol)) &&
        (this.name == null ? uniswapV2TokenV2DTO.name == null : this.name.equals(uniswapV2TokenV2DTO.name)) &&
        (this.decimals == null ? uniswapV2TokenV2DTO.decimals == null : this.decimals.equals(uniswapV2TokenV2DTO.decimals)) &&
        (this.totalSupply == null ? uniswapV2TokenV2DTO.totalSupply == null : this.totalSupply.equals(uniswapV2TokenV2DTO.totalSupply)) &&
        (this.tradeVolume == null ? uniswapV2TokenV2DTO.tradeVolume == null : this.tradeVolume.equals(uniswapV2TokenV2DTO.tradeVolume)) &&
        (this.tradeVolumeUsd == null ? uniswapV2TokenV2DTO.tradeVolumeUsd == null : this.tradeVolumeUsd.equals(uniswapV2TokenV2DTO.tradeVolumeUsd)) &&
        (this.untrackedVolumeUsd == null ? uniswapV2TokenV2DTO.untrackedVolumeUsd == null : this.untrackedVolumeUsd.equals(uniswapV2TokenV2DTO.untrackedVolumeUsd)) &&
        (this.txCount == null ? uniswapV2TokenV2DTO.txCount == null : this.txCount.equals(uniswapV2TokenV2DTO.txCount)) &&
        (this.totalLiquidity == null ? uniswapV2TokenV2DTO.totalLiquidity == null : this.totalLiquidity.equals(uniswapV2TokenV2DTO.totalLiquidity)) &&
        (this.derivedEth == null ? uniswapV2TokenV2DTO.derivedEth == null : this.derivedEth.equals(uniswapV2TokenV2DTO.derivedEth)) &&
        (this.tokenSymbol == null ? uniswapV2TokenV2DTO.tokenSymbol == null : this.tokenSymbol.equals(uniswapV2TokenV2DTO.tokenSymbol));
  }
