...
public class UniswapV3TickDayDataV3DTO {
  ...
  public boolean equals(Object o) {
    ...
    return (this.entryTime == null ? uniswapV3TickDayDataV3DTO.entryTime == null : this.entryTime.equals(uniswapV3TickDayDataV3DTO.entryTime)) &&
        (this.recvTime == null ? uniswapV3TickDayDataV3DTO.recvTime == null : this.recvTime.equals(uniswapV3TickDayDataV3DTO.recvTime)) &&
        (this.blockNumber == null ? uniswapV3TickDayDataV3DTO.blockNumber == null : this.blockNumber.equals(uniswapV3TickDayDataV3DTO.blockNumber)) &&
        (this.id == null ? uniswapV3TickDayDataV3DTO.id == null : this.id.equals(uniswapV3TickDayDataV3DTO.id)) &&
        (this.date == null ? uniswapV3TickDayDataV3DTO.date == null : this.date.equals(uniswapV3TickDayDataV3DTO.date)) &&
        (this.pool == null ? uniswapV3TickDayDataV3DTO.pool == null : this.pool.equals(uniswapV3TickDayDataV3DTO.pool)) &&
        (this.tick == null ? uniswapV3TickDayDataV3DTO.tick == null : this.tick.equals(uniswapV3TickDayDataV3DTO.tick)) &&
        (this.liquidityGross == null ? uniswapV3TickDayDataV3DTO.liquidityGross == null : this.liquidityGross.equals(uniswapV3TickDayDataV3DTO.liquidityGross)) &&
        (this.liquidityNet == null ? uniswapV3TickDayDataV3DTO.liquidityNet == null : this.liquidityNet.equals(uniswapV3TickDayDataV3DTO.liquidityNet)) &&
        (this.volumeToken0 == null ? uniswapV3TickDayDataV3DTO.volumeToken0 == null : this.volumeToken0.equals(uniswapV3TickDayDataV3DTO.volumeToken0)) &&
        (this.volumeToken1 == null ? uniswapV3TickDayDataV3DTO.volumeToken1 == null : this.volumeToken1.equals(uniswapV3TickDayDataV3DTO.volumeToken1)) &&
        (this.volumeUsd == null ? uniswapV3TickDayDataV3DTO.volumeUsd == null : this.volumeUsd.equals(uniswapV3TickDayDataV3DTO.volumeUsd)) &&
        (this.feesUsd == null ? uniswapV3TickDayDataV3DTO.feesUsd == null : this.feesUsd.equals(uniswapV3TickDayDataV3DTO.feesUsd)) &&
        (this.feeGrowthOutside0x128 == null ? uniswapV3TickDayDataV3DTO.feeGrowthOutside0x128 == null : this.feeGrowthOutside0x128.equals(uniswapV3TickDayDataV3DTO.feeGrowthOutside0x128)) &&
        (this.feeGrowthOutside1x128 == null ? uniswapV3TickDayDataV3DTO.feeGrowthOutside1x128 == null : this.feeGrowthOutside1x128.equals(uniswapV3TickDayDataV3DTO.feeGrowthOutside1x128)) &&
        (this.vid == null ? uniswapV3TickDayDataV3DTO.vid == null : this.vid.equals(uniswapV3TickDayDataV3DTO.vid));
  }
