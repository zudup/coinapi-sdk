...
public class UniswapV3FactoryV3DTO {
  ...
  public boolean equals(Object o) {
    ...
    return (this.entryTime == null ? uniswapV3FactoryV3DTO.entryTime == null : this.entryTime.equals(uniswapV3FactoryV3DTO.entryTime)) &&
        (this.recvTime == null ? uniswapV3FactoryV3DTO.recvTime == null : this.recvTime.equals(uniswapV3FactoryV3DTO.recvTime)) &&
        (this.blockNumber == null ? uniswapV3FactoryV3DTO.blockNumber == null : this.blockNumber.equals(uniswapV3FactoryV3DTO.blockNumber)) &&
        (this.id == null ? uniswapV3FactoryV3DTO.id == null : this.id.equals(uniswapV3FactoryV3DTO.id)) &&
        (this.poolCount == null ? uniswapV3FactoryV3DTO.poolCount == null : this.poolCount.equals(uniswapV3FactoryV3DTO.poolCount)) &&
        (this.txCount == null ? uniswapV3FactoryV3DTO.txCount == null : this.txCount.equals(uniswapV3FactoryV3DTO.txCount)) &&
        (this.totalVolumeUsd == null ? uniswapV3FactoryV3DTO.totalVolumeUsd == null : this.totalVolumeUsd.equals(uniswapV3FactoryV3DTO.totalVolumeUsd)) &&
        (this.totalVolumeEth == null ? uniswapV3FactoryV3DTO.totalVolumeEth == null : this.totalVolumeEth.equals(uniswapV3FactoryV3DTO.totalVolumeEth)) &&
        (this.totalFeesUsd == null ? uniswapV3FactoryV3DTO.totalFeesUsd == null : this.totalFeesUsd.equals(uniswapV3FactoryV3DTO.totalFeesUsd)) &&
        (this.totalFeesEth == null ? uniswapV3FactoryV3DTO.totalFeesEth == null : this.totalFeesEth.equals(uniswapV3FactoryV3DTO.totalFeesEth)) &&
        (this.untrackedVolumeUsd == null ? uniswapV3FactoryV3DTO.untrackedVolumeUsd == null : this.untrackedVolumeUsd.equals(uniswapV3FactoryV3DTO.untrackedVolumeUsd)) &&
        (this.totalValueLockedUsd == null ? uniswapV3FactoryV3DTO.totalValueLockedUsd == null : this.totalValueLockedUsd.equals(uniswapV3FactoryV3DTO.totalValueLockedUsd)) &&
        (this.totalValueLockedEth == null ? uniswapV3FactoryV3DTO.totalValueLockedEth == null : this.totalValueLockedEth.equals(uniswapV3FactoryV3DTO.totalValueLockedEth)) &&
        (this.totalValueLockedUsdUntracked == null ? uniswapV3FactoryV3DTO.totalValueLockedUsdUntracked == null : this.totalValueLockedUsdUntracked.equals(uniswapV3FactoryV3DTO.totalValueLockedUsdUntracked)) &&
        (this.totalValueLockedEthUntracked == null ? uniswapV3FactoryV3DTO.totalValueLockedEthUntracked == null : this.totalValueLockedEthUntracked.equals(uniswapV3FactoryV3DTO.totalValueLockedEthUntracked)) &&
        (this.owner == null ? uniswapV3FactoryV3DTO.owner == null : this.owner.equals(uniswapV3FactoryV3DTO.owner)) &&
        (this.vid == null ? uniswapV3FactoryV3DTO.vid == null : this.vid.equals(uniswapV3FactoryV3DTO.vid));
  }
