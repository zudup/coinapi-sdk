...
public class UniswapV2TokenDayDataV2DTO {
  ...
  public boolean equals(Object o) {
    ...
    return (this.entryTime == null ? uniswapV2TokenDayDataV2DTO.entryTime == null : this.entryTime.equals(uniswapV2TokenDayDataV2DTO.entryTime)) &&
        (this.recvTime == null ? uniswapV2TokenDayDataV2DTO.recvTime == null : this.recvTime.equals(uniswapV2TokenDayDataV2DTO.recvTime)) &&
        (this.blockNumber == null ? uniswapV2TokenDayDataV2DTO.blockNumber == null : this.blockNumber.equals(uniswapV2TokenDayDataV2DTO.blockNumber)) &&
        (this.id == null ? uniswapV2TokenDayDataV2DTO.id == null : this.id.equals(uniswapV2TokenDayDataV2DTO.id)) &&
        (this.date == null ? uniswapV2TokenDayDataV2DTO.date == null : this.date.equals(uniswapV2TokenDayDataV2DTO.date)) &&
        (this.token == null ? uniswapV2TokenDayDataV2DTO.token == null : this.token.equals(uniswapV2TokenDayDataV2DTO.token)) &&
        (this.dailyVolumeToken == null ? uniswapV2TokenDayDataV2DTO.dailyVolumeToken == null : this.dailyVolumeToken.equals(uniswapV2TokenDayDataV2DTO.dailyVolumeToken)) &&
        (this.dailyVolumeEth == null ? uniswapV2TokenDayDataV2DTO.dailyVolumeEth == null : this.dailyVolumeEth.equals(uniswapV2TokenDayDataV2DTO.dailyVolumeEth)) &&
        (this.dailyVolumeUsd == null ? uniswapV2TokenDayDataV2DTO.dailyVolumeUsd == null : this.dailyVolumeUsd.equals(uniswapV2TokenDayDataV2DTO.dailyVolumeUsd)) &&
        (this.dailyTxns == null ? uniswapV2TokenDayDataV2DTO.dailyTxns == null : this.dailyTxns.equals(uniswapV2TokenDayDataV2DTO.dailyTxns)) &&
        (this.totalLiquidityToken == null ? uniswapV2TokenDayDataV2DTO.totalLiquidityToken == null : this.totalLiquidityToken.equals(uniswapV2TokenDayDataV2DTO.totalLiquidityToken)) &&
        (this.totalLiquidityEth == null ? uniswapV2TokenDayDataV2DTO.totalLiquidityEth == null : this.totalLiquidityEth.equals(uniswapV2TokenDayDataV2DTO.totalLiquidityEth)) &&
        (this.totalLiquidityUsd == null ? uniswapV2TokenDayDataV2DTO.totalLiquidityUsd == null : this.totalLiquidityUsd.equals(uniswapV2TokenDayDataV2DTO.totalLiquidityUsd)) &&
        (this.priceUsd == null ? uniswapV2TokenDayDataV2DTO.priceUsd == null : this.priceUsd.equals(uniswapV2TokenDayDataV2DTO.priceUsd)) &&
        (this.vid == null ? uniswapV2TokenDayDataV2DTO.vid == null : this.vid.equals(uniswapV2TokenDayDataV2DTO.vid));
  }
