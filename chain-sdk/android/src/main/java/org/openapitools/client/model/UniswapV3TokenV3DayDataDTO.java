...
public class UniswapV3TokenV3DayDataDTO {
  ...
  public boolean equals(Object o) {
    ...
    return (this.entryTime == null ? uniswapV3TokenV3DayDataDTO.entryTime == null : this.entryTime.equals(uniswapV3TokenV3DayDataDTO.entryTime)) &&
        (this.recvTime == null ? uniswapV3TokenV3DayDataDTO.recvTime == null : this.recvTime.equals(uniswapV3TokenV3DayDataDTO.recvTime)) &&
        (this.blockNumber == null ? uniswapV3TokenV3DayDataDTO.blockNumber == null : this.blockNumber.equals(uniswapV3TokenV3DayDataDTO.blockNumber)) &&
        (this.vid == null ? uniswapV3TokenV3DayDataDTO.vid == null : this.vid.equals(uniswapV3TokenV3DayDataDTO.vid)) &&
        (this.id == null ? uniswapV3TokenV3DayDataDTO.id == null : this.id.equals(uniswapV3TokenV3DayDataDTO.id)) &&
        (this.date == null ? uniswapV3TokenV3DayDataDTO.date == null : this.date.equals(uniswapV3TokenV3DayDataDTO.date)) &&
        (this.token == null ? uniswapV3TokenV3DayDataDTO.token == null : this.token.equals(uniswapV3TokenV3DayDataDTO.token)) &&
        (this.volume == null ? uniswapV3TokenV3DayDataDTO.volume == null : this.volume.equals(uniswapV3TokenV3DayDataDTO.volume)) &&
        (this.volumeUsd == null ? uniswapV3TokenV3DayDataDTO.volumeUsd == null : this.volumeUsd.equals(uniswapV3TokenV3DayDataDTO.volumeUsd)) &&
        (this.untrackedVolumeUsd == null ? uniswapV3TokenV3DayDataDTO.untrackedVolumeUsd == null : this.untrackedVolumeUsd.equals(uniswapV3TokenV3DayDataDTO.untrackedVolumeUsd)) &&
        (this.totalValueLocked == null ? uniswapV3TokenV3DayDataDTO.totalValueLocked == null : this.totalValueLocked.equals(uniswapV3TokenV3DayDataDTO.totalValueLocked)) &&
        (this.totalValueLockedUsd == null ? uniswapV3TokenV3DayDataDTO.totalValueLockedUsd == null : this.totalValueLockedUsd.equals(uniswapV3TokenV3DayDataDTO.totalValueLockedUsd)) &&
        (this.priceUsd == null ? uniswapV3TokenV3DayDataDTO.priceUsd == null : this.priceUsd.equals(uniswapV3TokenV3DayDataDTO.priceUsd)) &&
        (this.feesUsd == null ? uniswapV3TokenV3DayDataDTO.feesUsd == null : this.feesUsd.equals(uniswapV3TokenV3DayDataDTO.feesUsd)) &&
        (this.open == null ? uniswapV3TokenV3DayDataDTO.open == null : this.open.equals(uniswapV3TokenV3DayDataDTO.open)) &&
        (this.high == null ? uniswapV3TokenV3DayDataDTO.high == null : this.high.equals(uniswapV3TokenV3DayDataDTO.high)) &&
        (this.low == null ? uniswapV3TokenV3DayDataDTO.low == null : this.low.equals(uniswapV3TokenV3DayDataDTO.low)) &&
        (this.close == null ? uniswapV3TokenV3DayDataDTO.close == null : this.close.equals(uniswapV3TokenV3DayDataDTO.close));
  }
