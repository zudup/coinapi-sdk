...
public class UniswapV3UniswapDayDataV3DTO {
  ...
  public boolean equals(Object o) {
    ...
    return (this.entryTime == null ? uniswapV3UniswapDayDataV3DTO.entryTime == null : this.entryTime.equals(uniswapV3UniswapDayDataV3DTO.entryTime)) &&
        (this.recvTime == null ? uniswapV3UniswapDayDataV3DTO.recvTime == null : this.recvTime.equals(uniswapV3UniswapDayDataV3DTO.recvTime)) &&
        (this.blockNumber == null ? uniswapV3UniswapDayDataV3DTO.blockNumber == null : this.blockNumber.equals(uniswapV3UniswapDayDataV3DTO.blockNumber)) &&
        (this.vid == null ? uniswapV3UniswapDayDataV3DTO.vid == null : this.vid.equals(uniswapV3UniswapDayDataV3DTO.vid)) &&
        (this.id == null ? uniswapV3UniswapDayDataV3DTO.id == null : this.id.equals(uniswapV3UniswapDayDataV3DTO.id)) &&
        (this.date == null ? uniswapV3UniswapDayDataV3DTO.date == null : this.date.equals(uniswapV3UniswapDayDataV3DTO.date)) &&
        (this.volumeEth == null ? uniswapV3UniswapDayDataV3DTO.volumeEth == null : this.volumeEth.equals(uniswapV3UniswapDayDataV3DTO.volumeEth)) &&
        (this.volumeUsd == null ? uniswapV3UniswapDayDataV3DTO.volumeUsd == null : this.volumeUsd.equals(uniswapV3UniswapDayDataV3DTO.volumeUsd)) &&
        (this.volumeUsdUntracked == null ? uniswapV3UniswapDayDataV3DTO.volumeUsdUntracked == null : this.volumeUsdUntracked.equals(uniswapV3UniswapDayDataV3DTO.volumeUsdUntracked)) &&
        (this.feesUsd == null ? uniswapV3UniswapDayDataV3DTO.feesUsd == null : this.feesUsd.equals(uniswapV3UniswapDayDataV3DTO.feesUsd)) &&
        (this.txCount == null ? uniswapV3UniswapDayDataV3DTO.txCount == null : this.txCount.equals(uniswapV3UniswapDayDataV3DTO.txCount)) &&
        (this.tvlUsd == null ? uniswapV3UniswapDayDataV3DTO.tvlUsd == null : this.tvlUsd.equals(uniswapV3UniswapDayDataV3DTO.tvlUsd));
  }
