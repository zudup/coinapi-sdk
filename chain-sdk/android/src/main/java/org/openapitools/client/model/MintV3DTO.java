...
public class MintV3DTO {
  ...
  public boolean equals(Object o) {
    ...
    return (this.entryTime == null ? mintV3DTO.entryTime == null : this.entryTime.equals(mintV3DTO.entryTime)) &&
        (this.recvTime == null ? mintV3DTO.recvTime == null : this.recvTime.equals(mintV3DTO.recvTime)) &&
        (this.blockNumber == null ? mintV3DTO.blockNumber == null : this.blockNumber.equals(mintV3DTO.blockNumber)) &&
        (this.id == null ? mintV3DTO.id == null : this.id.equals(mintV3DTO.id)) &&
        (this.transaction == null ? mintV3DTO.transaction == null : this.transaction.equals(mintV3DTO.transaction)) &&
        (this.timestamp == null ? mintV3DTO.timestamp == null : this.timestamp.equals(mintV3DTO.timestamp)) &&
        (this.pool == null ? mintV3DTO.pool == null : this.pool.equals(mintV3DTO.pool)) &&
        (this.token0 == null ? mintV3DTO.token0 == null : this.token0.equals(mintV3DTO.token0)) &&
        (this.token1 == null ? mintV3DTO.token1 == null : this.token1.equals(mintV3DTO.token1)) &&
        (this.owner == null ? mintV3DTO.owner == null : this.owner.equals(mintV3DTO.owner)) &&
        (this.sender == null ? mintV3DTO.sender == null : this.sender.equals(mintV3DTO.sender)) &&
        (this.origin == null ? mintV3DTO.origin == null : this.origin.equals(mintV3DTO.origin)) &&
        (this.amount == null ? mintV3DTO.amount == null : this.amount.equals(mintV3DTO.amount)) &&
        (this.amount0 == null ? mintV3DTO.amount0 == null : this.amount0.equals(mintV3DTO.amount0)) &&
        (this.amount1 == null ? mintV3DTO.amount1 == null : this.amount1.equals(mintV3DTO.amount1)) &&
        (this.amountUsd == null ? mintV3DTO.amountUsd == null : this.amountUsd.equals(mintV3DTO.amountUsd)) &&
        (this.tickLower == null ? mintV3DTO.tickLower == null : this.tickLower.equals(mintV3DTO.tickLower)) &&
        (this.tickUpper == null ? mintV3DTO.tickUpper == null : this.tickUpper.equals(mintV3DTO.tickUpper)) &&
        (this.logIndex == null ? mintV3DTO.logIndex == null : this.logIndex.equals(mintV3DTO.logIndex)) &&
        (this.vid == null ? mintV3DTO.vid == null : this.vid.equals(mintV3DTO.vid));
  }
