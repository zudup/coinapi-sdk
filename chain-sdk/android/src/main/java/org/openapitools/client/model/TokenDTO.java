...
public class TokenDTO {
  ...
  public boolean equals(Object o) {
    ...
    return (this.entryTime == null ? tokenDTO.entryTime == null : this.entryTime.equals(tokenDTO.entryTime)) &&
        (this.recvTime == null ? tokenDTO.recvTime == null : this.recvTime.equals(tokenDTO.recvTime)) &&
        (this.blockNumber == null ? tokenDTO.blockNumber == null : this.blockNumber.equals(tokenDTO.blockNumber)) &&
        (this.id == null ? tokenDTO.id == null : this.id.equals(tokenDTO.id)) &&
        (this.factory == null ? tokenDTO.factory == null : this.factory.equals(tokenDTO.factory)) &&
        (this.symbol == null ? tokenDTO.symbol == null : this.symbol.equals(tokenDTO.symbol)) &&
        (this.name == null ? tokenDTO.name == null : this.name.equals(tokenDTO.name)) &&
        (this.decimals == null ? tokenDTO.decimals == null : this.decimals.equals(tokenDTO.decimals)) &&
        (this.totalSupply == null ? tokenDTO.totalSupply == null : this.totalSupply.equals(tokenDTO.totalSupply)) &&
        (this.volume == null ? tokenDTO.volume == null : this.volume.equals(tokenDTO.volume)) &&
        (this.volumeUsd == null ? tokenDTO.volumeUsd == null : this.volumeUsd.equals(tokenDTO.volumeUsd)) &&
        (this.untrackedVolumeUsd == null ? tokenDTO.untrackedVolumeUsd == null : this.untrackedVolumeUsd.equals(tokenDTO.untrackedVolumeUsd)) &&
        (this.txCount == null ? tokenDTO.txCount == null : this.txCount.equals(tokenDTO.txCount)) &&
        (this.liquidity == null ? tokenDTO.liquidity == null : this.liquidity.equals(tokenDTO.liquidity)) &&
        (this.derivedEth == null ? tokenDTO.derivedEth == null : this.derivedEth.equals(tokenDTO.derivedEth)) &&
        (this.whitelistPairs == null ? tokenDTO.whitelistPairs == null : this.whitelistPairs.equals(tokenDTO.whitelistPairs)) &&
        (this.vid == null ? tokenDTO.vid == null : this.vid.equals(tokenDTO.vid)) &&
        (this.tokenSymbol == null ? tokenDTO.tokenSymbol == null : this.tokenSymbol.equals(tokenDTO.tokenSymbol));
  }
