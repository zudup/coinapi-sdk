...
public class UniswapV2MintV2DTO {
  ...
  public boolean equals(Object o) {
    ...
    return (this.entryTime == null ? uniswapV2MintV2DTO.entryTime == null : this.entryTime.equals(uniswapV2MintV2DTO.entryTime)) &&
        (this.recvTime == null ? uniswapV2MintV2DTO.recvTime == null : this.recvTime.equals(uniswapV2MintV2DTO.recvTime)) &&
        (this.blockNumber == null ? uniswapV2MintV2DTO.blockNumber == null : this.blockNumber.equals(uniswapV2MintV2DTO.blockNumber)) &&
        (this.id == null ? uniswapV2MintV2DTO.id == null : this.id.equals(uniswapV2MintV2DTO.id)) &&
        (this.transaction == null ? uniswapV2MintV2DTO.transaction == null : this.transaction.equals(uniswapV2MintV2DTO.transaction)) &&
        (this.timestamp == null ? uniswapV2MintV2DTO.timestamp == null : this.timestamp.equals(uniswapV2MintV2DTO.timestamp)) &&
        (this.pair == null ? uniswapV2MintV2DTO.pair == null : this.pair.equals(uniswapV2MintV2DTO.pair)) &&
        (this.to == null ? uniswapV2MintV2DTO.to == null : this.to.equals(uniswapV2MintV2DTO.to)) &&
        (this.liquidity == null ? uniswapV2MintV2DTO.liquidity == null : this.liquidity.equals(uniswapV2MintV2DTO.liquidity)) &&
        (this.sender == null ? uniswapV2MintV2DTO.sender == null : this.sender.equals(uniswapV2MintV2DTO.sender)) &&
        (this.amount0 == null ? uniswapV2MintV2DTO.amount0 == null : this.amount0.equals(uniswapV2MintV2DTO.amount0)) &&
        (this.amount1 == null ? uniswapV2MintV2DTO.amount1 == null : this.amount1.equals(uniswapV2MintV2DTO.amount1)) &&
        (this.logIndex == null ? uniswapV2MintV2DTO.logIndex == null : this.logIndex.equals(uniswapV2MintV2DTO.logIndex)) &&
        (this.amountUsd == null ? uniswapV2MintV2DTO.amountUsd == null : this.amountUsd.equals(uniswapV2MintV2DTO.amountUsd)) &&
        (this.feeTo == null ? uniswapV2MintV2DTO.feeTo == null : this.feeTo.equals(uniswapV2MintV2DTO.feeTo)) &&
        (this.feeLiquidity == null ? uniswapV2MintV2DTO.feeLiquidity == null : this.feeLiquidity.equals(uniswapV2MintV2DTO.feeLiquidity)) &&
        (this.vid == null ? uniswapV2MintV2DTO.vid == null : this.vid.equals(uniswapV2MintV2DTO.vid)) &&
        (this.blockRange == null ? uniswapV2MintV2DTO.blockRange == null : this.blockRange.equals(uniswapV2MintV2DTO.blockRange));
  }
