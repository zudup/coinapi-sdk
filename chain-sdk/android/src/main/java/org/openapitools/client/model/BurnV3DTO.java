...
public class BurnV3DTO {
  ...
  public boolean equals(Object o) {
    ...
    return (this.entryTime == null ? burnV3DTO.entryTime == null : this.entryTime.equals(burnV3DTO.entryTime)) &&
        (this.recvTime == null ? burnV3DTO.recvTime == null : this.recvTime.equals(burnV3DTO.recvTime)) &&
        (this.blockNumber == null ? burnV3DTO.blockNumber == null : this.blockNumber.equals(burnV3DTO.blockNumber)) &&
        (this.id == null ? burnV3DTO.id == null : this.id.equals(burnV3DTO.id)) &&
        (this.transaction == null ? burnV3DTO.transaction == null : this.transaction.equals(burnV3DTO.transaction)) &&
        (this.pool == null ? burnV3DTO.pool == null : this.pool.equals(burnV3DTO.pool)) &&
        (this.token0 == null ? burnV3DTO.token0 == null : this.token0.equals(burnV3DTO.token0)) &&
        (this.token1 == null ? burnV3DTO.token1 == null : this.token1.equals(burnV3DTO.token1)) &&
        (this.timestamp == null ? burnV3DTO.timestamp == null : this.timestamp.equals(burnV3DTO.timestamp)) &&
        (this.owner == null ? burnV3DTO.owner == null : this.owner.equals(burnV3DTO.owner)) &&
        (this.origin == null ? burnV3DTO.origin == null : this.origin.equals(burnV3DTO.origin)) &&
        (this.amount == null ? burnV3DTO.amount == null : this.amount.equals(burnV3DTO.amount)) &&
        (this.amount0 == null ? burnV3DTO.amount0 == null : this.amount0.equals(burnV3DTO.amount0)) &&
        (this.amount1 == null ? burnV3DTO.amount1 == null : this.amount1.equals(burnV3DTO.amount1)) &&
        (this.amountUsd == null ? burnV3DTO.amountUsd == null : this.amountUsd.equals(burnV3DTO.amountUsd)) &&
        (this.tickLower == null ? burnV3DTO.tickLower == null : this.tickLower.equals(burnV3DTO.tickLower)) &&
        (this.tickUpper == null ? burnV3DTO.tickUpper == null : this.tickUpper.equals(burnV3DTO.tickUpper)) &&
        (this.logIndex == null ? burnV3DTO.logIndex == null : this.logIndex.equals(burnV3DTO.logIndex)) &&
        (this.vid == null ? burnV3DTO.vid == null : this.vid.equals(burnV3DTO.vid));
  }
