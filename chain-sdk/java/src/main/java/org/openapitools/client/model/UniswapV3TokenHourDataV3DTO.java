...
public class UniswapV3TokenHourDataV3DTO {
  ...
  public UniswapV3TokenHourDataV3DTO() {
  }

  public UniswapV3TokenHourDataV3DTO entryTime(OffsetDateTime entryTime) {
  ...
  **/
  ...
  public UniswapV3TokenHourDataV3DTO recvTime(OffsetDateTime recvTime) {
  ...
  **/
  ...
  public UniswapV3TokenHourDataV3DTO blockNumber(Long blockNumber) {
  ...
  **/
  ...
  public UniswapV3TokenHourDataV3DTO id(String id) {
  ...
  **/
  ...
  public UniswapV3TokenHourDataV3DTO periodStartUnix(Integer periodStartUnix) {
  ...
  **/
  ...
  public UniswapV3TokenHourDataV3DTO token(String token) {
  ...
  **/
  ...
  public UniswapV3TokenHourDataV3DTO volume(String volume) {
  ...
  **/
  ...
  public UniswapV3TokenHourDataV3DTO volumeUsd(String volumeUsd) {
  ...
  **/
  ...
  public UniswapV3TokenHourDataV3DTO untrackedVolumeUsd(String untrackedVolumeUsd) {
  ...
  **/
  ...
  public UniswapV3TokenHourDataV3DTO totalValueLocked(String totalValueLocked) {
  ...
  **/
  ...
  public UniswapV3TokenHourDataV3DTO totalValueLockedUsd(String totalValueLockedUsd) {
  ...
  **/
  ...
  public UniswapV3TokenHourDataV3DTO priceUsd(String priceUsd) {
  ...
  **/
  ...
  public UniswapV3TokenHourDataV3DTO feesUsd(String feesUsd) {
  ...
  **/
  ...
  public UniswapV3TokenHourDataV3DTO open(String open) {
  ...
  **/
  ...
  public UniswapV3TokenHourDataV3DTO high(String high) {
  ...
  **/
  ...
  public UniswapV3TokenHourDataV3DTO low(String low) {
  ...
  **/
  ...
  public UniswapV3TokenHourDataV3DTO close(String close) {
  ...
  **/
  ...
  public UniswapV3TokenHourDataV3DTO vid(Long vid) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    UniswapV3TokenHourDataV3DTO uniswapV3TokenHourDataV3DTO = (UniswapV3TokenHourDataV3DTO) o;
    return Objects.equals(this.entryTime, uniswapV3TokenHourDataV3DTO.entryTime) &&
        Objects.equals(this.recvTime, uniswapV3TokenHourDataV3DTO.recvTime) &&
        Objects.equals(this.blockNumber, uniswapV3TokenHourDataV3DTO.blockNumber) &&
        Objects.equals(this.id, uniswapV3TokenHourDataV3DTO.id) &&
        Objects.equals(this.periodStartUnix, uniswapV3TokenHourDataV3DTO.periodStartUnix) &&
        Objects.equals(this.token, uniswapV3TokenHourDataV3DTO.token) &&
        Objects.equals(this.volume, uniswapV3TokenHourDataV3DTO.volume) &&
        Objects.equals(this.volumeUsd, uniswapV3TokenHourDataV3DTO.volumeUsd) &&
        Objects.equals(this.untrackedVolumeUsd, uniswapV3TokenHourDataV3DTO.untrackedVolumeUsd) &&
        Objects.equals(this.totalValueLocked, uniswapV3TokenHourDataV3DTO.totalValueLocked) &&
        Objects.equals(this.totalValueLockedUsd, uniswapV3TokenHourDataV3DTO.totalValueLockedUsd) &&
        Objects.equals(this.priceUsd, uniswapV3TokenHourDataV3DTO.priceUsd) &&
        Objects.equals(this.feesUsd, uniswapV3TokenHourDataV3DTO.feesUsd) &&
        Objects.equals(this.open, uniswapV3TokenHourDataV3DTO.open) &&
        Objects.equals(this.high, uniswapV3TokenHourDataV3DTO.high) &&
        Objects.equals(this.low, uniswapV3TokenHourDataV3DTO.low) &&
        Objects.equals(this.close, uniswapV3TokenHourDataV3DTO.close) &&
        Objects.equals(this.vid, uniswapV3TokenHourDataV3DTO.vid);
  }
  ...
  public String toString() {
    ...
    sb.append("class UniswapV3TokenHourDataV3DTO {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to UniswapV3TokenHourDataV3DTO
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!UniswapV3TokenHourDataV3DTO.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in UniswapV3TokenHourDataV3DTO is not found in the empty JSON string", UniswapV3TokenHourDataV3DTO.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!UniswapV3TokenHourDataV3DTO.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `UniswapV3TokenHourDataV3DTO` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UniswapV3TokenHourDataV3DTO.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UniswapV3TokenHourDataV3DTO' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UniswapV3TokenHourDataV3DTO> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UniswapV3TokenHourDataV3DTO.class));

       return (TypeAdapter<T>) new TypeAdapter<UniswapV3TokenHourDataV3DTO>() {
           @Override
           public void write(JsonWriter out, UniswapV3TokenHourDataV3DTO value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public UniswapV3TokenHourDataV3DTO read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of UniswapV3TokenHourDataV3DTO given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of UniswapV3TokenHourDataV3DTO
  * @throws IOException if the JSON string is invalid with respect to UniswapV3TokenHourDataV3DTO
  */
  public static UniswapV3TokenHourDataV3DTO fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UniswapV3TokenHourDataV3DTO.class);
  }

 /**
  * Convert an instance of UniswapV3TokenHourDataV3DTO to an JSON string
  *
  * @return JSON string
  */
