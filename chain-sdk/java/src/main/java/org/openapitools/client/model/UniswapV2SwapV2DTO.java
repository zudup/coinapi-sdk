...
public class UniswapV2SwapV2DTO {
  ...
  public UniswapV2SwapV2DTO entryTime(OffsetDateTime entryTime) {
  ...
  **/
  ...
  public UniswapV2SwapV2DTO recvTime(OffsetDateTime recvTime) {
  ...
  **/
  ...
  public UniswapV2SwapV2DTO blockNumber(Long blockNumber) {
  ...
  **/
  ...
  public UniswapV2SwapV2DTO vid(Long vid) {
  ...
  **/
  ...
  public UniswapV2SwapV2DTO id(String id) {
  ...
  **/
  ...
  public UniswapV2SwapV2DTO transaction(String transaction) {
  ...
  **/
  ...
  public UniswapV2SwapV2DTO timestamp(OffsetDateTime timestamp) {
  ...
  **/
  ...
  public UniswapV2SwapV2DTO pair(String pair) {
  ...
  **/
  ...
  public UniswapV2SwapV2DTO sender(String sender) {
  ...
  **/
  ...
  public UniswapV2SwapV2DTO from(String from) {
  ...
  **/
  ...
  public UniswapV2SwapV2DTO amount0In(String amount0In) {
  ...
  **/
  ...
  public UniswapV2SwapV2DTO amount1In(String amount1In) {
  ...
  **/
  ...
  public UniswapV2SwapV2DTO amount0Out(String amount0Out) {
  ...
  **/
  ...
  public UniswapV2SwapV2DTO amount1Out(String amount1Out) {
  ...
  **/
  ...
  public UniswapV2SwapV2DTO to(String to) {
  ...
  **/
  ...
  public UniswapV2SwapV2DTO logIndex(NumericsBigInteger logIndex) {
  ...
  **/
  ...
  public UniswapV2SwapV2DTO amountUsd(String amountUsd) {
  ...
  **/
  ...
  public UniswapV2SwapV2DTO evaluatedAggressor(TransactionsETradeAggressiveSide evaluatedAggressor) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.entryTime, uniswapV2SwapV2DTO.entryTime) &&
        Objects.equals(this.recvTime, uniswapV2SwapV2DTO.recvTime) &&
        Objects.equals(this.blockNumber, uniswapV2SwapV2DTO.blockNumber) &&
        Objects.equals(this.vid, uniswapV2SwapV2DTO.vid) &&
        Objects.equals(this.id, uniswapV2SwapV2DTO.id) &&
        Objects.equals(this.transaction, uniswapV2SwapV2DTO.transaction) &&
        Objects.equals(this.timestamp, uniswapV2SwapV2DTO.timestamp) &&
        Objects.equals(this.pair, uniswapV2SwapV2DTO.pair) &&
        Objects.equals(this.sender, uniswapV2SwapV2DTO.sender) &&
        Objects.equals(this.from, uniswapV2SwapV2DTO.from) &&
        Objects.equals(this.amount0In, uniswapV2SwapV2DTO.amount0In) &&
        Objects.equals(this.amount1In, uniswapV2SwapV2DTO.amount1In) &&
        Objects.equals(this.amount0Out, uniswapV2SwapV2DTO.amount0Out) &&
        Objects.equals(this.amount1Out, uniswapV2SwapV2DTO.amount1Out) &&
        Objects.equals(this.to, uniswapV2SwapV2DTO.to) &&
        Objects.equals(this.logIndex, uniswapV2SwapV2DTO.logIndex) &&
        Objects.equals(this.amountUsd, uniswapV2SwapV2DTO.amountUsd) &&
        Objects.equals(this.evaluatedPrice, uniswapV2SwapV2DTO.evaluatedPrice) &&
        Objects.equals(this.evaluatedAmount, uniswapV2SwapV2DTO.evaluatedAmount) &&
        Objects.equals(this.evaluatedAggressor, uniswapV2SwapV2DTO.evaluatedAggressor) &&
        Objects.equals(this.poolId, uniswapV2SwapV2DTO.poolId) &&
        Objects.equals(this.transactionId, uniswapV2SwapV2DTO.transactionId);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to UniswapV2SwapV2DTO
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!UniswapV2SwapV2DTO.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in UniswapV2SwapV2DTO is not found in the empty JSON string", UniswapV2SwapV2DTO.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!UniswapV2SwapV2DTO.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `UniswapV2SwapV2DTO` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UniswapV2SwapV2DTO.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UniswapV2SwapV2DTO' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UniswapV2SwapV2DTO> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UniswapV2SwapV2DTO.class));

       return (TypeAdapter<T>) new TypeAdapter<UniswapV2SwapV2DTO>() {
           @Override
           public void write(JsonWriter out, UniswapV2SwapV2DTO value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public UniswapV2SwapV2DTO read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of UniswapV2SwapV2DTO given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of UniswapV2SwapV2DTO
  * @throws IOException if the JSON string is invalid with respect to UniswapV2SwapV2DTO
  */
  public static UniswapV2SwapV2DTO fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UniswapV2SwapV2DTO.class);
  }

 /**
  * Convert an instance of UniswapV2SwapV2DTO to an JSON string
  *
  * @return JSON string
  */
