...
public class UniswapV2PairV2DTO {
  ...
  public UniswapV2PairV2DTO entryTime(OffsetDateTime entryTime) {
  ...
  **/
  ...
  public UniswapV2PairV2DTO recvTime(OffsetDateTime recvTime) {
  ...
  **/
  ...
  public UniswapV2PairV2DTO blockNumber(Long blockNumber) {
  ...
  **/
  ...
  public UniswapV2PairV2DTO vid(Long vid) {
  ...
  **/
  ...
  public UniswapV2PairV2DTO id(String id) {
  ...
  **/
  ...
  public UniswapV2PairV2DTO token0(String token0) {
  ...
  **/
  ...
  public UniswapV2PairV2DTO token1(String token1) {
  ...
  **/
  ...
  public UniswapV2PairV2DTO reserve0(String reserve0) {
  ...
  **/
  ...
  public UniswapV2PairV2DTO reserve1(String reserve1) {
  ...
  **/
  ...
  public UniswapV2PairV2DTO totalSupply(String totalSupply) {
  ...
  **/
  ...
  public UniswapV2PairV2DTO reserveEth(String reserveEth) {
  ...
  **/
  ...
  public UniswapV2PairV2DTO reserveUsd(String reserveUsd) {
  ...
  **/
  ...
  public UniswapV2PairV2DTO trackedReserveEth(String trackedReserveEth) {
  ...
  **/
  ...
  public UniswapV2PairV2DTO token0Price(String token0Price) {
  ...
  **/
  ...
  public UniswapV2PairV2DTO token1Price(String token1Price) {
  ...
  **/
  ...
  public UniswapV2PairV2DTO volumeToken0(String volumeToken0) {
  ...
  **/
  ...
  public UniswapV2PairV2DTO volumeToken1(String volumeToken1) {
  ...
  **/
  ...
  public UniswapV2PairV2DTO volumeUsd(String volumeUsd) {
  ...
  **/
  ...
  public UniswapV2PairV2DTO untrackedVolumeUsd(String untrackedVolumeUsd) {
  ...
  **/
  ...
  public UniswapV2PairV2DTO txCount(NumericsBigInteger txCount) {
  ...
  **/
  ...
  public UniswapV2PairV2DTO createdAtTimestamp(OffsetDateTime createdAtTimestamp) {
  ...
  **/
  ...
  public UniswapV2PairV2DTO liquidityProviderCount(String liquidityProviderCount) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    UniswapV2PairV2DTO uniswapV2PairV2DTO = (UniswapV2PairV2DTO) o;
    return Objects.equals(this.entryTime, uniswapV2PairV2DTO.entryTime) &&
        Objects.equals(this.recvTime, uniswapV2PairV2DTO.recvTime) &&
        Objects.equals(this.blockNumber, uniswapV2PairV2DTO.blockNumber) &&
        Objects.equals(this.vid, uniswapV2PairV2DTO.vid) &&
        Objects.equals(this.id, uniswapV2PairV2DTO.id) &&
        Objects.equals(this.token0, uniswapV2PairV2DTO.token0) &&
        Objects.equals(this.token1, uniswapV2PairV2DTO.token1) &&
        Objects.equals(this.reserve0, uniswapV2PairV2DTO.reserve0) &&
        Objects.equals(this.reserve1, uniswapV2PairV2DTO.reserve1) &&
        Objects.equals(this.totalSupply, uniswapV2PairV2DTO.totalSupply) &&
        Objects.equals(this.reserveEth, uniswapV2PairV2DTO.reserveEth) &&
        Objects.equals(this.reserveUsd, uniswapV2PairV2DTO.reserveUsd) &&
        Objects.equals(this.trackedReserveEth, uniswapV2PairV2DTO.trackedReserveEth) &&
        Objects.equals(this.token0Price, uniswapV2PairV2DTO.token0Price) &&
        Objects.equals(this.token1Price, uniswapV2PairV2DTO.token1Price) &&
        Objects.equals(this.volumeToken0, uniswapV2PairV2DTO.volumeToken0) &&
        Objects.equals(this.volumeToken1, uniswapV2PairV2DTO.volumeToken1) &&
        Objects.equals(this.volumeUsd, uniswapV2PairV2DTO.volumeUsd) &&
        Objects.equals(this.untrackedVolumeUsd, uniswapV2PairV2DTO.untrackedVolumeUsd) &&
        Objects.equals(this.txCount, uniswapV2PairV2DTO.txCount) &&
        Objects.equals(this.createdAtTimestamp, uniswapV2PairV2DTO.createdAtTimestamp) &&
        Objects.equals(this.liquidityProviderCount, uniswapV2PairV2DTO.liquidityProviderCount) &&
        Objects.equals(this.evaluatedAsk, uniswapV2PairV2DTO.evaluatedAsk);
  }
  ...
  public String toString() {
    ...
    sb.append("class UniswapV2PairV2DTO {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to UniswapV2PairV2DTO
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!UniswapV2PairV2DTO.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in UniswapV2PairV2DTO is not found in the empty JSON string", UniswapV2PairV2DTO.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!UniswapV2PairV2DTO.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `UniswapV2PairV2DTO` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UniswapV2PairV2DTO.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UniswapV2PairV2DTO' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UniswapV2PairV2DTO> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UniswapV2PairV2DTO.class));

       return (TypeAdapter<T>) new TypeAdapter<UniswapV2PairV2DTO>() {
           @Override
           public void write(JsonWriter out, UniswapV2PairV2DTO value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public UniswapV2PairV2DTO read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of UniswapV2PairV2DTO given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of UniswapV2PairV2DTO
  * @throws IOException if the JSON string is invalid with respect to UniswapV2PairV2DTO
  */
  public static UniswapV2PairV2DTO fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UniswapV2PairV2DTO.class);
  }

 /**
  * Convert an instance of UniswapV2PairV2DTO to an JSON string
  *
  * @return JSON string
  */
