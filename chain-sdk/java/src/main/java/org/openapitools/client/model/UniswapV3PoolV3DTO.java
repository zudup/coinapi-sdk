...
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2022-11-04T13:26:43.473018Z[Etc/UTC]")
public class UniswapV3PoolV3DTO {
  ...
  public UniswapV3PoolV3DTO entryTime(OffsetDateTime entryTime) {
  ...
  **/
  ...
  public UniswapV3PoolV3DTO recvTime(OffsetDateTime recvTime) {
  ...
  **/
  ...
  public UniswapV3PoolV3DTO blockNumber(Long blockNumber) {
  ...
  **/
  ...
  public UniswapV3PoolV3DTO vid(Long vid) {
  ...
  **/
  ...
  public UniswapV3PoolV3DTO id(String id) {
  ...
  **/
  ...
  public UniswapV3PoolV3DTO createdAtTimestamp(OffsetDateTime createdAtTimestamp) {
  ...
  **/
  ...
  public UniswapV3PoolV3DTO token0(String token0) {
  ...
  **/
  ...
  public UniswapV3PoolV3DTO token1(String token1) {
  ...
  **/
  ...
  public UniswapV3PoolV3DTO feeTier(NumericsBigInteger feeTier) {
  ...
  **/
  ...
  public UniswapV3PoolV3DTO liquidity(NumericsBigInteger liquidity) {
  ...
  **/
  ...
  public UniswapV3PoolV3DTO sqrtPrice(NumericsBigInteger sqrtPrice) {
  ...
  **/
  ...
  public UniswapV3PoolV3DTO feeGrowthGlobal0x128(NumericsBigInteger feeGrowthGlobal0x128) {
  ...
  **/
  ...
  public UniswapV3PoolV3DTO feeGrowthGlobal1x128(NumericsBigInteger feeGrowthGlobal1x128) {
  ...
  **/
  ...
  public UniswapV3PoolV3DTO token0Price(String token0Price) {
  ...
  **/
  ...
  public UniswapV3PoolV3DTO token1Price(String token1Price) {
  ...
  **/
  ...
  public UniswapV3PoolV3DTO tick(NumericsBigInteger tick) {
  ...
  **/
  ...
  public UniswapV3PoolV3DTO observationIndex(NumericsBigInteger observationIndex) {
  ...
  **/
  ...
  public UniswapV3PoolV3DTO volumeToken0(String volumeToken0) {
  ...
  **/
  ...
  public UniswapV3PoolV3DTO volumeToken1(String volumeToken1) {
  ...
  **/
  ...
  public UniswapV3PoolV3DTO volumeUsd(String volumeUsd) {
  ...
  **/
  ...
  public UniswapV3PoolV3DTO untrackedVolumeUsd(String untrackedVolumeUsd) {
  ...
  **/
  ...
  public UniswapV3PoolV3DTO feesUsd(String feesUsd) {
  ...
  **/
  ...
  public UniswapV3PoolV3DTO txCount(NumericsBigInteger txCount) {
  ...
  **/
  ...
  public UniswapV3PoolV3DTO collectedFeesToken0(String collectedFeesToken0) {
  ...
  **/
  ...
  public UniswapV3PoolV3DTO collectedFeesToken1(String collectedFeesToken1) {
  ...
  **/
  ...
  public UniswapV3PoolV3DTO collectedFeesUsd(String collectedFeesUsd) {
  ...
  **/
  ...
  public UniswapV3PoolV3DTO totalValueLockedToken0(String totalValueLockedToken0) {
  ...
  **/
  ...
  public UniswapV3PoolV3DTO totalValueLockedToken1(String totalValueLockedToken1) {
  ...
  **/
  ...
  public UniswapV3PoolV3DTO totalValueLockedEth(String totalValueLockedEth) {
  ...
  **/
  ...
  public UniswapV3PoolV3DTO totalValueLockedUsd(String totalValueLockedUsd) {
  ...
  **/
  ...
  public UniswapV3PoolV3DTO totalValueLockedUsdUntracked(String totalValueLockedUsdUntracked) {
  ...
  **/
  ...
  public UniswapV3PoolV3DTO liquidityProviderCount(String liquidityProviderCount) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    UniswapV3PoolV3DTO uniswapV3PoolV3DTO = (UniswapV3PoolV3DTO) o;
    return Objects.equals(this.entryTime, uniswapV3PoolV3DTO.entryTime) &&
        Objects.equals(this.recvTime, uniswapV3PoolV3DTO.recvTime) &&
        Objects.equals(this.blockNumber, uniswapV3PoolV3DTO.blockNumber) &&
        Objects.equals(this.vid, uniswapV3PoolV3DTO.vid) &&
        Objects.equals(this.id, uniswapV3PoolV3DTO.id) &&
        Objects.equals(this.createdAtTimestamp, uniswapV3PoolV3DTO.createdAtTimestamp) &&
        Objects.equals(this.token0, uniswapV3PoolV3DTO.token0) &&
        Objects.equals(this.token1, uniswapV3PoolV3DTO.token1) &&
        Objects.equals(this.feeTier, uniswapV3PoolV3DTO.feeTier) &&
        Objects.equals(this.liquidity, uniswapV3PoolV3DTO.liquidity) &&
        Objects.equals(this.sqrtPrice, uniswapV3PoolV3DTO.sqrtPrice) &&
        Objects.equals(this.feeGrowthGlobal0x128, uniswapV3PoolV3DTO.feeGrowthGlobal0x128) &&
        Objects.equals(this.feeGrowthGlobal1x128, uniswapV3PoolV3DTO.feeGrowthGlobal1x128) &&
        Objects.equals(this.token0Price, uniswapV3PoolV3DTO.token0Price) &&
        Objects.equals(this.token1Price, uniswapV3PoolV3DTO.token1Price) &&
        Objects.equals(this.tick, uniswapV3PoolV3DTO.tick) &&
        Objects.equals(this.observationIndex, uniswapV3PoolV3DTO.observationIndex) &&
        Objects.equals(this.volumeToken0, uniswapV3PoolV3DTO.volumeToken0) &&
        Objects.equals(this.volumeToken1, uniswapV3PoolV3DTO.volumeToken1) &&
        Objects.equals(this.volumeUsd, uniswapV3PoolV3DTO.volumeUsd) &&
        Objects.equals(this.untrackedVolumeUsd, uniswapV3PoolV3DTO.untrackedVolumeUsd) &&
        Objects.equals(this.feesUsd, uniswapV3PoolV3DTO.feesUsd) &&
        Objects.equals(this.txCount, uniswapV3PoolV3DTO.txCount) &&
        Objects.equals(this.collectedFeesToken0, uniswapV3PoolV3DTO.collectedFeesToken0) &&
        Objects.equals(this.collectedFeesToken1, uniswapV3PoolV3DTO.collectedFeesToken1) &&
        Objects.equals(this.collectedFeesUsd, uniswapV3PoolV3DTO.collectedFeesUsd) &&
        Objects.equals(this.totalValueLockedToken0, uniswapV3PoolV3DTO.totalValueLockedToken0) &&
        Objects.equals(this.totalValueLockedToken1, uniswapV3PoolV3DTO.totalValueLockedToken1) &&
        Objects.equals(this.totalValueLockedEth, uniswapV3PoolV3DTO.totalValueLockedEth) &&
        Objects.equals(this.totalValueLockedUsd, uniswapV3PoolV3DTO.totalValueLockedUsd) &&
        Objects.equals(this.totalValueLockedUsdUntracked, uniswapV3PoolV3DTO.totalValueLockedUsdUntracked) &&
        Objects.equals(this.liquidityProviderCount, uniswapV3PoolV3DTO.liquidityProviderCount) &&
        Objects.equals(this.evaluatedAsk, uniswapV3PoolV3DTO.evaluatedAsk);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to UniswapV3PoolV3DTO
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!UniswapV3PoolV3DTO.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in UniswapV3PoolV3DTO is not found in the empty JSON string", UniswapV3PoolV3DTO.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!UniswapV3PoolV3DTO.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `UniswapV3PoolV3DTO` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UniswapV3PoolV3DTO.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UniswapV3PoolV3DTO' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UniswapV3PoolV3DTO> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UniswapV3PoolV3DTO.class));

       return (TypeAdapter<T>) new TypeAdapter<UniswapV3PoolV3DTO>() {
           @Override
           public void write(JsonWriter out, UniswapV3PoolV3DTO value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public UniswapV3PoolV3DTO read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of UniswapV3PoolV3DTO given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of UniswapV3PoolV3DTO
  * @throws IOException if the JSON string is invalid with respect to UniswapV3PoolV3DTO
  */
  public static UniswapV3PoolV3DTO fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UniswapV3PoolV3DTO.class);
  }

 /**
  * Convert an instance of UniswapV3PoolV3DTO to an JSON string
  *
  * @return JSON string
  */
