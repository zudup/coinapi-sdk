...
public class UniswapV3TickDayDataV3DTO {
  ...
  public UniswapV3TickDayDataV3DTO() {
  }

  public UniswapV3TickDayDataV3DTO entryTime(OffsetDateTime entryTime) {
  ...
  **/
  ...
  public UniswapV3TickDayDataV3DTO recvTime(OffsetDateTime recvTime) {
  ...
  **/
  ...
  public UniswapV3TickDayDataV3DTO blockNumber(Long blockNumber) {
  ...
  **/
  ...
  public UniswapV3TickDayDataV3DTO id(String id) {
  ...
  **/
  ...
  public UniswapV3TickDayDataV3DTO date(Integer date) {
  ...
  **/
  ...
  public UniswapV3TickDayDataV3DTO pool(String pool) {
  ...
  **/
  ...
  public UniswapV3TickDayDataV3DTO tick(String tick) {
  ...
  **/
  ...
  public UniswapV3TickDayDataV3DTO liquidityGross(String liquidityGross) {
  ...
  **/
  ...
  public UniswapV3TickDayDataV3DTO liquidityNet(String liquidityNet) {
  ...
  **/
  ...
  public UniswapV3TickDayDataV3DTO volumeToken0(String volumeToken0) {
  ...
  **/
  ...
  public UniswapV3TickDayDataV3DTO volumeToken1(String volumeToken1) {
  ...
  **/
  ...
  public UniswapV3TickDayDataV3DTO volumeUsd(String volumeUsd) {
  ...
  **/
  ...
  public UniswapV3TickDayDataV3DTO feesUsd(String feesUsd) {
  ...
  **/
  ...
  public UniswapV3TickDayDataV3DTO feeGrowthOutside0x128(String feeGrowthOutside0x128) {
  ...
  **/
  ...
  public UniswapV3TickDayDataV3DTO feeGrowthOutside1x128(String feeGrowthOutside1x128) {
  ...
  **/
  ...
  public UniswapV3TickDayDataV3DTO vid(Long vid) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    UniswapV3TickDayDataV3DTO uniswapV3TickDayDataV3DTO = (UniswapV3TickDayDataV3DTO) o;
    return Objects.equals(this.entryTime, uniswapV3TickDayDataV3DTO.entryTime) &&
        Objects.equals(this.recvTime, uniswapV3TickDayDataV3DTO.recvTime) &&
        Objects.equals(this.blockNumber, uniswapV3TickDayDataV3DTO.blockNumber) &&
        Objects.equals(this.id, uniswapV3TickDayDataV3DTO.id) &&
        Objects.equals(this.date, uniswapV3TickDayDataV3DTO.date) &&
        Objects.equals(this.pool, uniswapV3TickDayDataV3DTO.pool) &&
        Objects.equals(this.tick, uniswapV3TickDayDataV3DTO.tick) &&
        Objects.equals(this.liquidityGross, uniswapV3TickDayDataV3DTO.liquidityGross) &&
        Objects.equals(this.liquidityNet, uniswapV3TickDayDataV3DTO.liquidityNet) &&
        Objects.equals(this.volumeToken0, uniswapV3TickDayDataV3DTO.volumeToken0) &&
        Objects.equals(this.volumeToken1, uniswapV3TickDayDataV3DTO.volumeToken1) &&
        Objects.equals(this.volumeUsd, uniswapV3TickDayDataV3DTO.volumeUsd) &&
        Objects.equals(this.feesUsd, uniswapV3TickDayDataV3DTO.feesUsd) &&
        Objects.equals(this.feeGrowthOutside0x128, uniswapV3TickDayDataV3DTO.feeGrowthOutside0x128) &&
        Objects.equals(this.feeGrowthOutside1x128, uniswapV3TickDayDataV3DTO.feeGrowthOutside1x128) &&
        Objects.equals(this.vid, uniswapV3TickDayDataV3DTO.vid);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to UniswapV3TickDayDataV3DTO
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!UniswapV3TickDayDataV3DTO.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in UniswapV3TickDayDataV3DTO is not found in the empty JSON string", UniswapV3TickDayDataV3DTO.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!UniswapV3TickDayDataV3DTO.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `UniswapV3TickDayDataV3DTO` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UniswapV3TickDayDataV3DTO.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UniswapV3TickDayDataV3DTO' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UniswapV3TickDayDataV3DTO> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UniswapV3TickDayDataV3DTO.class));

       return (TypeAdapter<T>) new TypeAdapter<UniswapV3TickDayDataV3DTO>() {
           @Override
           public void write(JsonWriter out, UniswapV3TickDayDataV3DTO value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public UniswapV3TickDayDataV3DTO read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of UniswapV3TickDayDataV3DTO given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of UniswapV3TickDayDataV3DTO
  * @throws IOException if the JSON string is invalid with respect to UniswapV3TickDayDataV3DTO
  */
  public static UniswapV3TickDayDataV3DTO fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UniswapV3TickDayDataV3DTO.class);
  }

 /**
  * Convert an instance of UniswapV3TickDayDataV3DTO to an JSON string
  *
  * @return JSON string
  */
