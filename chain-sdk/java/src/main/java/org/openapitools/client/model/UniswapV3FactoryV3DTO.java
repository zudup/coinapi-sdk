...
public class UniswapV3FactoryV3DTO {
  ...
  public UniswapV3FactoryV3DTO() {
  }

  public UniswapV3FactoryV3DTO entryTime(OffsetDateTime entryTime) {
  ...
  **/
  ...
  public UniswapV3FactoryV3DTO recvTime(OffsetDateTime recvTime) {
  ...
  **/
  ...
  public UniswapV3FactoryV3DTO blockNumber(Long blockNumber) {
  ...
  **/
  ...
  public UniswapV3FactoryV3DTO id(String id) {
  ...
  **/
  ...
  public UniswapV3FactoryV3DTO poolCount(String poolCount) {
  ...
  **/
  ...
  public UniswapV3FactoryV3DTO txCount(String txCount) {
  ...
  **/
  ...
  public UniswapV3FactoryV3DTO totalVolumeUsd(String totalVolumeUsd) {
  ...
  **/
  ...
  public UniswapV3FactoryV3DTO totalVolumeEth(String totalVolumeEth) {
  ...
  **/
  ...
  public UniswapV3FactoryV3DTO totalFeesUsd(String totalFeesUsd) {
  ...
  **/
  ...
  public UniswapV3FactoryV3DTO totalFeesEth(String totalFeesEth) {
  ...
  **/
  ...
  public UniswapV3FactoryV3DTO untrackedVolumeUsd(String untrackedVolumeUsd) {
  ...
  **/
  ...
  public UniswapV3FactoryV3DTO totalValueLockedUsd(String totalValueLockedUsd) {
  ...
  **/
  ...
  public UniswapV3FactoryV3DTO totalValueLockedEth(String totalValueLockedEth) {
  ...
  **/
  ...
  public UniswapV3FactoryV3DTO totalValueLockedUsdUntracked(String totalValueLockedUsdUntracked) {
  ...
  **/
  ...
  public UniswapV3FactoryV3DTO totalValueLockedEthUntracked(String totalValueLockedEthUntracked) {
  ...
  **/
  ...
  public UniswapV3FactoryV3DTO owner(String owner) {
  ...
  **/
  ...
  public UniswapV3FactoryV3DTO vid(Long vid) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    UniswapV3FactoryV3DTO uniswapV3FactoryV3DTO = (UniswapV3FactoryV3DTO) o;
    return Objects.equals(this.entryTime, uniswapV3FactoryV3DTO.entryTime) &&
        Objects.equals(this.recvTime, uniswapV3FactoryV3DTO.recvTime) &&
        Objects.equals(this.blockNumber, uniswapV3FactoryV3DTO.blockNumber) &&
        Objects.equals(this.id, uniswapV3FactoryV3DTO.id) &&
        Objects.equals(this.poolCount, uniswapV3FactoryV3DTO.poolCount) &&
        Objects.equals(this.txCount, uniswapV3FactoryV3DTO.txCount) &&
        Objects.equals(this.totalVolumeUsd, uniswapV3FactoryV3DTO.totalVolumeUsd) &&
        Objects.equals(this.totalVolumeEth, uniswapV3FactoryV3DTO.totalVolumeEth) &&
        Objects.equals(this.totalFeesUsd, uniswapV3FactoryV3DTO.totalFeesUsd) &&
        Objects.equals(this.totalFeesEth, uniswapV3FactoryV3DTO.totalFeesEth) &&
        Objects.equals(this.untrackedVolumeUsd, uniswapV3FactoryV3DTO.untrackedVolumeUsd) &&
        Objects.equals(this.totalValueLockedUsd, uniswapV3FactoryV3DTO.totalValueLockedUsd) &&
        Objects.equals(this.totalValueLockedEth, uniswapV3FactoryV3DTO.totalValueLockedEth) &&
        Objects.equals(this.totalValueLockedUsdUntracked, uniswapV3FactoryV3DTO.totalValueLockedUsdUntracked) &&
        Objects.equals(this.totalValueLockedEthUntracked, uniswapV3FactoryV3DTO.totalValueLockedEthUntracked) &&
        Objects.equals(this.owner, uniswapV3FactoryV3DTO.owner) &&
        Objects.equals(this.vid, uniswapV3FactoryV3DTO.vid);
  }
  ...
  public String toString() {
    ...
    sb.append("class UniswapV3FactoryV3DTO {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to UniswapV3FactoryV3DTO
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!UniswapV3FactoryV3DTO.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in UniswapV3FactoryV3DTO is not found in the empty JSON string", UniswapV3FactoryV3DTO.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!UniswapV3FactoryV3DTO.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `UniswapV3FactoryV3DTO` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UniswapV3FactoryV3DTO.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UniswapV3FactoryV3DTO' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UniswapV3FactoryV3DTO> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UniswapV3FactoryV3DTO.class));

       return (TypeAdapter<T>) new TypeAdapter<UniswapV3FactoryV3DTO>() {
           @Override
           public void write(JsonWriter out, UniswapV3FactoryV3DTO value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public UniswapV3FactoryV3DTO read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of UniswapV3FactoryV3DTO given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of UniswapV3FactoryV3DTO
  * @throws IOException if the JSON string is invalid with respect to UniswapV3FactoryV3DTO
  */
  public static UniswapV3FactoryV3DTO fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UniswapV3FactoryV3DTO.class);
  }

 /**
  * Convert an instance of UniswapV3FactoryV3DTO to an JSON string
  *
  * @return JSON string
  */
