...
public class UniswapV2UniswapDayDataV2DTO {
  ...
  public UniswapV2UniswapDayDataV2DTO() {
  }

  public UniswapV2UniswapDayDataV2DTO entryTime(OffsetDateTime entryTime) {
  ...
  **/
  ...
  public UniswapV2UniswapDayDataV2DTO recvTime(OffsetDateTime recvTime) {
  ...
  **/
  ...
  public UniswapV2UniswapDayDataV2DTO blockNumber(Long blockNumber) {
  ...
  **/
  ...
  public UniswapV2UniswapDayDataV2DTO id(String id) {
  ...
  **/
  ...
  public UniswapV2UniswapDayDataV2DTO date(Integer date) {
  ...
  **/
  ...
  public UniswapV2UniswapDayDataV2DTO dailyVolumeEth(String dailyVolumeEth) {
  ...
  **/
  ...
  public UniswapV2UniswapDayDataV2DTO dailyVolumeUsd(String dailyVolumeUsd) {
  ...
  **/
  ...
  public UniswapV2UniswapDayDataV2DTO dailyVolumeUntracked(String dailyVolumeUntracked) {
  ...
  **/
  ...
  public UniswapV2UniswapDayDataV2DTO totalVolumeEth(String totalVolumeEth) {
  ...
  **/
  ...
  public UniswapV2UniswapDayDataV2DTO totalLiquidityEth(String totalLiquidityEth) {
  ...
  **/
  ...
  public UniswapV2UniswapDayDataV2DTO totalVolumeUsd(String totalVolumeUsd) {
  ...
  **/
  ...
  public UniswapV2UniswapDayDataV2DTO totalLiquidityUsd(String totalLiquidityUsd) {
  ...
  **/
  ...
  public UniswapV2UniswapDayDataV2DTO txCount(String txCount) {
  ...
  **/
  ...
  public UniswapV2UniswapDayDataV2DTO vid(Long vid) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.entryTime, uniswapV2UniswapDayDataV2DTO.entryTime) &&
        Objects.equals(this.recvTime, uniswapV2UniswapDayDataV2DTO.recvTime) &&
        Objects.equals(this.blockNumber, uniswapV2UniswapDayDataV2DTO.blockNumber) &&
        Objects.equals(this.id, uniswapV2UniswapDayDataV2DTO.id) &&
        Objects.equals(this.date, uniswapV2UniswapDayDataV2DTO.date) &&
        Objects.equals(this.dailyVolumeEth, uniswapV2UniswapDayDataV2DTO.dailyVolumeEth) &&
        Objects.equals(this.dailyVolumeUsd, uniswapV2UniswapDayDataV2DTO.dailyVolumeUsd) &&
        Objects.equals(this.dailyVolumeUntracked, uniswapV2UniswapDayDataV2DTO.dailyVolumeUntracked) &&
        Objects.equals(this.totalVolumeEth, uniswapV2UniswapDayDataV2DTO.totalVolumeEth) &&
        Objects.equals(this.totalLiquidityEth, uniswapV2UniswapDayDataV2DTO.totalLiquidityEth) &&
        Objects.equals(this.totalVolumeUsd, uniswapV2UniswapDayDataV2DTO.totalVolumeUsd) &&
        Objects.equals(this.totalLiquidityUsd, uniswapV2UniswapDayDataV2DTO.totalLiquidityUsd) &&
        Objects.equals(this.txCount, uniswapV2UniswapDayDataV2DTO.txCount) &&
        Objects.equals(this.vid, uniswapV2UniswapDayDataV2DTO.vid);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to UniswapV2UniswapDayDataV2DTO
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!UniswapV2UniswapDayDataV2DTO.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in UniswapV2UniswapDayDataV2DTO is not found in the empty JSON string", UniswapV2UniswapDayDataV2DTO.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!UniswapV2UniswapDayDataV2DTO.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `UniswapV2UniswapDayDataV2DTO` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UniswapV2UniswapDayDataV2DTO.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UniswapV2UniswapDayDataV2DTO' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UniswapV2UniswapDayDataV2DTO> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UniswapV2UniswapDayDataV2DTO.class));

       return (TypeAdapter<T>) new TypeAdapter<UniswapV2UniswapDayDataV2DTO>() {
           @Override
           public void write(JsonWriter out, UniswapV2UniswapDayDataV2DTO value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public UniswapV2UniswapDayDataV2DTO read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of UniswapV2UniswapDayDataV2DTO given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of UniswapV2UniswapDayDataV2DTO
  * @throws IOException if the JSON string is invalid with respect to UniswapV2UniswapDayDataV2DTO
  */
  public static UniswapV2UniswapDayDataV2DTO fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UniswapV2UniswapDayDataV2DTO.class);
  }

 /**
  * Convert an instance of UniswapV2UniswapDayDataV2DTO to an JSON string
  *
  * @return JSON string
  */
