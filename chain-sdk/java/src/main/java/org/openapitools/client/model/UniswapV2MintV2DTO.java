...
public class UniswapV2MintV2DTO {
  ...
  public UniswapV2MintV2DTO() {
  }

  public UniswapV2MintV2DTO entryTime(OffsetDateTime entryTime) {
  ...
  **/
  ...
  public UniswapV2MintV2DTO recvTime(OffsetDateTime recvTime) {
  ...
  **/
  ...
  public UniswapV2MintV2DTO blockNumber(Long blockNumber) {
  ...
  **/
  ...
  public UniswapV2MintV2DTO id(String id) {
  ...
  **/
  ...
  public UniswapV2MintV2DTO transaction(String transaction) {
  ...
  **/
  ...
  public UniswapV2MintV2DTO timestamp(String timestamp) {
  ...
  **/
  ...
  public UniswapV2MintV2DTO pair(String pair) {
  ...
  **/
  ...
  public UniswapV2MintV2DTO to(String to) {
  ...
  **/
  ...
  public UniswapV2MintV2DTO liquidity(String liquidity) {
  ...
  **/
  ...
  public UniswapV2MintV2DTO sender(String sender) {
  ...
  **/
  ...
  public UniswapV2MintV2DTO amount0(String amount0) {
  ...
  **/
  ...
  public UniswapV2MintV2DTO amount1(String amount1) {
  ...
  **/
  ...
  public UniswapV2MintV2DTO logIndex(String logIndex) {
  ...
  **/
  ...
  public UniswapV2MintV2DTO amountUsd(String amountUsd) {
  ...
  **/
  ...
  public UniswapV2MintV2DTO feeTo(String feeTo) {
  ...
  **/
  ...
  public UniswapV2MintV2DTO feeLiquidity(String feeLiquidity) {
  ...
  **/
  ...
  public UniswapV2MintV2DTO vid(Long vid) {
  ...
  **/
  ...
  public UniswapV2MintV2DTO blockRange(String blockRange) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    UniswapV2MintV2DTO uniswapV2MintV2DTO = (UniswapV2MintV2DTO) o;
    return Objects.equals(this.entryTime, uniswapV2MintV2DTO.entryTime) &&
        Objects.equals(this.recvTime, uniswapV2MintV2DTO.recvTime) &&
        Objects.equals(this.blockNumber, uniswapV2MintV2DTO.blockNumber) &&
        Objects.equals(this.id, uniswapV2MintV2DTO.id) &&
        Objects.equals(this.transaction, uniswapV2MintV2DTO.transaction) &&
        Objects.equals(this.timestamp, uniswapV2MintV2DTO.timestamp) &&
        Objects.equals(this.pair, uniswapV2MintV2DTO.pair) &&
        Objects.equals(this.to, uniswapV2MintV2DTO.to) &&
        Objects.equals(this.liquidity, uniswapV2MintV2DTO.liquidity) &&
        Objects.equals(this.sender, uniswapV2MintV2DTO.sender) &&
        Objects.equals(this.amount0, uniswapV2MintV2DTO.amount0) &&
        Objects.equals(this.amount1, uniswapV2MintV2DTO.amount1) &&
        Objects.equals(this.logIndex, uniswapV2MintV2DTO.logIndex) &&
        Objects.equals(this.amountUsd, uniswapV2MintV2DTO.amountUsd) &&
        Objects.equals(this.feeTo, uniswapV2MintV2DTO.feeTo) &&
        Objects.equals(this.feeLiquidity, uniswapV2MintV2DTO.feeLiquidity) &&
        Objects.equals(this.vid, uniswapV2MintV2DTO.vid) &&
        Objects.equals(this.blockRange, uniswapV2MintV2DTO.blockRange);
  }
  ...
  public String toString() {
    ...
    sb.append("class UniswapV2MintV2DTO {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to UniswapV2MintV2DTO
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!UniswapV2MintV2DTO.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in UniswapV2MintV2DTO is not found in the empty JSON string", UniswapV2MintV2DTO.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!UniswapV2MintV2DTO.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `UniswapV2MintV2DTO` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UniswapV2MintV2DTO.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UniswapV2MintV2DTO' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UniswapV2MintV2DTO> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UniswapV2MintV2DTO.class));

       return (TypeAdapter<T>) new TypeAdapter<UniswapV2MintV2DTO>() {
           @Override
           public void write(JsonWriter out, UniswapV2MintV2DTO value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public UniswapV2MintV2DTO read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of UniswapV2MintV2DTO given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of UniswapV2MintV2DTO
  * @throws IOException if the JSON string is invalid with respect to UniswapV2MintV2DTO
  */
  public static UniswapV2MintV2DTO fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UniswapV2MintV2DTO.class);
  }

 /**
  * Convert an instance of UniswapV2MintV2DTO to an JSON string
  *
  * @return JSON string
  */
