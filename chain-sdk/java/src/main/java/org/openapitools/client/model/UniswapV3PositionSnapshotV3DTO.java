...
public class UniswapV3PositionSnapshotV3DTO {
  ...
  public UniswapV3PositionSnapshotV3DTO() {
  }

  public UniswapV3PositionSnapshotV3DTO entryTime(OffsetDateTime entryTime) {
  ...
  **/
  ...
  public UniswapV3PositionSnapshotV3DTO recvTime(OffsetDateTime recvTime) {
  ...
  **/
  ...
  public UniswapV3PositionSnapshotV3DTO blockNumber(Long blockNumber) {
  ...
  **/
  ...
  public UniswapV3PositionSnapshotV3DTO id(String id) {
  ...
  **/
  ...
  public UniswapV3PositionSnapshotV3DTO owner(String owner) {
  ...
  **/
  ...
  public UniswapV3PositionSnapshotV3DTO pool(String pool) {
  ...
  **/
  ...
  public UniswapV3PositionSnapshotV3DTO position(String position) {
  ...
  **/
  ...
  public UniswapV3PositionSnapshotV3DTO timestamp(String timestamp) {
  ...
  **/
  ...
  public UniswapV3PositionSnapshotV3DTO liquidity(String liquidity) {
  ...
  **/
  ...
  public UniswapV3PositionSnapshotV3DTO depositedToken0(String depositedToken0) {
  ...
  **/
  ...
  public UniswapV3PositionSnapshotV3DTO depositedToken1(String depositedToken1) {
  ...
  **/
  ...
  public UniswapV3PositionSnapshotV3DTO withdrawnToken0(String withdrawnToken0) {
  ...
  **/
  ...
  public UniswapV3PositionSnapshotV3DTO withdrawnToken1(String withdrawnToken1) {
  ...
  **/
  ...
  public UniswapV3PositionSnapshotV3DTO collectedFeesToken0(String collectedFeesToken0) {
  ...
  **/
  ...
  public UniswapV3PositionSnapshotV3DTO collectedFeesToken1(String collectedFeesToken1) {
  ...
  **/
  ...
  public UniswapV3PositionSnapshotV3DTO transaction(String transaction) {
  ...
  **/
  ...
  public UniswapV3PositionSnapshotV3DTO feeGrowthInside0LastX128(String feeGrowthInside0LastX128) {
  ...
  **/
  ...
  public UniswapV3PositionSnapshotV3DTO feeGrowthInside1LastX128(String feeGrowthInside1LastX128) {
  ...
  **/
  ...
  public UniswapV3PositionSnapshotV3DTO vid(Long vid) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    UniswapV3PositionSnapshotV3DTO uniswapV3PositionSnapshotV3DTO = (UniswapV3PositionSnapshotV3DTO) o;
    return Objects.equals(this.entryTime, uniswapV3PositionSnapshotV3DTO.entryTime) &&
        Objects.equals(this.recvTime, uniswapV3PositionSnapshotV3DTO.recvTime) &&
        Objects.equals(this.blockNumber, uniswapV3PositionSnapshotV3DTO.blockNumber) &&
        Objects.equals(this.id, uniswapV3PositionSnapshotV3DTO.id) &&
        Objects.equals(this.owner, uniswapV3PositionSnapshotV3DTO.owner) &&
        Objects.equals(this.pool, uniswapV3PositionSnapshotV3DTO.pool) &&
        Objects.equals(this.position, uniswapV3PositionSnapshotV3DTO.position) &&
        Objects.equals(this.timestamp, uniswapV3PositionSnapshotV3DTO.timestamp) &&
        Objects.equals(this.liquidity, uniswapV3PositionSnapshotV3DTO.liquidity) &&
        Objects.equals(this.depositedToken0, uniswapV3PositionSnapshotV3DTO.depositedToken0) &&
        Objects.equals(this.depositedToken1, uniswapV3PositionSnapshotV3DTO.depositedToken1) &&
        Objects.equals(this.withdrawnToken0, uniswapV3PositionSnapshotV3DTO.withdrawnToken0) &&
        Objects.equals(this.withdrawnToken1, uniswapV3PositionSnapshotV3DTO.withdrawnToken1) &&
        Objects.equals(this.collectedFeesToken0, uniswapV3PositionSnapshotV3DTO.collectedFeesToken0) &&
        Objects.equals(this.collectedFeesToken1, uniswapV3PositionSnapshotV3DTO.collectedFeesToken1) &&
        Objects.equals(this.transaction, uniswapV3PositionSnapshotV3DTO.transaction) &&
        Objects.equals(this.feeGrowthInside0LastX128, uniswapV3PositionSnapshotV3DTO.feeGrowthInside0LastX128) &&
        Objects.equals(this.feeGrowthInside1LastX128, uniswapV3PositionSnapshotV3DTO.feeGrowthInside1LastX128) &&
        Objects.equals(this.vid, uniswapV3PositionSnapshotV3DTO.vid);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to UniswapV3PositionSnapshotV3DTO
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!UniswapV3PositionSnapshotV3DTO.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in UniswapV3PositionSnapshotV3DTO is not found in the empty JSON string", UniswapV3PositionSnapshotV3DTO.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!UniswapV3PositionSnapshotV3DTO.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `UniswapV3PositionSnapshotV3DTO` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UniswapV3PositionSnapshotV3DTO.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UniswapV3PositionSnapshotV3DTO' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UniswapV3PositionSnapshotV3DTO> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UniswapV3PositionSnapshotV3DTO.class));

       return (TypeAdapter<T>) new TypeAdapter<UniswapV3PositionSnapshotV3DTO>() {
           @Override
           public void write(JsonWriter out, UniswapV3PositionSnapshotV3DTO value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public UniswapV3PositionSnapshotV3DTO read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of UniswapV3PositionSnapshotV3DTO given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of UniswapV3PositionSnapshotV3DTO
  * @throws IOException if the JSON string is invalid with respect to UniswapV3PositionSnapshotV3DTO
  */
  public static UniswapV3PositionSnapshotV3DTO fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UniswapV3PositionSnapshotV3DTO.class);
  }

 /**
  * Convert an instance of UniswapV3PositionSnapshotV3DTO to an JSON string
  *
  * @return JSON string
  */
