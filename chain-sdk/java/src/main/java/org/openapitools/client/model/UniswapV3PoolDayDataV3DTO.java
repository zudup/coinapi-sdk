...
public class UniswapV3PoolDayDataV3DTO {
  ...
  public UniswapV3PoolDayDataV3DTO() {
  }

  public UniswapV3PoolDayDataV3DTO entryTime(OffsetDateTime entryTime) {
  ...
  **/
  ...
  public UniswapV3PoolDayDataV3DTO recvTime(OffsetDateTime recvTime) {
  ...
  **/
  ...
  public UniswapV3PoolDayDataV3DTO blockNumber(Long blockNumber) {
  ...
  **/
  ...
  public UniswapV3PoolDayDataV3DTO id(String id) {
  ...
  **/
  ...
  public UniswapV3PoolDayDataV3DTO date(Integer date) {
  ...
  **/
  ...
  public UniswapV3PoolDayDataV3DTO pool(String pool) {
  ...
  **/
  ...
  public UniswapV3PoolDayDataV3DTO liquidity(String liquidity) {
  ...
  **/
  ...
  public UniswapV3PoolDayDataV3DTO sqrtPrice(String sqrtPrice) {
  ...
  **/
  ...
  public UniswapV3PoolDayDataV3DTO token0Price(String token0Price) {
  ...
  **/
  ...
  public UniswapV3PoolDayDataV3DTO token1Price(String token1Price) {
  ...
  **/
  ...
  public UniswapV3PoolDayDataV3DTO tick(String tick) {
  ...
  **/
  ...
  public UniswapV3PoolDayDataV3DTO feeGrowthGlobal0x128(String feeGrowthGlobal0x128) {
  ...
  **/
  ...
  public UniswapV3PoolDayDataV3DTO feeGrowthGlobal1x128(String feeGrowthGlobal1x128) {
  ...
  **/
  ...
  public UniswapV3PoolDayDataV3DTO tvlUsd(String tvlUsd) {
  ...
  **/
  ...
  public UniswapV3PoolDayDataV3DTO volumeToken0(String volumeToken0) {
  ...
  **/
  ...
  public UniswapV3PoolDayDataV3DTO volumeToken1(String volumeToken1) {
  ...
  **/
  ...
  public UniswapV3PoolDayDataV3DTO volumeUsd(String volumeUsd) {
  ...
  **/
  ...
  public UniswapV3PoolDayDataV3DTO feesUsd(String feesUsd) {
  ...
  **/
  ...
  public UniswapV3PoolDayDataV3DTO txCount(String txCount) {
  ...
  **/
  ...
  public UniswapV3PoolDayDataV3DTO open(String open) {
  ...
  **/
  ...
  public UniswapV3PoolDayDataV3DTO high(String high) {
  ...
  **/
  ...
  public UniswapV3PoolDayDataV3DTO low(String low) {
  ...
  **/
  ...
  public UniswapV3PoolDayDataV3DTO close(String close) {
  ...
  **/
  ...
  public UniswapV3PoolDayDataV3DTO vid(Long vid) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    UniswapV3PoolDayDataV3DTO uniswapV3PoolDayDataV3DTO = (UniswapV3PoolDayDataV3DTO) o;
    return Objects.equals(this.entryTime, uniswapV3PoolDayDataV3DTO.entryTime) &&
        Objects.equals(this.recvTime, uniswapV3PoolDayDataV3DTO.recvTime) &&
        Objects.equals(this.blockNumber, uniswapV3PoolDayDataV3DTO.blockNumber) &&
        Objects.equals(this.id, uniswapV3PoolDayDataV3DTO.id) &&
        Objects.equals(this.date, uniswapV3PoolDayDataV3DTO.date) &&
        Objects.equals(this.pool, uniswapV3PoolDayDataV3DTO.pool) &&
        Objects.equals(this.liquidity, uniswapV3PoolDayDataV3DTO.liquidity) &&
        Objects.equals(this.sqrtPrice, uniswapV3PoolDayDataV3DTO.sqrtPrice) &&
        Objects.equals(this.token0Price, uniswapV3PoolDayDataV3DTO.token0Price) &&
        Objects.equals(this.token1Price, uniswapV3PoolDayDataV3DTO.token1Price) &&
        Objects.equals(this.tick, uniswapV3PoolDayDataV3DTO.tick) &&
        Objects.equals(this.feeGrowthGlobal0x128, uniswapV3PoolDayDataV3DTO.feeGrowthGlobal0x128) &&
        Objects.equals(this.feeGrowthGlobal1x128, uniswapV3PoolDayDataV3DTO.feeGrowthGlobal1x128) &&
        Objects.equals(this.tvlUsd, uniswapV3PoolDayDataV3DTO.tvlUsd) &&
        Objects.equals(this.volumeToken0, uniswapV3PoolDayDataV3DTO.volumeToken0) &&
        Objects.equals(this.volumeToken1, uniswapV3PoolDayDataV3DTO.volumeToken1) &&
        Objects.equals(this.volumeUsd, uniswapV3PoolDayDataV3DTO.volumeUsd) &&
        Objects.equals(this.feesUsd, uniswapV3PoolDayDataV3DTO.feesUsd) &&
        Objects.equals(this.txCount, uniswapV3PoolDayDataV3DTO.txCount) &&
        Objects.equals(this.open, uniswapV3PoolDayDataV3DTO.open) &&
        Objects.equals(this.high, uniswapV3PoolDayDataV3DTO.high) &&
        Objects.equals(this.low, uniswapV3PoolDayDataV3DTO.low) &&
        Objects.equals(this.close, uniswapV3PoolDayDataV3DTO.close) &&
        Objects.equals(this.vid, uniswapV3PoolDayDataV3DTO.vid);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to UniswapV3PoolDayDataV3DTO
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!UniswapV3PoolDayDataV3DTO.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in UniswapV3PoolDayDataV3DTO is not found in the empty JSON string", UniswapV3PoolDayDataV3DTO.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!UniswapV3PoolDayDataV3DTO.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `UniswapV3PoolDayDataV3DTO` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UniswapV3PoolDayDataV3DTO.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UniswapV3PoolDayDataV3DTO' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UniswapV3PoolDayDataV3DTO> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UniswapV3PoolDayDataV3DTO.class));

       return (TypeAdapter<T>) new TypeAdapter<UniswapV3PoolDayDataV3DTO>() {
           @Override
           public void write(JsonWriter out, UniswapV3PoolDayDataV3DTO value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public UniswapV3PoolDayDataV3DTO read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of UniswapV3PoolDayDataV3DTO given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of UniswapV3PoolDayDataV3DTO
  * @throws IOException if the JSON string is invalid with respect to UniswapV3PoolDayDataV3DTO
  */
  public static UniswapV3PoolDayDataV3DTO fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UniswapV3PoolDayDataV3DTO.class);
  }

 /**
  * Convert an instance of UniswapV3PoolDayDataV3DTO to an JSON string
  *
  * @return JSON string
  */
