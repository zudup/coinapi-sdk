...
public class UniswapV2TokenDayDataV2DTO {
  ...
  public UniswapV2TokenDayDataV2DTO() {
  }

  public UniswapV2TokenDayDataV2DTO entryTime(OffsetDateTime entryTime) {
  ...
  **/
  ...
  public UniswapV2TokenDayDataV2DTO recvTime(OffsetDateTime recvTime) {
  ...
  **/
  ...
  public UniswapV2TokenDayDataV2DTO blockNumber(Long blockNumber) {
  ...
  **/
  ...
  public UniswapV2TokenDayDataV2DTO id(String id) {
  ...
  **/
  ...
  public UniswapV2TokenDayDataV2DTO date(Integer date) {
  ...
  **/
  ...
  public UniswapV2TokenDayDataV2DTO token(String token) {
  ...
  **/
  ...
  public UniswapV2TokenDayDataV2DTO dailyVolumeToken(String dailyVolumeToken) {
  ...
  **/
  ...
  public UniswapV2TokenDayDataV2DTO dailyVolumeEth(String dailyVolumeEth) {
  ...
  **/
  ...
  public UniswapV2TokenDayDataV2DTO dailyVolumeUsd(String dailyVolumeUsd) {
  ...
  **/
  ...
  public UniswapV2TokenDayDataV2DTO dailyTxns(String dailyTxns) {
  ...
  **/
  ...
  public UniswapV2TokenDayDataV2DTO totalLiquidityToken(String totalLiquidityToken) {
  ...
  **/
  ...
  public UniswapV2TokenDayDataV2DTO totalLiquidityEth(String totalLiquidityEth) {
  ...
  **/
  ...
  public UniswapV2TokenDayDataV2DTO totalLiquidityUsd(String totalLiquidityUsd) {
  ...
  **/
  ...
  public UniswapV2TokenDayDataV2DTO priceUsd(String priceUsd) {
  ...
  **/
  ...
  public UniswapV2TokenDayDataV2DTO vid(Long vid) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    UniswapV2TokenDayDataV2DTO uniswapV2TokenDayDataV2DTO = (UniswapV2TokenDayDataV2DTO) o;
    return Objects.equals(this.entryTime, uniswapV2TokenDayDataV2DTO.entryTime) &&
        Objects.equals(this.recvTime, uniswapV2TokenDayDataV2DTO.recvTime) &&
        Objects.equals(this.blockNumber, uniswapV2TokenDayDataV2DTO.blockNumber) &&
        Objects.equals(this.id, uniswapV2TokenDayDataV2DTO.id) &&
        Objects.equals(this.date, uniswapV2TokenDayDataV2DTO.date) &&
        Objects.equals(this.token, uniswapV2TokenDayDataV2DTO.token) &&
        Objects.equals(this.dailyVolumeToken, uniswapV2TokenDayDataV2DTO.dailyVolumeToken) &&
        Objects.equals(this.dailyVolumeEth, uniswapV2TokenDayDataV2DTO.dailyVolumeEth) &&
        Objects.equals(this.dailyVolumeUsd, uniswapV2TokenDayDataV2DTO.dailyVolumeUsd) &&
        Objects.equals(this.dailyTxns, uniswapV2TokenDayDataV2DTO.dailyTxns) &&
        Objects.equals(this.totalLiquidityToken, uniswapV2TokenDayDataV2DTO.totalLiquidityToken) &&
        Objects.equals(this.totalLiquidityEth, uniswapV2TokenDayDataV2DTO.totalLiquidityEth) &&
        Objects.equals(this.totalLiquidityUsd, uniswapV2TokenDayDataV2DTO.totalLiquidityUsd) &&
        Objects.equals(this.priceUsd, uniswapV2TokenDayDataV2DTO.priceUsd) &&
        Objects.equals(this.vid, uniswapV2TokenDayDataV2DTO.vid);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to UniswapV2TokenDayDataV2DTO
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!UniswapV2TokenDayDataV2DTO.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in UniswapV2TokenDayDataV2DTO is not found in the empty JSON string", UniswapV2TokenDayDataV2DTO.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!UniswapV2TokenDayDataV2DTO.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `UniswapV2TokenDayDataV2DTO` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UniswapV2TokenDayDataV2DTO.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UniswapV2TokenDayDataV2DTO' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UniswapV2TokenDayDataV2DTO> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UniswapV2TokenDayDataV2DTO.class));

       return (TypeAdapter<T>) new TypeAdapter<UniswapV2TokenDayDataV2DTO>() {
           @Override
           public void write(JsonWriter out, UniswapV2TokenDayDataV2DTO value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public UniswapV2TokenDayDataV2DTO read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of UniswapV2TokenDayDataV2DTO given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of UniswapV2TokenDayDataV2DTO
  * @throws IOException if the JSON string is invalid with respect to UniswapV2TokenDayDataV2DTO
  */
  public static UniswapV2TokenDayDataV2DTO fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UniswapV2TokenDayDataV2DTO.class);
  }

 /**
  * Convert an instance of UniswapV2TokenDayDataV2DTO to an JSON string
  *
  * @return JSON string
  */
