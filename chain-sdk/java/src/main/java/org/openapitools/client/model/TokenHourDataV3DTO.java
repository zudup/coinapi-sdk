...
public class TokenHourDataV3DTO {
  ...
  public TokenHourDataV3DTO() {
  }

  public TokenHourDataV3DTO entryTime(OffsetDateTime entryTime) {
  ...
  **/
  ...
  public TokenHourDataV3DTO recvTime(OffsetDateTime recvTime) {
  ...
  **/
  ...
  public TokenHourDataV3DTO blockNumber(Long blockNumber) {
  ...
  **/
  ...
  public TokenHourDataV3DTO id(String id) {
  ...
  **/
  ...
  public TokenHourDataV3DTO periodStartUnix(Integer periodStartUnix) {
  ...
  **/
  ...
  public TokenHourDataV3DTO token(String token) {
  ...
  **/
  ...
  public TokenHourDataV3DTO volume(String volume) {
  ...
  **/
  ...
  public TokenHourDataV3DTO volumeUsd(String volumeUsd) {
  ...
  **/
  ...
  public TokenHourDataV3DTO untrackedVolumeUsd(String untrackedVolumeUsd) {
  ...
  **/
  ...
  public TokenHourDataV3DTO totalValueLocked(String totalValueLocked) {
  ...
  **/
  ...
  public TokenHourDataV3DTO totalValueLockedUsd(String totalValueLockedUsd) {
  ...
  **/
  ...
  public TokenHourDataV3DTO priceUsd(String priceUsd) {
  ...
  **/
  ...
  public TokenHourDataV3DTO feesUsd(String feesUsd) {
  ...
  **/
  ...
  public TokenHourDataV3DTO open(String open) {
  ...
  **/
  ...
  public TokenHourDataV3DTO high(String high) {
  ...
  **/
  ...
  public TokenHourDataV3DTO low(String low) {
  ...
  **/
  ...
  public TokenHourDataV3DTO close(String close) {
  ...
  **/
  ...
  public TokenHourDataV3DTO vid(Long vid) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.entryTime, tokenHourDataV3DTO.entryTime) &&
        Objects.equals(this.recvTime, tokenHourDataV3DTO.recvTime) &&
        Objects.equals(this.blockNumber, tokenHourDataV3DTO.blockNumber) &&
        Objects.equals(this.id, tokenHourDataV3DTO.id) &&
        Objects.equals(this.periodStartUnix, tokenHourDataV3DTO.periodStartUnix) &&
        Objects.equals(this.token, tokenHourDataV3DTO.token) &&
        Objects.equals(this.volume, tokenHourDataV3DTO.volume) &&
        Objects.equals(this.volumeUsd, tokenHourDataV3DTO.volumeUsd) &&
        Objects.equals(this.untrackedVolumeUsd, tokenHourDataV3DTO.untrackedVolumeUsd) &&
        Objects.equals(this.totalValueLocked, tokenHourDataV3DTO.totalValueLocked) &&
        Objects.equals(this.totalValueLockedUsd, tokenHourDataV3DTO.totalValueLockedUsd) &&
        Objects.equals(this.priceUsd, tokenHourDataV3DTO.priceUsd) &&
        Objects.equals(this.feesUsd, tokenHourDataV3DTO.feesUsd) &&
        Objects.equals(this.open, tokenHourDataV3DTO.open) &&
        Objects.equals(this.high, tokenHourDataV3DTO.high) &&
        Objects.equals(this.low, tokenHourDataV3DTO.low) &&
        Objects.equals(this.close, tokenHourDataV3DTO.close) &&
        Objects.equals(this.vid, tokenHourDataV3DTO.vid);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to TokenHourDataV3DTO
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!TokenHourDataV3DTO.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in TokenHourDataV3DTO is not found in the empty JSON string", TokenHourDataV3DTO.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!TokenHourDataV3DTO.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `TokenHourDataV3DTO` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!TokenHourDataV3DTO.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'TokenHourDataV3DTO' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<TokenHourDataV3DTO> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(TokenHourDataV3DTO.class));

       return (TypeAdapter<T>) new TypeAdapter<TokenHourDataV3DTO>() {
           @Override
           public void write(JsonWriter out, TokenHourDataV3DTO value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public TokenHourDataV3DTO read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of TokenHourDataV3DTO given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of TokenHourDataV3DTO
  * @throws IOException if the JSON string is invalid with respect to TokenHourDataV3DTO
  */
  public static TokenHourDataV3DTO fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, TokenHourDataV3DTO.class);
  }

 /**
  * Convert an instance of TokenHourDataV3DTO to an JSON string
  *
  * @return JSON string
  */
