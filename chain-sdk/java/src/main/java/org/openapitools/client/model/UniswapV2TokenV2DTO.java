...
public class UniswapV2TokenV2DTO {
  ...
  public UniswapV2TokenV2DTO entryTime(OffsetDateTime entryTime) {
  ...
  **/
  ...
  public UniswapV2TokenV2DTO recvTime(OffsetDateTime recvTime) {
  ...
  **/
  ...
  public UniswapV2TokenV2DTO blockNumber(Long blockNumber) {
  ...
  **/
  ...
  public UniswapV2TokenV2DTO vid(Long vid) {
  ...
  **/
  ...
  public UniswapV2TokenV2DTO id(String id) {
  ...
  **/
  ...
  public UniswapV2TokenV2DTO symbol(String symbol) {
  ...
  **/
  ...
  public UniswapV2TokenV2DTO name(String name) {
  ...
  **/
  ...
  public UniswapV2TokenV2DTO decimals(Integer decimals) {
  ...
  **/
  ...
  public UniswapV2TokenV2DTO totalSupply(NumericsBigInteger totalSupply) {
  ...
  **/
  ...
  public UniswapV2TokenV2DTO tradeVolume(String tradeVolume) {
  ...
  **/
  ...
  public UniswapV2TokenV2DTO tradeVolumeUsd(String tradeVolumeUsd) {
  ...
  **/
  ...
  public UniswapV2TokenV2DTO untrackedVolumeUsd(String untrackedVolumeUsd) {
  ...
  **/
  ...
  public UniswapV2TokenV2DTO txCount(NumericsBigInteger txCount) {
  ...
  **/
  ...
  public UniswapV2TokenV2DTO totalLiquidity(String totalLiquidity) {
  ...
  **/
  ...
  public UniswapV2TokenV2DTO derivedEth(String derivedEth) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    UniswapV2TokenV2DTO uniswapV2TokenV2DTO = (UniswapV2TokenV2DTO) o;
    return Objects.equals(this.entryTime, uniswapV2TokenV2DTO.entryTime) &&
        Objects.equals(this.recvTime, uniswapV2TokenV2DTO.recvTime) &&
        Objects.equals(this.blockNumber, uniswapV2TokenV2DTO.blockNumber) &&
        Objects.equals(this.vid, uniswapV2TokenV2DTO.vid) &&
        Objects.equals(this.id, uniswapV2TokenV2DTO.id) &&
        Objects.equals(this.symbol, uniswapV2TokenV2DTO.symbol) &&
        Objects.equals(this.name, uniswapV2TokenV2DTO.name) &&
        Objects.equals(this.decimals, uniswapV2TokenV2DTO.decimals) &&
        Objects.equals(this.totalSupply, uniswapV2TokenV2DTO.totalSupply) &&
        Objects.equals(this.tradeVolume, uniswapV2TokenV2DTO.tradeVolume) &&
        Objects.equals(this.tradeVolumeUsd, uniswapV2TokenV2DTO.tradeVolumeUsd) &&
        Objects.equals(this.untrackedVolumeUsd, uniswapV2TokenV2DTO.untrackedVolumeUsd) &&
        Objects.equals(this.txCount, uniswapV2TokenV2DTO.txCount) &&
        Objects.equals(this.totalLiquidity, uniswapV2TokenV2DTO.totalLiquidity) &&
        Objects.equals(this.derivedEth, uniswapV2TokenV2DTO.derivedEth) &&
        Objects.equals(this.tokenSymbol, uniswapV2TokenV2DTO.tokenSymbol);
  }
  ...
  public String toString() {
    ...
    sb.append("class UniswapV2TokenV2DTO {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to UniswapV2TokenV2DTO
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!UniswapV2TokenV2DTO.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in UniswapV2TokenV2DTO is not found in the empty JSON string", UniswapV2TokenV2DTO.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!UniswapV2TokenV2DTO.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `UniswapV2TokenV2DTO` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UniswapV2TokenV2DTO.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UniswapV2TokenV2DTO' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UniswapV2TokenV2DTO> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UniswapV2TokenV2DTO.class));

       return (TypeAdapter<T>) new TypeAdapter<UniswapV2TokenV2DTO>() {
           @Override
           public void write(JsonWriter out, UniswapV2TokenV2DTO value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public UniswapV2TokenV2DTO read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of UniswapV2TokenV2DTO given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of UniswapV2TokenV2DTO
  * @throws IOException if the JSON string is invalid with respect to UniswapV2TokenV2DTO
  */
  public static UniswapV2TokenV2DTO fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UniswapV2TokenV2DTO.class);
  }

 /**
  * Convert an instance of UniswapV2TokenV2DTO to an JSON string
  *
  * @return JSON string
  */
