...
public class UniswapV3PositionV3DTO {
  ...
  public UniswapV3PositionV3DTO() {
  }

  public UniswapV3PositionV3DTO entryTime(OffsetDateTime entryTime) {
  ...
  **/
  ...
  public UniswapV3PositionV3DTO recvTime(OffsetDateTime recvTime) {
  ...
  **/
  ...
  public UniswapV3PositionV3DTO blockNumber(Long blockNumber) {
  ...
  **/
  ...
  public UniswapV3PositionV3DTO id(String id) {
  ...
  **/
  ...
  public UniswapV3PositionV3DTO owner(String owner) {
  ...
  **/
  ...
  public UniswapV3PositionV3DTO pool(String pool) {
  ...
  **/
  ...
  public UniswapV3PositionV3DTO token0(String token0) {
  ...
  **/
  ...
  public UniswapV3PositionV3DTO token1(String token1) {
  ...
  **/
  ...
  public UniswapV3PositionV3DTO tickLower(String tickLower) {
  ...
  **/
  ...
  public UniswapV3PositionV3DTO tickUpper(String tickUpper) {
  ...
  **/
  ...
  public UniswapV3PositionV3DTO liquidity(String liquidity) {
  ...
  **/
  ...
  public UniswapV3PositionV3DTO depositedToken0(String depositedToken0) {
  ...
  **/
  ...
  public UniswapV3PositionV3DTO depositedToken1(String depositedToken1) {
  ...
  **/
  ...
  public UniswapV3PositionV3DTO withdrawnToken0(String withdrawnToken0) {
  ...
  **/
  ...
  public UniswapV3PositionV3DTO withdrawnToken1(String withdrawnToken1) {
  ...
  **/
  ...
  public UniswapV3PositionV3DTO collectedFeesToken0(String collectedFeesToken0) {
  ...
  **/
  ...
  public UniswapV3PositionV3DTO collectedFeesToken1(String collectedFeesToken1) {
  ...
  **/
  ...
  public UniswapV3PositionV3DTO transaction(String transaction) {
  ...
  **/
  ...
  public UniswapV3PositionV3DTO feeGrowthInside0LastX128(String feeGrowthInside0LastX128) {
  ...
  **/
  ...
  public UniswapV3PositionV3DTO feeGrowthInside1LastX128(String feeGrowthInside1LastX128) {
  ...
  **/
  ...
  public UniswapV3PositionV3DTO vid(Long vid) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.entryTime, uniswapV3PositionV3DTO.entryTime) &&
        Objects.equals(this.recvTime, uniswapV3PositionV3DTO.recvTime) &&
        Objects.equals(this.blockNumber, uniswapV3PositionV3DTO.blockNumber) &&
        Objects.equals(this.id, uniswapV3PositionV3DTO.id) &&
        Objects.equals(this.owner, uniswapV3PositionV3DTO.owner) &&
        Objects.equals(this.pool, uniswapV3PositionV3DTO.pool) &&
        Objects.equals(this.token0, uniswapV3PositionV3DTO.token0) &&
        Objects.equals(this.token1, uniswapV3PositionV3DTO.token1) &&
        Objects.equals(this.tickLower, uniswapV3PositionV3DTO.tickLower) &&
        Objects.equals(this.tickUpper, uniswapV3PositionV3DTO.tickUpper) &&
        Objects.equals(this.liquidity, uniswapV3PositionV3DTO.liquidity) &&
        Objects.equals(this.depositedToken0, uniswapV3PositionV3DTO.depositedToken0) &&
        Objects.equals(this.depositedToken1, uniswapV3PositionV3DTO.depositedToken1) &&
        Objects.equals(this.withdrawnToken0, uniswapV3PositionV3DTO.withdrawnToken0) &&
        Objects.equals(this.withdrawnToken1, uniswapV3PositionV3DTO.withdrawnToken1) &&
        Objects.equals(this.collectedFeesToken0, uniswapV3PositionV3DTO.collectedFeesToken0) &&
        Objects.equals(this.collectedFeesToken1, uniswapV3PositionV3DTO.collectedFeesToken1) &&
        Objects.equals(this.transaction, uniswapV3PositionV3DTO.transaction) &&
        Objects.equals(this.feeGrowthInside0LastX128, uniswapV3PositionV3DTO.feeGrowthInside0LastX128) &&
        Objects.equals(this.feeGrowthInside1LastX128, uniswapV3PositionV3DTO.feeGrowthInside1LastX128) &&
        Objects.equals(this.vid, uniswapV3PositionV3DTO.vid);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to UniswapV3PositionV3DTO
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!UniswapV3PositionV3DTO.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in UniswapV3PositionV3DTO is not found in the empty JSON string", UniswapV3PositionV3DTO.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!UniswapV3PositionV3DTO.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `UniswapV3PositionV3DTO` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UniswapV3PositionV3DTO.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UniswapV3PositionV3DTO' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UniswapV3PositionV3DTO> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UniswapV3PositionV3DTO.class));

       return (TypeAdapter<T>) new TypeAdapter<UniswapV3PositionV3DTO>() {
           @Override
           public void write(JsonWriter out, UniswapV3PositionV3DTO value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public UniswapV3PositionV3DTO read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of UniswapV3PositionV3DTO given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of UniswapV3PositionV3DTO
  * @throws IOException if the JSON string is invalid with respect to UniswapV3PositionV3DTO
  */
  public static UniswapV3PositionV3DTO fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UniswapV3PositionV3DTO.class);
  }

 /**
  * Convert an instance of UniswapV3PositionV3DTO to an JSON string
  *
  * @return JSON string
  */
