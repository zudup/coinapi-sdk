...
public class UniswapV2UniswapFactoryV2DTO {
  ...
  public UniswapV2UniswapFactoryV2DTO entryTime(OffsetDateTime entryTime) {
  ...
  **/
  ...
  public UniswapV2UniswapFactoryV2DTO recvTime(OffsetDateTime recvTime) {
  ...
  **/
  ...
  public UniswapV2UniswapFactoryV2DTO blockNumber(Long blockNumber) {
  ...
  **/
  ...
  public UniswapV2UniswapFactoryV2DTO id(String id) {
  ...
  **/
  ...
  public UniswapV2UniswapFactoryV2DTO pairCount(Integer pairCount) {
  ...
  **/
  ...
  public UniswapV2UniswapFactoryV2DTO totalVolumeUsd(String totalVolumeUsd) {
  ...
  **/
  ...
  public UniswapV2UniswapFactoryV2DTO totalVolumeEth(String totalVolumeEth) {
  ...
  **/
  ...
  public UniswapV2UniswapFactoryV2DTO untrackedVolumeUsd(String untrackedVolumeUsd) {
  ...
  **/
  ...
  public UniswapV2UniswapFactoryV2DTO totalLiquidityUsd(String totalLiquidityUsd) {
  ...
  **/
  ...
  public UniswapV2UniswapFactoryV2DTO totalLiquidityEth(String totalLiquidityEth) {
  ...
  **/
  ...
  public UniswapV2UniswapFactoryV2DTO txCount(String txCount) {
  ...
  **/
  ...
  public UniswapV2UniswapFactoryV2DTO vid(Long vid) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.entryTime, uniswapV2UniswapFactoryV2DTO.entryTime) &&
        Objects.equals(this.recvTime, uniswapV2UniswapFactoryV2DTO.recvTime) &&
        Objects.equals(this.blockNumber, uniswapV2UniswapFactoryV2DTO.blockNumber) &&
        Objects.equals(this.id, uniswapV2UniswapFactoryV2DTO.id) &&
        Objects.equals(this.pairCount, uniswapV2UniswapFactoryV2DTO.pairCount) &&
        Objects.equals(this.totalVolumeUsd, uniswapV2UniswapFactoryV2DTO.totalVolumeUsd) &&
        Objects.equals(this.totalVolumeEth, uniswapV2UniswapFactoryV2DTO.totalVolumeEth) &&
        Objects.equals(this.untrackedVolumeUsd, uniswapV2UniswapFactoryV2DTO.untrackedVolumeUsd) &&
        Objects.equals(this.totalLiquidityUsd, uniswapV2UniswapFactoryV2DTO.totalLiquidityUsd) &&
        Objects.equals(this.totalLiquidityEth, uniswapV2UniswapFactoryV2DTO.totalLiquidityEth) &&
        Objects.equals(this.txCount, uniswapV2UniswapFactoryV2DTO.txCount) &&
        Objects.equals(this.vid, uniswapV2UniswapFactoryV2DTO.vid);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to UniswapV2UniswapFactoryV2DTO
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!UniswapV2UniswapFactoryV2DTO.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in UniswapV2UniswapFactoryV2DTO is not found in the empty JSON string", UniswapV2UniswapFactoryV2DTO.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!UniswapV2UniswapFactoryV2DTO.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `UniswapV2UniswapFactoryV2DTO` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UniswapV2UniswapFactoryV2DTO.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UniswapV2UniswapFactoryV2DTO' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UniswapV2UniswapFactoryV2DTO> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UniswapV2UniswapFactoryV2DTO.class));

       return (TypeAdapter<T>) new TypeAdapter<UniswapV2UniswapFactoryV2DTO>() {
           @Override
           public void write(JsonWriter out, UniswapV2UniswapFactoryV2DTO value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public UniswapV2UniswapFactoryV2DTO read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of UniswapV2UniswapFactoryV2DTO given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of UniswapV2UniswapFactoryV2DTO
  * @throws IOException if the JSON string is invalid with respect to UniswapV2UniswapFactoryV2DTO
  */
  public static UniswapV2UniswapFactoryV2DTO fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UniswapV2UniswapFactoryV2DTO.class);
  }

 /**
  * Convert an instance of UniswapV2UniswapFactoryV2DTO to an JSON string
  *
  * @return JSON string
  */
