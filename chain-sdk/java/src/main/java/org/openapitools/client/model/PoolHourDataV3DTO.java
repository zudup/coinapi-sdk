...
public class PoolHourDataV3DTO {
  ...
  public PoolHourDataV3DTO() {
  }

  public PoolHourDataV3DTO entryTime(OffsetDateTime entryTime) {
  ...
  **/
  ...
  public PoolHourDataV3DTO recvTime(OffsetDateTime recvTime) {
  ...
  **/
  ...
  public PoolHourDataV3DTO blockNumber(Long blockNumber) {
  ...
  **/
  ...
  public PoolHourDataV3DTO id(String id) {
  ...
  **/
  ...
  public PoolHourDataV3DTO periodStartUnix(Integer periodStartUnix) {
  ...
  **/
  ...
  public PoolHourDataV3DTO pool(String pool) {
  ...
  **/
  ...
  public PoolHourDataV3DTO liquidity(String liquidity) {
  ...
  **/
  ...
  public PoolHourDataV3DTO sqrtPrice(String sqrtPrice) {
  ...
  **/
  ...
  public PoolHourDataV3DTO token0Price(String token0Price) {
  ...
  **/
  ...
  public PoolHourDataV3DTO token1Price(String token1Price) {
  ...
  **/
  ...
  public PoolHourDataV3DTO tick(String tick) {
  ...
  **/
  ...
  public PoolHourDataV3DTO feeGrowthGlobal0x128(String feeGrowthGlobal0x128) {
  ...
  **/
  ...
  public PoolHourDataV3DTO feeGrowthGlobal1x128(String feeGrowthGlobal1x128) {
  ...
  **/
  ...
  public PoolHourDataV3DTO tvlUsd(String tvlUsd) {
  ...
  **/
  ...
  public PoolHourDataV3DTO volumeToken0(String volumeToken0) {
  ...
  **/
  ...
  public PoolHourDataV3DTO volumeToken1(String volumeToken1) {
  ...
  **/
  ...
  public PoolHourDataV3DTO volumeUsd(String volumeUsd) {
  ...
  **/
  ...
  public PoolHourDataV3DTO feesUsd(String feesUsd) {
  ...
  **/
  ...
  public PoolHourDataV3DTO txCount(String txCount) {
  ...
  **/
  ...
  public PoolHourDataV3DTO open(String open) {
  ...
  **/
  ...
  public PoolHourDataV3DTO high(String high) {
  ...
  **/
  ...
  public PoolHourDataV3DTO low(String low) {
  ...
  **/
  ...
  public PoolHourDataV3DTO close(String close) {
  ...
  **/
  ...
  public PoolHourDataV3DTO vid(Long vid) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.entryTime, poolHourDataV3DTO.entryTime) &&
        Objects.equals(this.recvTime, poolHourDataV3DTO.recvTime) &&
        Objects.equals(this.blockNumber, poolHourDataV3DTO.blockNumber) &&
        Objects.equals(this.id, poolHourDataV3DTO.id) &&
        Objects.equals(this.periodStartUnix, poolHourDataV3DTO.periodStartUnix) &&
        Objects.equals(this.pool, poolHourDataV3DTO.pool) &&
        Objects.equals(this.liquidity, poolHourDataV3DTO.liquidity) &&
        Objects.equals(this.sqrtPrice, poolHourDataV3DTO.sqrtPrice) &&
        Objects.equals(this.token0Price, poolHourDataV3DTO.token0Price) &&
        Objects.equals(this.token1Price, poolHourDataV3DTO.token1Price) &&
        Objects.equals(this.tick, poolHourDataV3DTO.tick) &&
        Objects.equals(this.feeGrowthGlobal0x128, poolHourDataV3DTO.feeGrowthGlobal0x128) &&
        Objects.equals(this.feeGrowthGlobal1x128, poolHourDataV3DTO.feeGrowthGlobal1x128) &&
        Objects.equals(this.tvlUsd, poolHourDataV3DTO.tvlUsd) &&
        Objects.equals(this.volumeToken0, poolHourDataV3DTO.volumeToken0) &&
        Objects.equals(this.volumeToken1, poolHourDataV3DTO.volumeToken1) &&
        Objects.equals(this.volumeUsd, poolHourDataV3DTO.volumeUsd) &&
        Objects.equals(this.feesUsd, poolHourDataV3DTO.feesUsd) &&
        Objects.equals(this.txCount, poolHourDataV3DTO.txCount) &&
        Objects.equals(this.open, poolHourDataV3DTO.open) &&
        Objects.equals(this.high, poolHourDataV3DTO.high) &&
        Objects.equals(this.low, poolHourDataV3DTO.low) &&
        Objects.equals(this.close, poolHourDataV3DTO.close) &&
        Objects.equals(this.vid, poolHourDataV3DTO.vid);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to PoolHourDataV3DTO
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!PoolHourDataV3DTO.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PoolHourDataV3DTO is not found in the empty JSON string", PoolHourDataV3DTO.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!PoolHourDataV3DTO.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `PoolHourDataV3DTO` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PoolHourDataV3DTO.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PoolHourDataV3DTO' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PoolHourDataV3DTO> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PoolHourDataV3DTO.class));

       return (TypeAdapter<T>) new TypeAdapter<PoolHourDataV3DTO>() {
           @Override
           public void write(JsonWriter out, PoolHourDataV3DTO value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public PoolHourDataV3DTO read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of PoolHourDataV3DTO given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of PoolHourDataV3DTO
  * @throws IOException if the JSON string is invalid with respect to PoolHourDataV3DTO
  */
  public static PoolHourDataV3DTO fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PoolHourDataV3DTO.class);
  }

 /**
  * Convert an instance of PoolHourDataV3DTO to an JSON string
  *
  * @return JSON string
  */
