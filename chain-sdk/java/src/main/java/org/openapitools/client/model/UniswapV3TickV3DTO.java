...
public class UniswapV3TickV3DTO {
  ...
  public UniswapV3TickV3DTO() {
  }

  public UniswapV3TickV3DTO entryTime(OffsetDateTime entryTime) {
  ...
  **/
  ...
  public UniswapV3TickV3DTO recvTime(OffsetDateTime recvTime) {
  ...
  **/
  ...
  public UniswapV3TickV3DTO blockNumber(Long blockNumber) {
  ...
  **/
  ...
  public UniswapV3TickV3DTO vid(Long vid) {
  ...
  **/
  ...
  public UniswapV3TickV3DTO id(String id) {
  ...
  **/
  ...
  public UniswapV3TickV3DTO poolAddress(String poolAddress) {
  ...
  **/
  ...
  public UniswapV3TickV3DTO tickIdx(NumericsBigInteger tickIdx) {
  ...
  **/
  ...
  public UniswapV3TickV3DTO pool(String pool) {
  ...
  **/
  ...
  public UniswapV3TickV3DTO liquidityGross(NumericsBigInteger liquidityGross) {
  ...
  **/
  ...
  public UniswapV3TickV3DTO liquidityNet(NumericsBigInteger liquidityNet) {
  ...
  **/
  ...
  public UniswapV3TickV3DTO price0(String price0) {
  ...
  **/
  ...
  public UniswapV3TickV3DTO price1(String price1) {
  ...
  **/
  ...
  public UniswapV3TickV3DTO volumeToken0(String volumeToken0) {
  ...
  **/
  ...
  public UniswapV3TickV3DTO volumeToken1(String volumeToken1) {
  ...
  **/
  ...
  public UniswapV3TickV3DTO volumeUsd(String volumeUsd) {
  ...
  **/
  ...
  public UniswapV3TickV3DTO untrackedVolumeUsd(String untrackedVolumeUsd) {
  ...
  **/
  ...
  public UniswapV3TickV3DTO feesUsd(String feesUsd) {
  ...
  **/
  ...
  public UniswapV3TickV3DTO collectedFeesToken0(String collectedFeesToken0) {
  ...
  **/
  ...
  public UniswapV3TickV3DTO collectedFeesToken1(String collectedFeesToken1) {
  ...
  **/
  ...
  public UniswapV3TickV3DTO collectedFeesUsd(String collectedFeesUsd) {
  ...
  **/
  ...
  public UniswapV3TickV3DTO createdAtTimestamp(OffsetDateTime createdAtTimestamp) {
  ...
  **/
  ...
  public UniswapV3TickV3DTO liquidityProviderCount(NumericsBigInteger liquidityProviderCount) {
  ...
  **/
  ...
  public UniswapV3TickV3DTO feeGrowthOutside0x128(NumericsBigInteger feeGrowthOutside0x128) {
  ...
  **/
  ...
  public UniswapV3TickV3DTO feeGrowthOutside1x128(NumericsBigInteger feeGrowthOutside1x128) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    UniswapV3TickV3DTO uniswapV3TickV3DTO = (UniswapV3TickV3DTO) o;
    return Objects.equals(this.entryTime, uniswapV3TickV3DTO.entryTime) &&
        Objects.equals(this.recvTime, uniswapV3TickV3DTO.recvTime) &&
        Objects.equals(this.blockNumber, uniswapV3TickV3DTO.blockNumber) &&
        Objects.equals(this.vid, uniswapV3TickV3DTO.vid) &&
        Objects.equals(this.id, uniswapV3TickV3DTO.id) &&
        Objects.equals(this.poolAddress, uniswapV3TickV3DTO.poolAddress) &&
        Objects.equals(this.tickIdx, uniswapV3TickV3DTO.tickIdx) &&
        Objects.equals(this.pool, uniswapV3TickV3DTO.pool) &&
        Objects.equals(this.liquidityGross, uniswapV3TickV3DTO.liquidityGross) &&
        Objects.equals(this.liquidityNet, uniswapV3TickV3DTO.liquidityNet) &&
        Objects.equals(this.price0, uniswapV3TickV3DTO.price0) &&
        Objects.equals(this.price1, uniswapV3TickV3DTO.price1) &&
        Objects.equals(this.volumeToken0, uniswapV3TickV3DTO.volumeToken0) &&
        Objects.equals(this.volumeToken1, uniswapV3TickV3DTO.volumeToken1) &&
        Objects.equals(this.volumeUsd, uniswapV3TickV3DTO.volumeUsd) &&
        Objects.equals(this.untrackedVolumeUsd, uniswapV3TickV3DTO.untrackedVolumeUsd) &&
        Objects.equals(this.feesUsd, uniswapV3TickV3DTO.feesUsd) &&
        Objects.equals(this.collectedFeesToken0, uniswapV3TickV3DTO.collectedFeesToken0) &&
        Objects.equals(this.collectedFeesToken1, uniswapV3TickV3DTO.collectedFeesToken1) &&
        Objects.equals(this.collectedFeesUsd, uniswapV3TickV3DTO.collectedFeesUsd) &&
        Objects.equals(this.createdAtTimestamp, uniswapV3TickV3DTO.createdAtTimestamp) &&
        Objects.equals(this.liquidityProviderCount, uniswapV3TickV3DTO.liquidityProviderCount) &&
        Objects.equals(this.feeGrowthOutside0x128, uniswapV3TickV3DTO.feeGrowthOutside0x128) &&
        Objects.equals(this.feeGrowthOutside1x128, uniswapV3TickV3DTO.feeGrowthOutside1x128);
  }
  ...
  public String toString() {
    ...
    sb.append("class UniswapV3TickV3DTO {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to UniswapV3TickV3DTO
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!UniswapV3TickV3DTO.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in UniswapV3TickV3DTO is not found in the empty JSON string", UniswapV3TickV3DTO.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!UniswapV3TickV3DTO.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `UniswapV3TickV3DTO` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UniswapV3TickV3DTO.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UniswapV3TickV3DTO' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UniswapV3TickV3DTO> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UniswapV3TickV3DTO.class));

       return (TypeAdapter<T>) new TypeAdapter<UniswapV3TickV3DTO>() {
           @Override
           public void write(JsonWriter out, UniswapV3TickV3DTO value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public UniswapV3TickV3DTO read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of UniswapV3TickV3DTO given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of UniswapV3TickV3DTO
  * @throws IOException if the JSON string is invalid with respect to UniswapV3TickV3DTO
  */
  public static UniswapV3TickV3DTO fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UniswapV3TickV3DTO.class);
  }

 /**
  * Convert an instance of UniswapV3TickV3DTO to an JSON string
  *
  * @return JSON string
  */
