...
public class UniswapV2PairDayDataV2DTO {
  ...
  public UniswapV2PairDayDataV2DTO() {
  }

  public UniswapV2PairDayDataV2DTO entryTime(OffsetDateTime entryTime) {
  ...
  **/
  ...
  public UniswapV2PairDayDataV2DTO recvTime(OffsetDateTime recvTime) {
  ...
  **/
  ...
  public UniswapV2PairDayDataV2DTO blockNumber(Long blockNumber) {
  ...
  **/
  ...
  public UniswapV2PairDayDataV2DTO id(String id) {
  ...
  **/
  ...
  public UniswapV2PairDayDataV2DTO date(Integer date) {
  ...
  **/
  ...
  public UniswapV2PairDayDataV2DTO pairAddress(String pairAddress) {
  ...
  **/
  ...
  public UniswapV2PairDayDataV2DTO token0(String token0) {
  ...
  **/
  ...
  public UniswapV2PairDayDataV2DTO token1(String token1) {
  ...
  **/
  ...
  public UniswapV2PairDayDataV2DTO reserve0(String reserve0) {
  ...
  **/
  ...
  public UniswapV2PairDayDataV2DTO reserve1(String reserve1) {
  ...
  **/
  ...
  public UniswapV2PairDayDataV2DTO totalSupply(String totalSupply) {
  ...
  **/
  ...
  public UniswapV2PairDayDataV2DTO reserveUsd(String reserveUsd) {
  ...
  **/
  ...
  public UniswapV2PairDayDataV2DTO dailyVolumeToken0(String dailyVolumeToken0) {
  ...
  **/
  ...
  public UniswapV2PairDayDataV2DTO dailyVolumeToken1(String dailyVolumeToken1) {
  ...
  **/
  ...
  public UniswapV2PairDayDataV2DTO dailyVolumeUsd(String dailyVolumeUsd) {
  ...
  **/
  ...
  public UniswapV2PairDayDataV2DTO dailyTxns(String dailyTxns) {
  ...
  **/
  ...
  public UniswapV2PairDayDataV2DTO vid(Long vid) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    UniswapV2PairDayDataV2DTO uniswapV2PairDayDataV2DTO = (UniswapV2PairDayDataV2DTO) o;
    return Objects.equals(this.entryTime, uniswapV2PairDayDataV2DTO.entryTime) &&
        Objects.equals(this.recvTime, uniswapV2PairDayDataV2DTO.recvTime) &&
        Objects.equals(this.blockNumber, uniswapV2PairDayDataV2DTO.blockNumber) &&
        Objects.equals(this.id, uniswapV2PairDayDataV2DTO.id) &&
        Objects.equals(this.date, uniswapV2PairDayDataV2DTO.date) &&
        Objects.equals(this.pairAddress, uniswapV2PairDayDataV2DTO.pairAddress) &&
        Objects.equals(this.token0, uniswapV2PairDayDataV2DTO.token0) &&
        Objects.equals(this.token1, uniswapV2PairDayDataV2DTO.token1) &&
        Objects.equals(this.reserve0, uniswapV2PairDayDataV2DTO.reserve0) &&
        Objects.equals(this.reserve1, uniswapV2PairDayDataV2DTO.reserve1) &&
        Objects.equals(this.totalSupply, uniswapV2PairDayDataV2DTO.totalSupply) &&
        Objects.equals(this.reserveUsd, uniswapV2PairDayDataV2DTO.reserveUsd) &&
        Objects.equals(this.dailyVolumeToken0, uniswapV2PairDayDataV2DTO.dailyVolumeToken0) &&
        Objects.equals(this.dailyVolumeToken1, uniswapV2PairDayDataV2DTO.dailyVolumeToken1) &&
        Objects.equals(this.dailyVolumeUsd, uniswapV2PairDayDataV2DTO.dailyVolumeUsd) &&
        Objects.equals(this.dailyTxns, uniswapV2PairDayDataV2DTO.dailyTxns) &&
        Objects.equals(this.vid, uniswapV2PairDayDataV2DTO.vid);
  }
  ...
  public String toString() {
    ...
    sb.append("class UniswapV2PairDayDataV2DTO {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to UniswapV2PairDayDataV2DTO
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!UniswapV2PairDayDataV2DTO.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in UniswapV2PairDayDataV2DTO is not found in the empty JSON string", UniswapV2PairDayDataV2DTO.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!UniswapV2PairDayDataV2DTO.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `UniswapV2PairDayDataV2DTO` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UniswapV2PairDayDataV2DTO.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UniswapV2PairDayDataV2DTO' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UniswapV2PairDayDataV2DTO> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UniswapV2PairDayDataV2DTO.class));

       return (TypeAdapter<T>) new TypeAdapter<UniswapV2PairDayDataV2DTO>() {
           @Override
           public void write(JsonWriter out, UniswapV2PairDayDataV2DTO value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public UniswapV2PairDayDataV2DTO read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of UniswapV2PairDayDataV2DTO given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of UniswapV2PairDayDataV2DTO
  * @throws IOException if the JSON string is invalid with respect to UniswapV2PairDayDataV2DTO
  */
  public static UniswapV2PairDayDataV2DTO fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UniswapV2PairDayDataV2DTO.class);
  }

 /**
  * Convert an instance of UniswapV2PairDayDataV2DTO to an JSON string
  *
  * @return JSON string
  */
