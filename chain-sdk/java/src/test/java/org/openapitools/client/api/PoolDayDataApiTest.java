...
/**
 * API tests for PoolDayDataApi
 */
@Disabled
public class PoolDayDataApiTest {

    private final PoolDayDataApi api = new PoolDayDataApi();

    /**
     * @throws ApiException if the Api call fails
     */
    @Test
    public void chainsChainIdDappsSushiswapPoolDayDataHistoricalGetTest() throws ApiException {
        String chainId = null;
