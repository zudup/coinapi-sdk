...
function Initialize-FactoryV3DTO {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => FactoryV3DTO' | Write-Debug
...
Convert from JSON to FactoryV3DTO<PSCustomObject>
...
FactoryV3DTO<PSCustomObject>
#>
function ConvertFrom-JsonToFactoryV3DTO {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => FactoryV3DTO' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in FactoryV3DTO
