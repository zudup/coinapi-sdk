...
UniswapV3MintV3DTO<PSCustomObject>
#>

function Initialize-UniswapV3MintV3DTO {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => UniswapV3MintV3DTO' | Write-Debug
...
Convert from JSON to UniswapV3MintV3DTO<PSCustomObject>
...
UniswapV3MintV3DTO<PSCustomObject>
#>
function ConvertFrom-JsonToUniswapV3MintV3DTO {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => UniswapV3MintV3DTO' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in UniswapV3MintV3DTO
