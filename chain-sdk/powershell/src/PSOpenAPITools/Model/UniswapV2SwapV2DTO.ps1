...
UniswapV2SwapV2DTO<PSCustomObject>
#>

function Initialize-UniswapV2SwapV2DTO {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => UniswapV2SwapV2DTO' | Write-Debug
...
Convert from JSON to UniswapV2SwapV2DTO<PSCustomObject>
...
UniswapV2SwapV2DTO<PSCustomObject>
#>
function ConvertFrom-JsonToUniswapV2SwapV2DTO {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => UniswapV2SwapV2DTO' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in UniswapV2SwapV2DTO
