...
UniswapV3TokenV3DayDataDTO<PSCustomObject>
#>

function Initialize-UniswapV3TokenV3DayDataDTO {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => UniswapV3TokenV3DayDataDTO' | Write-Debug
...
Convert from JSON to UniswapV3TokenV3DayDataDTO<PSCustomObject>
...
UniswapV3TokenV3DayDataDTO<PSCustomObject>
#>
function ConvertFrom-JsonToUniswapV3TokenV3DayDataDTO {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => UniswapV3TokenV3DayDataDTO' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in UniswapV3TokenV3DayDataDTO
