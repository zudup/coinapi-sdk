...
function Initialize-TokenHourDataV3DTO {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => TokenHourDataV3DTO' | Write-Debug
...
Convert from JSON to TokenHourDataV3DTO<PSCustomObject>
...
TokenHourDataV3DTO<PSCustomObject>
#>
function ConvertFrom-JsonToTokenHourDataV3DTO {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => TokenHourDataV3DTO' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in TokenHourDataV3DTO
