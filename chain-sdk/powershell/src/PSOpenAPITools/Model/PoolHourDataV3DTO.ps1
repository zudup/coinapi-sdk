...
function Initialize-PoolHourDataV3DTO {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => PoolHourDataV3DTO' | Write-Debug
...
Convert from JSON to PoolHourDataV3DTO<PSCustomObject>
...
PoolHourDataV3DTO<PSCustomObject>
#>
function ConvertFrom-JsonToPoolHourDataV3DTO {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => PoolHourDataV3DTO' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in PoolHourDataV3DTO
