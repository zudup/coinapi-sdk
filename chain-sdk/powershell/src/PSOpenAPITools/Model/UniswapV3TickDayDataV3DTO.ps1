...
UniswapV3TickDayDataV3DTO<PSCustomObject>
#>

function Initialize-UniswapV3TickDayDataV3DTO {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => UniswapV3TickDayDataV3DTO' | Write-Debug
...
Convert from JSON to UniswapV3TickDayDataV3DTO<PSCustomObject>
...
UniswapV3TickDayDataV3DTO<PSCustomObject>
#>
function ConvertFrom-JsonToUniswapV3TickDayDataV3DTO {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => UniswapV3TickDayDataV3DTO' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in UniswapV3TickDayDataV3DTO
