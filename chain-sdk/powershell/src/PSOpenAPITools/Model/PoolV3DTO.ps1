...
PoolV3DTO<PSCustomObject>
#>

function Initialize-PoolV3DTO {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => PoolV3DTO' | Write-Debug
...
Convert from JSON to PoolV3DTO<PSCustomObject>
...
PoolV3DTO<PSCustomObject>
#>
function ConvertFrom-JsonToPoolV3DTO {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => PoolV3DTO' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in PoolV3DTO
