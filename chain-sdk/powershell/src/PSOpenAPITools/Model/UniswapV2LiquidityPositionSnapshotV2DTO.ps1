...
UniswapV2LiquidityPositionSnapshotV2DTO<PSCustomObject>
#>

function Initialize-UniswapV2LiquidityPositionSnapshotV2DTO {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => UniswapV2LiquidityPositionSnapshotV2DTO' | Write-Debug
...
Convert from JSON to UniswapV2LiquidityPositionSnapshotV2DTO<PSCustomObject>
...
UniswapV2LiquidityPositionSnapshotV2DTO<PSCustomObject>
#>
function ConvertFrom-JsonToUniswapV2LiquidityPositionSnapshotV2DTO {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => UniswapV2LiquidityPositionSnapshotV2DTO' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in UniswapV2LiquidityPositionSnapshotV2DTO
