...
UniswapV2MintV2DTO<PSCustomObject>
#>

function Initialize-UniswapV2MintV2DTO {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => UniswapV2MintV2DTO' | Write-Debug
...
Convert from JSON to UniswapV2MintV2DTO<PSCustomObject>
...
UniswapV2MintV2DTO<PSCustomObject>
#>
function ConvertFrom-JsonToUniswapV2MintV2DTO {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => UniswapV2MintV2DTO' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in UniswapV2MintV2DTO
