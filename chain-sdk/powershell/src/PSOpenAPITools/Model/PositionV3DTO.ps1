...
function Initialize-PositionV3DTO {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => PositionV3DTO' | Write-Debug
...
Convert from JSON to PositionV3DTO<PSCustomObject>
...
PositionV3DTO<PSCustomObject>
#>
function ConvertFrom-JsonToPositionV3DTO {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => PositionV3DTO' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in PositionV3DTO
