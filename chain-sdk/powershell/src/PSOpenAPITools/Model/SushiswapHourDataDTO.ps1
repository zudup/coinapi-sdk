...
SushiswapHourDataDTO<PSCustomObject>
#>

function Initialize-SushiswapHourDataDTO {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => SushiswapHourDataDTO' | Write-Debug
...
Convert from JSON to SushiswapHourDataDTO<PSCustomObject>
...
SushiswapHourDataDTO<PSCustomObject>
#>
function ConvertFrom-JsonToSushiswapHourDataDTO {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => SushiswapHourDataDTO' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in SushiswapHourDataDTO
