...
BigInteger<PSCustomObject>
#>

function Initialize-BigInteger {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => BigInteger' | Write-Debug
...
Convert from JSON to BigInteger<PSCustomObject>
...
BigInteger<PSCustomObject>
#>
function ConvertFrom-JsonToBigInteger {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => BigInteger' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in BigInteger
