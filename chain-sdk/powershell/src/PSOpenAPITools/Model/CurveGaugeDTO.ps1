...
CurveGaugeDTO<PSCustomObject>
#>

function Initialize-CurveGaugeDTO {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => CurveGaugeDTO' | Write-Debug
...
Convert from JSON to CurveGaugeDTO<PSCustomObject>
...
CurveGaugeDTO<PSCustomObject>
#>
function ConvertFrom-JsonToCurveGaugeDTO {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => CurveGaugeDTO' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in CurveGaugeDTO
        $AllProperties = ("entry_time", "recv_time", "block_number", "id", "address", "type", "pool", "created", "created_at_block", "created_at_transaction", "vid")
