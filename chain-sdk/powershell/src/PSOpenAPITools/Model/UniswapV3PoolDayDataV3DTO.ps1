...
UniswapV3PoolDayDataV3DTO<PSCustomObject>
#>

function Initialize-UniswapV3PoolDayDataV3DTO {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => UniswapV3PoolDayDataV3DTO' | Write-Debug
...
Convert from JSON to UniswapV3PoolDayDataV3DTO<PSCustomObject>
...
UniswapV3PoolDayDataV3DTO<PSCustomObject>
#>
function ConvertFrom-JsonToUniswapV3PoolDayDataV3DTO {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => UniswapV3PoolDayDataV3DTO' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in UniswapV3PoolDayDataV3DTO
