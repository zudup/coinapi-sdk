...
UniswapV3FactoryV3DTO<PSCustomObject>
#>

function Initialize-UniswapV3FactoryV3DTO {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => UniswapV3FactoryV3DTO' | Write-Debug
...
Convert from JSON to UniswapV3FactoryV3DTO<PSCustomObject>
...
UniswapV3FactoryV3DTO<PSCustomObject>
#>
function ConvertFrom-JsonToUniswapV3FactoryV3DTO {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => UniswapV3FactoryV3DTO' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in UniswapV3FactoryV3DTO
