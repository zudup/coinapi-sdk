...
UniswapV2TokenDayDataV2DTO<PSCustomObject>
#>

function Initialize-UniswapV2TokenDayDataV2DTO {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => UniswapV2TokenDayDataV2DTO' | Write-Debug
...
Convert from JSON to UniswapV2TokenDayDataV2DTO<PSCustomObject>
...
UniswapV2TokenDayDataV2DTO<PSCustomObject>
#>
function ConvertFrom-JsonToUniswapV2TokenDayDataV2DTO {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => UniswapV2TokenDayDataV2DTO' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in UniswapV2TokenDayDataV2DTO
