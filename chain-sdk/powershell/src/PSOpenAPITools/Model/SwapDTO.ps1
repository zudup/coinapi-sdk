...
SwapDTO<PSCustomObject>
#>

function Initialize-SwapDTO {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => SwapDTO' | Write-Debug
...
Convert from JSON to SwapDTO<PSCustomObject>
...
SwapDTO<PSCustomObject>
#>
function ConvertFrom-JsonToSwapDTO {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => SwapDTO' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in SwapDTO
