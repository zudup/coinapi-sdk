...
PairV2DTO<PSCustomObject>
#>

function Initialize-PairV2DTO {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => PairV2DTO' | Write-Debug
...
Convert from JSON to PairV2DTO<PSCustomObject>
...
PairV2DTO<PSCustomObject>
#>
function ConvertFrom-JsonToPairV2DTO {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => PairV2DTO' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in PairV2DTO
