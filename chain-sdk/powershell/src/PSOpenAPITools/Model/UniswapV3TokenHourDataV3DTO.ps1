...
UniswapV3TokenHourDataV3DTO<PSCustomObject>
#>

function Initialize-UniswapV3TokenHourDataV3DTO {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => UniswapV3TokenHourDataV3DTO' | Write-Debug
...
Convert from JSON to UniswapV3TokenHourDataV3DTO<PSCustomObject>
...
UniswapV3TokenHourDataV3DTO<PSCustomObject>
#>
function ConvertFrom-JsonToUniswapV3TokenHourDataV3DTO {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => UniswapV3TokenHourDataV3DTO' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in UniswapV3TokenHourDataV3DTO
