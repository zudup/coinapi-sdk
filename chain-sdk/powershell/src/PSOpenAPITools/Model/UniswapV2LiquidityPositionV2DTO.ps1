...
UniswapV2LiquidityPositionV2DTO<PSCustomObject>
#>

function Initialize-UniswapV2LiquidityPositionV2DTO {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => UniswapV2LiquidityPositionV2DTO' | Write-Debug
...
Convert from JSON to UniswapV2LiquidityPositionV2DTO<PSCustomObject>
...
UniswapV2LiquidityPositionV2DTO<PSCustomObject>
#>
function ConvertFrom-JsonToUniswapV2LiquidityPositionV2DTO {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => UniswapV2LiquidityPositionV2DTO' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in UniswapV2LiquidityPositionV2DTO
