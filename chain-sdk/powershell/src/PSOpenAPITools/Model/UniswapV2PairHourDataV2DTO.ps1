...
UniswapV2PairHourDataV2DTO<PSCustomObject>
#>

function Initialize-UniswapV2PairHourDataV2DTO {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => UniswapV2PairHourDataV2DTO' | Write-Debug
...
Convert from JSON to UniswapV2PairHourDataV2DTO<PSCustomObject>
...
UniswapV2PairHourDataV2DTO<PSCustomObject>
#>
function ConvertFrom-JsonToUniswapV2PairHourDataV2DTO {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => UniswapV2PairHourDataV2DTO' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in UniswapV2PairHourDataV2DTO
