...
SwapV3DTO<PSCustomObject>
#>

function Initialize-SwapV3DTO {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => SwapV3DTO' | Write-Debug
...
Convert from JSON to SwapV3DTO<PSCustomObject>
...
SwapV3DTO<PSCustomObject>
#>
function ConvertFrom-JsonToSwapV3DTO {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => SwapV3DTO' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in SwapV3DTO
