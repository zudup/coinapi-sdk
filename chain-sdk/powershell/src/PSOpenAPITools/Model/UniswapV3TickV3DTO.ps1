...
UniswapV3TickV3DTO<PSCustomObject>
#>

function Initialize-UniswapV3TickV3DTO {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => UniswapV3TickV3DTO' | Write-Debug
...
Convert from JSON to UniswapV3TickV3DTO<PSCustomObject>
...
UniswapV3TickV3DTO<PSCustomObject>
#>
function ConvertFrom-JsonToUniswapV3TickV3DTO {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => UniswapV3TickV3DTO' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in UniswapV3TickV3DTO
