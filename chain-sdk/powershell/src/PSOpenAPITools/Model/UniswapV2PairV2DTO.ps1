...
UniswapV2PairV2DTO<PSCustomObject>
#>

function Initialize-UniswapV2PairV2DTO {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => UniswapV2PairV2DTO' | Write-Debug
...
Convert from JSON to UniswapV2PairV2DTO<PSCustomObject>
...
UniswapV2PairV2DTO<PSCustomObject>
#>
function ConvertFrom-JsonToUniswapV2PairV2DTO {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => UniswapV2PairV2DTO' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in UniswapV2PairV2DTO
