...
UniswapV2TokenV2DTO<PSCustomObject>
#>

function Initialize-UniswapV2TokenV2DTO {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => UniswapV2TokenV2DTO' | Write-Debug
...
Convert from JSON to UniswapV2TokenV2DTO<PSCustomObject>
...
UniswapV2TokenV2DTO<PSCustomObject>
#>
function ConvertFrom-JsonToUniswapV2TokenV2DTO {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => UniswapV2TokenV2DTO' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in UniswapV2TokenV2DTO
