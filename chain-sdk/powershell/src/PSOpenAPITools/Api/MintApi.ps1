...
None
#>
function Invoke-ChainsChainIdDappsUniswapv2MintHistoricalGet {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Calling method: Invoke-ChainsChainIdDappsUniswapv2MintHistoricalGet' | Write-Debug
        ...
        $LocalVarUri = '/chains/{chain_id}/dapps/uniswapv2/mint/historical'
        if (!$ChainId) {
            throw "Error! The required parameter `ChainId` missing when calling chainsChainIdDappsUniswapv2MintHistoricalGet."
        }
