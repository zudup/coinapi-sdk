...
None
#>
function Invoke-ChainsChainIdDappsSushiswapBurnsHistoricalGet {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Calling method: Invoke-ChainsChainIdDappsSushiswapBurnsHistoricalGet' | Write-Debug
        ...
        $LocalVarUri = '/chains/{chain_id}/dapps/sushiswap/burns/historical'
        if (!$ChainId) {
            throw "Error! The required parameter `ChainId` missing when calling chainsChainIdDappsSushiswapBurnsHistoricalGet."
        }
...
function Invoke-ChainsChainIdDappsUniswapv3BurnsHistoricalGet {
    ...
    Process {
        'Calling method: Invoke-ChainsChainIdDappsUniswapv3BurnsHistoricalGet' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
        ...
        $Configuration = Get-Configuration
        $LocalVarUri = '/chains/{chain_id}/dapps/uniswapv3/burns/historical'
        if (!$ChainId) {
            throw "Error! The required parameter `ChainId` missing when calling chainsChainIdDappsUniswapv3BurnsHistoricalGet."
        }
        $LocalVarUri = $LocalVarUri.replace('{chain_id}', [System.Web.HTTPUtility]::UrlEncode($ChainId))
