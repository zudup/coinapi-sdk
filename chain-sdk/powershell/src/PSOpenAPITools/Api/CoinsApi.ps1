...
None
#>
function Invoke-ChainsChainIdDappsCurveCoinsHistoricalGet {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Calling method: Invoke-ChainsChainIdDappsCurveCoinsHistoricalGet' | Write-Debug
        ...
        $LocalVarUri = '/chains/{chain_id}/dapps/curve/coins/historical'
        if (!$ChainId) {
            throw "Error! The required parameter `ChainId` missing when calling chainsChainIdDappsCurveCoinsHistoricalGet."
        }
