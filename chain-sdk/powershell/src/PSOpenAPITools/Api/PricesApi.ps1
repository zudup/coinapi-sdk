...
None
#>
function Invoke-ChainsChainIdDappsDexPricesHistoricalGet {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Calling method: Invoke-ChainsChainIdDappsDexPricesHistoricalGet' | Write-Debug
        ...
        $LocalVarUri = '/chains/{chain_id}/dapps/dex/prices/historical'
        if (!$ChainId) {
            throw "Error! The required parameter `ChainId` missing when calling chainsChainIdDappsDexPricesHistoricalGet."
        }
