...
None
#>
function Invoke-ChainsChainIdDappsDexSolutionHistoricalGet {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Calling method: Invoke-ChainsChainIdDappsDexSolutionHistoricalGet' | Write-Debug
        ...
        $LocalVarUri = '/chains/{chain_id}/dapps/dex/solution/historical'
        if (!$ChainId) {
            throw "Error! The required parameter `ChainId` missing when calling chainsChainIdDappsDexSolutionHistoricalGet."
        }
