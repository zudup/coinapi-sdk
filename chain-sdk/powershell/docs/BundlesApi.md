# PSOpenAPITools.PSOpenAPITools/Api.BundlesApi

All URIs are relative to *https://onchain.coinapi.io*

Method | HTTP request | Description
------------- | ------------- | -------------
[**Invoke-ChainsChainIdDappsSushiswapBundlesHistoricalGet**](BundlesApi.md#Invoke-ChainsChainIdDappsSushiswapBundlesHistoricalGet) | **GET** /chains/{chain_id}/dapps/sushiswap/bundles/historical | 
...
<a name="Invoke-ChainsChainIdDappsSushiswapBundlesHistoricalGet"></a>
# **Invoke-ChainsChainIdDappsSushiswapBundlesHistoricalGet**
> void Invoke-ChainsChainIdDappsSushiswapBundlesHistoricalGet<br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-ChainId] <String><br>
...
try {
    $Result = Invoke-ChainsChainIdDappsSushiswapBundlesHistoricalGet -ChainId $ChainId -StartBlock $StartBlock -EndBlock $EndBlock -StartDate $StartDate -EndDate $EndDate
} catch {
    Write-Host ("Exception occurred when calling Invoke-ChainsChainIdDappsSushiswapBundlesHistoricalGet: {0}" -f ($_.ErrorDetails | ConvertFrom-Json))
