...
------------- | ------------- | -------------
[**Invoke-ChainsChainIdDappsSushiswapTransactionsHistoricalGet**](TransactionsApi.md#Invoke-ChainsChainIdDappsSushiswapTransactionsHistoricalGet) | **GET** /chains/{chain_id}/dapps/sushiswap/transactions/historical | 
...
<a name="Invoke-ChainsChainIdDappsSushiswapTransactionsHistoricalGet"></a>
# **Invoke-ChainsChainIdDappsSushiswapTransactionsHistoricalGet**
> void Invoke-ChainsChainIdDappsSushiswapTransactionsHistoricalGet<br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-ChainId] <String><br>
...
try {
    $Result = Invoke-ChainsChainIdDappsSushiswapTransactionsHistoricalGet -ChainId $ChainId -StartBlock $StartBlock -EndBlock $EndBlock -StartDate $StartDate -EndDate $EndDate
} catch {
    Write-Host ("Exception occurred when calling Invoke-ChainsChainIdDappsSushiswapTransactionsHistoricalGet: {0}" -f ($_.ErrorDetails | ConvertFrom-Json))
