# WWW::OpenAPIClient::DepositApi

## Load the API package
```perl
use WWW::OpenAPIClient::Object::DepositApi;
```
...
my $api_instance = WWW::OpenAPIClient::DepositApi->new(
);
...
if ($@) {
    warn "Exception when calling DepositApi->chains_chain_id_dapps_dex_tokens_historical_get: $@\n";
}
```
