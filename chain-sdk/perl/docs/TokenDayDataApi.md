# WWW::OpenAPIClient::TokenDayDataApi
...
> chains_chain_id_dapps_sushiswap_token_day_data_historical_get(chain_id => $chain_id, start_block => $start_block, end_block => $end_block, start_date => $start_date, end_date => $end_date, token_id => $token_id)
...
eval {
    $api_instance->chains_chain_id_dapps_sushiswap_token_day_data_historical_get(chain_id => $chain_id, start_block => $start_block, end_block => $end_block, start_date => $start_date, end_date => $end_date, token_id => $token_id);
};
if ($@) {
    warn "Exception when calling TokenDayDataApi->chains_chain_id_dapps_sushiswap_token_day_data_historical_get: $@\n";
}
```
