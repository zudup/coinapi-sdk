# WWW::OpenAPIClient::PoolDayDataApi
...
> chains_chain_id_dapps_sushiswap_pool_day_data_historical_get(chain_id => $chain_id, start_block => $start_block, end_block => $end_block, start_date => $start_date, end_date => $end_date, pool_id => $pool_id)
...
eval {
    $api_instance->chains_chain_id_dapps_sushiswap_pool_day_data_historical_get(chain_id => $chain_id, start_block => $start_block, end_block => $end_block, start_date => $start_date, end_date => $end_date, pool_id => $pool_id);
};
if ($@) {
    warn "Exception when calling PoolDayDataApi->chains_chain_id_dapps_sushiswap_pool_day_data_historical_get: $@\n";
}
```
