# WWW::OpenAPIClient::UniswapDayDataApi
...
> chains_chain_id_dapps_uniswapv2_uniswap_day_data_historical_get(chain_id => $chain_id, start_block => $start_block, end_block => $end_block, start_date => $start_date, end_date => $end_date)
...
eval {
    $api_instance->chains_chain_id_dapps_uniswapv2_uniswap_day_data_historical_get(chain_id => $chain_id, start_block => $start_block, end_block => $end_block, start_date => $start_date, end_date => $end_date);
};
if ($@) {
    warn "Exception when calling UniswapDayDataApi->chains_chain_id_dapps_uniswapv2_uniswap_day_data_historical_get: $@\n";
}
```
