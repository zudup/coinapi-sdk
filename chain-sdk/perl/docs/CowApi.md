...
> dapps_cow_poi_historical_get(start_block => $start_block, end_block => $end_block, start_date => $start_date, end_date => $end_date)
...
eval {
    $api_instance->dapps_cow_poi_historical_get(start_block => $start_block, end_block => $end_block, start_date => $start_date, end_date => $end_date);
};
if ($@) {
    warn "Exception when calling CowApi->dapps_cow_poi_historical_get: $@\n";
}
```
