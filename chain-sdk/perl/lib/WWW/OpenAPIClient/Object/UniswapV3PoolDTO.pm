...
#
package WWW::OpenAPIClient::Object::UniswapV3PoolDTO;
...
__PACKAGE__->class_documentation({description => 'Information about a pool. Includes references to each token within the pool, volume information, liquidity information, and more. The pool entity mirrors the pool smart contract, and also contains aggregated information about use.',
...
__PACKAGE__->method_documentation({
    ...
    'volume_token_0' => {
        ...
        description => 'All time token0 swapped.',
        format => '',
        read_only => '',
            },
    'volume_token_1' => {
        ...
        description => 'All time token1 swapped.',
        format => '',
        read_only => '',
            },
    'volume_usd' => {
        ...
        description => 'All time USD swapped.',
        format => '',
        read_only => '',
            },
    'untracked_volume_usd' => {
        ...
        description => 'All time USD swapped, unfiltered for unreliable USD pools.',
        format => '',
        read_only => '',
            },
    'fees_usd' => {
    ...
    'collected_fees_token_0' => {
        ...
        description => 'All time fees collected token0.',
        format => '',
        read_only => '',
            },
    'collected_fees_token_1' => {
        ...
        description => 'All time fees collected token1.',
        format => '',
        read_only => '',
            },
    'collected_fees_usd' => {
        ...
        description => 'All time fees collected derived USD.',
        format => '',
        read_only => '',
            },
    'total_value_locked_token_0' => {
        datatype => 'string',
        base_name => 'total_value_locked_token_0',
        description => 'Total token 0 across all ticks.',
        format => '',
        read_only => '',
            },
    'total_value_locked_token_1' => {
        datatype => 'string',
        base_name => 'total_value_locked_token_1',
        description => '',
        format => '',
        read_only => '',
            },
    'total_value_locked_eth' => {
        datatype => 'string',
        base_name => 'total_value_locked_eth',
        description => 'Total token 1 across all ticks.',
        format => '',
        read_only => '',
            },
    ...
    'total_value_locked_usd_untracked' => {
        ...
        description => 'Total value locked derived ETH.',
        format => '',
        read_only => '',
            },
    'liquidity_provider_count' => {
        ...
        description => 'Liquidity providers count, used to detect new exchanges.',
        format => '',
        read_only => '',
            },
    'evaluated_ask' => {
