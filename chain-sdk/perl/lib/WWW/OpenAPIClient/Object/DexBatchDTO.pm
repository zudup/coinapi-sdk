...
#
package WWW::OpenAPIClient::Object::DexBatchDTO;
...
__PACKAGE__->class_documentation({description => 'Batch executed. Every batch will contain at least solution with the a set of trades that are executed in it',
                                  class => 'DexBatchDTO',
                                  required => [], # TODO
}                                 );
...
__PACKAGE__->method_documentation({
    ...
    'first_solution_epoch' => {
        datatype => 'string',
        base_name => 'first_solution_epoch',
        description => 'First solution epoch.',
        format => '',
        read_only => '',
            },
    'last_revert_epoch' => {
        datatype => 'string',
        base_name => 'last_revert_epoch',
        description => 'Last revert epoch.',
        format => '',
        read_only => '',
            },
    'tx_hash' => {
