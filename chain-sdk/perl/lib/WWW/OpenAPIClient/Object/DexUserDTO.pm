...
#
package WWW::OpenAPIClient::Object::DexUserDTO;
...
__PACKAGE__->class_documentation({description => 'User of the protocol. Any ethereum account that deposited tokens or traded.',
                                  class => 'DexUserDTO',
                                  required => [], # TODO
}                                 );
