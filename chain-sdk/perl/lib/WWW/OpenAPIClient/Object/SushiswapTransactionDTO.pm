...
#
package WWW::OpenAPIClient::Object::SushiswapTransactionDTO;
...
__PACKAGE__->class_documentation({description => 'Transaction entities are created for each Ethereum transaction that contains an interaction within Sushiswap contracts. Each transaction contains 3 arrays, and at least one of these arrays has a length of 1.',
