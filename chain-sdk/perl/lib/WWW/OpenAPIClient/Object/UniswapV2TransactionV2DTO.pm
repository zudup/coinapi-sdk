...
#
package WWW::OpenAPIClient::Object::UniswapV2TransactionV2DTO;
...
__PACKAGE__->class_documentation({description => 'Transaction entities are created for each Ethereum transaction that contains an interaction within Uniswap contracts. Each transaction contains 3 arrays, and at least one of these arrays has a length of 1.',
