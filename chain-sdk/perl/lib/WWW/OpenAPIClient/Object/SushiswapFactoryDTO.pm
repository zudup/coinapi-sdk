...
#
package WWW::OpenAPIClient::Object::SushiswapFactoryDTO;
...
__PACKAGE__->class_documentation({description => 'The Sushiswap Factory entity is responsible for storing aggregate information across all Sushiswap pairs. It can be used to view stats about total liquidity, volume, amount of pairs and more.',
...
__PACKAGE__->method_documentation({
    ...
    'pair_count' => {
        datatype => 'string',
        base_name => 'pair_count',
        description => 'Amount of pairs created by the Sushiswap factory.',
        format => '',
        read_only => '',
            },
    'volume_usd' => {
    ...
    'untracked_volume_usd' => {
        ...
        description => 'Untracked volume USD.',
        format => '',
        read_only => '',
            },
    'liquidity_usd' => {
