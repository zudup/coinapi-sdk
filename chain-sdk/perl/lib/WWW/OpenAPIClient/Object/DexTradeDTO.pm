...
#
package WWW::OpenAPIClient::Object::DexTradeDTO;
...
__PACKAGE__->class_documentation({description => 'Trade for a single user, as part of a ring trade. It&#39;s part of the solution submitted by a solver for a given batch.',
                                  class => 'DexTradeDTO',
                                  required => [], # TODO
}                                 );
...
__PACKAGE__->method_documentation({
    ...
    'trade_epoch' => {
        datatype => 'string',
        base_name => 'trade_epoch',
        description => 'The date of the end of the batch.',
        format => '',
        read_only => '',
            },
    'buy_token' => {
    ...
    'create_epoch' => {
        ...
        description => 'The date where the transaction was mined.',
        format => '',
        read_only => '',
            },
    'revert_epoch' => {
        datatype => 'string',
        base_name => 'revert_epoch',
        description => '',
        format => '',
        read_only => '',
            },
