...
#
package WWW::OpenAPIClient::Object::UniswapV2SwapV2DTO;
...
__PACKAGE__->method_documentation({
    ...
    'from' => {
        datatype => 'string',
        base_name => 'from',
        description => 'The EOA (Externally Owned Account) that initiated the transaction.',
        format => '',
        read_only => '',
            },
    'amount_0_in' => {
        datatype => 'string',
        base_name => 'amount_0_in',
