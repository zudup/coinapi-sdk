...
#
package WWW::OpenAPIClient::Object::CowSettlementDTO;
...
__PACKAGE__->class_documentation({description => 'A settlement comprises a list of traded tokens with their corresponding price in the batch.',
