...
#
package WWW::OpenAPIClient::Object::SushiswapTokenDTO;
...
__PACKAGE__->method_documentation({
    ...
    'total_supply' => {
        ...
        description => 'Total supply of liquidity token.',
        format => '',
        read_only => '',
            },
    'volume' => {
    ...
    'whitelist_pairs' => {
        ...
        description => 'Array of whitelisted pairs.',
        format => '',
        read_only => '',
            },
    'vid' => {
