...
#
package WWW::OpenAPIClient::Object::CowTokenDTO;
...
__PACKAGE__->class_documentation({description => 'Stores information for a specific token across all pairs that token is included in.',
                                  class => 'CowTokenDTO',
                                  required => [], # TODO
}                                 );
...
__PACKAGE__->method_documentation({
    ...
    'first_trade_timestamp' => {
        ...
        description => 'First token trade block timestamp.',
        format => '',
        read_only => '',
            },
    'name' => {
    ...
    'decimals' => {
        datatype => 'int',
        base_name => 'decimals',
        description => 'Token decimals fetched by contract call.',
        format => '',
        read_only => '',
            },
    'total_volume' => {
        datatype => 'string',
        base_name => 'total_volume',
        description => 'Sum of total amount traded for this token.',
        format => '',
        read_only => '',
            },
    'vid' => {
