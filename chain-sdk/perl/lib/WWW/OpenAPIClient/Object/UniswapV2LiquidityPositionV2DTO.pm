...
#
package WWW::OpenAPIClient::Object::UniswapV2LiquidityPositionV2DTO;
...
__PACKAGE__->class_documentation({description => 'This entity is used to store data about a user&#39;s liquidity position. This information, along with information from the pair itself can be used to provide position sizes, token deposits, and more.',
