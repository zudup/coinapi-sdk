...
#
package WWW::OpenAPIClient::GaugeWeightApi;
...
# @param DATE_TIME $end_date  (optional)
{
    ...
    __PACKAGE__->method_documentation->{ 'chains_chain_id_dapps_curve_gauge_weight_historical_get' } = {
        summary => '',
        params => $params,
        returns => undef,
        };
...
# @return void
#
sub chains_chain_id_dapps_curve_gauge_weight_historical_get {
    my ($self, %args) = @_;

    # verify the required parameter 'chain_id' is set
    unless (exists $args{'chain_id'}) {
      croak("Missing the required parameter 'chain_id' when calling chains_chain_id_dapps_curve_gauge_weight_historical_get");
    }

    # parse inputs
    my $_resource_path = '/chains/{chain_id}/dapps/curve/gaugeWeight/historical';
