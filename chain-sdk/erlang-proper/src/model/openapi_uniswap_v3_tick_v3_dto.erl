-module(openapi_uniswap_v3_tick_v3_dto).

-include("openapi.hrl").

-export([openapi_uniswap_v3_tick_v3_dto/0]).

-export([openapi_uniswap_v3_tick_v3_dto/1]).

-export_type([openapi_uniswap_v3_tick_v3_dto/0]).

-type openapi_uniswap_v3_tick_v3_dto() ::
  [ {'entry_time', datetime() }
  | {'recv_time', datetime() }
...
openapi_uniswap_v3_tick_v3_dto() ->
    openapi_uniswap_v3_tick_v3_dto([]).

openapi_uniswap_v3_tick_v3_dto(Fields) ->
