...
-export([openapi_uniswap_v3_tick_day_data_v3_dto/0]).

-export([openapi_uniswap_v3_tick_day_data_v3_dto/1]).
...
openapi_uniswap_v3_tick_day_data_v3_dto() ->
    openapi_uniswap_v3_tick_day_data_v3_dto([]).

openapi_uniswap_v3_tick_day_data_v3_dto(Fields) ->
