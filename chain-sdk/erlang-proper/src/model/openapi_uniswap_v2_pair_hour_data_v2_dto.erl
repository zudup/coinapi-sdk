...
-export([openapi_uniswap_v2_pair_hour_data_v2_dto/0]).

-export([openapi_uniswap_v2_pair_hour_data_v2_dto/1]).
...
openapi_uniswap_v2_pair_hour_data_v2_dto() ->
    openapi_uniswap_v2_pair_hour_data_v2_dto([]).

openapi_uniswap_v2_pair_hour_data_v2_dto(Fields) ->
