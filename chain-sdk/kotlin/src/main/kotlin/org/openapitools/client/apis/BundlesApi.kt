...
class BundlesApi(basePath: kotlin.String = defaultBasePath, client: OkHttpClient = ApiClient.defaultClient) : ApiClient(basePath, client) {
    ...
    fun chainsChainIdDappsSushiswapBundlesHistoricalGet(chainId: kotlin.String, startBlock: kotlin.Long? = null, endBlock: kotlin.Long? = null, startDate: java.time.OffsetDateTime? = null, endDate: java.time.OffsetDateTime? = null) : Unit {
        val localVarResponse = chainsChainIdDappsSushiswapBundlesHistoricalGetWithHttpInfo(chainId = chainId, startBlock = startBlock, endBlock = endBlock, startDate = startDate, endDate = endDate)
    ...
    fun chainsChainIdDappsSushiswapBundlesHistoricalGetWithHttpInfo(chainId: kotlin.String, startBlock: kotlin.Long?, endBlock: kotlin.Long?, startDate: java.time.OffsetDateTime?, endDate: java.time.OffsetDateTime?) : ApiResponse<Unit?> {
        val localVariableConfig = chainsChainIdDappsSushiswapBundlesHistoricalGetRequestConfig(chainId = chainId, startBlock = startBlock, endBlock = endBlock, startDate = startDate, endDate = endDate)
    ...
    /**
     * To obtain the request config of the operation chainsChainIdDappsSushiswapBundlesHistoricalGet
     *
     * @param chainId 
     * @param startBlock  (optional)
     * @param endBlock  (optional)
     ...
     */
    fun chainsChainIdDappsSushiswapBundlesHistoricalGetRequestConfig(chainId: kotlin.String, startBlock: kotlin.Long?, endBlock: kotlin.Long?, startDate: java.time.OffsetDateTime?, endDate: java.time.OffsetDateTime?) : RequestConfig<Unit> {
        ...
        return RequestConfig(
            ...
            path = "/chains/{chain_id}/dapps/sushiswap/bundles/historical".replace("{"+"chain_id"+"}", encodeURIComponent(chainId.toString())),
