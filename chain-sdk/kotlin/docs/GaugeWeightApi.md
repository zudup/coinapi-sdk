...
val apiInstance = GaugeWeightApi()
...
try {
    ...
    println("4xx response calling GaugeWeightApi#chainsChainIdDappsCurveGaugeWeightHistoricalGet")
    e.printStackTrace()
} catch (e: ServerException) {
    println("5xx response calling GaugeWeightApi#chainsChainIdDappsCurveGaugeWeightHistoricalGet")
    e.printStackTrace()
}
```
