...
try {
    ...
    println("4xx response calling TicksApi#chainsChainIdDappsUniswapv3TicksHistoricalGet")
    e.printStackTrace()
} catch (e: ServerException) {
    println("5xx response calling TicksApi#chainsChainIdDappsUniswapv3TicksHistoricalGet")
    e.printStackTrace()
}
```
