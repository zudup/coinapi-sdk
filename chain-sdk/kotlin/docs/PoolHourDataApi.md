...
try {
    ...
    println("4xx response calling PoolHourDataApi#chainsChainIdDappsSushiswapPoolHourDataHistoricalGet")
    e.printStackTrace()
} catch (e: ServerException) {
    println("5xx response calling PoolHourDataApi#chainsChainIdDappsSushiswapPoolHourDataHistoricalGet")
    e.printStackTrace()
}
```
...
try {
    ...
    println("4xx response calling PoolHourDataApi#chainsChainIdDappsUniswapv2PoolHourDataHistoricalGet")
    e.printStackTrace()
} catch (e: ServerException) {
    println("5xx response calling PoolHourDataApi#chainsChainIdDappsUniswapv2PoolHourDataHistoricalGet")
    e.printStackTrace()
}
```
