...
try {
    ...
    println("4xx response calling LiquidityPositionApi#chainsChainIdDappsSushiswapLiquidityPositionHistoricalGet")
    e.printStackTrace()
} catch (e: ServerException) {
    println("5xx response calling LiquidityPositionApi#chainsChainIdDappsSushiswapLiquidityPositionHistoricalGet")
    e.printStackTrace()
}
```
