...
try {
    ...
    println("4xx response calling PoiApi#chainsChainIdDappsCurvePoiHistoricalGet")
    e.printStackTrace()
} catch (e: ServerException) {
    println("5xx response calling PoiApi#chainsChainIdDappsCurvePoiHistoricalGet")
    e.printStackTrace()
}
```
