...
val apiInstance = HourlyVolumeApi()
...
try {
    ...
    println("4xx response calling HourlyVolumeApi#chainsChainIdDappsCurveHourlyVolumeHistoricalGet")
    e.printStackTrace()
} catch (e: ServerException) {
    println("5xx response calling HourlyVolumeApi#chainsChainIdDappsCurveHourlyVolumeHistoricalGet")
    e.printStackTrace()
}
```
