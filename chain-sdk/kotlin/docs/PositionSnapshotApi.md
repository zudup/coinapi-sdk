...
val apiInstance = PositionSnapshotApi()
...
try {
    ...
    println("4xx response calling PositionSnapshotApi#chainsChainIdDappsUniswapv3PositionSnapshotHistoricalGet")
    e.printStackTrace()
} catch (e: ServerException) {
    println("5xx response calling PositionSnapshotApi#chainsChainIdDappsUniswapv3PositionSnapshotHistoricalGet")
    e.printStackTrace()
}
```
