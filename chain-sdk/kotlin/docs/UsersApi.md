...
try {
    ...
    println("4xx response calling UsersApi#chainsChainIdDappsCowUsersHistoricalGet")
    e.printStackTrace()
} catch (e: ServerException) {
    println("5xx response calling UsersApi#chainsChainIdDappsCowUsersHistoricalGet")
    e.printStackTrace()
}
```
...
try {
    ...
    println("4xx response calling UsersApi#chainsChainIdDappsDexUsersHistoricalGet")
    e.printStackTrace()
} catch (e: ServerException) {
    println("5xx response calling UsersApi#chainsChainIdDappsDexUsersHistoricalGet")
    e.printStackTrace()
}
```
