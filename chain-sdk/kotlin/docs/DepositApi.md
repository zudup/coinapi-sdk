...
try {
    ...
    println("4xx response calling DepositApi#chainsChainIdDappsDexTokensHistoricalGet")
    e.printStackTrace()
} catch (e: ServerException) {
    println("5xx response calling DepositApi#chainsChainIdDappsDexTokensHistoricalGet")
    e.printStackTrace()
}
```
