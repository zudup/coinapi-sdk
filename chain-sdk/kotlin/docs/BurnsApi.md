...
try {
    ...
    println("4xx response calling BurnsApi#chainsChainIdDappsSushiswapBurnsHistoricalGet")
    e.printStackTrace()
} catch (e: ServerException) {
    println("5xx response calling BurnsApi#chainsChainIdDappsSushiswapBurnsHistoricalGet")
    e.printStackTrace()
}
```
