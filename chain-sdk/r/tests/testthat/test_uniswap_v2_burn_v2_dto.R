...
context("Test UniswapV2BurnV2DTO")

model_instance <- UniswapV2BurnV2DTO$new()
...
test_that("needs_complete", {
  # tests for the property `needs_complete` (character)
  # 

  # uncomment below to test the property
  #expect_equal(model.instance$`needs_complete`, "EXPECTED_RESULT")
})
