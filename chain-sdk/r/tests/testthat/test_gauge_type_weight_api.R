...
context("Test GaugeTypeWeightApi")

api_instance <- GaugeTypeWeightApi$new()

test_that("ChainsChainIdDappsCurveGaugeTypeWeightHistoricalGet", {
  # tests for ChainsChainIdDappsCurveGaugeTypeWeightHistoricalGet
