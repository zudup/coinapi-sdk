...
context("Test GaugeLiquidityApi")

api_instance <- GaugeLiquidityApi$new()

test_that("ChainsChainIdDappsCurveGaugeLiquidityHistoricalGet", {
  # tests for ChainsChainIdDappsCurveGaugeLiquidityHistoricalGet
