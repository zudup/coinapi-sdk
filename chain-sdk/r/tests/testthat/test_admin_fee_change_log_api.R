...
context("Test AdminFeeChangeLogApi")

api_instance <- AdminFeeChangeLogApi$new()

test_that("ChainsChainIdDappsCurveAdminFeeChangeLogHistoricalGet", {
  # tests for ChainsChainIdDappsCurveAdminFeeChangeLogHistoricalGet
