...
context("Test RemoveLiquidityEventApi")

api_instance <- RemoveLiquidityEventApi$new()

test_that("ChainsChainIdDappsCurveRemoveLiquidityEventHistoricalGet", {
  # tests for ChainsChainIdDappsCurveRemoveLiquidityEventHistoricalGet
