...
context("Test PoolV3DTO")

model_instance <- PoolV3DTO$new()
...
test_that("fee_tier", {
  # tests for the property `fee_tier` (BigInteger)
...
test_that("liquidity", {
  # tests for the property `liquidity` (BigInteger)
...
test_that("sqrt_price", {
  # tests for the property `sqrt_price` (BigInteger)
...
test_that("fee_growth_global_0x128", {
  # tests for the property `fee_growth_global_0x128` (BigInteger)
...
test_that("fee_growth_global_1x128", {
  # tests for the property `fee_growth_global_1x128` (BigInteger)
...
test_that("observation_index", {
  # tests for the property `observation_index` (BigInteger)
