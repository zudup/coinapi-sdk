...
context("Test CurveRemoveLiquidityOneEventDTO")

model_instance <- CurveRemoveLiquidityOneEventDTO$new()
...
test_that("token_amount", {
  # tests for the property `token_amount` (character)
  # 

  # uncomment below to test the property
  #expect_equal(model.instance$`token_amount`, "EXPECTED_RESULT")
})

test_that("coin_amount", {
  # tests for the property `coin_amount` (character)
  # 

  # uncomment below to test the property
  #expect_equal(model.instance$`coin_amount`, "EXPECTED_RESULT")
})
