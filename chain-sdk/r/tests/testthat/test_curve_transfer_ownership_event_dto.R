...
context("Test CurveTransferOwnershipEventDTO")

model_instance <- CurveTransferOwnershipEventDTO$new()
...
test_that("new_admin", {
  # tests for the property `new_admin` (character)
  # 

  # uncomment below to test the property
  #expect_equal(model.instance$`new_admin`, "EXPECTED_RESULT")
})
