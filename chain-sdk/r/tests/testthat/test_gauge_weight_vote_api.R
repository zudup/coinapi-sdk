...
context("Test GaugeWeightVoteApi")

api_instance <- GaugeWeightVoteApi$new()

test_that("ChainsChainIdDappsCurveGaugeWeightVoteHistoricalGet", {
  # tests for ChainsChainIdDappsCurveGaugeWeightVoteHistoricalGet
