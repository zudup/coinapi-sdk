...
context("Test AddLiquidityEventApi")

api_instance <- AddLiquidityEventApi$new()

test_that("ChainsChainIdDappsCurveAddLiquidityEventHistoricalGet", {
  # tests for ChainsChainIdDappsCurveAddLiquidityEventHistoricalGet
