...
#' @section Methods:
#' \describe{
#' \strong{ ChainsChainIdDappsDexWithdrawHistoricalGet } \emph{  }
#'
#' \itemize{
...
WithdrawApi <- R6::R6Class(
  ...
  public = list(
    ...
    #' @return void
    #' @export
    ChainsChainIdDappsDexWithdrawHistoricalGet = function(chain_id, start_block = NULL, end_block = NULL, start_date = NULL, end_date = NULL, token_id = NULL, ...) {
      local_var_response <- self$ChainsChainIdDappsDexWithdrawHistoricalGetWithHttpInfo(chain_id, start_block, end_block, start_date, end_date, token_id, ...)
    ...
    #' @export
    ChainsChainIdDappsDexWithdrawHistoricalGetWithHttpInfo = function(chain_id, start_block = NULL, end_block = NULL, start_date = NULL, end_date = NULL, token_id = NULL, ...) {
      args <- list(...)
      query_params <- list()
      header_params <- c()
      form_params <- list()
      ...
      local_var_url_path <- "/chains/{chain_id}/dapps/dex/withdraw/historical"
      if (!missing(`chain_id`)) {
