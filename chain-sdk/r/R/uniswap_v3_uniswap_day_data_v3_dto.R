#' Create a new UniswapV3UniswapDayDataV3DTO
#'
#' @description
#' Data accumulated and condensed into day stats for all of Uniswap.
#'
#' @docType class
#' @title UniswapV3UniswapDayDataV3DTO
#' @description UniswapV3UniswapDayDataV3DTO Class
...
#' @export
UniswapV3UniswapDayDataV3DTO <- R6::R6Class(
  ...
  public = list(
    ...
    `tx_count` = NULL,
    `tvl_usd` = NULL,
    #' Initialize a new UniswapV3UniswapDayDataV3DTO class.
    #'
    #' @description
    #' Initialize a new UniswapV3UniswapDayDataV3DTO class.
    #'
    ...
    #' To JSON String
    #'
    #' @return UniswapV3UniswapDayDataV3DTO in JSON format
    #' @export
    toJSON = function() {
      UniswapV3UniswapDayDataV3DTOObject <- list()
      if (!is.null(self$`entry_time`)) {
        UniswapV3UniswapDayDataV3DTOObject[["entry_time"]] <-
          self$`entry_time`
      }
      if (!is.null(self$`recv_time`)) {
        UniswapV3UniswapDayDataV3DTOObject[["recv_time"]] <-
          self$`recv_time`
      }
      if (!is.null(self$`block_number`)) {
        UniswapV3UniswapDayDataV3DTOObject[["block_number"]] <-
          self$`block_number`
      }
      if (!is.null(self$`vid`)) {
        UniswapV3UniswapDayDataV3DTOObject[["vid"]] <-
          self$`vid`
      }
      if (!is.null(self$`id`)) {
        UniswapV3UniswapDayDataV3DTOObject[["id"]] <-
          self$`id`
      }
      if (!is.null(self$`date`)) {
        UniswapV3UniswapDayDataV3DTOObject[["date"]] <-
          self$`date`
      }
      if (!is.null(self$`volume_eth`)) {
        UniswapV3UniswapDayDataV3DTOObject[["volume_eth"]] <-
          self$`volume_eth`
      }
      if (!is.null(self$`volume_usd`)) {
        UniswapV3UniswapDayDataV3DTOObject[["volume_usd"]] <-
          self$`volume_usd`
      }
      if (!is.null(self$`volume_usd_untracked`)) {
        UniswapV3UniswapDayDataV3DTOObject[["volume_usd_untracked"]] <-
          self$`volume_usd_untracked`
      }
      if (!is.null(self$`fees_usd`)) {
        UniswapV3UniswapDayDataV3DTOObject[["fees_usd"]] <-
          self$`fees_usd`
      }
      if (!is.null(self$`tx_count`)) {
        UniswapV3UniswapDayDataV3DTOObject[["tx_count"]] <-
          self$`tx_count`$toJSON()
      }
      if (!is.null(self$`tvl_usd`)) {
        UniswapV3UniswapDayDataV3DTOObject[["tvl_usd"]] <-
          self$`tvl_usd`
      }
      UniswapV3UniswapDayDataV3DTOObject
    },
    #' Deserialize JSON string into an instance of UniswapV3UniswapDayDataV3DTO
    #'
    #' @description
    #' Deserialize JSON string into an instance of UniswapV3UniswapDayDataV3DTO
    #'
    #' @param input_json the JSON input
    #' @return the instance of UniswapV3UniswapDayDataV3DTO
    #' @export
    ...
    #' Validate JSON input with respect to UniswapV3UniswapDayDataV3DTO
    #'
    #' @description
    #' Validate JSON input with respect to UniswapV3UniswapDayDataV3DTO and throw an exception if invalid
    #'
    ...
    #' To string (JSON format)
    #'
    #' @return String representation of UniswapV3UniswapDayDataV3DTO
    #' @export
    toString = function() {
      self$toJSONString()
    },
...
# UniswapV3UniswapDayDataV3DTO$unlock()
#
## Below is an example to define the print fnuction
# UniswapV3UniswapDayDataV3DTO$set("public", "print", function(...) {
#   print(jsonlite::prettify(self$toJSONString()))
#   invisible(self)
# })
## Uncomment below to lock the class to prevent modifications to the method or field
# UniswapV3UniswapDayDataV3DTO$lock()
