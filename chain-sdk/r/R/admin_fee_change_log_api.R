...
#'
#' @docType class
#' @title AdminFeeChangeLog operations
#' @description AdminFeeChangeLogApi
#' @format An \code{R6Class} generator object
#' @field api_client Handles the client-server communication.
#'
#' @section Methods:
#' \describe{
#' \strong{ ChainsChainIdDappsCurveAdminFeeChangeLogHistoricalGet } \emph{  }
#'
#' \itemize{
...
#' @export
AdminFeeChangeLogApi <- R6::R6Class(
  "AdminFeeChangeLogApi",
  public = list(
    api_client = NULL,
    #' Initialize a new AdminFeeChangeLogApi.
    #'
    #' @description
    #' Initialize a new AdminFeeChangeLogApi.
    #'
    ...
    #' @return void
    #' @export
    ChainsChainIdDappsCurveAdminFeeChangeLogHistoricalGet = function(chain_id, start_block = NULL, end_block = NULL, start_date = NULL, end_date = NULL, pool_id = NULL, ...) {
      local_var_response <- self$ChainsChainIdDappsCurveAdminFeeChangeLogHistoricalGetWithHttpInfo(chain_id, start_block, end_block, start_date, end_date, pool_id, ...)
    ...
    #' @export
    ChainsChainIdDappsCurveAdminFeeChangeLogHistoricalGetWithHttpInfo = function(chain_id, start_block = NULL, end_block = NULL, start_date = NULL, end_date = NULL, pool_id = NULL, ...) {
      args <- list(...)
      query_params <- list()
      header_params <- c()
      form_params <- list()
      ...
      local_var_url_path <- "/chains/{chain_id}/dapps/curve/adminFeeChangeLog/historical"
      if (!missing(`chain_id`)) {
