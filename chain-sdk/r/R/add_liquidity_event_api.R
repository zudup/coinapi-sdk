...
#'
#' @docType class
#' @title AddLiquidityEvent operations
#' @description AddLiquidityEventApi
#' @format An \code{R6Class} generator object
#' @field api_client Handles the client-server communication.
#'
#' @section Methods:
#' \describe{
#' \strong{ ChainsChainIdDappsCurveAddLiquidityEventHistoricalGet } \emph{  }
#'
#' \itemize{
...
#' @export
AddLiquidityEventApi <- R6::R6Class(
  "AddLiquidityEventApi",
  public = list(
    api_client = NULL,
    #' Initialize a new AddLiquidityEventApi.
    #'
    #' @description
    #' Initialize a new AddLiquidityEventApi.
    #'
    ...
    #' @return void
    #' @export
    ChainsChainIdDappsCurveAddLiquidityEventHistoricalGet = function(chain_id, start_block = NULL, end_block = NULL, start_date = NULL, end_date = NULL, pool_id = NULL, ...) {
      local_var_response <- self$ChainsChainIdDappsCurveAddLiquidityEventHistoricalGetWithHttpInfo(chain_id, start_block, end_block, start_date, end_date, pool_id, ...)
    ...
    #' @export
    ChainsChainIdDappsCurveAddLiquidityEventHistoricalGetWithHttpInfo = function(chain_id, start_block = NULL, end_block = NULL, start_date = NULL, end_date = NULL, pool_id = NULL, ...) {
      args <- list(...)
      query_params <- list()
      header_params <- c()
      form_params <- list()
      ...
      local_var_url_path <- "/chains/{chain_id}/dapps/curve/addLiquidityEvent/historical"
      if (!missing(`chain_id`)) {
