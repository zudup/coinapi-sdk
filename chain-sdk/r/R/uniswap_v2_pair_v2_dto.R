#' Create a new UniswapV2PairV2DTO
#'
#' @description
#' Information about a pair. Includes references to each token within the pair, volume information, liquidity information, and more. The pair entity mirrors the pair smart contract, and also contains aggregated information about use.
#'
#' @docType class
#' @title UniswapV2PairV2DTO
#' @description UniswapV2PairV2DTO Class
...
UniswapV2PairV2DTO <- R6::R6Class(
  ...
  public = list(
    ...
    `evaluated_ask` = NULL,
    #' Initialize a new UniswapV2PairV2DTO class.
    #'
    #' @description
    #' Initialize a new UniswapV2PairV2DTO class.
    #'
    ...
    #' To JSON String
    #'
    #' @return UniswapV2PairV2DTO in JSON format
    #' @export
    toJSON = function() {
      UniswapV2PairV2DTOObject <- list()
      if (!is.null(self$`entry_time`)) {
        UniswapV2PairV2DTOObject[["entry_time"]] <-
          self$`entry_time`
      }
      if (!is.null(self$`recv_time`)) {
        UniswapV2PairV2DTOObject[["recv_time"]] <-
          self$`recv_time`
      }
      if (!is.null(self$`block_number`)) {
        UniswapV2PairV2DTOObject[["block_number"]] <-
          self$`block_number`
      }
      if (!is.null(self$`vid`)) {
        UniswapV2PairV2DTOObject[["vid"]] <-
          self$`vid`
      }
      if (!is.null(self$`id`)) {
        UniswapV2PairV2DTOObject[["id"]] <-
          self$`id`
      }
      if (!is.null(self$`token_0`)) {
        UniswapV2PairV2DTOObject[["token_0"]] <-
          self$`token_0`
      }
      if (!is.null(self$`token_1`)) {
        UniswapV2PairV2DTOObject[["token_1"]] <-
          self$`token_1`
      }
      if (!is.null(self$`reserve_0`)) {
        UniswapV2PairV2DTOObject[["reserve_0"]] <-
          self$`reserve_0`
      }
      if (!is.null(self$`reserve_1`)) {
        UniswapV2PairV2DTOObject[["reserve_1"]] <-
          self$`reserve_1`
      }
      if (!is.null(self$`total_supply`)) {
        UniswapV2PairV2DTOObject[["total_supply"]] <-
          self$`total_supply`
      }
      if (!is.null(self$`reserve_eth`)) {
        UniswapV2PairV2DTOObject[["reserve_eth"]] <-
          self$`reserve_eth`
      }
      if (!is.null(self$`reserve_usd`)) {
        UniswapV2PairV2DTOObject[["reserve_usd"]] <-
          self$`reserve_usd`
      }
      if (!is.null(self$`tracked_reserve_eth`)) {
        UniswapV2PairV2DTOObject[["tracked_reserve_eth"]] <-
          self$`tracked_reserve_eth`
      }
      if (!is.null(self$`token_0_price`)) {
        UniswapV2PairV2DTOObject[["token_0_price"]] <-
          self$`token_0_price`
      }
      if (!is.null(self$`token_1_price`)) {
        UniswapV2PairV2DTOObject[["token_1_price"]] <-
          self$`token_1_price`
      }
      if (!is.null(self$`volume_token_0`)) {
        UniswapV2PairV2DTOObject[["volume_token_0"]] <-
          self$`volume_token_0`
      }
      if (!is.null(self$`volume_token_1`)) {
        UniswapV2PairV2DTOObject[["volume_token_1"]] <-
          self$`volume_token_1`
      }
      if (!is.null(self$`volume_usd`)) {
        UniswapV2PairV2DTOObject[["volume_usd"]] <-
          self$`volume_usd`
      }
      if (!is.null(self$`untracked_volume_usd`)) {
        UniswapV2PairV2DTOObject[["untracked_volume_usd"]] <-
          self$`untracked_volume_usd`
      }
      if (!is.null(self$`tx_count`)) {
        UniswapV2PairV2DTOObject[["tx_count"]] <-
          self$`tx_count`$toJSON()
      }
      if (!is.null(self$`created_at_timestamp`)) {
        UniswapV2PairV2DTOObject[["created_at_timestamp"]] <-
          self$`created_at_timestamp`
      }
      if (!is.null(self$`liquidity_provider_count`)) {
        UniswapV2PairV2DTOObject[["liquidity_provider_count"]] <-
          self$`liquidity_provider_count`
      }
      if (!is.null(self$`evaluated_ask`)) {
        UniswapV2PairV2DTOObject[["evaluated_ask"]] <-
          self$`evaluated_ask`
      }
      UniswapV2PairV2DTOObject
    },
    #' Deserialize JSON string into an instance of UniswapV2PairV2DTO
    #'
    #' @description
    #' Deserialize JSON string into an instance of UniswapV2PairV2DTO
    #'
    #' @param input_json the JSON input
    #' @return the instance of UniswapV2PairV2DTO
    #' @export
    ...
    #' Validate JSON input with respect to UniswapV2PairV2DTO
    #'
    #' @description
    #' Validate JSON input with respect to UniswapV2PairV2DTO and throw an exception if invalid
    #'
    ...
    #' To string (JSON format)
    #'
    #' @return String representation of UniswapV2PairV2DTO
    #' @export
    toString = function() {
      self$toJSONString()
    },
...
# UniswapV2PairV2DTO$unlock()
#
## Below is an example to define the print fnuction
# UniswapV2PairV2DTO$set("public", "print", function(...) {
#   print(jsonlite::prettify(self$toJSONString()))
#   invisible(self)
# })
## Uncomment below to lock the class to prevent modifications to the method or field
# UniswapV2PairV2DTO$lock()
