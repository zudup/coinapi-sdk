...
#'
#' @docType class
#' @title Ticks operations
#' @description TicksApi
#' @format An \code{R6Class} generator object
#' @field api_client Handles the client-server communication.
#'
#' @section Methods:
#' \describe{
#' \strong{ ChainsChainIdDappsUniswapv3TicksHistoricalGet } \emph{  }
#'
#' \itemize{
...
TicksApi <- R6::R6Class(
  ...
  public = list(
    ...
    #' @return void
    #' @export
    ChainsChainIdDappsUniswapv3TicksHistoricalGet = function(chain_id, start_block = NULL, end_block = NULL, start_date = NULL, end_date = NULL, pool_id = NULL, ...) {
      local_var_response <- self$ChainsChainIdDappsUniswapv3TicksHistoricalGetWithHttpInfo(chain_id, start_block, end_block, start_date, end_date, pool_id, ...)
    ...
    #' @export
    ChainsChainIdDappsUniswapv3TicksHistoricalGetWithHttpInfo = function(chain_id, start_block = NULL, end_block = NULL, start_date = NULL, end_date = NULL, pool_id = NULL, ...) {
      args <- list(...)
      query_params <- list()
      header_params <- c()
      form_params <- list()
      ...
      local_var_url_path <- "/chains/{chain_id}/dapps/uniswapv3/ticks/historical"
      if (!missing(`chain_id`)) {
