...
#'
#' @docType class
#' @title ProposalsVote operations
#' @description ProposalsVoteApi
#' @format An \code{R6Class} generator object
#' @field api_client Handles the client-server communication.
#'
#' @section Methods:
#' \describe{
#' \strong{ ChainsChainIdDappsCurveProposalsVoteHistoricalGet } \emph{  }
#'
#' \itemize{
...
#' @export
ProposalsVoteApi <- R6::R6Class(
  "ProposalsVoteApi",
  public = list(
    api_client = NULL,
    #' Initialize a new ProposalsVoteApi.
    #'
    #' @description
    #' Initialize a new ProposalsVoteApi.
    #'
    ...
    #' @return void
    #' @export
    ChainsChainIdDappsCurveProposalsVoteHistoricalGet = function(chain_id, start_block = NULL, end_block = NULL, start_date = NULL, end_date = NULL, ...) {
      local_var_response <- self$ChainsChainIdDappsCurveProposalsVoteHistoricalGetWithHttpInfo(chain_id, start_block, end_block, start_date, end_date, ...)
    ...
    #' @export
    ChainsChainIdDappsCurveProposalsVoteHistoricalGetWithHttpInfo = function(chain_id, start_block = NULL, end_block = NULL, start_date = NULL, end_date = NULL, ...) {
      args <- list(...)
      query_params <- list()
      header_params <- c()
      form_params <- list()
      ...
      local_var_url_path <- "/chains/{chain_id}/dapps/curve/proposalsVote/historical"
      if (!missing(`chain_id`)) {
