#' Create a new UniswapV3TokenHourDataV3DTO
#'
#' @description
#' Token data aggregated across all pairs that include token.
#'
#' @docType class
#' @title UniswapV3TokenHourDataV3DTO
#' @description UniswapV3TokenHourDataV3DTO Class
...
#' @export
UniswapV3TokenHourDataV3DTO <- R6::R6Class(
  ...
  public = list(
    ...
    `close` = NULL,
    `vid` = NULL,
    #' Initialize a new UniswapV3TokenHourDataV3DTO class.
    #'
    #' @description
    #' Initialize a new UniswapV3TokenHourDataV3DTO class.
    #'
    ...
    #' To JSON String
    #'
    #' @return UniswapV3TokenHourDataV3DTO in JSON format
    #' @export
    toJSON = function() {
      UniswapV3TokenHourDataV3DTOObject <- list()
      if (!is.null(self$`entry_time`)) {
        UniswapV3TokenHourDataV3DTOObject[["entry_time"]] <-
          self$`entry_time`
      }
      if (!is.null(self$`recv_time`)) {
        UniswapV3TokenHourDataV3DTOObject[["recv_time"]] <-
          self$`recv_time`
      }
      if (!is.null(self$`block_number`)) {
        UniswapV3TokenHourDataV3DTOObject[["block_number"]] <-
          self$`block_number`
      }
      if (!is.null(self$`id`)) {
        UniswapV3TokenHourDataV3DTOObject[["id"]] <-
          self$`id`
      }
      if (!is.null(self$`period_start_unix`)) {
        UniswapV3TokenHourDataV3DTOObject[["period_start_unix"]] <-
          self$`period_start_unix`
      }
      if (!is.null(self$`token`)) {
        UniswapV3TokenHourDataV3DTOObject[["token"]] <-
          self$`token`
      }
      if (!is.null(self$`volume`)) {
        UniswapV3TokenHourDataV3DTOObject[["volume"]] <-
          self$`volume`
      }
      if (!is.null(self$`volume_usd`)) {
        UniswapV3TokenHourDataV3DTOObject[["volume_usd"]] <-
          self$`volume_usd`
      }
      if (!is.null(self$`untracked_volume_usd`)) {
        UniswapV3TokenHourDataV3DTOObject[["untracked_volume_usd"]] <-
          self$`untracked_volume_usd`
      }
      if (!is.null(self$`total_value_locked`)) {
        UniswapV3TokenHourDataV3DTOObject[["total_value_locked"]] <-
          self$`total_value_locked`
      }
      if (!is.null(self$`total_value_locked_usd`)) {
        UniswapV3TokenHourDataV3DTOObject[["total_value_locked_usd"]] <-
          self$`total_value_locked_usd`
      }
      if (!is.null(self$`price_usd`)) {
        UniswapV3TokenHourDataV3DTOObject[["price_usd"]] <-
          self$`price_usd`
      }
      if (!is.null(self$`fees_usd`)) {
        UniswapV3TokenHourDataV3DTOObject[["fees_usd"]] <-
          self$`fees_usd`
      }
      if (!is.null(self$`open`)) {
        UniswapV3TokenHourDataV3DTOObject[["open"]] <-
          self$`open`
      }
      if (!is.null(self$`high`)) {
        UniswapV3TokenHourDataV3DTOObject[["high"]] <-
          self$`high`
      }
      if (!is.null(self$`low`)) {
        UniswapV3TokenHourDataV3DTOObject[["low"]] <-
          self$`low`
      }
      if (!is.null(self$`close`)) {
        UniswapV3TokenHourDataV3DTOObject[["close"]] <-
          self$`close`
      }
      if (!is.null(self$`vid`)) {
        UniswapV3TokenHourDataV3DTOObject[["vid"]] <-
          self$`vid`
      }
      UniswapV3TokenHourDataV3DTOObject
    },
    #' Deserialize JSON string into an instance of UniswapV3TokenHourDataV3DTO
    #'
    #' @description
    #' Deserialize JSON string into an instance of UniswapV3TokenHourDataV3DTO
    #'
    #' @param input_json the JSON input
    #' @return the instance of UniswapV3TokenHourDataV3DTO
    #' @export
    ...
    #' Validate JSON input with respect to UniswapV3TokenHourDataV3DTO
    #'
    #' @description
    #' Validate JSON input with respect to UniswapV3TokenHourDataV3DTO and throw an exception if invalid
    #'
    ...
    #' To string (JSON format)
    #'
    #' @return String representation of UniswapV3TokenHourDataV3DTO
    #' @export
    toString = function() {
      self$toJSONString()
    },
...
# UniswapV3TokenHourDataV3DTO$unlock()
#
## Below is an example to define the print fnuction
# UniswapV3TokenHourDataV3DTO$set("public", "print", function(...) {
#   print(jsonlite::prettify(self$toJSONString()))
#   invisible(self)
# })
## Uncomment below to lock the class to prevent modifications to the method or field
# UniswapV3TokenHourDataV3DTO$lock()
