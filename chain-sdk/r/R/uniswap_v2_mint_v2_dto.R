#' Create a new UniswapV2MintV2DTO
#'
#' @description
...
#'
#' @docType class
#' @title UniswapV2MintV2DTO
#' @description UniswapV2MintV2DTO Class
...
UniswapV2MintV2DTO <- R6::R6Class(
  ...
  public = list(
    ...
    `vid` = NULL,
    `block_range` = NULL,
    #' Initialize a new UniswapV2MintV2DTO class.
    #'
    #' @description
    #' Initialize a new UniswapV2MintV2DTO class.
    #'
    ...
    #' To JSON String
    #'
    #' @return UniswapV2MintV2DTO in JSON format
    #' @export
    toJSON = function() {
      UniswapV2MintV2DTOObject <- list()
      if (!is.null(self$`entry_time`)) {
        UniswapV2MintV2DTOObject[["entry_time"]] <-
          self$`entry_time`
      }
      if (!is.null(self$`recv_time`)) {
        UniswapV2MintV2DTOObject[["recv_time"]] <-
          self$`recv_time`
      }
      if (!is.null(self$`block_number`)) {
        UniswapV2MintV2DTOObject[["block_number"]] <-
          self$`block_number`
      }
      if (!is.null(self$`id`)) {
        UniswapV2MintV2DTOObject[["id"]] <-
          self$`id`
      }
      if (!is.null(self$`transaction`)) {
        UniswapV2MintV2DTOObject[["transaction"]] <-
          self$`transaction`
      }
      if (!is.null(self$`timestamp`)) {
        UniswapV2MintV2DTOObject[["timestamp"]] <-
          self$`timestamp`
      }
      if (!is.null(self$`pair`)) {
        UniswapV2MintV2DTOObject[["pair"]] <-
          self$`pair`
      }
      if (!is.null(self$`to`)) {
        UniswapV2MintV2DTOObject[["to"]] <-
          self$`to`
      }
      if (!is.null(self$`liquidity`)) {
        UniswapV2MintV2DTOObject[["liquidity"]] <-
          self$`liquidity`
      }
      if (!is.null(self$`sender`)) {
        UniswapV2MintV2DTOObject[["sender"]] <-
          self$`sender`
      }
      if (!is.null(self$`amount_0`)) {
        UniswapV2MintV2DTOObject[["amount_0"]] <-
          self$`amount_0`
      }
      if (!is.null(self$`amount_1`)) {
        UniswapV2MintV2DTOObject[["amount_1"]] <-
          self$`amount_1`
      }
      if (!is.null(self$`log_index`)) {
        UniswapV2MintV2DTOObject[["log_index"]] <-
          self$`log_index`
      }
      if (!is.null(self$`amount_usd`)) {
        UniswapV2MintV2DTOObject[["amount_usd"]] <-
          self$`amount_usd`
      }
      if (!is.null(self$`fee_to`)) {
        UniswapV2MintV2DTOObject[["fee_to"]] <-
          self$`fee_to`
      }
      if (!is.null(self$`fee_liquidity`)) {
        UniswapV2MintV2DTOObject[["fee_liquidity"]] <-
          self$`fee_liquidity`
      }
      if (!is.null(self$`vid`)) {
        UniswapV2MintV2DTOObject[["vid"]] <-
          self$`vid`
      }
      if (!is.null(self$`block_range`)) {
        UniswapV2MintV2DTOObject[["block_range"]] <-
          self$`block_range`
      }
      UniswapV2MintV2DTOObject
    },
    #' Deserialize JSON string into an instance of UniswapV2MintV2DTO
    #'
    #' @description
    #' Deserialize JSON string into an instance of UniswapV2MintV2DTO
    #'
    #' @param input_json the JSON input
    #' @return the instance of UniswapV2MintV2DTO
    #' @export
    ...
    #' Validate JSON input with respect to UniswapV2MintV2DTO
    #'
    #' @description
    #' Validate JSON input with respect to UniswapV2MintV2DTO and throw an exception if invalid
    #'
    ...
    #' To string (JSON format)
    #'
    #' @return String representation of UniswapV2MintV2DTO
    #' @export
    toString = function() {
      self$toJSONString()
    },
...
# UniswapV2MintV2DTO$unlock()
#
## Below is an example to define the print fnuction
# UniswapV2MintV2DTO$set("public", "print", function(...) {
#   print(jsonlite::prettify(self$toJSONString()))
#   invisible(self)
# })
## Uncomment below to lock the class to prevent modifications to the method or field
# UniswapV2MintV2DTO$lock()
