...
#'
#' @docType class
#' @title TransferOwnershipEvent operations
#' @description TransferOwnershipEventApi
#' @format An \code{R6Class} generator object
#' @field api_client Handles the client-server communication.
#'
#' @section Methods:
#' \describe{
#' \strong{ ChainsChainIdDappsCurveTransferOwnershipEventHistoricalGet } \emph{  }
#'
#' \itemize{
...
#' @export
TransferOwnershipEventApi <- R6::R6Class(
  "TransferOwnershipEventApi",
  public = list(
    api_client = NULL,
    #' Initialize a new TransferOwnershipEventApi.
    #'
    #' @description
    #' Initialize a new TransferOwnershipEventApi.
    #'
    ...
    #' @return void
    #' @export
    ChainsChainIdDappsCurveTransferOwnershipEventHistoricalGet = function(chain_id, start_block = NULL, end_block = NULL, start_date = NULL, end_date = NULL, pool_id = NULL, ...) {
      local_var_response <- self$ChainsChainIdDappsCurveTransferOwnershipEventHistoricalGetWithHttpInfo(chain_id, start_block, end_block, start_date, end_date, pool_id, ...)
    ...
    #' @export
    ChainsChainIdDappsCurveTransferOwnershipEventHistoricalGetWithHttpInfo = function(chain_id, start_block = NULL, end_block = NULL, start_date = NULL, end_date = NULL, pool_id = NULL, ...) {
      args <- list(...)
      query_params <- list()
      header_params <- c()
      form_params <- list()
      ...
      local_var_url_path <- "/chains/{chain_id}/dapps/curve/transferOwnershipEvent/historical"
      if (!missing(`chain_id`)) {
