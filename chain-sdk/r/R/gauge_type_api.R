...
#'
#' @docType class
#' @title GaugeType operations
#' @description GaugeTypeApi
#' @format An \code{R6Class} generator object
#' @field api_client Handles the client-server communication.
#'
#' @section Methods:
#' \describe{
#' \strong{ ChainsChainIdDappsCurveGaugeTypeHistoricalGet } \emph{  }
#'
#' \itemize{
...
#' @export
GaugeTypeApi <- R6::R6Class(
  "GaugeTypeApi",
  public = list(
    api_client = NULL,
    #' Initialize a new GaugeTypeApi.
    #'
    #' @description
    #' Initialize a new GaugeTypeApi.
    #'
    ...
    #' @return void
    #' @export
    ChainsChainIdDappsCurveGaugeTypeHistoricalGet = function(chain_id, start_block = NULL, end_block = NULL, start_date = NULL, end_date = NULL, ...) {
      local_var_response <- self$ChainsChainIdDappsCurveGaugeTypeHistoricalGetWithHttpInfo(chain_id, start_block, end_block, start_date, end_date, ...)
    ...
    #' @export
    ChainsChainIdDappsCurveGaugeTypeHistoricalGetWithHttpInfo = function(chain_id, start_block = NULL, end_block = NULL, start_date = NULL, end_date = NULL, ...) {
      args <- list(...)
      query_params <- list()
      header_params <- c()
      form_params <- list()
      ...
      local_var_url_path <- "/chains/{chain_id}/dapps/curve/gaugeType/historical"
      if (!missing(`chain_id`)) {
