#' Create a new UniswapV3PositionSnapshotV3DTO
#'
#' @description
#' UniswapV3PositionSnapshotV3DTO Class
#'
#' @docType class
#' @title UniswapV3PositionSnapshotV3DTO
#' @description UniswapV3PositionSnapshotV3DTO Class
...
#' @export
UniswapV3PositionSnapshotV3DTO <- R6::R6Class(
  ...
  public = list(
    ...
    `vid` = NULL,
    #' Initialize a new UniswapV3PositionSnapshotV3DTO class.
    #'
    #' @description
    #' Initialize a new UniswapV3PositionSnapshotV3DTO class.
    #'
    ...
    #' To JSON String
    #'
    #' @return UniswapV3PositionSnapshotV3DTO in JSON format
    #' @export
    toJSON = function() {
      UniswapV3PositionSnapshotV3DTOObject <- list()
      if (!is.null(self$`entry_time`)) {
        UniswapV3PositionSnapshotV3DTOObject[["entry_time"]] <-
          self$`entry_time`
      }
      if (!is.null(self$`recv_time`)) {
        UniswapV3PositionSnapshotV3DTOObject[["recv_time"]] <-
          self$`recv_time`
      }
      if (!is.null(self$`block_number`)) {
        UniswapV3PositionSnapshotV3DTOObject[["block_number"]] <-
          self$`block_number`
      }
      if (!is.null(self$`id`)) {
        UniswapV3PositionSnapshotV3DTOObject[["id"]] <-
          self$`id`
      }
      if (!is.null(self$`owner`)) {
        UniswapV3PositionSnapshotV3DTOObject[["owner"]] <-
          self$`owner`
      }
      if (!is.null(self$`pool`)) {
        UniswapV3PositionSnapshotV3DTOObject[["pool"]] <-
          self$`pool`
      }
      if (!is.null(self$`position`)) {
        UniswapV3PositionSnapshotV3DTOObject[["position"]] <-
          self$`position`
      }
      if (!is.null(self$`timestamp`)) {
        UniswapV3PositionSnapshotV3DTOObject[["timestamp"]] <-
          self$`timestamp`
      }
      if (!is.null(self$`liquidity`)) {
        UniswapV3PositionSnapshotV3DTOObject[["liquidity"]] <-
          self$`liquidity`
      }
      if (!is.null(self$`deposited_token_0`)) {
        UniswapV3PositionSnapshotV3DTOObject[["deposited_token_0"]] <-
          self$`deposited_token_0`
      }
      if (!is.null(self$`deposited_token_1`)) {
        UniswapV3PositionSnapshotV3DTOObject[["deposited_token_1"]] <-
          self$`deposited_token_1`
      }
      if (!is.null(self$`withdrawn_token_0`)) {
        UniswapV3PositionSnapshotV3DTOObject[["withdrawn_token_0"]] <-
          self$`withdrawn_token_0`
      }
      if (!is.null(self$`withdrawn_token_1`)) {
        UniswapV3PositionSnapshotV3DTOObject[["withdrawn_token_1"]] <-
          self$`withdrawn_token_1`
      }
      if (!is.null(self$`collected_fees_token_0`)) {
        UniswapV3PositionSnapshotV3DTOObject[["collected_fees_token_0"]] <-
          self$`collected_fees_token_0`
      }
      if (!is.null(self$`collected_fees_token_1`)) {
        UniswapV3PositionSnapshotV3DTOObject[["collected_fees_token_1"]] <-
          self$`collected_fees_token_1`
      }
      if (!is.null(self$`transaction`)) {
        UniswapV3PositionSnapshotV3DTOObject[["transaction"]] <-
          self$`transaction`
      }
      if (!is.null(self$`fee_growth_inside_0_last_x128`)) {
        UniswapV3PositionSnapshotV3DTOObject[["fee_growth_inside_0_last_x128"]] <-
          self$`fee_growth_inside_0_last_x128`
      }
      if (!is.null(self$`fee_growth_inside_1_last_x128`)) {
        UniswapV3PositionSnapshotV3DTOObject[["fee_growth_inside_1_last_x128"]] <-
          self$`fee_growth_inside_1_last_x128`
      }
      if (!is.null(self$`vid`)) {
        UniswapV3PositionSnapshotV3DTOObject[["vid"]] <-
          self$`vid`
      }
      UniswapV3PositionSnapshotV3DTOObject
    },
    #' Deserialize JSON string into an instance of UniswapV3PositionSnapshotV3DTO
    #'
    #' @description
    #' Deserialize JSON string into an instance of UniswapV3PositionSnapshotV3DTO
    #'
    #' @param input_json the JSON input
    #' @return the instance of UniswapV3PositionSnapshotV3DTO
    #' @export
    ...
    #' Validate JSON input with respect to UniswapV3PositionSnapshotV3DTO
    #'
    #' @description
    #' Validate JSON input with respect to UniswapV3PositionSnapshotV3DTO and throw an exception if invalid
    #'
    ...
    #' To string (JSON format)
    #'
    #' @return String representation of UniswapV3PositionSnapshotV3DTO
    #' @export
    toString = function() {
      self$toJSONString()
    },
...
# UniswapV3PositionSnapshotV3DTO$unlock()
#
## Below is an example to define the print fnuction
# UniswapV3PositionSnapshotV3DTO$set("public", "print", function(...) {
#   print(jsonlite::prettify(self$toJSONString()))
#   invisible(self)
# })
## Uncomment below to lock the class to prevent modifications to the method or field
# UniswapV3PositionSnapshotV3DTO$lock()
