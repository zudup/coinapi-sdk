...
MintV3DTO <- R6::R6Class(
  ...
  public = list(
    ...
    `log_index` = NULL,
    `vid` = NULL,
    #' Initialize a new MintV3DTO class.
    #'
    #' @description
    #' Initialize a new MintV3DTO class.
    #'
    ...
    #' @export
    initialize = function(
        `entry_time` = NULL, `recv_time` = NULL, `block_number` = NULL, `id` = NULL, `transaction` = NULL, `timestamp` = NULL, `pool` = NULL, `token_0` = NULL, `token_1` = NULL, `owner` = NULL, `sender` = NULL, `origin` = NULL, `amount` = NULL, `amount_0` = NULL, `amount_1` = NULL, `amount_usd` = NULL, `tick_lower` = NULL, `tick_upper` = NULL, `log_index` = NULL, `vid` = NULL, ...
    ) {
    ...
    #' To JSON String
    #'
    #' @return MintV3DTO in JSON format
    #' @export
    toJSON = function() {
      MintV3DTOObject <- list()
      if (!is.null(self$`entry_time`)) {
        MintV3DTOObject[["entry_time"]] <-
          self$`entry_time`
      }
      if (!is.null(self$`recv_time`)) {
        MintV3DTOObject[["recv_time"]] <-
          self$`recv_time`
      }
      if (!is.null(self$`block_number`)) {
        MintV3DTOObject[["block_number"]] <-
          self$`block_number`
      }
      if (!is.null(self$`id`)) {
        MintV3DTOObject[["id"]] <-
      ...
      if (!is.null(self$`transaction`)) {
        MintV3DTOObject[["transaction"]] <-
          self$`transaction`
      }
      if (!is.null(self$`timestamp`)) {
        MintV3DTOObject[["timestamp"]] <-
          self$`timestamp`
      }
      if (!is.null(self$`pool`)) {
        MintV3DTOObject[["pool"]] <-
          self$`pool`
      }
      if (!is.null(self$`token_0`)) {
        MintV3DTOObject[["token_0"]] <-
          self$`token_0`
      }
      if (!is.null(self$`token_1`)) {
        MintV3DTOObject[["token_1"]] <-
          self$`token_1`
      }
      if (!is.null(self$`owner`)) {
        MintV3DTOObject[["owner"]] <-
          self$`owner`
      }
      if (!is.null(self$`sender`)) {
        MintV3DTOObject[["sender"]] <-
          self$`sender`
      }
      if (!is.null(self$`origin`)) {
        MintV3DTOObject[["origin"]] <-
          self$`origin`
      }
      if (!is.null(self$`amount`)) {
        MintV3DTOObject[["amount"]] <-
          self$`amount`
      }
      if (!is.null(self$`amount_0`)) {
        MintV3DTOObject[["amount_0"]] <-
          self$`amount_0`
      }
      if (!is.null(self$`amount_1`)) {
        MintV3DTOObject[["amount_1"]] <-
          self$`amount_1`
      }
      if (!is.null(self$`amount_usd`)) {
        MintV3DTOObject[["amount_usd"]] <-
          self$`amount_usd`
      }
      if (!is.null(self$`tick_lower`)) {
        MintV3DTOObject[["tick_lower"]] <-
          self$`tick_lower`
      }
      if (!is.null(self$`tick_upper`)) {
        MintV3DTOObject[["tick_upper"]] <-
          self$`tick_upper`
      }
      if (!is.null(self$`log_index`)) {
        MintV3DTOObject[["log_index"]] <-
          self$`log_index`
      }
      if (!is.null(self$`vid`)) {
        MintV3DTOObject[["vid"]] <-
    ...
    #' Deserialize JSON string into an instance of MintV3DTO
    #'
    #' @description
    #' Deserialize JSON string into an instance of MintV3DTO
    #'
    #' @param input_json the JSON input
    #' @return the instance of MintV3DTO
    #' @export
    ...
    #' Validate JSON input with respect to MintV3DTO
    #'
    #' @description
    #' Validate JSON input with respect to MintV3DTO and throw an exception if invalid
    #'
    ...
    #' To string (JSON format)
    #'
    #' @return String representation of MintV3DTO
    #' @export
    toString = function() {
      self$toJSONString()
    },
...
#MintV3DTO$set("public", "print", function(...) {
#  print(jsonlite::prettify(self$toJSONString()))
#  invisible(self)
#})
