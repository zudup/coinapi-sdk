#' Create a new UniswapV3PoolHourDataV3DTO
#'
#' @description
#' Hourly stats tracker for pool.
#'
#' @docType class
#' @title UniswapV3PoolHourDataV3DTO
#' @description UniswapV3PoolHourDataV3DTO Class
...
#' @export
UniswapV3PoolHourDataV3DTO <- R6::R6Class(
  ...
  public = list(
    ...
    `close` = NULL,
    `vid` = NULL,
    #' Initialize a new UniswapV3PoolHourDataV3DTO class.
    #'
    #' @description
    #' Initialize a new UniswapV3PoolHourDataV3DTO class.
    #'
    ...
    #' To JSON String
    #'
    #' @return UniswapV3PoolHourDataV3DTO in JSON format
    #' @export
    toJSON = function() {
      UniswapV3PoolHourDataV3DTOObject <- list()
      if (!is.null(self$`entry_time`)) {
        UniswapV3PoolHourDataV3DTOObject[["entry_time"]] <-
          self$`entry_time`
      }
      if (!is.null(self$`recv_time`)) {
        UniswapV3PoolHourDataV3DTOObject[["recv_time"]] <-
          self$`recv_time`
      }
      if (!is.null(self$`block_number`)) {
        UniswapV3PoolHourDataV3DTOObject[["block_number"]] <-
          self$`block_number`
      }
      if (!is.null(self$`id`)) {
        UniswapV3PoolHourDataV3DTOObject[["id"]] <-
          self$`id`
      }
      if (!is.null(self$`period_start_unix`)) {
        UniswapV3PoolHourDataV3DTOObject[["period_start_unix"]] <-
          self$`period_start_unix`
      }
      if (!is.null(self$`pool`)) {
        UniswapV3PoolHourDataV3DTOObject[["pool"]] <-
          self$`pool`
      }
      if (!is.null(self$`liquidity`)) {
        UniswapV3PoolHourDataV3DTOObject[["liquidity"]] <-
          self$`liquidity`
      }
      if (!is.null(self$`sqrt_price`)) {
        UniswapV3PoolHourDataV3DTOObject[["sqrt_price"]] <-
          self$`sqrt_price`
      }
      if (!is.null(self$`token_0_price`)) {
        UniswapV3PoolHourDataV3DTOObject[["token_0_price"]] <-
          self$`token_0_price`
      }
      if (!is.null(self$`token_1_price`)) {
        UniswapV3PoolHourDataV3DTOObject[["token_1_price"]] <-
          self$`token_1_price`
      }
      if (!is.null(self$`tick`)) {
        UniswapV3PoolHourDataV3DTOObject[["tick"]] <-
          self$`tick`
      }
      if (!is.null(self$`fee_growth_global_0x128`)) {
        UniswapV3PoolHourDataV3DTOObject[["fee_growth_global_0x128"]] <-
          self$`fee_growth_global_0x128`
      }
      if (!is.null(self$`fee_growth_global_1x128`)) {
        UniswapV3PoolHourDataV3DTOObject[["fee_growth_global_1x128"]] <-
          self$`fee_growth_global_1x128`
      }
      if (!is.null(self$`tvl_usd`)) {
        UniswapV3PoolHourDataV3DTOObject[["tvl_usd"]] <-
          self$`tvl_usd`
      }
      if (!is.null(self$`volume_token_0`)) {
        UniswapV3PoolHourDataV3DTOObject[["volume_token_0"]] <-
          self$`volume_token_0`
      }
      if (!is.null(self$`volume_token_1`)) {
        UniswapV3PoolHourDataV3DTOObject[["volume_token_1"]] <-
          self$`volume_token_1`
      }
      if (!is.null(self$`volume_usd`)) {
        UniswapV3PoolHourDataV3DTOObject[["volume_usd"]] <-
          self$`volume_usd`
      }
      if (!is.null(self$`fees_usd`)) {
        UniswapV3PoolHourDataV3DTOObject[["fees_usd"]] <-
          self$`fees_usd`
      }
      if (!is.null(self$`tx_count`)) {
        UniswapV3PoolHourDataV3DTOObject[["tx_count"]] <-
          self$`tx_count`
      }
      if (!is.null(self$`open`)) {
        UniswapV3PoolHourDataV3DTOObject[["open"]] <-
          self$`open`
      }
      if (!is.null(self$`high`)) {
        UniswapV3PoolHourDataV3DTOObject[["high"]] <-
          self$`high`
      }
      if (!is.null(self$`low`)) {
        UniswapV3PoolHourDataV3DTOObject[["low"]] <-
          self$`low`
      }
      if (!is.null(self$`close`)) {
        UniswapV3PoolHourDataV3DTOObject[["close"]] <-
          self$`close`
      }
      if (!is.null(self$`vid`)) {
        UniswapV3PoolHourDataV3DTOObject[["vid"]] <-
          self$`vid`
      }
      UniswapV3PoolHourDataV3DTOObject
    },
    #' Deserialize JSON string into an instance of UniswapV3PoolHourDataV3DTO
    #'
    #' @description
    #' Deserialize JSON string into an instance of UniswapV3PoolHourDataV3DTO
    #'
    #' @param input_json the JSON input
    #' @return the instance of UniswapV3PoolHourDataV3DTO
    #' @export
    ...
    #' Validate JSON input with respect to UniswapV3PoolHourDataV3DTO
    #'
    #' @description
    #' Validate JSON input with respect to UniswapV3PoolHourDataV3DTO and throw an exception if invalid
    #'
    ...
    #' To string (JSON format)
    #'
    #' @return String representation of UniswapV3PoolHourDataV3DTO
    #' @export
    toString = function() {
      self$toJSONString()
    },
...
# UniswapV3PoolHourDataV3DTO$unlock()
#
## Below is an example to define the print fnuction
# UniswapV3PoolHourDataV3DTO$set("public", "print", function(...) {
#   print(jsonlite::prettify(self$toJSONString()))
#   invisible(self)
# })
## Uncomment below to lock the class to prevent modifications to the method or field
# UniswapV3PoolHourDataV3DTO$lock()
