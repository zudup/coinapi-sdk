...
#' @field recipient  character [optional]
...
#' @field sqrt_price_x96  \link{BigInteger} [optional]
...
SwapV3DTO <- R6::R6Class(
  ...
  public = list(
    ...
    `pool_id` = NULL,
    `transaction_id` = NULL,
    #' Initialize a new SwapV3DTO class.
    #'
    #' @description
    #' Initialize a new SwapV3DTO class.
    #'
    ...
    #' @export
    initialize = function(
        `entry_time` = NULL, `recv_time` = NULL, `block_number` = NULL, `vid` = NULL, `id` = NULL, `transaction` = NULL, `timestamp` = NULL, `pool` = NULL, `token_0` = NULL, `token_1` = NULL, `sender` = NULL, `recipient` = NULL, `origin` = NULL, `amount_0` = NULL, `amount_1` = NULL, `amount_usd` = NULL, `sqrt_price_x96` = NULL, `tick` = NULL, `log_index` = NULL, `evaluated_price` = NULL, `evaluated_amount` = NULL, `evaluated_aggressor` = NULL, `pool_id` = NULL, `transaction_id` = NULL, ...
    ) {
    ...
    #' To JSON String
    #'
    #' @return SwapV3DTO in JSON format
    #' @export
    toJSON = function() {
      SwapV3DTOObject <- list()
      if (!is.null(self$`entry_time`)) {
        SwapV3DTOObject[["entry_time"]] <-
          self$`entry_time`
      }
      if (!is.null(self$`recv_time`)) {
        SwapV3DTOObject[["recv_time"]] <-
          self$`recv_time`
      }
      if (!is.null(self$`block_number`)) {
        SwapV3DTOObject[["block_number"]] <-
          self$`block_number`
      }
      if (!is.null(self$`vid`)) {
        SwapV3DTOObject[["vid"]] <-
      ...
      if (!is.null(self$`transaction`)) {
        SwapV3DTOObject[["transaction"]] <-
          self$`transaction`
      }
      if (!is.null(self$`timestamp`)) {
        SwapV3DTOObject[["timestamp"]] <-
          self$`timestamp`
      }
      if (!is.null(self$`pool`)) {
        SwapV3DTOObject[["pool"]] <-
          self$`pool`
      }
      if (!is.null(self$`token_0`)) {
        SwapV3DTOObject[["token_0"]] <-
          self$`token_0`
      }
      if (!is.null(self$`token_1`)) {
        SwapV3DTOObject[["token_1"]] <-
          self$`token_1`
      }
      if (!is.null(self$`sender`)) {
        SwapV3DTOObject[["sender"]] <-
          self$`sender`
      }
      if (!is.null(self$`recipient`)) {
        SwapV3DTOObject[["recipient"]] <-
          self$`recipient`
      }
      if (!is.null(self$`origin`)) {
        SwapV3DTOObject[["origin"]] <-
          self$`origin`
      }
      if (!is.null(self$`amount_0`)) {
        SwapV3DTOObject[["amount_0"]] <-
          self$`amount_0`
      }
      if (!is.null(self$`amount_1`)) {
        SwapV3DTOObject[["amount_1"]] <-
          self$`amount_1`
      }
      if (!is.null(self$`amount_usd`)) {
        SwapV3DTOObject[["amount_usd"]] <-
          self$`amount_usd`
      }
      if (!is.null(self$`sqrt_price_x96`)) {
        SwapV3DTOObject[["sqrt_price_x96"]] <-
          self$`sqrt_price_x96`$toJSON()
      }
      if (!is.null(self$`tick`)) {
        SwapV3DTOObject[["tick"]] <-
          self$`tick`$toJSON()
      }
      if (!is.null(self$`log_index`)) {
        SwapV3DTOObject[["log_index"]] <-
          self$`log_index`$toJSON()
      }
      if (!is.null(self$`evaluated_price`)) {
        SwapV3DTOObject[["evaluated_price"]] <-
          self$`evaluated_price`
      }
      if (!is.null(self$`evaluated_amount`)) {
        SwapV3DTOObject[["evaluated_amount"]] <-
          self$`evaluated_amount`
      }
      if (!is.null(self$`evaluated_aggressor`)) {
        SwapV3DTOObject[["evaluated_aggressor"]] <-
          self$`evaluated_aggressor`$toJSON()
      }
      if (!is.null(self$`pool_id`)) {
        SwapV3DTOObject[["pool_id"]] <-
          self$`pool_id`
      }
      if (!is.null(self$`transaction_id`)) {
        SwapV3DTOObject[["transaction_id"]] <-
          self$`transaction_id`
      }
      SwapV3DTOObject
    },
    #' Deserialize JSON string into an instance of SwapV3DTO
    #'
    #' @description
    #' Deserialize JSON string into an instance of SwapV3DTO
    #'
    #' @param input_json the JSON input
    #' @return the instance of SwapV3DTO
    #' @export
    fromJSON = function(input_json) {
      ...
      if (!is.null(this_object$`sqrt_price_x96`)) {
        sqrt_price_x96_object <- BigInteger$new()
    ...
    fromJSONString = function(input_json) {
      ...
      self$`amount_1` <- this_object$`amount_1`
      self$`amount_usd` <- this_object$`amount_usd`
      self$`sqrt_price_x96` <- BigInteger$new()$fromJSON(jsonlite::toJSON(this_object$sqrt_price_x96, auto_unbox = TRUE, digits = NA))
    ...
    #' Validate JSON input with respect to SwapV3DTO
    #'
    #' @description
    #' Validate JSON input with respect to SwapV3DTO and throw an exception if invalid
    #'
    ...
    #' To string (JSON format)
    #'
    #' @return String representation of SwapV3DTO
    #' @export
    toString = function() {
      self$toJSONString()
    },
...
#SwapV3DTO$set("public", "print", function(...) {
#  print(jsonlite::prettify(self$toJSONString()))
#  invisible(self)
#})
