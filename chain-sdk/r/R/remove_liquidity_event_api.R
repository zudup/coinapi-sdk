...
#'
#' @docType class
#' @title RemoveLiquidityEvent operations
#' @description RemoveLiquidityEventApi
#' @format An \code{R6Class} generator object
#' @field api_client Handles the client-server communication.
#'
#' @section Methods:
#' \describe{
#' \strong{ ChainsChainIdDappsCurveRemoveLiquidityEventHistoricalGet } \emph{  }
#'
#' \itemize{
...
#' @export
RemoveLiquidityEventApi <- R6::R6Class(
  "RemoveLiquidityEventApi",
  public = list(
    api_client = NULL,
    #' Initialize a new RemoveLiquidityEventApi.
    #'
    #' @description
    #' Initialize a new RemoveLiquidityEventApi.
    #'
    ...
    #' @return void
    #' @export
    ChainsChainIdDappsCurveRemoveLiquidityEventHistoricalGet = function(chain_id, start_block = NULL, end_block = NULL, start_date = NULL, end_date = NULL, pool_id = NULL, ...) {
      local_var_response <- self$ChainsChainIdDappsCurveRemoveLiquidityEventHistoricalGetWithHttpInfo(chain_id, start_block, end_block, start_date, end_date, pool_id, ...)
    ...
    #' @export
    ChainsChainIdDappsCurveRemoveLiquidityEventHistoricalGetWithHttpInfo = function(chain_id, start_block = NULL, end_block = NULL, start_date = NULL, end_date = NULL, pool_id = NULL, ...) {
      args <- list(...)
      query_params <- list()
      header_params <- c()
      form_params <- list()
      ...
      local_var_url_path <- "/chains/{chain_id}/dapps/curve/removeLiquidityEvent/historical"
      if (!missing(`chain_id`)) {
