#' Create a new UniswapV3PoolDayDataV3DTO
#'
#' @description
#' Data accumulated and condensed into day stats for each pool.
#'
#' @docType class
#' @title UniswapV3PoolDayDataV3DTO
#' @description UniswapV3PoolDayDataV3DTO Class
...
#' @export
UniswapV3PoolDayDataV3DTO <- R6::R6Class(
  ...
  public = list(
    ...
    `close` = NULL,
    `vid` = NULL,
    #' Initialize a new UniswapV3PoolDayDataV3DTO class.
    #'
    #' @description
    #' Initialize a new UniswapV3PoolDayDataV3DTO class.
    #'
    ...
    #' To JSON String
    #'
    #' @return UniswapV3PoolDayDataV3DTO in JSON format
    #' @export
    toJSON = function() {
      UniswapV3PoolDayDataV3DTOObject <- list()
      if (!is.null(self$`entry_time`)) {
        UniswapV3PoolDayDataV3DTOObject[["entry_time"]] <-
          self$`entry_time`
      }
      if (!is.null(self$`recv_time`)) {
        UniswapV3PoolDayDataV3DTOObject[["recv_time"]] <-
          self$`recv_time`
      }
      if (!is.null(self$`block_number`)) {
        UniswapV3PoolDayDataV3DTOObject[["block_number"]] <-
          self$`block_number`
      }
      if (!is.null(self$`id`)) {
        UniswapV3PoolDayDataV3DTOObject[["id"]] <-
          self$`id`
      }
      if (!is.null(self$`date`)) {
        UniswapV3PoolDayDataV3DTOObject[["date"]] <-
          self$`date`
      }
      if (!is.null(self$`pool`)) {
        UniswapV3PoolDayDataV3DTOObject[["pool"]] <-
          self$`pool`
      }
      if (!is.null(self$`liquidity`)) {
        UniswapV3PoolDayDataV3DTOObject[["liquidity"]] <-
          self$`liquidity`
      }
      if (!is.null(self$`sqrt_price`)) {
        UniswapV3PoolDayDataV3DTOObject[["sqrt_price"]] <-
          self$`sqrt_price`
      }
      if (!is.null(self$`token_0_price`)) {
        UniswapV3PoolDayDataV3DTOObject[["token_0_price"]] <-
          self$`token_0_price`
      }
      if (!is.null(self$`token_1_price`)) {
        UniswapV3PoolDayDataV3DTOObject[["token_1_price"]] <-
          self$`token_1_price`
      }
      if (!is.null(self$`tick`)) {
        UniswapV3PoolDayDataV3DTOObject[["tick"]] <-
          self$`tick`
      }
      if (!is.null(self$`fee_growth_global_0x128`)) {
        UniswapV3PoolDayDataV3DTOObject[["fee_growth_global_0x128"]] <-
          self$`fee_growth_global_0x128`
      }
      if (!is.null(self$`fee_growth_global_1x128`)) {
        UniswapV3PoolDayDataV3DTOObject[["fee_growth_global_1x128"]] <-
          self$`fee_growth_global_1x128`
      }
      if (!is.null(self$`tvl_usd`)) {
        UniswapV3PoolDayDataV3DTOObject[["tvl_usd"]] <-
          self$`tvl_usd`
      }
      if (!is.null(self$`volume_token_0`)) {
        UniswapV3PoolDayDataV3DTOObject[["volume_token_0"]] <-
          self$`volume_token_0`
      }
      if (!is.null(self$`volume_token_1`)) {
        UniswapV3PoolDayDataV3DTOObject[["volume_token_1"]] <-
          self$`volume_token_1`
      }
      if (!is.null(self$`volume_usd`)) {
        UniswapV3PoolDayDataV3DTOObject[["volume_usd"]] <-
          self$`volume_usd`
      }
      if (!is.null(self$`fees_usd`)) {
        UniswapV3PoolDayDataV3DTOObject[["fees_usd"]] <-
          self$`fees_usd`
      }
      if (!is.null(self$`tx_count`)) {
        UniswapV3PoolDayDataV3DTOObject[["tx_count"]] <-
          self$`tx_count`
      }
      if (!is.null(self$`open`)) {
        UniswapV3PoolDayDataV3DTOObject[["open"]] <-
          self$`open`
      }
      if (!is.null(self$`high`)) {
        UniswapV3PoolDayDataV3DTOObject[["high"]] <-
          self$`high`
      }
      if (!is.null(self$`low`)) {
        UniswapV3PoolDayDataV3DTOObject[["low"]] <-
          self$`low`
      }
      if (!is.null(self$`close`)) {
        UniswapV3PoolDayDataV3DTOObject[["close"]] <-
          self$`close`
      }
      if (!is.null(self$`vid`)) {
        UniswapV3PoolDayDataV3DTOObject[["vid"]] <-
          self$`vid`
      }
      UniswapV3PoolDayDataV3DTOObject
    },
    #' Deserialize JSON string into an instance of UniswapV3PoolDayDataV3DTO
    #'
    #' @description
    #' Deserialize JSON string into an instance of UniswapV3PoolDayDataV3DTO
    #'
    #' @param input_json the JSON input
    #' @return the instance of UniswapV3PoolDayDataV3DTO
    #' @export
    ...
    #' Validate JSON input with respect to UniswapV3PoolDayDataV3DTO
    #'
    #' @description
    #' Validate JSON input with respect to UniswapV3PoolDayDataV3DTO and throw an exception if invalid
    #'
    ...
    #' To string (JSON format)
    #'
    #' @return String representation of UniswapV3PoolDayDataV3DTO
    #' @export
    toString = function() {
      self$toJSONString()
    },
...
# UniswapV3PoolDayDataV3DTO$unlock()
#
## Below is an example to define the print fnuction
# UniswapV3PoolDayDataV3DTO$set("public", "print", function(...) {
#   print(jsonlite::prettify(self$toJSONString()))
#   invisible(self)
# })
## Uncomment below to lock the class to prevent modifications to the method or field
# UniswapV3PoolDayDataV3DTO$lock()
