#' Create a new UniswapV2SwapV2DTO
#'
#' @description
#' Swap are created for each token swap within a pair.
#'
#' @docType class
#' @title UniswapV2SwapV2DTO
#' @description UniswapV2SwapV2DTO Class
...
UniswapV2SwapV2DTO <- R6::R6Class(
  ...
  public = list(
    ...
    `pool_id` = NULL,
    `transaction_id` = NULL,
    #' Initialize a new UniswapV2SwapV2DTO class.
    #'
    #' @description
    #' Initialize a new UniswapV2SwapV2DTO class.
    #'
    ...
    #' To JSON String
    #'
    #' @return UniswapV2SwapV2DTO in JSON format
    #' @export
    toJSON = function() {
      UniswapV2SwapV2DTOObject <- list()
      if (!is.null(self$`entry_time`)) {
        UniswapV2SwapV2DTOObject[["entry_time"]] <-
          self$`entry_time`
      }
      if (!is.null(self$`recv_time`)) {
        UniswapV2SwapV2DTOObject[["recv_time"]] <-
          self$`recv_time`
      }
      if (!is.null(self$`block_number`)) {
        UniswapV2SwapV2DTOObject[["block_number"]] <-
          self$`block_number`
      }
      if (!is.null(self$`vid`)) {
        UniswapV2SwapV2DTOObject[["vid"]] <-
          self$`vid`
      }
      if (!is.null(self$`id`)) {
        UniswapV2SwapV2DTOObject[["id"]] <-
          self$`id`
      }
      if (!is.null(self$`transaction`)) {
        UniswapV2SwapV2DTOObject[["transaction"]] <-
          self$`transaction`
      }
      if (!is.null(self$`timestamp`)) {
        UniswapV2SwapV2DTOObject[["timestamp"]] <-
          self$`timestamp`
      }
      if (!is.null(self$`pair`)) {
        UniswapV2SwapV2DTOObject[["pair"]] <-
          self$`pair`
      }
      if (!is.null(self$`sender`)) {
        UniswapV2SwapV2DTOObject[["sender"]] <-
          self$`sender`
      }
      if (!is.null(self$`from`)) {
        UniswapV2SwapV2DTOObject[["from"]] <-
          self$`from`
      }
      if (!is.null(self$`amount_0_in`)) {
        UniswapV2SwapV2DTOObject[["amount_0_in"]] <-
          self$`amount_0_in`
      }
      if (!is.null(self$`amount_1_in`)) {
        UniswapV2SwapV2DTOObject[["amount_1_in"]] <-
          self$`amount_1_in`
      }
      if (!is.null(self$`amount_0_out`)) {
        UniswapV2SwapV2DTOObject[["amount_0_out"]] <-
          self$`amount_0_out`
      }
      if (!is.null(self$`amount_1_out`)) {
        UniswapV2SwapV2DTOObject[["amount_1_out"]] <-
          self$`amount_1_out`
      }
      if (!is.null(self$`to`)) {
        UniswapV2SwapV2DTOObject[["to"]] <-
          self$`to`
      }
      if (!is.null(self$`log_index`)) {
        UniswapV2SwapV2DTOObject[["log_index"]] <-
          self$`log_index`$toJSON()
      }
      if (!is.null(self$`amount_usd`)) {
        UniswapV2SwapV2DTOObject[["amount_usd"]] <-
          self$`amount_usd`
      }
      if (!is.null(self$`evaluated_price`)) {
        UniswapV2SwapV2DTOObject[["evaluated_price"]] <-
          self$`evaluated_price`
      }
      if (!is.null(self$`evaluated_amount`)) {
        UniswapV2SwapV2DTOObject[["evaluated_amount"]] <-
          self$`evaluated_amount`
      }
      if (!is.null(self$`evaluated_aggressor`)) {
        UniswapV2SwapV2DTOObject[["evaluated_aggressor"]] <-
          self$`evaluated_aggressor`$toJSON()
      }
      if (!is.null(self$`pool_id`)) {
        UniswapV2SwapV2DTOObject[["pool_id"]] <-
          self$`pool_id`
      }
      if (!is.null(self$`transaction_id`)) {
        UniswapV2SwapV2DTOObject[["transaction_id"]] <-
          self$`transaction_id`
      }
      UniswapV2SwapV2DTOObject
    },
    #' Deserialize JSON string into an instance of UniswapV2SwapV2DTO
    #'
    #' @description
    #' Deserialize JSON string into an instance of UniswapV2SwapV2DTO
    #'
    #' @param input_json the JSON input
    #' @return the instance of UniswapV2SwapV2DTO
    #' @export
    ...
    #' Validate JSON input with respect to UniswapV2SwapV2DTO
    #'
    #' @description
    #' Validate JSON input with respect to UniswapV2SwapV2DTO and throw an exception if invalid
    #'
    ...
    #' To string (JSON format)
    #'
    #' @return String representation of UniswapV2SwapV2DTO
    #' @export
    toString = function() {
      self$toJSONString()
    },
...
# UniswapV2SwapV2DTO$unlock()
#
## Below is an example to define the print fnuction
# UniswapV2SwapV2DTO$set("public", "print", function(...) {
#   print(jsonlite::prettify(self$toJSONString()))
#   invisible(self)
# })
## Uncomment below to lock the class to prevent modifications to the method or field
# UniswapV2SwapV2DTO$lock()
