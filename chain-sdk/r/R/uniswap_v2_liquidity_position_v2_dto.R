#' Create a new UniswapV2LiquidityPositionV2DTO
#'
#' @description
...
#'
#' @docType class
#' @title UniswapV2LiquidityPositionV2DTO
#' @description UniswapV2LiquidityPositionV2DTO Class
...
#' @export
UniswapV2LiquidityPositionV2DTO <- R6::R6Class(
  ...
  public = list(
    ...
    `vid` = NULL,
    #' Initialize a new UniswapV2LiquidityPositionV2DTO class.
    #'
    #' @description
    #' Initialize a new UniswapV2LiquidityPositionV2DTO class.
    #'
    ...
    #' To JSON String
    #'
    #' @return UniswapV2LiquidityPositionV2DTO in JSON format
    #' @export
    toJSON = function() {
      UniswapV2LiquidityPositionV2DTOObject <- list()
      if (!is.null(self$`entry_time`)) {
        UniswapV2LiquidityPositionV2DTOObject[["entry_time"]] <-
          self$`entry_time`
      }
      if (!is.null(self$`recv_time`)) {
        UniswapV2LiquidityPositionV2DTOObject[["recv_time"]] <-
          self$`recv_time`
      }
      if (!is.null(self$`block_number`)) {
        UniswapV2LiquidityPositionV2DTOObject[["block_number"]] <-
          self$`block_number`
      }
      if (!is.null(self$`id`)) {
        UniswapV2LiquidityPositionV2DTOObject[["id"]] <-
          self$`id`
      }
      if (!is.null(self$`user`)) {
        UniswapV2LiquidityPositionV2DTOObject[["user"]] <-
          self$`user`
      }
      if (!is.null(self$`pair`)) {
        UniswapV2LiquidityPositionV2DTOObject[["pair"]] <-
          self$`pair`
      }
      if (!is.null(self$`liquidity_token_balance`)) {
        UniswapV2LiquidityPositionV2DTOObject[["liquidity_token_balance"]] <-
          self$`liquidity_token_balance`
      }
      if (!is.null(self$`vid`)) {
        UniswapV2LiquidityPositionV2DTOObject[["vid"]] <-
          self$`vid`
      }
      UniswapV2LiquidityPositionV2DTOObject
    },
    #' Deserialize JSON string into an instance of UniswapV2LiquidityPositionV2DTO
    #'
    #' @description
    #' Deserialize JSON string into an instance of UniswapV2LiquidityPositionV2DTO
    #'
    #' @param input_json the JSON input
    #' @return the instance of UniswapV2LiquidityPositionV2DTO
    #' @export
    ...
    #' Validate JSON input with respect to UniswapV2LiquidityPositionV2DTO
    #'
    #' @description
    #' Validate JSON input with respect to UniswapV2LiquidityPositionV2DTO and throw an exception if invalid
    #'
    ...
    #' To string (JSON format)
    #'
    #' @return String representation of UniswapV2LiquidityPositionV2DTO
    #' @export
    toString = function() {
      self$toJSONString()
    },
...
# UniswapV2LiquidityPositionV2DTO$unlock()
#
## Below is an example to define the print fnuction
# UniswapV2LiquidityPositionV2DTO$set("public", "print", function(...) {
#   print(jsonlite::prettify(self$toJSONString()))
#   invisible(self)
# })
## Uncomment below to lock the class to prevent modifications to the method or field
# UniswapV2LiquidityPositionV2DTO$lock()
