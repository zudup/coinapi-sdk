#' Create a new UniswapV2TokenV2DTO
#'
#' @description
#' Stores aggregated information for a specific token across all pairs that token is included in.
#'
#' @docType class
#' @title UniswapV2TokenV2DTO
#' @description UniswapV2TokenV2DTO Class
...
#' @export
UniswapV2TokenV2DTO <- R6::R6Class(
  "UniswapV2TokenV2DTO",
  public = list(
    `entry_time` = NULL,
    `recv_time` = NULL,
    ...
    `derived_eth` = NULL,
    `token_symbol` = NULL,
    #' Initialize a new UniswapV2TokenV2DTO class.
    #'
    #' @description
    #' Initialize a new UniswapV2TokenV2DTO class.
    #'
    ...
    #' To JSON String
    #'
    #' @return UniswapV2TokenV2DTO in JSON format
    #' @export
    toJSON = function() {
      UniswapV2TokenV2DTOObject <- list()
      if (!is.null(self$`entry_time`)) {
        UniswapV2TokenV2DTOObject[["entry_time"]] <-
          self$`entry_time`
      }
      if (!is.null(self$`recv_time`)) {
        UniswapV2TokenV2DTOObject[["recv_time"]] <-
          self$`recv_time`
      }
      if (!is.null(self$`block_number`)) {
        UniswapV2TokenV2DTOObject[["block_number"]] <-
          self$`block_number`
      }
      if (!is.null(self$`vid`)) {
        UniswapV2TokenV2DTOObject[["vid"]] <-
          self$`vid`
      }
      if (!is.null(self$`id`)) {
        UniswapV2TokenV2DTOObject[["id"]] <-
          self$`id`
      }
      if (!is.null(self$`symbol`)) {
        UniswapV2TokenV2DTOObject[["symbol"]] <-
          self$`symbol`
      }
      if (!is.null(self$`name`)) {
        UniswapV2TokenV2DTOObject[["name"]] <-
          self$`name`
      }
      if (!is.null(self$`decimals`)) {
        UniswapV2TokenV2DTOObject[["decimals"]] <-
          self$`decimals`
      }
      if (!is.null(self$`total_supply`)) {
        UniswapV2TokenV2DTOObject[["total_supply"]] <-
          self$`total_supply`$toJSON()
      }
      if (!is.null(self$`trade_volume`)) {
        UniswapV2TokenV2DTOObject[["trade_volume"]] <-
          self$`trade_volume`
      }
      if (!is.null(self$`trade_volume_usd`)) {
        UniswapV2TokenV2DTOObject[["trade_volume_usd"]] <-
          self$`trade_volume_usd`
      }
      if (!is.null(self$`untracked_volume_usd`)) {
        UniswapV2TokenV2DTOObject[["untracked_volume_usd"]] <-
          self$`untracked_volume_usd`
      }
      if (!is.null(self$`tx_count`)) {
        UniswapV2TokenV2DTOObject[["tx_count"]] <-
          self$`tx_count`$toJSON()
      }
      if (!is.null(self$`total_liquidity`)) {
        UniswapV2TokenV2DTOObject[["total_liquidity"]] <-
          self$`total_liquidity`
      }
      if (!is.null(self$`derived_eth`)) {
        UniswapV2TokenV2DTOObject[["derived_eth"]] <-
          self$`derived_eth`
      }
      if (!is.null(self$`token_symbol`)) {
        UniswapV2TokenV2DTOObject[["token_symbol"]] <-
          self$`token_symbol`
      }
      UniswapV2TokenV2DTOObject
    },
    #' Deserialize JSON string into an instance of UniswapV2TokenV2DTO
    #'
    #' @description
    #' Deserialize JSON string into an instance of UniswapV2TokenV2DTO
    #'
    #' @param input_json the JSON input
    #' @return the instance of UniswapV2TokenV2DTO
    #' @export
    ...
    #' Validate JSON input with respect to UniswapV2TokenV2DTO
    #'
    #' @description
    #' Validate JSON input with respect to UniswapV2TokenV2DTO and throw an exception if invalid
    #'
    ...
    #' To string (JSON format)
    #'
    #' @return String representation of UniswapV2TokenV2DTO
    #' @export
    toString = function() {
      self$toJSONString()
    },
...
# UniswapV2TokenV2DTO$unlock()
#
## Below is an example to define the print fnuction
# UniswapV2TokenV2DTO$set("public", "print", function(...) {
#   print(jsonlite::prettify(self$toJSONString()))
#   invisible(self)
# })
## Uncomment below to lock the class to prevent modifications to the method or field
# UniswapV2TokenV2DTO$lock()
