...
#'
#' @docType class
#' @title LpToken operations
#' @description LpTokenApi
#' @format An \code{R6Class} generator object
#' @field api_client Handles the client-server communication.
#'
#' @section Methods:
#' \describe{
#' \strong{ ChainsChainIdDappsCurveLpTokenHistoricalGet } \emph{  }
#'
#' \itemize{
...
#' @export
LpTokenApi <- R6::R6Class(
  "LpTokenApi",
  public = list(
    api_client = NULL,
    #' Initialize a new LpTokenApi.
    #'
    #' @description
    #' Initialize a new LpTokenApi.
    #'
    ...
    #' @return void
    #' @export
    ChainsChainIdDappsCurveLpTokenHistoricalGet = function(chain_id, start_block = NULL, end_block = NULL, start_date = NULL, end_date = NULL, pool_id = NULL, ...) {
      local_var_response <- self$ChainsChainIdDappsCurveLpTokenHistoricalGetWithHttpInfo(chain_id, start_block, end_block, start_date, end_date, pool_id, ...)
    ...
    #' @export
    ChainsChainIdDappsCurveLpTokenHistoricalGetWithHttpInfo = function(chain_id, start_block = NULL, end_block = NULL, start_date = NULL, end_date = NULL, pool_id = NULL, ...) {
      args <- list(...)
      query_params <- list()
      header_params <- c()
      form_params <- list()
      ...
      local_var_url_path <- "/chains/{chain_id}/dapps/curve/lpToken/historical"
      if (!missing(`chain_id`)) {
