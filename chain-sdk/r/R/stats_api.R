...
#' @section Methods:
#' \describe{
#' \strong{ ChainsChainIdDappsDexStatsHistoricalGet } \emph{  }
#'
#' \itemize{
...
StatsApi <- R6::R6Class(
  ...
  public = list(
    ...
    #' @return void
    #' @export
    ChainsChainIdDappsDexStatsHistoricalGet = function(chain_id, start_block = NULL, end_block = NULL, start_date = NULL, end_date = NULL, ...) {
      local_var_response <- self$ChainsChainIdDappsDexStatsHistoricalGetWithHttpInfo(chain_id, start_block, end_block, start_date, end_date, ...)
    ...
    #' @export
    ChainsChainIdDappsDexStatsHistoricalGetWithHttpInfo = function(chain_id, start_block = NULL, end_block = NULL, start_date = NULL, end_date = NULL, ...) {
      args <- list(...)
      query_params <- list()
      header_params <- c()
      form_params <- list()
      ...
      local_var_url_path <- "/chains/{chain_id}/dapps/dex/stats/historical"
      if (!missing(`chain_id`)) {
