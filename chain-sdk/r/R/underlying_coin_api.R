...
#'
#' @docType class
#' @title UnderlyingCoin operations
#' @description UnderlyingCoinApi
#' @format An \code{R6Class} generator object
#' @field api_client Handles the client-server communication.
#'
#' @section Methods:
#' \describe{
#' \strong{ ChainsChainIdDappsCurveUnderlyingCoinHistoricalGet } \emph{  }
#'
#' \itemize{
...
#' @export
UnderlyingCoinApi <- R6::R6Class(
  "UnderlyingCoinApi",
  public = list(
    api_client = NULL,
    #' Initialize a new UnderlyingCoinApi.
    #'
    #' @description
    #' Initialize a new UnderlyingCoinApi.
    #'
    ...
    #' @return void
    #' @export
    ChainsChainIdDappsCurveUnderlyingCoinHistoricalGet = function(chain_id, start_block = NULL, end_block = NULL, start_date = NULL, end_date = NULL, pool_id = NULL, ...) {
      local_var_response <- self$ChainsChainIdDappsCurveUnderlyingCoinHistoricalGetWithHttpInfo(chain_id, start_block, end_block, start_date, end_date, pool_id, ...)
    ...
    #' @export
    ChainsChainIdDappsCurveUnderlyingCoinHistoricalGetWithHttpInfo = function(chain_id, start_block = NULL, end_block = NULL, start_date = NULL, end_date = NULL, pool_id = NULL, ...) {
      args <- list(...)
      query_params <- list()
      header_params <- c()
      form_params <- list()
      ...
      local_var_url_path <- "/chains/{chain_id}/dapps/curve/underlyingCoin/historical"
      if (!missing(`chain_id`)) {
