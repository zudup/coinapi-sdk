#' Create a new UniswapV3BurnV3DTO
#'
#' @description
#' Burn entities are created for every emitted Burn event on the Uniswap core contracts. The Burn entity stores key data about the event like token amounts, who burned, who received tokens, and more. This entity can be used to track liquidity removals on pairs.
#'
#' @docType class
#' @title UniswapV3BurnV3DTO
#' @description UniswapV3BurnV3DTO Class
...
UniswapV3BurnV3DTO <- R6::R6Class(
  ...
  public = list(
    ...
    `log_index` = NULL,
    `vid` = NULL,
    #' Initialize a new UniswapV3BurnV3DTO class.
    #'
    #' @description
    #' Initialize a new UniswapV3BurnV3DTO class.
    #'
    ...
    #' To JSON String
    #'
    #' @return UniswapV3BurnV3DTO in JSON format
    #' @export
    toJSON = function() {
      UniswapV3BurnV3DTOObject <- list()
      if (!is.null(self$`entry_time`)) {
        UniswapV3BurnV3DTOObject[["entry_time"]] <-
          self$`entry_time`
      }
      if (!is.null(self$`recv_time`)) {
        UniswapV3BurnV3DTOObject[["recv_time"]] <-
          self$`recv_time`
      }
      if (!is.null(self$`block_number`)) {
        UniswapV3BurnV3DTOObject[["block_number"]] <-
          self$`block_number`
      }
      if (!is.null(self$`id`)) {
        UniswapV3BurnV3DTOObject[["id"]] <-
          self$`id`
      }
      if (!is.null(self$`transaction`)) {
        UniswapV3BurnV3DTOObject[["transaction"]] <-
          self$`transaction`
      }
      if (!is.null(self$`pool`)) {
        UniswapV3BurnV3DTOObject[["pool"]] <-
          self$`pool`
      }
      if (!is.null(self$`token_0`)) {
        UniswapV3BurnV3DTOObject[["token_0"]] <-
          self$`token_0`
      }
      if (!is.null(self$`token_1`)) {
        UniswapV3BurnV3DTOObject[["token_1"]] <-
          self$`token_1`
      }
      if (!is.null(self$`timestamp`)) {
        UniswapV3BurnV3DTOObject[["timestamp"]] <-
          self$`timestamp`
      }
      if (!is.null(self$`owner`)) {
        UniswapV3BurnV3DTOObject[["owner"]] <-
          self$`owner`
      }
      if (!is.null(self$`origin`)) {
        UniswapV3BurnV3DTOObject[["origin"]] <-
          self$`origin`
      }
      if (!is.null(self$`amount`)) {
        UniswapV3BurnV3DTOObject[["amount"]] <-
          self$`amount`
      }
      if (!is.null(self$`amount_0`)) {
        UniswapV3BurnV3DTOObject[["amount_0"]] <-
          self$`amount_0`
      }
      if (!is.null(self$`amount_1`)) {
        UniswapV3BurnV3DTOObject[["amount_1"]] <-
          self$`amount_1`
      }
      if (!is.null(self$`amount_usd`)) {
        UniswapV3BurnV3DTOObject[["amount_usd"]] <-
          self$`amount_usd`
      }
      if (!is.null(self$`tick_lower`)) {
        UniswapV3BurnV3DTOObject[["tick_lower"]] <-
          self$`tick_lower`
      }
      if (!is.null(self$`tick_upper`)) {
        UniswapV3BurnV3DTOObject[["tick_upper"]] <-
          self$`tick_upper`
      }
      if (!is.null(self$`log_index`)) {
        UniswapV3BurnV3DTOObject[["log_index"]] <-
          self$`log_index`
      }
      if (!is.null(self$`vid`)) {
        UniswapV3BurnV3DTOObject[["vid"]] <-
          self$`vid`
      }
      UniswapV3BurnV3DTOObject
    },
    #' Deserialize JSON string into an instance of UniswapV3BurnV3DTO
    #'
    #' @description
    #' Deserialize JSON string into an instance of UniswapV3BurnV3DTO
    #'
    #' @param input_json the JSON input
    #' @return the instance of UniswapV3BurnV3DTO
    #' @export
    ...
    #' Validate JSON input with respect to UniswapV3BurnV3DTO
    #'
    #' @description
    #' Validate JSON input with respect to UniswapV3BurnV3DTO and throw an exception if invalid
    #'
    ...
    #' To string (JSON format)
    #'
    #' @return String representation of UniswapV3BurnV3DTO
    #' @export
    toString = function() {
      self$toJSONString()
    },
...
# UniswapV3BurnV3DTO$unlock()
#
## Below is an example to define the print fnuction
# UniswapV3BurnV3DTO$set("public", "print", function(...) {
#   print(jsonlite::prettify(self$toJSONString()))
#   invisible(self)
# })
## Uncomment below to lock the class to prevent modifications to the method or field
# UniswapV3BurnV3DTO$lock()
