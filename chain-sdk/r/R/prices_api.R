...
#' @section Methods:
#' \describe{
#' \strong{ ChainsChainIdDappsDexPricesHistoricalGet } \emph{  }
#'
#' \itemize{
...
PricesApi <- R6::R6Class(
  ...
  public = list(
    ...
    #' @return void
    #' @export
    ChainsChainIdDappsDexPricesHistoricalGet = function(chain_id, start_block = NULL, end_block = NULL, start_date = NULL, end_date = NULL, token_id = NULL, ...) {
      local_var_response <- self$ChainsChainIdDappsDexPricesHistoricalGetWithHttpInfo(chain_id, start_block, end_block, start_date, end_date, token_id, ...)
    ...
    #' @export
    ChainsChainIdDappsDexPricesHistoricalGetWithHttpInfo = function(chain_id, start_block = NULL, end_block = NULL, start_date = NULL, end_date = NULL, token_id = NULL, ...) {
      args <- list(...)
      query_params <- list()
      header_params <- c()
      form_params <- list()
      ...
      local_var_url_path <- "/chains/{chain_id}/dapps/dex/prices/historical"
      if (!missing(`chain_id`)) {
