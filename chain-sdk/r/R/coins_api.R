...
#' @section Methods:
#' \describe{
#' \strong{ ChainsChainIdDappsCurveCoinsHistoricalGet } \emph{  }
#'
#' \itemize{
...
CoinsApi <- R6::R6Class(
  ...
  public = list(
    ...
    #' @return void
    #' @export
    ChainsChainIdDappsCurveCoinsHistoricalGet = function(chain_id, start_block = NULL, end_block = NULL, start_date = NULL, end_date = NULL, pool_id = NULL, ...) {
      local_var_response <- self$ChainsChainIdDappsCurveCoinsHistoricalGetWithHttpInfo(chain_id, start_block, end_block, start_date, end_date, pool_id, ...)
    ...
    #' @export
    ChainsChainIdDappsCurveCoinsHistoricalGetWithHttpInfo = function(chain_id, start_block = NULL, end_block = NULL, start_date = NULL, end_date = NULL, pool_id = NULL, ...) {
      args <- list(...)
      query_params <- list()
      header_params <- c()
      form_params <- list()
      ...
      local_var_url_path <- "/chains/{chain_id}/dapps/curve/coins/historical"
      if (!missing(`chain_id`)) {
