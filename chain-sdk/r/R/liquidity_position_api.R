...
#'
#' @docType class
#' @title LiquidityPosition operations
#' @description LiquidityPositionApi
#' @format An \code{R6Class} generator object
#' @field api_client Handles the client-server communication.
#'
#' @section Methods:
#' \describe{
#' \strong{ ChainsChainIdDappsSushiswapLiquidityPositionHistoricalGet } \emph{  }
#'
#' \itemize{
...
#' }
#'
#' \strong{ ChainsChainIdDappsUniswapv2LiquidityPositionHistoricalGet } \emph{  }
#'
#' \itemize{
#' \item \emph{ @param } chain_id character
#' \item \emph{ @param } start_block integer
...
#' @export
LiquidityPositionApi <- R6::R6Class(
  "LiquidityPositionApi",
  public = list(
    api_client = NULL,
    #' Initialize a new LiquidityPositionApi.
    #'
    #' @description
    #' Initialize a new LiquidityPositionApi.
    #'
    ...
    #' @return void
    #' @export
    ChainsChainIdDappsSushiswapLiquidityPositionHistoricalGet = function(chain_id, start_block = NULL, end_block = NULL, start_date = NULL, end_date = NULL, pool_id = NULL, ...) {
      local_var_response <- self$ChainsChainIdDappsSushiswapLiquidityPositionHistoricalGetWithHttpInfo(chain_id, start_block, end_block, start_date, end_date, pool_id, ...)
    ...
    #' @export
    ChainsChainIdDappsSushiswapLiquidityPositionHistoricalGetWithHttpInfo = function(chain_id, start_block = NULL, end_block = NULL, start_date = NULL, end_date = NULL, pool_id = NULL, ...) {
      args <- list(...)
      query_params <- list()
      header_params <- c()
      form_params <- list()
      ...
      local_var_url_path <- "/chains/{chain_id}/dapps/sushiswap/liquidityPosition/historical"
      if (!missing(`chain_id`)) {
    ...
    #' @return void
    #' @export
    ChainsChainIdDappsUniswapv2LiquidityPositionHistoricalGet = function(chain_id, start_block = NULL, end_block = NULL, start_date = NULL, end_date = NULL, pool_id = NULL, ...) {
      local_var_response <- self$ChainsChainIdDappsUniswapv2LiquidityPositionHistoricalGetWithHttpInfo(chain_id, start_block, end_block, start_date, end_date, pool_id, ...)
      if (local_var_response$status_code >= 200 && local_var_response$status_code <= 299) {
        local_var_response$content
      } else if (local_var_response$status_code >= 300 && local_var_response$status_code <= 399) {
        local_var_response
    ...
    #' @return API response (void) with additional information such as HTTP status code, headers
    #' @export
    ChainsChainIdDappsUniswapv2LiquidityPositionHistoricalGetWithHttpInfo = function(chain_id, start_block = NULL, end_block = NULL, start_date = NULL, end_date = NULL, pool_id = NULL, ...) {
      args <- list(...)
      query_params <- list()
      header_params <- c()
      form_params <- list()
      ...
      local_var_url_path <- "/chains/{chain_id}/dapps/uniswapv2/liquidityPosition/historical"
      if (!missing(`chain_id`)) {
        local_var_url_path <- gsub("\\{chain_id\\}", URLencode(as.character(`chain_id`), reserved = TRUE), local_var_url_path)
      }
