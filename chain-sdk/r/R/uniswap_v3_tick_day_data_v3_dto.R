#' Create a new UniswapV3TickDayDataV3DTO
#'
#' @description
#' Data accumulated and condensed into day stats for each exchange. Entity gets saved only if there is a change during the day
#'
#' @docType class
#' @title UniswapV3TickDayDataV3DTO
#' @description UniswapV3TickDayDataV3DTO Class
...
#' @export
UniswapV3TickDayDataV3DTO <- R6::R6Class(
  ...
  public = list(
    ...
    `vid` = NULL,
    #' Initialize a new UniswapV3TickDayDataV3DTO class.
    #'
    #' @description
    #' Initialize a new UniswapV3TickDayDataV3DTO class.
    #'
    ...
    #' To JSON String
    #'
    #' @return UniswapV3TickDayDataV3DTO in JSON format
    #' @export
    toJSON = function() {
      UniswapV3TickDayDataV3DTOObject <- list()
      if (!is.null(self$`entry_time`)) {
        UniswapV3TickDayDataV3DTOObject[["entry_time"]] <-
          self$`entry_time`
      }
      if (!is.null(self$`recv_time`)) {
        UniswapV3TickDayDataV3DTOObject[["recv_time"]] <-
          self$`recv_time`
      }
      if (!is.null(self$`block_number`)) {
        UniswapV3TickDayDataV3DTOObject[["block_number"]] <-
          self$`block_number`
      }
      if (!is.null(self$`id`)) {
        UniswapV3TickDayDataV3DTOObject[["id"]] <-
          self$`id`
      }
      if (!is.null(self$`date`)) {
        UniswapV3TickDayDataV3DTOObject[["date"]] <-
          self$`date`
      }
      if (!is.null(self$`pool`)) {
        UniswapV3TickDayDataV3DTOObject[["pool"]] <-
          self$`pool`
      }
      if (!is.null(self$`tick`)) {
        UniswapV3TickDayDataV3DTOObject[["tick"]] <-
          self$`tick`
      }
      if (!is.null(self$`liquidity_gross`)) {
        UniswapV3TickDayDataV3DTOObject[["liquidity_gross"]] <-
          self$`liquidity_gross`
      }
      if (!is.null(self$`liquidity_net`)) {
        UniswapV3TickDayDataV3DTOObject[["liquidity_net"]] <-
          self$`liquidity_net`
      }
      if (!is.null(self$`volume_token_0`)) {
        UniswapV3TickDayDataV3DTOObject[["volume_token_0"]] <-
          self$`volume_token_0`
      }
      if (!is.null(self$`volume_token_1`)) {
        UniswapV3TickDayDataV3DTOObject[["volume_token_1"]] <-
          self$`volume_token_1`
      }
      if (!is.null(self$`volume_usd`)) {
        UniswapV3TickDayDataV3DTOObject[["volume_usd"]] <-
          self$`volume_usd`
      }
      if (!is.null(self$`fees_usd`)) {
        UniswapV3TickDayDataV3DTOObject[["fees_usd"]] <-
          self$`fees_usd`
      }
      if (!is.null(self$`fee_growth_outside_0x128`)) {
        UniswapV3TickDayDataV3DTOObject[["fee_growth_outside_0x128"]] <-
          self$`fee_growth_outside_0x128`
      }
      if (!is.null(self$`fee_growth_outside_1x128`)) {
        UniswapV3TickDayDataV3DTOObject[["fee_growth_outside_1x128"]] <-
          self$`fee_growth_outside_1x128`
      }
      if (!is.null(self$`vid`)) {
        UniswapV3TickDayDataV3DTOObject[["vid"]] <-
          self$`vid`
      }
      UniswapV3TickDayDataV3DTOObject
    },
    #' Deserialize JSON string into an instance of UniswapV3TickDayDataV3DTO
    #'
    #' @description
    #' Deserialize JSON string into an instance of UniswapV3TickDayDataV3DTO
    #'
    #' @param input_json the JSON input
    #' @return the instance of UniswapV3TickDayDataV3DTO
    #' @export
    ...
    #' Validate JSON input with respect to UniswapV3TickDayDataV3DTO
    #'
    #' @description
    #' Validate JSON input with respect to UniswapV3TickDayDataV3DTO and throw an exception if invalid
    #'
    ...
    #' To string (JSON format)
    #'
    #' @return String representation of UniswapV3TickDayDataV3DTO
    #' @export
    toString = function() {
      self$toJSONString()
    },
...
# UniswapV3TickDayDataV3DTO$unlock()
#
## Below is an example to define the print fnuction
# UniswapV3TickDayDataV3DTO$set("public", "print", function(...) {
#   print(jsonlite::prettify(self$toJSONString()))
#   invisible(self)
# })
## Uncomment below to lock the class to prevent modifications to the method or field
# UniswapV3TickDayDataV3DTO$lock()
