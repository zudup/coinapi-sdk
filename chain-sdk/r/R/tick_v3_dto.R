...
TickV3DTO <- R6::R6Class(
  ...
  public = list(
    ...
    #' Initialize a new TickV3DTO class.
    #'
    #' @description
    #' Initialize a new TickV3DTO class.
    #'
    ...
    #' To JSON String
    #'
    #' @return TickV3DTO in JSON format
    #' @export
    toJSON = function() {
      TickV3DTOObject <- list()
      if (!is.null(self$`entry_time`)) {
        TickV3DTOObject[["entry_time"]] <-
          self$`entry_time`
      }
      if (!is.null(self$`recv_time`)) {
        TickV3DTOObject[["recv_time"]] <-
          self$`recv_time`
      }
      if (!is.null(self$`block_number`)) {
        TickV3DTOObject[["block_number"]] <-
          self$`block_number`
      }
      if (!is.null(self$`vid`)) {
        TickV3DTOObject[["vid"]] <-
    ...
    fromJSON = function(input_json) {
      ...
      if (!is.null(this_object$`tick_idx`)) {
        tick_idx_object <- BigInteger$new()
      ...
      if (!is.null(this_object$`liquidity_gross`)) {
        liquidity_gross_object <- BigInteger$new()
      ...
      if (!is.null(this_object$`liquidity_net`)) {
        liquidity_net_object <- BigInteger$new()
      ...
      if (!is.null(this_object$`liquidity_provider_count`)) {
        liquidity_provider_count_object <- BigInteger$new()
      ...
      if (!is.null(this_object$`fee_growth_outside_0x128`)) {
        fee_growth_outside_0x128_object <- BigInteger$new()
      ...
      if (!is.null(this_object$`fee_growth_outside_1x128`)) {
        fee_growth_outside_1x128_object <- BigInteger$new()
    ...
    fromJSONString = function(input_json) {
      ...
      self$`id` <- this_object$`id`
      self$`pool_address` <- this_object$`pool_address`
      self$`tick_idx` <- BigInteger$new()$fromJSON(jsonlite::toJSON(this_object$tick_idx, auto_unbox = TRUE, digits = NA))
      self$`pool` <- this_object$`pool`
      self$`liquidity_gross` <- BigInteger$new()$fromJSON(jsonlite::toJSON(this_object$liquidity_gross, auto_unbox = TRUE, digits = NA))
      self$`liquidity_net` <- BigInteger$new()$fromJSON(jsonlite::toJSON(this_object$liquidity_net, auto_unbox = TRUE, digits = NA))
      self$`price_0` <- this_object$`price_0`
      self$`price_1` <- this_object$`price_1`
      self$`volume_token_0` <- this_object$`volume_token_0`
      self$`volume_token_1` <- this_object$`volume_token_1`
      ...
      self$`collected_fees_usd` <- this_object$`collected_fees_usd`
      self$`created_at_timestamp` <- this_object$`created_at_timestamp`
      self$`liquidity_provider_count` <- BigInteger$new()$fromJSON(jsonlite::toJSON(this_object$liquidity_provider_count, auto_unbox = TRUE, digits = NA))
      self$`fee_growth_outside_0x128` <- BigInteger$new()$fromJSON(jsonlite::toJSON(this_object$fee_growth_outside_0x128, auto_unbox = TRUE, digits = NA))
      self$`fee_growth_outside_1x128` <- BigInteger$new()$fromJSON(jsonlite::toJSON(this_object$fee_growth_outside_1x128, auto_unbox = TRUE, digits = NA))
      self
    },
    #' Validate JSON input with respect to TickV3DTO
    #'
    #' @description
    #' Validate JSON input with respect to TickV3DTO and throw an exception if invalid
    #'
    ...
    #' To string (JSON format)
    #'
    #' @return String representation of TickV3DTO
    #' @export
    toString = function() {
      self$toJSONString()
    },
