...
PoolHourDataV3DTO <- R6::R6Class(
  ...
  public = list(
    ...
    #' @export
    initialize = function(
        `entry_time` = NULL, `recv_time` = NULL, `block_number` = NULL, `id` = NULL, `period_start_unix` = NULL, `pool` = NULL, `liquidity` = NULL, `sqrt_price` = NULL, `token_0_price` = NULL, `token_1_price` = NULL, `tick` = NULL, `fee_growth_global_0x128` = NULL, `fee_growth_global_1x128` = NULL, `tvl_usd` = NULL, `volume_token_0` = NULL, `volume_token_1` = NULL, `volume_usd` = NULL, `fees_usd` = NULL, `tx_count` = NULL, `open` = NULL, `high` = NULL, `low` = NULL, `close` = NULL, `vid` = NULL, ...
    ) {
