...
#' @section Methods:
#' \describe{
#' \strong{ ChainsChainIdDappsCowSettlementHistoricalGet } \emph{  }
#'
#' \itemize{
...
#' @export
SettlementApi <- R6::R6Class(
  "SettlementApi",
  public = list(
    api_client = NULL,
    #' Initialize a new SettlementApi.
    #'
    #' @description
    #' Initialize a new SettlementApi.
    #'
    ...
    #' @return void
    #' @export
    ChainsChainIdDappsCowSettlementHistoricalGet = function(chain_id, start_block = NULL, end_block = NULL, start_date = NULL, end_date = NULL, ...) {
      local_var_response <- self$ChainsChainIdDappsCowSettlementHistoricalGetWithHttpInfo(chain_id, start_block, end_block, start_date, end_date, ...)
    ...
    #' @export
    ChainsChainIdDappsCowSettlementHistoricalGetWithHttpInfo = function(chain_id, start_block = NULL, end_block = NULL, start_date = NULL, end_date = NULL, ...) {
      args <- list(...)
      query_params <- list()
      header_params <- c()
      form_params <- list()
      ...
      local_var_url_path <- "/chains/{chain_id}/dapps/cow/settlement/historical"
      if (!missing(`chain_id`)) {
