...
#' }
#'
#' \strong{ DappsCowPoiHistoricalGet } \emph{  }
#'
#' \itemize{
#' \item \emph{ @param } start_block integer
#' \item \emph{ @param } end_block integer
...
CowApi <- R6::R6Class(
  ...
  public = list(
    ...
    #' @return void
    #' @export
    DappsCowPoiHistoricalGet = function(start_block = NULL, end_block = NULL, start_date = NULL, end_date = NULL, ...) {
      local_var_response <- self$DappsCowPoiHistoricalGetWithHttpInfo(start_block, end_block, start_date, end_date, ...)
      if (local_var_response$status_code >= 200 && local_var_response$status_code <= 299) {
        local_var_response$content
      } else if (local_var_response$status_code >= 300 && local_var_response$status_code <= 399) {
        local_var_response
    ...
    #' @return API response (void) with additional information such as HTTP status code, headers
    #' @export
    DappsCowPoiHistoricalGetWithHttpInfo = function(start_block = NULL, end_block = NULL, start_date = NULL, end_date = NULL, ...) {
      args <- list(...)
      query_params <- list()
      header_params <- c()
      form_params <- list()
      ...
      local_var_url_path <- "/dapps/cow/poi/historical"
