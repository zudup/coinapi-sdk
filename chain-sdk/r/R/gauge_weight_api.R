...
#'
#' @docType class
#' @title GaugeWeight operations
#' @description GaugeWeightApi
#' @format An \code{R6Class} generator object
#' @field api_client Handles the client-server communication.
#'
#' @section Methods:
#' \describe{
#' \strong{ ChainsChainIdDappsCurveGaugeWeightHistoricalGet } \emph{  }
#'
#' \itemize{
...
#' @export
GaugeWeightApi <- R6::R6Class(
  "GaugeWeightApi",
  public = list(
    api_client = NULL,
    #' Initialize a new GaugeWeightApi.
    #'
    #' @description
    #' Initialize a new GaugeWeightApi.
    #'
    ...
    #' @return void
    #' @export
    ChainsChainIdDappsCurveGaugeWeightHistoricalGet = function(chain_id, start_block = NULL, end_block = NULL, start_date = NULL, end_date = NULL, ...) {
      local_var_response <- self$ChainsChainIdDappsCurveGaugeWeightHistoricalGetWithHttpInfo(chain_id, start_block, end_block, start_date, end_date, ...)
    ...
    #' @export
    ChainsChainIdDappsCurveGaugeWeightHistoricalGetWithHttpInfo = function(chain_id, start_block = NULL, end_block = NULL, start_date = NULL, end_date = NULL, ...) {
      args <- list(...)
      query_params <- list()
      header_params <- c()
      form_params <- list()
      ...
      local_var_url_path <- "/chains/{chain_id}/dapps/curve/gaugeWeight/historical"
      if (!missing(`chain_id`)) {
