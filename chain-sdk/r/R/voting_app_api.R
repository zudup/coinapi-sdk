...
#'
#' @docType class
#' @title VotingApp operations
#' @description VotingAppApi
#' @format An \code{R6Class} generator object
#' @field api_client Handles the client-server communication.
#'
#' @section Methods:
#' \describe{
#' \strong{ ChainsChainIdDappsCurveVotingAppHistoricalGet } \emph{  }
#'
#' \itemize{
...
#' @export
VotingAppApi <- R6::R6Class(
  "VotingAppApi",
  public = list(
    api_client = NULL,
    #' Initialize a new VotingAppApi.
    #'
    #' @description
    #' Initialize a new VotingAppApi.
    #'
    ...
    #' @return void
    #' @export
    ChainsChainIdDappsCurveVotingAppHistoricalGet = function(chain_id, start_block = NULL, end_block = NULL, start_date = NULL, end_date = NULL, ...) {
      local_var_response <- self$ChainsChainIdDappsCurveVotingAppHistoricalGetWithHttpInfo(chain_id, start_block, end_block, start_date, end_date, ...)
    ...
    #' @export
    ChainsChainIdDappsCurveVotingAppHistoricalGetWithHttpInfo = function(chain_id, start_block = NULL, end_block = NULL, start_date = NULL, end_date = NULL, ...) {
      args <- list(...)
      query_params <- list()
      header_params <- c()
      form_params <- list()
      ...
      local_var_url_path <- "/chains/{chain_id}/dapps/curve/votingApp/historical"
      if (!missing(`chain_id`)) {
