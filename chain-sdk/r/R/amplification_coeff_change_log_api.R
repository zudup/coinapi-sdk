...
#'
#' @docType class
#' @title AmplificationCoeffChangeLog operations
#' @description AmplificationCoeffChangeLogApi
#' @format An \code{R6Class} generator object
#' @field api_client Handles the client-server communication.
#'
#' @section Methods:
#' \describe{
#' \strong{ ChainsChainIdDappsCurveAmplificationCoeffChangeLogHistoricalGet } \emph{  }
#'
#' \itemize{
...
#' @export
AmplificationCoeffChangeLogApi <- R6::R6Class(
  "AmplificationCoeffChangeLogApi",
  public = list(
    api_client = NULL,
    #' Initialize a new AmplificationCoeffChangeLogApi.
    #'
    #' @description
    #' Initialize a new AmplificationCoeffChangeLogApi.
    #'
    ...
    #' @return void
    #' @export
    ChainsChainIdDappsCurveAmplificationCoeffChangeLogHistoricalGet = function(chain_id, start_block = NULL, end_block = NULL, start_date = NULL, end_date = NULL, pool_id = NULL, ...) {
      local_var_response <- self$ChainsChainIdDappsCurveAmplificationCoeffChangeLogHistoricalGetWithHttpInfo(chain_id, start_block, end_block, start_date, end_date, pool_id, ...)
    ...
    #' @export
    ChainsChainIdDappsCurveAmplificationCoeffChangeLogHistoricalGetWithHttpInfo = function(chain_id, start_block = NULL, end_block = NULL, start_date = NULL, end_date = NULL, pool_id = NULL, ...) {
      args <- list(...)
      query_params <- list()
      header_params <- c()
      form_params <- list()
      ...
      local_var_url_path <- "/chains/{chain_id}/dapps/curve/amplificationCoeffChangeLog/historical"
      if (!missing(`chain_id`)) {
