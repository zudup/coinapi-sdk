...
#' @section Methods:
#' \describe{
#' \strong{ ChainsChainIdDappsCurveContractsHistoricalGet } \emph{  }
#'
#' \itemize{
...
#' @export
ContractsApi <- R6::R6Class(
  "ContractsApi",
  public = list(
    api_client = NULL,
    #' Initialize a new ContractsApi.
    #'
    #' @description
    #' Initialize a new ContractsApi.
    #'
    ...
    #' @return void
    #' @export
    ChainsChainIdDappsCurveContractsHistoricalGet = function(chain_id, start_block = NULL, end_block = NULL, start_date = NULL, end_date = NULL, pool_id = NULL, ...) {
      local_var_response <- self$ChainsChainIdDappsCurveContractsHistoricalGetWithHttpInfo(chain_id, start_block, end_block, start_date, end_date, pool_id, ...)
    ...
    #' @export
    ChainsChainIdDappsCurveContractsHistoricalGetWithHttpInfo = function(chain_id, start_block = NULL, end_block = NULL, start_date = NULL, end_date = NULL, pool_id = NULL, ...) {
      args <- list(...)
      query_params <- list()
      header_params <- c()
      form_params <- list()
      ...
      local_var_url_path <- "/chains/{chain_id}/dapps/curve/contracts/historical"
      if (!missing(`chain_id`)) {
