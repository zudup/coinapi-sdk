...
#' @description GaugeApi
#' @format An \code{R6Class} generator object
#' @field api_client Handles the client-server communication.
#'
#' @section Methods:
#' \describe{
#' \strong{ ChainsChainIdDappsCurveGaugeHistoricalGet } \emph{  }
#'
#' \itemize{
...
GaugeApi <- R6::R6Class(
  ...
  public = list(
    ...
    #' @return void
    #' @export
    ChainsChainIdDappsCurveGaugeHistoricalGet = function(chain_id, start_block = NULL, end_block = NULL, start_date = NULL, end_date = NULL, pool_id = NULL, ...) {
      local_var_response <- self$ChainsChainIdDappsCurveGaugeHistoricalGetWithHttpInfo(chain_id, start_block, end_block, start_date, end_date, pool_id, ...)
    ...
    #' @export
    ChainsChainIdDappsCurveGaugeHistoricalGetWithHttpInfo = function(chain_id, start_block = NULL, end_block = NULL, start_date = NULL, end_date = NULL, pool_id = NULL, ...) {
      args <- list(...)
      query_params <- list()
      header_params <- c()
      form_params <- list()
      ...
      local_var_url_path <- "/chains/{chain_id}/dapps/curve/gauge/historical"
      if (!missing(`chain_id`)) {
