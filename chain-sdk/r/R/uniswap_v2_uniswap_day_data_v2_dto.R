#' Create a new UniswapV2UniswapDayDataV2DTO
#'
#' @description
#' Tracks data across all pairs aggregated into a daily bucket.
#'
#' @docType class
#' @title UniswapV2UniswapDayDataV2DTO
#' @description UniswapV2UniswapDayDataV2DTO Class
...
#' @export
UniswapV2UniswapDayDataV2DTO <- R6::R6Class(
  ...
  public = list(
    ...
    `tx_count` = NULL,
    `vid` = NULL,
    #' Initialize a new UniswapV2UniswapDayDataV2DTO class.
    #'
    #' @description
    #' Initialize a new UniswapV2UniswapDayDataV2DTO class.
    #'
    ...
    #' To JSON String
    #'
    #' @return UniswapV2UniswapDayDataV2DTO in JSON format
    #' @export
    toJSON = function() {
      UniswapV2UniswapDayDataV2DTOObject <- list()
      if (!is.null(self$`entry_time`)) {
        UniswapV2UniswapDayDataV2DTOObject[["entry_time"]] <-
          self$`entry_time`
      }
      if (!is.null(self$`recv_time`)) {
        UniswapV2UniswapDayDataV2DTOObject[["recv_time"]] <-
          self$`recv_time`
      }
      if (!is.null(self$`block_number`)) {
        UniswapV2UniswapDayDataV2DTOObject[["block_number"]] <-
          self$`block_number`
      }
      if (!is.null(self$`id`)) {
        UniswapV2UniswapDayDataV2DTOObject[["id"]] <-
          self$`id`
      }
      if (!is.null(self$`date`)) {
        UniswapV2UniswapDayDataV2DTOObject[["date"]] <-
          self$`date`
      }
      if (!is.null(self$`daily_volume_eth`)) {
        UniswapV2UniswapDayDataV2DTOObject[["daily_volume_eth"]] <-
          self$`daily_volume_eth`
      }
      if (!is.null(self$`daily_volume_usd`)) {
        UniswapV2UniswapDayDataV2DTOObject[["daily_volume_usd"]] <-
          self$`daily_volume_usd`
      }
      if (!is.null(self$`daily_volume_untracked`)) {
        UniswapV2UniswapDayDataV2DTOObject[["daily_volume_untracked"]] <-
          self$`daily_volume_untracked`
      }
      if (!is.null(self$`total_volume_eth`)) {
        UniswapV2UniswapDayDataV2DTOObject[["total_volume_eth"]] <-
          self$`total_volume_eth`
      }
      if (!is.null(self$`total_liquidity_eth`)) {
        UniswapV2UniswapDayDataV2DTOObject[["total_liquidity_eth"]] <-
          self$`total_liquidity_eth`
      }
      if (!is.null(self$`total_volume_usd`)) {
        UniswapV2UniswapDayDataV2DTOObject[["total_volume_usd"]] <-
          self$`total_volume_usd`
      }
      if (!is.null(self$`total_liquidity_usd`)) {
        UniswapV2UniswapDayDataV2DTOObject[["total_liquidity_usd"]] <-
          self$`total_liquidity_usd`
      }
      if (!is.null(self$`tx_count`)) {
        UniswapV2UniswapDayDataV2DTOObject[["tx_count"]] <-
          self$`tx_count`
      }
      if (!is.null(self$`vid`)) {
        UniswapV2UniswapDayDataV2DTOObject[["vid"]] <-
          self$`vid`
      }
      UniswapV2UniswapDayDataV2DTOObject
    },
    #' Deserialize JSON string into an instance of UniswapV2UniswapDayDataV2DTO
    #'
    #' @description
    #' Deserialize JSON string into an instance of UniswapV2UniswapDayDataV2DTO
    #'
    #' @param input_json the JSON input
    #' @return the instance of UniswapV2UniswapDayDataV2DTO
    #' @export
    ...
    #' Validate JSON input with respect to UniswapV2UniswapDayDataV2DTO
    #'
    #' @description
    #' Validate JSON input with respect to UniswapV2UniswapDayDataV2DTO and throw an exception if invalid
    #'
    ...
    #' To string (JSON format)
    #'
    #' @return String representation of UniswapV2UniswapDayDataV2DTO
    #' @export
    toString = function() {
      self$toJSONString()
    },
...
# UniswapV2UniswapDayDataV2DTO$unlock()
#
## Below is an example to define the print fnuction
# UniswapV2UniswapDayDataV2DTO$set("public", "print", function(...) {
#   print(jsonlite::prettify(self$toJSONString()))
#   invisible(self)
# })
## Uncomment below to lock the class to prevent modifications to the method or field
# UniswapV2UniswapDayDataV2DTO$lock()
