...
#'
#' @docType class
#' @title TokenHourData operations
#' @description TokenHourDataApi
#' @format An \code{R6Class} generator object
#' @field api_client Handles the client-server communication.
#'
#' @section Methods:
#' \describe{
#' \strong{ ChainsChainIdDappsUniswapv3TokenHourDataHistoricalGet } \emph{  }
#'
#' \itemize{
...
#' @export
TokenHourDataApi <- R6::R6Class(
  "TokenHourDataApi",
  public = list(
    api_client = NULL,
    #' Initialize a new TokenHourDataApi.
    #'
    #' @description
    #' Initialize a new TokenHourDataApi.
    #'
    ...
    #' @return void
    #' @export
    ChainsChainIdDappsUniswapv3TokenHourDataHistoricalGet = function(chain_id, start_block = NULL, end_block = NULL, start_date = NULL, end_date = NULL, token_id = NULL, ...) {
      local_var_response <- self$ChainsChainIdDappsUniswapv3TokenHourDataHistoricalGetWithHttpInfo(chain_id, start_block, end_block, start_date, end_date, token_id, ...)
    ...
    #' @export
    ChainsChainIdDappsUniswapv3TokenHourDataHistoricalGetWithHttpInfo = function(chain_id, start_block = NULL, end_block = NULL, start_date = NULL, end_date = NULL, token_id = NULL, ...) {
      args <- list(...)
      query_params <- list()
      header_params <- c()
      form_params <- list()
      ...
      local_var_url_path <- "/chains/{chain_id}/dapps/uniswapv3/tokenHourData/historical"
      if (!missing(`chain_id`)) {
