...
#'
#' @docType class
#' @title GaugeLiquidity operations
#' @description GaugeLiquidityApi
#' @format An \code{R6Class} generator object
#' @field api_client Handles the client-server communication.
#'
#' @section Methods:
#' \describe{
#' \strong{ ChainsChainIdDappsCurveGaugeLiquidityHistoricalGet } \emph{  }
#'
#' \itemize{
...
#' @export
GaugeLiquidityApi <- R6::R6Class(
  "GaugeLiquidityApi",
  public = list(
    api_client = NULL,
    #' Initialize a new GaugeLiquidityApi.
    #'
    #' @description
    #' Initialize a new GaugeLiquidityApi.
    #'
    ...
    #' @return void
    #' @export
    ChainsChainIdDappsCurveGaugeLiquidityHistoricalGet = function(chain_id, start_block = NULL, end_block = NULL, start_date = NULL, end_date = NULL, ...) {
      local_var_response <- self$ChainsChainIdDappsCurveGaugeLiquidityHistoricalGetWithHttpInfo(chain_id, start_block, end_block, start_date, end_date, ...)
    ...
    #' @export
    ChainsChainIdDappsCurveGaugeLiquidityHistoricalGetWithHttpInfo = function(chain_id, start_block = NULL, end_block = NULL, start_date = NULL, end_date = NULL, ...) {
      args <- list(...)
      query_params <- list()
      header_params <- c()
      form_params <- list()
      ...
      local_var_url_path <- "/chains/{chain_id}/dapps/curve/gaugeLiquidity/historical"
      if (!missing(`chain_id`)) {
