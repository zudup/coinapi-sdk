...
#'
#' @docType class
#' @title HourlyVolume operations
#' @description HourlyVolumeApi
#' @format An \code{R6Class} generator object
#' @field api_client Handles the client-server communication.
#'
#' @section Methods:
#' \describe{
#' \strong{ ChainsChainIdDappsCurveHourlyVolumeHistoricalGet } \emph{  }
#'
#' \itemize{
...
#' @export
HourlyVolumeApi <- R6::R6Class(
  "HourlyVolumeApi",
  public = list(
    api_client = NULL,
    #' Initialize a new HourlyVolumeApi.
    #'
    #' @description
    #' Initialize a new HourlyVolumeApi.
    #'
    ...
    #' @return void
    #' @export
    ChainsChainIdDappsCurveHourlyVolumeHistoricalGet = function(chain_id, start_block = NULL, end_block = NULL, start_date = NULL, end_date = NULL, pool_id = NULL, ...) {
      local_var_response <- self$ChainsChainIdDappsCurveHourlyVolumeHistoricalGetWithHttpInfo(chain_id, start_block, end_block, start_date, end_date, pool_id, ...)
    ...
    #' @export
    ChainsChainIdDappsCurveHourlyVolumeHistoricalGetWithHttpInfo = function(chain_id, start_block = NULL, end_block = NULL, start_date = NULL, end_date = NULL, pool_id = NULL, ...) {
      args <- list(...)
      query_params <- list()
      header_params <- c()
      form_params <- list()
      ...
      local_var_url_path <- "/chains/{chain_id}/dapps/curve/hourlyVolume/historical"
      if (!missing(`chain_id`)) {
