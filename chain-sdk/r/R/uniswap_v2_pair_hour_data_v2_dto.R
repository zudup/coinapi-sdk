#' Create a new UniswapV2PairHourDataV2DTO
#'
#' @description
#' Tracks pair data across each hour.
#'
#' @docType class
#' @title UniswapV2PairHourDataV2DTO
#' @description UniswapV2PairHourDataV2DTO Class
...
#' @export
UniswapV2PairHourDataV2DTO <- R6::R6Class(
  ...
  public = list(
    ...
    `hourly_txns` = NULL,
    `vid` = NULL,
    #' Initialize a new UniswapV2PairHourDataV2DTO class.
    #'
    #' @description
    #' Initialize a new UniswapV2PairHourDataV2DTO class.
    #'
    ...
    #' To JSON String
    #'
    #' @return UniswapV2PairHourDataV2DTO in JSON format
    #' @export
    toJSON = function() {
      UniswapV2PairHourDataV2DTOObject <- list()
      if (!is.null(self$`entry_time`)) {
        UniswapV2PairHourDataV2DTOObject[["entry_time"]] <-
          self$`entry_time`
      }
      if (!is.null(self$`recv_time`)) {
        UniswapV2PairHourDataV2DTOObject[["recv_time"]] <-
          self$`recv_time`
      }
      if (!is.null(self$`block_number`)) {
        UniswapV2PairHourDataV2DTOObject[["block_number"]] <-
          self$`block_number`
      }
      if (!is.null(self$`id`)) {
        UniswapV2PairHourDataV2DTOObject[["id"]] <-
          self$`id`
      }
      if (!is.null(self$`hour_start_unix`)) {
        UniswapV2PairHourDataV2DTOObject[["hour_start_unix"]] <-
          self$`hour_start_unix`
      }
      if (!is.null(self$`pair`)) {
        UniswapV2PairHourDataV2DTOObject[["pair"]] <-
          self$`pair`
      }
      if (!is.null(self$`reserve_0`)) {
        UniswapV2PairHourDataV2DTOObject[["reserve_0"]] <-
          self$`reserve_0`
      }
      if (!is.null(self$`reserve_1`)) {
        UniswapV2PairHourDataV2DTOObject[["reserve_1"]] <-
          self$`reserve_1`
      }
      if (!is.null(self$`total_supply`)) {
        UniswapV2PairHourDataV2DTOObject[["total_supply"]] <-
          self$`total_supply`
      }
      if (!is.null(self$`reserve_usd`)) {
        UniswapV2PairHourDataV2DTOObject[["reserve_usd"]] <-
          self$`reserve_usd`
      }
      if (!is.null(self$`hourly_volume_token_0`)) {
        UniswapV2PairHourDataV2DTOObject[["hourly_volume_token_0"]] <-
          self$`hourly_volume_token_0`
      }
      if (!is.null(self$`hourly_volume_token_1`)) {
        UniswapV2PairHourDataV2DTOObject[["hourly_volume_token_1"]] <-
          self$`hourly_volume_token_1`
      }
      if (!is.null(self$`hourly_volume_usd`)) {
        UniswapV2PairHourDataV2DTOObject[["hourly_volume_usd"]] <-
          self$`hourly_volume_usd`
      }
      if (!is.null(self$`hourly_txns`)) {
        UniswapV2PairHourDataV2DTOObject[["hourly_txns"]] <-
          self$`hourly_txns`
      }
      if (!is.null(self$`vid`)) {
        UniswapV2PairHourDataV2DTOObject[["vid"]] <-
          self$`vid`
      }
      UniswapV2PairHourDataV2DTOObject
    },
    #' Deserialize JSON string into an instance of UniswapV2PairHourDataV2DTO
    #'
    #' @description
    #' Deserialize JSON string into an instance of UniswapV2PairHourDataV2DTO
    #'
    #' @param input_json the JSON input
    #' @return the instance of UniswapV2PairHourDataV2DTO
    #' @export
    ...
    #' Validate JSON input with respect to UniswapV2PairHourDataV2DTO
    #'
    #' @description
    #' Validate JSON input with respect to UniswapV2PairHourDataV2DTO and throw an exception if invalid
    #'
    ...
    #' To string (JSON format)
    #'
    #' @return String representation of UniswapV2PairHourDataV2DTO
    #' @export
    toString = function() {
      self$toJSONString()
    },
...
# UniswapV2PairHourDataV2DTO$unlock()
#
## Below is an example to define the print fnuction
# UniswapV2PairHourDataV2DTO$set("public", "print", function(...) {
#   print(jsonlite::prettify(self$toJSONString()))
#   invisible(self)
# })
## Uncomment below to lock the class to prevent modifications to the method or field
# UniswapV2PairHourDataV2DTO$lock()
