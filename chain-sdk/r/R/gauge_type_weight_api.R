...
#'
#' @docType class
#' @title GaugeTypeWeight operations
#' @description GaugeTypeWeightApi
#' @format An \code{R6Class} generator object
#' @field api_client Handles the client-server communication.
#'
#' @section Methods:
#' \describe{
#' \strong{ ChainsChainIdDappsCurveGaugeTypeWeightHistoricalGet } \emph{  }
#'
#' \itemize{
...
#' @export
GaugeTypeWeightApi <- R6::R6Class(
  "GaugeTypeWeightApi",
  public = list(
    api_client = NULL,
    #' Initialize a new GaugeTypeWeightApi.
    #'
    #' @description
    #' Initialize a new GaugeTypeWeightApi.
    #'
    ...
    #' @return void
    #' @export
    ChainsChainIdDappsCurveGaugeTypeWeightHistoricalGet = function(chain_id, start_block = NULL, end_block = NULL, start_date = NULL, end_date = NULL, ...) {
      local_var_response <- self$ChainsChainIdDappsCurveGaugeTypeWeightHistoricalGetWithHttpInfo(chain_id, start_block, end_block, start_date, end_date, ...)
    ...
    #' @export
    ChainsChainIdDappsCurveGaugeTypeWeightHistoricalGetWithHttpInfo = function(chain_id, start_block = NULL, end_block = NULL, start_date = NULL, end_date = NULL, ...) {
      args <- list(...)
      query_params <- list()
      header_params <- c()
      form_params <- list()
      ...
      local_var_url_path <- "/chains/{chain_id}/dapps/curve/gaugeTypeWeight/historical"
      if (!missing(`chain_id`)) {
