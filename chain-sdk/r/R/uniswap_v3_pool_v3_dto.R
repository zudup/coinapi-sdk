#' Create a new UniswapV3PoolV3DTO
#'
#' @description
#' Information about a pool. Includes references to each token within the pool, volume information, liquidity information, and more. The pool entity mirrors the pool smart contract, and also contains aggregated information about use.
#'
#' @docType class
#' @title UniswapV3PoolV3DTO
#' @description UniswapV3PoolV3DTO Class
...
UniswapV3PoolV3DTO <- R6::R6Class(
  ...
  public = list(
    ...
    `evaluated_ask` = NULL,
    #' Initialize a new UniswapV3PoolV3DTO class.
    #'
    #' @description
    #' Initialize a new UniswapV3PoolV3DTO class.
    #'
    ...
    #' To JSON String
    #'
    #' @return UniswapV3PoolV3DTO in JSON format
    #' @export
    toJSON = function() {
      UniswapV3PoolV3DTOObject <- list()
      if (!is.null(self$`entry_time`)) {
        UniswapV3PoolV3DTOObject[["entry_time"]] <-
          self$`entry_time`
      }
      if (!is.null(self$`recv_time`)) {
        UniswapV3PoolV3DTOObject[["recv_time"]] <-
          self$`recv_time`
      }
      if (!is.null(self$`block_number`)) {
        UniswapV3PoolV3DTOObject[["block_number"]] <-
          self$`block_number`
      }
      if (!is.null(self$`vid`)) {
        UniswapV3PoolV3DTOObject[["vid"]] <-
          self$`vid`
      }
      if (!is.null(self$`id`)) {
        UniswapV3PoolV3DTOObject[["id"]] <-
          self$`id`
      }
      if (!is.null(self$`created_at_timestamp`)) {
        UniswapV3PoolV3DTOObject[["created_at_timestamp"]] <-
          self$`created_at_timestamp`
      }
      if (!is.null(self$`token_0`)) {
        UniswapV3PoolV3DTOObject[["token_0"]] <-
          self$`token_0`
      }
      if (!is.null(self$`token_1`)) {
        UniswapV3PoolV3DTOObject[["token_1"]] <-
          self$`token_1`
      }
      if (!is.null(self$`fee_tier`)) {
        UniswapV3PoolV3DTOObject[["fee_tier"]] <-
          self$`fee_tier`$toJSON()
      }
      if (!is.null(self$`liquidity`)) {
        UniswapV3PoolV3DTOObject[["liquidity"]] <-
          self$`liquidity`$toJSON()
      }
      if (!is.null(self$`sqrt_price`)) {
        UniswapV3PoolV3DTOObject[["sqrt_price"]] <-
          self$`sqrt_price`$toJSON()
      }
      if (!is.null(self$`fee_growth_global_0x128`)) {
        UniswapV3PoolV3DTOObject[["fee_growth_global_0x128"]] <-
          self$`fee_growth_global_0x128`$toJSON()
      }
      if (!is.null(self$`fee_growth_global_1x128`)) {
        UniswapV3PoolV3DTOObject[["fee_growth_global_1x128"]] <-
          self$`fee_growth_global_1x128`$toJSON()
      }
      if (!is.null(self$`token_0_price`)) {
        UniswapV3PoolV3DTOObject[["token_0_price"]] <-
          self$`token_0_price`
      }
      if (!is.null(self$`token_1_price`)) {
        UniswapV3PoolV3DTOObject[["token_1_price"]] <-
          self$`token_1_price`
      }
      if (!is.null(self$`tick`)) {
        UniswapV3PoolV3DTOObject[["tick"]] <-
          self$`tick`$toJSON()
      }
      if (!is.null(self$`observation_index`)) {
        UniswapV3PoolV3DTOObject[["observation_index"]] <-
          self$`observation_index`$toJSON()
      }
      if (!is.null(self$`volume_token_0`)) {
        UniswapV3PoolV3DTOObject[["volume_token_0"]] <-
          self$`volume_token_0`
      }
      if (!is.null(self$`volume_token_1`)) {
        UniswapV3PoolV3DTOObject[["volume_token_1"]] <-
          self$`volume_token_1`
      }
      if (!is.null(self$`volume_usd`)) {
        UniswapV3PoolV3DTOObject[["volume_usd"]] <-
          self$`volume_usd`
      }
      if (!is.null(self$`untracked_volume_usd`)) {
        UniswapV3PoolV3DTOObject[["untracked_volume_usd"]] <-
          self$`untracked_volume_usd`
      }
      if (!is.null(self$`fees_usd`)) {
        UniswapV3PoolV3DTOObject[["fees_usd"]] <-
          self$`fees_usd`
      }
      if (!is.null(self$`tx_count`)) {
        UniswapV3PoolV3DTOObject[["tx_count"]] <-
          self$`tx_count`$toJSON()
      }
      if (!is.null(self$`collected_fees_token_0`)) {
        UniswapV3PoolV3DTOObject[["collected_fees_token_0"]] <-
          self$`collected_fees_token_0`
      }
      if (!is.null(self$`collected_fees_token_1`)) {
        UniswapV3PoolV3DTOObject[["collected_fees_token_1"]] <-
          self$`collected_fees_token_1`
      }
      if (!is.null(self$`collected_fees_usd`)) {
        UniswapV3PoolV3DTOObject[["collected_fees_usd"]] <-
          self$`collected_fees_usd`
      }
      if (!is.null(self$`total_value_locked_token_0`)) {
        UniswapV3PoolV3DTOObject[["total_value_locked_token_0"]] <-
          self$`total_value_locked_token_0`
      }
      if (!is.null(self$`total_value_locked_token_1`)) {
        UniswapV3PoolV3DTOObject[["total_value_locked_token_1"]] <-
          self$`total_value_locked_token_1`
      }
      if (!is.null(self$`total_value_locked_eth`)) {
        UniswapV3PoolV3DTOObject[["total_value_locked_eth"]] <-
          self$`total_value_locked_eth`
      }
      if (!is.null(self$`total_value_locked_usd`)) {
        UniswapV3PoolV3DTOObject[["total_value_locked_usd"]] <-
          self$`total_value_locked_usd`
      }
      if (!is.null(self$`total_value_locked_usd_untracked`)) {
        UniswapV3PoolV3DTOObject[["total_value_locked_usd_untracked"]] <-
          self$`total_value_locked_usd_untracked`
      }
      if (!is.null(self$`liquidity_provider_count`)) {
        UniswapV3PoolV3DTOObject[["liquidity_provider_count"]] <-
          self$`liquidity_provider_count`
      }
      if (!is.null(self$`evaluated_ask`)) {
        UniswapV3PoolV3DTOObject[["evaluated_ask"]] <-
          self$`evaluated_ask`
      }
      UniswapV3PoolV3DTOObject
    },
    #' Deserialize JSON string into an instance of UniswapV3PoolV3DTO
    #'
    #' @description
    #' Deserialize JSON string into an instance of UniswapV3PoolV3DTO
    #'
    #' @param input_json the JSON input
    #' @return the instance of UniswapV3PoolV3DTO
    #' @export
    ...
    #' Validate JSON input with respect to UniswapV3PoolV3DTO
    #'
    #' @description
    #' Validate JSON input with respect to UniswapV3PoolV3DTO and throw an exception if invalid
    #'
    ...
    #' To string (JSON format)
    #'
    #' @return String representation of UniswapV3PoolV3DTO
    #' @export
    toString = function() {
      self$toJSONString()
    },
...
# UniswapV3PoolV3DTO$unlock()
#
## Below is an example to define the print fnuction
# UniswapV3PoolV3DTO$set("public", "print", function(...) {
#   print(jsonlite::prettify(self$toJSONString()))
#   invisible(self)
# })
## Uncomment below to lock the class to prevent modifications to the method or field
# UniswapV3PoolV3DTO$lock()
