#' Create a new UniswapV3TickV3DTO
#'
#' @description
#' Ticks are the boundaries between discrete areas in price space.
#'
#' @docType class
#' @title UniswapV3TickV3DTO
#' @description UniswapV3TickV3DTO Class
...
UniswapV3TickV3DTO <- R6::R6Class(
  ...
  public = list(
    ...
    #' Initialize a new UniswapV3TickV3DTO class.
    #'
    #' @description
    #' Initialize a new UniswapV3TickV3DTO class.
    #'
    ...
    #' To JSON String
    #'
    #' @return UniswapV3TickV3DTO in JSON format
    #' @export
    toJSON = function() {
      UniswapV3TickV3DTOObject <- list()
      if (!is.null(self$`entry_time`)) {
        UniswapV3TickV3DTOObject[["entry_time"]] <-
          self$`entry_time`
      }
      if (!is.null(self$`recv_time`)) {
        UniswapV3TickV3DTOObject[["recv_time"]] <-
          self$`recv_time`
      }
      if (!is.null(self$`block_number`)) {
        UniswapV3TickV3DTOObject[["block_number"]] <-
          self$`block_number`
      }
      if (!is.null(self$`vid`)) {
        UniswapV3TickV3DTOObject[["vid"]] <-
          self$`vid`
      }
      if (!is.null(self$`id`)) {
        UniswapV3TickV3DTOObject[["id"]] <-
          self$`id`
      }
      if (!is.null(self$`pool_address`)) {
        UniswapV3TickV3DTOObject[["pool_address"]] <-
          self$`pool_address`
      }
      if (!is.null(self$`tick_idx`)) {
        UniswapV3TickV3DTOObject[["tick_idx"]] <-
          self$`tick_idx`$toJSON()
      }
      if (!is.null(self$`pool`)) {
        UniswapV3TickV3DTOObject[["pool"]] <-
          self$`pool`
      }
      if (!is.null(self$`liquidity_gross`)) {
        UniswapV3TickV3DTOObject[["liquidity_gross"]] <-
          self$`liquidity_gross`$toJSON()
      }
      if (!is.null(self$`liquidity_net`)) {
        UniswapV3TickV3DTOObject[["liquidity_net"]] <-
          self$`liquidity_net`$toJSON()
      }
      if (!is.null(self$`price_0`)) {
        UniswapV3TickV3DTOObject[["price_0"]] <-
          self$`price_0`
      }
      if (!is.null(self$`price_1`)) {
        UniswapV3TickV3DTOObject[["price_1"]] <-
          self$`price_1`
      }
      if (!is.null(self$`volume_token_0`)) {
        UniswapV3TickV3DTOObject[["volume_token_0"]] <-
          self$`volume_token_0`
      }
      if (!is.null(self$`volume_token_1`)) {
        UniswapV3TickV3DTOObject[["volume_token_1"]] <-
          self$`volume_token_1`
      }
      if (!is.null(self$`volume_usd`)) {
        UniswapV3TickV3DTOObject[["volume_usd"]] <-
          self$`volume_usd`
      }
      if (!is.null(self$`untracked_volume_usd`)) {
        UniswapV3TickV3DTOObject[["untracked_volume_usd"]] <-
          self$`untracked_volume_usd`
      }
      if (!is.null(self$`fees_usd`)) {
        UniswapV3TickV3DTOObject[["fees_usd"]] <-
          self$`fees_usd`
      }
      if (!is.null(self$`collected_fees_token_0`)) {
        UniswapV3TickV3DTOObject[["collected_fees_token_0"]] <-
          self$`collected_fees_token_0`
      }
      if (!is.null(self$`collected_fees_token_1`)) {
        UniswapV3TickV3DTOObject[["collected_fees_token_1"]] <-
          self$`collected_fees_token_1`
      }
      if (!is.null(self$`collected_fees_usd`)) {
        UniswapV3TickV3DTOObject[["collected_fees_usd"]] <-
          self$`collected_fees_usd`
      }
      if (!is.null(self$`created_at_timestamp`)) {
        UniswapV3TickV3DTOObject[["created_at_timestamp"]] <-
          self$`created_at_timestamp`
      }
      if (!is.null(self$`liquidity_provider_count`)) {
        UniswapV3TickV3DTOObject[["liquidity_provider_count"]] <-
          self$`liquidity_provider_count`$toJSON()
      }
      if (!is.null(self$`fee_growth_outside_0x128`)) {
        UniswapV3TickV3DTOObject[["fee_growth_outside_0x128"]] <-
          self$`fee_growth_outside_0x128`$toJSON()
      }
      if (!is.null(self$`fee_growth_outside_1x128`)) {
        UniswapV3TickV3DTOObject[["fee_growth_outside_1x128"]] <-
          self$`fee_growth_outside_1x128`$toJSON()
      }
      UniswapV3TickV3DTOObject
    },
    #' Deserialize JSON string into an instance of UniswapV3TickV3DTO
    #'
    #' @description
    #' Deserialize JSON string into an instance of UniswapV3TickV3DTO
    #'
    #' @param input_json the JSON input
    #' @return the instance of UniswapV3TickV3DTO
    #' @export
    ...
    #' Validate JSON input with respect to UniswapV3TickV3DTO
    #'
    #' @description
    #' Validate JSON input with respect to UniswapV3TickV3DTO and throw an exception if invalid
    #'
    ...
    #' To string (JSON format)
    #'
    #' @return String representation of UniswapV3TickV3DTO
    #' @export
    toString = function() {
      self$toJSONString()
    },
...
# UniswapV3TickV3DTO$unlock()
#
## Below is an example to define the print fnuction
# UniswapV3TickV3DTO$set("public", "print", function(...) {
#   print(jsonlite::prettify(self$toJSONString()))
#   invisible(self)
# })
## Uncomment below to lock the class to prevent modifications to the method or field
# UniswapV3TickV3DTO$lock()
