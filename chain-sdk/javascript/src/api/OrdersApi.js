...
export default class OrdersApi {
    ...
    */
    ...
    /**
     * Callback function to receive the result of the chainsChainIdDappsCowOrdersHistoricalGet operation.
     * @callback module:api/OrdersApi~chainsChainIdDappsCowOrdersHistoricalGetCallback
     ...
     * @param {module:api/OrdersApi~chainsChainIdDappsCowOrdersHistoricalGetCallback} callback The callback function, accepting three arguments: error, data, response
     */
    chainsChainIdDappsCowOrdersHistoricalGet(chainId, opts, callback) {
      opts = opts || {};
      let postBody = null;
      // verify the required parameter 'chainId' is set
      if (chainId === undefined || chainId === null) {
        throw new Error("Missing the required parameter 'chainId' when calling chainsChainIdDappsCowOrdersHistoricalGet");
      }
      ...
      return this.apiClient.callApi(
        '/chains/{chain_id}/dapps/cow/orders/historical', 'GET',
