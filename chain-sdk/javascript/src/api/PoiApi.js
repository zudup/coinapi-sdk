...
export default class PoiApi {
    ...
    */
    ...
    /**
     * Callback function to receive the result of the chainsChainIdDappsCurvePoiHistoricalGet operation.
     * @callback module:api/PoiApi~chainsChainIdDappsCurvePoiHistoricalGetCallback
     * @param {String} error Error message, if any.
     * @param data This operation does not return a value.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {Date} opts.startDate 
     * @param {Date} opts.endDate 
     * @param {module:api/PoiApi~chainsChainIdDappsCurvePoiHistoricalGetCallback} callback The callback function, accepting three arguments: error, data, response
     */
    chainsChainIdDappsCurvePoiHistoricalGet(chainId, opts, callback) {
      opts = opts || {};
      let postBody = null;
      // verify the required parameter 'chainId' is set
      if (chainId === undefined || chainId === null) {
        throw new Error("Missing the required parameter 'chainId' when calling chainsChainIdDappsCurvePoiHistoricalGet");
      }
      ...
      let returnType = null;
      return this.apiClient.callApi(
        '/chains/{chain_id}/dapps/curve/poi/historical', 'GET',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null, callback
      );
    }
    ...
    /**
     * Callback function to receive the result of the chainsChainIdDappsDexPoiHistoricalGet operation.
     * @callback module:api/PoiApi~chainsChainIdDappsDexPoiHistoricalGetCallback
     * @param {String} error Error message, if any.
     * @param data This operation does not return a value.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {Date} opts.startDate 
     * @param {Date} opts.endDate 
     * @param {module:api/PoiApi~chainsChainIdDappsDexPoiHistoricalGetCallback} callback The callback function, accepting three arguments: error, data, response
     */
    chainsChainIdDappsDexPoiHistoricalGet(chainId, opts, callback) {
      opts = opts || {};
      let postBody = null;
      // verify the required parameter 'chainId' is set
      if (chainId === undefined || chainId === null) {
        throw new Error("Missing the required parameter 'chainId' when calling chainsChainIdDappsDexPoiHistoricalGet");
      }
      ...
      let returnType = null;
      return this.apiClient.callApi(
        '/chains/{chain_id}/dapps/dex/poi/historical', 'GET',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null, callback
      );
    }
