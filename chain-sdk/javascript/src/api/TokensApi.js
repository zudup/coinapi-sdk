...
export default class TokensApi {
    ...
    */
     ...
     * @callback module:api/TokensApi~chainsChainIdDappsDexTokensHistoricalGetCallback
     * @param {String} error Error message, if any.
     * @param data This operation does not return a value.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {Date} opts.endDate 
     * @param {String} opts.tokenId 
     * @param {module:api/TokensApi~chainsChainIdDappsDexTokensHistoricalGetCallback} callback The callback function, accepting three arguments: error, data, response
     */
