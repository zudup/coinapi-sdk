...
/**
* UniswapDayData service.
* @module api/UniswapDayDataApi
* @version v1
*/
export default class UniswapDayDataApi {

    /**
    * Constructs a new UniswapDayDataApi. 
    * @alias module:api/UniswapDayDataApi
    * @class
