...
/**
 * The UniswapV3MintV3DTO model module.
 * @module model/UniswapV3MintV3DTO
 * @version v1
 */
class UniswapV3MintV3DTO {
    /**
     * Constructs a new <code>UniswapV3MintV3DTO</code>.
     * Mint entities are created for every emitted Mint event on the Uniswap core contracts. The Mint entity stores key data about the event like token amounts, who sent the transaction, and more.
     * @alias module:model/UniswapV3MintV3DTO
     */
    constructor() { 
        
        UniswapV3MintV3DTO.initialize(this);
    }
    ...
    /**
     * Constructs a <code>UniswapV3MintV3DTO</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/UniswapV3MintV3DTO} obj Optional instance to populate.
     * @return {module:model/UniswapV3MintV3DTO} The populated <code>UniswapV3MintV3DTO</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new UniswapV3MintV3DTO();
    ...
    /**
     * Validates the JSON data with respect to <code>UniswapV3MintV3DTO</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>UniswapV3MintV3DTO</code>.
     */
 ...
 */
UniswapV3MintV3DTO.prototype['entry_time'] = undefined;

/**
 * @member {Date} recv_time
 */
UniswapV3MintV3DTO.prototype['recv_time'] = undefined;

/**
 * Number of block in which entity was recorded.
 * @member {Number} block_number
 */
UniswapV3MintV3DTO.prototype['block_number'] = undefined;

/**
 * Transaction hash + '#' + index in mints Transaction array.
 * @member {String} id
 */
UniswapV3MintV3DTO.prototype['id'] = undefined;

/**
 * Which txn the mint was included in.
 * @member {String} transaction
 */
UniswapV3MintV3DTO.prototype['transaction'] = undefined;

/**
 * Time of transaction.
 * @member {String} timestamp
 */
UniswapV3MintV3DTO.prototype['timestamp'] = undefined;

/**
 * Pool address.
 * @member {String} pool
 */
UniswapV3MintV3DTO.prototype['pool'] = undefined;

/**
 * Reference to token0 as stored in pool contract.
 * @member {String} token_0
 */
UniswapV3MintV3DTO.prototype['token_0'] = undefined;

/**
 * Reference to token1 as stored in pool contract.
 * @member {String} token_1
 */
UniswapV3MintV3DTO.prototype['token_1'] = undefined;

/**
 * Owner of position where liquidity minted to.
 * @member {String} owner
 */
UniswapV3MintV3DTO.prototype['owner'] = undefined;

/**
 * The address that minted the liquidity.
 * @member {String} sender
 */
UniswapV3MintV3DTO.prototype['sender'] = undefined;

/**
 * Transaction origin: the EOA (Externally Owned Account) that initiated the transaction.
 * @member {String} origin
 */
UniswapV3MintV3DTO.prototype['origin'] = undefined;

/**
 * Amount of liquidity minted.
 * @member {String} amount
 */
UniswapV3MintV3DTO.prototype['amount'] = undefined;

/**
 * Amount of token 0 minted.
 * @member {String} amount_0
 */
UniswapV3MintV3DTO.prototype['amount_0'] = undefined;

/**
 * Amount of token 1 minted.
 * @member {String} amount_1
 */
UniswapV3MintV3DTO.prototype['amount_1'] = undefined;

/**
 * Derived amount based on available prices of tokens.
 * @member {String} amount_usd
 */
UniswapV3MintV3DTO.prototype['amount_usd'] = undefined;

/**
 * Lower tick of the position.
 * @member {String} tick_lower
 */
UniswapV3MintV3DTO.prototype['tick_lower'] = undefined;

/**
 * Upper tick of the position.
 * @member {String} tick_upper
 */
UniswapV3MintV3DTO.prototype['tick_upper'] = undefined;

/**
 * Order within the transaction.
 * @member {String} log_index
 */
UniswapV3MintV3DTO.prototype['log_index'] = undefined;

/**
 * 
 * @member {Number} vid
 */
UniswapV3MintV3DTO.prototype['vid'] = undefined;
...
export default UniswapV3MintV3DTO;
