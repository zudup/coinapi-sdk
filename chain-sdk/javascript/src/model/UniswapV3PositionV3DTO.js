...
/**
 * The UniswapV3PositionV3DTO model module.
 * @module model/UniswapV3PositionV3DTO
 * @version v1
 */
class UniswapV3PositionV3DTO {
    /**
     * Constructs a new <code>UniswapV3PositionV3DTO</code>.
     ...
     * @alias module:model/UniswapV3PositionV3DTO
     */
    constructor() { 
        
        UniswapV3PositionV3DTO.initialize(this);
    }
    ...
    /**
     * Constructs a <code>UniswapV3PositionV3DTO</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/UniswapV3PositionV3DTO} obj Optional instance to populate.
     * @return {module:model/UniswapV3PositionV3DTO} The populated <code>UniswapV3PositionV3DTO</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new UniswapV3PositionV3DTO();
    ...
    /**
     * Validates the JSON data with respect to <code>UniswapV3PositionV3DTO</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>UniswapV3PositionV3DTO</code>.
     */
 ...
 */
UniswapV3PositionV3DTO.prototype['entry_time'] = undefined;

/**
 * @member {Date} recv_time
 */
UniswapV3PositionV3DTO.prototype['recv_time'] = undefined;

/**
 * Number of block in which entity was recorded.
 * @member {Number} block_number
 */
UniswapV3PositionV3DTO.prototype['block_number'] = undefined;

/**
 * NFT token identifier.
 * @member {String} id
 */
UniswapV3PositionV3DTO.prototype['id'] = undefined;

/**
 * Owner of the NFT.
 * @member {String} owner
 */
UniswapV3PositionV3DTO.prototype['owner'] = undefined;

/**
 * Pool position is within.
 * @member {String} pool
 */
UniswapV3PositionV3DTO.prototype['pool'] = undefined;

/**
 * Reference to token0 as stored in pair contract.
 * @member {String} token_0
 */
UniswapV3PositionV3DTO.prototype['token_0'] = undefined;

/**
 * Reference to token1 as stored in pair contract.
 * @member {String} token_1
 */
UniswapV3PositionV3DTO.prototype['token_1'] = undefined;

/**
 * Lower tick of the position.
 * @member {String} tick_lower
 */
UniswapV3PositionV3DTO.prototype['tick_lower'] = undefined;

/**
 * Upper tick of the position.
 * @member {String} tick_upper
 */
UniswapV3PositionV3DTO.prototype['tick_upper'] = undefined;

/**
 * Total position liquidity.
 * @member {String} liquidity
 */
UniswapV3PositionV3DTO.prototype['liquidity'] = undefined;

/**
 * Amount of token 0 ever deposited to position.
 * @member {String} deposited_token_0
 */
UniswapV3PositionV3DTO.prototype['deposited_token_0'] = undefined;

/**
 * Amount of token 1 ever deposited to position.
 * @member {String} deposited_token_1
 */
UniswapV3PositionV3DTO.prototype['deposited_token_1'] = undefined;

/**
 * Amount of token 0 ever withdrawn from position (without fees).
 * @member {String} withdrawn_token_0
 */
UniswapV3PositionV3DTO.prototype['withdrawn_token_0'] = undefined;

/**
 * Amount of token 1 ever withdrawn from position (without fees).
 * @member {String} withdrawn_token_1
 */
UniswapV3PositionV3DTO.prototype['withdrawn_token_1'] = undefined;

/**
 * All time collected fees in token0.
 * @member {String} collected_fees_token_0
 */
UniswapV3PositionV3DTO.prototype['collected_fees_token_0'] = undefined;

/**
 * All time collected fees in token1.
 * @member {String} collected_fees_token_1
 */
UniswapV3PositionV3DTO.prototype['collected_fees_token_1'] = undefined;

/**
 * Transaction in which the position was initialized.
 * @member {String} transaction
 */
UniswapV3PositionV3DTO.prototype['transaction'] = undefined;

/**
 * Variable needed for fee computation.
 * @member {String} fee_growth_inside_0_last_x128
 */
UniswapV3PositionV3DTO.prototype['fee_growth_inside_0_last_x128'] = undefined;

/**
 * Variable needed for fee computation.
 * @member {String} fee_growth_inside_1_last_x128
 */
UniswapV3PositionV3DTO.prototype['fee_growth_inside_1_last_x128'] = undefined;

/**
 * 
 * @member {Number} vid
 */
UniswapV3PositionV3DTO.prototype['vid'] = undefined;
...
export default UniswapV3PositionV3DTO;
