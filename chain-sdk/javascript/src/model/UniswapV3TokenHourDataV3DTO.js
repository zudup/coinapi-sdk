...
/**
 * The UniswapV3TokenHourDataV3DTO model module.
 * @module model/UniswapV3TokenHourDataV3DTO
 * @version v1
 */
class UniswapV3TokenHourDataV3DTO {
    /**
     * Constructs a new <code>UniswapV3TokenHourDataV3DTO</code>.
     * Token data aggregated across all pairs that include token.
     * @alias module:model/UniswapV3TokenHourDataV3DTO
     */
    constructor() { 
        
        UniswapV3TokenHourDataV3DTO.initialize(this);
    }
    ...
    /**
     * Constructs a <code>UniswapV3TokenHourDataV3DTO</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/UniswapV3TokenHourDataV3DTO} obj Optional instance to populate.
     * @return {module:model/UniswapV3TokenHourDataV3DTO} The populated <code>UniswapV3TokenHourDataV3DTO</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new UniswapV3TokenHourDataV3DTO();
    ...
    /**
     * Validates the JSON data with respect to <code>UniswapV3TokenHourDataV3DTO</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>UniswapV3TokenHourDataV3DTO</code>.
     */
 ...
 */
UniswapV3TokenHourDataV3DTO.prototype['entry_time'] = undefined;

/**
 * @member {Date} recv_time
 */
UniswapV3TokenHourDataV3DTO.prototype['recv_time'] = undefined;

/**
 * Number of block in which entity was recorded.
 * @member {Number} block_number
 */
UniswapV3TokenHourDataV3DTO.prototype['block_number'] = undefined;

/**
 * Token address concatendated with date.
 * @member {String} id
 */
UniswapV3TokenHourDataV3DTO.prototype['id'] = undefined;

/**
 * Unix timestamp for start of hour.
 * @member {Number} period_start_unix
 */
UniswapV3TokenHourDataV3DTO.prototype['period_start_unix'] = undefined;

/**
 * Pointer to token.
 * @member {String} token
 */
UniswapV3TokenHourDataV3DTO.prototype['token'] = undefined;

/**
 * Volume in token units.
 * @member {String} volume
 */
UniswapV3TokenHourDataV3DTO.prototype['volume'] = undefined;

/**
 * Volume in derived USD.
 * @member {String} volume_usd
 */
UniswapV3TokenHourDataV3DTO.prototype['volume_usd'] = undefined;

/**
 * Volume in USD even on pools with less reliable USD values.
 * @member {String} untracked_volume_usd
 */
UniswapV3TokenHourDataV3DTO.prototype['untracked_volume_usd'] = undefined;

/**
 * Liquidity across all pools in token units.
 * @member {String} total_value_locked
 */
UniswapV3TokenHourDataV3DTO.prototype['total_value_locked'] = undefined;

/**
 * Liquidity across all pools in derived USD.
 * @member {String} total_value_locked_usd
 */
UniswapV3TokenHourDataV3DTO.prototype['total_value_locked_usd'] = undefined;

/**
 * Price at end of period in USD.
 * @member {String} price_usd
 */
UniswapV3TokenHourDataV3DTO.prototype['price_usd'] = undefined;

/**
 * Fees in USD.
 * @member {String} fees_usd
 */
UniswapV3TokenHourDataV3DTO.prototype['fees_usd'] = undefined;

/**
 * Opening price USD.
 * @member {String} open
 */
UniswapV3TokenHourDataV3DTO.prototype['open'] = undefined;

/**
 * High price USD.
 * @member {String} high
 */
UniswapV3TokenHourDataV3DTO.prototype['high'] = undefined;

/**
 * Low price USD.
 * @member {String} low
 */
UniswapV3TokenHourDataV3DTO.prototype['low'] = undefined;

/**
 * Close price USD.
 * @member {String} close
 */
UniswapV3TokenHourDataV3DTO.prototype['close'] = undefined;

/**
 * 
 * @member {Number} vid
 */
UniswapV3TokenHourDataV3DTO.prototype['vid'] = undefined;
...
export default UniswapV3TokenHourDataV3DTO;
