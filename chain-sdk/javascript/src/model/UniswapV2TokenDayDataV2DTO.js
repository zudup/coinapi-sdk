...
/**
 * The UniswapV2TokenDayDataV2DTO model module.
 * @module model/UniswapV2TokenDayDataV2DTO
 * @version v1
 */
class UniswapV2TokenDayDataV2DTO {
    /**
     * Constructs a new <code>UniswapV2TokenDayDataV2DTO</code>.
     * Token data aggregated across all pairs that include token.
     * @alias module:model/UniswapV2TokenDayDataV2DTO
     */
    constructor() { 
        
        UniswapV2TokenDayDataV2DTO.initialize(this);
    }
    ...
    /**
     * Constructs a <code>UniswapV2TokenDayDataV2DTO</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/UniswapV2TokenDayDataV2DTO} obj Optional instance to populate.
     * @return {module:model/UniswapV2TokenDayDataV2DTO} The populated <code>UniswapV2TokenDayDataV2DTO</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new UniswapV2TokenDayDataV2DTO();
    ...
    /**
     * Validates the JSON data with respect to <code>UniswapV2TokenDayDataV2DTO</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>UniswapV2TokenDayDataV2DTO</code>.
     */
...
export default UniswapV2TokenDayDataV2DTO;
