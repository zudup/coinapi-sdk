...
class PoolV3DTO {
    ...
    /**
     * Validates the JSON data with respect to <code>PoolV3DTO</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>PoolV3DTO</code>.
     */
    static validateJSON(data) {
        ...
        if (data['observation_index']) { // data not null
          BigInteger.validateJSON(data['observation_index']);
        }
        // ensure the json data is a string
