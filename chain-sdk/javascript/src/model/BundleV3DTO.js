...
/**
 * The BundleV3DTO model module.
 * @module model/BundleV3DTO
 * @version v1
 */
class BundleV3DTO {
    /**
    ...
    /**
     * Constructs a <code>BundleV3DTO</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/BundleV3DTO} obj Optional instance to populate.
     * @return {module:model/BundleV3DTO} The populated <code>BundleV3DTO</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new BundleV3DTO();
 ...
 */
BundleV3DTO.prototype['entry_time'] = undefined;
