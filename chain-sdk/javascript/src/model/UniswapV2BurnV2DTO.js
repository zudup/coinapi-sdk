...
/**
 * The UniswapV2BurnV2DTO model module.
 * @module model/UniswapV2BurnV2DTO
 * @version v1
 */
class UniswapV2BurnV2DTO {
    /**
     * Constructs a new <code>UniswapV2BurnV2DTO</code>.
     * Burn entities are created for every emitted Burn event on the Uniswap core contracts. The Burn entity stores key data about the event like token amounts, who burned LP tokens, who received tokens, and more. This entity can be used to track liquidity removals on pairs.
     * @alias module:model/UniswapV2BurnV2DTO
     */
    constructor() { 
        
        UniswapV2BurnV2DTO.initialize(this);
    }
    ...
    /**
     * Constructs a <code>UniswapV2BurnV2DTO</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/UniswapV2BurnV2DTO} obj Optional instance to populate.
     * @return {module:model/UniswapV2BurnV2DTO} The populated <code>UniswapV2BurnV2DTO</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new UniswapV2BurnV2DTO();
    ...
    /**
     * Validates the JSON data with respect to <code>UniswapV2BurnV2DTO</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>UniswapV2BurnV2DTO</code>.
     */
 ...
 */
UniswapV2BurnV2DTO.prototype['entry_time'] = undefined;

/**
 * @member {Date} recv_time
 */
UniswapV2BurnV2DTO.prototype['recv_time'] = undefined;

/**
 * Number of block in which entity was recorded.
 * @member {Number} block_number
 */
UniswapV2BurnV2DTO.prototype['block_number'] = undefined;

/**
 * Transaction hash plus index in the transaction burn array
 * @member {String} id
 */
UniswapV2BurnV2DTO.prototype['id'] = undefined;

/**
 * Reference to the transaction Burn was included in.
 * @member {String} transaction
 */
UniswapV2BurnV2DTO.prototype['transaction'] = undefined;

/**
 * Timestamp of Burn, used to sort recent liquidity removals.
 * @member {String} timestamp
 */
UniswapV2BurnV2DTO.prototype['timestamp'] = undefined;

/**
 * Reference to pair.
 * @member {String} pair
 */
UniswapV2BurnV2DTO.prototype['pair'] = undefined;

/**
 * Amount of liquidity tokens burned.
 * @member {String} liquidity
 */
UniswapV2BurnV2DTO.prototype['liquidity'] = undefined;

/**
 * Address that initiated the liquidity removal.
 * @member {String} sender
 */
UniswapV2BurnV2DTO.prototype['sender'] = undefined;

/**
 * Amount of token0 removed.
 * @member {String} amount_0
 */
UniswapV2BurnV2DTO.prototype['amount_0'] = undefined;

/**
 * Amount of token1 removed.
 * @member {String} amount_1
 */
UniswapV2BurnV2DTO.prototype['amount_1'] = undefined;

/**
 * Recipient of tokens.
 * @member {String} to
 */
UniswapV2BurnV2DTO.prototype['to'] = undefined;

/**
 * Index in the transaction event was emitted.
 * @member {String} log_index
 */
UniswapV2BurnV2DTO.prototype['log_index'] = undefined;

/**
 * Derived USD value of token0 amount plus token1 amount.
 * @member {String} amount_usd
 */
UniswapV2BurnV2DTO.prototype['amount_usd'] = undefined;

/**
 * 
 * @member {Boolean} needs_complete
 */
UniswapV2BurnV2DTO.prototype['needs_complete'] = undefined;

/**
 * Address of fee recipient (if fee is on).
 * @member {String} fee_to
 */
UniswapV2BurnV2DTO.prototype['fee_to'] = undefined;

/**
 * Amount of tokens sent to fee recipient (if fee is on).
 * @member {String} fee_liquidity
 */
UniswapV2BurnV2DTO.prototype['fee_liquidity'] = undefined;

/**
 * 
 * @member {Number} vid
 */
UniswapV2BurnV2DTO.prototype['vid'] = undefined;
...
export default UniswapV2BurnV2DTO;
