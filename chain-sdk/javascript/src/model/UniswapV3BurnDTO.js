...
/**
 * The UniswapV3BurnDTO model module.
 * @module model/UniswapV3BurnDTO
 * @version v1
 */
class UniswapV3BurnDTO {
    /**
     * Constructs a new <code>UniswapV3BurnDTO</code>.
     * Burn entities are created for every emitted Burn event on the Uniswap core contracts. The Burn entity stores key data about the event like token amounts, who burned, who received tokens, and more. This entity can be used to track liquidity removals on pairs.
     * @alias module:model/UniswapV3BurnDTO
     */
    constructor() { 
        
        UniswapV3BurnDTO.initialize(this);
    }
    ...
    /**
     * Constructs a <code>UniswapV3BurnDTO</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/UniswapV3BurnDTO} obj Optional instance to populate.
     * @return {module:model/UniswapV3BurnDTO} The populated <code>UniswapV3BurnDTO</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new UniswapV3BurnDTO();
    ...
    /**
     * Validates the JSON data with respect to <code>UniswapV3BurnDTO</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>UniswapV3BurnDTO</code>.
     */
 ...
 */
UniswapV3BurnDTO.prototype['entry_time'] = undefined;

/**
 * @member {Date} recv_time
 */
UniswapV3BurnDTO.prototype['recv_time'] = undefined;

/**
 * Number of block in which entity was recorded.
 * @member {Number} block_number
 */
UniswapV3BurnDTO.prototype['block_number'] = undefined;

/**
 * Transaction hash + '#' + index in mints Transaction array.
 * @member {String} id
 */
UniswapV3BurnDTO.prototype['id'] = undefined;

/**
 * Transaction burn was included in.
 * @member {String} transaction
 */
UniswapV3BurnDTO.prototype['transaction'] = undefined;

/**
 * Pool position is within.
 * @member {String} pool
 */
UniswapV3BurnDTO.prototype['pool'] = undefined;

/**
 * Reference to token0 as stored in pool contract.
 * @member {String} token_0
 */
UniswapV3BurnDTO.prototype['token_0'] = undefined;

/**
 * Reference to token1 as stored in pool contract.
 * @member {String} token_1
 */
UniswapV3BurnDTO.prototype['token_1'] = undefined;

/**
 * Timestamp.
 * @member {String} timestamp
 */
UniswapV3BurnDTO.prototype['timestamp'] = undefined;

/**
 * Owner of position where liquidity was burned.
 * @member {String} owner
 */
UniswapV3BurnDTO.prototype['owner'] = undefined;

/**
 * Transaction origin: the EOA (Externally Owned Account) that initiated the transaction.
 * @member {String} origin
 */
UniswapV3BurnDTO.prototype['origin'] = undefined;

/**
 * Amount of liquidity burned.
 * @member {String} amount
 */
UniswapV3BurnDTO.prototype['amount'] = undefined;

/**
 * Amount of token 0 burned.
 * @member {String} amount_0
 */
UniswapV3BurnDTO.prototype['amount_0'] = undefined;

/**
 * Amount of token 1 burned.
 * @member {String} amount_1
 */
UniswapV3BurnDTO.prototype['amount_1'] = undefined;

/**
 * Derived amount based on available prices of tokens.
 * @member {String} amount_usd
 */
UniswapV3BurnDTO.prototype['amount_usd'] = undefined;

/**
 * Lower tick of position.
 * @member {String} tick_lower
 */
UniswapV3BurnDTO.prototype['tick_lower'] = undefined;

/**
 * Upper tick of position.
 * @member {String} tick_upper
 */
UniswapV3BurnDTO.prototype['tick_upper'] = undefined;

/**
 * Position within the transactions.
 * @member {String} log_index
 */
UniswapV3BurnDTO.prototype['log_index'] = undefined;

/**
 * 
 * @member {Number} vid
 */
UniswapV3BurnDTO.prototype['vid'] = undefined;
...
export default UniswapV3BurnDTO;
