...
/**
 * The UniswapV3TickDayDataV3DTO model module.
 * @module model/UniswapV3TickDayDataV3DTO
 * @version v1
 */
class UniswapV3TickDayDataV3DTO {
    /**
     * Constructs a new <code>UniswapV3TickDayDataV3DTO</code>.
     * Data accumulated and condensed into day stats for each exchange. Entity gets saved only if there is a change during the day
     * @alias module:model/UniswapV3TickDayDataV3DTO
     */
    constructor() { 
        
        UniswapV3TickDayDataV3DTO.initialize(this);
    }
    ...
    /**
     * Constructs a <code>UniswapV3TickDayDataV3DTO</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/UniswapV3TickDayDataV3DTO} obj Optional instance to populate.
     * @return {module:model/UniswapV3TickDayDataV3DTO} The populated <code>UniswapV3TickDayDataV3DTO</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new UniswapV3TickDayDataV3DTO();
    ...
    /**
     * Validates the JSON data with respect to <code>UniswapV3TickDayDataV3DTO</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>UniswapV3TickDayDataV3DTO</code>.
     */
 ...
 */
UniswapV3TickDayDataV3DTO.prototype['entry_time'] = undefined;

/**
 * @member {Date} recv_time
 */
UniswapV3TickDayDataV3DTO.prototype['recv_time'] = undefined;

/**
 * Number of block in which entity was recorded.
 * @member {Number} block_number
 */
UniswapV3TickDayDataV3DTO.prototype['block_number'] = undefined;

/**
 * Identifier, format: <pool address>-<tick index>-<timestamp>.
 * @member {String} id
 */
UniswapV3TickDayDataV3DTO.prototype['id'] = undefined;

/**
 * Timestamp rounded to current day by dividing by 86400.
 * @member {Number} date
 */
UniswapV3TickDayDataV3DTO.prototype['date'] = undefined;

/**
 * Pointer to pool.
 * @member {String} pool
 */
UniswapV3TickDayDataV3DTO.prototype['pool'] = undefined;

/**
 * Pointer to tick.
 * @member {String} tick
 */
UniswapV3TickDayDataV3DTO.prototype['tick'] = undefined;

/**
 * Total liquidity pool has as tick lower or upper at end of period.
 * @member {String} liquidity_gross
 */
UniswapV3TickDayDataV3DTO.prototype['liquidity_gross'] = undefined;

/**
 * How much liquidity changes when tick crossed at end of period.
 * @member {String} liquidity_net
 */
UniswapV3TickDayDataV3DTO.prototype['liquidity_net'] = undefined;

/**
 * Hourly volume of token0 with this tick in range.
 * @member {String} volume_token_0
 */
UniswapV3TickDayDataV3DTO.prototype['volume_token_0'] = undefined;

/**
 * Hourly volume of token1 with this tick in range.
 * @member {String} volume_token_1
 */
UniswapV3TickDayDataV3DTO.prototype['volume_token_1'] = undefined;

/**
 * Hourly volume in derived USD with this tick in range.
 * @member {String} volume_usd
 */
UniswapV3TickDayDataV3DTO.prototype['volume_usd'] = undefined;

/**
 * Fees in USD.
 * @member {String} fees_usd
 */
UniswapV3TickDayDataV3DTO.prototype['fees_usd'] = undefined;

/**
 * Variable needed for fee computation.
 * @member {String} fee_growth_outside_0x128
 */
UniswapV3TickDayDataV3DTO.prototype['fee_growth_outside_0x128'] = undefined;

/**
 * Variable needed for fee computation.
 * @member {String} fee_growth_outside_1x128
 */
UniswapV3TickDayDataV3DTO.prototype['fee_growth_outside_1x128'] = undefined;

/**
 * 
 * @member {Number} vid
 */
UniswapV3TickDayDataV3DTO.prototype['vid'] = undefined;
...
export default UniswapV3TickDayDataV3DTO;
