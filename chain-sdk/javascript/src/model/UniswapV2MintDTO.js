...
/**
 * The UniswapV2MintDTO model module.
 * @module model/UniswapV2MintDTO
 * @version v1
 */
class UniswapV2MintDTO {
    /**
     * Constructs a new <code>UniswapV2MintDTO</code>.
     ...
     * @alias module:model/UniswapV2MintDTO
     */
    constructor() { 
        
        UniswapV2MintDTO.initialize(this);
    }
    ...
    /**
     * Constructs a <code>UniswapV2MintDTO</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/UniswapV2MintDTO} obj Optional instance to populate.
     * @return {module:model/UniswapV2MintDTO} The populated <code>UniswapV2MintDTO</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new UniswapV2MintDTO();
    ...
    /**
     * Validates the JSON data with respect to <code>UniswapV2MintDTO</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>UniswapV2MintDTO</code>.
     */
 ...
 */
UniswapV2MintDTO.prototype['entry_time'] = undefined;

/**
 * @member {Date} recv_time
 */
UniswapV2MintDTO.prototype['recv_time'] = undefined;

/**
 * Number of block in which entity was recorded.
 * @member {Number} block_number
 */
UniswapV2MintDTO.prototype['block_number'] = undefined;

/**
 * Transaction hash plus index in the transaction mint array.
 * @member {String} id
 */
UniswapV2MintDTO.prototype['id'] = undefined;

/**
 * Reference to the transaction Mint was included in.
 * @member {String} transaction
 */
UniswapV2MintDTO.prototype['transaction'] = undefined;

/**
 * Timestamp of Mint, used to sort recent liquidity provisions.
 * @member {String} timestamp
 */
UniswapV2MintDTO.prototype['timestamp'] = undefined;

/**
 * Reference to pair.
 * @member {String} pair
 */
UniswapV2MintDTO.prototype['pair'] = undefined;

/**
 * Recipient of liquidity tokens.
 * @member {String} to
 */
UniswapV2MintDTO.prototype['to'] = undefined;

/**
 * Amount of liquidity tokens minted.
 * @member {String} liquidity
 */
UniswapV2MintDTO.prototype['liquidity'] = undefined;

/**
 * Address that initiated the liquidity provision.
 * @member {String} sender
 */
UniswapV2MintDTO.prototype['sender'] = undefined;

/**
 * Amount of token0 provided.
 * @member {String} amount_0
 */
UniswapV2MintDTO.prototype['amount_0'] = undefined;

/**
 * Amount of token1 provided.
 * @member {String} amount_1
 */
UniswapV2MintDTO.prototype['amount_1'] = undefined;

/**
 * Index in the transaction event was emitted.
 * @member {String} log_index
 */
UniswapV2MintDTO.prototype['log_index'] = undefined;

/**
 * Derived USD value of token0 amount plus token1 amount.
 * @member {String} amount_usd
 */
UniswapV2MintDTO.prototype['amount_usd'] = undefined;

/**
 * Address of fee recipient (if fee is on).
 * @member {String} fee_to
 */
UniswapV2MintDTO.prototype['fee_to'] = undefined;

/**
 * Amount of liquidity sent to fee recipient (if fee is on).
 * @member {String} fee_liquidity
 */
UniswapV2MintDTO.prototype['fee_liquidity'] = undefined;

/**
 * 
 * @member {Number} vid
 */
UniswapV2MintDTO.prototype['vid'] = undefined;

/**
 * 
 * @member {String} block_range
 */
UniswapV2MintDTO.prototype['block_range'] = undefined;
...
export default UniswapV2MintDTO;
