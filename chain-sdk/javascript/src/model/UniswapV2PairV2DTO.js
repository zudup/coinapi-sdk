...
/**
 * The UniswapV2PairV2DTO model module.
 * @module model/UniswapV2PairV2DTO
 * @version v1
 */
class UniswapV2PairV2DTO {
    /**
     * Constructs a new <code>UniswapV2PairV2DTO</code>.
     * Information about a pair. Includes references to each token within the pair, volume information, liquidity information, and more. The pair entity mirrors the pair smart contract, and also contains aggregated information about use.
     * @alias module:model/UniswapV2PairV2DTO
     */
    constructor() { 
        
        UniswapV2PairV2DTO.initialize(this);
    }
    ...
    /**
     * Constructs a <code>UniswapV2PairV2DTO</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/UniswapV2PairV2DTO} obj Optional instance to populate.
     * @return {module:model/UniswapV2PairV2DTO} The populated <code>UniswapV2PairV2DTO</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new UniswapV2PairV2DTO();
    ...
    /**
     * Validates the JSON data with respect to <code>UniswapV2PairV2DTO</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>UniswapV2PairV2DTO</code>.
     */
 ...
 */
UniswapV2PairV2DTO.prototype['entry_time'] = undefined;

/**
 * @member {Date} recv_time
 */
UniswapV2PairV2DTO.prototype['recv_time'] = undefined;

/**
 * Number of block in which entity was recorded.
 * @member {Number} block_number
 */
UniswapV2PairV2DTO.prototype['block_number'] = undefined;

/**
 * 
 * @member {Number} vid
 */
UniswapV2PairV2DTO.prototype['vid'] = undefined;

/**
 * Pair contract address.
 * @member {String} id
 */
UniswapV2PairV2DTO.prototype['id'] = undefined;

/**
 * Reference to token0 as stored in pair contract.
 * @member {String} token_0
 */
UniswapV2PairV2DTO.prototype['token_0'] = undefined;

/**
 * Reference to token1 as stored in pair contract.
 * @member {String} token_1
 */
UniswapV2PairV2DTO.prototype['token_1'] = undefined;

/**
 * Reserve of token0.
 * @member {String} reserve_0
 */
UniswapV2PairV2DTO.prototype['reserve_0'] = undefined;

/**
 * Reserve of token1.
 * @member {String} reserve_1
 */
UniswapV2PairV2DTO.prototype['reserve_1'] = undefined;

/**
 * Total supply of liquidity token distributed to LPs.
 * @member {String} total_supply
 */
UniswapV2PairV2DTO.prototype['total_supply'] = undefined;

/**
 * Total liquidity in pair stored as an amount of ETH.
 * @member {String} reserve_eth
 */
UniswapV2PairV2DTO.prototype['reserve_eth'] = undefined;

/**
 * Total liquidity amount in pair stored as an amount of USD.
 * @member {String} reserve_usd
 */
UniswapV2PairV2DTO.prototype['reserve_usd'] = undefined;

/**
 * Total liquidity with only tracked amount.
 * @member {String} tracked_reserve_eth
 */
UniswapV2PairV2DTO.prototype['tracked_reserve_eth'] = undefined;

/**
 * Token0 per token1.
 * @member {String} token_0_price
 */
UniswapV2PairV2DTO.prototype['token_0_price'] = undefined;

/**
 * Token1 per token0.
 * @member {String} token_1_price
 */
UniswapV2PairV2DTO.prototype['token_1_price'] = undefined;

/**
 * Amount of token0 swapped on this pair.
 * @member {String} volume_token_0
 */
UniswapV2PairV2DTO.prototype['volume_token_0'] = undefined;

/**
 * Amount of token1 swapped on this pair.
 * @member {String} volume_token_1
 */
UniswapV2PairV2DTO.prototype['volume_token_1'] = undefined;

/**
 * Total amount swapped all time in this pair stored in USD (only tracked if USD liquidity is above minimum threshold).
 * @member {String} volume_usd
 */
UniswapV2PairV2DTO.prototype['volume_usd'] = undefined;

/**
 * Total amount swapped all time in this pair stored in USD, no minimum liquidity threshold.
 * @member {String} untracked_volume_usd
 */
UniswapV2PairV2DTO.prototype['untracked_volume_usd'] = undefined;

/**
 * @member {module:model/NumericsBigInteger} tx_count
 */
UniswapV2PairV2DTO.prototype['tx_count'] = undefined;

/**
 * Timestamp contract was created.
 * @member {Date} created_at_timestamp
 */
UniswapV2PairV2DTO.prototype['created_at_timestamp'] = undefined;

/**
 * Total number of LPs.
 * @member {String} liquidity_provider_count
 */
UniswapV2PairV2DTO.prototype['liquidity_provider_count'] = undefined;

/**
 * @member {Number} evaluated_ask
 */
UniswapV2PairV2DTO.prototype['evaluated_ask'] = undefined;
...
export default UniswapV2PairV2DTO;
