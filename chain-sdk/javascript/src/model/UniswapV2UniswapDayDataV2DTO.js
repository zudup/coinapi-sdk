...
/**
 * The UniswapV2UniswapDayDataV2DTO model module.
 * @module model/UniswapV2UniswapDayDataV2DTO
 * @version v1
 */
class UniswapV2UniswapDayDataV2DTO {
    /**
     * Constructs a new <code>UniswapV2UniswapDayDataV2DTO</code>.
     * Tracks data across all pairs aggregated into a daily bucket.
     * @alias module:model/UniswapV2UniswapDayDataV2DTO
     */
    constructor() { 
        
        UniswapV2UniswapDayDataV2DTO.initialize(this);
    }
    ...
    /**
     * Constructs a <code>UniswapV2UniswapDayDataV2DTO</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/UniswapV2UniswapDayDataV2DTO} obj Optional instance to populate.
     * @return {module:model/UniswapV2UniswapDayDataV2DTO} The populated <code>UniswapV2UniswapDayDataV2DTO</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new UniswapV2UniswapDayDataV2DTO();
    ...
    /**
     * Validates the JSON data with respect to <code>UniswapV2UniswapDayDataV2DTO</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>UniswapV2UniswapDayDataV2DTO</code>.
     */
 ...
 */
UniswapV2UniswapDayDataV2DTO.prototype['entry_time'] = undefined;

/**
 * @member {Date} recv_time
 */
UniswapV2UniswapDayDataV2DTO.prototype['recv_time'] = undefined;

/**
 * Number of block in which entity was recorded.
 * @member {Number} block_number
 */
UniswapV2UniswapDayDataV2DTO.prototype['block_number'] = undefined;

/**
 * Unix timestamp for start of day / 86400 giving a unique day index.
 * @member {String} id
 */
UniswapV2UniswapDayDataV2DTO.prototype['id'] = undefined;

/**
 * Unix timestamp for start of day.
 * @member {Number} date
 */
UniswapV2UniswapDayDataV2DTO.prototype['date'] = undefined;

/**
 * Total volume across all pairs on this day, stored as a derived amount of ETH.
 * @member {String} daily_volume_eth
 */
UniswapV2UniswapDayDataV2DTO.prototype['daily_volume_eth'] = undefined;

/**
 * Total volume across all pairs on this day, stored as a derived amount of USD.
 * @member {String} daily_volume_usd
 */
UniswapV2UniswapDayDataV2DTO.prototype['daily_volume_usd'] = undefined;

/**
 * Total volume across all pairs on this day, untracked.
 * @member {String} daily_volume_untracked
 */
UniswapV2UniswapDayDataV2DTO.prototype['daily_volume_untracked'] = undefined;

/**
 * All time volume across all pairs in ETH up to and including this day.
 * @member {String} total_volume_eth
 */
UniswapV2UniswapDayDataV2DTO.prototype['total_volume_eth'] = undefined;

/**
 * Total liquidity across all pairs in ETH up to and including this day.
 * @member {String} total_liquidity_eth
 */
UniswapV2UniswapDayDataV2DTO.prototype['total_liquidity_eth'] = undefined;

/**
 * All time volume across all pairs in USD up to and including this day.
 * @member {String} total_volume_usd
 */
UniswapV2UniswapDayDataV2DTO.prototype['total_volume_usd'] = undefined;

/**
 * Total liquidity across all pairs in USD up to and including this day.
 * @member {String} total_liquidity_usd
 */
UniswapV2UniswapDayDataV2DTO.prototype['total_liquidity_usd'] = undefined;

/**
 * Number of transactions throughout this day.
 * @member {String} tx_count
 */
UniswapV2UniswapDayDataV2DTO.prototype['tx_count'] = undefined;

/**
 * 
 * @member {Number} vid
 */
UniswapV2UniswapDayDataV2DTO.prototype['vid'] = undefined;
...
export default UniswapV2UniswapDayDataV2DTO;
