...
/**
 * The UniswapV2PairDayDataV2DTO model module.
 * @module model/UniswapV2PairDayDataV2DTO
 * @version v1
 */
class UniswapV2PairDayDataV2DTO {
    /**
     * Constructs a new <code>UniswapV2PairDayDataV2DTO</code>.
     * Tracks pair data across each day.
     * @alias module:model/UniswapV2PairDayDataV2DTO
     */
    constructor() { 
        
        UniswapV2PairDayDataV2DTO.initialize(this);
    }
    ...
    /**
     * Constructs a <code>UniswapV2PairDayDataV2DTO</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/UniswapV2PairDayDataV2DTO} obj Optional instance to populate.
     * @return {module:model/UniswapV2PairDayDataV2DTO} The populated <code>UniswapV2PairDayDataV2DTO</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new UniswapV2PairDayDataV2DTO();
    ...
    /**
     * Validates the JSON data with respect to <code>UniswapV2PairDayDataV2DTO</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>UniswapV2PairDayDataV2DTO</code>.
     */
 ...
 */
UniswapV2PairDayDataV2DTO.prototype['entry_time'] = undefined;

/**
 * @member {Date} recv_time
 */
UniswapV2PairDayDataV2DTO.prototype['recv_time'] = undefined;

/**
 * Number of block in which entity was recorded.
 * @member {Number} block_number
 */
UniswapV2PairDayDataV2DTO.prototype['block_number'] = undefined;

/**
 * 
 * @member {String} id
 */
UniswapV2PairDayDataV2DTO.prototype['id'] = undefined;

/**
 * Unix timestamp for start of day.
 * @member {Number} date
 */
UniswapV2PairDayDataV2DTO.prototype['date'] = undefined;

/**
 * Address for pair contract.
 * @member {String} pair_address
 */
UniswapV2PairDayDataV2DTO.prototype['pair_address'] = undefined;

/**
 * Reference to token0.
 * @member {String} token_0
 */
UniswapV2PairDayDataV2DTO.prototype['token_0'] = undefined;

/**
 * Reference to token1.
 * @member {String} token_1
 */
UniswapV2PairDayDataV2DTO.prototype['token_1'] = undefined;

/**
 * Reserve of token0 (updated during each transaction on pair).
 * @member {String} reserve_0
 */
UniswapV2PairDayDataV2DTO.prototype['reserve_0'] = undefined;

/**
 * Reserve of token1 (updated during each transaction on pair).
 * @member {String} reserve_1
 */
UniswapV2PairDayDataV2DTO.prototype['reserve_1'] = undefined;

/**
 * Total supply of liquidity token distributed to LPs.
 * @member {String} total_supply
 */
UniswapV2PairDayDataV2DTO.prototype['total_supply'] = undefined;

/**
 * Reserve of token0 plus token1 stored as a derived USD amount.
 * @member {String} reserve_usd
 */
UniswapV2PairDayDataV2DTO.prototype['reserve_usd'] = undefined;

/**
 * Total amount of token0 swapped throughout day.
 * @member {String} daily_volume_token_0
 */
UniswapV2PairDayDataV2DTO.prototype['daily_volume_token_0'] = undefined;

/**
 * Total amount of token1 swapped throughout day.
 * @member {String} daily_volume_token_1
 */
UniswapV2PairDayDataV2DTO.prototype['daily_volume_token_1'] = undefined;

/**
 * Total volume within pair throughout day.
 * @member {String} daily_volume_usd
 */
UniswapV2PairDayDataV2DTO.prototype['daily_volume_usd'] = undefined;

/**
 * Amount of transactions on pair throughout day.
 * @member {String} daily_txns
 */
UniswapV2PairDayDataV2DTO.prototype['daily_txns'] = undefined;

/**
 * 
 * @member {Number} vid
 */
UniswapV2PairDayDataV2DTO.prototype['vid'] = undefined;
...
export default UniswapV2PairDayDataV2DTO;
