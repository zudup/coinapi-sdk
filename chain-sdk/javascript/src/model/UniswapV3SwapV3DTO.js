...
/**
 * The UniswapV3SwapV3DTO model module.
 * @module model/UniswapV3SwapV3DTO
 * @version v1
 */
class UniswapV3SwapV3DTO {
    /**
     * Constructs a new <code>UniswapV3SwapV3DTO</code>.
     * Swap are created for each token swap within a pair.
     * @alias module:model/UniswapV3SwapV3DTO
     */
    constructor() { 
        
        UniswapV3SwapV3DTO.initialize(this);
    }
    ...
    /**
     * Constructs a <code>UniswapV3SwapV3DTO</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/UniswapV3SwapV3DTO} obj Optional instance to populate.
     * @return {module:model/UniswapV3SwapV3DTO} The populated <code>UniswapV3SwapV3DTO</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new UniswapV3SwapV3DTO();
    ...
    /**
     * Validates the JSON data with respect to <code>UniswapV3SwapV3DTO</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>UniswapV3SwapV3DTO</code>.
     */
 ...
 */
UniswapV3SwapV3DTO.prototype['entry_time'] = undefined;

/**
 * @member {Date} recv_time
 */
UniswapV3SwapV3DTO.prototype['recv_time'] = undefined;

/**
 * Number of block in which entity was recorded.
 * @member {Number} block_number
 */
UniswapV3SwapV3DTO.prototype['block_number'] = undefined;

/**
 * 
 * @member {Number} vid
 */
UniswapV3SwapV3DTO.prototype['vid'] = undefined;

/**
 * Identifier, format: transaction hash + \"#\" + index in swaps Transaction array.
 * @member {String} id
 */
UniswapV3SwapV3DTO.prototype['id'] = undefined;

/**
 * Pointer to transaction.
 * @member {String} transaction
 */
UniswapV3SwapV3DTO.prototype['transaction'] = undefined;

/**
 * Timestamp of transaction.
 * @member {Date} timestamp
 */
UniswapV3SwapV3DTO.prototype['timestamp'] = undefined;

/**
 * Pool swap occured within.
 * @member {String} pool
 */
UniswapV3SwapV3DTO.prototype['pool'] = undefined;

/**
 * Reference to token0 as stored in pair contract.
 * @member {String} token_0
 */
UniswapV3SwapV3DTO.prototype['token_0'] = undefined;

/**
 * Reference to token1 as stored in pair contract.
 * @member {String} token_1
 */
UniswapV3SwapV3DTO.prototype['token_1'] = undefined;

/**
 * Sender of the swap.
 * @member {String} sender
 */
UniswapV3SwapV3DTO.prototype['sender'] = undefined;

/**
 * Recipient of the swap.
 * @member {String} recipient
 */
UniswapV3SwapV3DTO.prototype['recipient'] = undefined;

/**
 * Transaction origin: the EOA (Externally Owned Account) that initiated the transaction
 * @member {String} origin
 */
UniswapV3SwapV3DTO.prototype['origin'] = undefined;

/**
 * Delta of token0 swapped.
 * @member {String} amount_0
 */
UniswapV3SwapV3DTO.prototype['amount_0'] = undefined;

/**
 * Delta of token1 swapped.
 * @member {String} amount_1
 */
UniswapV3SwapV3DTO.prototype['amount_1'] = undefined;

/**
 * Derived amount of tokens sold in USD.
 * @member {String} amount_usd
 */
UniswapV3SwapV3DTO.prototype['amount_usd'] = undefined;

/**
 * @member {module:model/NumericsBigInteger} sqrt_price_x96
 */
UniswapV3SwapV3DTO.prototype['sqrt_price_x96'] = undefined;

/**
 * @member {module:model/NumericsBigInteger} tick
 */
UniswapV3SwapV3DTO.prototype['tick'] = undefined;

/**
 * @member {module:model/NumericsBigInteger} log_index
 */
UniswapV3SwapV3DTO.prototype['log_index'] = undefined;

/**
 * @member {Number} evaluated_price
 */
UniswapV3SwapV3DTO.prototype['evaluated_price'] = undefined;

/**
 * @member {Number} evaluated_amount
 */
UniswapV3SwapV3DTO.prototype['evaluated_amount'] = undefined;

/**
 * @member {module:model/TransactionsETradeAggressiveSide} evaluated_aggressor
 */
UniswapV3SwapV3DTO.prototype['evaluated_aggressor'] = undefined;

/**
 * @member {String} pool_id
 */
UniswapV3SwapV3DTO.prototype['pool_id'] = undefined;

/**
 * @member {String} transaction_id
 */
UniswapV3SwapV3DTO.prototype['transaction_id'] = undefined;
...
export default UniswapV3SwapV3DTO;
