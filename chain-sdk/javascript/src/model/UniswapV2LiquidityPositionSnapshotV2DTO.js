...
/**
 * The UniswapV2LiquidityPositionSnapshotV2DTO model module.
 * @module model/UniswapV2LiquidityPositionSnapshotV2DTO
 * @version v1
 */
class UniswapV2LiquidityPositionSnapshotV2DTO {
    /**
     * Constructs a new <code>UniswapV2LiquidityPositionSnapshotV2DTO</code>.
     * This entity is used to store data about a user&#39;s liquidity position over time. This information, along with information from the pair itself can be used to provide position sizes, token deposits, and more. It gets created and never updated.
     * @alias module:model/UniswapV2LiquidityPositionSnapshotV2DTO
     */
    constructor() { 
        
        UniswapV2LiquidityPositionSnapshotV2DTO.initialize(this);
    }
    ...
    /**
     * Constructs a <code>UniswapV2LiquidityPositionSnapshotV2DTO</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/UniswapV2LiquidityPositionSnapshotV2DTO} obj Optional instance to populate.
     * @return {module:model/UniswapV2LiquidityPositionSnapshotV2DTO} The populated <code>UniswapV2LiquidityPositionSnapshotV2DTO</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new UniswapV2LiquidityPositionSnapshotV2DTO();
    ...
    /**
     * Validates the JSON data with respect to <code>UniswapV2LiquidityPositionSnapshotV2DTO</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>UniswapV2LiquidityPositionSnapshotV2DTO</code>.
     */
 ...
 */
UniswapV2LiquidityPositionSnapshotV2DTO.prototype['entry_time'] = undefined;

/**
 * @member {Date} recv_time
 */
UniswapV2LiquidityPositionSnapshotV2DTO.prototype['recv_time'] = undefined;

/**
 * Number of block in which entity was recorded.
 * @member {Number} block_number
 */
UniswapV2LiquidityPositionSnapshotV2DTO.prototype['block_number'] = undefined;

/**
 * Identifier, format: <pair address>-<user address>
 * @member {String} id
 */
UniswapV2LiquidityPositionSnapshotV2DTO.prototype['id'] = undefined;

/**
 * Reference to LP identifier.
 * @member {String} liquidity_position
 */
UniswapV2LiquidityPositionSnapshotV2DTO.prototype['liquidity_position'] = undefined;

/**
 * Creation time.
 * @member {Number} timestamp
 */
UniswapV2LiquidityPositionSnapshotV2DTO.prototype['timestamp'] = undefined;

/**
 * Number of block in which LP snapshot was recorded.
 * @member {Number} block
 */
UniswapV2LiquidityPositionSnapshotV2DTO.prototype['block'] = undefined;

/**
 * Reference to user.
 * @member {String} user
 */
UniswapV2LiquidityPositionSnapshotV2DTO.prototype['user'] = undefined;

/**
 * Reference to the pair liquidity is being provided on.
 * @member {String} pair
 */
UniswapV2LiquidityPositionSnapshotV2DTO.prototype['pair'] = undefined;

/**
 * Snapshot of token0 price.
 * @member {String} token_0_price_usd
 */
UniswapV2LiquidityPositionSnapshotV2DTO.prototype['token_0_price_usd'] = undefined;

/**
 * Snapshot of token0 price.
 * @member {String} token_1_price_usd
 */
UniswapV2LiquidityPositionSnapshotV2DTO.prototype['token_1_price_usd'] = undefined;

/**
 * Snapshot of pair token0 reserves.
 * @member {String} reserve_0
 */
UniswapV2LiquidityPositionSnapshotV2DTO.prototype['reserve_0'] = undefined;

/**
 * Snapshot of pair token1 reserves.
 * @member {String} reserve_1
 */
UniswapV2LiquidityPositionSnapshotV2DTO.prototype['reserve_1'] = undefined;

/**
 * Snapshot of pair reserves in USD.
 * @member {String} reserve_usd
 */
UniswapV2LiquidityPositionSnapshotV2DTO.prototype['reserve_usd'] = undefined;

/**
 * Snapshot of pool token supply.
 * @member {String} liquidity_token_total_supply
 */
UniswapV2LiquidityPositionSnapshotV2DTO.prototype['liquidity_token_total_supply'] = undefined;

/**
 * Snapshot of users pool token balance.
 * @member {String} liquidity_token_balance
 */
UniswapV2LiquidityPositionSnapshotV2DTO.prototype['liquidity_token_balance'] = undefined;

/**
 * 
 * @member {Number} vid
 */
UniswapV2LiquidityPositionSnapshotV2DTO.prototype['vid'] = undefined;

/**
 * 
 * @member {String} block_range
 */
UniswapV2LiquidityPositionSnapshotV2DTO.prototype['block_range'] = undefined;
...
export default UniswapV2LiquidityPositionSnapshotV2DTO;
