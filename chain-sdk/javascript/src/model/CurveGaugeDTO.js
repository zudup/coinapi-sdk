...
/**
 * The CurveGaugeDTO model module.
 * @module model/CurveGaugeDTO
 * @version v1
 */
class CurveGaugeDTO {
    /**
     * Constructs a new <code>CurveGaugeDTO</code>.
     * @alias module:model/CurveGaugeDTO
     */
    constructor() { 
        
        CurveGaugeDTO.initialize(this);
    }
    ...
    /**
     * Constructs a <code>CurveGaugeDTO</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CurveGaugeDTO} obj Optional instance to populate.
     * @return {module:model/CurveGaugeDTO} The populated <code>CurveGaugeDTO</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CurveGaugeDTO();
    ...
    /**
     * Validates the JSON data with respect to <code>CurveGaugeDTO</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CurveGaugeDTO</code>.
     */
 ...
 */
CurveGaugeDTO.prototype['entry_time'] = undefined;

/**
 * @member {Date} recv_time
 */
CurveGaugeDTO.prototype['recv_time'] = undefined;

/**
 * Number of block in which entity was recorded.
 * @member {Number} block_number
 */
CurveGaugeDTO.prototype['block_number'] = undefined;

/**
 * 
 * @member {String} id
 */
CurveGaugeDTO.prototype['id'] = undefined;

/**
 * 
 * @member {String} address
 */
CurveGaugeDTO.prototype['address'] = undefined;

/**
 * 
 * @member {String} type
 */
CurveGaugeDTO.prototype['type'] = undefined;

/**
 * 
 * @member {String} pool
 */
CurveGaugeDTO.prototype['pool'] = undefined;

/**
 * 
 * @member {String} created
 */
CurveGaugeDTO.prototype['created'] = undefined;

/**
 * 
 * @member {String} created_at_block
 */
CurveGaugeDTO.prototype['created_at_block'] = undefined;

/**
 * 
 * @member {String} created_at_transaction
 */
CurveGaugeDTO.prototype['created_at_transaction'] = undefined;

/**
 * 
 * @member {Number} vid
 */
CurveGaugeDTO.prototype['vid'] = undefined;
