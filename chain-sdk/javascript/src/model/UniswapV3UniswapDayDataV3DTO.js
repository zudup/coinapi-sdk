...
/**
 * The UniswapV3UniswapDayDataV3DTO model module.
 * @module model/UniswapV3UniswapDayDataV3DTO
 * @version v1
 */
class UniswapV3UniswapDayDataV3DTO {
    /**
     * Constructs a new <code>UniswapV3UniswapDayDataV3DTO</code>.
     * Data accumulated and condensed into day stats for all of Uniswap.
     * @alias module:model/UniswapV3UniswapDayDataV3DTO
     */
    constructor() { 
        
        UniswapV3UniswapDayDataV3DTO.initialize(this);
    }
    ...
    /**
     * Constructs a <code>UniswapV3UniswapDayDataV3DTO</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/UniswapV3UniswapDayDataV3DTO} obj Optional instance to populate.
     * @return {module:model/UniswapV3UniswapDayDataV3DTO} The populated <code>UniswapV3UniswapDayDataV3DTO</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new UniswapV3UniswapDayDataV3DTO();
    ...
    /**
     * Validates the JSON data with respect to <code>UniswapV3UniswapDayDataV3DTO</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>UniswapV3UniswapDayDataV3DTO</code>.
     */
 ...
 */
UniswapV3UniswapDayDataV3DTO.prototype['entry_time'] = undefined;

/**
 * @member {Date} recv_time
 */
UniswapV3UniswapDayDataV3DTO.prototype['recv_time'] = undefined;

/**
 * Number of block in which entity was recorded.
 * @member {Number} block_number
 */
UniswapV3UniswapDayDataV3DTO.prototype['block_number'] = undefined;

/**
 * 
 * @member {Number} vid
 */
UniswapV3UniswapDayDataV3DTO.prototype['vid'] = undefined;

/**
 * Timestamp rounded to current day by dividing by 86400.
 * @member {String} id
 */
UniswapV3UniswapDayDataV3DTO.prototype['id'] = undefined;

/**
 * Timestamp rounded to current day by dividing by 86400.
 * @member {Number} date
 */
UniswapV3UniswapDayDataV3DTO.prototype['date'] = undefined;

/**
 * Total volume across all pairs on this day, stored as a derived amount of ETH.
 * @member {String} volume_eth
 */
UniswapV3UniswapDayDataV3DTO.prototype['volume_eth'] = undefined;

/**
 * Total volume across all pairs on this day, stored as a derived amount of USD.
 * @member {String} volume_usd
 */
UniswapV3UniswapDayDataV3DTO.prototype['volume_usd'] = undefined;

/**
 * Total daily volume in Uniswap derived in terms of USD untracked.
 * @member {String} volume_usd_untracked
 */
UniswapV3UniswapDayDataV3DTO.prototype['volume_usd_untracked'] = undefined;

/**
 * Fees in USD
 * @member {String} fees_usd
 */
UniswapV3UniswapDayDataV3DTO.prototype['fees_usd'] = undefined;

/**
 * @member {module:model/NumericsBigInteger} tx_count
 */
UniswapV3UniswapDayDataV3DTO.prototype['tx_count'] = undefined;

/**
 * Tvl in terms of USD.
 * @member {String} tvl_usd
 */
UniswapV3UniswapDayDataV3DTO.prototype['tvl_usd'] = undefined;
...
export default UniswapV3UniswapDayDataV3DTO;
