...
/**
 * The UniswapV2UniswapFactoryV2DTO model module.
 * @module model/UniswapV2UniswapFactoryV2DTO
 * @version v1
 */
class UniswapV2UniswapFactoryV2DTO {
    /**
     * Constructs a new <code>UniswapV2UniswapFactoryV2DTO</code>.
     * The Uniswap Factory entity is responsible for storing aggregate information across all Uniswap pairs. It can be used to view stats about total liquidity, volume, amount of pairs and more.
     * @alias module:model/UniswapV2UniswapFactoryV2DTO
     */
    constructor() { 
        
        UniswapV2UniswapFactoryV2DTO.initialize(this);
    }
    ...
    /**
     * Constructs a <code>UniswapV2UniswapFactoryV2DTO</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/UniswapV2UniswapFactoryV2DTO} obj Optional instance to populate.
     * @return {module:model/UniswapV2UniswapFactoryV2DTO} The populated <code>UniswapV2UniswapFactoryV2DTO</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new UniswapV2UniswapFactoryV2DTO();
    ...
    /**
     * Validates the JSON data with respect to <code>UniswapV2UniswapFactoryV2DTO</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>UniswapV2UniswapFactoryV2DTO</code>.
     */
 ...
 */
UniswapV2UniswapFactoryV2DTO.prototype['entry_time'] = undefined;

/**
 * @member {Date} recv_time
 */
UniswapV2UniswapFactoryV2DTO.prototype['recv_time'] = undefined;

/**
 * Number of block in which entity was recorded.
 * @member {Number} block_number
 */
UniswapV2UniswapFactoryV2DTO.prototype['block_number'] = undefined;

/**
 * Factory address.
 * @member {String} id
 */
UniswapV2UniswapFactoryV2DTO.prototype['id'] = undefined;

/**
 * Amount of pairs created by the Uniswap factory.
 * @member {Number} pair_count
 */
UniswapV2UniswapFactoryV2DTO.prototype['pair_count'] = undefined;

/**
 * All time USD volume across all pairs (USD is derived).
 * @member {String} total_volume_usd
 */
UniswapV2UniswapFactoryV2DTO.prototype['total_volume_usd'] = undefined;

/**
 * All time volume in ETH across all pairs (ETH is derived).
 * @member {String} total_volume_eth
 */
UniswapV2UniswapFactoryV2DTO.prototype['total_volume_eth'] = undefined;

/**
 * Untracked volume USD.
 * @member {String} untracked_volume_usd
 */
UniswapV2UniswapFactoryV2DTO.prototype['untracked_volume_usd'] = undefined;

/**
 * Total liquidity across all pairs stored as a derived USD amount.
 * @member {String} total_liquidity_usd
 */
UniswapV2UniswapFactoryV2DTO.prototype['total_liquidity_usd'] = undefined;

/**
 * Total liquidity across all pairs stored as a derived ETH amount.
 * @member {String} total_liquidity_eth
 */
UniswapV2UniswapFactoryV2DTO.prototype['total_liquidity_eth'] = undefined;

/**
 * All time amount of transactions across all pairs.
 * @member {String} tx_count
 */
UniswapV2UniswapFactoryV2DTO.prototype['tx_count'] = undefined;

/**
 * .
 * @member {Number} vid
 */
UniswapV2UniswapFactoryV2DTO.prototype['vid'] = undefined;
...
export default UniswapV2UniswapFactoryV2DTO;
