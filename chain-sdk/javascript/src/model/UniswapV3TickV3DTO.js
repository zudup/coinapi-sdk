...
/**
 * The UniswapV3TickV3DTO model module.
 * @module model/UniswapV3TickV3DTO
 * @version v1
 */
class UniswapV3TickV3DTO {
    /**
     * Constructs a new <code>UniswapV3TickV3DTO</code>.
     * Ticks are the boundaries between discrete areas in price space.
     * @alias module:model/UniswapV3TickV3DTO
     */
    constructor() { 
        
        UniswapV3TickV3DTO.initialize(this);
    }
    ...
    /**
     * Constructs a <code>UniswapV3TickV3DTO</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/UniswapV3TickV3DTO} obj Optional instance to populate.
     * @return {module:model/UniswapV3TickV3DTO} The populated <code>UniswapV3TickV3DTO</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new UniswapV3TickV3DTO();
    ...
    /**
     * Validates the JSON data with respect to <code>UniswapV3TickV3DTO</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>UniswapV3TickV3DTO</code>.
     */
 ...
 */
UniswapV3TickV3DTO.prototype['entry_time'] = undefined;

/**
 * @member {Date} recv_time
 */
UniswapV3TickV3DTO.prototype['recv_time'] = undefined;

/**
 * Number of block in which entity was recorded.
 * @member {Number} block_number
 */
UniswapV3TickV3DTO.prototype['block_number'] = undefined;

/**
 * 
 * @member {Number} vid
 */
UniswapV3TickV3DTO.prototype['vid'] = undefined;

/**
 * Identifier, format: <pool address>#<tick index>
 * @member {String} id
 */
UniswapV3TickV3DTO.prototype['id'] = undefined;

/**
 * Pool address.
 * @member {String} pool_address
 */
UniswapV3TickV3DTO.prototype['pool_address'] = undefined;

/**
 * @member {module:model/NumericsBigInteger} tick_idx
 */
UniswapV3TickV3DTO.prototype['tick_idx'] = undefined;

/**
 * Pool address.
 * @member {String} pool
 */
UniswapV3TickV3DTO.prototype['pool'] = undefined;

/**
 * @member {module:model/NumericsBigInteger} liquidity_gross
 */
UniswapV3TickV3DTO.prototype['liquidity_gross'] = undefined;

/**
 * @member {module:model/NumericsBigInteger} liquidity_net
 */
UniswapV3TickV3DTO.prototype['liquidity_net'] = undefined;

/**
 * Calculated price of token0 of tick within this pool - constant.
 * @member {String} price_0
 */
UniswapV3TickV3DTO.prototype['price_0'] = undefined;

/**
 * Calculated price of token1 of tick within this pool - constant.
 * @member {String} price_1
 */
UniswapV3TickV3DTO.prototype['price_1'] = undefined;

/**
 * Lifetime volume of token0 with this tick in range.
 * @member {String} volume_token_0
 */
UniswapV3TickV3DTO.prototype['volume_token_0'] = undefined;

/**
 * Lifetime volume of token1 with this tick in range.
 * @member {String} volume_token_1
 */
UniswapV3TickV3DTO.prototype['volume_token_1'] = undefined;

/**
 * Lifetime volume in derived USD with this tick in range.
 * @member {String} volume_usd
 */
UniswapV3TickV3DTO.prototype['volume_usd'] = undefined;

/**
 * Lifetime volume in untracked USD with this tick in range.
 * @member {String} untracked_volume_usd
 */
UniswapV3TickV3DTO.prototype['untracked_volume_usd'] = undefined;

/**
 * Fees in USD.
 * @member {String} fees_usd
 */
UniswapV3TickV3DTO.prototype['fees_usd'] = undefined;

/**
 * All time collected fees in token0.
 * @member {String} collected_fees_token_0
 */
UniswapV3TickV3DTO.prototype['collected_fees_token_0'] = undefined;

/**
 * All time collected fees in token1.
 * @member {String} collected_fees_token_1
 */
UniswapV3TickV3DTO.prototype['collected_fees_token_1'] = undefined;

/**
 * All time collected fees in USD.
 * @member {String} collected_fees_usd
 */
UniswapV3TickV3DTO.prototype['collected_fees_usd'] = undefined;

/**
 * Created time.
 * @member {Date} created_at_timestamp
 */
UniswapV3TickV3DTO.prototype['created_at_timestamp'] = undefined;

/**
 * @member {module:model/NumericsBigInteger} liquidity_provider_count
 */
UniswapV3TickV3DTO.prototype['liquidity_provider_count'] = undefined;

/**
 * @member {module:model/NumericsBigInteger} fee_growth_outside_0x128
 */
UniswapV3TickV3DTO.prototype['fee_growth_outside_0x128'] = undefined;

/**
 * @member {module:model/NumericsBigInteger} fee_growth_outside_1x128
 */
UniswapV3TickV3DTO.prototype['fee_growth_outside_1x128'] = undefined;
...
export default UniswapV3TickV3DTO;
