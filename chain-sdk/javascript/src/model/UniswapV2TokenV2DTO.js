...
/**
 * The UniswapV2TokenV2DTO model module.
 * @module model/UniswapV2TokenV2DTO
 * @version v1
 */
class UniswapV2TokenV2DTO {
    /**
     * Constructs a new <code>UniswapV2TokenV2DTO</code>.
     * Stores aggregated information for a specific token across all pairs that token is included in.
     * @alias module:model/UniswapV2TokenV2DTO
     */
    constructor() { 
        
        UniswapV2TokenV2DTO.initialize(this);
    }
    ...
    /**
     * Constructs a <code>UniswapV2TokenV2DTO</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/UniswapV2TokenV2DTO} obj Optional instance to populate.
     * @return {module:model/UniswapV2TokenV2DTO} The populated <code>UniswapV2TokenV2DTO</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new UniswapV2TokenV2DTO();
    ...
    /**
     * Validates the JSON data with respect to <code>UniswapV2TokenV2DTO</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>UniswapV2TokenV2DTO</code>.
     */
 ...
 */
UniswapV2TokenV2DTO.prototype['entry_time'] = undefined;

/**
 * @member {Date} recv_time
 */
UniswapV2TokenV2DTO.prototype['recv_time'] = undefined;

/**
 * Number of block in which entity was recorded.
 * @member {Number} block_number
 */
UniswapV2TokenV2DTO.prototype['block_number'] = undefined;

/**
 * 
 * @member {Number} vid
 */
UniswapV2TokenV2DTO.prototype['vid'] = undefined;

/**
 * Token address.
 * @member {String} id
 */
UniswapV2TokenV2DTO.prototype['id'] = undefined;

/**
 * Token symbol.
 * @member {String} symbol
 */
UniswapV2TokenV2DTO.prototype['symbol'] = undefined;

/**
 * Token name.
 * @member {String} name
 */
UniswapV2TokenV2DTO.prototype['name'] = undefined;

/**
 * Token decimals.
 * @member {Number} decimals
 */
UniswapV2TokenV2DTO.prototype['decimals'] = undefined;

/**
 * @member {module:model/NumericsBigInteger} total_supply
 */
UniswapV2TokenV2DTO.prototype['total_supply'] = undefined;

/**
 * Amount of token traded all time across all pairs.
 * @member {String} trade_volume
 */
UniswapV2TokenV2DTO.prototype['trade_volume'] = undefined;

/**
 * Amount of token in USD traded all time across pairs (only for tokens with liquidity above minimum threshold).
 * @member {String} trade_volume_usd
 */
UniswapV2TokenV2DTO.prototype['trade_volume_usd'] = undefined;

/**
 * Amount of token in USD traded all time across pairs (no minimum liquidity threshold).
 * @member {String} untracked_volume_usd
 */
UniswapV2TokenV2DTO.prototype['untracked_volume_usd'] = undefined;

/**
 * @member {module:model/NumericsBigInteger} tx_count
 */
UniswapV2TokenV2DTO.prototype['tx_count'] = undefined;

/**
 * Total amount of token provided as liquidity across all pairs.
 * @member {String} total_liquidity
 */
UniswapV2TokenV2DTO.prototype['total_liquidity'] = undefined;

/**
 * ETH per token.
 * @member {String} derived_eth
 */
UniswapV2TokenV2DTO.prototype['derived_eth'] = undefined;

/**
 * @member {String} token_symbol
 */
UniswapV2TokenV2DTO.prototype['token_symbol'] = undefined;
...
export default UniswapV2TokenV2DTO;
