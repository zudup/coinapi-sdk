...
/**
 * The UniswapV3TokenV3DTO model module.
 * @module model/UniswapV3TokenV3DTO
 * @version v1
 */
class UniswapV3TokenV3DTO {
    /**
     * Constructs a new <code>UniswapV3TokenV3DTO</code>.
     * Stores aggregated information for a specific token across all pairs that token is included in.
     * @alias module:model/UniswapV3TokenV3DTO
     */
    constructor() { 
        
        UniswapV3TokenV3DTO.initialize(this);
    }
    ...
    /**
     * Constructs a <code>UniswapV3TokenV3DTO</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/UniswapV3TokenV3DTO} obj Optional instance to populate.
     * @return {module:model/UniswapV3TokenV3DTO} The populated <code>UniswapV3TokenV3DTO</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new UniswapV3TokenV3DTO();
    ...
    /**
     * Validates the JSON data with respect to <code>UniswapV3TokenV3DTO</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>UniswapV3TokenV3DTO</code>.
     */
 ...
 */
UniswapV3TokenV3DTO.prototype['entry_time'] = undefined;

/**
 * @member {Date} recv_time
 */
UniswapV3TokenV3DTO.prototype['recv_time'] = undefined;

/**
 * Number of block in which entity was recorded.
 * @member {Number} block_number
 */
UniswapV3TokenV3DTO.prototype['block_number'] = undefined;

/**
 * 
 * @member {Number} vid
 */
UniswapV3TokenV3DTO.prototype['vid'] = undefined;

/**
 * Token address.
 * @member {String} id
 */
UniswapV3TokenV3DTO.prototype['id'] = undefined;

/**
 * Token symbol.
 * @member {String} symbol
 */
UniswapV3TokenV3DTO.prototype['symbol'] = undefined;

/**
 * Token name.
 * @member {String} name
 */
UniswapV3TokenV3DTO.prototype['name'] = undefined;

/**
 * Token decimals.
 * @member {Number} decimals
 */
UniswapV3TokenV3DTO.prototype['decimals'] = undefined;

/**
 * @member {module:model/NumericsBigInteger} total_supply
 */
UniswapV3TokenV3DTO.prototype['total_supply'] = undefined;

/**
 * Volume in token units.
 * @member {String} volume
 */
UniswapV3TokenV3DTO.prototype['volume'] = undefined;

/**
 * Volume in derived USD.
 * @member {String} volume_usd
 */
UniswapV3TokenV3DTO.prototype['volume_usd'] = undefined;

/**
 * Volume in USD even on pools with less reliable USD values.
 * @member {String} untracked_volume_usd
 */
UniswapV3TokenV3DTO.prototype['untracked_volume_usd'] = undefined;

/**
 * Fees in USD.
 * @member {String} fees_usd
 */
UniswapV3TokenV3DTO.prototype['fees_usd'] = undefined;

/**
 * @member {module:model/NumericsBigInteger} tx_count
 */
UniswapV3TokenV3DTO.prototype['tx_count'] = undefined;

/**
 * @member {module:model/NumericsBigInteger} pool_count
 */
UniswapV3TokenV3DTO.prototype['pool_count'] = undefined;

/**
 * Liquidity across all pools in token units.
 * @member {String} total_value_locked
 */
UniswapV3TokenV3DTO.prototype['total_value_locked'] = undefined;

/**
 * Liquidity across all pools in derived USD.
 * @member {String} total_value_locked_usd
 */
UniswapV3TokenV3DTO.prototype['total_value_locked_usd'] = undefined;

/**
 * TVL derived in USD untracked.
 * @member {String} total_value_locked_usd_untracked
 */
UniswapV3TokenV3DTO.prototype['total_value_locked_usd_untracked'] = undefined;

/**
 * Derived price in ETH.
 * @member {String} derived_eth
 */
UniswapV3TokenV3DTO.prototype['derived_eth'] = undefined;

/**
 * Pools token is in that are white listed for USD pricing.
 * @member {Array.<String>} whitelist_pools
 */
UniswapV3TokenV3DTO.prototype['whitelist_pools'] = undefined;

/**
 * @member {String} token_symbol
 */
UniswapV3TokenV3DTO.prototype['token_symbol'] = undefined;
...
export default UniswapV3TokenV3DTO;
