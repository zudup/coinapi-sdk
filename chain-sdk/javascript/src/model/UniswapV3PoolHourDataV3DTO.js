...
/**
 * The UniswapV3PoolHourDataV3DTO model module.
 * @module model/UniswapV3PoolHourDataV3DTO
 * @version v1
 */
class UniswapV3PoolHourDataV3DTO {
    /**
     * Constructs a new <code>UniswapV3PoolHourDataV3DTO</code>.
     * Hourly stats tracker for pool.
     * @alias module:model/UniswapV3PoolHourDataV3DTO
     */
    constructor() { 
        
        UniswapV3PoolHourDataV3DTO.initialize(this);
    }
    ...
    /**
     * Constructs a <code>UniswapV3PoolHourDataV3DTO</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/UniswapV3PoolHourDataV3DTO} obj Optional instance to populate.
     * @return {module:model/UniswapV3PoolHourDataV3DTO} The populated <code>UniswapV3PoolHourDataV3DTO</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new UniswapV3PoolHourDataV3DTO();
    ...
    /**
     * Validates the JSON data with respect to <code>UniswapV3PoolHourDataV3DTO</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>UniswapV3PoolHourDataV3DTO</code>.
     */
 ...
 */
UniswapV3PoolHourDataV3DTO.prototype['entry_time'] = undefined;

/**
 * @member {Date} recv_time
 */
UniswapV3PoolHourDataV3DTO.prototype['recv_time'] = undefined;

/**
 * Number of block in which entity was recorded.
 * @member {Number} block_number
 */
UniswapV3PoolHourDataV3DTO.prototype['block_number'] = undefined;

/**
 * Identifier, format: <pool address>-<day id>
 * @member {String} id
 */
UniswapV3PoolHourDataV3DTO.prototype['id'] = undefined;

/**
 * Unix timestamp for start of hour.
 * @member {Number} period_start_unix
 */
UniswapV3PoolHourDataV3DTO.prototype['period_start_unix'] = undefined;

/**
 * Pointer to pool.
 * @member {String} pool
 */
UniswapV3PoolHourDataV3DTO.prototype['pool'] = undefined;

/**
 * In range liquidity at end of period.
 * @member {String} liquidity
 */
UniswapV3PoolHourDataV3DTO.prototype['liquidity'] = undefined;

/**
 * Current price tracker at end of period.
 * @member {String} sqrt_price
 */
UniswapV3PoolHourDataV3DTO.prototype['sqrt_price'] = undefined;

/**
 * Price of token0 - derived from sqrtPrice.
 * @member {String} token_0_price
 */
UniswapV3PoolHourDataV3DTO.prototype['token_0_price'] = undefined;

/**
 * Price of token1 - derived from sqrtPrice.
 * @member {String} token_1_price
 */
UniswapV3PoolHourDataV3DTO.prototype['token_1_price'] = undefined;

/**
 * Current tick at end of period.
 * @member {String} tick
 */
UniswapV3PoolHourDataV3DTO.prototype['tick'] = undefined;

/**
 * Tracker for global fee growth.
 * @member {String} fee_growth_global_0x128
 */
UniswapV3PoolHourDataV3DTO.prototype['fee_growth_global_0x128'] = undefined;

/**
 * Tracker for global fee growth.
 * @member {String} fee_growth_global_1x128
 */
UniswapV3PoolHourDataV3DTO.prototype['fee_growth_global_1x128'] = undefined;

/**
 * Total value locked derived in USD at end of period.
 * @member {String} tvl_usd
 */
UniswapV3PoolHourDataV3DTO.prototype['tvl_usd'] = undefined;

/**
 * Volume in token0.
 * @member {String} volume_token_0
 */
UniswapV3PoolHourDataV3DTO.prototype['volume_token_0'] = undefined;

/**
 * Volume in token1.
 * @member {String} volume_token_1
 */
UniswapV3PoolHourDataV3DTO.prototype['volume_token_1'] = undefined;

/**
 * Volume in USD.
 * @member {String} volume_usd
 */
UniswapV3PoolHourDataV3DTO.prototype['volume_usd'] = undefined;

/**
 * Fees in USD.
 * @member {String} fees_usd
 */
UniswapV3PoolHourDataV3DTO.prototype['fees_usd'] = undefined;

/**
 * Number of transactions during period.
 * @member {String} tx_count
 */
UniswapV3PoolHourDataV3DTO.prototype['tx_count'] = undefined;

/**
 * Opening price of token0.
 * @member {String} open
 */
UniswapV3PoolHourDataV3DTO.prototype['open'] = undefined;

/**
 * High price of token0.
 * @member {String} high
 */
UniswapV3PoolHourDataV3DTO.prototype['high'] = undefined;

/**
 * Low price of token0.
 * @member {String} low
 */
UniswapV3PoolHourDataV3DTO.prototype['low'] = undefined;

/**
 * Close price of token0.
 * @member {String} close
 */
UniswapV3PoolHourDataV3DTO.prototype['close'] = undefined;

/**
 * 
 * @member {Number} vid
 */
UniswapV3PoolHourDataV3DTO.prototype['vid'] = undefined;
...
export default UniswapV3PoolHourDataV3DTO;
