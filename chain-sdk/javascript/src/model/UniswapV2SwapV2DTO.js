...
/**
 * The UniswapV2SwapV2DTO model module.
 * @module model/UniswapV2SwapV2DTO
 * @version v1
 */
class UniswapV2SwapV2DTO {
    /**
     * Constructs a new <code>UniswapV2SwapV2DTO</code>.
     * Swap are created for each token swap within a pair.
     * @alias module:model/UniswapV2SwapV2DTO
     */
    constructor() { 
        
        UniswapV2SwapV2DTO.initialize(this);
    }
    ...
    /**
     * Constructs a <code>UniswapV2SwapV2DTO</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/UniswapV2SwapV2DTO} obj Optional instance to populate.
     * @return {module:model/UniswapV2SwapV2DTO} The populated <code>UniswapV2SwapV2DTO</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new UniswapV2SwapV2DTO();
    ...
    /**
     * Validates the JSON data with respect to <code>UniswapV2SwapV2DTO</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>UniswapV2SwapV2DTO</code>.
     */
 ...
 */
UniswapV2SwapV2DTO.prototype['entry_time'] = undefined;

/**
 * @member {Date} recv_time
 */
UniswapV2SwapV2DTO.prototype['recv_time'] = undefined;

/**
 * Number of block in which entity was recorded.
 * @member {Number} block_number
 */
UniswapV2SwapV2DTO.prototype['block_number'] = undefined;

/**
 * 
 * @member {Number} vid
 */
UniswapV2SwapV2DTO.prototype['vid'] = undefined;

/**
 * Transaction hash plus index in Transaction swap array.
 * @member {String} id
 */
UniswapV2SwapV2DTO.prototype['id'] = undefined;

/**
 * Reference to transaction swap was included in.
 * @member {String} transaction
 */
UniswapV2SwapV2DTO.prototype['transaction'] = undefined;

/**
 * Timestamp of swap, used for sorted lookups.
 * @member {Date} timestamp
 */
UniswapV2SwapV2DTO.prototype['timestamp'] = undefined;

/**
 * Reference to pair.
 * @member {String} pair
 */
UniswapV2SwapV2DTO.prototype['pair'] = undefined;

/**
 * Address that initiated the swap.
 * @member {String} sender
 */
UniswapV2SwapV2DTO.prototype['sender'] = undefined;

/**
 * The EOA (Externally Owned Account) that initiated the transaction.
 * @member {String} from
 */
UniswapV2SwapV2DTO.prototype['from'] = undefined;

/**
 * Amount of token0 sold.
 * @member {String} amount_0_in
 */
UniswapV2SwapV2DTO.prototype['amount_0_in'] = undefined;

/**
 * Amount of token1 sold.
 * @member {String} amount_1_in
 */
UniswapV2SwapV2DTO.prototype['amount_1_in'] = undefined;

/**
 * Amount of token0 received.
 * @member {String} amount_0_out
 */
UniswapV2SwapV2DTO.prototype['amount_0_out'] = undefined;

/**
 * Amount of token1 received.
 * @member {String} amount_1_out
 */
UniswapV2SwapV2DTO.prototype['amount_1_out'] = undefined;

/**
 * Recipient of output tokens.
 * @member {String} to
 */
UniswapV2SwapV2DTO.prototype['to'] = undefined;

/**
 * @member {module:model/NumericsBigInteger} log_index
 */
UniswapV2SwapV2DTO.prototype['log_index'] = undefined;

/**
 * Derived amount of tokens sold in USD.
 * @member {String} amount_usd
 */
UniswapV2SwapV2DTO.prototype['amount_usd'] = undefined;

/**
 * @member {Number} evaluated_price
 */
UniswapV2SwapV2DTO.prototype['evaluated_price'] = undefined;

/**
 * @member {Number} evaluated_amount
 */
UniswapV2SwapV2DTO.prototype['evaluated_amount'] = undefined;

/**
 * @member {module:model/TransactionsETradeAggressiveSide} evaluated_aggressor
 */
UniswapV2SwapV2DTO.prototype['evaluated_aggressor'] = undefined;

/**
 * @member {String} pool_id
 */
UniswapV2SwapV2DTO.prototype['pool_id'] = undefined;

/**
 * @member {String} transaction_id
 */
UniswapV2SwapV2DTO.prototype['transaction_id'] = undefined;
...
export default UniswapV2SwapV2DTO;
