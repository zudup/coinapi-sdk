...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OnChainDappsRestApi.UniswapV3SwapDTO();
  });
  ...
  describe('UniswapV3SwapDTO', function() {
    it('should create an instance of UniswapV3SwapDTO', function() {
      // uncomment below and update the code to test UniswapV3SwapDTO
      //var instance = new OnChainDappsRestApi.UniswapV3SwapDTO();
      //expect(instance).to.be.a(OnChainDappsRestApi.UniswapV3SwapDTO);
    });
    ...
    it('should have the property sqrtPriceX96 (base name: "sqrt_price_x96")', function() {
      // uncomment below and update the code to test the property sqrtPriceX96
      //var instance = new OnChainDappsRestApi.UniswapV3SwapDTO();
      //expect(instance).to.be();
    });
