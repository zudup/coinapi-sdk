...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OnChainApi.UniswapV3TokenV3DTO();
  });
  ...
  describe('UniswapV3TokenV3DTO', function() {
    it('should create an instance of UniswapV3TokenV3DTO', function() {
      // uncomment below and update the code to test UniswapV3TokenV3DTO
      //var instance = new OnChainApi.UniswapV3TokenV3DTO();
      //expect(instance).to.be.a(OnChainApi.UniswapV3TokenV3DTO);
    });
