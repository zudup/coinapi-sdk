...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OnChainApi.TokenV2DTO();
  });
  ...
  describe('TokenV2DTO', function() {
    it('should create an instance of TokenV2DTO', function() {
      // uncomment below and update the code to test TokenV2DTO
      //var instance = new OnChainApi.TokenV2DTO();
      //expect(instance).to.be.a(OnChainApi.TokenV2DTO);
    });
