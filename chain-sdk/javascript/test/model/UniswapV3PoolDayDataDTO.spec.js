...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OnChainRestApi.UniswapV3PoolDayDataDTO();
  });
  ...
  describe('UniswapV3PoolDayDataDTO', function() {
    it('should create an instance of UniswapV3PoolDayDataDTO', function() {
      ...
      //var instance = new OnChainRestApi.UniswapV3PoolDayDataDTO();
      //expect(instance).to.be.a(OnChainRestApi.UniswapV3PoolDayDataDTO);
    });
