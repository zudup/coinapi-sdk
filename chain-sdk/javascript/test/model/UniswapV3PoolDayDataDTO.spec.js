...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OnChainApi.UniswapV3PoolDayDataDTO();
  });
  ...
  describe('UniswapV3PoolDayDataDTO', function() {
    it('should create an instance of UniswapV3PoolDayDataDTO', function() {
      ...
      //var instance = new OnChainApi.UniswapV3PoolDayDataDTO();
      //expect(instance).to.be.a(OnChainApi.UniswapV3PoolDayDataDTO);
    });
