...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OnChainDappsRestApi.UniswapV3PoolDayDataDTO();
  });
  ...
  describe('UniswapV3PoolDayDataDTO', function() {
    it('should create an instance of UniswapV3PoolDayDataDTO', function() {
      // uncomment below and update the code to test UniswapV3PoolDayDataDTO
      //var instance = new OnChainDappsRestApi.UniswapV3PoolDayDataDTO();
      //expect(instance).to.be.a(OnChainDappsRestApi.UniswapV3PoolDayDataDTO);
    });
