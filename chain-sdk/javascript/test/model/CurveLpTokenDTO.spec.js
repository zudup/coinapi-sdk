...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OnChainDappsRestApi.CurveLpTokenDTO();
  });
  ...
  describe('CurveLpTokenDTO', function() {
    it('should create an instance of CurveLpTokenDTO', function() {
      // uncomment below and update the code to test CurveLpTokenDTO
      //var instance = new OnChainDappsRestApi.CurveLpTokenDTO();
      //expect(instance).to.be.a(OnChainDappsRestApi.CurveLpTokenDTO);
    });
