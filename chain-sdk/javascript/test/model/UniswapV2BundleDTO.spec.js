...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OnChainDappsRestApi.UniswapV2BundleDTO();
  });
  ...
  describe('UniswapV2BundleDTO', function() {
    it('should create an instance of UniswapV2BundleDTO', function() {
      // uncomment below and update the code to test UniswapV2BundleDTO
      //var instance = new OnChainDappsRestApi.UniswapV2BundleDTO();
      //expect(instance).to.be.a(OnChainDappsRestApi.UniswapV2BundleDTO);
    });
    ...
    it('should have the property ethPrice (base name: "eth_price")', function() {
      // uncomment below and update the code to test the property ethPrice
      //var instance = new OnChainDappsRestApi.UniswapV2BundleDTO();
      //expect(instance).to.be();
    });
