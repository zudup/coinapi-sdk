...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OnChainDappsRestApi.CurveTransferOwnershipEventDTO();
  });
  ...
  describe('CurveTransferOwnershipEventDTO', function() {
    it('should create an instance of CurveTransferOwnershipEventDTO', function() {
      // uncomment below and update the code to test CurveTransferOwnershipEventDTO
      //var instance = new OnChainDappsRestApi.CurveTransferOwnershipEventDTO();
      //expect(instance).to.be.a(OnChainDappsRestApi.CurveTransferOwnershipEventDTO);
    });
    ...
    it('should have the property newAdmin (base name: "new_admin")', function() {
      // uncomment below and update the code to test the property newAdmin
      //var instance = new OnChainDappsRestApi.CurveTransferOwnershipEventDTO();
      //expect(instance).to.be();
    });
