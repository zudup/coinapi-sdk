...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OnChainDappsRestApi.SushiswapPairHourDataDTO();
  });
  ...
  describe('SushiswapPairHourDataDTO', function() {
    it('should create an instance of SushiswapPairHourDataDTO', function() {
      // uncomment below and update the code to test SushiswapPairHourDataDTO
      //var instance = new OnChainDappsRestApi.SushiswapPairHourDataDTO();
      //expect(instance).to.be.a(OnChainDappsRestApi.SushiswapPairHourDataDTO);
    });
