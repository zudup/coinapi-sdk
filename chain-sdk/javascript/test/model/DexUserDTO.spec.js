...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OnChainDappsRestApi.DexUserDTO();
  });
  ...
  describe('DexUserDTO', function() {
    it('should create an instance of DexUserDTO', function() {
      // uncomment below and update the code to test DexUserDTO
      //var instance = new OnChainDappsRestApi.DexUserDTO();
      //expect(instance).to.be.a(OnChainDappsRestApi.DexUserDTO);
    });
