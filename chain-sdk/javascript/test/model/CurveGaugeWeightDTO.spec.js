...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OnChainDappsRestApi.CurveGaugeWeightDTO();
  });
  ...
  describe('CurveGaugeWeightDTO', function() {
    it('should create an instance of CurveGaugeWeightDTO', function() {
      // uncomment below and update the code to test CurveGaugeWeightDTO
      //var instance = new OnChainDappsRestApi.CurveGaugeWeightDTO();
      //expect(instance).to.be.a(OnChainDappsRestApi.CurveGaugeWeightDTO);
    });
