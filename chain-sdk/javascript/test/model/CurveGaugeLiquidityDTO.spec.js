...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OnChainDappsRestApi.CurveGaugeLiquidityDTO();
  });
  ...
  describe('CurveGaugeLiquidityDTO', function() {
    it('should create an instance of CurveGaugeLiquidityDTO', function() {
      // uncomment below and update the code to test CurveGaugeLiquidityDTO
      //var instance = new OnChainDappsRestApi.CurveGaugeLiquidityDTO();
      //expect(instance).to.be.a(OnChainDappsRestApi.CurveGaugeLiquidityDTO);
    });
    ...
    it('should have the property originalBalance (base name: "original_balance")', function() {
      // uncomment below and update the code to test the property originalBalance
      //var instance = new OnChainDappsRestApi.CurveGaugeLiquidityDTO();
      //expect(instance).to.be();
    });

    it('should have the property originalSupply (base name: "original_supply")', function() {
      // uncomment below and update the code to test the property originalSupply
      //var instance = new OnChainDappsRestApi.CurveGaugeLiquidityDTO();
      //expect(instance).to.be();
    });

    it('should have the property workingBalance (base name: "working_balance")', function() {
      // uncomment below and update the code to test the property workingBalance
      //var instance = new OnChainDappsRestApi.CurveGaugeLiquidityDTO();
      //expect(instance).to.be();
    });

    it('should have the property workingSupply (base name: "working_supply")', function() {
      // uncomment below and update the code to test the property workingSupply
      //var instance = new OnChainDappsRestApi.CurveGaugeLiquidityDTO();
      //expect(instance).to.be();
    });
