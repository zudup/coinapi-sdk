...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OnChainApi.TokenV3DayDataDTO();
  });
  ...
  describe('TokenV3DayDataDTO', function() {
    it('should create an instance of TokenV3DayDataDTO', function() {
      // uncomment below and update the code to test TokenV3DayDataDTO
      //var instance = new OnChainApi.TokenV3DayDataDTO();
      //expect(instance).to.be.a(OnChainApi.TokenV3DayDataDTO);
    });
