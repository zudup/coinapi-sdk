...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OnChainApi.PoolV3DTO();
  });
  ...
  describe('PoolV3DTO', function() {
    it('should create an instance of PoolV3DTO', function() {
      // uncomment below and update the code to test PoolV3DTO
      //var instance = new OnChainApi.PoolV3DTO();
      //expect(instance).to.be.a(OnChainApi.PoolV3DTO);
    });
