...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OnChainApi.UniswapV2PairDayDataV2DTO();
  });
  ...
  describe('UniswapV2PairDayDataV2DTO', function() {
    it('should create an instance of UniswapV2PairDayDataV2DTO', function() {
      // uncomment below and update the code to test UniswapV2PairDayDataV2DTO
      //var instance = new OnChainApi.UniswapV2PairDayDataV2DTO();
      //expect(instance).to.be.a(OnChainApi.UniswapV2PairDayDataV2DTO);
    });
