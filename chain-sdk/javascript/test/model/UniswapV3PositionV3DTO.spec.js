...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OnChainApi.UniswapV3PositionV3DTO();
  });
  ...
  describe('UniswapV3PositionV3DTO', function() {
    it('should create an instance of UniswapV3PositionV3DTO', function() {
      // uncomment below and update the code to test UniswapV3PositionV3DTO
      //var instance = new OnChainApi.UniswapV3PositionV3DTO();
      //expect(instance).to.be.a(OnChainApi.UniswapV3PositionV3DTO);
    });
