...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OnChainDappsRestApi.SushiswapPairDTO();
  });
  ...
  describe('SushiswapPairDTO', function() {
    it('should create an instance of SushiswapPairDTO', function() {
      ...
      //var instance = new OnChainDappsRestApi.SushiswapPairDTO();
      //expect(instance).to.be.a(OnChainDappsRestApi.SushiswapPairDTO);
    });
