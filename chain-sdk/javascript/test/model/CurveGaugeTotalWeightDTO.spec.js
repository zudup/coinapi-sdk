...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OnChainDappsRestApi.CurveGaugeTotalWeightDTO();
  });
  ...
  describe('CurveGaugeTotalWeightDTO', function() {
    it('should create an instance of CurveGaugeTotalWeightDTO', function() {
      // uncomment below and update the code to test CurveGaugeTotalWeightDTO
      //var instance = new OnChainDappsRestApi.CurveGaugeTotalWeightDTO();
      //expect(instance).to.be.a(OnChainDappsRestApi.CurveGaugeTotalWeightDTO);
    });
