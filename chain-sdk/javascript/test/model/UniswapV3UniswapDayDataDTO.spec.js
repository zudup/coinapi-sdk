...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OnChainDappsRestApi.UniswapV3UniswapDayDataDTO();
  });
  ...
  describe('UniswapV3UniswapDayDataDTO', function() {
    it('should create an instance of UniswapV3UniswapDayDataDTO', function() {
      // uncomment below and update the code to test UniswapV3UniswapDayDataDTO
      //var instance = new OnChainDappsRestApi.UniswapV3UniswapDayDataDTO();
      //expect(instance).to.be.a(OnChainDappsRestApi.UniswapV3UniswapDayDataDTO);
    });
    ...
    it('should have the property volumeUsdUntracked (base name: "volume_usd_untracked")', function() {
      // uncomment below and update the code to test the property volumeUsdUntracked
      //var instance = new OnChainDappsRestApi.UniswapV3UniswapDayDataDTO();
      //expect(instance).to.be();
    });
