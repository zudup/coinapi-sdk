...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OnChainDappsRestApi.SushiswapLiquidityPositionDTO();
  });
  ...
  describe('SushiswapLiquidityPositionDTO', function() {
    it('should create an instance of SushiswapLiquidityPositionDTO', function() {
      // uncomment below and update the code to test SushiswapLiquidityPositionDTO
      //var instance = new OnChainDappsRestApi.SushiswapLiquidityPositionDTO();
      //expect(instance).to.be.a(OnChainDappsRestApi.SushiswapLiquidityPositionDTO);
    });
