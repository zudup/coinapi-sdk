...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OnChainDappsRestApi.CurveExchangeDTO();
  });
  ...
  describe('CurveExchangeDTO', function() {
    it('should create an instance of CurveExchangeDTO', function() {
      // uncomment below and update the code to test CurveExchangeDTO
      //var instance = new OnChainDappsRestApi.CurveExchangeDTO();
      //expect(instance).to.be.a(OnChainDappsRestApi.CurveExchangeDTO);
    });
    ...
    it('should have the property tokenSold (base name: "token_sold")', function() {
      // uncomment below and update the code to test the property tokenSold
      //var instance = new OnChainDappsRestApi.CurveExchangeDTO();
      //expect(instance).to.be();
    });

    it('should have the property tokenBought (base name: "token_bought")', function() {
      // uncomment below and update the code to test the property tokenBought
      //var instance = new OnChainDappsRestApi.CurveExchangeDTO();
      //expect(instance).to.be();
    });

    it('should have the property amountSold (base name: "amount_sold")', function() {
      // uncomment below and update the code to test the property amountSold
      //var instance = new OnChainDappsRestApi.CurveExchangeDTO();
      //expect(instance).to.be();
    });

    it('should have the property amountBought (base name: "amount_bought")', function() {
      // uncomment below and update the code to test the property amountBought
      //var instance = new OnChainDappsRestApi.CurveExchangeDTO();
      //expect(instance).to.be();
    });
