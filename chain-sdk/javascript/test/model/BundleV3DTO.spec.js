...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OnChainApi.BundleV3DTO();
  });
  ...
  describe('BundleV3DTO', function() {
    it('should create an instance of BundleV3DTO', function() {
      // uncomment below and update the code to test BundleV3DTO
      //var instance = new OnChainApi.BundleV3DTO();
      //expect(instance).to.be.a(OnChainApi.BundleV3DTO);
    });
