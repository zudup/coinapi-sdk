...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OnChainApi.UniswapV2UniswapDayDataDTO();
  });
  ...
  describe('UniswapV2UniswapDayDataDTO', function() {
    it('should create an instance of UniswapV2UniswapDayDataDTO', function() {
      ...
      //var instance = new OnChainApi.UniswapV2UniswapDayDataDTO();
      //expect(instance).to.be.a(OnChainApi.UniswapV2UniswapDayDataDTO);
    });
