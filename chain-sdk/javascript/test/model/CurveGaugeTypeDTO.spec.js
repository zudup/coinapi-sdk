...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OnChainDappsRestApi.CurveGaugeTypeDTO();
  });
  ...
  describe('CurveGaugeTypeDTO', function() {
    it('should create an instance of CurveGaugeTypeDTO', function() {
      ...
      //var instance = new OnChainDappsRestApi.CurveGaugeTypeDTO();
      //expect(instance).to.be.a(OnChainDappsRestApi.CurveGaugeTypeDTO);
    });
