...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OnChainDappsRestApi.UniswapV2UserDTO();
  });
  ...
  describe('UniswapV2UserDTO', function() {
    it('should create an instance of UniswapV2UserDTO', function() {
      // uncomment below and update the code to test UniswapV2UserDTO
      //var instance = new OnChainDappsRestApi.UniswapV2UserDTO();
      //expect(instance).to.be.a(OnChainDappsRestApi.UniswapV2UserDTO);
    });
    ...
    it('should have the property usdSwapped (base name: "usd_swapped")', function() {
      // uncomment below and update the code to test the property usdSwapped
      //var instance = new OnChainDappsRestApi.UniswapV2UserDTO();
      //expect(instance).to.be();
    });
