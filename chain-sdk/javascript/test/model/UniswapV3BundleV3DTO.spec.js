...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OnChainApi.UniswapV3BundleV3DTO();
  });
  ...
  describe('UniswapV3BundleV3DTO', function() {
    it('should create an instance of UniswapV3BundleV3DTO', function() {
      // uncomment below and update the code to test UniswapV3BundleV3DTO
      //var instance = new OnChainApi.UniswapV3BundleV3DTO();
      //expect(instance).to.be.a(OnChainApi.UniswapV3BundleV3DTO);
    });
