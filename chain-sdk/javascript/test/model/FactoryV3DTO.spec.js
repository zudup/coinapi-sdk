...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OnChainApi.FactoryV3DTO();
  });
  ...
  describe('FactoryV3DTO', function() {
    it('should create an instance of FactoryV3DTO', function() {
      // uncomment below and update the code to test FactoryV3DTO
      //var instance = new OnChainApi.FactoryV3DTO();
      //expect(instance).to.be.a(OnChainApi.FactoryV3DTO);
    });
