...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OnChainApi.UniswapV2UserV2DTO();
  });
  ...
  describe('UniswapV2UserV2DTO', function() {
    it('should create an instance of UniswapV2UserV2DTO', function() {
      // uncomment below and update the code to test UniswapV2UserV2DTO
      //var instance = new OnChainApi.UniswapV2UserV2DTO();
      //expect(instance).to.be.a(OnChainApi.UniswapV2UserV2DTO);
    });
