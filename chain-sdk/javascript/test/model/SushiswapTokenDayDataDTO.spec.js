...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OnChainDappsRestApi.SushiswapTokenDayDataDTO();
  });
  ...
  describe('SushiswapTokenDayDataDTO', function() {
    it('should create an instance of SushiswapTokenDayDataDTO', function() {
      // uncomment below and update the code to test SushiswapTokenDayDataDTO
      //var instance = new OnChainDappsRestApi.SushiswapTokenDayDataDTO();
      //expect(instance).to.be.a(OnChainDappsRestApi.SushiswapTokenDayDataDTO);
    });
