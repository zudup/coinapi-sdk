...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OnChainApi.PositionV3DTO();
  });
  ...
  describe('PositionV3DTO', function() {
    it('should create an instance of PositionV3DTO', function() {
      // uncomment below and update the code to test PositionV3DTO
      //var instance = new OnChainApi.PositionV3DTO();
      //expect(instance).to.be.a(OnChainApi.PositionV3DTO);
    });
