...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OnChainApi.UniswapV2PairV2DTO();
  });
  ...
  describe('UniswapV2PairV2DTO', function() {
    it('should create an instance of UniswapV2PairV2DTO', function() {
      // uncomment below and update the code to test UniswapV2PairV2DTO
      //var instance = new OnChainApi.UniswapV2PairV2DTO();
      //expect(instance).to.be.a(OnChainApi.UniswapV2PairV2DTO);
    });
