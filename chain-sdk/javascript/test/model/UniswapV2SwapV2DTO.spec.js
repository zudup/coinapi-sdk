...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OnChainApi.UniswapV2SwapV2DTO();
  });
  ...
  describe('UniswapV2SwapV2DTO', function() {
    it('should create an instance of UniswapV2SwapV2DTO', function() {
      // uncomment below and update the code to test UniswapV2SwapV2DTO
      //var instance = new OnChainApi.UniswapV2SwapV2DTO();
      //expect(instance).to.be.a(OnChainApi.UniswapV2SwapV2DTO);
    });
