...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OnChainDappsRestApi.DexSolutionDTO();
  });
  ...
  describe('DexSolutionDTO', function() {
    it('should create an instance of DexSolutionDTO', function() {
      // uncomment below and update the code to test DexSolutionDTO
      //var instance = new OnChainDappsRestApi.DexSolutionDTO();
      //expect(instance).to.be.a(OnChainDappsRestApi.DexSolutionDTO);
    });
    ...
    it('should have the property feeReward (base name: "fee_reward")', function() {
      // uncomment below and update the code to test the property feeReward
      //var instance = new OnChainDappsRestApi.DexSolutionDTO();
      //expect(instance).to.be();
    });

    it('should have the property objectiveValue (base name: "objective_value")', function() {
