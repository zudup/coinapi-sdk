...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OnChainDappsRestApi.UniswapV2MintDTO();
  });
  ...
  describe('UniswapV2MintDTO', function() {
    it('should create an instance of UniswapV2MintDTO', function() {
      ...
      //var instance = new OnChainDappsRestApi.UniswapV2MintDTO();
      //expect(instance).to.be.a(OnChainDappsRestApi.UniswapV2MintDTO);
    });
