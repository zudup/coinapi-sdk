...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OnChainApi.UniswapV2BurnV2DTO();
  });
  ...
  describe('UniswapV2BurnV2DTO', function() {
    it('should create an instance of UniswapV2BurnV2DTO', function() {
      // uncomment below and update the code to test UniswapV2BurnV2DTO
      //var instance = new OnChainApi.UniswapV2BurnV2DTO();
      //expect(instance).to.be.a(OnChainApi.UniswapV2BurnV2DTO);
    });
