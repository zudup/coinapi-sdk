...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OnChainApi.UniswapV3TickDayDataV3DTO();
  });
  ...
  describe('UniswapV3TickDayDataV3DTO', function() {
    it('should create an instance of UniswapV3TickDayDataV3DTO', function() {
      // uncomment below and update the code to test UniswapV3TickDayDataV3DTO
      //var instance = new OnChainApi.UniswapV3TickDayDataV3DTO();
      //expect(instance).to.be.a(OnChainApi.UniswapV3TickDayDataV3DTO);
    });
