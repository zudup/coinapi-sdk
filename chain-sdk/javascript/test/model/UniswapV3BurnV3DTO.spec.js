...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OnChainApi.UniswapV3BurnV3DTO();
  });
  ...
  describe('UniswapV3BurnV3DTO', function() {
    it('should create an instance of UniswapV3BurnV3DTO', function() {
      // uncomment below and update the code to test UniswapV3BurnV3DTO
      //var instance = new OnChainApi.UniswapV3BurnV3DTO();
      //expect(instance).to.be.a(OnChainApi.UniswapV3BurnV3DTO);
    });
