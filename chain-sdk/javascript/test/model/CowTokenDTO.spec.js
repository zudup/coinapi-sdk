...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OnChainDappsRestApi.CowTokenDTO();
  });
  ...
  describe('CowTokenDTO', function() {
    it('should create an instance of CowTokenDTO', function() {
      // uncomment below and update the code to test CowTokenDTO
      //var instance = new OnChainDappsRestApi.CowTokenDTO();
      //expect(instance).to.be.a(OnChainDappsRestApi.CowTokenDTO);
    });
