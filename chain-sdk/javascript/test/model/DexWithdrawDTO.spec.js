...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OnChainDappsRestApi.DexWithdrawDTO();
  });
  ...
  describe('DexWithdrawDTO', function() {
    it('should create an instance of DexWithdrawDTO', function() {
      // uncomment below and update the code to test DexWithdrawDTO
      //var instance = new OnChainDappsRestApi.DexWithdrawDTO();
      //expect(instance).to.be.a(OnChainDappsRestApi.DexWithdrawDTO);
    });
