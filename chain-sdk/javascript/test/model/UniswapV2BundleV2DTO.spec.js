...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OnChainApi.UniswapV2BundleV2DTO();
  });
  ...
  describe('UniswapV2BundleV2DTO', function() {
    it('should create an instance of UniswapV2BundleV2DTO', function() {
      // uncomment below and update the code to test UniswapV2BundleV2DTO
      //var instance = new OnChainApi.UniswapV2BundleV2DTO();
      //expect(instance).to.be.a(OnChainApi.UniswapV2BundleV2DTO);
    });
