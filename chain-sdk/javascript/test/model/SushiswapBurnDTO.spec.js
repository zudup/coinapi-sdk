...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OnChainDappsRestApi.SushiswapBurnDTO();
  });
  ...
  describe('SushiswapBurnDTO', function() {
    it('should create an instance of SushiswapBurnDTO', function() {
      // uncomment below and update the code to test SushiswapBurnDTO
      //var instance = new OnChainDappsRestApi.SushiswapBurnDTO();
      //expect(instance).to.be.a(OnChainDappsRestApi.SushiswapBurnDTO);
    });
