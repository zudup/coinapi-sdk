...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OnChainApi.UniswapV3UniswapDayDataV3DTO();
  });
  ...
  describe('UniswapV3UniswapDayDataV3DTO', function() {
    it('should create an instance of UniswapV3UniswapDayDataV3DTO', function() {
      // uncomment below and update the code to test UniswapV3UniswapDayDataV3DTO
      //var instance = new OnChainApi.UniswapV3UniswapDayDataV3DTO();
      //expect(instance).to.be.a(OnChainApi.UniswapV3UniswapDayDataV3DTO);
    });
