...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OnChainApi.TokenHourDataV3DTO();
  });
  ...
  describe('TokenHourDataV3DTO', function() {
    it('should create an instance of TokenHourDataV3DTO', function() {
      // uncomment below and update the code to test TokenHourDataV3DTO
      //var instance = new OnChainApi.TokenHourDataV3DTO();
      //expect(instance).to.be.a(OnChainApi.TokenHourDataV3DTO);
    });
