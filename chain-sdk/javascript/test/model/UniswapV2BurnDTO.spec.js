...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OnChainDappsRestApi.UniswapV2BurnDTO();
  });
  ...
  describe('UniswapV2BurnDTO', function() {
    it('should create an instance of UniswapV2BurnDTO', function() {
      // uncomment below and update the code to test UniswapV2BurnDTO
      //var instance = new OnChainDappsRestApi.UniswapV2BurnDTO();
      //expect(instance).to.be.a(OnChainDappsRestApi.UniswapV2BurnDTO);
    });
    ...
    it('should have the property needsComplete (base name: "needs_complete")', function() {
      // uncomment below and update the code to test the property needsComplete
      //var instance = new OnChainDappsRestApi.UniswapV2BurnDTO();
      //expect(instance).to.be();
    });
