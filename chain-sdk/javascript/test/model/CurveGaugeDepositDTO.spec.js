...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OnChainDappsRestApi.CurveGaugeDepositDTO();
  });
  ...
  describe('CurveGaugeDepositDTO', function() {
    it('should create an instance of CurveGaugeDepositDTO', function() {
      // uncomment below and update the code to test CurveGaugeDepositDTO
      //var instance = new OnChainDappsRestApi.CurveGaugeDepositDTO();
      //expect(instance).to.be.a(OnChainDappsRestApi.CurveGaugeDepositDTO);
    });
