...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OnChainApi.SwapV3DTO();
  });
  ...
  describe('SwapV3DTO', function() {
    it('should create an instance of SwapV3DTO', function() {
      // uncomment below and update the code to test SwapV3DTO
      //var instance = new OnChainApi.SwapV3DTO();
      //expect(instance).to.be.a(OnChainApi.SwapV3DTO);
    });
