...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OnChainDappsRestApi.UniswapV3TransactionDTO();
  });
  ...
  describe('UniswapV3TransactionDTO', function() {
    it('should create an instance of UniswapV3TransactionDTO', function() {
      // uncomment below and update the code to test UniswapV3TransactionDTO
      //var instance = new OnChainDappsRestApi.UniswapV3TransactionDTO();
      //expect(instance).to.be.a(OnChainDappsRestApi.UniswapV3TransactionDTO);
    });
