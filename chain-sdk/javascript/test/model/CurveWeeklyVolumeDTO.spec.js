...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OnChainDappsRestApi.CurveWeeklyVolumeDTO();
  });
  ...
  describe('CurveWeeklyVolumeDTO', function() {
    it('should create an instance of CurveWeeklyVolumeDTO', function() {
      // uncomment below and update the code to test CurveWeeklyVolumeDTO
      //var instance = new OnChainDappsRestApi.CurveWeeklyVolumeDTO();
      //expect(instance).to.be.a(OnChainDappsRestApi.CurveWeeklyVolumeDTO);
    });
