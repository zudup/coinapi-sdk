...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OnChainDappsRestApi.UniswapV3PositionDTO();
  });
  ...
  describe('UniswapV3PositionDTO', function() {
    it('should create an instance of UniswapV3PositionDTO', function() {
      // uncomment below and update the code to test UniswapV3PositionDTO
      //var instance = new OnChainDappsRestApi.UniswapV3PositionDTO();
      //expect(instance).to.be.a(OnChainDappsRestApi.UniswapV3PositionDTO);
    });
