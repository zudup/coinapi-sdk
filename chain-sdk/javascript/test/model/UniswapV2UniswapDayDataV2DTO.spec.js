...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OnChainApi.UniswapV2UniswapDayDataV2DTO();
  });
  ...
  describe('UniswapV2UniswapDayDataV2DTO', function() {
    it('should create an instance of UniswapV2UniswapDayDataV2DTO', function() {
      // uncomment below and update the code to test UniswapV2UniswapDayDataV2DTO
      //var instance = new OnChainApi.UniswapV2UniswapDayDataV2DTO();
      //expect(instance).to.be.a(OnChainApi.UniswapV2UniswapDayDataV2DTO);
    });
