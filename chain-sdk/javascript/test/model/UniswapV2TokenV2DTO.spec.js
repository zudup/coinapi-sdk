...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OnChainApi.UniswapV2TokenV2DTO();
  });
  ...
  describe('UniswapV2TokenV2DTO', function() {
    it('should create an instance of UniswapV2TokenV2DTO', function() {
      // uncomment below and update the code to test UniswapV2TokenV2DTO
      //var instance = new OnChainApi.UniswapV2TokenV2DTO();
      //expect(instance).to.be.a(OnChainApi.UniswapV2TokenV2DTO);
    });
