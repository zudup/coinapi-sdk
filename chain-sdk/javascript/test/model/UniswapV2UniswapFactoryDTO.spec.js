...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OnChainDappsRestApi.UniswapV2UniswapFactoryDTO();
  });
  ...
  describe('UniswapV2UniswapFactoryDTO', function() {
    it('should create an instance of UniswapV2UniswapFactoryDTO', function() {
      // uncomment below and update the code to test UniswapV2UniswapFactoryDTO
      //var instance = new OnChainDappsRestApi.UniswapV2UniswapFactoryDTO();
      //expect(instance).to.be.a(OnChainDappsRestApi.UniswapV2UniswapFactoryDTO);
    });
