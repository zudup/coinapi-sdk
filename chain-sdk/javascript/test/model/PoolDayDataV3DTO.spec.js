...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OnChainApi.PoolDayDataV3DTO();
  });
  ...
  describe('PoolDayDataV3DTO', function() {
    it('should create an instance of PoolDayDataV3DTO', function() {
      // uncomment below and update the code to test PoolDayDataV3DTO
      //var instance = new OnChainApi.PoolDayDataV3DTO();
      //expect(instance).to.be.a(OnChainApi.PoolDayDataV3DTO);
    });
