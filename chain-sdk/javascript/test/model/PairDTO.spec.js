...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OnChainApi.PairDTO();
  });
  ...
  describe('PairDTO', function() {
    it('should create an instance of PairDTO', function() {
      // uncomment below and update the code to test PairDTO
      //var instance = new OnChainApi.PairDTO();
      //expect(instance).to.be.a(OnChainApi.PairDTO);
    });
