...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OnChainDappsRestApi.CurveAmplificationCoeffChangeLogDTO();
  });
  ...
  describe('CurveAmplificationCoeffChangeLogDTO', function() {
    it('should create an instance of CurveAmplificationCoeffChangeLogDTO', function() {
      // uncomment below and update the code to test CurveAmplificationCoeffChangeLogDTO
      //var instance = new OnChainDappsRestApi.CurveAmplificationCoeffChangeLogDTO();
      //expect(instance).to.be.a(OnChainDappsRestApi.CurveAmplificationCoeffChangeLogDTO);
    });
