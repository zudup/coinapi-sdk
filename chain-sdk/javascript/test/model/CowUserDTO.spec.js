...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OnChainDappsRestApi.CowUserDTO();
  });
  ...
  describe('CowUserDTO', function() {
    it('should create an instance of CowUserDTO', function() {
      // uncomment below and update the code to test CowUserDTO
      //var instance = new OnChainDappsRestApi.CowUserDTO();
      //expect(instance).to.be.a(OnChainDappsRestApi.CowUserDTO);
    });
    ...
    it('should have the property isSolver (base name: "is_solver")', function() {
      // uncomment below and update the code to test the property isSolver
      //var instance = new OnChainDappsRestApi.CowUserDTO();
      //expect(instance).to.be();
    });
