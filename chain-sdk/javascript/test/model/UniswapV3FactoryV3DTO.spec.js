...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OnChainApi.UniswapV3FactoryV3DTO();
  });
  ...
  describe('UniswapV3FactoryV3DTO', function() {
    it('should create an instance of UniswapV3FactoryV3DTO', function() {
      // uncomment below and update the code to test UniswapV3FactoryV3DTO
      //var instance = new OnChainApi.UniswapV3FactoryV3DTO();
      //expect(instance).to.be.a(OnChainApi.UniswapV3FactoryV3DTO);
    });
