...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OnChainDappsRestApi.CurveGaugeTypeWeightDTO();
  });
  ...
  describe('CurveGaugeTypeWeightDTO', function() {
    it('should create an instance of CurveGaugeTypeWeightDTO', function() {
      // uncomment below and update the code to test CurveGaugeTypeWeightDTO
      //var instance = new OnChainDappsRestApi.CurveGaugeTypeWeightDTO();
      //expect(instance).to.be.a(OnChainDappsRestApi.CurveGaugeTypeWeightDTO);
    });
