...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OnChainDappsRestApi.SushiswapTransactionDTO();
  });
  ...
  describe('SushiswapTransactionDTO', function() {
    it('should create an instance of SushiswapTransactionDTO', function() {
      // uncomment below and update the code to test SushiswapTransactionDTO
      //var instance = new OnChainDappsRestApi.SushiswapTransactionDTO();
      //expect(instance).to.be.a(OnChainDappsRestApi.SushiswapTransactionDTO);
    });
