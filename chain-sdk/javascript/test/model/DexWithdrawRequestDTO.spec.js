...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OnChainDappsRestApi.DexWithdrawRequestDTO();
  });
  ...
  describe('DexWithdrawRequestDTO', function() {
    it('should create an instance of DexWithdrawRequestDTO', function() {
      // uncomment below and update the code to test DexWithdrawRequestDTO
      //var instance = new OnChainDappsRestApi.DexWithdrawRequestDTO();
      //expect(instance).to.be.a(OnChainDappsRestApi.DexWithdrawRequestDTO);
    });
    ...
    it('should have the property withdrawableFromBatchId (base name: "withdrawable_from_batch_id")', function() {
      // uncomment below and update the code to test the property withdrawableFromBatchId
      //var instance = new OnChainDappsRestApi.DexWithdrawRequestDTO();
      //expect(instance).to.be();
    });
    ...
    it('should have the property createBatchId (base name: "create_batch_id")', function() {
      // uncomment below and update the code to test the property createBatchId
      //var instance = new OnChainDappsRestApi.DexWithdrawRequestDTO();
      //expect(instance).to.be();
    });
