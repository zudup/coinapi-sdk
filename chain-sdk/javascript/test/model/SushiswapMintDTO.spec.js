...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OnChainDappsRestApi.SushiswapMintDTO();
  });
  ...
  describe('SushiswapMintDTO', function() {
    it('should create an instance of SushiswapMintDTO', function() {
      // uncomment below and update the code to test SushiswapMintDTO
      //var instance = new OnChainDappsRestApi.SushiswapMintDTO();
      //expect(instance).to.be.a(OnChainDappsRestApi.SushiswapMintDTO);
    });
