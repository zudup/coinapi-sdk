...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OnChainApi.SwapV2DTO();
  });
  ...
  describe('SwapV2DTO', function() {
    it('should create an instance of SwapV2DTO', function() {
      // uncomment below and update the code to test SwapV2DTO
      //var instance = new OnChainApi.SwapV2DTO();
      //expect(instance).to.be.a(OnChainApi.SwapV2DTO);
    });
