...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OnChainDappsRestApi.UniswapV3MintDTO();
  });
  ...
  describe('UniswapV3MintDTO', function() {
    it('should create an instance of UniswapV3MintDTO', function() {
      // uncomment below and update the code to test UniswapV3MintDTO
      //var instance = new OnChainDappsRestApi.UniswapV3MintDTO();
      //expect(instance).to.be.a(OnChainDappsRestApi.UniswapV3MintDTO);
    });
