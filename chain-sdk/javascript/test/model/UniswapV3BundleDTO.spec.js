...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OnChainRestApi.UniswapV3BundleDTO();
  });
  ...
  describe('UniswapV3BundleDTO', function() {
    it('should create an instance of UniswapV3BundleDTO', function() {
      ...
      //var instance = new OnChainRestApi.UniswapV3BundleDTO();
      //expect(instance).to.be.a(OnChainRestApi.UniswapV3BundleDTO);
    });
