...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OnChainDappsRestApi.UniswapV3BundleDTO();
  });
  ...
  describe('UniswapV3BundleDTO', function() {
    it('should create an instance of UniswapV3BundleDTO', function() {
      // uncomment below and update the code to test UniswapV3BundleDTO
      //var instance = new OnChainDappsRestApi.UniswapV3BundleDTO();
      //expect(instance).to.be.a(OnChainDappsRestApi.UniswapV3BundleDTO);
    });
    ...
    it('should have the property ethPriceUsd (base name: "eth_price_usd")', function() {
      // uncomment below and update the code to test the property ethPriceUsd
      //var instance = new OnChainDappsRestApi.UniswapV3BundleDTO();
      //expect(instance).to.be();
    });
