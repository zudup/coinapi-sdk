...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OnChainDappsRestApi.CurveHourlyVolumeDTO();
  });
  ...
  describe('CurveHourlyVolumeDTO', function() {
    it('should create an instance of CurveHourlyVolumeDTO', function() {
      // uncomment below and update the code to test CurveHourlyVolumeDTO
      //var instance = new OnChainDappsRestApi.CurveHourlyVolumeDTO();
      //expect(instance).to.be.a(OnChainDappsRestApi.CurveHourlyVolumeDTO);
    });
