...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OnChainApi.PairV2DTO();
  });
  ...
  describe('PairV2DTO', function() {
    it('should create an instance of PairV2DTO', function() {
      // uncomment below and update the code to test PairV2DTO
      //var instance = new OnChainApi.PairV2DTO();
      //expect(instance).to.be.a(OnChainApi.PairV2DTO);
    });
