...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OnChainApi.CurveGaugeWeightVoteDTO();
  });
  ...
  describe('CurveGaugeWeightVoteDTO', function() {
    it('should create an instance of CurveGaugeWeightVoteDTO', function() {
      ...
      //var instance = new OnChainApi.CurveGaugeWeightVoteDTO();
      //expect(instance).to.be.a(OnChainApi.CurveGaugeWeightVoteDTO);
    });
