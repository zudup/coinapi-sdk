...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OnChainDappsRestApi.CurveGaugeWeightVoteDTO();
  });
  ...
  describe('CurveGaugeWeightVoteDTO', function() {
    it('should create an instance of CurveGaugeWeightVoteDTO', function() {
      ...
      //var instance = new OnChainDappsRestApi.CurveGaugeWeightVoteDTO();
      //expect(instance).to.be.a(OnChainDappsRestApi.CurveGaugeWeightVoteDTO);
    });
