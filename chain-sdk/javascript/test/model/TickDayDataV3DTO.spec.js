...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OnChainApi.TickDayDataV3DTO();
  });
  ...
  describe('TickDayDataV3DTO', function() {
    it('should create an instance of TickDayDataV3DTO', function() {
      // uncomment below and update the code to test TickDayDataV3DTO
      //var instance = new OnChainApi.TickDayDataV3DTO();
      //expect(instance).to.be.a(OnChainApi.TickDayDataV3DTO);
    });
