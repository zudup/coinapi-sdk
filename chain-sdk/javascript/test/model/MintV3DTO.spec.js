...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OnChainApi.MintV3DTO();
  });
  ...
  describe('MintV3DTO', function() {
    it('should create an instance of MintV3DTO', function() {
      // uncomment below and update the code to test MintV3DTO
      //var instance = new OnChainApi.MintV3DTO();
      //expect(instance).to.be.a(OnChainApi.MintV3DTO);
    });
