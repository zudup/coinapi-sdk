...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OnChainApi.UniswapV2TransactionV2DTO();
  });
  ...
  describe('UniswapV2TransactionV2DTO', function() {
    it('should create an instance of UniswapV2TransactionV2DTO', function() {
      // uncomment below and update the code to test UniswapV2TransactionV2DTO
      //var instance = new OnChainApi.UniswapV2TransactionV2DTO();
      //expect(instance).to.be.a(OnChainApi.UniswapV2TransactionV2DTO);
    });
