...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OnChainDappsRestApi.CurveRemoveLiquidityEventDTO();
  });
  ...
  describe('CurveRemoveLiquidityEventDTO', function() {
    it('should create an instance of CurveRemoveLiquidityEventDTO', function() {
      // uncomment below and update the code to test CurveRemoveLiquidityEventDTO
      //var instance = new OnChainDappsRestApi.CurveRemoveLiquidityEventDTO();
      //expect(instance).to.be.a(OnChainDappsRestApi.CurveRemoveLiquidityEventDTO);
    });
