...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OnChainApi.UniswapV2LiquidityPositionV2DTO();
  });
  ...
  describe('UniswapV2LiquidityPositionV2DTO', function() {
    it('should create an instance of UniswapV2LiquidityPositionV2DTO', function() {
      // uncomment below and update the code to test UniswapV2LiquidityPositionV2DTO
      //var instance = new OnChainApi.UniswapV2LiquidityPositionV2DTO();
      //expect(instance).to.be.a(OnChainApi.UniswapV2LiquidityPositionV2DTO);
    });
