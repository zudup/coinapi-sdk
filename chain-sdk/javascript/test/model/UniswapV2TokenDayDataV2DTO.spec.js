...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OnChainApi.UniswapV2TokenDayDataV2DTO();
  });
  ...
  describe('UniswapV2TokenDayDataV2DTO', function() {
    it('should create an instance of UniswapV2TokenDayDataV2DTO', function() {
      // uncomment below and update the code to test UniswapV2TokenDayDataV2DTO
      //var instance = new OnChainApi.UniswapV2TokenDayDataV2DTO();
      //expect(instance).to.be.a(OnChainApi.UniswapV2TokenDayDataV2DTO);
    });
