...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OnChainApi.UniswapV3PoolHourDataV3DTO();
  });
  ...
  describe('UniswapV3PoolHourDataV3DTO', function() {
    it('should create an instance of UniswapV3PoolHourDataV3DTO', function() {
      // uncomment below and update the code to test UniswapV3PoolHourDataV3DTO
      //var instance = new OnChainApi.UniswapV3PoolHourDataV3DTO();
      //expect(instance).to.be.a(OnChainApi.UniswapV3PoolHourDataV3DTO);
    });
