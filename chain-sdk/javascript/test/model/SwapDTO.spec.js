...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OnChainApi.SwapDTO();
  });
  ...
  describe('SwapDTO', function() {
    it('should create an instance of SwapDTO', function() {
      // uncomment below and update the code to test SwapDTO
      //var instance = new OnChainApi.SwapDTO();
      //expect(instance).to.be.a(OnChainApi.SwapDTO);
    });
