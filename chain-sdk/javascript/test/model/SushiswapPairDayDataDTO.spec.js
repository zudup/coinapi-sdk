...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OnChainApi.SushiswapPairDayDataDTO();
  });
  ...
  describe('SushiswapPairDayDataDTO', function() {
    it('should create an instance of SushiswapPairDayDataDTO', function() {
      ...
      //var instance = new OnChainApi.SushiswapPairDayDataDTO();
      //expect(instance).to.be.a(OnChainApi.SushiswapPairDayDataDTO);
    });
