...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OnChainDappsRestApi.SushiswapPairDayDataDTO();
  });
  ...
  describe('SushiswapPairDayDataDTO', function() {
    it('should create an instance of SushiswapPairDayDataDTO', function() {
      // uncomment below and update the code to test SushiswapPairDayDataDTO
      //var instance = new OnChainDappsRestApi.SushiswapPairDayDataDTO();
      //expect(instance).to.be.a(OnChainDappsRestApi.SushiswapPairDayDataDTO);
    });
