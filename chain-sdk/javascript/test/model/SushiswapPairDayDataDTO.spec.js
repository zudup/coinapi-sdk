...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OnChainRestApi.SushiswapPairDayDataDTO();
  });
  ...
  describe('SushiswapPairDayDataDTO', function() {
    it('should create an instance of SushiswapPairDayDataDTO', function() {
      ...
      //var instance = new OnChainRestApi.SushiswapPairDayDataDTO();
      //expect(instance).to.be.a(OnChainRestApi.SushiswapPairDayDataDTO);
    });
