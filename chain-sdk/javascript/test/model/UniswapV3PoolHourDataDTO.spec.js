...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OnChainRestApi.UniswapV3PoolHourDataDTO();
  });
  ...
  describe('UniswapV3PoolHourDataDTO', function() {
    it('should create an instance of UniswapV3PoolHourDataDTO', function() {
      ...
      //var instance = new OnChainRestApi.UniswapV3PoolHourDataDTO();
      //expect(instance).to.be.a(OnChainRestApi.UniswapV3PoolHourDataDTO);
    });
