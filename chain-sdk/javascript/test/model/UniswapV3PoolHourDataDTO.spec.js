...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OnChainApi.UniswapV3PoolHourDataDTO();
  });
  ...
  describe('UniswapV3PoolHourDataDTO', function() {
    it('should create an instance of UniswapV3PoolHourDataDTO', function() {
      ...
      //var instance = new OnChainApi.UniswapV3PoolHourDataDTO();
      //expect(instance).to.be.a(OnChainApi.UniswapV3PoolHourDataDTO);
    });
