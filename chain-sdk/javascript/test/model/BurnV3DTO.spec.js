...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OnChainApi.BurnV3DTO();
  });
  ...
  describe('BurnV3DTO', function() {
    it('should create an instance of BurnV3DTO', function() {
      // uncomment below and update the code to test BurnV3DTO
      //var instance = new OnChainApi.BurnV3DTO();
      //expect(instance).to.be.a(OnChainApi.BurnV3DTO);
    });
