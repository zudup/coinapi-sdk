...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OnChainDappsRestApi.SushiswapHourDataDTO();
  });
  ...
  describe('SushiswapHourDataDTO', function() {
    it('should create an instance of SushiswapHourDataDTO', function() {
      // uncomment below and update the code to test SushiswapHourDataDTO
      //var instance = new OnChainDappsRestApi.SushiswapHourDataDTO();
      //expect(instance).to.be.a(OnChainDappsRestApi.SushiswapHourDataDTO);
    });
    ...
    it('should have the property untrackedVolume (base name: "untracked_volume")', function() {
      // uncomment below and update the code to test the property untrackedVolume
      //var instance = new OnChainDappsRestApi.SushiswapHourDataDTO();
      //expect(instance).to.be();
    });
