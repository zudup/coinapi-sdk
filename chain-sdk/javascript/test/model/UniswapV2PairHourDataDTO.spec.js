...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OnChainDappsRestApi.UniswapV2PairHourDataDTO();
  });
  ...
  describe('UniswapV2PairHourDataDTO', function() {
    it('should create an instance of UniswapV2PairHourDataDTO', function() {
      // uncomment below and update the code to test UniswapV2PairHourDataDTO
      //var instance = new OnChainDappsRestApi.UniswapV2PairHourDataDTO();
      //expect(instance).to.be.a(OnChainDappsRestApi.UniswapV2PairHourDataDTO);
    });
