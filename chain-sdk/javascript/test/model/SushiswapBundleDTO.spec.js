...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OnChainRestApi.SushiswapBundleDTO();
  });
  ...
  describe('SushiswapBundleDTO', function() {
    it('should create an instance of SushiswapBundleDTO', function() {
      ...
      //var instance = new OnChainRestApi.SushiswapBundleDTO();
      //expect(instance).to.be.a(OnChainRestApi.SushiswapBundleDTO);
    });
