...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OnChainDappsRestApi.SushiswapBundleDTO();
  });
  ...
  describe('SushiswapBundleDTO', function() {
    it('should create an instance of SushiswapBundleDTO', function() {
      // uncomment below and update the code to test SushiswapBundleDTO
      //var instance = new OnChainDappsRestApi.SushiswapBundleDTO();
      //expect(instance).to.be.a(OnChainDappsRestApi.SushiswapBundleDTO);
    });
