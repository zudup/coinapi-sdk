...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OnChainDappsRestApi.CurveAdminFeeChangeLogDTO();
  });
  ...
  describe('CurveAdminFeeChangeLogDTO', function() {
    it('should create an instance of CurveAdminFeeChangeLogDTO', function() {
      // uncomment below and update the code to test CurveAdminFeeChangeLogDTO
      //var instance = new OnChainDappsRestApi.CurveAdminFeeChangeLogDTO();
      //expect(instance).to.be.a(OnChainDappsRestApi.CurveAdminFeeChangeLogDTO);
    });
