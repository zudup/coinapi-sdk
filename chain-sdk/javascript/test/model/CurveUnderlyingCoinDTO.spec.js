...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OnChainDappsRestApi.CurveUnderlyingCoinDTO();
  });
  ...
  describe('CurveUnderlyingCoinDTO', function() {
    it('should create an instance of CurveUnderlyingCoinDTO', function() {
      // uncomment below and update the code to test CurveUnderlyingCoinDTO
      //var instance = new OnChainDappsRestApi.CurveUnderlyingCoinDTO();
      //expect(instance).to.be.a(OnChainDappsRestApi.CurveUnderlyingCoinDTO);
    });
