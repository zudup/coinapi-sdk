...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OnChainDappsRestApi.CurveDailyVolumeDTO();
  });
  ...
  describe('CurveDailyVolumeDTO', function() {
    it('should create an instance of CurveDailyVolumeDTO', function() {
      // uncomment below and update the code to test CurveDailyVolumeDTO
      //var instance = new OnChainDappsRestApi.CurveDailyVolumeDTO();
      //expect(instance).to.be.a(OnChainDappsRestApi.CurveDailyVolumeDTO);
    });
