...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OnChainDappsRestApi.DexPriceDTO();
  });
  ...
  describe('DexPriceDTO', function() {
    it('should create an instance of DexPriceDTO', function() {
      // uncomment below and update the code to test DexPriceDTO
      //var instance = new OnChainDappsRestApi.DexPriceDTO();
      //expect(instance).to.be.a(OnChainDappsRestApi.DexPriceDTO);
    });
    ...
    it('should have the property priceInOwlNumerator (base name: "price_in_owl_numerator")', function() {
      // uncomment below and update the code to test the property priceInOwlNumerator
      //var instance = new OnChainDappsRestApi.DexPriceDTO();
      //expect(instance).to.be();
    });

    it('should have the property priceInOwlDenominator (base name: "price_in_owl_denominator")', function() {
      // uncomment below and update the code to test the property priceInOwlDenominator
      //var instance = new OnChainDappsRestApi.DexPriceDTO();
      //expect(instance).to.be();
    });
