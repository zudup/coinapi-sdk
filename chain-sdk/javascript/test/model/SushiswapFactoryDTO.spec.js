...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OnChainDappsRestApi.SushiswapFactoryDTO();
  });
  ...
  describe('SushiswapFactoryDTO', function() {
    it('should create an instance of SushiswapFactoryDTO', function() {
      ...
      //var instance = new OnChainDappsRestApi.SushiswapFactoryDTO();
      //expect(instance).to.be.a(OnChainDappsRestApi.SushiswapFactoryDTO);
    });
