...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OnChainApi.TokenV3DTO();
  });
  ...
  describe('TokenV3DTO', function() {
    it('should create an instance of TokenV3DTO', function() {
      // uncomment below and update the code to test TokenV3DTO
      //var instance = new OnChainApi.TokenV3DTO();
      //expect(instance).to.be.a(OnChainApi.TokenV3DTO);
    });
