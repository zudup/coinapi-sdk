...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OnChainDappsRestApi.CurveGaugeDTO();
  });
  ...
  describe('CurveGaugeDTO', function() {
    it('should create an instance of CurveGaugeDTO', function() {
      ...
      //var instance = new OnChainDappsRestApi.CurveGaugeDTO();
      //expect(instance).to.be.a(OnChainDappsRestApi.CurveGaugeDTO);
    });
