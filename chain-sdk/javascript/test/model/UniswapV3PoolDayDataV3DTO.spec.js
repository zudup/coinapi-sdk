...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OnChainApi.UniswapV3PoolDayDataV3DTO();
  });
  ...
  describe('UniswapV3PoolDayDataV3DTO', function() {
    it('should create an instance of UniswapV3PoolDayDataV3DTO', function() {
      // uncomment below and update the code to test UniswapV3PoolDayDataV3DTO
      //var instance = new OnChainApi.UniswapV3PoolDayDataV3DTO();
      //expect(instance).to.be.a(OnChainApi.UniswapV3PoolDayDataV3DTO);
    });
