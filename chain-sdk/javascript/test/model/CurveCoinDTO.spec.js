...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OnChainDappsRestApi.CurveCoinDTO();
  });
  ...
  describe('CurveCoinDTO', function() {
    it('should create an instance of CurveCoinDTO', function() {
      ...
      //var instance = new OnChainDappsRestApi.CurveCoinDTO();
      //expect(instance).to.be.a(OnChainDappsRestApi.CurveCoinDTO);
    });
