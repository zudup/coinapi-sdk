...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OnChainDappsRestApi.CurveAccountDTO();
  });
  ...
  describe('CurveAccountDTO', function() {
    it('should create an instance of CurveAccountDTO', function() {
      // uncomment below and update the code to test CurveAccountDTO
      //var instance = new OnChainDappsRestApi.CurveAccountDTO();
      //expect(instance).to.be.a(OnChainDappsRestApi.CurveAccountDTO);
    });
