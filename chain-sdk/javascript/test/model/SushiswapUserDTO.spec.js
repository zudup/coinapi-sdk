...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OnChainDappsRestApi.SushiswapUserDTO();
  });
  ...
  describe('SushiswapUserDTO', function() {
    it('should create an instance of SushiswapUserDTO', function() {
      // uncomment below and update the code to test SushiswapUserDTO
      //var instance = new OnChainDappsRestApi.SushiswapUserDTO();
      //expect(instance).to.be.a(OnChainDappsRestApi.SushiswapUserDTO);
    });
