...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OnChainDappsRestApi.CurveContractVersionDTO();
  });
  ...
  describe('CurveContractVersionDTO', function() {
    it('should create an instance of CurveContractVersionDTO', function() {
      // uncomment below and update the code to test CurveContractVersionDTO
      //var instance = new OnChainDappsRestApi.CurveContractVersionDTO();
      //expect(instance).to.be.a(OnChainDappsRestApi.CurveContractVersionDTO);
    });
