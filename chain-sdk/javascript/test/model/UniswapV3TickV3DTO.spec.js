...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OnChainApi.UniswapV3TickV3DTO();
  });
  ...
  describe('UniswapV3TickV3DTO', function() {
    it('should create an instance of UniswapV3TickV3DTO', function() {
      // uncomment below and update the code to test UniswapV3TickV3DTO
      //var instance = new OnChainApi.UniswapV3TickV3DTO();
      //expect(instance).to.be.a(OnChainApi.UniswapV3TickV3DTO);
    });
