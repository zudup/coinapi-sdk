...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OnChainDappsRestApi.UniswapV3TickDayDataDTO();
  });
  ...
  describe('UniswapV3TickDayDataDTO', function() {
    it('should create an instance of UniswapV3TickDayDataDTO', function() {
      // uncomment below and update the code to test UniswapV3TickDayDataDTO
      //var instance = new OnChainDappsRestApi.UniswapV3TickDayDataDTO();
      //expect(instance).to.be.a(OnChainDappsRestApi.UniswapV3TickDayDataDTO);
    });
