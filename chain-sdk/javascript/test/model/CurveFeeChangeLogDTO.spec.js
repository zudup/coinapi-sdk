...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OnChainDappsRestApi.CurveFeeChangeLogDTO();
  });
  ...
  describe('CurveFeeChangeLogDTO', function() {
    it('should create an instance of CurveFeeChangeLogDTO', function() {
      // uncomment below and update the code to test CurveFeeChangeLogDTO
      //var instance = new OnChainDappsRestApi.CurveFeeChangeLogDTO();
      //expect(instance).to.be.a(OnChainDappsRestApi.CurveFeeChangeLogDTO);
    });
