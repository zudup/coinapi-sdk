...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OnChainDappsRestApi.DexBatchDTO();
  });
  ...
  describe('DexBatchDTO', function() {
    it('should create an instance of DexBatchDTO', function() {
      // uncomment below and update the code to test DexBatchDTO
      //var instance = new OnChainDappsRestApi.DexBatchDTO();
      //expect(instance).to.be.a(OnChainDappsRestApi.DexBatchDTO);
    });
    ...
    it('should have the property startEpoch (base name: "start_epoch")', function() {
      // uncomment below and update the code to test the property startEpoch
      //var instance = new OnChainDappsRestApi.DexBatchDTO();
      //expect(instance).to.be();
    });
    ...
    it('should have the property firstSolutionEpoch (base name: "first_solution_epoch")', function() {
      // uncomment below and update the code to test the property firstSolutionEpoch
      //var instance = new OnChainDappsRestApi.DexBatchDTO();
      //expect(instance).to.be();
    });

    it('should have the property lastRevertEpoch (base name: "last_revert_epoch")', function() {
      // uncomment below and update the code to test the property lastRevertEpoch
      //var instance = new OnChainDappsRestApi.DexBatchDTO();
      //expect(instance).to.be();
    });
