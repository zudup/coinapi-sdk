...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OnChainApi.TickV3DTO();
  });
  ...
  describe('TickV3DTO', function() {
    it('should create an instance of TickV3DTO', function() {
      // uncomment below and update the code to test TickV3DTO
      //var instance = new OnChainApi.TickV3DTO();
      //expect(instance).to.be.a(OnChainApi.TickV3DTO);
    });
