...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OnChainDappsRestApi.SushiswapDayDataDTO();
  });
  ...
  describe('SushiswapDayDataDTO', function() {
    it('should create an instance of SushiswapDayDataDTO', function() {
      // uncomment below and update the code to test SushiswapDayDataDTO
      //var instance = new OnChainDappsRestApi.SushiswapDayDataDTO();
      //expect(instance).to.be.a(OnChainDappsRestApi.SushiswapDayDataDTO);
    });
