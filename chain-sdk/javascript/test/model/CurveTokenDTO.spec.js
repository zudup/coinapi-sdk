...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OnChainDappsRestApi.CurveTokenDTO();
  });
  ...
  describe('CurveTokenDTO', function() {
    it('should create an instance of CurveTokenDTO', function() {
      // uncomment below and update the code to test CurveTokenDTO
      //var instance = new OnChainDappsRestApi.CurveTokenDTO();
      //expect(instance).to.be.a(OnChainDappsRestApi.CurveTokenDTO);
    });
