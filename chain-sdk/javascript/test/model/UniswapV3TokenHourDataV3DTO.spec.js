...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OnChainApi.UniswapV3TokenHourDataV3DTO();
  });
  ...
  describe('UniswapV3TokenHourDataV3DTO', function() {
    it('should create an instance of UniswapV3TokenHourDataV3DTO', function() {
      // uncomment below and update the code to test UniswapV3TokenHourDataV3DTO
      //var instance = new OnChainApi.UniswapV3TokenHourDataV3DTO();
      //expect(instance).to.be.a(OnChainApi.UniswapV3TokenHourDataV3DTO);
    });
