...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OnChainApi.UniswapV3TransactionV3DTO();
  });
  ...
  describe('UniswapV3TransactionV3DTO', function() {
    it('should create an instance of UniswapV3TransactionV3DTO', function() {
      // uncomment below and update the code to test UniswapV3TransactionV3DTO
      //var instance = new OnChainApi.UniswapV3TransactionV3DTO();
      //expect(instance).to.be.a(OnChainApi.UniswapV3TransactionV3DTO);
    });
