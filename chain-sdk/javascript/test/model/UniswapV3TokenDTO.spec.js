...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OnChainDappsRestApi.UniswapV3TokenDTO();
  });
  ...
  describe('UniswapV3TokenDTO', function() {
    it('should create an instance of UniswapV3TokenDTO', function() {
      // uncomment below and update the code to test UniswapV3TokenDTO
      //var instance = new OnChainDappsRestApi.UniswapV3TokenDTO();
      //expect(instance).to.be.a(OnChainDappsRestApi.UniswapV3TokenDTO);
    });
