...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OnChainDappsRestApi.UniswapV2LiquidityPositionSnapshotDTO();
  });
  ...
  describe('UniswapV2LiquidityPositionSnapshotDTO', function() {
    it('should create an instance of UniswapV2LiquidityPositionSnapshotDTO', function() {
      // uncomment below and update the code to test UniswapV2LiquidityPositionSnapshotDTO
      //var instance = new OnChainDappsRestApi.UniswapV2LiquidityPositionSnapshotDTO();
      //expect(instance).to.be.a(OnChainDappsRestApi.UniswapV2LiquidityPositionSnapshotDTO);
    });
