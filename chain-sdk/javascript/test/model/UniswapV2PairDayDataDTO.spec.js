...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OnChainDappsRestApi.UniswapV2PairDayDataDTO();
  });
  ...
  describe('UniswapV2PairDayDataDTO', function() {
    it('should create an instance of UniswapV2PairDayDataDTO', function() {
      // uncomment below and update the code to test UniswapV2PairDayDataDTO
      //var instance = new OnChainDappsRestApi.UniswapV2PairDayDataDTO();
      //expect(instance).to.be.a(OnChainDappsRestApi.UniswapV2PairDayDataDTO);
    });
    ...
    it('should have the property pairAddress (base name: "pair_address")', function() {
      // uncomment below and update the code to test the property pairAddress
      //var instance = new OnChainDappsRestApi.UniswapV2PairDayDataDTO();
      //expect(instance).to.be();
    });
    ...
    it('should have the property dailyVolumeToken0 (base name: "daily_volume_token_0")', function() {
      // uncomment below and update the code to test the property dailyVolumeToken0
      //var instance = new OnChainDappsRestApi.UniswapV2PairDayDataDTO();
      //expect(instance).to.be();
    });

    it('should have the property dailyVolumeToken1 (base name: "daily_volume_token_1")', function() {
      // uncomment below and update the code to test the property dailyVolumeToken1
      //var instance = new OnChainDappsRestApi.UniswapV2PairDayDataDTO();
      //expect(instance).to.be();
    });
