...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OnChainApi.UniswapDayDataV3DTO();
  });
  ...
  describe('UniswapDayDataV3DTO', function() {
    it('should create an instance of UniswapDayDataV3DTO', function() {
      // uncomment below and update the code to test UniswapDayDataV3DTO
      //var instance = new OnChainApi.UniswapDayDataV3DTO();
      //expect(instance).to.be.a(OnChainApi.UniswapDayDataV3DTO);
    });
