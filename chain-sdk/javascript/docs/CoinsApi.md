...
> chainsChainIdDappsCurveCoinsHistoricalGet(chainId, opts)
...
let apiInstance = new OnChainApi.CoinsApi();
...
apiInstance.chainsChainIdDappsCurveCoinsHistoricalGet(chainId, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
