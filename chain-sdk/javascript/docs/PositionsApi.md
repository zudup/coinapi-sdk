...
> chainsChainIdDappsUniswapv3PositionsHistoricalGet(chainId, opts)
...
let apiInstance = new OnChainApi.PositionsApi();
...
apiInstance.chainsChainIdDappsUniswapv3PositionsHistoricalGet(chainId, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
