...
> chainsChainIdDappsCurveHourlyVolumeHistoricalGet(chainId, opts)
...
let apiInstance = new OnChainApi.HourlyVolumeApi();
...
apiInstance.chainsChainIdDappsCurveHourlyVolumeHistoricalGet(chainId, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
