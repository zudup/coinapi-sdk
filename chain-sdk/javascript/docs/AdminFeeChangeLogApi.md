# OnChainApi.AdminFeeChangeLogApi
...
> chainsChainIdDappsCurveAdminFeeChangeLogHistoricalGet(chainId, opts)
...
let apiInstance = new OnChainApi.AdminFeeChangeLogApi();
...
apiInstance.chainsChainIdDappsCurveAdminFeeChangeLogHistoricalGet(chainId, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
