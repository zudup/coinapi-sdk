...
> chainsChainIdDappsCurvePoiHistoricalGet(chainId, opts)
...
apiInstance.chainsChainIdDappsCurvePoiHistoricalGet(chainId, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully.');
...
> chainsChainIdDappsDexPoiHistoricalGet(chainId, opts)
...
apiInstance.chainsChainIdDappsDexPoiHistoricalGet(chainId, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully.');
