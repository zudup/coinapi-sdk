...
> chainsChainIdDappsCurveFeeChangeLogHistoricalGet(chainId, opts)
...
let apiInstance = new OnChainApi.FeeChangeLogApi();
...
apiInstance.chainsChainIdDappsCurveFeeChangeLogHistoricalGet(chainId, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
