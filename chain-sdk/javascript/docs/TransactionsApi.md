...
> chainsChainIdDappsSushiswapTransactionsHistoricalGet(chainId, opts)
...
apiInstance.chainsChainIdDappsSushiswapTransactionsHistoricalGet(chainId, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
