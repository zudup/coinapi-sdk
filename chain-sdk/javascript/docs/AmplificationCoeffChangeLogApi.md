# OnChainApi.AmplificationCoeffChangeLogApi
...
> chainsChainIdDappsCurveAmplificationCoeffChangeLogHistoricalGet(chainId, opts)
...
let apiInstance = new OnChainApi.AmplificationCoeffChangeLogApi();
...
apiInstance.chainsChainIdDappsCurveAmplificationCoeffChangeLogHistoricalGet(chainId, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
