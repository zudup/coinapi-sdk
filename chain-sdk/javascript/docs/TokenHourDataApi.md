...
> chainsChainIdDappsUniswapv3TokenHourDataHistoricalGet(chainId, opts)
...
let apiInstance = new OnChainApi.TokenHourDataApi();
...
apiInstance.chainsChainIdDappsUniswapv3TokenHourDataHistoricalGet(chainId, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
