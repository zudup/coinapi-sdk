...
> chainsChainIdDappsCurveWeeklyVolumeHistoricalGet(chainId, opts)
...
let apiInstance = new OnChainApi.WeeklyVolumeApi();
...
apiInstance.chainsChainIdDappsCurveWeeklyVolumeHistoricalGet(chainId, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
