 ...
 */
API.Client.OrdersApi.prototype.chainsChainIdDappsCowOrdersHistoricalGet = function(chainId, opt_startBlock, opt_endBlock, opt_startDate, opt_endDate, opt_extraHttpRequestParams) {
  /** @const {string} */
  var path = this.basePath_ + '/chains/{chain_id}/dapps/cow/orders/historical'
  ...
  if (!chainId) {
    throw new Error('Missing required parameter chainId when calling chainsChainIdDappsCowOrdersHistoricalGet');
  }
 ...
 * @return {!angular.$q.Promise}
 */
API.Client.OrdersApi.prototype.chainsChainIdDappsDexOrdersHistoricalGet = function(chainId, opt_startBlock, opt_endBlock, opt_startDate, opt_endDate, opt_tokenId, opt_extraHttpRequestParams) {
  /** @const {string} */
  var path = this.basePath_ + '/chains/{chain_id}/dapps/dex/orders/historical'
      .replace('{' + 'chain_id' + '}', String(chainId));
  ...
  // verify required parameter 'chainId' is set
  if (!chainId) {
    throw new Error('Missing required parameter chainId when calling chainsChainIdDappsDexOrdersHistoricalGet');
  }
  if (opt_startBlock !== undefined) {
    queryParameters['startBlock'] = opt_startBlock;
  }
