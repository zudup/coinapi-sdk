/**
 * @fileoverview AUTOMATICALLY GENERATED service for API.Client.UniswapDayDataApi.
...
goog.provide('API.Client.UniswapDayDataApi');
 ...
 * @struct
 */
API.Client.UniswapDayDataApi = function($http, $httpParamSerializer, $injector) {
  /** @private {!string} */
  this.basePath_ = $injector.has('UniswapDayDataApiBasePath') ?
                   /** @type {!string} */ ($injector.get('UniswapDayDataApiBasePath')) :
                   'https://onchain.coinapi.io';

  /** @private {!Object<string, string>} */
  this.defaultHeaders_ = $injector.has('UniswapDayDataApiDefaultHeaders') ?
                   /** @type {!Object<string, string>} */ (
                       $injector.get('UniswapDayDataApiDefaultHeaders')) :
                   {};
...
API.Client.UniswapDayDataApi.$inject = ['$http', '$httpParamSerializer', '$injector'];
