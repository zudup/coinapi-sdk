 ...
 * @return {!angular.$q.Promise}
 */
API.Client.TokensApi.prototype.chainsChainIdDappsDexTokensHistoricalGet = function(chainId, opt_startBlock, opt_endBlock, opt_startDate, opt_endDate, opt_tokenId, opt_extraHttpRequestParams) {
  /** @const {string} */
