 ...
 */
API.Client.UserApi.prototype.chainsChainIdDappsUniswapv2UsersHistoricalGet = function(chainId, opt_startBlock, opt_endBlock, opt_startDate, opt_endDate, opt_extraHttpRequestParams) {
  /** @const {string} */
