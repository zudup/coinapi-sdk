 ...
 */
API.Client.PricesApi.prototype.chainsChainIdDappsDexPricesHistoricalGet = function(chainId, opt_startBlock, opt_endBlock, opt_startDate, opt_endDate, opt_tokenId, opt_extraHttpRequestParams) {
  /** @const {string} */
  var path = this.basePath_ + '/chains/{chain_id}/dapps/dex/prices/historical'
  ...
  if (!chainId) {
    throw new Error('Missing required parameter chainId when calling chainsChainIdDappsDexPricesHistoricalGet');
  }
