/**
 * @fileoverview AUTOMATICALLY GENERATED service for API.Client.TokenDayDataApi.
...
goog.provide('API.Client.TokenDayDataApi');
 ...
 * @struct
 */
API.Client.TokenDayDataApi = function($http, $httpParamSerializer, $injector) {
  /** @private {!string} */
  this.basePath_ = $injector.has('TokenDayDataApiBasePath') ?
                   /** @type {!string} */ ($injector.get('TokenDayDataApiBasePath')) :
                   'https://onchain.coinapi.io';

  /** @private {!Object<string, string>} */
  this.defaultHeaders_ = $injector.has('TokenDayDataApiDefaultHeaders') ?
                   /** @type {!Object<string, string>} */ (
                       $injector.get('TokenDayDataApiDefaultHeaders')) :
                   {};
...
API.Client.TokenDayDataApi.$inject = ['$http', '$httpParamSerializer', '$injector'];
 ...
 */
API.Client.TokenDayDataApi.prototype.chainsChainIdDappsSushiswapTokenDayDataHistoricalGet = function(chainId, opt_startBlock, opt_endBlock, opt_startDate, opt_endDate, opt_tokenId, opt_extraHttpRequestParams) {
  /** @const {string} */
  var path = this.basePath_ + '/chains/{chain_id}/dapps/sushiswap/tokenDayData/historical'
  ...
  if (!chainId) {
    throw new Error('Missing required parameter chainId when calling chainsChainIdDappsSushiswapTokenDayDataHistoricalGet');
  }
...
API.Client.TokenDayDataApi.prototype.chainsChainIdDappsUniswapv3TokenDayDataHistoricalGet = function(chainId, opt_startBlock, opt_endBlock, opt_startDate, opt_endDate, opt_tokenId, opt_extraHttpRequestParams) {
  ...
  // verify required parameter 'chainId' is set
  if (!chainId) {
    throw new Error('Missing required parameter chainId when calling chainsChainIdDappsUniswapv3TokenDayDataHistoricalGet');
  }
  if (opt_startBlock !== undefined) {
    queryParameters['startBlock'] = opt_startBlock;
  }
