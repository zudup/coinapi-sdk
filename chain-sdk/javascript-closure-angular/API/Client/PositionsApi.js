 ...
 */
API.Client.PositionsApi.prototype.chainsChainIdDappsUniswapv3PositionsHistoricalGet = function(chainId, opt_startBlock, opt_endBlock, opt_startDate, opt_endDate, opt_poolId, opt_extraHttpRequestParams) {
  /** @const {string} */
  var path = this.basePath_ + '/chains/{chain_id}/dapps/uniswapv3/positions/historical'
  ...
  if (!chainId) {
    throw new Error('Missing required parameter chainId when calling chainsChainIdDappsUniswapv3PositionsHistoricalGet');
  }
