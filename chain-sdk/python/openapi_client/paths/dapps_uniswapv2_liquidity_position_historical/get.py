...
class BaseApi(api_client.Api):
    ...
    def _dapps_uniswapv2_liquidity_position_historical_get_oapg(
        self: api_client.Api,
...
class DappsUniswapv2LiquidityPositionHistoricalGet(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    def dapps_uniswapv2_liquidity_position_historical_get(
        self: BaseApi,
        query_params: RequestQueryParams = frozendict.frozendict(),
        stream: bool = False,
        timeout: typing.Optional[typing.Union[int, typing.Tuple]] = None,
        ...
        return self._dapps_uniswapv2_liquidity_position_historical_get_oapg(
