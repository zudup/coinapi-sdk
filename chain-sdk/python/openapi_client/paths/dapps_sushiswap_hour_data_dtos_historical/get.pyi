...
class SchemaFor200ResponseBodyTextPlain(
    ...
    def __new__(
        cls,
        arg: typing.Union[typing.Tuple['SushiswapHourDataDTO'], typing.List['SushiswapHourDataDTO']],
...
class BaseApi(api_client.Api):
    @typing.overload
    def _sushiswap_get_hour_data_dtos__historical_oapg(
        self,
...
class SushiswapGetHourDataDtosHistorical(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def sushiswap_get_hour_data_dtos__historical(
        self,
        query_params: RequestQueryParams = frozendict.frozendict(),
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
        stream: bool = False,
    ...
    def sushiswap_get_hour_data_dtos__historical(
        ...
        return self._sushiswap_get_hour_data_dtos__historical_oapg(
