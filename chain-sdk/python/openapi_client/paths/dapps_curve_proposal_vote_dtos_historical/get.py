...
class SchemaFor200ResponseBodyTextPlain(
    ...
    def __new__(
        cls,
        arg: typing.Union[typing.Tuple['CurveProposalVoteDTO'], typing.List['CurveProposalVoteDTO']],
...
class BaseApi(api_client.Api):
    @typing.overload
    def _curve_get_proposal_vote_dtos__historical_oapg(
        self,
...
class CurveGetProposalVoteDtosHistorical(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def curve_get_proposal_vote_dtos__historical(
        self,
        query_params: RequestQueryParams = frozendict.frozendict(),
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
        stream: bool = False,
    ...
    def curve_get_proposal_vote_dtos__historical(
        ...
        return self._curve_get_proposal_vote_dtos__historical_oapg(
