...
class BaseApi(api_client.Api):
    @typing.overload
    def _dapps_uniswapv3_ticks_current_get_oapg(
        self,
...
class DappsUniswapv3TicksCurrentGet(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def dapps_uniswapv3_ticks_current_get(
        self,
        query_params: RequestQueryParams = frozendict.frozendict(),
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
        stream: bool = False,
    ...
    def dapps_uniswapv3_ticks_current_get(
        ...
        return self._dapps_uniswapv3_ticks_current_get_oapg(
