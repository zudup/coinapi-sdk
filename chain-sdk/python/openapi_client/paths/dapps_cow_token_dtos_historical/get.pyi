...
class SchemaFor200ResponseBodyTextPlain(
    ...
    def __new__(
        cls,
        arg: typing.Union[typing.Tuple['CowTokenDTO'], typing.List['CowTokenDTO']],
...
class BaseApi(api_client.Api):
    @typing.overload
    def _cow_get_token_dtos__historical_oapg(
        self,
...
class CowGetTokenDtosHistorical(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def cow_get_token_dtos__historical(
        self,
        query_params: RequestQueryParams = frozendict.frozendict(),
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
        stream: bool = False,
    ...
    def cow_get_token_dtos__historical(
        ...
        return self._cow_get_token_dtos__historical_oapg(
