...
class BaseApi(api_client.Api):
    ...
    def _chains_chain_id_dapps_sushiswap_swaps_historical_get_oapg(
        self: api_client.Api,
...
class ChainsChainIdDappsSushiswapSwapsHistoricalGet(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    def chains_chain_id_dapps_sushiswap_swaps_historical_get(
        self: BaseApi,
        query_params: RequestQueryParams = frozendict.frozendict(),
        path_params: RequestPathParams = frozendict.frozendict(),
        stream: bool = False,
        ...
        return self._chains_chain_id_dapps_sushiswap_swaps_historical_get_oapg(
