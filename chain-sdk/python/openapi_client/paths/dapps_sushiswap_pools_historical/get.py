...
class SchemaFor200ResponseBodyTextPlain(
    ...
    class MetaOapg:
        ...
        @staticmethod
        def items() -> typing.Type['PairDTO']:
            return PairDTO

    def __new__(
        cls,
        arg: typing.Union[typing.Tuple['PairDTO'], typing.List['PairDTO']],
    ...
    def __getitem__(self, i: int) -> 'PairDTO':
...
class BaseApi(api_client.Api):
    @typing.overload
    def _dapps_sushiswap_pools_historical_get_oapg(
        self,
...
class DappsSushiswapPoolsHistoricalGet(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def dapps_sushiswap_pools_historical_get(
        self,
        query_params: RequestQueryParams = frozendict.frozendict(),
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
        stream: bool = False,
    ...
    def dapps_sushiswap_pools_historical_get(
        ...
        return self._dapps_sushiswap_pools_historical_get_oapg(
