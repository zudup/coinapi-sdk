...
class BaseApi(api_client.Api):
    ...
    def _chains_chain_id_dapps_uniswapv3_bundle_current_get_oapg(
        self: api_client.Api,
...
class ChainsChainIdDappsUniswapv3BundleCurrentGet(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    def chains_chain_id_dapps_uniswapv3_bundle_current_get(
        self: BaseApi,
        path_params: RequestPathParams = frozendict.frozendict(),
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
        stream: bool = False,
        ...
        return self._chains_chain_id_dapps_uniswapv3_bundle_current_get_oapg(
