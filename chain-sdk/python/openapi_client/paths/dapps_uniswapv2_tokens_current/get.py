...
class BaseApi(api_client.Api):
    @typing.overload
    def _dapps_uniswapv2_tokens_current_get_oapg(
        self,
...
class DappsUniswapv2TokensCurrentGet(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def dapps_uniswapv2_tokens_current_get(
        self,
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
        stream: bool = False,
        timeout: typing.Optional[typing.Union[int, typing.Tuple]] = None,
    ...
    def dapps_uniswapv2_tokens_current_get(
        ...
        return self._dapps_uniswapv2_tokens_current_get_oapg(
