...
class BaseApi(api_client.Api):
    @typing.overload
    def _dapps_curve_pools_historical_get_oapg(
        self,
...
class DappsCurvePoolsHistoricalGet(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def dapps_curve_pools_historical_get(
        self,
        query_params: RequestQueryParams = frozendict.frozendict(),
        stream: bool = False,
        timeout: typing.Optional[typing.Union[int, typing.Tuple]] = None,
    ...
    def dapps_curve_pools_historical_get(
        ...
        return self._dapps_curve_pools_historical_get_oapg(
