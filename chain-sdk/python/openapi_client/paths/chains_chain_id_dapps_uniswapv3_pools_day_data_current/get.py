...
class SchemaFor200ResponseBodyTextPlain(
    ...
    class MetaOapg:
        ...
        @staticmethod
        def items() -> typing.Type['PoolDayDataV3DTO']:
            return PoolDayDataV3DTO

    def __new__(
        cls,
        arg: typing.Union[typing.Tuple['PoolDayDataV3DTO'], typing.List['PoolDayDataV3DTO']],
    ...
    def __getitem__(self, i: int) -> 'PoolDayDataV3DTO':
...
class BaseApi(api_client.Api):
    ...
    def _chains_chain_id_dapps_uniswapv3_pools_day_data_current_get_oapg(
        self: api_client.Api,
...
class ChainsChainIdDappsUniswapv3PoolsDayDataCurrentGet(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    def chains_chain_id_dapps_uniswapv3_pools_day_data_current_get(
        self: BaseApi,
        query_params: RequestQueryParams = frozendict.frozendict(),
        path_params: RequestPathParams = frozendict.frozendict(),
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
        ...
        return self._chains_chain_id_dapps_uniswapv3_pools_day_data_current_get_oapg(
