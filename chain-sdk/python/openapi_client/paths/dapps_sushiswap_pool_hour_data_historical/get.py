...
class BaseApi(api_client.Api):
    ...
    def _dapps_sushiswap_pool_hour_data_historical_get_oapg(
        self: api_client.Api,
...
class DappsSushiswapPoolHourDataHistoricalGet(BaseApi):
    ...
    def dapps_sushiswap_pool_hour_data_historical_get(
        ...
        return self._dapps_sushiswap_pool_hour_data_historical_get_oapg(
