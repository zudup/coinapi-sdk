...
class BaseApi(api_client.Api):
    @typing.overload
    def _uniswap_v3_get_tick_day_data_v3s__historical_oapg(
        self,
...
class UniswapV3GetTickDayDataV3sHistorical(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def uniswap_v3_get_tick_day_data_v3s__historical(
        self,
        query_params: RequestQueryParams = frozendict.frozendict(),
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
        stream: bool = False,
    ...
    def uniswap_v3_get_tick_day_data_v3s__historical(
        ...
        return self._uniswap_v3_get_tick_day_data_v3s__historical_oapg(
