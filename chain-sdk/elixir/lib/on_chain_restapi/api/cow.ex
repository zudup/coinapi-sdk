...
defmodule OnChain-RESTAPI.Api.Cow do
  @moduledoc """
  ...
  """
  @spec cow_get_orders__historical(Tesla.Env.client, keyword()) :: {:ok, list(OnChain-RESTAPI.Model.CowOrderDto.t)} | {:error, Tesla.Env.t}
  def cow_get_orders__historical(connection, opts \\ []) do
    ...
    |> evaluate_response([
      {200, [%OnChain-RESTAPI.Model.CowOrderDto{}]}
    ])
  end
  ...
  - `{:error, Tesla.Env.t}` on failure
  """
  @spec cow_get_settlements__historical(Tesla.Env.client, keyword()) :: {:ok, list(OnChain-RESTAPI.Model.CowSettlementDto.t)} | {:error, Tesla.Env.t}
  def cow_get_settlements__historical(connection, opts \\ []) do
    ...
    |> Connection.request(request)
    |> evaluate_response([
      {200, [%OnChain-RESTAPI.Model.CowSettlementDto{}]}
    ])
  end
  ...
  - `{:error, Tesla.Env.t}` on failure
  """
  @spec cow_get_tokens__historical(Tesla.Env.client, keyword()) :: {:ok, list(OnChain-RESTAPI.Model.CowTokenDto.t)} | {:error, Tesla.Env.t}
  def cow_get_tokens__historical(connection, opts \\ []) do
    ...
    |> Connection.request(request)
    |> evaluate_response([
      {200, [%OnChain-RESTAPI.Model.CowTokenDto{}]}
    ])
  end
  ...
  - `{:error, Tesla.Env.t}` on failure
  """
  @spec cow_get_trades__historical(Tesla.Env.client, keyword()) :: {:ok, list(OnChain-RESTAPI.Model.CowTradeDto.t)} | {:error, Tesla.Env.t}
  def cow_get_trades__historical(connection, opts \\ []) do
    ...
    |> Connection.request(request)
    |> evaluate_response([
      {200, [%OnChain-RESTAPI.Model.CowTradeDto{}]}
    ])
  end
  ...
  - `{:error, Tesla.Env.t}` on failure
  """
  @spec cow_get_users__historical(Tesla.Env.client, keyword()) :: {:ok, list(OnChain-RESTAPI.Model.CowUserDto.t)} | {:error, Tesla.Env.t}
  def cow_get_users__historical(connection, opts \\ []) do
    ...
    |> Connection.request(request)
    |> evaluate_response([
      {200, [%OnChain-RESTAPI.Model.CowUserDto{}]}
    ])
  end
  ...
  - `{:error, Tesla.Env.t}` on failure
  """
  @spec cow_orders__current(Tesla.Env.client, keyword()) :: {:ok, list(OnChain-RESTAPI.Model.CowOrderDto.t)} | {:error, Tesla.Env.t}
  ...
  - `{:error, Tesla.Env.t}` on failure
  """
  @spec cow_settlements__current(Tesla.Env.client, keyword()) :: {:ok, list(OnChain-RESTAPI.Model.CowSettlementDto.t)} | {:error, Tesla.Env.t}
  ...
  - `{:error, Tesla.Env.t}` on failure
  """
  @spec cow_tokens__current(Tesla.Env.client, keyword()) :: {:ok, list(OnChain-RESTAPI.Model.CowTokenDto.t)} | {:error, Tesla.Env.t}
  ...
  - `{:error, Tesla.Env.t}` on failure
  """
  @spec cow_trades__current(Tesla.Env.client, keyword()) :: {:ok, list(OnChain-RESTAPI.Model.CowTradeDto.t)} | {:error, Tesla.Env.t}
  ...
  - `{:error, Tesla.Env.t}` on failure
  """
  @spec cow_users__current(Tesla.Env.client, keyword()) :: {:ok, list(OnChain-RESTAPI.Model.CowUserDto.t)} | {:error, Tesla.Env.t}
