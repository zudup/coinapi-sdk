...
defmodule OnChain-RESTAPI.Model.SushiswapLiquidityPositionSnapshotDto do
  @moduledoc """
...
defimpl Poison.Decoder, for: OnChain-RESTAPI.Model.SushiswapLiquidityPositionSnapshotDto do
