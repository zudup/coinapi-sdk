...
defmodule OnChain-RESTAPI.Model.UniswapV2LiquidityPositionSnapshotDto do
  @moduledoc """
...
defimpl Poison.Decoder, for: OnChain-RESTAPI.Model.UniswapV2LiquidityPositionSnapshotDto do
