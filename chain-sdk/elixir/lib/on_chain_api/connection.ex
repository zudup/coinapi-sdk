...
defmodule OnChainAPI.Connection do
  @moduledoc """
  Handle Tesla connections for OnChainAPI.

  Additional middleware can be set in the compile-time or runtime configuration:

      config :tesla, OnChainAPI.Connection,
  ...
  def middleware(options \\ []) do
    base_url =
      Keyword.get(
        options,
        :base_url,
        Application.get_env(:on_chain_api, :base_url, @default_base_url)
      )
    ...
    user_agent =
      Keyword.get(
        ...
        Keyword.get(
          tesla_options,
          :user_agent,
          "openapi-generator - OnChainAPI v1 - elixir"
        )
      )
