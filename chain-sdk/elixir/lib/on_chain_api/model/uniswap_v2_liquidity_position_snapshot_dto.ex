...
defmodule OnChainAPI.Model.UniswapV2LiquidityPositionSnapshotDto do
  @moduledoc """
...
defimpl Poison.Decoder, for: OnChainAPI.Model.UniswapV2LiquidityPositionSnapshotDto do
