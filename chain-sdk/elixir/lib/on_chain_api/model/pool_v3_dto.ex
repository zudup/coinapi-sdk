...
defmodule OnChainAPI.Model.PoolV3Dto do
  @moduledoc """
  ...
  @type t :: %__MODULE__{
    ...
    :fee_tier => OnChainAPI.Model.BigInteger.t | nil,
    :liquidity => OnChainAPI.Model.BigInteger.t | nil,
    :sqrt_price => OnChainAPI.Model.BigInteger.t | nil,
    :fee_growth_global_0x128 => OnChainAPI.Model.BigInteger.t | nil,
    :fee_growth_global_1x128 => OnChainAPI.Model.BigInteger.t | nil,
    :token_0_price => String.t | nil,
    :token_1_price => String.t | nil,
    :tick => OnChainAPI.Model.BigInteger.t | nil,
    :observation_index => OnChainAPI.Model.BigInteger.t | nil,
...
defimpl Poison.Decoder, for: OnChainAPI.Model.PoolV3Dto do
  import OnChainAPI.Deserializer
  def decode(value, options) do
    value
    |> deserialize(:fee_tier, :struct, OnChainAPI.Model.BigInteger, options)
    |> deserialize(:liquidity, :struct, OnChainAPI.Model.BigInteger, options)
    |> deserialize(:sqrt_price, :struct, OnChainAPI.Model.BigInteger, options)
    |> deserialize(:fee_growth_global_0x128, :struct, OnChainAPI.Model.BigInteger, options)
    |> deserialize(:fee_growth_global_1x128, :struct, OnChainAPI.Model.BigInteger, options)
    |> deserialize(:tick, :struct, OnChainAPI.Model.BigInteger, options)
    |> deserialize(:observation_index, :struct, OnChainAPI.Model.BigInteger, options)
