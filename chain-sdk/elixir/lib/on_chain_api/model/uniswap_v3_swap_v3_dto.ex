...
defmodule OnChainAPI.Model.UniswapV3SwapV3Dto do
  @moduledoc """
  ...
  @type t :: %__MODULE__{
    ...
    :sqrt_price_x96 => OnChainAPI.Model.NumericsBigInteger.t | nil,
...
defimpl Poison.Decoder, for: OnChainAPI.Model.UniswapV3SwapV3Dto do
  import OnChainAPI.Deserializer
  def decode(value, options) do
    value
    |> deserialize(:sqrt_price_x96, :struct, OnChainAPI.Model.NumericsBigInteger, options)
