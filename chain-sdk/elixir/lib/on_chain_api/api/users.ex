...
defmodule OnChainAPI.Api.Users do
  ...
  - `{:error, Tesla.Env.t}` on failure
  """
  @spec chains_chain_id_dapps_dex_users_historical_get(Tesla.Env.client, String.t, keyword()) :: {:ok, nil} | {:error, Tesla.Env.t}
  def chains_chain_id_dapps_dex_users_historical_get(connection, chain_id, opts \\ []) do
    optional_params = %{
      :startBlock => :query,
      :endBlock => :query,
      :startDate => :query,
    ...
    request =
      %{}
      |> method(:get)
      |> url("/chains/#{chain_id}/dapps/dex/users/historical")
      |> add_optional_params(optional_params, opts)
      |> Enum.into([])
