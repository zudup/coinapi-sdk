...
module OnChain-REST.API.Cow where
...
cowGetOrdersHistorical
  ...
  -> OnChain-RESTRequest CowGetOrdersHistorical MimeNoContent [CowOrderDTO] accept
...
cowGetSettlementsHistorical
  :: Accept accept -- ^ request accept ('MimeType')
  -> OnChain-RESTRequest CowGetSettlementsHistorical MimeNoContent [CowSettlementDTO] accept
...
cowGetTokensHistorical
  :: Accept accept -- ^ request accept ('MimeType')
  -> OnChain-RESTRequest CowGetTokensHistorical MimeNoContent [CowTokenDTO] accept
...
cowGetTradesHistorical
  :: Accept accept -- ^ request accept ('MimeType')
  -> OnChain-RESTRequest CowGetTradesHistorical MimeNoContent [CowTradeDTO] accept
...
cowGetUsersHistorical
  :: Accept accept -- ^ request accept ('MimeType')
  -> OnChain-RESTRequest CowGetUsersHistorical MimeNoContent [CowUserDTO] accept
...
cowOrdersCurrent
  :: Accept accept -- ^ request accept ('MimeType')
  -> OnChain-RESTRequest CowOrdersCurrent MimeNoContent [CowOrderDTO] accept
cowOrdersCurrent  _ =
...
cowSettlementsCurrent
  :: Accept accept -- ^ request accept ('MimeType')
  -> OnChain-RESTRequest CowSettlementsCurrent MimeNoContent [CowSettlementDTO] accept
...
cowTokensCurrent
  :: Accept accept -- ^ request accept ('MimeType')
  -> OnChain-RESTRequest CowTokensCurrent MimeNoContent [CowTokenDTO] accept
cowTokensCurrent  _ =
...
cowTradesCurrent
  :: Accept accept -- ^ request accept ('MimeType')
  -> OnChain-RESTRequest CowTradesCurrent MimeNoContent [CowTradeDTO] accept
cowTradesCurrent  _ =
...
cowUsersCurrent
  :: Accept accept -- ^ request accept ('MimeType')
  -> OnChain-RESTRequest CowUsersCurrent MimeNoContent [CowUserDTO] accept
cowUsersCurrent  _ =
