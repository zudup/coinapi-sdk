...
module OnChain-REST.Core where
...
-- |
data OnChain-RESTConfig = OnChain-RESTConfig
...
-- | display the config
instance P.Show OnChain-RESTConfig where
  show c =
    T.printf
...
-- | constructs a default OnChain-RESTConfig
--
-- configHost:
--
...
-- configUserAgent:
--
-- @"on-chain---rest/0.1.0.0"@
--
newConfig :: IO OnChain-RESTConfig
newConfig = do
    logCxt <- initLogContext
    return $ OnChain-RESTConfig
        { configHost = "https://onchain.coinapi.io"
        , configUserAgent = "on-chain---rest/0.1.0.0"
...
addAuthMethod :: AuthMethod auth => OnChain-RESTConfig -> auth -> OnChain-RESTConfig
addAuthMethod config@OnChain-RESTConfig {configAuthMethods = as} a =
  config { configAuthMethods = AnyAuthMethod a : as}

-- | updates the config to use stdout logging
withStdoutLogging :: OnChain-RESTConfig -> IO OnChain-RESTConfig
...
withStderrLogging :: OnChain-RESTConfig -> IO OnChain-RESTConfig
...
withNoLogging :: OnChain-RESTConfig -> OnChain-RESTConfig
...
data OnChain-RESTRequest req contentType res accept = OnChain-RESTRequest
  { rMethod  :: NH.Method   -- ^ Method of OnChain-RESTRequest
  , rUrlPath :: [BCL.ByteString] -- ^ Endpoint of OnChain-RESTRequest
  , rParams   :: Params -- ^ params of OnChain-RESTRequest
  , rAuthTypes :: [P.TypeRep] -- ^ types of auth methods
  }
  deriving (P.Show)

-- | 'rMethod' Lens
rMethodL :: Lens_' (OnChain-RESTRequest req contentType res accept) NH.Method
rMethodL f OnChain-RESTRequest{..} = (\rMethod -> OnChain-RESTRequest { rMethod, ..} ) <$> f rMethod
{-# INLINE rMethodL #-}

-- | 'rUrlPath' Lens
rUrlPathL :: Lens_' (OnChain-RESTRequest req contentType res accept) [BCL.ByteString]
rUrlPathL f OnChain-RESTRequest{..} = (\rUrlPath -> OnChain-RESTRequest { rUrlPath, ..} ) <$> f rUrlPath
{-# INLINE rUrlPathL #-}

-- | 'rParams' Lens
rParamsL :: Lens_' (OnChain-RESTRequest req contentType res accept) Params
rParamsL f OnChain-RESTRequest{..} = (\rParams -> OnChain-RESTRequest { rParams, ..} ) <$> f rParams
{-# INLINE rParamsL #-}

-- | 'rParams' Lens
rAuthTypesL :: Lens_' (OnChain-RESTRequest req contentType res accept) [P.TypeRep]
rAuthTypesL f OnChain-RESTRequest{..} = (\rAuthTypes -> OnChain-RESTRequest { rAuthTypes, ..} ) <$> f rAuthTypes
{-# INLINE rAuthTypesL #-}
...
class HasBodyParam req param where
  setBodyParam :: forall contentType res accept. (Consumes req contentType, MimeRender contentType param) => OnChain-RESTRequest req contentType res accept -> param -> OnChain-RESTRequest req contentType res accept
  setBodyParam req xs =
...
class HasOptionalParam req param where
  ...
  applyOptionalParam :: OnChain-RESTRequest req contentType res accept -> param -> OnChain-RESTRequest req contentType res accept
  applyOptionalParam = (-&-)
  {-# INLINE applyOptionalParam #-}

  -- | infix operator \/ alias for 'addOptionalParam'
  (-&-) :: OnChain-RESTRequest req contentType res accept -> param -> OnChain-RESTRequest req contentType res accept
  (-&-) = applyOptionalParam
  {-# INLINE (-&-) #-}
...
-- ** OnChain-RESTRequest Utils

_mkRequest :: NH.Method -- ^ Method
          -> [BCL.ByteString] -- ^ Endpoint
          -> OnChain-RESTRequest req contentType res accept -- ^ req: Request Type, res: Response Type
_mkRequest m u = OnChain-RESTRequest m u _mkParams []

_mkParams :: Params
_mkParams = Params [] [] ParamBodyNone

setHeader ::
     OnChain-RESTRequest req contentType res accept
  -> [NH.Header]
  -> OnChain-RESTRequest req contentType res accept
...
removeHeader :: OnChain-RESTRequest req contentType res accept -> [NH.HeaderName] -> OnChain-RESTRequest req contentType res accept
...
_setContentTypeHeader :: forall req contentType res accept. MimeType contentType => OnChain-RESTRequest req contentType res accept -> OnChain-RESTRequest req contentType res accept
_setContentTypeHeader req =
    case mimeType (P.Proxy :: P.Proxy contentType) of
        Just m -> req `setHeader` [("content-type", BC.pack $ P.show m)]
        Nothing -> req `removeHeader` ["content-type"]

_setAcceptHeader :: forall req contentType res accept. MimeType accept => OnChain-RESTRequest req contentType res accept -> OnChain-RESTRequest req contentType res accept
...
addForm :: OnChain-RESTRequest req contentType res accept -> WH.Form -> OnChain-RESTRequest req contentType res accept
addForm req newform =
...
_addMultiFormPart :: OnChain-RESTRequest req contentType res accept -> NH.Part -> OnChain-RESTRequest req contentType res accept
...
_setBodyBS :: OnChain-RESTRequest req contentType res accept -> B.ByteString -> OnChain-RESTRequest req contentType res accept
_setBodyBS req body =
    req & L.set (rParamsL . paramsBodyL) (ParamBodyB body)

_setBodyLBS :: OnChain-RESTRequest req contentType res accept -> BL.ByteString -> OnChain-RESTRequest req contentType res accept
_setBodyLBS req body =
    req & L.set (rParamsL . paramsBodyL) (ParamBodyBL body)

_hasAuthType :: AuthMethod authMethod => OnChain-RESTRequest req contentType res accept -> P.Proxy authMethod -> OnChain-RESTRequest req contentType res accept
...
class P.Typeable a =>
  ...
  applyAuthMethod
    ...
    -> a
    -> OnChain-RESTRequest req contentType res accept
    -> IO (OnChain-RESTRequest req contentType res accept)
...
_applyAuthMethods
  ...
  -> OnChain-RESTConfig
  -> IO (OnChain-RESTRequest req contentType res accept)
_applyAuthMethods req config@(OnChain-RESTConfig {configAuthMethods = as}) =
  foldlM go req as
  where
