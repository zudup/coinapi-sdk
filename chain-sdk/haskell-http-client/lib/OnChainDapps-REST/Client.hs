...
module OnChainDapps-REST.Client where
...
dispatchLbs
  ...
  -> OnChainDapps-RESTConfig -- ^ config
  -> OnChainDapps-RESTRequest req contentType res accept -- ^ request
