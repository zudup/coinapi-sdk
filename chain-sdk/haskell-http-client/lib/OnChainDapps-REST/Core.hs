...
module OnChainDapps-REST.Core where
...
-- * OnChainDapps-RESTConfig

-- |
data OnChainDapps-RESTConfig = OnChainDapps-RESTConfig
...
-- | display the config
instance P.Show OnChainDapps-RESTConfig where
  show c =
    T.printf
...
-- | constructs a default OnChainDapps-RESTConfig
--
-- configHost:
--
...
-- configUserAgent:
--
-- @"on-chain-dapps---rest/0.1.0.0"@
--
newConfig :: IO OnChainDapps-RESTConfig
newConfig = do
    logCxt <- initLogContext
    return $ OnChainDapps-RESTConfig
        { configHost = "https://onchain.coinapi.io"
        , configUserAgent = "on-chain-dapps---rest/0.1.0.0"
...
addAuthMethod :: AuthMethod auth => OnChainDapps-RESTConfig -> auth -> OnChainDapps-RESTConfig
addAuthMethod config@OnChainDapps-RESTConfig {configAuthMethods = as} a =
  config { configAuthMethods = AnyAuthMethod a : as}

-- | updates the config to use stdout logging
withStdoutLogging :: OnChainDapps-RESTConfig -> IO OnChainDapps-RESTConfig
...
withStderrLogging :: OnChainDapps-RESTConfig -> IO OnChainDapps-RESTConfig
...
withNoLogging :: OnChainDapps-RESTConfig -> OnChainDapps-RESTConfig
withNoLogging p = p { configLogExecWithContext =  runNullLogExec}

-- * OnChainDapps-RESTRequest
...
data OnChainDapps-RESTRequest req contentType res accept = OnChainDapps-RESTRequest
  { rMethod  :: NH.Method   -- ^ Method of OnChainDapps-RESTRequest
  , rUrlPath :: [BCL.ByteString] -- ^ Endpoint of OnChainDapps-RESTRequest
  , rParams   :: Params -- ^ params of OnChainDapps-RESTRequest
  , rAuthTypes :: [P.TypeRep] -- ^ types of auth methods
  }
  deriving (P.Show)

-- | 'rMethod' Lens
rMethodL :: Lens_' (OnChainDapps-RESTRequest req contentType res accept) NH.Method
rMethodL f OnChainDapps-RESTRequest{..} = (\rMethod -> OnChainDapps-RESTRequest { rMethod, ..} ) <$> f rMethod
{-# INLINE rMethodL #-}

-- | 'rUrlPath' Lens
rUrlPathL :: Lens_' (OnChainDapps-RESTRequest req contentType res accept) [BCL.ByteString]
rUrlPathL f OnChainDapps-RESTRequest{..} = (\rUrlPath -> OnChainDapps-RESTRequest { rUrlPath, ..} ) <$> f rUrlPath
{-# INLINE rUrlPathL #-}

-- | 'rParams' Lens
rParamsL :: Lens_' (OnChainDapps-RESTRequest req contentType res accept) Params
rParamsL f OnChainDapps-RESTRequest{..} = (\rParams -> OnChainDapps-RESTRequest { rParams, ..} ) <$> f rParams
{-# INLINE rParamsL #-}

-- | 'rParams' Lens
rAuthTypesL :: Lens_' (OnChainDapps-RESTRequest req contentType res accept) [P.TypeRep]
rAuthTypesL f OnChainDapps-RESTRequest{..} = (\rAuthTypes -> OnChainDapps-RESTRequest { rAuthTypes, ..} ) <$> f rAuthTypes
{-# INLINE rAuthTypesL #-}
...
class HasBodyParam req param where
  setBodyParam :: forall contentType res accept. (Consumes req contentType, MimeRender contentType param) => OnChainDapps-RESTRequest req contentType res accept -> param -> OnChainDapps-RESTRequest req contentType res accept
  setBodyParam req xs =
...
class HasOptionalParam req param where
  ...
  applyOptionalParam :: OnChainDapps-RESTRequest req contentType res accept -> param -> OnChainDapps-RESTRequest req contentType res accept
  applyOptionalParam = (-&-)
  {-# INLINE applyOptionalParam #-}

  -- | infix operator \/ alias for 'addOptionalParam'
  (-&-) :: OnChainDapps-RESTRequest req contentType res accept -> param -> OnChainDapps-RESTRequest req contentType res accept
  (-&-) = applyOptionalParam
  {-# INLINE (-&-) #-}
...
-- ** OnChainDapps-RESTRequest Utils

_mkRequest :: NH.Method -- ^ Method
          -> [BCL.ByteString] -- ^ Endpoint
          -> OnChainDapps-RESTRequest req contentType res accept -- ^ req: Request Type, res: Response Type
_mkRequest m u = OnChainDapps-RESTRequest m u _mkParams []

_mkParams :: Params
_mkParams = Params [] [] ParamBodyNone

setHeader ::
     OnChainDapps-RESTRequest req contentType res accept
  -> [NH.Header]
  -> OnChainDapps-RESTRequest req contentType res accept
...
removeHeader :: OnChainDapps-RESTRequest req contentType res accept -> [NH.HeaderName] -> OnChainDapps-RESTRequest req contentType res accept
...
_setContentTypeHeader :: forall req contentType res accept. MimeType contentType => OnChainDapps-RESTRequest req contentType res accept -> OnChainDapps-RESTRequest req contentType res accept
_setContentTypeHeader req =
    case mimeType (P.Proxy :: P.Proxy contentType) of
        Just m -> req `setHeader` [("content-type", BC.pack $ P.show m)]
        Nothing -> req `removeHeader` ["content-type"]

_setAcceptHeader :: forall req contentType res accept. MimeType accept => OnChainDapps-RESTRequest req contentType res accept -> OnChainDapps-RESTRequest req contentType res accept
...
addForm :: OnChainDapps-RESTRequest req contentType res accept -> WH.Form -> OnChainDapps-RESTRequest req contentType res accept
addForm req newform =
...
_addMultiFormPart :: OnChainDapps-RESTRequest req contentType res accept -> NH.Part -> OnChainDapps-RESTRequest req contentType res accept
...
_setBodyBS :: OnChainDapps-RESTRequest req contentType res accept -> B.ByteString -> OnChainDapps-RESTRequest req contentType res accept
_setBodyBS req body =
    req & L.set (rParamsL . paramsBodyL) (ParamBodyB body)

_setBodyLBS :: OnChainDapps-RESTRequest req contentType res accept -> BL.ByteString -> OnChainDapps-RESTRequest req contentType res accept
_setBodyLBS req body =
    req & L.set (rParamsL . paramsBodyL) (ParamBodyBL body)

_hasAuthType :: AuthMethod authMethod => OnChainDapps-RESTRequest req contentType res accept -> P.Proxy authMethod -> OnChainDapps-RESTRequest req contentType res accept
...
class P.Typeable a =>
  ...
  applyAuthMethod
    ...
    -> a
    -> OnChainDapps-RESTRequest req contentType res accept
    -> IO (OnChainDapps-RESTRequest req contentType res accept)
...
_applyAuthMethods
  ...
  -> OnChainDapps-RESTConfig
  -> IO (OnChainDapps-RESTRequest req contentType res accept)
_applyAuthMethods req config@(OnChainDapps-RESTConfig {configAuthMethods = as}) =
  foldlM go req as
  where
