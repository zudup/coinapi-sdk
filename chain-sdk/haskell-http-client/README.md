## OpenAPI Auto-Generated [http-client](https://www.stackage.org/lts-10.0/package/http-client-0.5.7.1) Bindings to `OnChain API`

The library in `lib` provides auto-generated-from-OpenAPI [http-client](https://www.stackage.org/lts-10.0/package/http-client-0.5.7.1) bindings to the OnChain API API.
...
| baseModule                      | Set the base module namespace                                                                                                 |          | OnChain                      |
| cabalPackage                    | Set the cabal package name, which consists of one or more alphanumeric words separated by hyphens                             |          | onchain                    |
...
| configType                      | Set the name of the type used for configuration                                                                               |          | OnChainConfig                      |
...
| requestType                     | Set the name of the type used to generate requests                                                                            |          | OnChainRequest                     |
...
| MODULE              | NOTES                                               |
| ------------------- | --------------------------------------------------- |
| OnChain.Client    | use the "dispatch" functions to send requests       |
| OnChain.Core      | core functions, config and request types            |
| OnChain.API       | construct api requests                              |
| OnChain.Model     | describes api models                                |
| OnChain.MimeTypes | encoding/decoding MIME types (content-types/accept) |
| OnChain.ModelLens | lenses for model fields                             |
| OnChain.Logging   | logging functions and utils                         |
