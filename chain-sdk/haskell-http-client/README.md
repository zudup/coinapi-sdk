## OpenAPI Auto-Generated [http-client](https://www.stackage.org/lts-10.0/package/http-client-0.5.7.1) Bindings to `On Chain Dapps - REST API`

The library in `lib` provides auto-generated-from-OpenAPI [http-client](https://www.stackage.org/lts-10.0/package/http-client-0.5.7.1) bindings to the On Chain Dapps - REST API API.
...
| baseModule                      | Set the base module namespace                                                                                                 |          | OnChainDapps-REST                      |
| cabalPackage                    | Set the cabal package name, which consists of one or more alphanumeric words separated by hyphens                             |          | on-chain-dapps---rest                    |
...
| configType                      | Set the name of the type used for configuration                                                                               |          | OnChainDapps-RESTConfig                      |
...
| requestType                     | Set the name of the type used to generate requests                                                                            |          | OnChainDapps-RESTRequest                     |
...
| MODULE              | NOTES                                               |
| ------------------- | --------------------------------------------------- |
| OnChainDapps-REST.Client    | use the "dispatch" functions to send requests       |
| OnChainDapps-REST.Core      | core functions, config and request types            |
| OnChainDapps-REST.API       | construct api requests                              |
| OnChainDapps-REST.Model     | describes api models                                |
| OnChainDapps-REST.MimeTypes | encoding/decoding MIME types (content-types/accept) |
| OnChainDapps-REST.ModelLens | lenses for model fields                             |
| OnChainDapps-REST.Logging   | logging functions and utils                         |
