## OpenAPI Auto-Generated [http-client](https://www.stackage.org/lts-10.0/package/http-client-0.5.7.1) Bindings to `On Chain - REST API`

The library in `lib` provides auto-generated-from-OpenAPI [http-client](https://www.stackage.org/lts-10.0/package/http-client-0.5.7.1) bindings to the On Chain - REST API API.
...
| baseModule                      | Set the base module namespace                                                                                                 |          | OnChain-REST                      |
| cabalPackage                    | Set the cabal package name, which consists of one or more alphanumeric words separated by hyphens                             |          | on-chain---rest                    |
...
| configType                      | Set the name of the type used for configuration                                                                               |          | OnChain-RESTConfig                      |
...
| requestType                     | Set the name of the type used to generate requests                                                                            |          | OnChain-RESTRequest                     |
...
| MODULE              | NOTES                                               |
| ------------------- | --------------------------------------------------- |
| OnChain-REST.Client    | use the "dispatch" functions to send requests       |
| OnChain-REST.Core      | core functions, config and request types            |
| OnChain-REST.API       | construct api requests                              |
| OnChain-REST.Model     | describes api models                                |
| OnChain-REST.MimeTypes | encoding/decoding MIME types (content-types/accept) |
| OnChain-REST.ModelLens | lenses for model fields                             |
| OnChain-REST.Logging   | logging functions and utils                         |
