...
module OMS-REST.API.Orders where
...
v1OrdersCancelAllPost 
  ...
  -> OMS-RESTRequest V1OrdersCancelAllPost MimeJSON MessagesOk MimeJSON
...
v1OrdersCancelPost 
  ...
  -> OMS-RESTRequest V1OrdersCancelPost MimeJSON OrderLive accept
...
-- 
v1OrdersGet 
  :: OMS-RESTRequest V1OrdersGet MimeNoContent [Order] MimeJSON
v1OrdersGet =
...
v1OrdersPost 
  ...
  => Accept accept -- ^ request accept ('MimeType')
  -> NewOrder -- ^ "newOrder"
  -> OMS-RESTRequest V1OrdersPost MimeJSON OrderLive accept
