...
#ifndef OAIMessagesInfo_H
#define OAIMessagesInfo_H
...
class OAIMessagesInfo : public OAIObject {
public:
    OAIMessagesInfo();
    OAIMessagesInfo(QString json);
    ~OAIMessagesInfo() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIMessagesInfo)

#endif // OAIMessagesInfo_H
