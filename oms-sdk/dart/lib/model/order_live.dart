...
class OrderLive {
  ...
  static List<OrderLive> listFromJson(List<dynamic> json) {
    return json == null ? List<OrderLive>() : json.map((value) => OrderLive.fromJson(value)).toList();
  }

  static Map<String, OrderLive> mapFromJson(Map<String, dynamic> json) {
    var map = Map<String, OrderLive>();
    if (json != null && json.isNotEmpty) {
      json.forEach((String key, dynamic value) => map[key] = OrderLive.fromJson(value));
    }
    return map;
  }

  // maps a json object with a list of OrderLive-objects as value to a dart map
  static Map<String, List<OrderLive>> mapListFromJson(Map<String, dynamic> json) {
    var map = Map<String, List<OrderLive>>();
     if (json != null && json.isNotEmpty) {
       json.forEach((String key, dynamic value) {
         map[key] = OrderLive.listFromJson(value);
       });
     }
     return map;
  }
