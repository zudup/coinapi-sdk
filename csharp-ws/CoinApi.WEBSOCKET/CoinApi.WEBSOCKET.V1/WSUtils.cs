...
namespace CoinApi.WEBSOCKET.V1
{
    internal static class WSUtils
    {
        ...
        internal async static Task<MessageData> ReceiveMessage(WebSocket webSocket, long maxSize = long.MaxValue)
        {
        ...
        public static async Task SendMessage(ArraySegment<byte> data, WebSocket webSocket)
        {
